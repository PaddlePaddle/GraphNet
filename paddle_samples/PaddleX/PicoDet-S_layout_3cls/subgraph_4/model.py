...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        ...
        # pd_op.argmax: (2x6150xi64) <- (2x3x6150xf32, 1xi64)
        ...
        # pd_op.add: (2x6150xi64) <- (2x6150xi64, 2x1xi64)
        ...
        # pd_op.flatten: (12300xi64) <- (2x6150xi64)
        ...
        # pd_op.gather: (12300xi32) <- (6xi32, 12300xi64, 1xi32)
        gather_0 = paddle._C_ops.gather(flatten_0, flatten_1, full_2)
        del flatten_0

        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_0 = [2, 6150]

        # pd_op.reshape: (2x6150xi32) <- (12300xi32, 2xi64)
        ...
        # pd_op.greater_than: (2x6150xb) <- (2x6150xf32, xf32)
        ...
        # pd_op.full_like: (2x6150xi32) <- (2x6150xi32, 1xf32)
        full_like_0 = paddle._C_ops.full_like(
            reshape_1, full_4, paddle.int32, paddle.framework._current_expected_place()
        )
        del full_4

        # pd_op.where: (2x6150xi32) <- (2x6150xb, 2x6150xi32, 2x6150xi32)
        ...
        # pd_op.gather: (12300x4xf32) <- (6x4xf32, 12300xi64, 1xi32)
        gather_1 = paddle._C_ops.gather(reshape_2, flatten_1, full_2)
        del flatten_1, full_2, reshape_2

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_2 = [2, 6150, 4]

        # pd_op.reshape: (2x6150x4xf32) <- (12300x4xf32, 3xi64)
        ...
        # pd_op.one_hot: (2x6150x12xf32) <- (2x6150xi32, 1xi32)
        ...
        # pd_op.index_select: (2x6150x11xf32) <- (2x6150x12xf32, 11xi64)
        index_select_0 = paddle._C_ops.index_select(one_hot_0, assign_value__0, -1)
        del assign_value__0, one_hot_0

        # pd_op.multiply: (2x3x6150xf32) <- (2x3x6150xf32, 2x3x6150xf32)
        ...
        # pd_op.max: (2x3x1xf32) <- (2x3x6150xf32, 1xi64)
        ...
        # pd_op.divide: (2x3x6150xf32) <- (2x3x6150xf32, 2x3x1xf32)
        divide_0 = paddle._C_ops.divide(multiply_1, scale_1)
        del multiply_1, scale_1

        # pd_op.multiply: (2x3x6150xf32) <- (2x3x6150xf32, 2x3x1xf32)
