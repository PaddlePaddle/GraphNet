...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        (
            ...
            paddle._C_ops.distribute_fpn_proposals(data_4, data_5, 2, 5, 4, 224, False),
        ...
        slice_2 = paddle._C_ops.slice(
            data_4, [1], full_int_array_2, full_int_array_5, [1], [1]
        )

        # pd_op.slice: (512xf32) <- (512x4xf32, 1xi64, 1xi64)
        slice_3 = paddle._C_ops.slice(
            data_4, [1], full_int_array_4, full_int_array_1, [1], [1]
        )
        ...
        scale_0 = paddle._C_ops.scale(strided_slice_0, full_1, float("0"), True)
        ...
        # pd_op.scale: (-1x1xf32) <- (-1x1xf32, 1xf32)
        scale_1 = paddle._C_ops.scale(strided_slice_1, full_1, float("0"), True)
        ...
        # pd_op.scale: (-1x1xf32) <- (-1x1xf32, 1xf32)
        scale_2 = paddle._C_ops.scale(strided_slice_2, full_2, float("0"), True)
        ...
        # pd_op.scale: (-1x1xf32) <- (-1x1xf32, 1xf32)
        scale_3 = paddle._C_ops.scale(strided_slice_3, full_2, float("0"), True)
        ...
        clip_0 = paddle._C_ops.clip(scale_2, full_3, full_4)

        # pd_op.clip: (-1x1xf32) <- (-1x1xf32, 1xf32, 1xf32)
        clip_1 = paddle._C_ops.clip(scale_3, full_3, full_4)
