...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        # pd_op.multiply: (4x-1x-1xf32) <- (4x-1x-1xf32, 4x-1x-1xf32)
        multiply_0 = paddle._C_ops.multiply(data_3, data_1)
        del data_3

        # pd_op.flatten: (-1x-1xf32) <- (4x-1x-1xf32)
        flatten_0 = paddle._C_ops.flatten(multiply_0, 0, 1)

        # pd_op.flatten: (-1x27xi64) <- (4x-1x27xi64)
        flatten_1 = paddle._C_ops.flatten(data_2, 0, 1)
        del data_2

        # pd_op.index_sample: (-1x27xf32) <- (-1x-1xf32, -1x27xi64)
        ...
        # pd_op.reshape: (4x-1x-1xf32) <- (-1x27xf32, 3xi64)
        ...
        # pd_op.unsqueeze: (4x-1x1x4xf32) <- (4x-1x4xf32, 1xi64)
        unsqueeze_1 = paddle._C_ops.unsqueeze(data_5, full_int_array_2)
        del data_5, full_int_array_2

        # pd_op.split_with_num: ([4x-1x1x1xf32, 4x-1x1x1xf32, 4x-1x1x1xf32, 4x-1x1x1xf32]) <- (4x-1x1x4xf32, 1xi32)
        split_with_num_1 = paddle._C_ops.split_with_num(unsqueeze_1, 4, full_4)
        del full_4, unsqueeze_1

        # builtin.split: (4x-1x1x1xf32, 4x-1x1x1xf32, 4x-1x1x1xf32, 4x-1x1x1xf32) <- ([4x-1x1x1xf32, 4x-1x1x1xf32, 4x-1x1x1xf32, 4x-1x1x1xf32])
        (
            split_2,
            split_3,
            split_4,
        ...
        # pd_op.subtract: (4x-1x-1x1xf32) <- (1x1x-1x1xf32, 4x-1x1x1xf32)
        ...
        # pd_op.subtract: (4x-1x-1x1xf32) <- (4x-1x1x1xf32, 1x1x-1x1xf32)
        ...
        # builtin.combine: ([4x-1x-1x1xf32, 4x-1x-1x1xf32, 4x-1x-1x1xf32, 4x-1x-1x1xf32]) <- (4x-1x-1x1xf32, 4x-1x-1x1xf32, 4x-1x-1x1xf32, 4x-1x-1x1xf32)
        combine_1 = [subtract_1, subtract_2, subtract_3, subtract_4]
        del subtract_1, subtract_2, subtract_3, subtract_4

        # pd_op.concat: (4x-1x-1x4xf32) <- ([4x-1x-1x1xf32, 4x-1x-1x1xf32, 4x-1x-1x1xf32, 4x-1x-1x1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_1, full_5)
        del combine_1, full_5

        # pd_op.min: (4x-1x-1xf32) <- (4x-1x-1x4xf32, 1xi64)
        ...
        # pd_op.greater_than: (4x-1x-1xb) <- (4x-1x-1xf32, xf32)
        greater_than_2 = paddle._C_ops.greater_than(min_0, full_6)
        del full_6, min_0

        # pd_op.cast: (4x-1x-1xf32) <- (4x-1x-1xb)
        ...
        # pd_op.multiply: (4x-1x-1xf32) <- (4x-1x-1xf32, 4x-1x1xf32)
        ...
        # pd_op.sum: (4x-1xf32) <- (4x-1x-1xf32, 1xi64)
