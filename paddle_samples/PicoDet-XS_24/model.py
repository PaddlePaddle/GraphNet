...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (4x96x44x44xf32) <- (4x48x44x44xf32, 96x48x1x1xf32)
        conv2d_0 = paddle._C_ops.conv2d(
            data_0, parameter_298, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (4x96x44x44xf32, 96xf32, 96xf32, 96xf32, 96xf32, -1xui8) <- (4x96x44x44xf32, 96xf32, 96xf32, 96xf32, 96xf32)
        (
            batch_norm__0,
            batch_norm__1,
            batch_norm__2,
        ...
        # pd_op.hardswish: (4x96x44x44xf32) <- (4x96x44x44xf32)
        hardswish_0 = paddle._C_ops.hardswish(batch_norm__0)

        # pd_op.conv2d: (4x96x22x22xf32) <- (4x88x22x22xf32, 96x88x1x1xf32)
        conv2d_1 = paddle._C_ops.conv2d(
            data_1, parameter_293, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (4x96x22x22xf32, 96xf32, 96xf32, 96xf32, 96xf32, -1xui8) <- (4x96x22x22xf32, 96xf32, 96xf32, 96xf32, 96xf32)
        (
            batch_norm__6,
            batch_norm__7,
            batch_norm__8,
        ...
        # pd_op.hardswish: (4x96x22x22xf32) <- (4x96x22x22xf32)
        hardswish_1 = paddle._C_ops.hardswish(batch_norm__6)

        # pd_op.conv2d: (4x96x11x11xf32) <- (4x176x11x11xf32, 96x176x1x1xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            data_2, parameter_288, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (4x96x11x11xf32, 96xf32, 96xf32, 96xf32, 96xf32, -1xui8) <- (4x96x11x11xf32, 96xf32, 96xf32, 96xf32, 96xf32)
        (
            batch_norm__12,
            batch_norm__13,
            batch_norm__14,
        ...
        # pd_op.hardswish: (4x96x11x11xf32) <- (4x96x11x11xf32)
        hardswish_2 = paddle._C_ops.hardswish(batch_norm__12)

        # pd_op.nearest_interp: (4x96x22x22xf32) <- (4x96x11x11xf32, None, None, None)
        ...
        # builtin.combine: ([4x96x22x22xf32, 4x96x22x22xf32]) <- (4x96x22x22xf32, 4x96x22x22xf32)
        combine_0 = [nearest_interp_0, hardswish_1]

        # pd_op.concat: (4x192x22x22xf32) <- ([4x96x22x22xf32, 4x96x22x22xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_0)

        # pd_op.depthwise_conv2d: (4x192x22x22xf32) <- (4x192x22x22xf32, 192x1x5x5xf32)
        depthwise_conv2d_0 = paddle._C_ops.depthwise_conv2d(
            concat_0, parameter_283, [1, 1], [2, 2], "EXPLICIT", 192, [1, 1], "NCHW"
        )

        # pd_op.batch_norm_: (4x192x22x22xf32, 192xf32, 192xf32, 192xf32, 192xf32, -1xui8) <- (4x192x22x22xf32, 192xf32, 192xf32, 192xf32, 192xf32)
        (
            batch_norm__18,
            batch_norm__19,
            batch_norm__20,
        ...
        # pd_op.hardswish: (4x192x22x22xf32) <- (4x192x22x22xf32)
        hardswish_3 = paddle._C_ops.hardswish(batch_norm__18)

        # pd_op.conv2d: (4x192x22x22xf32) <- (4x192x22x22xf32, 192x192x1x1xf32)
        ...
        # pd_op.conv2d: (4x96x22x22xf32) <- (4x192x22x22xf32, 96x192x1x1xf32)
        ...
        # pd_op.nearest_interp: (4x96x44x44xf32) <- (4x96x22x22xf32, None, None, None)
        ...
        # builtin.combine: ([4x96x44x44xf32, 4x96x44x44xf32]) <- (4x96x44x44xf32, 4x96x44x44xf32)
        combine_1 = [nearest_interp_1, hardswish_0]

        # pd_op.concat: (4x192x44x44xf32) <- ([4x96x44x44xf32, 4x96x44x44xf32], 1xi32)
        concat_1 = paddle._C_ops.concat(combine_1, full_0)

        # pd_op.depthwise_conv2d: (4x192x44x44xf32) <- (4x192x44x44xf32, 192x1x5x5xf32)
        depthwise_conv2d_2 = paddle._C_ops.depthwise_conv2d(
            concat_1, parameter_263, [1, 1], [2, 2], "EXPLICIT", 192, [1, 1], "NCHW"
        )

        # pd_op.batch_norm_: (4x192x44x44xf32, 192xf32, 192xf32, 192xf32, 192xf32, -1xui8) <- (4x192x44x44xf32, 192xf32, 192xf32, 192xf32, 192xf32)
        (
            batch_norm__42,
            batch_norm__43,
            batch_norm__44,
        ...
        # pd_op.hardswish: (4x192x44x44xf32) <- (4x192x44x44xf32)
        hardswish_7 = paddle._C_ops.hardswish(batch_norm__42)

        # pd_op.conv2d: (4x192x44x44xf32) <- (4x192x44x44xf32, 192x192x1x1xf32)
        ...
        # pd_op.conv2d: (4x96x44x44xf32) <- (4x192x44x44xf32, 96x192x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (4x96x22x22xf32) <- (4x96x44x44xf32, 96x1x5x5xf32)
        ...
        # pd_op.conv2d: (4x96x22x22xf32) <- (4x96x22x22xf32, 96x96x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (4x96x11x11xf32) <- (4x96x22x22xf32, 96x1x5x5xf32)
        ...
        # pd_op.conv2d: (4x96x11x11xf32) <- (4x96x11x11xf32, 96x96x1x1xf32)
        ...
        # builtin.combine: ([4x96x11x11xf32, 4x96x11x11xf32]) <- (4x96x11x11xf32, 4x96x11x11xf32)
        combine_3 = [hardswish_16, hardswish_2]

        # pd_op.concat: (4x192x11x11xf32) <- ([4x96x11x11xf32, 4x96x11x11xf32], 1xi32)
        concat_3 = paddle._C_ops.concat(combine_3, full_0)

        # pd_op.depthwise_conv2d: (4x192x11x11xf32) <- (4x192x11x11xf32, 192x1x5x5xf32)
        depthwise_conv2d_8 = paddle._C_ops.depthwise_conv2d(
            concat_3, parameter_203, [1, 1], [2, 2], "EXPLICIT", 192, [1, 1], "NCHW"
        )

        # pd_op.batch_norm_: (4x192x11x11xf32, 192xf32, 192xf32, 192xf32, 192xf32, -1xui8) <- (4x192x11x11xf32, 192xf32, 192xf32, 192xf32, 192xf32)
        (
            batch_norm__114,
            batch_norm__115,
            batch_norm__116,
        ...
        # pd_op.hardswish: (4x192x11x11xf32) <- (4x192x11x11xf32)
        hardswish_17 = paddle._C_ops.hardswish(batch_norm__114)

        # pd_op.conv2d: (4x192x11x11xf32) <- (4x192x11x11xf32, 192x192x1x1xf32)
        ...
        # pd_op.conv2d: (4x96x11x11xf32) <- (4x192x11x11xf32, 96x192x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (4x96x6x6xf32) <- (4x96x11x11xf32, 96x1x5x5xf32)
        depthwise_conv2d_10 = paddle._C_ops.depthwise_conv2d(
            hardswish_2, parameter_183, [2, 2], [2, 2], "EXPLICIT", 96, [1, 1], "NCHW"
        )

        # pd_op.batch_norm_: (4x96x6x6xf32, 96xf32, 96xf32, 96xf32, 96xf32, -1xui8) <- (4x96x6x6xf32, 96xf32, 96xf32, 96xf32, 96xf32)
        (
            batch_norm__138,
            batch_norm__139,
            batch_norm__140,
        ...
        # pd_op.hardswish: (4x96x6x6xf32) <- (4x96x6x6xf32)
        hardswish_20 = paddle._C_ops.hardswish(batch_norm__138)

        # pd_op.conv2d: (4x96x6x6xf32) <- (4x96x6x6xf32, 96x96x1x1xf32)
        ...
        # pd_op.add: (4x96x6x6xf32) <- (4x96x6x6xf32, 4x96x6x6xf32)
        add_12 = paddle._C_ops.add(hardswish_21, hardswish_23)

        # pd_op.shape64: (4xi64) <- (4x96x44x44xf32)
        ...
        # pd_op.depthwise_conv2d: (4x96x44x44xf32) <- (4x96x44x44xf32, 96x1x5x5xf32)
        ...
        # pd_op.conv2d: (4x96x44x44xf32) <- (4x96x44x44xf32, 96x96x1x1xf32)
        ...
        # pd_op.pool2d: (4x96x1x1xf32) <- (4x96x44x44xf32, 2xi64)
        ...
        # pd_op.sigmoid: (4x96x1x1xf32) <- (4x96x1x1xf32)
        sigmoid_0 = paddle._C_ops.sigmoid(add_13)

        # pd_op.multiply: (4x96x44x44xf32) <- (4x96x44x44xf32, 4x96x1x1xf32)
        ...
        # pd_op.conv2d: (4x4x44x44xf32) <- (4x96x44x44xf32, 4x96x1x1xf32)
        ...
        # pd_op.add: (4x4x44x44xf32) <- (4x4x44x44xf32, 1x4x1x1xf32)
        add_14 = paddle._C_ops.add(conv2d_19, reshape_1)

        # pd_op.conv2d: (4x32x44x44xf32) <- (4x96x44x44xf32, 32x96x1x1xf32)
        ...
        # pd_op.add: (4x32x44x44xf32) <- (4x32x44x44xf32, 1x32x1x1xf32)
        add_0 = paddle._C_ops.add(conv2d_20, reshape_2)

        # pd_op.conv2d: (4x1x44x44xf32) <- (4x96x44x44xf32, 1x96x5x5xf32)
        conv2d_21 = paddle._C_ops.conv2d(
            hardswish_27, parameter_132, [1, 1], [2, 2], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (4x1x44x44xf32, 1xf32, 1xf32, 1xf32, 1xf32, -1xui8) <- (4x1x44x44xf32, 1xf32, 1xf32, 1xf32, 1xf32)
        (
            batch_norm__192,
            batch_norm__193,
            batch_norm__194,
        ...
        # pd_op.hardswish: (4x1x44x44xf32) <- (4x1x44x44xf32)
        hardswish_29 = paddle._C_ops.hardswish(batch_norm__192)

        # pd_op.conv2d: (4x1x44x44xf32) <- (4x1x44x44xf32, 1x1x1x1xf32)
        ...
        # pd_op.sigmoid: (4x1x44x44xf32) <- (4x1x44x44xf32)
        sigmoid_1 = paddle._C_ops.sigmoid(batch_norm__326)

        # pd_op.sigmoid: (4x4x44x44xf32) <- (4x4x44x44xf32)
        sigmoid_2 = paddle._C_ops.sigmoid(add_14)

        # pd_op.multiply: (4x4x44x44xf32) <- (4x4x44x44xf32, 4x1x44x44xf32)
        ...
        # pd_op.scale: (4x4x44x44xf32) <- (4x4x44x44xf32, 1xf32)
        scale_12 = paddle._C_ops.scale(multiply_4, full_1, float("1e-09"), True)

        # pd_op.sqrt: (4x4x44x44xf32) <- (4x4x44x44xf32)
        sqrt_0 = paddle._C_ops.sqrt(scale_12)

        # pd_op.transpose: (4x44x44x4xf32) <- (4x4x44x44xf32)
        transpose_12 = paddle._C_ops.transpose(sqrt_0, [0, 2, 3, 1])

        # pd_op.transpose: (4x44x44x32xf32) <- (4x32x44x44xf32)
        ...
        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_10 = [4, 1936, 4]

        # pd_op.reshape: (4x1936x4xf32) <- (7744x4xf32, 3xi64)
        ...
        # pd_op.split_with_num: ([4x1936x2xf32, 4x1936x2xf32]) <- (4x1936x4xf32, 1xi32)
        split_with_num_0 = paddle._C_ops.split_with_num(reshape_15, 2, full_2)

        # builtin.split: (4x1936x2xf32, 4x1936x2xf32) <- ([4x1936x2xf32, 4x1936x2xf32])
        (
            split_6,
            split_0,
        ) = split_with_num_0
        ...
        # pd_op.scale: (4x1936x2xf32) <- (4x1936x2xf32, 1xf32)
        scale_1 = paddle._C_ops.scale(split_6, full_3, float("0"), True)

        # pd_op.add: (4x1936x2xf32) <- (4x1936x2xf32, 1936x2xf32)
        ...
        # builtin.combine: ([4x1936x2xf32, 4x1936x2xf32]) <- (4x1936x2xf32, 4x1936x2xf32)
        combine_6 = [add_1, add_2]

        # pd_op.concat: (4x1936x4xf32) <- ([4x1936x2xf32, 4x1936x2xf32], 1xi32)
        concat_7 = paddle._C_ops.concat(combine_6, full_4)

        # pd_op.flatten: (4x4x1936xf32) <- (4x4x44x44xf32)
        flatten_2 = paddle._C_ops.flatten(sqrt_0, 2, 3)

        # pd_op.transpose: (4x1936x4xf32) <- (4x4x1936xf32)
        transpose_1 = paddle._C_ops.transpose(flatten_2, [0, 2, 1])

        # pd_op.flatten: (4x32x1936xf32) <- (4x32x44x44xf32)
        flatten_3 = paddle._C_ops.flatten(add_0, 2, 3)

        # pd_op.transpose: (4x1936x32xf32) <- (4x32x1936xf32)
        ...
        # pd_op.scale: (4x1936x4xf32) <- (4x1936x4xf32, 1xf32)
        scale_2 = paddle._C_ops.scale(concat_7, full_5, float("0"), True)

        # pd_op.shape64: (4xi64) <- (4x96x22x22xf32)
        ...
        # pd_op.depthwise_conv2d: (4x96x22x22xf32) <- (4x96x22x22xf32, 96x1x5x5xf32)
        ...
        # pd_op.pool2d: (4x96x1x1xf32) <- (4x96x22x22xf32, 2xi64)
        ...
        # pd_op.multiply: (4x96x22x22xf32) <- (4x96x22x22xf32, 4x96x1x1xf32)
        ...
        # pd_op.conv2d: (4x4x22x22xf32) <- (4x96x22x22xf32, 4x96x1x1xf32)
        ...
        # pd_op.add: (4x4x22x22xf32) <- (4x4x22x22xf32, 1x4x1x1xf32)
        add_16 = paddle._C_ops.add(conv2d_27, reshape_4)

        # pd_op.conv2d: (4x32x22x22xf32) <- (4x96x22x22xf32, 32x96x1x1xf32)
        ...
        # pd_op.add: (4x32x22x22xf32) <- (4x32x22x22xf32, 1x32x1x1xf32)
        add_3 = paddle._C_ops.add(conv2d_28, reshape_5)

        # pd_op.conv2d: (4x1x22x22xf32) <- (4x96x22x22xf32, 1x96x5x5xf32)
        conv2d_29 = paddle._C_ops.conv2d(
            hardswish_33, parameter_91, [1, 1], [2, 2], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (4x1x22x22xf32, 1xf32, 1xf32, 1xf32, 1xf32, -1xui8) <- (4x1x22x22xf32, 1xf32, 1xf32, 1xf32, 1xf32)
        (
            batch_norm__233,
            batch_norm__234,
            batch_norm__235,
        ...
        # pd_op.hardswish: (4x1x22x22xf32) <- (4x1x22x22xf32)
        hardswish_35 = paddle._C_ops.hardswish(batch_norm__233)

        # pd_op.conv2d: (4x1x22x22xf32) <- (4x1x22x22xf32, 1x1x1x1xf32)
        ...
        # pd_op.sigmoid: (4x1x22x22xf32) <- (4x1x22x22xf32)
        sigmoid_4 = paddle._C_ops.sigmoid(batch_norm__327)

        # pd_op.sigmoid: (4x4x22x22xf32) <- (4x4x22x22xf32)
        sigmoid_5 = paddle._C_ops.sigmoid(add_16)

        # pd_op.multiply: (4x4x22x22xf32) <- (4x4x22x22xf32, 4x1x22x22xf32)
        multiply_5 = paddle._C_ops.multiply(sigmoid_5, sigmoid_4)

        # pd_op.scale: (4x4x22x22xf32) <- (4x4x22x22xf32, 1xf32)
        scale_15 = paddle._C_ops.scale(multiply_5, full_1, float("1e-09"), True)

        # pd_op.sqrt: (4x4x22x22xf32) <- (4x4x22x22xf32)
        sqrt_1 = paddle._C_ops.sqrt(scale_15)

        # pd_op.transpose: (4x22x22x4xf32) <- (4x4x22x22xf32)
        transpose_13 = paddle._C_ops.transpose(sqrt_1, [0, 2, 3, 1])

        # pd_op.transpose: (4x22x22x32xf32) <- (4x32x22x22xf32)
        ...
        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_11 = [4, 484, 4]

        # pd_op.reshape: (4x484x4xf32) <- (1936x4xf32, 3xi64)
        reshape_19 = paddle._C_ops.reshape(scale_3, full_int_array_11)

        # pd_op.split_with_num: ([4x484x2xf32, 4x484x2xf32]) <- (4x484x4xf32, 1xi32)
        split_with_num_1 = paddle._C_ops.split_with_num(reshape_19, 2, full_2)

        # builtin.split: (4x484x2xf32, 4x484x2xf32) <- ([4x484x2xf32, 4x484x2xf32])
        (
            split_9,
            split_1,
        ) = split_with_num_1

        # pd_op.scale: (4x484x2xf32) <- (4x484x2xf32, 1xf32)
        scale_4 = paddle._C_ops.scale(split_9, full_3, float("0"), True)

        # pd_op.add: (4x484x2xf32) <- (4x484x2xf32, 484x2xf32)
        add_4 = paddle._C_ops.add(scale_4, stack_1)

        # pd_op.add: (4x484x2xf32) <- (4x484x2xf32, 484x2xf32)
        add_5 = paddle._C_ops.add(split_1, stack_1)

        # builtin.combine: ([4x484x2xf32, 4x484x2xf32]) <- (4x484x2xf32, 4x484x2xf32)
        combine_9 = [add_4, add_5]

        # pd_op.concat: (4x484x4xf32) <- ([4x484x2xf32, 4x484x2xf32], 1xi32)
        concat_8 = paddle._C_ops.concat(combine_9, full_4)

        # pd_op.flatten: (4x4x484xf32) <- (4x4x22x22xf32)
        flatten_6 = paddle._C_ops.flatten(sqrt_1, 2, 3)

        # pd_op.transpose: (4x484x4xf32) <- (4x4x484xf32)
        transpose_4 = paddle._C_ops.transpose(flatten_6, [0, 2, 1])

        # pd_op.flatten: (4x32x484xf32) <- (4x32x22x22xf32)
        flatten_7 = paddle._C_ops.flatten(add_3, 2, 3)

        # pd_op.transpose: (4x484x32xf32) <- (4x32x484xf32)
        ...
        # pd_op.scale: (4x484x4xf32) <- (4x484x4xf32, 1xf32)
        scale_5 = paddle._C_ops.scale(concat_8, full_6, float("0"), True)

        # pd_op.shape64: (4xi64) <- (4x96x11x11xf32)
        ...
        # pd_op.depthwise_conv2d: (4x96x11x11xf32) <- (4x96x11x11xf32, 96x1x5x5xf32)
        ...
        # pd_op.pool2d: (4x96x1x1xf32) <- (4x96x11x11xf32, 2xi64)
        ...
        # pd_op.multiply: (4x96x11x11xf32) <- (4x96x11x11xf32, 4x96x1x1xf32)
        ...
        # pd_op.conv2d: (4x4x11x11xf32) <- (4x96x11x11xf32, 4x96x1x1xf32)
        ...
        # pd_op.add: (4x4x11x11xf32) <- (4x4x11x11xf32, 1x4x1x1xf32)
        add_18 = paddle._C_ops.add(conv2d_35, reshape_7)

        # pd_op.conv2d: (4x32x11x11xf32) <- (4x96x11x11xf32, 32x96x1x1xf32)
        ...
        # pd_op.add: (4x32x11x11xf32) <- (4x32x11x11xf32, 1x32x1x1xf32)
        add_6 = paddle._C_ops.add(conv2d_36, reshape_8)

        # pd_op.conv2d: (4x1x11x11xf32) <- (4x96x11x11xf32, 1x96x5x5xf32)
        conv2d_37 = paddle._C_ops.conv2d(
            hardswish_39, parameter_50, [1, 1], [2, 2], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (4x1x11x11xf32, 1xf32, 1xf32, 1xf32, 1xf32, -1xui8) <- (4x1x11x11xf32, 1xf32, 1xf32, 1xf32, 1xf32)
        (
            batch_norm__274,
            batch_norm__275,
            batch_norm__276,
        ...
        # pd_op.hardswish: (4x1x11x11xf32) <- (4x1x11x11xf32)
        hardswish_41 = paddle._C_ops.hardswish(batch_norm__274)

        # pd_op.conv2d: (4x1x11x11xf32) <- (4x1x11x11xf32, 1x1x1x1xf32)
        ...
        # pd_op.sigmoid: (4x1x11x11xf32) <- (4x1x11x11xf32)
        sigmoid_7 = paddle._C_ops.sigmoid(batch_norm__328)

        # pd_op.sigmoid: (4x4x11x11xf32) <- (4x4x11x11xf32)
        sigmoid_8 = paddle._C_ops.sigmoid(add_18)

        # pd_op.multiply: (4x4x11x11xf32) <- (4x4x11x11xf32, 4x1x11x11xf32)
        multiply_6 = paddle._C_ops.multiply(sigmoid_8, sigmoid_7)

        # pd_op.scale: (4x4x11x11xf32) <- (4x4x11x11xf32, 1xf32)
        scale_18 = paddle._C_ops.scale(multiply_6, full_1, float("1e-09"), True)

        # pd_op.sqrt: (4x4x11x11xf32) <- (4x4x11x11xf32)
        sqrt_2 = paddle._C_ops.sqrt(scale_18)

        # pd_op.transpose: (4x11x11x4xf32) <- (4x4x11x11xf32)
        transpose_14 = paddle._C_ops.transpose(sqrt_2, [0, 2, 3, 1])

        # pd_op.transpose: (4x11x11x32xf32) <- (4x32x11x11xf32)
        ...
        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_12 = [4, 121, 4]

        # pd_op.reshape: (4x121x4xf32) <- (484x4xf32, 3xi64)
        reshape_23 = paddle._C_ops.reshape(scale_6, full_int_array_12)

        # pd_op.split_with_num: ([4x121x2xf32, 4x121x2xf32]) <- (4x121x4xf32, 1xi32)
        split_with_num_2 = paddle._C_ops.split_with_num(reshape_23, 2, full_2)

        # builtin.split: (4x121x2xf32, 4x121x2xf32) <- ([4x121x2xf32, 4x121x2xf32])
        (
            split_12,
            split_2,
        ) = split_with_num_2

        # pd_op.scale: (4x121x2xf32) <- (4x121x2xf32, 1xf32)
        scale_7 = paddle._C_ops.scale(split_12, full_3, float("0"), True)

        # pd_op.add: (4x121x2xf32) <- (4x121x2xf32, 121x2xf32)
        add_7 = paddle._C_ops.add(scale_7, stack_2)

        # pd_op.add: (4x121x2xf32) <- (4x121x2xf32, 121x2xf32)
        add_8 = paddle._C_ops.add(split_2, stack_2)

        # builtin.combine: ([4x121x2xf32, 4x121x2xf32]) <- (4x121x2xf32, 4x121x2xf32)
        combine_12 = [add_7, add_8]

        # pd_op.concat: (4x121x4xf32) <- ([4x121x2xf32, 4x121x2xf32], 1xi32)
        concat_9 = paddle._C_ops.concat(combine_12, full_4)

        # pd_op.flatten: (4x4x121xf32) <- (4x4x11x11xf32)
        flatten_10 = paddle._C_ops.flatten(sqrt_2, 2, 3)

        # pd_op.transpose: (4x121x4xf32) <- (4x4x121xf32)
        transpose_7 = paddle._C_ops.transpose(flatten_10, [0, 2, 1])

        # pd_op.flatten: (4x32x121xf32) <- (4x32x11x11xf32)
        flatten_11 = paddle._C_ops.flatten(add_6, 2, 3)

        # pd_op.transpose: (4x121x32xf32) <- (4x32x121xf32)
        ...
        # pd_op.scale: (4x121x4xf32) <- (4x121x4xf32, 1xf32)
        scale_8 = paddle._C_ops.scale(concat_9, full_7, float("0"), True)

        # pd_op.shape64: (4xi64) <- (4x96x6x6xf32)
        ...
        # pd_op.depthwise_conv2d: (4x96x6x6xf32) <- (4x96x6x6xf32, 96x1x5x5xf32)
        ...
        # pd_op.pool2d: (4x96x1x1xf32) <- (4x96x6x6xf32, 2xi64)
        ...
        # pd_op.multiply: (4x96x6x6xf32) <- (4x96x6x6xf32, 4x96x1x1xf32)
        ...
        # pd_op.conv2d: (4x4x6x6xf32) <- (4x96x6x6xf32, 4x96x1x1xf32)
        ...
        # pd_op.add: (4x4x6x6xf32) <- (4x4x6x6xf32, 1x4x1x1xf32)
        add_20 = paddle._C_ops.add(conv2d_43, reshape_10)

        # pd_op.conv2d: (4x32x6x6xf32) <- (4x96x6x6xf32, 32x96x1x1xf32)
        ...
        # pd_op.add: (4x32x6x6xf32) <- (4x32x6x6xf32, 1x32x1x1xf32)
        add_9 = paddle._C_ops.add(conv2d_44, reshape_11)

        # pd_op.conv2d: (4x1x6x6xf32) <- (4x96x6x6xf32, 1x96x5x5xf32)
        conv2d_45 = paddle._C_ops.conv2d(
            hardswish_45, parameter_9, [1, 1], [2, 2], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (4x1x6x6xf32, 1xf32, 1xf32, 1xf32, 1xf32, -1xui8) <- (4x1x6x6xf32, 1xf32, 1xf32, 1xf32, 1xf32)
        (
            batch_norm__315,
            batch_norm__316,
            batch_norm__317,
        ...
        # pd_op.hardswish: (4x1x6x6xf32) <- (4x1x6x6xf32)
        hardswish_47 = paddle._C_ops.hardswish(batch_norm__315)

        # pd_op.conv2d: (4x1x6x6xf32) <- (4x1x6x6xf32, 1x1x1x1xf32)
        ...
        # pd_op.arange: (6xf32) <- (1xf64, 1xf64, 1xf64)
        ...
        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_13 = [4, 36, 4]

        # pd_op.reshape: (4x36x4xf32) <- (144x4xf32, 3xi64)
        reshape_27 = paddle._C_ops.reshape(scale_9, full_int_array_13)

        # pd_op.split_with_num: ([4x36x2xf32, 4x36x2xf32]) <- (4x36x4xf32, 1xi32)
        split_with_num_3 = paddle._C_ops.split_with_num(reshape_27, 2, full_2)

        # builtin.split: (4x36x2xf32, 4x36x2xf32) <- ([4x36x2xf32, 4x36x2xf32])
        (
            split_15,
            split_3,
        ) = split_with_num_3

        # pd_op.scale: (4x36x2xf32) <- (4x36x2xf32, 1xf32)
        scale_10 = paddle._C_ops.scale(split_15, full_3, float("0"), True)

        # pd_op.add: (4x36x2xf32) <- (4x36x2xf32, 36x2xf32)
        add_10 = paddle._C_ops.add(scale_10, stack_3)

        # pd_op.add: (4x36x2xf32) <- (4x36x2xf32, 36x2xf32)
        add_11 = paddle._C_ops.add(split_3, stack_3)

        # builtin.combine: ([4x36x2xf32, 4x36x2xf32]) <- (4x36x2xf32, 4x36x2xf32)
        combine_15 = [add_10, add_11]

        # pd_op.concat: (4x36x4xf32) <- ([4x36x2xf32, 4x36x2xf32], 1xi32)
        concat_10 = paddle._C_ops.concat(combine_15, full_4)

        # pd_op.flatten: (4x4x36xf32) <- (4x4x6x6xf32)
        flatten_14 = paddle._C_ops.flatten(sqrt_3, 2, 3)

        # pd_op.transpose: (4x36x4xf32) <- (4x4x36xf32)
        transpose_10 = paddle._C_ops.transpose(flatten_14, [0, 2, 1])

        # pd_op.flatten: (4x32x36xf32) <- (4x32x6x6xf32)
        flatten_15 = paddle._C_ops.flatten(add_9, 2, 3)

        # pd_op.transpose: (4x36x32xf32) <- (4x32x36xf32)
        ...
        # pd_op.scale: (4x36x4xf32) <- (4x36x4xf32, 1xf32)
        scale_11 = paddle._C_ops.scale(concat_10, full_8, float("0"), True)

        # builtin.combine: ([4x1936x4xf32, 4x484x4xf32, 4x121x4xf32, 4x36x4xf32]) <- (4x1936x4xf32, 4x484x4xf32, 4x121x4xf32, 4x36x4xf32)
        combine_16 = [transpose_1, transpose_4, transpose_7, transpose_10]

        # pd_op.concat: (4x2577x4xf32) <- ([4x1936x4xf32, 4x484x4xf32, 4x121x4xf32, 4x36x4xf32], 1xi32)
        ...
        # builtin.combine: ([4x1936x32xf32, 4x484x32xf32, 4x121x32xf32, 4x36x32xf32]) <- (4x1936x32xf32, 4x484x32xf32, 4x121x32xf32, 4x36x32xf32)
        combine_18 = [transpose_2, transpose_5, transpose_8, transpose_11]

        # pd_op.concat: (4x2577x32xf32) <- ([4x1936x32xf32, 4x484x32xf32, 4x121x32xf32, 4x36x32xf32], 1xi32)
