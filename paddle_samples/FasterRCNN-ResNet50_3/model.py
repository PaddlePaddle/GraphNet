...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (2x64x427x320xf32) <- (2x3x853x640xf32, 64x3x7x7xf32)
        conv2d_32 = paddle._C_ops.conv2d(
            data_0, parameter_214, [2, 2], [3, 3], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (2x64x427x320xf32, 64xf32, 64xf32, 64xf32, 64xf32, -1xui8) <- (2x64x427x320xf32, 64xf32, 64xf32, 64xf32, 64xf32)
        (
            batch_norm__172,
            batch_norm__173,
            batch_norm__174,
        ...
        # pd_op.relu: (2x64x427x320xf32) <- (2x64x427x320xf32)
        relu_31 = paddle._C_ops.relu(batch_norm__172)

        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_0 = [3, 3]

        # pd_op.pool2d: (2x64x214x160xf32) <- (2x64x427x320xf32, 2xi64)
        ...
        # pd_op.conv2d: (2x64x214x160xf32) <- (2x64x214x160xf32, 64x64x1x1xf32)
        conv2d_33 = paddle._C_ops.conv2d(
            pool2d_0, parameter_209, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (2x64x214x160xf32, 64xf32, 64xf32, 64xf32, 64xf32, -1xui8) <- (2x64x214x160xf32, 64xf32, 64xf32, 64xf32, 64xf32)
        (
            batch_norm__178,
            batch_norm__179,
            batch_norm__180,
        ...
        # pd_op.relu: (2x64x214x160xf32) <- (2x64x214x160xf32)
        relu_32 = paddle._C_ops.relu(batch_norm__178)

        # pd_op.conv2d: (2x64x214x160xf32) <- (2x64x214x160xf32, 64x64x3x3xf32)
        ...
        # pd_op.conv2d: (2x256x214x160xf32) <- (2x64x214x160xf32, 256x64x1x1xf32)
        conv2d_35 = paddle._C_ops.conv2d(
            relu_33, parameter_199, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (2x256x214x160xf32, 256xf32, 256xf32, 256xf32, 256xf32, -1xui8) <- (2x256x214x160xf32, 256xf32, 256xf32, 256xf32, 256xf32)
        (
            batch_norm__190,
            batch_norm__191,
            batch_norm__192,
        ...
        # pd_op.add: (2x256x214x160xf32) <- (2x256x214x160xf32, 2x256x214x160xf32)
        add_0 = paddle._C_ops.add(batch_norm__190, batch_norm__196)

        # pd_op.relu: (2x256x214x160xf32) <- (2x256x214x160xf32)
        relu_34 = paddle._C_ops.relu(add_0)

        # pd_op.conv2d: (2x64x214x160xf32) <- (2x256x214x160xf32, 64x256x1x1xf32)
        ...
        # pd_op.conv2d: (2x128x214x160xf32) <- (2x256x214x160xf32, 128x256x1x1xf32)
        conv2d_0 = paddle._C_ops.conv2d(
            relu_0, parameter_159, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (2x128x214x160xf32, 128xf32, 128xf32, 128xf32, 128xf32, -1xui8) <- (2x128x214x160xf32, 128xf32, 128xf32, 128xf32, 128xf32)
        (
            batch_norm__238,
            batch_norm__0,
            batch_norm__1,
        ...
        # pd_op.relu: (2x128x214x160xf32) <- (2x128x214x160xf32)
        relu_1 = paddle._C_ops.relu(batch_norm__238)

        # pd_op.conv2d: (2x128x107x80xf32) <- (2x128x214x160xf32, 128x128x3x3xf32)
        conv2d_1 = paddle._C_ops.conv2d(
            relu_1, parameter_154, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (2x128x107x80xf32, 128xf32, 128xf32, 128xf32, 128xf32, -1xui8) <- (2x128x107x80xf32, 128xf32, 128xf32, 128xf32, 128xf32)
        (
            batch_norm__239,
            batch_norm__5,
            batch_norm__6,
        ...
        # pd_op.relu: (2x128x107x80xf32) <- (2x128x107x80xf32)
        relu_2 = paddle._C_ops.relu(batch_norm__239)

        # pd_op.conv2d: (2x512x107x80xf32) <- (2x128x107x80xf32, 512x128x1x1xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            relu_2, parameter_149, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (2x512x107x80xf32, 512xf32, 512xf32, 512xf32, 512xf32, -1xui8) <- (2x512x107x80xf32, 512xf32, 512xf32, 512xf32, 512xf32)
        (
            batch_norm__10,
            batch_norm__11,
            batch_norm__12,
        ...
        # pd_op.conv2d: (2x512x107x80xf32) <- (2x256x214x160xf32, 512x256x1x1xf32)
        ...
        # pd_op.add: (2x512x107x80xf32) <- (2x512x107x80xf32, 2x512x107x80xf32)
        add_3 = paddle._C_ops.add(batch_norm__10, batch_norm__16)

        # pd_op.relu: (2x512x107x80xf32) <- (2x512x107x80xf32)
        relu_3 = paddle._C_ops.relu(add_3)

        # pd_op.conv2d: (2x128x107x80xf32) <- (2x512x107x80xf32, 128x512x1x1xf32)
        ...
        # pd_op.conv2d: (2x128x107x80xf32) <- (2x128x107x80xf32, 128x128x3x3xf32)
        ...
        # pd_op.conv2d: (2x256x107x80xf32) <- (2x512x107x80xf32, 256x512x1x1xf32)
        conv2d_13 = paddle._C_ops.conv2d(
            relu_12, parameter_94, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (2x256x107x80xf32, 256xf32, 256xf32, 256xf32, 256xf32, -1xui8) <- (2x256x107x80xf32, 256xf32, 256xf32, 256xf32, 256xf32)
        (
            batch_norm__246,
            batch_norm__70,
            batch_norm__71,
        ...
        # pd_op.relu: (2x256x107x80xf32) <- (2x256x107x80xf32)
        relu_13 = paddle._C_ops.relu(batch_norm__246)

        # pd_op.conv2d: (2x256x54x40xf32) <- (2x256x107x80xf32, 256x256x3x3xf32)
        conv2d_14 = paddle._C_ops.conv2d(
            relu_13, parameter_89, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (2x256x54x40xf32, 256xf32, 256xf32, 256xf32, 256xf32, -1xui8) <- (2x256x54x40xf32, 256xf32, 256xf32, 256xf32, 256xf32)
        (
            batch_norm__247,
            batch_norm__75,
            batch_norm__76,
        ...
        # pd_op.relu: (2x256x54x40xf32) <- (2x256x54x40xf32)
        relu_14 = paddle._C_ops.relu(batch_norm__247)

        # pd_op.conv2d: (2x1024x54x40xf32) <- (2x256x54x40xf32, 1024x256x1x1xf32)
        conv2d_15 = paddle._C_ops.conv2d(
            relu_14, parameter_84, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (2x1024x54x40xf32, 1024xf32, 1024xf32, 1024xf32, 1024xf32, -1xui8) <- (2x1024x54x40xf32, 1024xf32, 1024xf32, 1024xf32, 1024xf32)
        (
            batch_norm__80,
            batch_norm__81,
            batch_norm__82,
        ...
        # pd_op.conv2d: (2x1024x54x40xf32) <- (2x512x107x80xf32, 1024x512x1x1xf32)
        ...
        # pd_op.add: (2x1024x54x40xf32) <- (2x1024x54x40xf32, 2x1024x54x40xf32)
        add_7 = paddle._C_ops.add(batch_norm__80, batch_norm__86)

        # pd_op.relu: (2x1024x54x40xf32) <- (2x1024x54x40xf32)
        relu_15 = paddle._C_ops.relu(add_7)

        # pd_op.conv2d: (2x256x54x40xf32) <- (2x1024x54x40xf32, 256x1024x1x1xf32)
        ...
        # pd_op.conv2d: (2x256x54x40xf32) <- (2x256x54x40xf32, 256x256x3x3xf32)
