...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.full_like: (4x-1x256xf32) <- (4x-1x256xf32, 1xf32)
        ...
        # pd_op.add: (4x-1x256xf32) <- (4x-1x256xf32, xf32)
        add_12 = paddle._C_ops.add(full_like_6, full_like_7)

        # pd_op.add: (4x-1x256xf32) <- (4x-1x256xf32, -1x-1x1xf32)
        ...
        # pd_op.add: (4x-1x256xf32) <- (xf32, 4x-1x256xf32)
        add_2 = paddle._C_ops.add(assign_value__0, add_0)

        # pd_op.add: (4x-1x256xf32) <- (-1x-1x1xf32, 4x-1x256xf32)
        add_13 = paddle._C_ops.add(cast_11, add_0)

        # pd_op.cast: (4x-1x256xb) <- (4x-1x256xf32)
        cast_0 = paddle._C_ops.cast(add_13, paddle.bool)

        # pd_op.where: (4x-1x256xf32) <- (4x-1x256xb, 4x-1x256xf32, 4x-1x256xf32)
        ...
        # pd_op.matmul: (4x-1x4xf32) <- (4x-1x256xf32, 256x4xf32)
        matmul_1 = paddle._C_ops.matmul(layer_norm_0, parameter_7, False, False)

        # pd_op.add: (4x-1x4xf32) <- (4x-1x4xf32, 4xf32)
        ...
        # pd_op.relu: (4x-1x256xf32) <- (4x-1x256xf32)
        ...
        # pd_op.add: (4x-1x4xf32) <- (4x-1x4xf32, -1x-1x4xf32)
        add_6 = paddle._C_ops.add(add_5, where_0)

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_3 = [-1]

        # pd_op.max: (4x-1xf32) <- (4x-1x4xf32, 1xi64)
        ...
        # pd_op.topk: (4x300xf32, 4x300xi64) <- (4x-1xf32, 1xi32)
        ...
        # pd_op.gather_nd: (4x300x4xf32) <- (4x-1x4xf32, 4x300x2xi64)
        ...
        # pd_op.gather_nd: (4x300x256xf32) <- (4x-1x256xf32, 4x300x2xi64)
