...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6, data_7):
        ...
        del full_10, gather_nd_1, less_than_0
        ...
        del flatten_0, reshape_5, reshape_6
        ...
        del full_int_array_10, scatter_1
        ...
        tile_1 = paddle._C_ops.tile(unsqueeze_2, full_int_array_11)
        del full_int_array_11, unsqueeze_2

        # pd_op.reshape: (89600x4xf32) <- (4x22400x4xf32, 2xi64)
        reshape_8 = paddle._C_ops.reshape(tile_1, full_int_array_1)
        del tile_1

        # pd_op.reshape: (89600x4xf32) <- (4x22400x4xf32, 2xi64)
        reshape_9 = paddle._C_ops.reshape(reshape_4, full_int_array_1)
        del full_int_array_1, reshape_4
        ...
        del full_int_array_2, full_int_array_4, reshape_9
        ...
        del divide_1, divide_2, scale_8, scale_9
        ...
        tile_2 = paddle._C_ops.tile(not_equal_0, full_int_array_14)
        del full_int_array_14, not_equal_0

        # pd_op.cast: (4x22400x4xf32) <- (4x22400x4xb)
        cast_1 = paddle._C_ops.cast(tile_2, paddle.float32)
        ...
        del assign_0, full_0, full_17, set_value__0, sum_0, tile_2

        return greater_than_0, concat_0, reshape_0, concat_1
