...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        combine_2 = [slice_0, full_28, full_28, full_28]
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_4 = [slice_1, full_28, full_28, full_28]
        ...
        split_59 = paddle._C_ops.split(batch_norm__21, full_int_array_4, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_6 = [slice_2, full_28, full_28, full_28]
        ...
        # pd_op.split: ([-1x96x28x28xf32, -1x288x28x28xf32]) <- (-1x384x28x28xf32, 2xi64, 1xi32)
        split_60 = paddle._C_ops.split(add_3, full_int_array_4, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_8 = [slice_3, full_28, full_28, full_28]
        ...
        # pd_op.split: ([-1x96x28x28xf32, -1x288x28x28xf32]) <- (-1x384x28x28xf32, 2xi64, 1xi32)
        split_61 = paddle._C_ops.split(add_4, full_int_array_4, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_10 = [slice_4, full_28, full_28, full_28]
        ...
        # pd_op.split: ([-1x96x28x28xf32, -1x288x28x28xf32]) <- (-1x384x28x28xf32, 2xi64, 1xi32)
        split_62 = paddle._C_ops.split(add_5, full_int_array_4, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_12 = [slice_5, full_28, full_28, full_28]
        ...
        split_63 = paddle._C_ops.split(batch_norm__47, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_14 = [slice_6, full_28, full_28, full_28]
        ...
        # pd_op.split: ([-1x192x14x14xf32, -1x576x14x14xf32]) <- (-1x768x14x14xf32, 2xi64, 1xi32)
        split_64 = paddle._C_ops.split(add_7, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_16 = [slice_7, full_28, full_28, full_28]
        ...
        # pd_op.split: ([-1x192x14x14xf32, -1x576x14x14xf32]) <- (-1x768x14x14xf32, 2xi64, 1xi32)
        split_65 = paddle._C_ops.split(add_8, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_18 = [slice_8, full_28, full_28, full_28]
        ...
        # pd_op.split: ([-1x192x14x14xf32, -1x576x14x14xf32]) <- (-1x768x14x14xf32, 2xi64, 1xi32)
        split_66 = paddle._C_ops.split(add_9, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_20 = [slice_9, full_28, full_28, full_28]
        ...
        # pd_op.split: ([-1x192x14x14xf32, -1x576x14x14xf32]) <- (-1x768x14x14xf32, 2xi64, 1xi32)
        split_67 = paddle._C_ops.split(add_10, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_22 = [slice_10, full_28, full_28, full_28]
        ...
        # pd_op.split: ([-1x192x14x14xf32, -1x576x14x14xf32]) <- (-1x768x14x14xf32, 2xi64, 1xi32)
        split_68 = paddle._C_ops.split(add_11, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_24 = [slice_11, full_28, full_28, full_28]
        ...
        # pd_op.split: ([-1x192x14x14xf32, -1x576x14x14xf32]) <- (-1x768x14x14xf32, 2xi64, 1xi32)
        split_69 = paddle._C_ops.split(add_12, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_26 = [slice_12, full_28, full_28, full_28]
        ...
        # pd_op.split: ([-1x192x14x14xf32, -1x576x14x14xf32]) <- (-1x768x14x14xf32, 2xi64, 1xi32)
        split_70 = paddle._C_ops.split(add_13, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_28 = [slice_13, full_28, full_28, full_28]
        ...
        # pd_op.split: ([-1x192x14x14xf32, -1x576x14x14xf32]) <- (-1x768x14x14xf32, 2xi64, 1xi32)
        split_71 = paddle._C_ops.split(add_14, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_30 = [slice_14, full_28, full_28, full_28]
        ...
        # pd_op.split: ([-1x192x14x14xf32, -1x576x14x14xf32]) <- (-1x768x14x14xf32, 2xi64, 1xi32)
        split_72 = paddle._C_ops.split(add_15, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_32 = [slice_15, full_28, full_28, full_28]
        ...
        # pd_op.split: ([-1x192x14x14xf32, -1x576x14x14xf32]) <- (-1x768x14x14xf32, 2xi64, 1xi32)
        split_73 = paddle._C_ops.split(add_16, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_34 = [slice_16, full_28, full_28, full_28]
        ...
        # pd_op.split: ([-1x192x14x14xf32, -1x576x14x14xf32]) <- (-1x768x14x14xf32, 2xi64, 1xi32)
        split_74 = paddle._C_ops.split(add_17, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_36 = [slice_17, full_28, full_28, full_28]
        ...
        # pd_op.split: ([-1x192x14x14xf32, -1x576x14x14xf32]) <- (-1x768x14x14xf32, 2xi64, 1xi32)
        split_75 = paddle._C_ops.split(add_18, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_38 = [slice_18, full_28, full_28, full_28]
        ...
        # pd_op.split: ([-1x192x14x14xf32, -1x576x14x14xf32]) <- (-1x768x14x14xf32, 2xi64, 1xi32)
        split_76 = paddle._C_ops.split(add_19, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_40 = [slice_19, full_28, full_28, full_28]
        ...
        # pd_op.split: ([-1x192x14x14xf32, -1x576x14x14xf32]) <- (-1x768x14x14xf32, 2xi64, 1xi32)
        split_77 = paddle._C_ops.split(add_20, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_42 = [slice_20, full_28, full_28, full_28]
        ...
        # pd_op.split: ([-1x192x14x14xf32, -1x576x14x14xf32]) <- (-1x768x14x14xf32, 2xi64, 1xi32)
        split_78 = paddle._C_ops.split(add_21, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_44 = [slice_21, full_28, full_28, full_28]
        ...
        # pd_op.split: ([-1x192x14x14xf32, -1x576x14x14xf32]) <- (-1x768x14x14xf32, 2xi64, 1xi32)
        split_79 = paddle._C_ops.split(add_22, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_46 = [slice_22, full_28, full_28, full_28]
        ...
        # pd_op.split: ([-1x192x14x14xf32, -1x576x14x14xf32]) <- (-1x768x14x14xf32, 2xi64, 1xi32)
        split_80 = paddle._C_ops.split(add_23, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_48 = [slice_23, full_28, full_28, full_28]
        ...
        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_6 = [384, 1152]

        # pd_op.split: ([-1x384x7x7xf32, -1x1152x7x7xf32]) <- (-1x1536x7x7xf32, 2xi64, 1xi32)
        split_81 = paddle._C_ops.split(batch_norm__143, full_int_array_6, full_0)

        # builtin.split: (-1x384x7x7xf32, -1x1152x7x7xf32) <- ([-1x384x7x7xf32, -1x1152x7x7xf32])
        (
            split_50,
            split_51,
        ) = split_81

        # pd_op.conv2d: (-1x384x7x7xf32) <- (-1x384x7x7xf32, 384x384x3x3xf32)
        conv2d_79 = paddle._C_ops.conv2d(
            split_50, parameter_23, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # builtin.combine: ([-1x384x7x7xf32, -1x1152x7x7xf32]) <- (-1x384x7x7xf32, -1x1152x7x7xf32)
        combine_49 = [conv2d_79, split_51]

        # pd_op.concat: (-1x1536x7x7xf32) <- ([-1x384x7x7xf32, -1x1152x7x7xf32], 1xi32)
        concat_25 = paddle._C_ops.concat(combine_49, full_0)

        # pd_op.conv2d: (-1x3072x7x7xf32) <- (-1x1536x7x7xf32, 3072x1536x1x1xf32)
        conv2d_80 = paddle._C_ops.conv2d(
            concat_25, parameter_22, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (-1x3072x7x7xf32, 3072xf32, 3072xf32, 3072xf32, 3072xf32, -1xui8) <- (-1x3072x7x7xf32, 3072xf32, 3072xf32, 3072xf32, 3072xf32)
        (
            batch_norm__189,
            batch_norm__149,
            batch_norm__150,
        ...
        # pd_op.relu: (-1x3072x7x7xf32) <- (-1x3072x7x7xf32)
        relu_25 = paddle._C_ops.relu(batch_norm__189)

        # pd_op.conv2d: (-1x1536x7x7xf32) <- (-1x3072x7x7xf32, 1536x3072x1x1xf32)
        ...
        # pd_op.shape64: (4xi64) <- (-1x1536x7x7xf32)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_50 = [slice_24, full_28, full_28, full_28]
        ...
        # pd_op.divide: (-1x1536x7x7xf32) <- (-1x1536x7x7xf32, xf32)
        divide_24 = paddle._C_ops.divide(conv2d_81, full_25)

        # pd_op.multiply: (-1x1536x7x7xf32) <- (-1x1536x7x7xf32, -1x1x1x1xf32)
        ...
        # pd_op.split: ([-1x384x7x7xf32, -1x1152x7x7xf32]) <- (-1x1536x7x7xf32, 2xi64, 1xi32)
        split_82 = paddle._C_ops.split(add_25, full_int_array_6, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_52 = [slice_25, full_28, full_28, full_28]
        ...
        # pd_op.split: ([-1x384x7x7xf32, -1x1152x7x7xf32]) <- (-1x1536x7x7xf32, 2xi64, 1xi32)
        split_83 = paddle._C_ops.split(add_26, full_int_array_6, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_54 = [slice_26, full_28, full_28, full_28]
        ...
        # pd_op.conv2d: (-1x1280x1x1xf32) <- (-1x1536x1x1xf32, 1280x1536x1x1xf32)
