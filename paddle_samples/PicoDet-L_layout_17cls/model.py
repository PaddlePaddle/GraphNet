...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        ...
        gather_2 = paddle._C_ops.gather(data_1, data_2, full_7)

        # pd_op.gather: (-1x4xf32) <- (-1x4xf32, -1xi64, 1xi32)
        gather_3 = paddle._C_ops.gather(data_3, data_2, full_7)

        # pd_op.gather: (-1x32xf32) <- (-1x32xf32, -1xi64, 1xi32)
        gather_0 = paddle._C_ops.gather(data_4, data_2, full_7)

        # pd_op.gather: (-1x1xf32) <- (-1x1xf32, -1xi64, 1xi32)
        gather_4 = paddle._C_ops.gather(data_5, data_2, full_7)

        # pd_op.gather: (-1x2xf32) <- (-1x2xf32, -1xi64, 1xi32)
        gather_5 = paddle._C_ops.gather(data_6, data_2, full_7)

        # pd_op.divide: (-1x2xf32) <- (-1x2xf32, -1x1xf32)
        divide_2 = paddle._C_ops.divide(gather_5, gather_4)

        # pd_op.share_data_: (-1x11xf32) <- (-1x11xf32)
        share_data__0 = data_0.detach()

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_1 = [1]

        # pd_op.max: (-1x1xf32) <- (-1x11xf32, 1xi64)
        max_0 = paddle._C_ops.max(share_data__0, full_int_array_1, True)

        # pd_op.gather: (-1x1xf32) <- (-1x1xf32, -1xi64, 1xi32)
        gather_1 = paddle._C_ops.gather(max_0, data_2, full_7)

        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_2 = [-1, 8]

        # pd_op.reshape: (-1x8xf32) <- (-1x32xf32, 2xi64)
        ...
        slice_0 = paddle._C_ops.slice(
            divide_2, [1], full_int_array_3, full_int_array_1, [1], [1]
        )
        ...
        subtract_9 = paddle._C_ops.subtract(slice_0, slice_1)
        ...
        slice_2 = paddle._C_ops.slice(
            divide_2, [1], full_int_array_1, full_int_array_4, [1], [1]
        )
        ...
        # pd_op.subtract: (-1xf32) <- (-1xf32, -1xf32)
        subtract_10 = paddle._C_ops.subtract(slice_2, slice_3)
        ...
        # pd_op.subtract: (-1xf32) <- (-1xf32, -1xf32)
        subtract_11 = paddle._C_ops.subtract(slice_4, slice_0)
        ...
        # pd_op.subtract: (-1xf32) <- (-1xf32, -1xf32)
        subtract_12 = paddle._C_ops.subtract(slice_5, slice_2)
        ...
        clip_2 = paddle._C_ops.clip(subtract_9, full_8, full_9)

        # pd_op.clip: (-1xf32) <- (-1xf32, 1xf32, 1xf32)
        clip_3 = paddle._C_ops.clip(subtract_10, full_8, full_9)

        # pd_op.clip: (-1xf32) <- (-1xf32, 1xf32, 1xf32)
        clip_4 = paddle._C_ops.clip(subtract_11, full_8, full_9)

        # pd_op.clip: (-1xf32) <- (-1xf32, 1xf32, 1xf32)
        clip_5 = paddle._C_ops.clip(subtract_12, full_8, full_9)
        ...
        # pd_op.reshape: (-1xf32) <- (-1x4xf32, 1xi64)
        ...
        clip_0 = paddle._C_ops.clip(subtract_0, full_8, full_1)

        # pd_op.subtract: (-1x1xf32) <- (-1x1xf32, -1x1xf32)
        subtract_1 = paddle._C_ops.subtract(minimum_1, maximum_1)

        # pd_op.clip: (-1x1xf32) <- (-1x1xf32, 1xf32, 1xf32)
        clip_1 = paddle._C_ops.clip(subtract_1, full_8, full_1)
        ...
        # pd_op.subtract: (-1x1xf32) <- (-1x1xf32, -1x1xf32)
        subtract_13 = paddle._C_ops.subtract(split_6, split_4)

        # pd_op.subtract: (-1x1xf32) <- (-1x1xf32, -1x1xf32)
        subtract_14 = paddle._C_ops.subtract(split_7, split_5)

        # pd_op.multiply: (-1x1xf32) <- (-1x1xf32, -1x1xf32)
        multiply_2 = paddle._C_ops.multiply(subtract_13, subtract_14)

        # pd_op.add: (-1x1xf32) <- (-1x1xf32, -1x1xf32)
        add_0 = paddle._C_ops.add(multiply_1, multiply_2)

        # pd_op.subtract: (-1x1xf32) <- (-1x1xf32, -1x1xf32)
        subtract_15 = paddle._C_ops.subtract(add_0, multiply_0)
        ...
        scale_0 = paddle._C_ops.scale(subtract_15, full_2, float("1e-10"), True)
        ...
        # pd_op.multiply: (-1x1xf32) <- (-1x1xf32, -1x1xf32)
        multiply_7 = paddle._C_ops.multiply(subtract_4, subtract_5)

        # pd_op.scale: (-1x1xf32) <- (-1x1xf32, 1xf32)
        scale_1 = paddle._C_ops.scale(multiply_7, full_2, float("1e-10"), True)
        ...
        # pd_op.subtract: (-1x1xf32) <- (-1x1xf32, -1x1xf32)
        subtract_16 = paddle._C_ops.subtract(divide_0, divide_1)
        ...
        # pd_op.scale: (-1x1xf32) <- (-1x1xf32, 1xf32)
        scale_5 = paddle._C_ops.scale(subtract_16, full_3, float("1"), True)
        ...
        # pd_op.scale: (-1x1xf32) <- (-1x1xf32, 1xf32)
        scale_2 = paddle._C_ops.scale(scale_5, full_4, float("0"), True)
        ...
        sum_1 = paddle._C_ops.sum(multiply_3, full_int_array_0, None, False)

        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_8 = [-1, 4]

        # pd_op.expand: (-1x4xf32) <- (-1x1xf32, 2xi64)
        ...
        cast_0 = paddle._C_ops.cast(reshape_2, paddle.int64)

        # pd_op.scale: (-1xi64) <- (-1xi64, 1xf32)
        scale_6 = paddle._C_ops.scale(cast_0, full_2, float("1"), True)

        # pd_op.cast: (-1xf32) <- (-1xi64)
        cast_1 = paddle._C_ops.cast(scale_6, paddle.float32)

        # pd_op.subtract: (-1xf32) <- (-1xf32, -1xf32)
        subtract_7 = paddle._C_ops.subtract(cast_1, reshape_2)

        # pd_op.cast: (-1xf32) <- (-1xi64)
        cast_2 = paddle._C_ops.cast(cast_0, paddle.float32)

        # pd_op.subtract: (-1xf32) <- (-1xf32, -1xf32)
        subtract_8 = paddle._C_ops.subtract(reshape_2, cast_2)

        # pd_op.unsqueeze: (-1x1xi64) <- (-1xi64, 1xi64)
        unsqueeze_0 = paddle._C_ops.unsqueeze(cast_0, full_int_array_7)
        ...
        # pd_op.unsqueeze: (-1x1xi64) <- (-1xi64, 1xi64)
        unsqueeze_1 = paddle._C_ops.unsqueeze(scale_6, full_int_array_7)
        ...
        scale_3 = paddle._C_ops.scale(add_1, full_5, float("0"), True)

        # pd_op.multiply: (-1xf32) <- (-1xf32, -1xf32)
        multiply_6 = paddle._C_ops.multiply(scale_3, reshape_0)

        # pd_op.sum: (xf32) <- (-1xf32, 0xi64)
        sum_2 = paddle._C_ops.sum(multiply_6, full_int_array_0, None, False)
        ...
        scale_4 = paddle._C_ops.scale(sum_2, full_6, float("0"), True)

        # pd_op.sum: (xf32) <- (-1x11xf32, 0xi64)
        sum_0 = paddle._C_ops.sum(data_0, full_int_array_0, None, False)
        return (
            assign_0,
            assign_1,
            gather_0,
