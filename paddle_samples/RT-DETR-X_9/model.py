...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.matmul: (2x498x4xf32) <- (2x498x256xf32, 256x4xf32)
        matmul_2 = paddle._C_ops.matmul(relu_1, parameter_3, False, False)

        # pd_op.assign: (2x498x4xf32) <- (2x498x4xf32)
        assign_4 = matmul_2

        # pd_op.add: (2x498x4xf32) <- (2x498x4xf32, 4xf32)
        ...
        # pd_op.clip: (2x498x4xf32) <- (2x498x4xf32, 1xf32, 1xf32)
        ...
        # pd_op.share_data_: (2x498x4xf32) <- (2x498x4xf32)
