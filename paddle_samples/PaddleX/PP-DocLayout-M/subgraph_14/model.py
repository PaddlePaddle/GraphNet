...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        ...
        greater_than_0 = paddle._C_ops.greater_than(data_4, full_5)
        del data_4, full_5
        ...
        combine_1 = [full_4, data_1, full_7]
        ...
        # pd_op.one_hot: (1x-1x12xf32) <- (1x-1xi32, 1xi32)
        ...
        # pd_op.index_select: (1x-1x11xf32) <- (1x-1x12xf32, 11xi64)
        ...
        # pd_op.multiply: (1x-1x11xf32) <- (1x-1x11xf32, 1x-1x1xf32)
