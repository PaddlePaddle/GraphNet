...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5):
        ...
        # pd_op.unsqueeze: (2x1x12096x4xf32) <- (2x12096x4xf32, 1xi64)
        ...
        # pd_op.slice: (2x1x12096x2xf32) <- (2x1x12096x4xf32, 1xi64, 1xi64)
        ...
        # pd_op.maximum: (2x22x12096x2xf32) <- (2x22x1x2xf32, 2x1x12096x2xf32)
        maximum_0 = paddle._C_ops.maximum(slice_0, slice_2)

        # pd_op.minimum: (2x22x12096x2xf32) <- (2x22x1x2xf32, 2x1x12096x2xf32)
        minimum_0 = paddle._C_ops.minimum(slice_1, slice_3)

        # pd_op.subtract: (2x22x12096x2xf32) <- (2x22x12096x2xf32, 2x22x12096x2xf32)
        ...
        # pd_op.clip: (2x22x12096x2xf32) <- (2x22x12096x2xf32, 1xf32, 1xf32)
        clip_0 = paddle._C_ops.clip(subtract_0, full_0, full_1)

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_4 = [-1]

        # pd_op.prod: (2x22x12096xf32) <- (2x22x12096x2xf32, 1xi64)
        ...
        # pd_op.subtract: (2x1x12096x2xf32) <- (2x1x12096x2xf32, 2x1x12096x2xf32)
        subtract_2 = paddle._C_ops.subtract(slice_3, slice_2)

        # pd_op.clip: (2x1x12096x2xf32) <- (2x1x12096x2xf32, 1xf32, 1xf32)
        clip_2 = paddle._C_ops.clip(subtract_2, full_0, full_1)

        # pd_op.prod: (2x1x12096xf32) <- (2x1x12096x2xf32, 1xi64)
        prod_2 = paddle._C_ops.prod(clip_2, full_int_array_4, False, False)

        # pd_op.add: (2x22x12096xf32) <- (2x22x1xf32, 2x1x12096xf32)
        add_0 = paddle._C_ops.add(prod_1, prod_2)

        # pd_op.subtract: (2x22x12096xf32) <- (2x22x12096xf32, 2x22x12096xf32)
        ...
        # pd_op.scale: (2x22x12096xf32) <- (2x22x12096xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(subtract_3, full_2, float("1e-09"), True)

        # pd_op.divide: (2x22x12096xf32) <- (2x22x12096xf32, 2x22x12096xf32)
        divide_0 = paddle._C_ops.divide(prod_0, scale_0)

        # pd_op.transpose: (2x1x12096xf32) <- (2x12096x1xf32)
        ...
        # pd_op.split_with_num: ([1x1x12096x1xf32, 1x1x12096x1xf32]) <- (1x1x12096x2xf32, 1xi32)
        split_with_num_0 = paddle._C_ops.split_with_num(unsqueeze_3, 2, full_6)

        # builtin.split: (1x1x12096x1xf32, 1x1x12096x1xf32) <- ([1x1x12096x1xf32, 1x1x12096x1xf32])
        (
            split_0,
            split_1,
        ) = split_with_num_0
        ...
        # pd_op.subtract: (2x22x12096x1xf32) <- (1x1x12096x1xf32, 2x22x1x1xf32)
        subtract_4 = paddle._C_ops.subtract(split_0, split_2)

        # pd_op.subtract: (2x22x12096x1xf32) <- (1x1x12096x1xf32, 2x22x1x1xf32)
        subtract_5 = paddle._C_ops.subtract(split_1, split_3)

        # pd_op.subtract: (2x22x12096x1xf32) <- (2x22x1x1xf32, 1x1x12096x1xf32)
        ...
        # builtin.combine: ([2x22x12096x1xf32, 2x22x12096x1xf32, 2x22x12096x1xf32, 2x22x12096x1xf32]) <- (2x22x12096x1xf32, 2x22x12096x1xf32, 2x22x12096x1xf32, 2x22x12096x1xf32)
        combine_1 = [subtract_4, subtract_5, subtract_6, subtract_7]

        # pd_op.concat: (2x22x12096x4xf32) <- ([2x22x12096x1xf32, 2x22x12096x1xf32, 2x22x12096x1xf32, 2x22x12096x1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_1, full_7)

        # pd_op.min: (2x22x12096xf32) <- (2x22x12096x4xf32, 1xi64)
        ...
        # pd_op.greater_than: (2x22x12096xb) <- (2x22x12096xf32, xf32)
        greater_than_1 = paddle._C_ops.greater_than(min_0, full_8)

        # pd_op.cast: (2x22x12096xf32) <- (2x22x12096xb)
        ...
        # pd_op.topk: (2x22x13xf32, 2x22x13xi64) <- (2x22x12096xf32, 1xi32)
        ...
        full_10 = paddle._C_ops.full(
            [1], float("12096"), paddle.int32, paddle.core.CPUPlace()
        )

        # pd_op.one_hot: (2x22x13x12096xf32) <- (2x22x13xi64, 1xi32)
        ...
        # pd_op.sum: (2x22x12096xf32) <- (2x22x13x12096xf32, 1xi64)
        sum_1 = paddle._C_ops.sum(one_hot_0, full_int_array_7, None, False)

        # pd_op.multiply: (2x22x12096xf32) <- (2x22x12096xf32, 2x22x1xf32)
        ...
        # pd_op.sum: (2x12096xf32) <- (2x22x12096xf32, 1xi64)
        sum_0 = paddle._C_ops.sum(multiply_0, full_int_array_7, None, False)

        # pd_op.full_int_array: (0xi64) <- ()
        full_int_array_8 = []

        # pd_op.max: (xf32) <- (2x12096xf32, 0xi64)
