...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5):
        # pd_op.multiply: (8x1x6069xf32) <- (8x1x6069xf32, 8x1x6069xf32)
        multiply_1 = paddle._C_ops.multiply(data_2, data_0)

        # pd_op.flatten: (8x6069xf32) <- (8x1x6069xf32)
        ...
        # pd_op.index_sample: (8x27xf32) <- (8x6069xf32, 8x27xi64)
        ...
        # pd_op.greater_than: (8x1x6069xb) <- (8x1x6069xf32, 8x1x1xf32)
        ...
        # pd_op.full_like: (8x1x6069xf32) <- (8x1x6069xf32, 1xf32)
        full_like_0 = paddle._C_ops.full_like(
            data_0, full_2, paddle.float32, paddle.framework._current_expected_place()
        )

        # pd_op.where: (8x1x6069xf32) <- (8x1x6069xb, 8x1x6069xf32, 8x1x6069xf32)
        ...
        # pd_op.subtract: (8x1x6069x1xf32) <- (1x1x6069x1xf32, 8x1x1x1xf32)
        subtract_1 = paddle._C_ops.subtract(split_0, split_2)

        # pd_op.subtract: (8x1x6069x1xf32) <- (1x1x6069x1xf32, 8x1x1x1xf32)
        subtract_2 = paddle._C_ops.subtract(split_1, split_3)

        # pd_op.subtract: (8x1x6069x1xf32) <- (8x1x1x1xf32, 1x1x6069x1xf32)
        ...
        # builtin.combine: ([8x1x6069x1xf32, 8x1x6069x1xf32, 8x1x6069x1xf32, 8x1x6069x1xf32]) <- (8x1x6069x1xf32, 8x1x6069x1xf32, 8x1x6069x1xf32, 8x1x6069x1xf32)
        combine_0 = [subtract_1, subtract_2, subtract_3, subtract_4]

        # pd_op.concat: (8x1x6069x4xf32) <- ([8x1x6069x1xf32, 8x1x6069x1xf32, 8x1x6069x1xf32, 8x1x6069x1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_4)

        # pd_op.min: (8x1x6069xf32) <- (8x1x6069x4xf32, 1xi64)
