...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.add: (-1x64x56x56xf32) <- (-1x64x56x56xf32, -1x64x56x56xf32)
        add_3 = paddle._C_ops.add(batch_norm__54, relu_6)
        ...
        # pd_op.add: (-1x128x28x28xf32) <- (-1x128x28x28xf32, -1x128x28x28xf32)
        add_5 = paddle._C_ops.add(batch_norm__84, relu_10)
        ...
        # pd_op.add: (-1x128x28x28xf32) <- (-1x128x28x28xf32, -1x128x28x28xf32)
        add_6 = paddle._C_ops.add(batch_norm__96, relu_12)
        ...
        # pd_op.add: (-1x128x28x28xf32) <- (-1x128x28x28xf32, -1x128x28x28xf32)
        add_7 = paddle._C_ops.add(batch_norm__108, relu_14)
        ...
        # pd_op.add: (-1x256x14x14xf32) <- (-1x256x14x14xf32, -1x256x14x14xf32)
        add_10 = paddle._C_ops.add(batch_norm__150, relu_20)
        ...
        # pd_op.add: (-1x256x14x14xf32) <- (-1x256x14x14xf32, -1x256x14x14xf32)
        add_11 = paddle._C_ops.add(batch_norm__162, relu_22)
        ...
        # pd_op.add: (-1x256x14x14xf32) <- (-1x256x14x14xf32, -1x256x14x14xf32)
        add_12 = paddle._C_ops.add(batch_norm__174, relu_24)
        ...
        # pd_op.add: (-1x256x14x14xf32) <- (-1x256x14x14xf32, -1x256x14x14xf32)
        add_13 = paddle._C_ops.add(batch_norm__186, relu_26)
        ...
        add_14 = paddle._C_ops.add(batch_norm__198, batch_norm__204)
        ...
        # pd_op.add: (-1x512x7x7xf32) <- (-1x512x7x7xf32, -1x512x7x7xf32)
        add_15 = paddle._C_ops.add(batch_norm__216, relu_30)
        ...
        # pd_op.add: (-1x512x7x7xf32) <- (-1x512x7x7xf32, -1x512x7x7xf32)
        add_16 = paddle._C_ops.add(batch_norm__228, relu_32)
