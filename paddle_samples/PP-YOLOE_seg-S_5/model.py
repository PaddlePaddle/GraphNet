...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5):
        ...
        # pd_op.unsqueeze: (1x1x1x4xf32) <- (1x1x4xf32, 1xi64)
        unsqueeze_1 = paddle._C_ops.unsqueeze(data_4, full_int_array_0)

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_1 = [1]

        # pd_op.unsqueeze: (1x1x8400x4xf32) <- (1x8400x4xf32, 1xi64)
        unsqueeze_2 = paddle._C_ops.unsqueeze(data_1, full_int_array_1)

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_2 = [0]

        # pd_op.slice: (1x1x1x2xf32) <- (1x1x1x4xf32, 1xi64, 1xi64)
        ...
        # pd_op.slice: (1x1x8400x2xf32) <- (1x1x8400x4xf32, 1xi64, 1xi64)
        ...
        # pd_op.maximum: (1x1x8400x2xf32) <- (1x1x1x2xf32, 1x1x8400x2xf32)
        maximum_0 = paddle._C_ops.maximum(slice_0, slice_2)

        # pd_op.minimum: (1x1x8400x2xf32) <- (1x1x1x2xf32, 1x1x8400x2xf32)
        minimum_0 = paddle._C_ops.minimum(slice_1, slice_3)

        # pd_op.subtract: (1x1x8400x2xf32) <- (1x1x8400x2xf32, 1x1x8400x2xf32)
        ...
        # pd_op.clip: (1x1x8400x2xf32) <- (1x1x8400x2xf32, 1xf32, 1xf32)
        clip_0 = paddle._C_ops.clip(subtract_0, full_0, full_1)

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_4 = [-1]

        # pd_op.prod: (1x1x8400xf32) <- (1x1x8400x2xf32, 1xi64)
        prod_0 = paddle._C_ops.prod(clip_0, full_int_array_4, False, False)

        # pd_op.subtract: (1x1x1x2xf32) <- (1x1x1x2xf32, 1x1x1x2xf32)
        subtract_1 = paddle._C_ops.subtract(slice_1, slice_0)

        # pd_op.clip: (1x1x1x2xf32) <- (1x1x1x2xf32, 1xf32, 1xf32)
        clip_1 = paddle._C_ops.clip(subtract_1, full_0, full_1)

        # pd_op.prod: (1x1x1xf32) <- (1x1x1x2xf32, 1xi64)
        ...
        # pd_op.add: (1x1x8400xf32) <- (1x1x1xf32, 1x1x8400xf32)
        add_0 = paddle._C_ops.add(prod_1, prod_2)

        # pd_op.subtract: (1x1x8400xf32) <- (1x1x8400xf32, 1x1x8400xf32)
        ...
        # pd_op.scale: (1x1x8400xf32) <- (1x1x8400xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(subtract_3, full_2, float("1e-09"), True)

        # pd_op.divide: (1x1x8400xf32) <- (1x1x8400xf32, 1x1x8400xf32)
        divide_0 = paddle._C_ops.divide(prod_0, scale_0)

        # pd_op.transpose: (1x2x8400xf32) <- (1x8400x2xf32)
        ...
        # pd_op.squeeze: (1x1xi32) <- (1x1x1xi32, 1xi64)
        ...
        # pd_op.stack: (1x1x2xi32) <- ([1x1xi32, 1x1xi32])
        stack_0 = paddle._C_ops.stack(combine_0, -1)

        # pd_op.gather_nd: (1x1x8400xf32) <- (1x2x8400xf32, 1x1x2xi32)
        gather_nd_0 = paddle._C_ops.gather_nd(transpose_0, stack_0)

        # pd_op.pow: (1x1x8400xf32) <- (1x1x8400xf32)
        ...
        # pd_op.unsqueeze: (1x1x8400x2xf32) <- (8400x2xf32, 2xi64)
        ...
        # pd_op.split_with_num: ([1x1x8400x1xf32, 1x1x8400x1xf32]) <- (1x1x8400x2xf32, 1xi32)
        split_with_num_0 = paddle._C_ops.split_with_num(unsqueeze_3, 2, full_5)

        # builtin.split: (1x1x8400x1xf32, 1x1x8400x1xf32) <- ([1x1x8400x1xf32, 1x1x8400x1xf32])
        (
            split_0,
            split_1,
        ) = split_with_num_0

        # pd_op.split_with_num: ([1x1x1x1xf32, 1x1x1x1xf32, 1x1x1x1xf32, 1x1x1x1xf32]) <- (1x1x1x4xf32, 1xi32)
        split_with_num_1 = paddle._C_ops.split_with_num(unsqueeze_1, 4, full_5)

        # builtin.split: (1x1x1x1xf32, 1x1x1x1xf32, 1x1x1x1xf32, 1x1x1x1xf32) <- ([1x1x1x1xf32, 1x1x1x1xf32, 1x1x1x1xf32, 1x1x1x1xf32])
        (
            split_2,
            split_3,
            split_4,
        ...
        # pd_op.subtract: (1x1x8400x1xf32) <- (1x1x8400x1xf32, 1x1x1x1xf32)
        subtract_4 = paddle._C_ops.subtract(split_0, split_2)

        # pd_op.subtract: (1x1x8400x1xf32) <- (1x1x8400x1xf32, 1x1x1x1xf32)
        subtract_5 = paddle._C_ops.subtract(split_1, split_3)

        # pd_op.subtract: (1x1x8400x1xf32) <- (1x1x1x1xf32, 1x1x8400x1xf32)
        ...
        # builtin.combine: ([1x1x8400x1xf32, 1x1x8400x1xf32, 1x1x8400x1xf32, 1x1x8400x1xf32]) <- (1x1x8400x1xf32, 1x1x8400x1xf32, 1x1x8400x1xf32, 1x1x8400x1xf32)
        combine_1 = [subtract_4, subtract_5, subtract_6, subtract_7]

        # pd_op.concat: (1x1x8400x4xf32) <- ([1x1x8400x1xf32, 1x1x8400x1xf32, 1x1x8400x1xf32, 1x1x8400x1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_1, full_6)

        # pd_op.min: (1x1x8400xf32) <- (1x1x8400x4xf32, 1xi64)
        ...
        # pd_op.greater_than: (1x1x8400xb) <- (1x1x8400xf32, xf32)
        greater_than_1 = paddle._C_ops.greater_than(min_0, full_7)

        # pd_op.cast: (1x1x8400xf32) <- (1x1x8400xb)
        ...
        # pd_op.topk: (1x1x13xf32, 1x1x13xi64) <- (1x1x8400xf32, 1xi32)
        topk_0, topk_1 = (lambda x, f: f(x))(
            paddle._C_ops.topk(multiply_2, full_8, -1, True, True),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )

        # pd_op.full: (1xi32) <- ()
        full_9 = paddle._C_ops.full(
            [1], float("8400"), paddle.int32, paddle.core.CPUPlace()
        )

        # pd_op.one_hot: (1x1x13x8400xf32) <- (1x1x13xi64, 1xi32)
        one_hot_0 = paddle._C_ops.one_hot(
            topk_1 % paddle.cast(full_9, topk_1.dtype), full_9
        )

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_7 = [-2]

        # pd_op.sum: (1x1x8400xf32) <- (1x1x13x8400xf32, 1xi64)
        ...
        # pd_op.sum: (1x8400xf32) <- (1x1x8400xf32, 1xi64)
        sum_0 = paddle._C_ops.sum(multiply_0, full_int_array_7, None, False)

        # pd_op.full_int_array: (0xi64) <- ()
        full_int_array_8 = []

        # pd_op.max: (xf32) <- (1x8400xf32, 0xi64)
        ...
        greater_than_0 = paddle._C_ops.greater_than(max_0, full_10)
