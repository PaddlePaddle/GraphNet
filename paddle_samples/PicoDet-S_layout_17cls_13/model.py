...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2):
        ...
        # pd_op.scale: (500xi64) <- (500xi64, 1xf32)
        scale_2 = paddle._C_ops.scale(cast_0, full_2, float("1"), True)

        # pd_op.cast: (500xf32) <- (500xi64)
        cast_1 = paddle._C_ops.cast(scale_2, paddle.float32)

        # pd_op.subtract: (500xf32) <- (500xf32, 500xf32)
        ...
        # pd_op.unsqueeze: (500x1xi64) <- (500xi64, 1xi64)
        unsqueeze_0 = paddle._C_ops.unsqueeze(cast_0, full_int_array_1)

        # pd_op.cross_entropy_with_softmax: (500x8xf32, 500x1xf32) <- (500x8xf32, 500x1xi64)
        ...
        # pd_op.add: (500xf32) <- (500xf32, 500xf32)
        ...
        # pd_op.scale: (500xf32) <- (500xf32, 1xf32)
