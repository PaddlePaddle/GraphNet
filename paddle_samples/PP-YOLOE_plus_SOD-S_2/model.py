...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # builtin.combine: ([324x4xf32, 1296x4xf32, 5184x4xf32]) <- (324x4xf32, 1296x4xf32, 5184x4xf32)
        combine_9 = [reshape_0, reshape_1, reshape_2]

        # pd_op.concat: (6804x4xf32) <- ([324x4xf32, 1296x4xf32, 5184x4xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_9, full_12)

        # builtin.combine: ([324x2xf32, 1296x2xf32, 5184x2xf32]) <- (324x2xf32, 1296x2xf32, 5184x2xf32)
        combine_10 = [reshape_3, reshape_4, reshape_5]

        # pd_op.concat: (6804x2xf32) <- ([324x2xf32, 1296x2xf32, 5184x2xf32], 1xi32)
        concat_1 = paddle._C_ops.concat(combine_10, full_12)

        # builtin.combine: ([324x1xf32, 1296x1xf32, 5184x1xf32]) <- (324x1xf32, 1296x1xf32, 5184x1xf32)
        combine_11 = [full_5, full_8, full_11]

        # pd_op.concat: (6804x1xf32) <- ([324x1xf32, 1296x1xf32, 5184x1xf32], 1xi32)
