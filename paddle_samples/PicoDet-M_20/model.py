...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6, data_7):
        ...
        one_hot_3 = paddle._C_ops.one_hot(
            topk_7 % paddle.cast(slice_3, topk_7.dtype), slice_3
        )
        ...
        # builtin.combine: ([4x1x-1xf32, 4x1x-1xf32, 4x1x-1xf32, 4x1x-1xf32]) <- (4x1x-1xf32, 4x1x-1xf32, 4x1x-1xf32, 4x1x-1xf32)
        combine_0 = [multiply_0, multiply_1, multiply_2, multiply_3]

        # pd_op.concat: (4x1x-1xf32) <- ([4x1x-1xf32, 4x1x-1xf32, 4x1x-1xf32, 4x1x-1xf32], 1xi32)
