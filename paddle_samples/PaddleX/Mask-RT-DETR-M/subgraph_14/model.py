...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.add: (1x1156x256xf32) <- (1x1156x256xf32, 1x1156x256xf32)
        ...
        # pd_op.matmul: (1x1156x256xf32) <- (1x1156x256xf32, 256x256xf32)
        matmul_0 = paddle._C_ops.matmul(add_0, slice_0, False, False)

        # pd_op.add: (1x1156x256xf32) <- (1x1156x256xf32, 256xf32)
        add_1 = paddle._C_ops.add(matmul_0, slice_1)

        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_2 = [0, 0, 8, 32]

        # pd_op.reshape: (1x1156x8x32xf32) <- (1x1156x256xf32, 4xi64)
        reshape_0 = paddle._C_ops.reshape(add_1, full_int_array_2)

        # pd_op.transpose: (1x8x1156x32xf32) <- (1x1156x8x32xf32)
        ...
        # pd_op.matmul: (1x8x1156x1156xf32) <- (1x8x1156x32xf32, 1x8x1156x32xf32)
        ...
        # pd_op.scale: (1x8x1156x1156xf32) <- (1x8x1156x1156xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(matmul_3, full_0, float("0"), True)
        del matmul_3

        # pd_op.softmax: (1x8x1156x1156xf32) <- (1x8x1156x1156xf32)
        softmax_0 = paddle._C_ops.softmax(scale_0, -1)
        del scale_0

        # pd_op.matmul: (1x8x1156x32xf32) <- (1x8x1156x1156xf32, 1x8x1156x32xf32)
        matmul_4 = paddle._C_ops.matmul(softmax_0, transpose_2, False, False)

        # pd_op.transpose: (1x1156x8x32xf32) <- (1x8x1156x32xf32)
        ...
        # pd_op.reshape: (1x1156x256xf32) <- (1x1156x8x32xf32, 3xi64)
        ...
        # pd_op.layer_norm: (1x1156x256xf32, 1x1156xf32, 1x1156xf32) <- (1x1156x256xf32, 256xf32, 256xf32)
        ...
        # pd_op.matmul: (1x1156x1024xf32) <- (1x1156x256xf32, 256x1024xf32)
        matmul_6 = paddle._C_ops.matmul(layer_norm_1, parameter_5, False, False)
        del parameter_5

        # pd_op.add: (1x1156x1024xf32) <- (1x1156x1024xf32, 1024xf32)
        add_6 = paddle._C_ops.add(matmul_6, parameter_4)
        del parameter_4

        # pd_op.gelu: (1x1156x1024xf32) <- (1x1156x1024xf32)
        gelu_0 = paddle._C_ops.gelu(add_6, False)

        # pd_op.matmul: (1x1156x256xf32) <- (1x1156x1024xf32, 1024x256xf32)
