...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (2x128x-1x-1xf32) <- (2x320x-1x-1xf32, 128x320x1x1xf32)
        ...
        # pd_op.hardswish: (2x128x-1x-1xf32) <- (2x128x-1x-1xf32)
        hardswish_0 = paddle._C_ops.hardswish(batch_norm__0)

        # pd_op.conv2d: (2x128x-1x-1xf32) <- (2x640x-1x-1xf32, 128x640x1x1xf32)
        ...
        # pd_op.conv2d: (2x128x-1x-1xf32) <- (2x1280x-1x-1xf32, 128x1280x1x1xf32)
        ...
        # builtin.combine: ([2x128x-1x-1xf32, 2x128x-1x-1xf32]) <- (2x128x-1x-1xf32, 2x128x-1x-1xf32)
        combine_0 = [nearest_interp_0, hardswish_1]

        # pd_op.concat: (2x256x-1x-1xf32) <- ([2x128x-1x-1xf32, 2x128x-1x-1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_0)

        # pd_op.conv2d: (2x64x-1x-1xf32) <- (2x256x-1x-1xf32, 64x256x1x1xf32)
        ...
        # pd_op.hardswish: (2x64x-1x-1xf32) <- (2x64x-1x-1xf32)
        ...
        # pd_op.conv2d: (2x64x-1x-1xf32) <- (2x64x-1x-1xf32, 64x64x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (2x64x-1x-1xf32) <- (2x64x-1x-1xf32, 64x1x5x5xf32)
        ...
        # builtin.combine: ([2x64x-1x-1xf32, 2x64x-1x-1xf32]) <- (2x64x-1x-1xf32, 2x64x-1x-1xf32)
        combine_1 = [hardswish_7, hardswish_3]

        # pd_op.concat: (2x128x-1x-1xf32) <- ([2x64x-1x-1xf32, 2x64x-1x-1xf32], 1xi32)
        concat_1 = paddle._C_ops.concat(combine_1, full_0)

        # pd_op.conv2d: (2x128x-1x-1xf32) <- (2x128x-1x-1xf32, 128x128x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (2x128x-1x-1xf32) <- (2x128x-1x-1xf32, 128x1x5x5xf32)
        ...
        # pd_op.conv2d: (2x33x-1x-1xf32) <- (2x128x-1x-1xf32, 33x128x1x1xf32)
        ...
        # pd_op.add: (2x33x-1x-1xf32) <- (2x33x-1x-1xf32, 1x33x1x1xf32)
        add_1 = paddle._C_ops.add(conv2d_31, reshape_0)

        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_1 = [1, 32]

        # pd_op.split: ([2x1x-1x-1xf32, 2x32x-1x-1xf32]) <- (2x33x-1x-1xf32, 2xi64, 1xi32)
        split_8 = paddle._C_ops.split(add_1, full_int_array_1, full_0)

        # builtin.split: (2x1x-1x-1xf32, 2x32x-1x-1xf32) <- ([2x1x-1x-1xf32, 2x32x-1x-1xf32])
        (
            split_0,
            split_4,
        ) = split_8
