...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        ...
        # pd_op.argmax: (4x2577xi64) <- (4x2x2577xf32, 1xi64)
        ...
        # pd_op.gather: (10308xi32) <- (8xi32, 10308xi64, 1xi32)
        ...
        # pd_op.gather: (10308x4xf32) <- (8x4xf32, 10308xi64, 1xi32)
        ...
        # pd_op.multiply: (4x2x2577xf32) <- (4x2x2577xf32, 4x2x2577xf32)
        ...
        # pd_op.max: (4x2x1xf32) <- (4x2x2577xf32, 1xi64)
        ...
        # pd_op.scale: (4x2x1xf32) <- (4x2x1xf32, 1xf32)
        scale_1 = paddle._C_ops.scale(max_0, full_7, float("1e-09"), True)
        del full_7, max_0

        # pd_op.divide: (4x2x2577xf32) <- (4x2x2577xf32, 4x2x1xf32)
        divide_0 = paddle._C_ops.divide(multiply_1, scale_1)
        del multiply_1, scale_1

        # pd_op.multiply: (4x2x2577xf32) <- (4x2x2577xf32, 4x2x1xf32)
        ...
        # pd_op.max: (4x2577xf32) <- (4x2x2577xf32, 1xi64)
