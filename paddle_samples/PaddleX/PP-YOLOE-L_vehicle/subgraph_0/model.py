...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (2x4x-1x-1xf32) <- (2x768x-1x-1xf32, 4x768x3x3xf32)
        ...
        # pd_op.conv2d: (2x68x-1x-1xf32) <- (2x768x-1x-1xf32, 68x768x3x3xf32)
        ...
        # pd_op.conv2d: (2x4x-1x-1xf32) <- (2x384x-1x-1xf32, 4x384x3x3xf32)
        ...
        # pd_op.conv2d: (2x4x-1x-1xf32) <- (2x192x-1x-1xf32, 4x192x3x3xf32)
        ...
        # pd_op.conv2d: (2x68x-1x-1xf32) <- (2x192x-1x-1xf32, 68x192x3x3xf32)
