...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        ...
        # pd_op.unsqueeze: (16x1x-1x4xf32) <- (16x-1x4xf32, 1xi64)
        ...
        # pd_op.slice: (16x-1x1x2xf32) <- (16x-1x1x4xf32, 1xi64, 1xi64)
        ...
        # pd_op.slice: (16x1x-1x2xf32) <- (16x1x-1x4xf32, 1xi64, 1xi64)
        ...
        # pd_op.maximum: (16x-1x-1x2xf32) <- (16x-1x1x2xf32, 16x1x-1x2xf32)
        maximum_0 = paddle._C_ops.maximum(slice_0, slice_2)

        # pd_op.minimum: (16x-1x-1x2xf32) <- (16x-1x1x2xf32, 16x1x-1x2xf32)
        minimum_0 = paddle._C_ops.minimum(slice_1, slice_3)

        # pd_op.subtract: (16x-1x-1x2xf32) <- (16x-1x-1x2xf32, 16x-1x-1x2xf32)
        ...
        # pd_op.scale: (16x-1x-1xf32) <- (16x-1x-1xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(subtract_3, full_13, float("1e-09"), True)
        del full_13, subtract_3

        # pd_op.divide: (16x-1x-1xf32) <- (16x-1x-1xf32, 16x-1x-1xf32)
