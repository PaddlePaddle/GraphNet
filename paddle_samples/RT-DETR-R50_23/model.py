...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.full_like: (4x12096x256xf32) <- (4x12096x256xf32, 1xf32)
        ...
        # pd_op.add: (4x12096x256xf32) <- (4x12096x256xf32, xf32)
        add_12 = paddle._C_ops.add(full_like_6, full_like_7)

        # pd_op.add: (4x12096x256xf32) <- (4x12096x256xf32, 1x12096x1xf32)
        add_0 = paddle._C_ops.add(add_12, cast_7)

        # pd_op.add: (4x12096x256xf32) <- (4x12096x256xf32, 4x12096x256xf32)
        add_1 = paddle._C_ops.add(data_0, add_0)

        # pd_op.add: (4x12096x256xf32) <- (xf32, 4x12096x256xf32)
        add_2 = paddle._C_ops.add(assign_value__0, add_0)

        # pd_op.add: (4x12096x256xf32) <- (1x12096x1xf32, 4x12096x256xf32)
        add_13 = paddle._C_ops.add(cast_8, add_0)

        # pd_op.cast: (4x12096x256xb) <- (4x12096x256xf32)
        cast_0 = paddle._C_ops.cast(add_13, paddle.bool)

        # pd_op.where: (4x12096x256xf32) <- (4x12096x256xb, 4x12096x256xf32, 4x12096x256xf32)
        where_1 = paddle._C_ops.where(cast_0, add_1, add_2)

        # pd_op.matmul: (4x12096x256xf32) <- (4x12096x256xf32, 256x256xf32)
        matmul_0 = paddle._C_ops.matmul(where_1, parameter_11, False, False)

        # pd_op.add: (4x12096x256xf32) <- (4x12096x256xf32, 256xf32)
        add_3 = paddle._C_ops.add(matmul_0, parameter_10)

        # pd_op.layer_norm: (4x12096x256xf32, 4x12096xf32, 4x12096xf32) <- (4x12096x256xf32, 256xf32, 256xf32)
        ...
        # pd_op.matmul: (4x12096x4xf32) <- (4x12096x256xf32, 256x4xf32)
        matmul_1 = paddle._C_ops.matmul(layer_norm_0, parameter_7, False, False)

        # pd_op.add: (4x12096x4xf32) <- (4x12096x4xf32, 4xf32)
        ...
        # pd_op.relu: (4x12096x256xf32) <- (4x12096x256xf32)
        ...
        # pd_op.add: (4x12096x4xf32) <- (4x12096x4xf32, 1x12096x4xf32)
        add_6 = paddle._C_ops.add(add_5, where_0)

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_4 = [-1]

        # pd_op.max: (4x12096xf32) <- (4x12096x4xf32, 1xi64)
        ...
        # pd_op.topk: (4x300xf32, 4x300xi64) <- (4x12096xf32, 1xi32)
        ...
        # pd_op.tile: (4x300xi64) <- (4x1xi64, 2xi64)
        tile_0 = paddle._C_ops.tile(unsqueeze_3, full_int_array_5)

        # builtin.combine: ([4x300xi64, 4x300xi64]) <- (4x300xi64, 4x300xi64)
        combine_10 = [tile_0, topk_1]

        # pd_op.stack: (4x300x2xi64) <- ([4x300xi64, 4x300xi64])
        stack_0 = paddle._C_ops.stack(combine_10, -1)

        # pd_op.gather_nd: (4x300x4xf32) <- (4x12096x4xf32, 4x300x2xi64)
        gather_nd_1 = paddle._C_ops.gather_nd(add_6, stack_0)

        # pd_op.sigmoid: (4x300x4xf32) <- (4x300x4xf32)
        sigmoid_0 = paddle._C_ops.sigmoid(gather_nd_1)

        # builtin.combine: ([4x200x4xf32, 4x300x4xf32]) <- (4x200x4xf32, 4x300x4xf32)
        combine_11 = [data_2, gather_nd_1]

        # pd_op.concat: (4x500x4xf32) <- ([4x200x4xf32, 4x300x4xf32], 1xi32)
        concat_5 = paddle._C_ops.concat(combine_11, full_13)

        # pd_op.share_data_: (4x500x4xf32) <- (4x500x4xf32)
        share_data__1 = concat_5.detach()

        # pd_op.gather_nd: (4x300x4xf32) <- (4x12096x4xf32, 4x300x2xi64)
        gather_nd_0 = paddle._C_ops.gather_nd(add_4, stack_0)

        # pd_op.gather_nd: (4x300x256xf32) <- (4x12096x256xf32, 4x300x2xi64)
        gather_nd_2 = paddle._C_ops.gather_nd(layer_norm_0, stack_0)

        # pd_op.share_data_: (4x300x256xf32) <- (4x300x256xf32)
        share_data__0 = gather_nd_2.detach()

        # builtin.combine: ([4x200x256xf32, 4x300x256xf32]) <- (4x200x256xf32, 4x300x256xf32)
        combine_12 = [data_1, share_data__0]

        # pd_op.concat: (4x500x256xf32) <- ([4x200x256xf32, 4x300x256xf32], 1xi32)
