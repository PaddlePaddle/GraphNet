...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3):
        ...
        # pd_op.slice: (5376xf32) <- (5376x4xf32, 1xi64, 1xi64)
        slice_1 = paddle._C_ops.slice(
            data_1, [1], full_int_array_0, full_int_array_1, [1], [1]
        )

        # pd_op.unsqueeze: (5376x1xf32) <- (5376xf32, 1xi64)
        unsqueeze_0 = paddle._C_ops.unsqueeze(slice_1, full_int_array_1)

        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_2 = [1, 6]

        # pd_op.tile: (5376x6xf32) <- (5376x1xf32, 2xi64)
        ...
        # pd_op.subtract: (5376x6xf32) <- (5376x6xf32, 6xf32)
        ...
        # pd_op.subtract: (5376x6xf32) <- (6xf32, 5376x6xf32)
        ...
        # builtin.combine: ([5376x6xf32, 5376x6xf32, 5376x6xf32, 5376x6xf32]) <- (5376x6xf32, 5376x6xf32, 5376x6xf32, 5376x6xf32)
        combine_0 = [subtract_0, subtract_1, subtract_2, subtract_3]

        # pd_op.stack: (5376x4x6xf32) <- ([5376x6xf32, 5376x6xf32, 5376x6xf32, 5376x6xf32])
        stack_0 = paddle._C_ops.stack(combine_0, 1)

        # pd_op.min: (5376x6xf32) <- (5376x4x6xf32, 1xi64)
        ...
        # pd_op.greater_than: (5376x6xb) <- (5376x6xf32, xf32)
        greater_than_0 = paddle._C_ops.greater_than(min_0, full_0)

        # pd_op.sum: (5376xi64) <- (5376x6xb, 1xi64)
        ...
        # pd_op.greater_than: (5376xb) <- (5376xi64, xi64)
        ...
        # pd_op.scale: (5376x6xf32) <- (5376x6xf32, 1xf32)
        ...
        # pd_op.add: (5376x6xf32) <- (6xf32, 5376x6xf32)
        add_2 = paddle._C_ops.add(scale_0, scale_2)

        # pd_op.add: (5376x6xf32) <- (6xf32, 5376x6xf32)
        add_3 = paddle._C_ops.add(scale_1, scale_3)

        # pd_op.subtract: (5376x6xf32) <- (5376x6xf32, 5376x6xf32)
        ...
        # pd_op.cast: (5376x6xi64) <- (5376x6xb)
        ...
        # pd_op.gather: (-1x6xi64) <- (5376x6xi64, -1xi64, 1xi32)
        gather_0 = paddle._C_ops.gather(cast_0, squeeze_0, full_4)

        # pd_op.cast: (-1x6xb) <- (-1x6xi64)
        ...
        # pd_op.logical_and: (-1x6xb) <- (-1x6xb, -1x6xb)
        ...
        # pd_op.gather_nd: (-1x4xf32) <- (5376x4xf32, -1x1xi64)
