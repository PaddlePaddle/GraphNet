...
class Program_weight_tensor_data_3:
    name = "data_3"
    shape = [6, 1, 100, 136, 136]
    dtype = "float32"
    min_val = float("-1437.12")
    max_val = float("16.7124")
    mean = float("-12.8371")
    std = float("22.2819")
    data = None
...
class Program_weight_tensor_data_4:
    ...
    shape = [1, 4]
    dtype = "float32"
    data = [0.494674, 0.791309, 0.196934, 0.299688]
...
class Program_weight_tensor_data_5:
    ...
    shape = [1, 100, 2]
    dtype = "float32"
    min_val = float("-6.38106")
    max_val = float("-3.47107")
    mean = float("-4.92606")
    std = float("1.45499")
    data = None
...
class Program_weight_tensor_data_10:
    ...
    shape = [1, 100, 4]
    dtype = "float32"
    min_val = float("0.00117449")
    max_val = float("0.936057")
    mean = float("0.44552")
    std = float("0.249341")
    data = None
