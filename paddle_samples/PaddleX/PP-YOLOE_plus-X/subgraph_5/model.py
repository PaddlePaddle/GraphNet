...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.pool2d: (4x960x1x1xf32) <- (4x960x-1x-1xf32, 2xi64)
        ...
        # pd_op.multiply: (4x960x-1x-1xf32) <- (4x960x-1x-1xf32, 4x960x1x1xf32)
        multiply_0 = paddle._C_ops.multiply(data_6, sigmoid_0)

        # pd_op.conv2d: (4x960x-1x-1xf32) <- (4x960x-1x-1xf32, 960x960x1x1xf32)
        conv2d_1 = paddle._C_ops.conv2d(
            multiply_0, parameter_51, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_51

        # pd_op.batch_norm_: (4x960x-1x-1xf32, 960xf32, 960xf32, 960xf32, 960xf32, -1xui8) <- (4x960x-1x-1xf32, 960xf32, 960xf32, 960xf32, 960xf32)
        (
            batch_norm__0,
            batch_norm__1,
            batch_norm__2,
        ...
        # pd_op.swish: (4x960x-1x-1xf32) <- (4x960x-1x-1xf32)
        swish_0 = paddle._C_ops.swish(batch_norm__0)

        # pd_op.add: (4x960x-1x-1xf32) <- (4x960x-1x-1xf32, 4x960x-1x-1xf32)
        add_1 = paddle._C_ops.add(swish_0, data_6)

        # pd_op.conv2d: (4x4x-1x-1xf32) <- (4x960x-1x-1xf32, 4x960x3x3xf32)
        ...
        # pd_op.conv2d: (4x68x-1x-1xf32) <- (4x960x-1x-1xf32, 68x960x3x3xf32)
        ...
        # pd_op.add: (4x68x-1x-1xf32) <- (4x68x-1x-1xf32, 1x68x1x1xf32)
        ...
        # pd_op.flatten: (4x68x-1xf32) <- (4x68x-1x-1xf32)
        flatten_1 = paddle._C_ops.flatten(add_4, 2, 3)

        # pd_op.transpose: (4x-1x68xf32) <- (4x68x-1xf32)
        transpose_1 = paddle._C_ops.transpose(flatten_1, [0, 2, 1])
        del flatten_1

        # pd_op.pool2d: (4x480x1x1xf32) <- (4x480x-1x-1xf32, 2xi64)
        ...
        # pd_op.multiply: (4x480x-1x-1xf32) <- (4x480x-1x-1xf32, 4x480x1x1xf32)
        multiply_2 = paddle._C_ops.multiply(data_7, sigmoid_3)

        # pd_op.conv2d: (4x480x-1x-1xf32) <- (4x480x-1x-1xf32, 480x480x1x1xf32)
        conv2d_7 = paddle._C_ops.conv2d(
            multiply_2, parameter_33, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_33

        # pd_op.batch_norm_: (4x480x-1x-1xf32, 480xf32, 480xf32, 480xf32, 480xf32, -1xui8) <- (4x480x-1x-1xf32, 480xf32, 480xf32, 480xf32, 480xf32)
        (
            batch_norm__12,
            batch_norm__13,
            batch_norm__14,
        ...
        # pd_op.swish: (4x480x-1x-1xf32) <- (4x480x-1x-1xf32)
        swish_2 = paddle._C_ops.swish(batch_norm__12)

        # pd_op.add: (4x480x-1x-1xf32) <- (4x480x-1x-1xf32, 4x480x-1x-1xf32)
        add_6 = paddle._C_ops.add(swish_2, data_7)

        # pd_op.conv2d: (4x4x-1x-1xf32) <- (4x480x-1x-1xf32, 4x480x3x3xf32)
        ...
        # pd_op.conv2d: (4x68x-1x-1xf32) <- (4x480x-1x-1xf32, 68x480x3x3xf32)
        ...
        # pd_op.pool2d: (4x240x1x1xf32) <- (4x240x-1x-1xf32, 2xi64)
        ...
        # pd_op.multiply: (4x240x-1x-1xf32) <- (4x240x-1x-1xf32, 4x240x1x1xf32)
        multiply_4 = paddle._C_ops.multiply(data_8, sigmoid_6)

        # pd_op.conv2d: (4x240x-1x-1xf32) <- (4x240x-1x-1xf32, 240x240x1x1xf32)
        conv2d_13 = paddle._C_ops.conv2d(
            multiply_4, parameter_15, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_15

        # pd_op.batch_norm_: (4x240x-1x-1xf32, 240xf32, 240xf32, 240xf32, 240xf32, -1xui8) <- (4x240x-1x-1xf32, 240xf32, 240xf32, 240xf32, 240xf32)
        (
            batch_norm__24,
            batch_norm__25,
            batch_norm__26,
        ...
        # pd_op.swish: (4x240x-1x-1xf32) <- (4x240x-1x-1xf32)
        swish_4 = paddle._C_ops.swish(batch_norm__24)

        # pd_op.add: (4x240x-1x-1xf32) <- (4x240x-1x-1xf32, 4x240x-1x-1xf32)
        add_11 = paddle._C_ops.add(swish_4, data_8)

        # pd_op.conv2d: (4x4x-1x-1xf32) <- (4x240x-1x-1xf32, 4x240x3x3xf32)
        ...
        # pd_op.conv2d: (4x68x-1x-1xf32) <- (4x240x-1x-1xf32, 68x240x3x3xf32)
        ...
        # builtin.combine: ([4x-1x4xf32, 4x-1x4xf32, 4x-1x4xf32]) <- (4x-1x4xf32, 4x-1x4xf32, 4x-1x4xf32)
        combine_15 = [transpose_0, transpose_2, transpose_4]

        # pd_op.concat: (4x-1x4xf32) <- ([4x-1x4xf32, 4x-1x4xf32, 4x-1x4xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_15, full_8)
        del combine_15

        # builtin.combine: ([4x-1x68xf32, 4x-1x68xf32, 4x-1x68xf32]) <- (4x-1x68xf32, 4x-1x68xf32, 4x-1x68xf32)
        combine_16 = [transpose_1, transpose_3, transpose_5]

        # pd_op.concat: (4x-1x68xf32) <- ([4x-1x68xf32, 4x-1x68xf32, 4x-1x68xf32], 1xi32)
