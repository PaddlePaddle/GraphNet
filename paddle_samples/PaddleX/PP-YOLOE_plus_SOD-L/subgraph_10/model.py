...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3):
        ...
        # pd_op.split_with_num: ([1x8400x2xf32, 1x8400x2xf32]) <- (1x8400x4xf32, 1xi32)
        split_with_num_0 = paddle._C_ops.split_with_num(data_0, 2, full_0)
        del data_0, full_0

        # builtin.split: (1x8400x2xf32, 1x8400x2xf32) <- ([1x8400x2xf32, 1x8400x2xf32])
        (
            split_0,
            split_1,
        ) = split_with_num_0
        ...
        # pd_op.add: (1x8400x2xf32) <- (1x8400x2xf32, 8400x2xf32)
        ...
        # pd_op.divide: (1x8400x4xf32) <- (1x8400x4xf32, 1x1x4xf32)
