...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        conv2d_0 = paddle._C_ops.conv2d(
            data_0, parameter_872, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        relu_0 = paddle._C_ops.relu(batch_norm__927)

        # pd_op.conv2d: (-1x24x112x112xf32) <- (-1x48x112x112xf32, 24x48x2x2xf32)
        conv2d_1 = paddle._C_ops.conv2d(
            relu_0, parameter_867, [1, 1], [0, 0], "SAME", [1, 1], 1, "NCHW"
        )
        ...
        relu_1 = paddle._C_ops.relu(batch_norm__928)

        # pd_op.conv2d: (-1x48x112x112xf32) <- (-1x24x112x112xf32, 48x24x2x2xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            relu_1, parameter_862, [1, 1], [0, 0], "SAME", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x48x112x112xf32) <- (-1x48x112x112xf32)
        relu_2 = paddle._C_ops.relu(batch_norm__929)
        ...
        conv2d_3 = paddle._C_ops.conv2d(
            concat_0, parameter_857, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        relu_3 = paddle._C_ops.relu(batch_norm__930)

        # pd_op.conv2d: (-1x96x56x56xf32) <- (-1x48x56x56xf32, 96x48x1x1xf32)
        conv2d_4 = paddle._C_ops.conv2d(
            relu_3, parameter_852, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        relu_4 = paddle._C_ops.relu(batch_norm__931)

        # pd_op.conv2d: (-1x96x56x56xf32) <- (-1x96x56x56xf32, 96x96x3x3xf32)
        conv2d_5 = paddle._C_ops.conv2d(
            relu_4, parameter_847, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x96x56x56xf32) <- (-1x96x56x56xf32)
        relu_5 = paddle._C_ops.relu(batch_norm__932)

        # pd_op.conv2d: (-1x96x56x56xf32) <- (-1x96x56x56xf32, 96x96x3x3xf32)
        conv2d_6 = paddle._C_ops.conv2d(
            relu_5, parameter_842, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x96x56x56xf32) <- (-1x96x56x56xf32)
        relu_6 = paddle._C_ops.relu(batch_norm__933)

        # pd_op.conv2d: (-1x96x56x56xf32) <- (-1x96x56x56xf32, 96x96x3x3xf32)
        conv2d_7 = paddle._C_ops.conv2d(
            relu_6, parameter_837, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x96x56x56xf32) <- (-1x96x56x56xf32)
        relu_7 = paddle._C_ops.relu(batch_norm__934)

        # pd_op.conv2d: (-1x96x56x56xf32) <- (-1x96x56x56xf32, 96x96x3x3xf32)
        conv2d_8 = paddle._C_ops.conv2d(
            relu_7, parameter_832, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x96x56x56xf32) <- (-1x96x56x56xf32)
        relu_8 = paddle._C_ops.relu(batch_norm__935)

        # pd_op.conv2d: (-1x96x56x56xf32) <- (-1x96x56x56xf32, 96x96x3x3xf32)
        conv2d_9 = paddle._C_ops.conv2d(
            relu_8, parameter_827, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x96x56x56xf32) <- (-1x96x56x56xf32)
        relu_9 = paddle._C_ops.relu(batch_norm__936)

        # pd_op.conv2d: (-1x96x56x56xf32) <- (-1x96x56x56xf32, 96x96x3x3xf32)
        conv2d_10 = paddle._C_ops.conv2d(
            relu_9, parameter_822, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x96x56x56xf32) <- (-1x96x56x56xf32)
        relu_10 = paddle._C_ops.relu(batch_norm__937)
        ...
        conv2d_11 = paddle._C_ops.conv2d(
            concat_1, parameter_817, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x96x56x56xf32) <- (-1x96x56x56xf32)
        relu_11 = paddle._C_ops.relu(batch_norm__938)

        # pd_op.conv2d: (-1x192x56x56xf32) <- (-1x96x56x56xf32, 192x96x1x1xf32)
        conv2d_12 = paddle._C_ops.conv2d(
            relu_11, parameter_812, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        relu_12 = paddle._C_ops.relu(batch_norm__939)

        # pd_op.conv2d: (-1x96x56x56xf32) <- (-1x192x56x56xf32, 96x192x3x3xf32)
        conv2d_13 = paddle._C_ops.conv2d(
            relu_12, parameter_807, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x96x56x56xf32) <- (-1x96x56x56xf32)
        relu_13 = paddle._C_ops.relu(batch_norm__940)

        # pd_op.conv2d: (-1x96x56x56xf32) <- (-1x96x56x56xf32, 96x96x3x3xf32)
        conv2d_14 = paddle._C_ops.conv2d(
            relu_13, parameter_802, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x96x56x56xf32) <- (-1x96x56x56xf32)
        relu_14 = paddle._C_ops.relu(batch_norm__941)

        # pd_op.conv2d: (-1x96x56x56xf32) <- (-1x96x56x56xf32, 96x96x3x3xf32)
        conv2d_15 = paddle._C_ops.conv2d(
            relu_14, parameter_797, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x96x56x56xf32) <- (-1x96x56x56xf32)
        relu_15 = paddle._C_ops.relu(batch_norm__942)

        # pd_op.conv2d: (-1x96x56x56xf32) <- (-1x96x56x56xf32, 96x96x3x3xf32)
        conv2d_16 = paddle._C_ops.conv2d(
            relu_15, parameter_792, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x96x56x56xf32) <- (-1x96x56x56xf32)
        relu_16 = paddle._C_ops.relu(batch_norm__943)

        # pd_op.conv2d: (-1x96x56x56xf32) <- (-1x96x56x56xf32, 96x96x3x3xf32)
        conv2d_17 = paddle._C_ops.conv2d(
            relu_16, parameter_787, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x96x56x56xf32) <- (-1x96x56x56xf32)
        relu_17 = paddle._C_ops.relu(batch_norm__944)

        # pd_op.conv2d: (-1x96x56x56xf32) <- (-1x96x56x56xf32, 96x96x3x3xf32)
        conv2d_18 = paddle._C_ops.conv2d(
            relu_17, parameter_782, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x96x56x56xf32) <- (-1x96x56x56xf32)
        relu_18 = paddle._C_ops.relu(batch_norm__945)
        ...
        combine_2 = [relu_12, relu_13, relu_14, relu_15, relu_16, relu_17, relu_18]
        ...
        conv2d_19 = paddle._C_ops.conv2d(
            concat_2, parameter_777, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x96x56x56xf32) <- (-1x96x56x56xf32)
        relu_19 = paddle._C_ops.relu(batch_norm__946)

        # pd_op.conv2d: (-1x192x56x56xf32) <- (-1x96x56x56xf32, 192x96x1x1xf32)
        conv2d_20 = paddle._C_ops.conv2d(
            relu_19, parameter_772, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        relu_21 = paddle._C_ops.relu(batch_norm__948)

        # pd_op.conv2d: (-1x192x28x28xf32) <- (-1x192x28x28xf32, 192x192x3x3xf32)
        conv2d_22 = paddle._C_ops.conv2d(
            relu_21, parameter_757, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x192x28x28xf32) <- (-1x192x28x28xf32)
        relu_22 = paddle._C_ops.relu(batch_norm__949)

        # pd_op.conv2d: (-1x192x28x28xf32) <- (-1x192x28x28xf32, 192x192x3x3xf32)
        conv2d_23 = paddle._C_ops.conv2d(
            relu_22, parameter_752, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x192x28x28xf32) <- (-1x192x28x28xf32)
        relu_23 = paddle._C_ops.relu(batch_norm__950)

        # pd_op.conv2d: (-1x192x28x28xf32) <- (-1x192x28x28xf32, 192x192x3x3xf32)
        conv2d_24 = paddle._C_ops.conv2d(
            relu_23, parameter_747, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x192x28x28xf32) <- (-1x192x28x28xf32)
        relu_24 = paddle._C_ops.relu(batch_norm__951)

        # pd_op.conv2d: (-1x192x28x28xf32) <- (-1x192x28x28xf32, 192x192x3x3xf32)
        conv2d_25 = paddle._C_ops.conv2d(
            relu_24, parameter_742, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x192x28x28xf32) <- (-1x192x28x28xf32)
        relu_25 = paddle._C_ops.relu(batch_norm__952)

        # pd_op.conv2d: (-1x192x28x28xf32) <- (-1x192x28x28xf32, 192x192x3x3xf32)
        conv2d_26 = paddle._C_ops.conv2d(
            relu_25, parameter_737, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x192x28x28xf32) <- (-1x192x28x28xf32)
        relu_26 = paddle._C_ops.relu(batch_norm__953)
        ...
        conv2d_27 = paddle._C_ops.conv2d(
            concat_3, parameter_732, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        relu_27 = paddle._C_ops.relu(batch_norm__954)

        # pd_op.conv2d: (-1x512x28x28xf32) <- (-1x256x28x28xf32, 512x256x1x1xf32)
        conv2d_28 = paddle._C_ops.conv2d(
            relu_27, parameter_727, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        relu_28 = paddle._C_ops.relu(batch_norm__955)

        # pd_op.conv2d: (-1x192x28x28xf32) <- (-1x512x28x28xf32, 192x512x3x3xf32)
        conv2d_29 = paddle._C_ops.conv2d(
            relu_28, parameter_722, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x192x28x28xf32) <- (-1x192x28x28xf32)
        relu_29 = paddle._C_ops.relu(batch_norm__956)

        # pd_op.conv2d: (-1x192x28x28xf32) <- (-1x192x28x28xf32, 192x192x3x3xf32)
        conv2d_30 = paddle._C_ops.conv2d(
            relu_29, parameter_717, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x192x28x28xf32) <- (-1x192x28x28xf32)
        relu_30 = paddle._C_ops.relu(batch_norm__957)

        # pd_op.conv2d: (-1x192x28x28xf32) <- (-1x192x28x28xf32, 192x192x3x3xf32)
        conv2d_31 = paddle._C_ops.conv2d(
            relu_30, parameter_712, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x192x28x28xf32) <- (-1x192x28x28xf32)
        relu_31 = paddle._C_ops.relu(batch_norm__958)

        # pd_op.conv2d: (-1x192x28x28xf32) <- (-1x192x28x28xf32, 192x192x3x3xf32)
        conv2d_32 = paddle._C_ops.conv2d(
            relu_31, parameter_707, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x192x28x28xf32) <- (-1x192x28x28xf32)
        relu_32 = paddle._C_ops.relu(batch_norm__959)

        # pd_op.conv2d: (-1x192x28x28xf32) <- (-1x192x28x28xf32, 192x192x3x3xf32)
        conv2d_33 = paddle._C_ops.conv2d(
            relu_32, parameter_702, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x192x28x28xf32) <- (-1x192x28x28xf32)
        relu_33 = paddle._C_ops.relu(batch_norm__960)

        # pd_op.conv2d: (-1x192x28x28xf32) <- (-1x192x28x28xf32, 192x192x3x3xf32)
        conv2d_34 = paddle._C_ops.conv2d(
            relu_33, parameter_697, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x192x28x28xf32) <- (-1x192x28x28xf32)
        relu_34 = paddle._C_ops.relu(batch_norm__961)
        ...
        combine_4 = [relu_28, relu_29, relu_30, relu_31, relu_32, relu_33, relu_34]
        ...
        conv2d_35 = paddle._C_ops.conv2d(
            concat_4, parameter_692, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x256x28x28xf32) <- (-1x256x28x28xf32)
        relu_35 = paddle._C_ops.relu(batch_norm__962)

        # pd_op.conv2d: (-1x512x28x28xf32) <- (-1x256x28x28xf32, 512x256x1x1xf32)
        conv2d_36 = paddle._C_ops.conv2d(
            relu_35, parameter_687, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x512x28x28xf32) <- (-1x512x28x28xf32)
        relu_36 = paddle._C_ops.relu(batch_norm__963)

        # pd_op.add: (-1x512x28x28xf32) <- (-1x512x28x28xf32, -1x512x28x28xf32)
        add_1 = paddle._C_ops.add(relu_36, relu_28)

        # pd_op.conv2d: (-1x192x28x28xf32) <- (-1x512x28x28xf32, 192x512x3x3xf32)
        conv2d_37 = paddle._C_ops.conv2d(
            add_1, parameter_682, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x192x28x28xf32) <- (-1x192x28x28xf32)
        relu_37 = paddle._C_ops.relu(batch_norm__964)

        # pd_op.conv2d: (-1x192x28x28xf32) <- (-1x192x28x28xf32, 192x192x3x3xf32)
        conv2d_38 = paddle._C_ops.conv2d(
            relu_37, parameter_677, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x192x28x28xf32) <- (-1x192x28x28xf32)
        relu_38 = paddle._C_ops.relu(batch_norm__965)

        # pd_op.conv2d: (-1x192x28x28xf32) <- (-1x192x28x28xf32, 192x192x3x3xf32)
        conv2d_39 = paddle._C_ops.conv2d(
            relu_38, parameter_672, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x192x28x28xf32) <- (-1x192x28x28xf32)
        relu_39 = paddle._C_ops.relu(batch_norm__966)

        # pd_op.conv2d: (-1x192x28x28xf32) <- (-1x192x28x28xf32, 192x192x3x3xf32)
        conv2d_40 = paddle._C_ops.conv2d(
            relu_39, parameter_667, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x192x28x28xf32) <- (-1x192x28x28xf32)
        relu_40 = paddle._C_ops.relu(batch_norm__967)

        # pd_op.conv2d: (-1x192x28x28xf32) <- (-1x192x28x28xf32, 192x192x3x3xf32)
        conv2d_41 = paddle._C_ops.conv2d(
            relu_40, parameter_662, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x192x28x28xf32) <- (-1x192x28x28xf32)
        relu_41 = paddle._C_ops.relu(batch_norm__968)

        # pd_op.conv2d: (-1x192x28x28xf32) <- (-1x192x28x28xf32, 192x192x3x3xf32)
        conv2d_42 = paddle._C_ops.conv2d(
            relu_41, parameter_657, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x192x28x28xf32) <- (-1x192x28x28xf32)
        relu_42 = paddle._C_ops.relu(batch_norm__969)

        # builtin.combine: ([-1x512x28x28xf32, -1x192x28x28xf32, -1x192x28x28xf32, -1x192x28x28xf32, -1x192x28x28xf32, -1x192x28x28xf32, -1x192x28x28xf32]) <- (-1x512x28x28xf32, -1x192x28x28xf32, -1x192x28x28xf32, -1x192x28x28xf32, -1x192x28x28xf32, -1x192x28x28xf32, -1x192x28x28xf32)
        combine_5 = [add_1, relu_37, relu_38, relu_39, relu_40, relu_41, relu_42]
        ...
        conv2d_43 = paddle._C_ops.conv2d(
            concat_5, parameter_652, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x256x28x28xf32) <- (-1x256x28x28xf32)
        relu_43 = paddle._C_ops.relu(batch_norm__970)

        # pd_op.conv2d: (-1x512x28x28xf32) <- (-1x256x28x28xf32, 512x256x1x1xf32)
        conv2d_44 = paddle._C_ops.conv2d(
            relu_43, parameter_647, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x512x28x28xf32) <- (-1x512x28x28xf32)
        relu_44 = paddle._C_ops.relu(batch_norm__971)

        # pd_op.add: (-1x512x28x28xf32) <- (-1x512x28x28xf32, -1x512x28x28xf32)
        add_2 = paddle._C_ops.add(relu_44, add_1)

        # pd_op.depthwise_conv2d: (-1x512x14x14xf32) <- (-1x512x28x28xf32, 512x1x3x3xf32)
        depthwise_conv2d_1 = paddle._C_ops.depthwise_conv2d(
            add_2, parameter_642, [2, 2], [1, 1], "EXPLICIT", 512, [1, 1], "NCHW"
        )
        ...
        relu_45 = paddle._C_ops.relu(batch_norm__972)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_46 = paddle._C_ops.conv2d(
            relu_45, parameter_627, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_46 = paddle._C_ops.relu(batch_norm__973)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_47 = paddle._C_ops.conv2d(
            relu_46, parameter_617, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_47 = paddle._C_ops.relu(batch_norm__974)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_48 = paddle._C_ops.conv2d(
            relu_47, parameter_607, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_48 = paddle._C_ops.relu(batch_norm__975)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_49 = paddle._C_ops.conv2d(
            relu_48, parameter_597, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_49 = paddle._C_ops.relu(batch_norm__976)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_50 = paddle._C_ops.conv2d(
            relu_49, parameter_587, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_50 = paddle._C_ops.relu(batch_norm__977)
        ...
        conv2d_51 = paddle._C_ops.conv2d(
            concat_6, parameter_577, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_53 = paddle._C_ops.relu(batch_norm__980)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_54 = paddle._C_ops.conv2d(
            relu_53, parameter_557, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_54 = paddle._C_ops.relu(batch_norm__981)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_55 = paddle._C_ops.conv2d(
            relu_54, parameter_547, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_55 = paddle._C_ops.relu(batch_norm__982)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_56 = paddle._C_ops.conv2d(
            relu_55, parameter_537, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_56 = paddle._C_ops.relu(batch_norm__983)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_57 = paddle._C_ops.conv2d(
            relu_56, parameter_527, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_57 = paddle._C_ops.relu(batch_norm__984)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_58 = paddle._C_ops.conv2d(
            relu_57, parameter_517, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_58 = paddle._C_ops.relu(batch_norm__985)
        ...
        combine_7 = [relu_52, relu_53, relu_54, relu_55, relu_56, relu_57, relu_58]
        ...
        conv2d_59 = paddle._C_ops.conv2d(
            concat_7, parameter_507, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x512x14x14xf32) <- (-1x512x14x14xf32)
        relu_59 = paddle._C_ops.relu(batch_norm__986)

        # pd_op.conv2d: (-1x1024x14x14xf32) <- (-1x512x14x14xf32, 1024x512x1x1xf32)
        conv2d_60 = paddle._C_ops.conv2d(
            relu_59, parameter_502, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x1024x14x14xf32) <- (-1x1024x14x14xf32)
        relu_60 = paddle._C_ops.relu(batch_norm__987)

        # pd_op.add: (-1x1024x14x14xf32) <- (-1x1024x14x14xf32, -1x1024x14x14xf32)
        add_3 = paddle._C_ops.add(relu_60, relu_52)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x1024x14x14xf32, 384x1024x1x1xf32)
        conv2d_61 = paddle._C_ops.conv2d(
            add_3, parameter_497, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_61 = paddle._C_ops.relu(batch_norm__988)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_62 = paddle._C_ops.conv2d(
            relu_61, parameter_487, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_62 = paddle._C_ops.relu(batch_norm__989)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_63 = paddle._C_ops.conv2d(
            relu_62, parameter_477, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_63 = paddle._C_ops.relu(batch_norm__990)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_64 = paddle._C_ops.conv2d(
            relu_63, parameter_467, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_64 = paddle._C_ops.relu(batch_norm__991)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_65 = paddle._C_ops.conv2d(
            relu_64, parameter_457, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_65 = paddle._C_ops.relu(batch_norm__992)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_66 = paddle._C_ops.conv2d(
            relu_65, parameter_447, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_66 = paddle._C_ops.relu(batch_norm__993)
        ...
        conv2d_67 = paddle._C_ops.conv2d(
            concat_8, parameter_437, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x512x14x14xf32) <- (-1x512x14x14xf32)
        relu_67 = paddle._C_ops.relu(batch_norm__994)

        # pd_op.conv2d: (-1x1024x14x14xf32) <- (-1x512x14x14xf32, 1024x512x1x1xf32)
        conv2d_68 = paddle._C_ops.conv2d(
            relu_67, parameter_432, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x1024x14x14xf32) <- (-1x1024x14x14xf32)
        relu_68 = paddle._C_ops.relu(batch_norm__995)
        ...
        conv2d_69 = paddle._C_ops.conv2d(
            add_4, parameter_427, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_69 = paddle._C_ops.relu(batch_norm__996)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_70 = paddle._C_ops.conv2d(
            relu_69, parameter_417, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_70 = paddle._C_ops.relu(batch_norm__997)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_71 = paddle._C_ops.conv2d(
            relu_70, parameter_407, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_71 = paddle._C_ops.relu(batch_norm__998)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_72 = paddle._C_ops.conv2d(
            relu_71, parameter_397, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_72 = paddle._C_ops.relu(batch_norm__999)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_73 = paddle._C_ops.conv2d(
            relu_72, parameter_387, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_73 = paddle._C_ops.relu(batch_norm__1000)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_74 = paddle._C_ops.conv2d(
            relu_73, parameter_377, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_74 = paddle._C_ops.relu(batch_norm__1001)

        # builtin.combine: ([-1x1024x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32]) <- (-1x1024x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32)
        combine_9 = [add_4, relu_69, relu_70, relu_71, relu_72, relu_73, relu_74]
        ...
        conv2d_75 = paddle._C_ops.conv2d(
            concat_9, parameter_367, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x512x14x14xf32) <- (-1x512x14x14xf32)
        relu_75 = paddle._C_ops.relu(batch_norm__1002)

        # pd_op.conv2d: (-1x1024x14x14xf32) <- (-1x512x14x14xf32, 1024x512x1x1xf32)
        conv2d_76 = paddle._C_ops.conv2d(
            relu_75, parameter_362, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x1024x14x14xf32) <- (-1x1024x14x14xf32)
        relu_76 = paddle._C_ops.relu(batch_norm__1003)

        # pd_op.add: (-1x1024x14x14xf32) <- (-1x1024x14x14xf32, -1x1024x14x14xf32)
        add_5 = paddle._C_ops.add(relu_76, add_4)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x1024x14x14xf32, 384x1024x1x1xf32)
        conv2d_77 = paddle._C_ops.conv2d(
            add_5, parameter_357, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_77 = paddle._C_ops.relu(batch_norm__1004)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_78 = paddle._C_ops.conv2d(
            relu_77, parameter_347, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_78 = paddle._C_ops.relu(batch_norm__1005)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_79 = paddle._C_ops.conv2d(
            relu_78, parameter_337, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_79 = paddle._C_ops.relu(batch_norm__1006)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_80 = paddle._C_ops.conv2d(
            relu_79, parameter_327, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_80 = paddle._C_ops.relu(batch_norm__1007)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_81 = paddle._C_ops.conv2d(
            relu_80, parameter_317, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_81 = paddle._C_ops.relu(batch_norm__1008)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_82 = paddle._C_ops.conv2d(
            relu_81, parameter_307, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_82 = paddle._C_ops.relu(batch_norm__1009)

        # builtin.combine: ([-1x1024x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32]) <- (-1x1024x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32)
        combine_10 = [add_5, relu_77, relu_78, relu_79, relu_80, relu_81, relu_82]
        ...
        conv2d_83 = paddle._C_ops.conv2d(
            concat_10, parameter_297, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x512x14x14xf32) <- (-1x512x14x14xf32)
        relu_83 = paddle._C_ops.relu(batch_norm__1010)

        # pd_op.conv2d: (-1x1024x14x14xf32) <- (-1x512x14x14xf32, 1024x512x1x1xf32)
        conv2d_84 = paddle._C_ops.conv2d(
            relu_83, parameter_292, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x1024x14x14xf32) <- (-1x1024x14x14xf32)
        relu_84 = paddle._C_ops.relu(batch_norm__1011)

        # pd_op.add: (-1x1024x14x14xf32) <- (-1x1024x14x14xf32, -1x1024x14x14xf32)
        add_6 = paddle._C_ops.add(relu_84, add_5)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x1024x14x14xf32, 384x1024x1x1xf32)
        conv2d_85 = paddle._C_ops.conv2d(
            add_6, parameter_287, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_85 = paddle._C_ops.relu(batch_norm__1012)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_86 = paddle._C_ops.conv2d(
            relu_85, parameter_277, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_86 = paddle._C_ops.relu(batch_norm__1013)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_87 = paddle._C_ops.conv2d(
            relu_86, parameter_267, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_87 = paddle._C_ops.relu(batch_norm__1014)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_88 = paddle._C_ops.conv2d(
            relu_87, parameter_257, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_88 = paddle._C_ops.relu(batch_norm__1015)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_89 = paddle._C_ops.conv2d(
            relu_88, parameter_247, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_89 = paddle._C_ops.relu(batch_norm__1016)

        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x384x14x14xf32, 384x384x1x1xf32)
        conv2d_90 = paddle._C_ops.conv2d(
            relu_89, parameter_237, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        relu_90 = paddle._C_ops.relu(batch_norm__1017)

        # builtin.combine: ([-1x1024x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32]) <- (-1x1024x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32, -1x384x14x14xf32)
        combine_11 = [add_6, relu_85, relu_86, relu_87, relu_88, relu_89, relu_90]
        ...
        conv2d_91 = paddle._C_ops.conv2d(
            concat_11, parameter_227, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x512x14x14xf32) <- (-1x512x14x14xf32)
        relu_91 = paddle._C_ops.relu(batch_norm__1018)

        # pd_op.conv2d: (-1x1024x14x14xf32) <- (-1x512x14x14xf32, 1024x512x1x1xf32)
        conv2d_92 = paddle._C_ops.conv2d(
            relu_91, parameter_222, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x1024x14x14xf32) <- (-1x1024x14x14xf32)
        relu_92 = paddle._C_ops.relu(batch_norm__1019)

        # pd_op.add: (-1x1024x14x14xf32) <- (-1x1024x14x14xf32, -1x1024x14x14xf32)
        add_7 = paddle._C_ops.add(relu_92, add_6)

        # pd_op.depthwise_conv2d: (-1x1024x7x7xf32) <- (-1x1024x14x14xf32, 1024x1x3x3xf32)
        depthwise_conv2d_38 = paddle._C_ops.depthwise_conv2d(
            add_7, parameter_217, [2, 2], [1, 1], "EXPLICIT", 1024, [1, 1], "NCHW"
        )
        ...
        relu_93 = paddle._C_ops.relu(batch_norm__1020)

        # pd_op.conv2d: (-1x768x7x7xf32) <- (-1x768x7x7xf32, 768x768x1x1xf32)
        conv2d_94 = paddle._C_ops.conv2d(
            relu_93, parameter_202, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x768x7x7xf32) <- (-1x768x7x7xf32)
        relu_94 = paddle._C_ops.relu(batch_norm__1021)

        # pd_op.conv2d: (-1x768x7x7xf32) <- (-1x768x7x7xf32, 768x768x1x1xf32)
        conv2d_95 = paddle._C_ops.conv2d(
            relu_94, parameter_192, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x768x7x7xf32) <- (-1x768x7x7xf32)
        relu_95 = paddle._C_ops.relu(batch_norm__1022)

        # pd_op.conv2d: (-1x768x7x7xf32) <- (-1x768x7x7xf32, 768x768x1x1xf32)
        conv2d_96 = paddle._C_ops.conv2d(
            relu_95, parameter_182, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x768x7x7xf32) <- (-1x768x7x7xf32)
        relu_96 = paddle._C_ops.relu(batch_norm__1023)

        # pd_op.conv2d: (-1x768x7x7xf32) <- (-1x768x7x7xf32, 768x768x1x1xf32)
        conv2d_97 = paddle._C_ops.conv2d(
            relu_96, parameter_172, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x768x7x7xf32) <- (-1x768x7x7xf32)
        relu_97 = paddle._C_ops.relu(batch_norm__1024)

        # pd_op.conv2d: (-1x768x7x7xf32) <- (-1x768x7x7xf32, 768x768x1x1xf32)
        conv2d_98 = paddle._C_ops.conv2d(
            relu_97, parameter_162, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x768x7x7xf32) <- (-1x768x7x7xf32)
        relu_98 = paddle._C_ops.relu(batch_norm__1025)
        ...
        conv2d_99 = paddle._C_ops.conv2d(
            concat_12, parameter_152, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        relu_99 = paddle._C_ops.relu(batch_norm__1026)

        # pd_op.conv2d: (-1x2048x7x7xf32) <- (-1x1024x7x7xf32, 2048x1024x1x1xf32)
        conv2d_100 = paddle._C_ops.conv2d(
            relu_99, parameter_147, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        relu_100 = paddle._C_ops.relu(batch_norm__1027)

        # pd_op.conv2d: (-1x768x7x7xf32) <- (-1x2048x7x7xf32, 768x2048x1x1xf32)
        conv2d_101 = paddle._C_ops.conv2d(
            relu_100, parameter_142, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x768x7x7xf32) <- (-1x768x7x7xf32)
        relu_101 = paddle._C_ops.relu(batch_norm__1028)

        # pd_op.conv2d: (-1x768x7x7xf32) <- (-1x768x7x7xf32, 768x768x1x1xf32)
        conv2d_102 = paddle._C_ops.conv2d(
            relu_101, parameter_132, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x768x7x7xf32) <- (-1x768x7x7xf32)
        relu_102 = paddle._C_ops.relu(batch_norm__1029)

        # pd_op.conv2d: (-1x768x7x7xf32) <- (-1x768x7x7xf32, 768x768x1x1xf32)
        conv2d_103 = paddle._C_ops.conv2d(
            relu_102, parameter_122, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x768x7x7xf32) <- (-1x768x7x7xf32)
        relu_103 = paddle._C_ops.relu(batch_norm__1030)

        # pd_op.conv2d: (-1x768x7x7xf32) <- (-1x768x7x7xf32, 768x768x1x1xf32)
        conv2d_104 = paddle._C_ops.conv2d(
            relu_103, parameter_112, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x768x7x7xf32) <- (-1x768x7x7xf32)
        relu_104 = paddle._C_ops.relu(batch_norm__1031)

        # pd_op.conv2d: (-1x768x7x7xf32) <- (-1x768x7x7xf32, 768x768x1x1xf32)
        conv2d_105 = paddle._C_ops.conv2d(
            relu_104, parameter_102, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x768x7x7xf32) <- (-1x768x7x7xf32)
        relu_105 = paddle._C_ops.relu(batch_norm__1032)

        # pd_op.conv2d: (-1x768x7x7xf32) <- (-1x768x7x7xf32, 768x768x1x1xf32)
        conv2d_106 = paddle._C_ops.conv2d(
            relu_105, parameter_92, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x768x7x7xf32) <- (-1x768x7x7xf32)
        relu_106 = paddle._C_ops.relu(batch_norm__1033)
        ...
        conv2d_107 = paddle._C_ops.conv2d(
            concat_13, parameter_82, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x1024x7x7xf32) <- (-1x1024x7x7xf32)
        relu_107 = paddle._C_ops.relu(batch_norm__1034)

        # pd_op.conv2d: (-1x2048x7x7xf32) <- (-1x1024x7x7xf32, 2048x1024x1x1xf32)
        conv2d_108 = paddle._C_ops.conv2d(
            relu_107, parameter_77, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x2048x7x7xf32) <- (-1x2048x7x7xf32)
        relu_108 = paddle._C_ops.relu(batch_norm__1035)

        # pd_op.add: (-1x2048x7x7xf32) <- (-1x2048x7x7xf32, -1x2048x7x7xf32)
        add_8 = paddle._C_ops.add(relu_108, relu_100)
        ...
        # pd_op.relu: (-1x768x7x7xf32) <- (-1x768x7x7xf32)
        relu_109 = paddle._C_ops.relu(batch_norm__1036)

        # pd_op.conv2d: (-1x768x7x7xf32) <- (-1x768x7x7xf32, 768x768x1x1xf32)
        conv2d_110 = paddle._C_ops.conv2d(
            relu_109, parameter_62, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x768x7x7xf32) <- (-1x768x7x7xf32)
        relu_110 = paddle._C_ops.relu(batch_norm__1037)

        # pd_op.conv2d: (-1x768x7x7xf32) <- (-1x768x7x7xf32, 768x768x1x1xf32)
        conv2d_111 = paddle._C_ops.conv2d(
            relu_110, parameter_52, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x768x7x7xf32) <- (-1x768x7x7xf32)
        relu_111 = paddle._C_ops.relu(batch_norm__1038)

        # pd_op.conv2d: (-1x768x7x7xf32) <- (-1x768x7x7xf32, 768x768x1x1xf32)
        conv2d_112 = paddle._C_ops.conv2d(
            relu_111, parameter_42, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x768x7x7xf32) <- (-1x768x7x7xf32)
        relu_112 = paddle._C_ops.relu(batch_norm__1039)

        # pd_op.conv2d: (-1x768x7x7xf32) <- (-1x768x7x7xf32, 768x768x1x1xf32)
        conv2d_113 = paddle._C_ops.conv2d(
            relu_112, parameter_32, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x768x7x7xf32) <- (-1x768x7x7xf32)
        relu_113 = paddle._C_ops.relu(batch_norm__1040)

        # pd_op.conv2d: (-1x768x7x7xf32) <- (-1x768x7x7xf32, 768x768x1x1xf32)
        conv2d_114 = paddle._C_ops.conv2d(
            relu_113, parameter_22, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x768x7x7xf32) <- (-1x768x7x7xf32)
        relu_114 = paddle._C_ops.relu(batch_norm__1041)

        # builtin.combine: ([-1x2048x7x7xf32, -1x768x7x7xf32, -1x768x7x7xf32, -1x768x7x7xf32, -1x768x7x7xf32, -1x768x7x7xf32, -1x768x7x7xf32]) <- (-1x2048x7x7xf32, -1x768x7x7xf32, -1x768x7x7xf32, -1x768x7x7xf32, -1x768x7x7xf32, -1x768x7x7xf32, -1x768x7x7xf32)
        combine_14 = [add_8, relu_109, relu_110, relu_111, relu_112, relu_113, relu_114]
        ...
        conv2d_115 = paddle._C_ops.conv2d(
            concat_14, parameter_12, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x1024x7x7xf32) <- (-1x1024x7x7xf32)
        relu_115 = paddle._C_ops.relu(batch_norm__1042)

        # pd_op.conv2d: (-1x2048x7x7xf32) <- (-1x1024x7x7xf32, 2048x1024x1x1xf32)
        conv2d_116 = paddle._C_ops.conv2d(
            relu_115, parameter_7, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x2048x7x7xf32) <- (-1x2048x7x7xf32)
        relu_116 = paddle._C_ops.relu(batch_norm__1043)

        # pd_op.add: (-1x2048x7x7xf32) <- (-1x2048x7x7xf32, -1x2048x7x7xf32)
        add_9 = paddle._C_ops.add(relu_116, add_8)
        ...
        relu_117 = paddle._C_ops.relu(conv2d_117)

        # pd_op.flatten: (-1x2048xf32) <- (-1x2048x1x1xf32)
        flatten_0 = paddle._C_ops.flatten(relu_117, 1, 3)
