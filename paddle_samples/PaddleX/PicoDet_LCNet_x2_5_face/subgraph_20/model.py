...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4):
        ...
        # pd_op.slice: (27540xf32) <- (27540x4xf32, 1xi64, 1xi64)
        slice_1 = paddle._C_ops.slice(
            data_2, [1], full_int_array_0, full_int_array_1, [1], [1]
        )

        # pd_op.unsqueeze: (27540x1xf32) <- (27540xf32, 1xi64)
        ...
        # pd_op.tile: (27540x-1xf32) <- (27540x1xf32, 2xi64)
        ...
        slice_4 = paddle._C_ops.slice(
            data_2, [1], full_int_array_3, full_int_array_4, [1], [1]
        )
        del data_2
        ...
        # pd_op.subtract: (27540x-1xf32) <- (27540x-1xf32, -1xf32)
        ...
        # pd_op.subtract: (27540x-1xf32) <- (-1xf32, 27540x-1xf32)
        subtract_2 = paddle._C_ops.subtract(slice_7, tile_0)

        # pd_op.slice: (-1xf32) <- (-1x4xf32, 1xi64, 1xi64)
        slice_8 = paddle._C_ops.slice(
            data_4, [1], full_int_array_3, full_int_array_4, [1], [1]
        )
        del data_4, full_int_array_3, full_int_array_4

        # pd_op.subtract: (27540x-1xf32) <- (-1xf32, 27540x-1xf32)
        subtract_3 = paddle._C_ops.subtract(slice_8, tile_1)

        # builtin.combine: ([27540x-1xf32, 27540x-1xf32, 27540x-1xf32, 27540x-1xf32]) <- (27540x-1xf32, 27540x-1xf32, 27540x-1xf32, 27540x-1xf32)
        combine_1 = [subtract_0, subtract_1, subtract_2, subtract_3]
        del subtract_0, subtract_1, subtract_2, subtract_3

        # pd_op.stack: (27540x4x-1xf32) <- ([27540x-1xf32, 27540x-1xf32, 27540x-1xf32, 27540x-1xf32])
        stack_1 = paddle._C_ops.stack(combine_1, 1)
        del combine_1

        # pd_op.min: (27540x-1xf32) <- (27540x4x-1xf32, 1xi64)
        ...
        # pd_op.greater_than: (27540x-1xb) <- (27540x-1xf32, xf32)
        greater_than_0 = paddle._C_ops.greater_than(min_0, full_2)
        del min_0

        # pd_op.sum: (27540xi64) <- (27540x-1xb, 1xi64)
        sum_0 = paddle._C_ops.sum(greater_than_0, full_int_array_1, None, False)

        # pd_op.greater_than: (27540xb) <- (27540xi64, xi64)
        greater_than_1 = paddle._C_ops.greater_than(sum_0, full_0)
        del sum_0
        ...
        # pd_op.scale: (27540x-1xf32) <- (27540x-1xf32, 1xf32)
        ...
        # pd_op.add: (27540x-1xf32) <- (-1xf32, 27540x-1xf32)
        ...
        # pd_op.subtract: (27540x-1xf32) <- (27540x-1xf32, 27540x-1xf32)
        ...
        # pd_op.greater_than: (27540x-1xb) <- (27540x-1xf32, xf32)
        greater_than_2 = paddle._C_ops.greater_than(min_1, full_2)
        del full_2, min_1
        ...
        # pd_op.greater_than: (27540xb) <- (27540xi64, xi64)
        greater_than_3 = paddle._C_ops.greater_than(sum_1, full_0)
        del full_0, sum_1

        # pd_op.logical_or: (27540xb) <- (27540xb, 27540xb)
        logical_or_0 = paddle._C_ops.logical_or(greater_than_1, greater_than_3)
        del greater_than_1, greater_than_3

        # pd_op.nonzero: (-1x1xi64) <- (27540xb)
        ...
        # pd_op.cast: (27540x-1xi64) <- (27540x-1xb)
        ...
        # pd_op.gather: (-1x-1xi64) <- (27540x-1xi64, -1xi64, 1xi32)
        gather_0 = paddle._C_ops.gather(cast_1, squeeze_0, full_5)
        del cast_1

        # pd_op.cast: (-1x-1xb) <- (-1x-1xi64)
        cast_2 = paddle._C_ops.cast(gather_0, paddle.bool)
        del gather_0

        # pd_op.cast: (27540x-1xi64) <- (27540x-1xb)
        cast_3 = paddle._C_ops.cast(greater_than_2, paddle.int64)
        del greater_than_2

        # pd_op.gather: (-1x-1xi64) <- (27540x-1xi64, -1xi64, 1xi32)
        gather_1 = paddle._C_ops.gather(cast_3, squeeze_0, full_5)
        del cast_3, full_5

        # pd_op.cast: (-1x-1xb) <- (-1x-1xi64)
        cast_4 = paddle._C_ops.cast(gather_1, paddle.bool)
        del gather_1

        # pd_op.logical_and: (-1x-1xb) <- (-1x-1xb, -1x-1xb)
        logical_and_0 = paddle._C_ops.logical_and(cast_2, cast_4)
        del cast_2, cast_4
        ...
        unsqueeze_4 = paddle._C_ops.unsqueeze(squeeze_0, full_int_array_5)
        del full_int_array_5, squeeze_0

        # pd_op.gather_nd: (-1x4xf32) <- (27540x4xf32, -1x1xi64)
        gather_nd_1 = paddle._C_ops.gather_nd(data_3, unsqueeze_4)
        del data_3

        # pd_op.gather_nd: (-1x1xf32) <- (27540x1xf32, -1x1xi64)
        gather_nd_0 = paddle._C_ops.gather_nd(data_1, unsqueeze_4)
        del data_1, unsqueeze_4
