...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        conv2d_0 = paddle._C_ops.conv2d(
            data_0, parameter_276, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        relu_0 = paddle._C_ops.relu(batch_norm__295)

        # pd_op.conv2d: (-1x32x112x112xf32) <- (-1x32x112x112xf32, 32x32x3x3xf32)
        conv2d_1 = paddle._C_ops.conv2d(
            relu_0, parameter_271, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x32x112x112xf32) <- (-1x32x112x112xf32)
        relu_1 = paddle._C_ops.relu(batch_norm__296)

        # pd_op.conv2d: (-1x64x112x112xf32) <- (-1x32x112x112xf32, 64x32x3x3xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            relu_1, parameter_266, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        relu_2 = paddle._C_ops.relu(batch_norm__297)
        ...
        conv2d_3 = paddle._C_ops.conv2d(
            pool2d_0, parameter_261, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        relu_3 = paddle._C_ops.relu(batch_norm__298)

        # pd_op.conv2d: (-1x64x56x56xf32) <- (-1x64x56x56xf32, 64x64x3x3xf32)
        conv2d_4 = paddle._C_ops.conv2d(
            relu_3, parameter_256, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x64x56x56xf32) <- (-1x64x56x56xf32)
        relu_4 = paddle._C_ops.relu(batch_norm__299)

        # pd_op.conv2d: (-1x256x56x56xf32) <- (-1x64x56x56xf32, 256x64x1x1xf32)
        conv2d_5 = paddle._C_ops.conv2d(
            relu_4, parameter_251, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_6 = paddle._C_ops.conv2d(
            pool2d_0, parameter_246, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_7 = paddle._C_ops.conv2d(
            relu_5, parameter_241, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x64x56x56xf32) <- (-1x64x56x56xf32)
        relu_6 = paddle._C_ops.relu(batch_norm__300)

        # pd_op.conv2d: (-1x64x56x56xf32) <- (-1x64x56x56xf32, 64x64x3x3xf32)
        conv2d_8 = paddle._C_ops.conv2d(
            relu_6, parameter_236, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x64x56x56xf32) <- (-1x64x56x56xf32)
        relu_7 = paddle._C_ops.relu(batch_norm__301)

        # pd_op.conv2d: (-1x256x56x56xf32) <- (-1x64x56x56xf32, 256x64x1x1xf32)
        conv2d_9 = paddle._C_ops.conv2d(
            relu_7, parameter_231, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_10 = paddle._C_ops.conv2d(
            relu_8, parameter_226, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x64x56x56xf32) <- (-1x64x56x56xf32)
        relu_9 = paddle._C_ops.relu(batch_norm__302)

        # pd_op.conv2d: (-1x64x56x56xf32) <- (-1x64x56x56xf32, 64x64x3x3xf32)
        conv2d_11 = paddle._C_ops.conv2d(
            relu_9, parameter_221, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x64x56x56xf32) <- (-1x64x56x56xf32)
        relu_10 = paddle._C_ops.relu(batch_norm__303)

        # pd_op.conv2d: (-1x256x56x56xf32) <- (-1x64x56x56xf32, 256x64x1x1xf32)
        conv2d_12 = paddle._C_ops.conv2d(
            relu_10, parameter_216, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_13 = paddle._C_ops.conv2d(
            relu_11, parameter_211, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        relu_12 = paddle._C_ops.relu(batch_norm__304)

        # pd_op.conv2d: (-1x128x28x28xf32) <- (-1x128x56x56xf32, 128x128x3x3xf32)
        conv2d_14 = paddle._C_ops.conv2d(
            relu_12, parameter_206, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        relu_13 = paddle._C_ops.relu(batch_norm__305)

        # pd_op.conv2d: (-1x512x28x28xf32) <- (-1x128x28x28xf32, 512x128x1x1xf32)
        conv2d_15 = paddle._C_ops.conv2d(
            relu_13, parameter_201, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_16 = paddle._C_ops.conv2d(
            pool2d_1, parameter_196, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_17 = paddle._C_ops.conv2d(
            relu_14, parameter_191, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x128x28x28xf32) <- (-1x128x28x28xf32)
        relu_15 = paddle._C_ops.relu(batch_norm__306)

        # pd_op.conv2d: (-1x128x28x28xf32) <- (-1x128x28x28xf32, 128x128x3x3xf32)
        conv2d_18 = paddle._C_ops.conv2d(
            relu_15, parameter_186, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x128x28x28xf32) <- (-1x128x28x28xf32)
        relu_16 = paddle._C_ops.relu(batch_norm__307)

        # pd_op.conv2d: (-1x512x28x28xf32) <- (-1x128x28x28xf32, 512x128x1x1xf32)
        conv2d_19 = paddle._C_ops.conv2d(
            relu_16, parameter_181, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_20 = paddle._C_ops.conv2d(
            relu_17, parameter_176, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x128x28x28xf32) <- (-1x128x28x28xf32)
        relu_18 = paddle._C_ops.relu(batch_norm__308)

        # pd_op.conv2d: (-1x128x28x28xf32) <- (-1x128x28x28xf32, 128x128x3x3xf32)
        conv2d_21 = paddle._C_ops.conv2d(
            relu_18, parameter_171, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x128x28x28xf32) <- (-1x128x28x28xf32)
        relu_19 = paddle._C_ops.relu(batch_norm__309)

        # pd_op.conv2d: (-1x512x28x28xf32) <- (-1x128x28x28xf32, 512x128x1x1xf32)
        conv2d_22 = paddle._C_ops.conv2d(
            relu_19, parameter_166, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_23 = paddle._C_ops.conv2d(
            relu_20, parameter_161, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x128x28x28xf32) <- (-1x128x28x28xf32)
        relu_21 = paddle._C_ops.relu(batch_norm__310)

        # pd_op.conv2d: (-1x128x28x28xf32) <- (-1x128x28x28xf32, 128x128x3x3xf32)
        conv2d_24 = paddle._C_ops.conv2d(
            relu_21, parameter_156, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x128x28x28xf32) <- (-1x128x28x28xf32)
        relu_22 = paddle._C_ops.relu(batch_norm__311)

        # pd_op.conv2d: (-1x512x28x28xf32) <- (-1x128x28x28xf32, 512x128x1x1xf32)
        conv2d_25 = paddle._C_ops.conv2d(
            relu_22, parameter_151, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_26 = paddle._C_ops.conv2d(
            relu_23, parameter_146, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        relu_24 = paddle._C_ops.relu(batch_norm__312)

        # pd_op.conv2d: (-1x256x14x14xf32) <- (-1x256x28x28xf32, 256x256x3x3xf32)
        conv2d_27 = paddle._C_ops.conv2d(
            relu_24, parameter_141, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_29 = paddle._C_ops.conv2d(
            pool2d_2, parameter_131, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_30 = paddle._C_ops.conv2d(
            relu_26, parameter_126, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x256x14x14xf32) <- (-1x256x14x14xf32)
        relu_27 = paddle._C_ops.relu(batch_norm__314)

        # pd_op.conv2d: (-1x256x14x14xf32) <- (-1x256x14x14xf32, 256x256x3x3xf32)
        conv2d_31 = paddle._C_ops.conv2d(
            relu_27, parameter_121, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x256x14x14xf32) <- (-1x256x14x14xf32)
        relu_28 = paddle._C_ops.relu(batch_norm__315)

        # pd_op.conv2d: (-1x1024x14x14xf32) <- (-1x256x14x14xf32, 1024x256x1x1xf32)
        conv2d_32 = paddle._C_ops.conv2d(
            relu_28, parameter_116, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_33 = paddle._C_ops.conv2d(
            relu_29, parameter_111, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x256x14x14xf32) <- (-1x256x14x14xf32)
        relu_30 = paddle._C_ops.relu(batch_norm__316)

        # pd_op.conv2d: (-1x256x14x14xf32) <- (-1x256x14x14xf32, 256x256x3x3xf32)
        conv2d_34 = paddle._C_ops.conv2d(
            relu_30, parameter_106, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x256x14x14xf32) <- (-1x256x14x14xf32)
        relu_31 = paddle._C_ops.relu(batch_norm__317)

        # pd_op.conv2d: (-1x1024x14x14xf32) <- (-1x256x14x14xf32, 1024x256x1x1xf32)
        conv2d_35 = paddle._C_ops.conv2d(
            relu_31, parameter_101, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_36 = paddle._C_ops.conv2d(
            relu_32, parameter_96, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x256x14x14xf32) <- (-1x256x14x14xf32)
        relu_33 = paddle._C_ops.relu(batch_norm__318)

        # pd_op.conv2d: (-1x256x14x14xf32) <- (-1x256x14x14xf32, 256x256x3x3xf32)
        conv2d_37 = paddle._C_ops.conv2d(
            relu_33, parameter_91, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x256x14x14xf32) <- (-1x256x14x14xf32)
        relu_34 = paddle._C_ops.relu(batch_norm__319)

        # pd_op.conv2d: (-1x1024x14x14xf32) <- (-1x256x14x14xf32, 1024x256x1x1xf32)
        conv2d_38 = paddle._C_ops.conv2d(
            relu_34, parameter_86, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_39 = paddle._C_ops.conv2d(
            relu_35, parameter_81, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x256x14x14xf32) <- (-1x256x14x14xf32)
        relu_36 = paddle._C_ops.relu(batch_norm__320)

        # pd_op.conv2d: (-1x256x14x14xf32) <- (-1x256x14x14xf32, 256x256x3x3xf32)
        conv2d_40 = paddle._C_ops.conv2d(
            relu_36, parameter_76, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x256x14x14xf32) <- (-1x256x14x14xf32)
        relu_37 = paddle._C_ops.relu(batch_norm__321)
        ...
        conv2d_42 = paddle._C_ops.conv2d(
            relu_38, parameter_66, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x256x14x14xf32) <- (-1x256x14x14xf32)
        relu_39 = paddle._C_ops.relu(batch_norm__322)

        # pd_op.conv2d: (-1x256x14x14xf32) <- (-1x256x14x14xf32, 256x256x3x3xf32)
        conv2d_43 = paddle._C_ops.conv2d(
            relu_39, parameter_61, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x256x14x14xf32) <- (-1x256x14x14xf32)
        relu_40 = paddle._C_ops.relu(batch_norm__323)

        # pd_op.conv2d: (-1x1024x14x14xf32) <- (-1x256x14x14xf32, 1024x256x1x1xf32)
        conv2d_44 = paddle._C_ops.conv2d(
            relu_40, parameter_56, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_45 = paddle._C_ops.conv2d(
            relu_41, parameter_51, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        relu_42 = paddle._C_ops.relu(batch_norm__324)

        # pd_op.conv2d: (-1x512x7x7xf32) <- (-1x512x14x14xf32, 512x512x3x3xf32)
        conv2d_46 = paddle._C_ops.conv2d(
            relu_42, parameter_46, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        relu_43 = paddle._C_ops.relu(batch_norm__325)

        # pd_op.conv2d: (-1x2048x7x7xf32) <- (-1x512x7x7xf32, 2048x512x1x1xf32)
        conv2d_47 = paddle._C_ops.conv2d(
            relu_43, parameter_41, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        add_14 = paddle._C_ops.add(batch_norm__251, batch_norm__257)
        ...
        conv2d_49 = paddle._C_ops.conv2d(
            relu_44, parameter_31, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x512x7x7xf32) <- (-1x512x7x7xf32)
        relu_45 = paddle._C_ops.relu(batch_norm__326)

        # pd_op.conv2d: (-1x512x7x7xf32) <- (-1x512x7x7xf32, 512x512x3x3xf32)
        conv2d_50 = paddle._C_ops.conv2d(
            relu_45, parameter_26, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x512x7x7xf32) <- (-1x512x7x7xf32)
        relu_46 = paddle._C_ops.relu(batch_norm__327)

        # pd_op.conv2d: (-1x2048x7x7xf32) <- (-1x512x7x7xf32, 2048x512x1x1xf32)
        conv2d_51 = paddle._C_ops.conv2d(
            relu_46, parameter_21, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.add: (-1x2048x7x7xf32) <- (-1x2048x7x7xf32, -1x2048x7x7xf32)
        add_15 = paddle._C_ops.add(batch_norm__273, relu_44)
        ...
        conv2d_52 = paddle._C_ops.conv2d(
            relu_47, parameter_16, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x512x7x7xf32) <- (-1x512x7x7xf32)
        relu_48 = paddle._C_ops.relu(batch_norm__328)

        # pd_op.conv2d: (-1x512x7x7xf32) <- (-1x512x7x7xf32, 512x512x3x3xf32)
        conv2d_53 = paddle._C_ops.conv2d(
            relu_48, parameter_11, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x512x7x7xf32) <- (-1x512x7x7xf32)
        relu_49 = paddle._C_ops.relu(batch_norm__329)

        # pd_op.conv2d: (-1x2048x7x7xf32) <- (-1x512x7x7xf32, 2048x512x1x1xf32)
        conv2d_54 = paddle._C_ops.conv2d(
            relu_49, parameter_6, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.add: (-1x2048x7x7xf32) <- (-1x2048x7x7xf32, -1x2048x7x7xf32)
        add_16 = paddle._C_ops.add(batch_norm__289, relu_47)
