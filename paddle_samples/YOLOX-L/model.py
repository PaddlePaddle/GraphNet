...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.tile: (6069x-1xf32) <- (6069x1xf32, 2xi64)
        ...
        # pd_op.subtract: (6069x-1xf32) <- (6069x-1xf32, -1xf32)
        ...
        # pd_op.subtract: (6069x-1xf32) <- (-1xf32, 6069x-1xf32)
        ...
        # builtin.combine: ([6069x-1xf32, 6069x-1xf32, 6069x-1xf32, 6069x-1xf32]) <- (6069x-1xf32, 6069x-1xf32, 6069x-1xf32, 6069x-1xf32)
        combine_1 = [subtract_0, subtract_1, subtract_2, subtract_3]

        # pd_op.stack: (6069x4x-1xf32) <- ([6069x-1xf32, 6069x-1xf32, 6069x-1xf32, 6069x-1xf32])
        stack_1 = paddle._C_ops.stack(combine_1, 1)

        # pd_op.min: (6069x-1xf32) <- (6069x4x-1xf32, 1xi64)
        ...
        # pd_op.greater_than: (6069x-1xb) <- (6069x-1xf32, xf32)
        greater_than_0 = paddle._C_ops.greater_than(min_0, full_1)

        # pd_op.sum: (6069xi64) <- (6069x-1xb, 1xi64)
        ...
        # pd_op.scale: (6069x-1xf32) <- (6069x-1xf32, 1xf32)
        ...
        # pd_op.add: (6069x-1xf32) <- (-1xf32, 6069x-1xf32)
        add_2 = paddle._C_ops.add(scale_0, scale_2)

        # pd_op.add: (6069x-1xf32) <- (-1xf32, 6069x-1xf32)
        add_3 = paddle._C_ops.add(scale_1, scale_3)

        # pd_op.subtract: (6069x-1xf32) <- (6069x-1xf32, 6069x-1xf32)
        ...
        # pd_op.cast: (6069x-1xi64) <- (6069x-1xb)
        ...
        # pd_op.gather: (-1x-1xi64) <- (6069x-1xi64, -1xi64, 1xi32)
