...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3):
        ...
        # pd_op.tile: (8400x2xf32) <- (8400x1xf32, 2xi64)
        ...
        # pd_op.subtract: (8400x2xf32) <- (8400x2xf32, 2xf32)
        ...
        # pd_op.subtract: (8400x2xf32) <- (2xf32, 8400x2xf32)
        ...
        # builtin.combine: ([8400x2xf32, 8400x2xf32, 8400x2xf32, 8400x2xf32]) <- (8400x2xf32, 8400x2xf32, 8400x2xf32, 8400x2xf32)
        combine_0 = [subtract_0, subtract_1, subtract_2, subtract_3]

        # pd_op.stack: (8400x4x2xf32) <- ([8400x2xf32, 8400x2xf32, 8400x2xf32, 8400x2xf32])
        stack_0 = paddle._C_ops.stack(combine_0, 1)

        # pd_op.min: (8400x2xf32) <- (8400x4x2xf32, 1xi64)
        ...
        # pd_op.greater_than: (8400x2xb) <- (8400x2xf32, xf32)
        greater_than_0 = paddle._C_ops.greater_than(min_0, full_0)

        # pd_op.sum: (8400xi64) <- (8400x2xb, 1xi64)
        ...
        # pd_op.scale: (8400x2xf32) <- (8400x2xf32, 1xf32)
        ...
        # pd_op.add: (8400x2xf32) <- (2xf32, 8400x2xf32)
        add_2 = paddle._C_ops.add(scale_0, scale_2)

        # pd_op.add: (8400x2xf32) <- (2xf32, 8400x2xf32)
        add_3 = paddle._C_ops.add(scale_1, scale_3)

        # pd_op.subtract: (8400x2xf32) <- (8400x2xf32, 8400x2xf32)
        ...
        # pd_op.cast: (8400x2xi64) <- (8400x2xb)
        ...
        # pd_op.gather: (-1x2xi64) <- (8400x2xi64, -1xi64, 1xi32)
