...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        embedding = None
        position_ids = torch.arange(0, 43, dtype=torch.int64, device=device(type="cpu"))
        ...
        expand = getitem.expand(1, 1, 43, 43)
        getitem = None
        ...
        view_2 = key_states.view(1, 43, -1, 64)
        key_states = None
        key_states_1 = view_2.transpose(1, 2)
        view_2 = None
        view_3 = value_states.view(1, 43, -1, 64)
        value_states = None
        ...
        transpose_3 = None
        reshape = attn_output_1.reshape(1, 43, -1)
        attn_output_1 = None
        ...
        view_4 = linear_6.view(1, 43, -1, 64)
        linear_6 = None
        ...
        view_5 = key_states_2.view(1, 43, -1, 64)
        key_states_2 = None
        key_states_3 = view_5.transpose(1, 2)
        view_5 = None
        view_6 = value_states_2.view(1, 43, -1, 64)
        value_states_2 = None
        ...
        transpose_7 = None
        reshape_1 = attn_output_5.reshape(1, 43, -1)
        attn_output_5 = None
        ...
        view_7 = linear_12.view(1, 43, -1, 64)
        linear_12 = None
        ...
        view_8 = key_states_4.view(1, 43, -1, 64)
        key_states_4 = None
        key_states_5 = view_8.transpose(1, 2)
        view_8 = None
        view_9 = value_states_4.view(1, 43, -1, 64)
        value_states_4 = None
        ...
        transpose_11 = None
        reshape_2 = attn_output_9.reshape(1, 43, -1)
        attn_output_9 = None
        ...
        view_10 = linear_18.view(1, 43, -1, 64)
        linear_18 = None
        ...
        view_11 = key_states_6.view(1, 43, -1, 64)
        key_states_6 = None
        key_states_7 = view_11.transpose(1, 2)
        view_11 = None
        view_12 = value_states_6.view(1, 43, -1, 64)
        value_states_6 = None
        ...
        transpose_15 = None
        reshape_3 = attn_output_13.reshape(1, 43, -1)
        attn_output_13 = None
        ...
        view_13 = linear_24.view(1, 43, -1, 64)
        linear_24 = None
        ...
        view_14 = key_states_8.view(1, 43, -1, 64)
        key_states_8 = None
        key_states_9 = view_14.transpose(1, 2)
        view_14 = None
        view_15 = value_states_8.view(1, 43, -1, 64)
        value_states_8 = None
        ...
        transpose_19 = None
        reshape_4 = attn_output_17.reshape(1, 43, -1)
        attn_output_17 = None
        ...
        view_16 = linear_30.view(1, 43, -1, 64)
        linear_30 = None
        ...
        view_17 = key_states_10.view(1, 43, -1, 64)
        key_states_10 = None
        key_states_11 = view_17.transpose(1, 2)
        view_17 = None
        view_18 = value_states_10.view(1, 43, -1, 64)
        ...
        transpose_23 = None
        reshape_5 = attn_output_21.reshape(1, 43, -1)
        attn_output_21 = None
        ...
        expand_2 = getitem_8.expand(1, 1, 1, 43)
        getitem_8 = None
        ...
        view_24 = key_states_14.view(1, 43, -1, 64)
        key_states_14 = None
        key_states_15 = view_24.transpose(1, 2)
        view_24 = None
        view_25 = value_states_14.view(1, 43, -1, 64)
        ...
        view_30 = key_states_18.view(1, 43, -1, 64)
        key_states_18 = None
        key_states_19 = view_30.transpose(1, 2)
        view_30 = None
        view_31 = value_states_18.view(1, 43, -1, 64)
        ...
        view_36 = key_states_22.view(1, 43, -1, 64)
        key_states_22 = None
        key_states_23 = view_36.transpose(1, 2)
        view_36 = None
        view_37 = value_states_22.view(1, 43, -1, 64)
        ...
        view_42 = key_states_26.view(1, 43, -1, 64)
        key_states_26 = None
        key_states_27 = view_42.transpose(1, 2)
        view_42 = None
        view_43 = value_states_26.view(1, 43, -1, 64)
        ...
        view_48 = key_states_30.view(1, 43, -1, 64)
        key_states_30 = None
        key_states_31 = view_48.transpose(1, 2)
        view_48 = None
        view_49 = value_states_30.view(1, 43, -1, 64)
        ...
        view_54 = key_states_34.view(1, 43, -1, 64)
        key_states_34 = None
        key_states_35 = view_54.transpose(1, 2)
        view_54 = None
        view_55 = value_states_34.view(1, 43, -1, 64)
