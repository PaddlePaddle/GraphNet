...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        ...
        # pd_op.tile: (2x49x3549xb) <- (2x1x3549xb, 3xi64)
        tile_0 = paddle._C_ops.tile(greater_than_0, full_int_array_1)
        del full_int_array_1, greater_than_0

        # pd_op.multiply: (2x49x3549xf32) <- (2x49x3549xf32, 2x49x3549xf32)
        ...
        # pd_op.argmax: (2x3549xi64) <- (2x49x3549xf32, 1xi64)
        ...
        # pd_op.one_hot: (2x3549x49xf32) <- (2x3549xi64, 1xi32)
        one_hot_0 = paddle._C_ops.one_hot(
            argmax_0 % paddle.cast(full_2, argmax_0.dtype), full_2
        )
        del argmax_0, full_2

        # pd_op.transpose: (2x49x3549xf32) <- (2x3549x49xf32)
        transpose_0 = paddle._C_ops.transpose(one_hot_0, [0, 2, 1])
        del one_hot_0

        # pd_op.where: (2x49x3549xf32) <- (2x49x3549xb, 2x49x3549xf32, 2x49x3549xf32)
        ...
        # pd_op.sum: (2x3549xf32) <- (2x49x3549xf32, 1xi64)
        ...
        # pd_op.gather: (7098xi32) <- (98xi32, 7098xi64, 1xi32)
        ...
        # pd_op.gather: (7098x4xf32) <- (98x4xf32, 7098xi64, 1xi32)
        ...
        # pd_op.one_hot: (2x3549x11xf32) <- (2x3549xi32, 1xi32)
        ...
        # pd_op.index_select: (2x3549x10xf32) <- (2x3549x11xf32, 10xi64)
        ...
        # pd_op.max: (2x49x1xf32) <- (2x49x3549xf32, 1xi64)
        ...
        # pd_op.divide: (2x49x3549xf32) <- (2x49x3549xf32, 2x49x1xf32)
        divide_0 = paddle._C_ops.divide(multiply_2, scale_1)
        del multiply_2, scale_1

        # pd_op.multiply: (2x49x3549xf32) <- (2x49x3549xf32, 2x49x1xf32)
        multiply_4 = paddle._C_ops.multiply(divide_0, max_1)
        del divide_0, max_1

        # pd_op.max: (2x3549xf32) <- (2x49x3549xf32, 1xi64)
        ...
        # pd_op.multiply: (2x3549x10xf32) <- (2x3549x10xf32, 2x3549x1xf32)
