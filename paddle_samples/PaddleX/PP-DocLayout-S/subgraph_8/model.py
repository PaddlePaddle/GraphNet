...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.clip: (13xf32) <- (13xf32, 1xf32, 1xf32)
        ...
        del full_0, full_1, subtract_3

        # builtin.combine: ([13xf32, 13xf32, 13xf32, 13xf32]) <- (13xf32, 13xf32, 13xf32, 13xf32)
        combine_0 = [clip_0, clip_1, clip_2, clip_3]
        del clip_0, clip_1, clip_2, clip_3

        # pd_op.stack: (13x4xf32) <- ([13xf32, 13xf32, 13xf32, 13xf32])
