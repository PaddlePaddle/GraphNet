...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2):
        ...
        # pd_op.slice: (4x-1x4xf32) <- (4x-1x5xf32, 1xi64, 1xi64)
        slice_0 = paddle._C_ops.slice(
            one_hot_0, [2], full_int_array_1, full_int_array_2, [1], []
        )

        # pd_op.pow: (4x-1x4xf32) <- (4x-1x4xf32)
        ...
        # pd_op.multiply: (4x-1x4xf32) <- (4x-1x4xf32, 4x-1x4xf32)
        ...
        # pd_op.bce_loss: (4x-1x4xf32) <- (4x-1x4xf32, 4x-1x4xf32)
        ...
        # pd_op.sum: (xf32) <- (4x-1x4xf32, 0xi64)
