...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.slice: (32400xf32) <- (32400x4xf32, 1xi64, 1xi64)
        ...
        # pd_op.subtract: (32400xf32) <- (32400xf32, 32400xf32)
        ...
        # pd_op.multiply: (32400xf32) <- (32400xf32, 32400xf32)
        ...
        # pd_op.slice: (32400x2xf32) <- (32400x4xf32, 1xi64, 1xi64)
        slice_9 = paddle._C_ops.slice(
            data_1, [1], full_int_array_0, full_int_array_5, [1], []
        )
        del full_int_array_5

        # pd_op.minimum: (1x32400x2xf32) <- (1x1x2xf32, 32400x2xf32)
        ...
        # pd_op.maximum: (1x32400x2xf32) <- (1x1x2xf32, 32400x2xf32)
        maximum_0 = paddle._C_ops.maximum(slice_10, slice_11)
        del slice_10, slice_11

        # pd_op.subtract: (1x32400x2xf32) <- (1x32400x2xf32, 1x32400x2xf32)
        ...
        # pd_op.clip: (1x32400x2xf32) <- (1x32400x2xf32, 1xf32, 1xf32)
        clip_0 = paddle._C_ops.clip(subtract_4, full_0, full_1)
        del full_1, subtract_4

        # pd_op.prod: (1x32400xf32) <- (1x32400x2xf32, 1xi64)
        ...
        # pd_op.greater_than: (1x32400xb) <- (1x32400xf32, xf32)
