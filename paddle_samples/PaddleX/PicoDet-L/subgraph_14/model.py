...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.arange: (-1xi64) <- (1xi64, xi64, 1xi64)
        arange_6 = paddle.arange(full_0, data_7, full_1, dtype="int64")
        del data_7
        ...
        # pd_op.arange: (-1xi64) <- (1xi64, xi64, 1xi64)
        arange_7 = paddle.arange(full_0, data_6, full_1, dtype="int64")
        del data_6, full_0, full_1
        ...
        share_data__0 = data_8.detach()
        del data_8

        # pd_op.multiply: (8x-1x4xf32) <- (8x-1x4xf32, -1x1xf32)
        multiply_0 = paddle._C_ops.multiply(share_data__0, concat_2)
        del concat_0, concat_2, share_data__0, slice_0, slice_1, slice_2, slice_3
