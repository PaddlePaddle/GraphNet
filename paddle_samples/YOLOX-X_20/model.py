...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.slice: (49xf32) <- (49x4xf32, 1xi64, 1xi64)
        ...
        # pd_op.subtract: (49xf32) <- (49xf32, 49xf32)
        ...
        # pd_op.multiply: (49xf32) <- (49xf32, 49xf32)
        ...
        # pd_op.maximum: (49x49x2xf32) <- (49x1x2xf32, 49x2xf32)
        maximum_0 = paddle._C_ops.maximum(slice_6, slice_7)

        # pd_op.subtract: (49x49x2xf32) <- (49x49x2xf32, 49x49x2xf32)
        ...
        # pd_op.clip: (49x49x2xf32) <- (49x49x2xf32, 1xf32, 1xf32)
        clip_0 = paddle._C_ops.clip(subtract_2, full_0, full_1)

        # pd_op.prod: (49x49xf32) <- (49x49x2xf32, 1xi64)
