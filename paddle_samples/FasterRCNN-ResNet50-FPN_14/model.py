...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.transpose: (4x272x-1x3xf32) <- (4x3x272x-1xf32)
        transpose_0 = paddle._C_ops.transpose(data_0, [0, 2, 3, 1])

        # pd_op.shape64: (4xi64) <- (4x3x272x-1xf32)
        ...
        full_int_array_3 = [4, -1, 1]

        # pd_op.reshape: (4x-1x1xf32) <- (4x272x-1x3xf32, 3xi64)
        reshape_0 = paddle._C_ops.reshape(transpose_0, full_int_array_3)

        # pd_op.transpose: (4x136x-1x3xf32) <- (4x3x136x-1xf32)
        transpose_1 = paddle._C_ops.transpose(data_1, [0, 2, 3, 1])

        # pd_op.shape64: (4xi64) <- (4x3x136x-1xf32)
        ...
        # pd_op.reshape: (4x-1x1xf32) <- (4x136x-1x3xf32, 3xi64)
        reshape_1 = paddle._C_ops.reshape(transpose_1, full_int_array_3)

        # pd_op.transpose: (4x68x-1x3xf32) <- (4x3x68x-1xf32)
        transpose_2 = paddle._C_ops.transpose(data_2, [0, 2, 3, 1])

        # pd_op.shape64: (4xi64) <- (4x3x68x-1xf32)
        ...
        # pd_op.reshape: (4x-1x1xf32) <- (4x68x-1x3xf32, 3xi64)
        reshape_2 = paddle._C_ops.reshape(transpose_2, full_int_array_3)

        # pd_op.transpose: (4x34x-1x3xf32) <- (4x3x34x-1xf32)
        transpose_3 = paddle._C_ops.transpose(data_3, [0, 2, 3, 1])

        # pd_op.shape64: (4xi64) <- (4x3x34x-1xf32)
        ...
        # pd_op.reshape: (4x-1x1xf32) <- (4x34x-1x3xf32, 3xi64)
        reshape_3 = paddle._C_ops.reshape(transpose_3, full_int_array_3)

        # pd_op.transpose: (4x17x-1x3xf32) <- (4x3x17x-1xf32)
        transpose_4 = paddle._C_ops.transpose(data_4, [0, 2, 3, 1])

        # pd_op.shape64: (4xi64) <- (4x3x17x-1xf32)
        ...
        # pd_op.reshape: (4x-1x1xf32) <- (4x17x-1x3xf32, 3xi64)
        reshape_4 = paddle._C_ops.reshape(transpose_4, full_int_array_3)
        ...
        # builtin.combine: ([4x-1x1xf32, 4x-1x1xf32, 4x-1x1xf32, 4x-1x1xf32, 4x-1x1xf32]) <- (4x-1x1xf32, 4x-1x1xf32, 4x-1x1xf32, 4x-1x1xf32, 4x-1x1xf32)
        combine_1 = [reshape_0, reshape_1, reshape_2, reshape_3, reshape_4]

        # pd_op.concat: (4x-1x1xf32) <- ([4x-1x1xf32, 4x-1x1xf32, 4x-1x1xf32, 4x-1x1xf32, 4x-1x1xf32], 1xi32)
        concat_1 = paddle._C_ops.concat(combine_1, full_0)

        # pd_op.transpose: (4x272x-1x12xf32) <- (4x12x272x-1xf32)
        transpose_5 = paddle._C_ops.transpose(data_5, [0, 2, 3, 1])

        # pd_op.shape64: (4xi64) <- (4x12x272x-1xf32)
        ...
        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_4 = [4, -1, 4]

        # pd_op.reshape: (4x-1x4xf32) <- (4x272x-1x12xf32, 3xi64)
        reshape_5 = paddle._C_ops.reshape(transpose_5, full_int_array_4)

        # pd_op.transpose: (4x136x-1x12xf32) <- (4x12x136x-1xf32)
        transpose_6 = paddle._C_ops.transpose(data_6, [0, 2, 3, 1])

        # pd_op.shape64: (4xi64) <- (4x12x136x-1xf32)
        ...
        # pd_op.reshape: (4x-1x4xf32) <- (4x136x-1x12xf32, 3xi64)
        reshape_6 = paddle._C_ops.reshape(transpose_6, full_int_array_4)

        # pd_op.transpose: (4x68x-1x12xf32) <- (4x12x68x-1xf32)
        transpose_7 = paddle._C_ops.transpose(data_7, [0, 2, 3, 1])

        # pd_op.shape64: (4xi64) <- (4x12x68x-1xf32)
        ...
        # pd_op.reshape: (4x-1x4xf32) <- (4x68x-1x12xf32, 3xi64)
        reshape_7 = paddle._C_ops.reshape(transpose_7, full_int_array_4)

        # pd_op.transpose: (4x34x-1x12xf32) <- (4x12x34x-1xf32)
        transpose_8 = paddle._C_ops.transpose(data_8, [0, 2, 3, 1])

        # pd_op.shape64: (4xi64) <- (4x12x34x-1xf32)
        ...
        # pd_op.reshape: (4x-1x4xf32) <- (4x34x-1x12xf32, 3xi64)
        reshape_8 = paddle._C_ops.reshape(transpose_8, full_int_array_4)

        # pd_op.transpose: (4x17x-1x12xf32) <- (4x12x17x-1xf32)
        transpose_9 = paddle._C_ops.transpose(data_9, [0, 2, 3, 1])

        # pd_op.shape64: (4xi64) <- (4x12x17x-1xf32)
        ...
        # pd_op.reshape: (4x-1x4xf32) <- (4x17x-1x12xf32, 3xi64)
        reshape_9 = paddle._C_ops.reshape(transpose_9, full_int_array_4)

        # builtin.combine: ([4x-1x4xf32, 4x-1x4xf32, 4x-1x4xf32, 4x-1x4xf32, 4x-1x4xf32]) <- (4x-1x4xf32, 4x-1x4xf32, 4x-1x4xf32, 4x-1x4xf32, 4x-1x4xf32)
        combine_2 = [reshape_5, reshape_6, reshape_7, reshape_8, reshape_9]

        # pd_op.concat: (4x-1x4xf32) <- ([4x-1x4xf32, 4x-1x4xf32, 4x-1x4xf32, 4x-1x4xf32, 4x-1x4xf32], 1xi32)
