...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5):
        ...
        # pd_op.argmax: (1x8500xi64) <- (1x-1x8500xf32, 1xi64)
        ...
        # pd_op.gather: (8500xi32) <- (-1xi32, 8500xi64, 1xi32)
        ...
        greater_than_0 = paddle._C_ops.greater_than(data_3, full_4)
        del data_3, full_4
        ...
        reshape_2 = paddle._C_ops.reshape(data_4, full_int_array_2)
        del full_int_array_2

        # pd_op.gather: (8500x4xf32) <- (-1x4xf32, 8500xi64, 1xi32)
        ...
        unsqueeze_1 = paddle._C_ops.unsqueeze(data_4, full_int_array_4)
        del data_4
        ...
        unsqueeze_2 = paddle._C_ops.unsqueeze(data_5, full_int_array_5)
        ...
        # pd_op.maximum: (1x-1x8500x2xf32) <- (1x-1x1x2xf32, 1x1x8500x2xf32)
        maximum_0 = paddle._C_ops.maximum(slice_0, slice_2)

        # pd_op.minimum: (1x-1x8500x2xf32) <- (1x-1x1x2xf32, 1x1x8500x2xf32)
        minimum_0 = paddle._C_ops.minimum(slice_1, slice_3)

        # pd_op.subtract: (1x-1x8500x2xf32) <- (1x-1x8500x2xf32, 1x-1x8500x2xf32)
        ...
        # pd_op.clip: (1x-1x8500x2xf32) <- (1x-1x8500x2xf32, 1xf32, 1xf32)
        clip_0 = paddle._C_ops.clip(subtract_0, full_8, full_9)
        del subtract_0

        # pd_op.prod: (1x-1x8500xf32) <- (1x-1x8500x2xf32, 1xi64)
        ...
        clip_1 = paddle._C_ops.clip(subtract_1, full_8, full_9)
        del subtract_1
        ...
        clip_2 = paddle._C_ops.clip(subtract_2, full_8, full_9)
        del full_8, full_9, subtract_2

        # pd_op.prod: (1x1x8500xf32) <- (1x1x8500x2xf32, 1xi64)
        prod_2 = paddle._C_ops.prod(clip_2, full_int_array_0, False, False)
        del clip_2

        # pd_op.add: (1x-1x8500xf32) <- (1x-1x1xf32, 1x1x8500xf32)
        add_1 = paddle._C_ops.add(prod_1, prod_2)
        del prod_1, prod_2

        # pd_op.subtract: (1x-1x8500xf32) <- (1x-1x8500xf32, 1x-1x8500xf32)
        ...
        # pd_op.scale: (1x-1x8500xf32) <- (1x-1x8500xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(subtract_3, full_10, float("1e-09"), True)
        del full_10, subtract_3

        # pd_op.divide: (1x-1x8500xf32) <- (1x-1x8500xf32, 1x-1x8500xf32)
        divide_0 = paddle._C_ops.divide(prod_0, scale_0)
        del prod_0, scale_0

        # pd_op.multiply: (1x-1x8500xf32) <- (1x-1x8500xf32, 1x-1x8500xf32)
        multiply_2 = paddle._C_ops.multiply(divide_0, data_1)
        del data_1, divide_0

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_8 = [-2]

        # pd_op.max: (1x8500xf32) <- (1x-1x8500xf32, 1xi64)
        max_0 = paddle._C_ops.max(multiply_2, full_int_array_8, False)
        del full_int_array_8, multiply_2
