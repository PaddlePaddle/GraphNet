...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (2x256x-1x11xf32) <- (2x256x-1x11xf32, 256x256x3x3xf32)
        conv2d_4 = paddle._C_ops.conv2d(
            data_4, parameter_5, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.add: (2x256x-1x11xf32) <- (2x256x-1x11xf32, 1x256x1x1xf32)
        add_14 = paddle._C_ops.add(conv2d_4, reshape_0)

        # pd_op.relu: (2x256x-1x11xf32) <- (2x256x-1x11xf32)
        relu_4 = paddle._C_ops.relu(add_14)

        # pd_op.conv2d: (2x3x-1x-1xf32) <- (2x256x-1x-1xf32, 3x256x1x1xf32)
        ...
        # pd_op.add: (2x3x-1x-1xf32) <- (2x3x-1x-1xf32, 1x3x1x1xf32)
        add_0 = paddle._C_ops.add(conv2d_5, reshape_1)

        # pd_op.conv2d: (2x12x-1x-1xf32) <- (2x256x-1x-1xf32, 12x256x1x1xf32)
        ...
        # pd_op.add: (2x12x-1x-1xf32) <- (2x12x-1x-1xf32, 1x12x1x1xf32)
        ...
        # pd_op.conv2d: (2x3x-1x11xf32) <- (2x256x-1x11xf32, 3x256x1x1xf32)
        conv2d_13 = paddle._C_ops.conv2d(
            relu_4, parameter_3, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.add: (2x3x-1x11xf32) <- (2x3x-1x11xf32, 1x3x1x1xf32)
        add_4 = paddle._C_ops.add(conv2d_13, reshape_1)

        # pd_op.conv2d: (2x12x-1x11xf32) <- (2x256x-1x11xf32, 12x256x1x1xf32)
        conv2d_14 = paddle._C_ops.conv2d(
            relu_4, parameter_1, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.add: (2x12x-1x11xf32) <- (2x12x-1x11xf32, 1x12x1x1xf32)
        add_9 = paddle._C_ops.add(conv2d_14, reshape_2)

        # pd_op.shape64: (4xi64) <- (2x256x-1x-1xf32)
        ...
        # pd_op.shape64: (4xi64) <- (2x256x-1x11xf32)
        ...
        reshape_3 = paddle._C_ops.reshape(add_15, full_int_array_7)
        ...
        # pd_op.reshape: (-1x4xf32) <- (-1x3x4xf32, 2xi64)
        reshape_4 = paddle._C_ops.reshape(add_16, full_int_array_7)
        ...
        # pd_op.reshape: (-1x4xf32) <- (-1x3x4xf32, 2xi64)
        reshape_5 = paddle._C_ops.reshape(add_17, full_int_array_7)
        ...
        # pd_op.reshape: (-1x4xf32) <- (-1x3x4xf32, 2xi64)
        reshape_6 = paddle._C_ops.reshape(add_18, full_int_array_7)
        ...
        arange_8 = paddle.arange(full_5, full_6, full_7, dtype="float32")
        ...
        # pd_op.scale: (xi64) <- (xi64, 1xf32)
        scale_8 = paddle._C_ops.scale(slice_8, full_8, float("0"), True)

        # pd_op.cast: (xf32) <- (xi64)
        cast_8 = paddle._C_ops.cast(scale_8, paddle.float32)

        # pd_op.arange: (-1xf32) <- (1xf32, xf32, 1xf32)
        arange_9 = paddle.arange(full_1, cast_8, full_8, dtype="float32")

        # builtin.combine: ([-1xf32, 11xf32]) <- (-1xf32, 11xf32)
        combine_8 = [arange_9, arange_8]

        # pd_op.meshgrid: ([-1x11xf32, -1x11xf32]) <- ([-1xf32, 11xf32])
        meshgrid_4 = paddle._C_ops.meshgrid(combine_8)

        # builtin.split: (-1x11xf32, -1x11xf32) <- ([-1x11xf32, -1x11xf32])
        (
            split_8,
            split_9,
        ) = meshgrid_4

        # pd_op.reshape: (-1xf32) <- (-1x11xf32, 1xi64)
        ...
        # pd_op.reshape: (-1x4xf32) <- (-1x3x4xf32, 2xi64)
        reshape_7 = paddle._C_ops.reshape(add_19, full_int_array_7)
        return (
            conv2d_0,
            reshape_0,
            relu_0,
