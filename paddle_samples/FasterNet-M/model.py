...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (64x144x56x56xf32) <- (64x3x224x224xf32, 144x3x4x4xf32)
        conv2d_0 = paddle._C_ops.conv2d(
            data_0, parameter_218, [4, 4], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (64x144x56x56xf32, 144xf32, 144xf32, 144xf32, 144xf32, -1xui8) <- (64x144x56x56xf32, 144xf32, 144xf32, 144xf32, 144xf32)
        (
            batch_norm__0,
            batch_norm__1,
            batch_norm__2,
        ...
        # pd_op.split: ([64x36x56x56xf32, 64x108x56x56xf32]) <- (64x144x56x56xf32, 2xi64, 1xi32)
        split_56 = paddle._C_ops.split(batch_norm__0, full_int_array_1, full_0)

        # builtin.split: (64x36x56x56xf32, 64x108x56x56xf32) <- ([64x36x56x56xf32, 64x108x56x56xf32])
        (
            split_0,
            split_1,
        ) = split_56

        # pd_op.conv2d: (64x36x56x56xf32) <- (64x36x56x56xf32, 36x36x3x3xf32)
        conv2d_1 = paddle._C_ops.conv2d(
            split_0, parameter_213, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # builtin.combine: ([64x36x56x56xf32, 64x108x56x56xf32]) <- (64x36x56x56xf32, 64x108x56x56xf32)
        combine_0 = [conv2d_1, split_1]

        # pd_op.concat: (64x144x56x56xf32) <- ([64x36x56x56xf32, 64x108x56x56xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_0)

        # pd_op.conv2d: (64x288x56x56xf32) <- (64x144x56x56xf32, 288x144x1x1xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            concat_0, parameter_212, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (64x288x56x56xf32, 288xf32, 288xf32, 288xf32, 288xf32, -1xui8) <- (64x288x56x56xf32, 288xf32, 288xf32, 288xf32, 288xf32)
        (
            batch_norm__164,
            batch_norm__6,
            batch_norm__7,
        ...
        # pd_op.relu: (64x288x56x56xf32) <- (64x288x56x56xf32)
        relu_0 = paddle._C_ops.relu(batch_norm__164)

        # pd_op.conv2d: (64x144x56x56xf32) <- (64x288x56x56xf32, 144x288x1x1xf32)
        conv2d_3 = paddle._C_ops.conv2d(
            relu_0, parameter_207, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.add: (64x144x56x56xf32) <- (64x144x56x56xf32, 64x144x56x56xf32)
        ...
        # pd_op.divide: (64x144x56x56xf32) <- (64x144x56x56xf32, xf32)
        divide_0 = paddle._C_ops.divide(conv2d_6, full_1)

        # pd_op.multiply: (64x144x56x56xf32) <- (64x144x56x56xf32, 64x1x1x1xf32)
        ...
        # pd_op.conv2d: (64x288x28x28xf32) <- (64x144x56x56xf32, 288x144x2x2xf32)
        conv2d_10 = paddle._C_ops.conv2d(
            add_2, parameter_192, [2, 2], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (64x288x28x28xf32, 288xf32, 288xf32, 288xf32, 288xf32, -1xui8) <- (64x288x28x28xf32, 288xf32, 288xf32, 288xf32, 288xf32)
        (
            batch_norm__21,
            batch_norm__22,
            batch_norm__23,
        ...
        # pd_op.split: ([64x72x28x28xf32, 64x216x28x28xf32]) <- (64x288x28x28xf32, 2xi64, 1xi32)
        split_59 = paddle._C_ops.split(batch_norm__21, full_int_array_3, full_0)

        # builtin.split: (64x72x28x28xf32, 64x216x28x28xf32) <- ([64x72x28x28xf32, 64x216x28x28xf32])
        (
            split_6,
            split_7,
        ) = split_59

        # pd_op.conv2d: (64x72x28x28xf32) <- (64x72x28x28xf32, 72x72x3x3xf32)
        conv2d_11 = paddle._C_ops.conv2d(
            split_6, parameter_187, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # builtin.combine: ([64x72x28x28xf32, 64x216x28x28xf32]) <- (64x72x28x28xf32, 64x216x28x28xf32)
        combine_3 = [conv2d_11, split_7]

        # pd_op.concat: (64x288x28x28xf32) <- ([64x72x28x28xf32, 64x216x28x28xf32], 1xi32)
        concat_3 = paddle._C_ops.concat(combine_3, full_0)

        # pd_op.conv2d: (64x576x28x28xf32) <- (64x288x28x28xf32, 576x288x1x1xf32)
        conv2d_12 = paddle._C_ops.conv2d(
            concat_3, parameter_186, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (64x576x28x28xf32, 576xf32, 576xf32, 576xf32, 576xf32, -1xui8) <- (64x576x28x28xf32, 576xf32, 576xf32, 576xf32, 576xf32)
        (
            batch_norm__167,
            batch_norm__27,
            batch_norm__28,
        ...
        # pd_op.relu: (64x576x28x28xf32) <- (64x576x28x28xf32)
        relu_3 = paddle._C_ops.relu(batch_norm__167)

        # pd_op.conv2d: (64x288x28x28xf32) <- (64x576x28x28xf32, 288x576x1x1xf32)
        ...
        # pd_op.divide: (64x288x28x28xf32) <- (64x288x28x28xf32, xf32)
        divide_2 = paddle._C_ops.divide(conv2d_13, full_3)

        # pd_op.multiply: (64x288x28x28xf32) <- (64x288x28x28xf32, 64x1x1x1xf32)
        multiply_2 = paddle._C_ops.multiply(divide_2, floor_2)

        # pd_op.add: (64x288x28x28xf32) <- (64x288x28x28xf32, 64x288x28x28xf32)
        ...
        # pd_op.conv2d: (64x576x14x14xf32) <- (64x288x28x28xf32, 576x288x2x2xf32)
        conv2d_23 = paddle._C_ops.conv2d(
            add_6, parameter_159, [2, 2], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (64x576x14x14xf32, 576xf32, 576xf32, 576xf32, 576xf32, -1xui8) <- (64x576x14x14xf32, 576xf32, 576xf32, 576xf32, 576xf32)
        (
            batch_norm__47,
            batch_norm__48,
            batch_norm__49,
        ...
        # pd_op.split: ([64x144x14x14xf32, 64x432x14x14xf32]) <- (64x576x14x14xf32, 2xi64, 1xi32)
        split_63 = paddle._C_ops.split(batch_norm__47, full_int_array_4, full_0)

        # builtin.split: (64x144x14x14xf32, 64x432x14x14xf32) <- ([64x144x14x14xf32, 64x432x14x14xf32])
        (
            split_14,
            split_15,
        ) = split_63

        # pd_op.conv2d: (64x144x14x14xf32) <- (64x144x14x14xf32, 144x144x3x3xf32)
        conv2d_24 = paddle._C_ops.conv2d(
            split_14, parameter_154, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # builtin.combine: ([64x144x14x14xf32, 64x432x14x14xf32]) <- (64x144x14x14xf32, 64x432x14x14xf32)
        combine_7 = [conv2d_24, split_15]

        # pd_op.concat: (64x576x14x14xf32) <- ([64x144x14x14xf32, 64x432x14x14xf32], 1xi32)
        concat_7 = paddle._C_ops.concat(combine_7, full_0)

        # pd_op.conv2d: (64x1152x14x14xf32) <- (64x576x14x14xf32, 1152x576x1x1xf32)
        conv2d_25 = paddle._C_ops.conv2d(
            concat_7, parameter_153, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (64x1152x14x14xf32, 1152xf32, 1152xf32, 1152xf32, 1152xf32, -1xui8) <- (64x1152x14x14xf32, 1152xf32, 1152xf32, 1152xf32, 1152xf32)
        (
            batch_norm__171,
            batch_norm__53,
            batch_norm__54,
        ...
        # pd_op.relu: (64x1152x14x14xf32) <- (64x1152x14x14xf32)
        relu_7 = paddle._C_ops.relu(batch_norm__171)

        # pd_op.conv2d: (64x576x14x14xf32) <- (64x1152x14x14xf32, 576x1152x1x1xf32)
        ...
        # pd_op.divide: (64x576x14x14xf32) <- (64x576x14x14xf32, xf32)
        divide_6 = paddle._C_ops.divide(conv2d_26, full_7)

        # pd_op.multiply: (64x576x14x14xf32) <- (64x576x14x14xf32, 64x1x1x1xf32)
        multiply_6 = paddle._C_ops.multiply(divide_6, floor_6)

        # pd_op.add: (64x576x14x14xf32) <- (64x576x14x14xf32, 64x576x14x14xf32)
        ...
        # pd_op.conv2d: (64x1152x7x7xf32) <- (64x576x14x14xf32, 1152x576x2x2xf32)
        conv2d_78 = paddle._C_ops.conv2d(
            add_24, parameter_28, [2, 2], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (64x1152x7x7xf32, 1152xf32, 1152xf32, 1152xf32, 1152xf32, -1xui8) <- (64x1152x7x7xf32, 1152xf32, 1152xf32, 1152xf32, 1152xf32)
        (
            batch_norm__143,
            batch_norm__144,
            batch_norm__145,
        ...
        # pd_op.split: ([64x288x7x7xf32, 64x864x7x7xf32]) <- (64x1152x7x7xf32, 2xi64, 1xi32)
        split_81 = paddle._C_ops.split(batch_norm__143, full_int_array_5, full_0)

        # builtin.split: (64x288x7x7xf32, 64x864x7x7xf32) <- ([64x288x7x7xf32, 64x864x7x7xf32])
        (
            split_50,
            split_51,
        ) = split_81

        # pd_op.conv2d: (64x288x7x7xf32) <- (64x288x7x7xf32, 288x288x3x3xf32)
        conv2d_79 = paddle._C_ops.conv2d(
            split_50, parameter_23, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # builtin.combine: ([64x288x7x7xf32, 64x864x7x7xf32]) <- (64x288x7x7xf32, 64x864x7x7xf32)
        combine_25 = [conv2d_79, split_51]

        # pd_op.concat: (64x1152x7x7xf32) <- ([64x288x7x7xf32, 64x864x7x7xf32], 1xi32)
        concat_25 = paddle._C_ops.concat(combine_25, full_0)

        # pd_op.conv2d: (64x2304x7x7xf32) <- (64x1152x7x7xf32, 2304x1152x1x1xf32)
        conv2d_80 = paddle._C_ops.conv2d(
            concat_25, parameter_22, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (64x2304x7x7xf32, 2304xf32, 2304xf32, 2304xf32, 2304xf32, -1xui8) <- (64x2304x7x7xf32, 2304xf32, 2304xf32, 2304xf32, 2304xf32)
        (
            batch_norm__189,
            batch_norm__149,
            batch_norm__150,
        ...
        # pd_op.relu: (64x2304x7x7xf32) <- (64x2304x7x7xf32)
        relu_25 = paddle._C_ops.relu(batch_norm__189)

        # pd_op.conv2d: (64x1152x7x7xf32) <- (64x2304x7x7xf32, 1152x2304x1x1xf32)
        ...
        # pd_op.divide: (64x1152x7x7xf32) <- (64x1152x7x7xf32, xf32)
        divide_24 = paddle._C_ops.divide(conv2d_81, full_25)

        # pd_op.multiply: (64x1152x7x7xf32) <- (64x1152x7x7xf32, 64x1x1x1xf32)
        multiply_24 = paddle._C_ops.multiply(divide_24, floor_24)

        # pd_op.add: (64x1152x7x7xf32) <- (64x1152x7x7xf32, 64x1152x7x7xf32)
        ...
        # pd_op.pool2d: (64x1152x1x1xf32) <- (64x1152x7x7xf32, 2xi64)
        ...
        # pd_op.conv2d: (64x1280x1x1xf32) <- (64x1152x1x1xf32, 1280x1152x1x1xf32)
