...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.greater_than: (1x1x-1xb) <- (1x1x-1xf32, xf32)
        ...
        # pd_op.tile: (1x-1x-1xb) <- (1x1x-1xb, 3xi64)
        ...
        # pd_op.add: (1x-1xi64) <- (1x-1xi64, 1x1xi64)
        ...
        # pd_op.full_like: (1x-1xi32) <- (1x-1xi32, 1xf32)
        full_like_0 = paddle._C_ops.full_like(
            reshape_1, full_5, paddle.int32, paddle.framework._current_expected_place()
        )
        del full_5

        # pd_op.where: (1x-1xi32) <- (1x-1xb, 1x-1xi32, 1x-1xi32)
        ...
        # builtin.combine: ([xi64, xi64, xi64]) <- (xi64, xi64, xi64)
        combine_2 = [full_1, data_1, full_6]
        del data_1, full_1, full_6

        # pd_op.stack: (3xi64) <- ([xi64, xi64, xi64])
        stack_2 = paddle._C_ops.stack(combine_2, 0)
        del combine_2

        # pd_op.reshape: (1x-1x4xf32) <- (-1x4xf32, 3xi64)
        ...
        # pd_op.one_hot: (1x-1x11xf32) <- (1x-1xi32, 1xi32)
        ...
        # pd_op.index_select: (1x-1x10xf32) <- (1x-1x11xf32, 10xi64)
        ...
        scale_0 = paddle._C_ops.scale(max_0, full_9, float("1e-09"), True)
        del full_9, max_0
        ...
        # pd_op.multiply: (1x-1x10xf32) <- (1x-1x10xf32, 1x-1x1xf32)
