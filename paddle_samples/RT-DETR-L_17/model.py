...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.sigmoid: (8x256x-1x-1xf32) <- (8x256x-1x-1xf32)
        sigmoid_0 = paddle._C_ops.sigmoid(batch_norm__0)

        # pd_op.multiply: (8x256x-1x-1xf32) <- (8x256x-1x-1xf32, 8x256x-1x-1xf32)
        ...
        # pd_op.conv2d: (8x256x-1x-1xf32) <- (8x256x-1x-1xf32, 256x256x1x1xf32)
        ...
        # pd_op.silu: (8x256x-1x-1xf32) <- (8x256x-1x-1xf32)
