class Program_weight_tensor_data_0:
    ...
    shape = [1, 256, 304, 200]
    dtype = "float32"
    min_val = float("-7.85653")
    max_val = float("6.19078")
    mean = float("0.010165")
    std = float("0.879755")
    data = None
...
class Program_weight_tensor_data_1:
    ...
    shape = [1, 256, 152, 100]
    dtype = "float32"
    min_val = float("-6.10409")
    max_val = float("5.63578")
    mean = float("0.00967448")
    std = float("0.719581")
    data = None
...
class Program_weight_tensor_data_2:
    ...
    shape = [1, 256, 76, 50]
    dtype = "float32"
    min_val = float("-6.70674")
    max_val = float("6.35431")
    mean = float("0.0130338")
    std = float("0.693341")
    data = None
...
class Program_weight_tensor_data_3:
    ...
    shape = [1, 256, 38, 25]
    dtype = "float32"
    min_val = float("-5.17124")
    max_val = float("7.06858")
    mean = float("0.00335256")
    std = float("0.670979")
    data = None
...
class Program_weight_tensor_data_4:
    ...
    shape = [1, 256, 19, 13]
    dtype = "float32"
    min_val = float("-4.47196")
    max_val = float("6.38939")
    mean = float("0.00690469")
    std = float("0.680487")
    data = None
