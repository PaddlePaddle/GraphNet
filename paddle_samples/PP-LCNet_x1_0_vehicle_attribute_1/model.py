...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (64x16x96x128xf32) <- (64x3x192x256xf32, 16x3x3x3xf32)
        conv2d_0 = paddle._C_ops.conv2d(
            data_0, parameter_145, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (64x16x96x128xf32, 16xf32, 16xf32, 16xf32, 16xf32, -1xui8) <- (64x16x96x128xf32, 16xf32, 16xf32, 16xf32, 16xf32)
        (
            batch_norm__0,
            batch_norm__1,
            batch_norm__2,
        ...
        # pd_op.hardswish: (64x16x96x128xf32) <- (64x16x96x128xf32)
        hardswish_0 = paddle._C_ops.hardswish(batch_norm__0)

        # pd_op.depthwise_conv2d: (64x16x96x128xf32) <- (64x16x96x128xf32, 16x1x3x3xf32)
        ...
        # pd_op.conv2d: (64x32x96x128xf32) <- (64x16x96x128xf32, 32x16x1x1xf32)
        conv2d_1 = paddle._C_ops.conv2d(
            hardswish_1, parameter_135, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (64x32x96x128xf32, 32xf32, 32xf32, 32xf32, 32xf32, -1xui8) <- (64x32x96x128xf32, 32xf32, 32xf32, 32xf32, 32xf32)
        (
            batch_norm__12,
            batch_norm__13,
            batch_norm__14,
        ...
        # pd_op.hardswish: (64x32x96x128xf32) <- (64x32x96x128xf32)
        hardswish_2 = paddle._C_ops.hardswish(batch_norm__12)

        # pd_op.depthwise_conv2d: (64x32x48x64xf32) <- (64x32x96x128xf32, 32x1x3x3xf32)
        depthwise_conv2d_1 = paddle._C_ops.depthwise_conv2d(
            hardswish_2, parameter_130, [2, 2], [1, 1], "EXPLICIT", 32, [1, 1], "NCHW"
        )

        # pd_op.batch_norm_: (64x32x48x64xf32, 32xf32, 32xf32, 32xf32, 32xf32, -1xui8) <- (64x32x48x64xf32, 32xf32, 32xf32, 32xf32, 32xf32)
        (
            batch_norm__18,
            batch_norm__19,
            batch_norm__20,
        ...
        # pd_op.hardswish: (64x32x48x64xf32) <- (64x32x48x64xf32)
        hardswish_3 = paddle._C_ops.hardswish(batch_norm__18)

        # pd_op.conv2d: (64x64x48x64xf32) <- (64x32x48x64xf32, 64x32x1x1xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            hardswish_3, parameter_125, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (64x64x48x64xf32, 64xf32, 64xf32, 64xf32, 64xf32, -1xui8) <- (64x64x48x64xf32, 64xf32, 64xf32, 64xf32, 64xf32)
        (
            batch_norm__24,
            batch_norm__25,
            batch_norm__26,
        ...
        # pd_op.hardswish: (64x64x48x64xf32) <- (64x64x48x64xf32)
        hardswish_4 = paddle._C_ops.hardswish(batch_norm__24)

        # pd_op.depthwise_conv2d: (64x64x48x64xf32) <- (64x64x48x64xf32, 64x1x3x3xf32)
        ...
        # pd_op.conv2d: (64x64x48x64xf32) <- (64x64x48x64xf32, 64x64x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (64x64x24x32xf32) <- (64x64x48x64xf32, 64x1x3x3xf32)
        depthwise_conv2d_3 = paddle._C_ops.depthwise_conv2d(
            hardswish_6, parameter_110, [2, 2], [1, 1], "EXPLICIT", 64, [1, 1], "NCHW"
        )

        # pd_op.batch_norm_: (64x64x24x32xf32, 64xf32, 64xf32, 64xf32, 64xf32, -1xui8) <- (64x64x24x32xf32, 64xf32, 64xf32, 64xf32, 64xf32)
        (
            batch_norm__42,
            batch_norm__43,
            batch_norm__44,
        ...
        # pd_op.hardswish: (64x64x24x32xf32) <- (64x64x24x32xf32)
        hardswish_7 = paddle._C_ops.hardswish(batch_norm__42)

        # pd_op.conv2d: (64x128x24x32xf32) <- (64x64x24x32xf32, 128x64x1x1xf32)
        conv2d_4 = paddle._C_ops.conv2d(
            hardswish_7, parameter_105, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (64x128x24x32xf32, 128xf32, 128xf32, 128xf32, 128xf32, -1xui8) <- (64x128x24x32xf32, 128xf32, 128xf32, 128xf32, 128xf32)
        (
            batch_norm__48,
            batch_norm__49,
            batch_norm__50,
        ...
        # pd_op.hardswish: (64x128x24x32xf32) <- (64x128x24x32xf32)
        hardswish_8 = paddle._C_ops.hardswish(batch_norm__48)

        # pd_op.depthwise_conv2d: (64x128x24x32xf32) <- (64x128x24x32xf32, 128x1x3x3xf32)
        ...
        # pd_op.conv2d: (64x128x24x32xf32) <- (64x128x24x32xf32, 128x128x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (64x128x12x16xf32) <- (64x128x24x32xf32, 128x1x3x3xf32)
        depthwise_conv2d_5 = paddle._C_ops.depthwise_conv2d(
            hardswish_10, parameter_90, [2, 2], [1, 1], "EXPLICIT", 128, [1, 1], "NCHW"
        )

        # pd_op.batch_norm_: (64x128x12x16xf32, 128xf32, 128xf32, 128xf32, 128xf32, -1xui8) <- (64x128x12x16xf32, 128xf32, 128xf32, 128xf32, 128xf32)
        (
            batch_norm__66,
            batch_norm__67,
            batch_norm__68,
        ...
        # pd_op.hardswish: (64x128x12x16xf32) <- (64x128x12x16xf32)
        hardswish_11 = paddle._C_ops.hardswish(batch_norm__66)

        # pd_op.conv2d: (64x256x12x16xf32) <- (64x128x12x16xf32, 256x128x1x1xf32)
        conv2d_6 = paddle._C_ops.conv2d(
            hardswish_11, parameter_85, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (64x256x12x16xf32, 256xf32, 256xf32, 256xf32, 256xf32, -1xui8) <- (64x256x12x16xf32, 256xf32, 256xf32, 256xf32, 256xf32)
        (
            batch_norm__72,
            batch_norm__73,
            batch_norm__74,
        ...
        # pd_op.hardswish: (64x256x12x16xf32) <- (64x256x12x16xf32)
        hardswish_12 = paddle._C_ops.hardswish(batch_norm__72)

        # pd_op.depthwise_conv2d: (64x256x12x16xf32) <- (64x256x12x16xf32, 256x1x5x5xf32)
        ...
        # pd_op.conv2d: (64x256x12x16xf32) <- (64x256x12x16xf32, 256x256x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (64x256x6x8xf32) <- (64x256x12x16xf32, 256x1x5x5xf32)
        depthwise_conv2d_11 = paddle._C_ops.depthwise_conv2d(
            hardswish_22, parameter_30, [2, 2], [2, 2], "EXPLICIT", 256, [1, 1], "NCHW"
        )

        # pd_op.batch_norm_: (64x256x6x8xf32, 256xf32, 256xf32, 256xf32, 256xf32, -1xui8) <- (64x256x6x8xf32, 256xf32, 256xf32, 256xf32, 256xf32)
        (
            batch_norm__138,
            batch_norm__139,
            batch_norm__140,
        ...
        # pd_op.hardswish: (64x256x6x8xf32) <- (64x256x6x8xf32)
        ...
        # pd_op.pool2d: (64x256x1x1xf32) <- (64x256x6x8xf32, 2xi64)
        ...
        # pd_op.multiply: (64x256x6x8xf32) <- (64x256x6x8xf32, 64x256x1x1xf32)
        multiply_0 = paddle._C_ops.multiply(hardswish_23, hardsigmoid_0)

        # pd_op.conv2d: (64x512x6x8xf32) <- (64x256x6x8xf32, 512x256x1x1xf32)
        conv2d_14 = paddle._C_ops.conv2d(
            multiply_0, parameter_21, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (64x512x6x8xf32, 512xf32, 512xf32, 512xf32, 512xf32, -1xui8) <- (64x512x6x8xf32, 512xf32, 512xf32, 512xf32, 512xf32)
        (
            batch_norm__144,
            batch_norm__145,
            batch_norm__146,
        ...
        # pd_op.hardswish: (64x512x6x8xf32) <- (64x512x6x8xf32)
        hardswish_24 = paddle._C_ops.hardswish(batch_norm__144)

        # pd_op.depthwise_conv2d: (64x512x6x8xf32) <- (64x512x6x8xf32, 512x1x5x5xf32)
        ...
        # pd_op.pool2d: (64x512x1x1xf32) <- (64x512x6x8xf32, 2xi64)
        ...
        # pd_op.multiply: (64x512x6x8xf32) <- (64x512x6x8xf32, 64x512x1x1xf32)
        multiply_1 = paddle._C_ops.multiply(hardswish_25, hardsigmoid_1)

        # pd_op.conv2d: (64x512x6x8xf32) <- (64x512x6x8xf32, 512x512x1x1xf32)
