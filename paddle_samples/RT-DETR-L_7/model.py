...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        full_int_array_1 = [8, 9261, 8, 32]

        # pd_op.reshape: (8x9261x8x32xf32) <- (8x9261x256xf32, 4xi64)
        ...
        full_int_array_2 = [8, 500, 8, 3, 4, 2]
        ...
        # pd_op.split: ([-1x-1x-1x-1xf32, -1x-1x-1x-1xf32, -1x-1x-1x-1xf32]) <- (8x9261x8x32xf32, 3xi64, 1xi32)
