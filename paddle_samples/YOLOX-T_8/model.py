...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.slice: (76xf32) <- (76x4xf32, 1xi64, 1xi64)
        ...
        # pd_op.subtract: (76xf32) <- (76xf32, 76xf32)
        ...
        # pd_op.multiply: (76xf32) <- (76xf32, 76xf32)
        ...
        # pd_op.maximum: (76x76x2xf32) <- (76x1x2xf32, 76x2xf32)
        maximum_0 = paddle._C_ops.maximum(slice_6, slice_7)

        # pd_op.subtract: (76x76x2xf32) <- (76x76x2xf32, 76x76x2xf32)
        ...
        # pd_op.clip: (76x76x2xf32) <- (76x76x2xf32, 1xf32, 1xf32)
        clip_0 = paddle._C_ops.clip(subtract_2, full_0, full_1)

        # pd_op.prod: (76x76xf32) <- (76x76x2xf32, 1xi64)
