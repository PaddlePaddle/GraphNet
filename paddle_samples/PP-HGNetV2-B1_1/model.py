...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        add_1 = paddle._C_ops.add(multiply_0, data_2)
        ...
        add_2 = paddle._C_ops.add(multiply_1, data_4)
        ...
        # pd_op.add: (-1x24x112x112xf32) <- (-1x24x112x112xf32, 1xf32)
        add_3 = paddle._C_ops.add(multiply_2, data_6)
        ...
        add_4 = paddle._C_ops.add(multiply_3, data_8)
        ...
        add_5 = paddle._C_ops.add(multiply_4, data_10)
        ...
        # pd_op.add: (-1x32x56x56xf32) <- (-1x32x56x56xf32, 1xf32)
        add_6 = paddle._C_ops.add(multiply_5, data_12)
        ...
        # pd_op.add: (-1x32x56x56xf32) <- (-1x32x56x56xf32, 1xf32)
        add_7 = paddle._C_ops.add(multiply_6, data_14)
        ...
        # pd_op.add: (-1x32x56x56xf32) <- (-1x32x56x56xf32, 1xf32)
        add_8 = paddle._C_ops.add(multiply_7, data_16)
        ...
        # pd_op.add: (-1x32x56x56xf32) <- (-1x32x56x56xf32, 1xf32)
        add_9 = paddle._C_ops.add(multiply_8, data_18)
        ...
        add_10 = paddle._C_ops.add(multiply_9, data_20)
        ...
        add_11 = paddle._C_ops.add(multiply_10, data_22)
        ...
        # pd_op.add: (-1x48x28x28xf32) <- (-1x48x28x28xf32, 1xf32)
        add_12 = paddle._C_ops.add(multiply_11, data_24)
        ...
        # pd_op.add: (-1x48x28x28xf32) <- (-1x48x28x28xf32, 1xf32)
        add_13 = paddle._C_ops.add(multiply_12, data_26)
        ...
        add_14 = paddle._C_ops.add(multiply_13, data_28)
        ...
        add_15 = paddle._C_ops.add(multiply_14, data_30)
        ...
        add_16 = paddle._C_ops.add(multiply_15, data_32)
        ...
        # pd_op.add: (-1x96x14x14xf32) <- (-1x96x14x14xf32, 1xf32)
        add_17 = paddle._C_ops.add(multiply_16, data_34)
        ...
        # pd_op.add: (-1x96x14x14xf32) <- (-1x96x14x14xf32, 1xf32)
        add_18 = paddle._C_ops.add(multiply_17, data_36)
        ...
        add_19 = paddle._C_ops.add(multiply_18, data_38)
        ...
        add_20 = paddle._C_ops.add(multiply_19, data_40)
        ...
        # pd_op.add: (-1x96x14x14xf32) <- (-1x96x14x14xf32, 1xf32)
        add_21 = paddle._C_ops.add(multiply_20, data_42)
        ...
        # pd_op.add: (-1x96x14x14xf32) <- (-1x96x14x14xf32, 1xf32)
        add_22 = paddle._C_ops.add(multiply_21, data_44)
        ...
        # pd_op.add: (-1x96x14x14xf32) <- (-1x96x14x14xf32, 1xf32)
        add_23 = paddle._C_ops.add(multiply_22, data_46)
        ...
        # pd_op.add: (-1x256x14x14xf32) <- (-1x256x14x14xf32, 1xf32)
        add_24 = paddle._C_ops.add(multiply_23, data_48)
        ...
        # pd_op.add: (-1x512x14x14xf32) <- (-1x512x14x14xf32, 1xf32)
        add_25 = paddle._C_ops.add(multiply_24, data_50)
        ...
        add_27 = paddle._C_ops.add(multiply_25, data_52)
        ...
        # pd_op.add: (-1x192x7x7xf32) <- (-1x192x7x7xf32, 1xf32)
        add_28 = paddle._C_ops.add(multiply_26, data_54)
        ...
        # pd_op.add: (-1x192x7x7xf32) <- (-1x192x7x7xf32, 1xf32)
        add_29 = paddle._C_ops.add(multiply_27, data_56)
        ...
        add_30 = paddle._C_ops.add(multiply_28, data_58)
        ...
        add_31 = paddle._C_ops.add(multiply_29, data_60)
        ...
        add_32 = paddle._C_ops.add(multiply_30, data_62)
