...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        conv2d_0 = paddle._C_ops.conv2d(
            data_0, parameter_106, [2, 2], [3, 3], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_2 = paddle._C_ops.conv2d(
            relu_1, parameter_96, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_4 = paddle._C_ops.conv2d(
            relu_2, parameter_86, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_5 = paddle._C_ops.conv2d(
            relu_3, parameter_81, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_6 = paddle._C_ops.conv2d(
            relu_4, parameter_76, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_7 = paddle._C_ops.conv2d(
            relu_5, parameter_71, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_8 = paddle._C_ops.conv2d(
            relu_4, parameter_66, [2, 2], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        add_3 = paddle._C_ops.add(batch_norm__42, batch_norm__48)
        ...
        conv2d_9 = paddle._C_ops.conv2d(
            relu_6, parameter_61, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_10 = paddle._C_ops.conv2d(
            relu_7, parameter_56, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.add: (-1x128x28x28xf32) <- (-1x128x28x28xf32, -1x128x28x28xf32)
        add_4 = paddle._C_ops.add(batch_norm__60, relu_6)
        ...
        conv2d_11 = paddle._C_ops.conv2d(
            relu_8, parameter_51, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_12 = paddle._C_ops.conv2d(
            relu_9, parameter_46, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_13 = paddle._C_ops.conv2d(
            relu_8, parameter_41, [2, 2], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        add_5 = paddle._C_ops.add(batch_norm__72, batch_norm__78)
        ...
        conv2d_14 = paddle._C_ops.conv2d(
            relu_10, parameter_36, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_15 = paddle._C_ops.conv2d(
            relu_11, parameter_31, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.add: (-1x256x14x14xf32) <- (-1x256x14x14xf32, -1x256x14x14xf32)
        add_6 = paddle._C_ops.add(batch_norm__90, relu_10)
        ...
        conv2d_16 = paddle._C_ops.conv2d(
            relu_12, parameter_26, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_17 = paddle._C_ops.conv2d(
            relu_13, parameter_21, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_18 = paddle._C_ops.conv2d(
            relu_12, parameter_16, [2, 2], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        add_7 = paddle._C_ops.add(batch_norm__102, batch_norm__108)
        ...
        conv2d_19 = paddle._C_ops.conv2d(
            relu_14, parameter_11, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x512x7x7xf32) <- (-1x512x7x7xf32)
        relu_15 = paddle._C_ops.relu(batch_norm__114)

        # pd_op.conv2d: (-1x512x7x7xf32) <- (-1x512x7x7xf32, 512x512x3x3xf32)
        conv2d_20 = paddle._C_ops.conv2d(
            relu_15, parameter_6, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.add: (-1x512x7x7xf32) <- (-1x512x7x7xf32, -1x512x7x7xf32)
        add_8 = paddle._C_ops.add(batch_norm__120, relu_14)
