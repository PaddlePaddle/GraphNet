...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.greater_than: (-1x11xb) <- (-1x11xf32, xf32)
        ...
        # pd_op.multiply: (-1x11xf32) <- (-1x11xf32, -1x11xf32)
        multiply_0 = paddle._C_ops.multiply(cast_0, cast_1)

        # pd_op.subtract: (-1x11xf32) <- (-1x11xf32, -1x11xf32)
        subtract_0 = paddle._C_ops.subtract(data_0, cast_0)

        # pd_op.abs: (-1x11xf32) <- (-1x11xf32)
        abs_0 = paddle._C_ops.abs(subtract_0)

        # pd_op.pow: (-1x11xf32) <- (-1x11xf32)
        ...
        # pd_op.less_equal: (-1x11xb) <- (-1x11xf32, xf32)
        ...
        # pd_op.add: (-1x11xf32) <- (-1x11xf32, -1x11xf32)
        add_0 = paddle._C_ops.add(multiply_0, multiply_1)

        # pd_op.bce_loss: (-1x11xf32) <- (-1x11xf32, -1x11xf32)
        ...
        # pd_op.sum: (-1xf32) <- (-1x11xf32, 1xi64)
