...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.slice: (300x136x136xf32) <- (1x300x136x136xf32, 1xi64, 1xi64)
        slice_3 = paddle._C_ops.slice(
            data_7, [0], full_int_array_0, full_int_array_1, [1], [0]
        )
        del data_7, full_int_array_0

        # pd_op.gather: (1x136x136xf32) <- (300x136x136xf32, 1xi64, 1xi32)
        ...
        assign_44 = full_int_array_8

        # pd_op.squeeze: (1x37632xf32) <- (1x1x1x37632xf32, 2xi64)
        squeeze_0 = paddle._C_ops.squeeze(grid_sample_0, full_int_array_8)
        del grid_sample_0
        ...
        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_9 = [1, 9408]

        # pd_op.tile: (1x9408xi64) <- (1x1xi64, 2xi64)
        tile_0 = paddle._C_ops.tile(unsqueeze_1, full_int_array_9)
        del full_int_array_9, unsqueeze_1
        ...
        squeeze_2 = paddle._C_ops.squeeze(grid_sample_1, full_int_array_8)
        ...
        # pd_op.squeeze: (1x12544xf32) <- (1x1x1x12544xf32, 2xi64)
        squeeze_3 = paddle._C_ops.squeeze(grid_sample_2, full_int_array_8)
        del full_int_array_8, grid_sample_2
