...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        combine_2 = [slice_0, full_13, full_13, full_13]
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_4 = [slice_1, full_13, full_13, full_13]
        ...
        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_5 = [64, 192]

        # pd_op.split: ([-1x64x14x14xf32, -1x192x14x14xf32]) <- (-1x256x14x14xf32, 2xi64, 1xi32)
        split_29 = paddle._C_ops.split(batch_norm__30, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_6 = [slice_2, full_13, full_13, full_13]
        ...
        # pd_op.split: ([-1x64x14x14xf32, -1x192x14x14xf32]) <- (-1x256x14x14xf32, 2xi64, 1xi32)
        split_30 = paddle._C_ops.split(add_3, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_8 = [slice_3, full_13, full_13, full_13]
        ...
        # pd_op.split: ([-1x64x14x14xf32, -1x192x14x14xf32]) <- (-1x256x14x14xf32, 2xi64, 1xi32)
        split_31 = paddle._C_ops.split(add_4, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_10 = [slice_4, full_13, full_13, full_13]
        ...
        # pd_op.split: ([-1x64x14x14xf32, -1x192x14x14xf32]) <- (-1x256x14x14xf32, 2xi64, 1xi32)
        split_32 = paddle._C_ops.split(add_5, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_12 = [slice_5, full_13, full_13, full_13]
        ...
        # pd_op.split: ([-1x64x14x14xf32, -1x192x14x14xf32]) <- (-1x256x14x14xf32, 2xi64, 1xi32)
        split_33 = paddle._C_ops.split(add_6, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_14 = [slice_6, full_13, full_13, full_13]
        ...
        # pd_op.split: ([-1x64x14x14xf32, -1x192x14x14xf32]) <- (-1x256x14x14xf32, 2xi64, 1xi32)
        split_34 = paddle._C_ops.split(add_7, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_16 = [slice_7, full_13, full_13, full_13]
        ...
        # pd_op.split: ([-1x64x14x14xf32, -1x192x14x14xf32]) <- (-1x256x14x14xf32, 2xi64, 1xi32)
        split_35 = paddle._C_ops.split(add_8, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_18 = [slice_8, full_13, full_13, full_13]
        ...
        # pd_op.split: ([-1x64x14x14xf32, -1x192x14x14xf32]) <- (-1x256x14x14xf32, 2xi64, 1xi32)
        split_36 = paddle._C_ops.split(add_9, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_20 = [slice_9, full_13, full_13, full_13]
        ...
        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_6 = [128, 384]

        # pd_op.split: ([-1x128x7x7xf32, -1x384x7x7xf32]) <- (-1x512x7x7xf32, 2xi64, 1xi32)
        split_37 = paddle._C_ops.split(batch_norm__84, full_int_array_6, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_22 = [slice_10, full_13, full_13, full_13]
        ...
        # pd_op.split: ([-1x128x7x7xf32, -1x384x7x7xf32]) <- (-1x512x7x7xf32, 2xi64, 1xi32)
        split_38 = paddle._C_ops.split(add_11, full_int_array_6, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_24 = [slice_11, full_13, full_13, full_13]
