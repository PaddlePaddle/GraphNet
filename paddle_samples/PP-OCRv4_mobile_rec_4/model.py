...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.flatten: (4x480x40xf32) <- (4x480x1x40xf32)
        flatten_0 = paddle._C_ops.flatten(data_0, 2, 3)

        # pd_op.transpose: (4x40x480xf32) <- (4x480x40xf32)
        transpose_0 = paddle._C_ops.transpose(flatten_0, [0, 2, 1])

        # pd_op.matmul: (4x40x384xf32) <- (4x40x480xf32, 480x384xf32)
        ...
        combine_4 = [full_6, slice_16, full_7, full_8, full_9]
        ...
        transpose_4 = paddle._C_ops.transpose(slice_17, [0, 1, 3, 2])
        ...
        combine_5 = [full_6, slice_16, full_10]
        ...
        combine_6 = [full_6, slice_18, full_8, full_9]
        ...
        transpose_8 = paddle._C_ops.transpose(slice_19, [0, 1, 3, 2])
        ...
        # builtin.combine: ([xi64, xi64, xi64]) <- (xi64, xi64, xi64)
        combine_7 = [full_6, slice_18, full_10]
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64, xi64)
        combine_8 = [full_6, slice_20, full_7, full_8, full_9]
        ...
        # pd_op.transpose: (4x12x32x-1xf32) <- (4x12x-1x32xf32)
        transpose_11 = paddle._C_ops.transpose(slice_21, [0, 1, 3, 2])
        ...
        # builtin.combine: ([xi64, xi64, xi64]) <- (xi64, xi64, xi64)
        combine_9 = [full_6, slice_20, full_10]
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64, xi64)
        combine_12 = [full_6, slice_24, full_7, full_8, full_9]
        ...
        # pd_op.transpose: (4x12x32x-1xf32) <- (4x12x-1x32xf32)
        transpose_18 = paddle._C_ops.transpose(slice_25, [0, 1, 3, 2])
        ...
        # builtin.combine: ([xi64, xi64, xi64]) <- (xi64, xi64, xi64)
        combine_13 = [full_6, slice_24, full_10]
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_14 = [full_6, slice_26, full_8, full_9]
        ...
        # pd_op.transpose: (4x12x32x40xf32) <- (4x12x40x32xf32)
        transpose_22 = paddle._C_ops.transpose(slice_27, [0, 1, 3, 2])
        ...
        # builtin.combine: ([xi64, xi64, xi64]) <- (xi64, xi64, xi64)
        combine_15 = [full_6, slice_26, full_10]
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64, xi64)
        combine_16 = [full_6, slice_28, full_7, full_8, full_9]
        ...
        # pd_op.transpose: (4x12x32x-1xf32) <- (4x12x-1x32xf32)
        transpose_25 = paddle._C_ops.transpose(slice_29, [0, 1, 3, 2])
        ...
        # builtin.combine: ([xi64, xi64, xi64]) <- (xi64, xi64, xi64)
        combine_17 = [full_6, slice_28, full_10]
        ...
        slice_30 = paddle._C_ops.slice(
            shape64_8, [0], full_int_array_4, full_int_array_5, [1], [0]
        )
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_18 = [full_6, slice_30, full_8, full_9]
        ...
        # pd_op.transpose: (4x12x32x40xf32) <- (4x12x40x32xf32)
        transpose_29 = paddle._C_ops.transpose(slice_31, [0, 1, 3, 2])
        ...
        # builtin.combine: ([xi64, xi64, xi64]) <- (xi64, xi64, xi64)
        combine_19 = [full_6, slice_30, full_10]
