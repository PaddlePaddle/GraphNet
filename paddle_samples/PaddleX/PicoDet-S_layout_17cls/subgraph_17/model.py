...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        ...
        # pd_op.argmax: (2x6150xi64) <- (2x12x6150xf32, 1xi64)
        ...
        # pd_op.gather: (12300xi32) <- (24xi32, 12300xi64, 1xi32)
        ...
        # pd_op.gather: (12300x4xf32) <- (24x4xf32, 12300xi64, 1xi32)
        ...
        # pd_op.multiply: (2x12x6150xf32) <- (2x12x6150xf32, 2x12x6150xf32)
        ...
        # pd_op.max: (2x12x1xf32) <- (2x12x6150xf32, 1xi64)
        ...
        # pd_op.divide: (2x12x6150xf32) <- (2x12x6150xf32, 2x12x1xf32)
        divide_0 = paddle._C_ops.divide(multiply_1, scale_1)
        del multiply_1, scale_1

        # pd_op.multiply: (2x12x6150xf32) <- (2x12x6150xf32, 2x12x1xf32)
        ...
        # pd_op.max: (2x6150xf32) <- (2x12x6150xf32, 1xi64)
