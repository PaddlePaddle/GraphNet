...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        relu_0 = paddle._C_ops.relu(batch_norm__257)
        ...
        # pd_op.relu: (-1x32x-1x-1xf32) <- (-1x32x-1x-1xf32)
        relu_1 = paddle._C_ops.relu(batch_norm__258)
        ...
        relu_2 = paddle._C_ops.relu(batch_norm__259)
        ...
        # pd_op.relu: (-1x64x-1x-1xf32) <- (-1x64x-1x-1xf32)
        relu_3 = paddle._C_ops.relu(batch_norm__260)
        ...
        relu_4 = paddle._C_ops.relu(batch_norm__261)
        ...
        # pd_op.relu: (-1x128x-1x-1xf32) <- (-1x128x-1x-1xf32)
        relu_5 = paddle._C_ops.relu(batch_norm__262)
        ...
        # pd_op.relu: (-1x128x-1x-1xf32) <- (-1x128x-1x-1xf32)
        relu_6 = paddle._C_ops.relu(batch_norm__263)
        ...
        # pd_op.relu: (-1x128x-1x-1xf32) <- (-1x128x-1x-1xf32)
        relu_7 = paddle._C_ops.relu(batch_norm__264)
        ...
        relu_8 = paddle._C_ops.relu(batch_norm__265)
        ...
        # pd_op.relu: (-1x256x-1x-1xf32) <- (-1x256x-1x-1xf32)
        relu_9 = paddle._C_ops.relu(batch_norm__266)
        ...
        # pd_op.relu: (-1x256x-1x-1xf32) <- (-1x256x-1x-1xf32)
        relu_10 = paddle._C_ops.relu(batch_norm__267)
        ...
        # pd_op.relu: (-1x256x-1x-1xf32) <- (-1x256x-1x-1xf32)
        relu_13 = paddle._C_ops.relu(batch_norm__268)
        ...
        relu_14 = paddle._C_ops.relu(batch_norm__269)
        ...
        # pd_op.relu: (-1x256x-1x-1xf32) <- (-1x256x-1x-1xf32)
        relu_21 = paddle._C_ops.relu(batch_norm__272)
        ...
        # pd_op.relu: (-1x512x-1x-1xf32) <- (-1x512x-1x-1xf32)
        relu_22 = paddle._C_ops.relu(batch_norm__273)
        ...
        # pd_op.relu: (-1x256x-1x-1xf32) <- (-1x256x-1x-1xf32)
        relu_25 = paddle._C_ops.relu(batch_norm__274)
        ...
        # pd_op.relu: (-1x512x-1x-1xf32) <- (-1x512x-1x-1xf32)
        relu_26 = paddle._C_ops.relu(batch_norm__275)
        ...
        # pd_op.relu: (-1x256x-1x-1xf32) <- (-1x256x-1x-1xf32)
        relu_29 = paddle._C_ops.relu(batch_norm__276)
        ...
        # pd_op.relu: (-1x512x-1x-1xf32) <- (-1x512x-1x-1xf32)
        relu_30 = paddle._C_ops.relu(batch_norm__277)
        ...
        # pd_op.relu: (-1x256x-1x-1xf32) <- (-1x256x-1x-1xf32)
        relu_33 = paddle._C_ops.relu(batch_norm__278)
        ...
        # pd_op.relu: (-1x512x-1x-1xf32) <- (-1x512x-1x-1xf32)
        relu_34 = paddle._C_ops.relu(batch_norm__279)
        ...
        # pd_op.add: (-1x512x-1x-1xf32) <- (-1x512x-1x-1xf32, -1x512x-1x-1xf32)
        add_26 = paddle._C_ops.add(batch_norm__217, batch_norm__223)
        ...
        relu_36 = paddle._C_ops.relu(batch_norm__280)
        ...
        add_5 = paddle._C_ops.add(batch_norm__234, batch_norm__240)
        ...
        # pd_op.add: (-1x1024x-1x-1xf32) <- (-1x1024x-1x-1xf32, -1x1024x-1x-1xf32)
        add_27 = paddle._C_ops.add(add_5, batch_norm__246)
        ...
        # pd_op.relu: (-1x1024x-1x-1xf32) <- (-1x1024x-1x-1xf32)
        relu_38 = paddle._C_ops.relu(batch_norm__281)

        # pd_op.add: (-1x1024x-1x-1xf32) <- (-1x1024x-1x-1xf32, -1x1024x-1x-1xf32)
        add_6 = paddle._C_ops.add(relu_38, relu_36)
        ...
        dropout_0, dropout_1 = (lambda x, f: f(x))(
            paddle._C_ops.dropout(
                relu_39, None, full_0, False, "downgrade_in_infer", 0, False
            ),
