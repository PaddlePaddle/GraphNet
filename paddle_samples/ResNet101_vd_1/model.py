...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        add_8 = paddle._C_ops.add(batch_norm__168, batch_norm__174)
        ...
        # pd_op.add: (-1x1024x14x14xf32) <- (-1x1024x14x14xf32, -1x1024x14x14xf32)
        add_9 = paddle._C_ops.add(batch_norm__192, relu_26)
        ...
        # pd_op.add: (-1x1024x14x14xf32) <- (-1x1024x14x14xf32, -1x1024x14x14xf32)
        add_10 = paddle._C_ops.add(batch_norm__210, relu_29)
        ...
        # pd_op.add: (-1x1024x14x14xf32) <- (-1x1024x14x14xf32, -1x1024x14x14xf32)
        add_11 = paddle._C_ops.add(batch_norm__228, relu_32)
        ...
        # pd_op.add: (-1x1024x14x14xf32) <- (-1x1024x14x14xf32, -1x1024x14x14xf32)
        add_12 = paddle._C_ops.add(batch_norm__246, relu_35)
        ...
        add_31 = paddle._C_ops.add(batch_norm__588, batch_norm__594)
        ...
        # pd_op.add: (-1x2048x7x7xf32) <- (-1x2048x7x7xf32, -1x2048x7x7xf32)
        add_32 = paddle._C_ops.add(batch_norm__612, relu_95)
        ...
        # pd_op.add: (-1x2048x7x7xf32) <- (-1x2048x7x7xf32, -1x2048x7x7xf32)
        add_33 = paddle._C_ops.add(batch_norm__630, relu_98)
