...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.matmul: (1x492x4xf32) <- (1x492x256xf32, 256x4xf32)
        matmul_2 = paddle._C_ops.matmul(relu_1, parameter_3, False, False)

        # pd_op.assign: (1x492x4xf32) <- (1x492x4xf32)
        assign_4 = matmul_2

        # pd_op.add: (1x492x4xf32) <- (1x492x4xf32, 4xf32)
        ...
        # pd_op.clip: (1x492x4xf32) <- (1x492x4xf32, 1xf32, 1xf32)
