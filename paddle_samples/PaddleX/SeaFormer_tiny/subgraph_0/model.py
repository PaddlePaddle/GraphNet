...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (-1x96x64x64xf32) <- (-1x-1x64x64xf32, 96x64x1x1xf32)
        conv2d_0 = paddle._C_ops.conv2d(
            data_0, parameter_9, [1, 1], [0, 0], "SAME", [1, 1], 1, "NCHW"
        )
        del data_0, parameter_9

        # pd_op.batch_norm_: (-1x96x64x64xf32, 96xf32, 96xf32, 96xf32, 96xf32, -1xui8) <- (-1x96x64x64xf32, 96xf32, 96xf32, 96xf32, 96xf32)
        (
            batch_norm__0,
            batch_norm__1,
            batch_norm__2,
        ...
        # pd_op.conv2d: (-1x96x-1x-1xf32) <- (-1x-1x-1x-1xf32, 96x160x1x1xf32)
        ...
        # pd_op.hardsigmoid: (-1x96x-1x-1xf32) <- (-1x96x-1x-1xf32)
        hardsigmoid_0 = paddle._C_ops.hardsigmoid(
            batch_norm__6, float("0.166667"), float("0.5")
        )
        del batch_norm__6

        # pd_op.bilinear_interp: (-1x96x64x64xf32) <- (-1x96x-1x-1xf32, None, None, None)
        ...
        # pd_op.multiply: (-1x96x64x64xf32) <- (-1x96x64x64xf32, -1x96x64x64xf32)
