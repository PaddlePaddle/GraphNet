...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.shape64: (3xi64) <- (4x-1x256xf32)
        ...
        # pd_op.reshape: (4x-1x8x32xf32) <- (4x-1x256xf32, 4xi64)
        reshape_4 = paddle._C_ops.reshape(add_2, stack_1)

        # pd_op.matmul: (4x-1x192xf32) <- (4x-1x256xf32, 256x192xf32)
        matmul_1 = paddle._C_ops.matmul(add_1, parameter_13, False, False)

        # pd_op.add: (4x-1x192xf32) <- (4x-1x192xf32, 192xf32)
        ...
        # pd_op.slice: (4x-1x1x2xf32) <- (4x-1x1x4xf32, 1xi64, 1xi64)
        ...
        # pd_op.unsqueeze: (4x-1x1x1x1x2xf32) <- (4x-1x1x2xf32, 2xi64)
        ...
        # pd_op.scale: (4x-1x8x3x4x2xf32) <- (4x-1x8x3x4x2xf32, 1xf32)
        ...
        # pd_op.multiply: (4x-1x8x3x4x2xf32) <- (4x-1x8x3x4x2xf32, 4x-1x1x1x1x2xf32)
        ...
        # pd_op.add: (4x-1x8x3x4x2xf32) <- (4x-1x1x1x1x2xf32, 4x-1x8x3x4x2xf32)
        ...
        # pd_op.shape64: (4xi64) <- (4x-1x8x32xf32)
        ...
        # pd_op.shape64: (6xi64) <- (4x-1x8x3x4x2xf32)
        ...
        # pd_op.split: ([-1x-1x-1x-1xf32, -1x-1x-1x-1xf32, -1x-1x-1x-1xf32]) <- (4x-1x8x32xf32, 3xi64, 1xi32)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_10 = [full_7, full_7, slice_8, slice_9]

        # pd_op.stack: (4xi64) <- ([xi64, xi64, xi64, xi64])
        stack_11 = paddle._C_ops.stack(combine_10, 0)

        # pd_op.reshape: (32x32x-1x-1xf32) <- (-1x-1x-1xf32, 4xi64)
        reshape_0 = paddle._C_ops.reshape(transpose_0, stack_11)

        # pd_op.slice: (4x-1x8x4x2xf32) <- (4x-1x8x3x4x2xf32, 1xi64, 1xi64)
        slice_16 = paddle._C_ops.slice(
            scale_2, [3], full_int_array_3, full_int_array_1, [1], [3]
        )

        # pd_op.transpose: (4x8x-1x4x2xf32) <- (4x-1x8x4x2xf32)
        transpose_1 = paddle._C_ops.transpose(slice_16, [0, 2, 1, 3, 4])

        # pd_op.flatten: (32x-1x4x2xf32) <- (4x8x-1x4x2xf32)
        flatten_0 = paddle._C_ops.flatten(transpose_1, 0, 1)

        # pd_op.grid_sample: (32x32x-1x4xf32) <- (32x32x-1x-1xf32, 32x-1x4x2xf32)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_11 = [full_7, full_7, slice_11, slice_12]
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_12 = [full_7, full_7, slice_14, slice_15]
        ...
        # pd_op.transpose: (4x8x-1x3x4xf32) <- (4x-1x8x3x4xf32)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_13 = [full_7, full_12, slice_6, full_10]

        # pd_op.stack: (4xi64) <- ([xi64, xi64, xi64, xi64])
        stack_14 = paddle._C_ops.stack(combine_13, 0)

        # pd_op.reshape: (32x1x-1x12xf32) <- (4x8x-1x3x4xf32, 4xi64)
        reshape_3 = paddle._C_ops.reshape(transpose_6, stack_14)

        # builtin.combine: ([32x32x-1x4xf32, 32x32x-1x4xf32, 32x32x-1x4xf32]) <- (32x32x-1x4xf32, 32x32x-1x4xf32, 32x32x-1x4xf32)
        combine_14 = [grid_sample_0, grid_sample_1, grid_sample_2]

        # pd_op.stack: (32x32x-1x3x4xf32) <- ([32x32x-1x4xf32, 32x32x-1x4xf32, 32x32x-1x4xf32])
        stack_0 = paddle._C_ops.stack(combine_14, -2)

        # pd_op.flatten: (32x32x-1x12xf32) <- (32x32x-1x3x4xf32)
        flatten_3 = paddle._C_ops.flatten(stack_0, 3, 4)

        # pd_op.multiply: (32x32x-1x12xf32) <- (32x32x-1x12xf32, 32x1x-1x12xf32)
        multiply_0 = paddle._C_ops.multiply(flatten_3, reshape_3)

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_0 = [-1]

        # pd_op.sum: (32x32x-1xf32) <- (32x32x-1x12xf32, 1xi64)
        ...
        # builtin.combine: ([xi64, xi64, xi64]) <- (xi64, xi64, xi64)
        combine_15 = [full_5, full_13, slice_6]

        # pd_op.stack: (3xi64) <- ([xi64, xi64, xi64])
        stack_15 = paddle._C_ops.stack(combine_15, 0)

        # pd_op.reshape: (4x256x-1xf32) <- (32x32x-1xf32, 3xi64)
