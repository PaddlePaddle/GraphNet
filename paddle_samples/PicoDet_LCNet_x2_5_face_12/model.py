...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2):
        ...
        # pd_op.slice: (1173xf32) <- (1173x11xf32, 1xi64, 1xi64)
        slice_0 = paddle._C_ops.slice(data_1, [1], stack_0, stack_1, [-1], [1])

        # pd_op.slice: (xi64) <- (11xi64, 1xi64, 1xi64)
        slice_1 = paddle._C_ops.slice(data_2, [0], stack_0, stack_1, [-1], [0])

        # pd_op.topk: (-1xf32, -1xi64) <- (1173xf32, xi64)
