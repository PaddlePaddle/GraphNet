...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.split: ([6x1x100x-1x-1xf32, 6x1x300x-1x-1xf32]) <- (6x1x400x-1x-1xf32, 2xi64, 1xi32)
        split_6 = paddle._C_ops.split(data_2, full_int_array_0, full_0)
        del data_2

        # builtin.split: (6x1x100x-1x-1xf32, 6x1x300x-1x-1xf32) <- ([6x1x100x-1x-1xf32, 6x1x300x-1x-1xf32])
        (
            split_7,
            split_8,
        ) = split_6
        ...
        # pd_op.split: ([1x100x-1x-1xf32, 1x300x-1x-1xf32]) <- (1x400x-1x-1xf32, 2xi64, 1xi32)
        split_15 = paddle._C_ops.split(data_8, full_int_array_0, full_1)
        del data_8, full_int_array_0

        # builtin.split: (1x100x-1x-1xf32, 1x300x-1x-1xf32) <- ([1x100x-1x-1xf32, 1x300x-1x-1xf32])
        (
            split_16,
            split_17,
        ) = split_15
        ...
        # pd_op.unsqueeze: (1x1x300x-1x-1xf32) <- (1x300x-1x-1xf32, 1xi64)
        unsqueeze_2 = paddle._C_ops.unsqueeze(split_17, full_int_array_1)

        # builtin.combine: ([1x1x300x-1x-1xf32, 6x1x300x-1x-1xf32]) <- (1x1x300x-1x-1xf32, 6x1x300x-1x-1xf32)
        combine_2 = [unsqueeze_2, split_8]

        # pd_op.concat: (7x1x300x-1x-1xf32) <- ([1x1x300x-1x-1xf32, 6x1x300x-1x-1xf32], 1xi32)
        ...
        # pd_op.unsqueeze: (1x1x100x-1x-1xf32) <- (1x100x-1x-1xf32, 1xi64)
        unsqueeze_5 = paddle._C_ops.unsqueeze(split_16, full_int_array_1)

        # builtin.combine: ([1x1x100x-1x-1xf32, 6x1x100x-1x-1xf32]) <- (1x1x100x-1x-1xf32, 6x1x100x-1x-1xf32)
        combine_5 = [unsqueeze_5, split_7]

        # pd_op.concat: (7x1x100x-1x-1xf32) <- ([1x1x100x-1x-1xf32, 6x1x100x-1x-1xf32], 1xi32)
        ...
        # builtin.combine: ([1x1x300x-1x-1xf32, 7x1x300x-1x-1xf32]) <- (1x1x300x-1x-1xf32, 7x1x300x-1x-1xf32)
        combine_8 = [unsqueeze_8, concat_8]

        # pd_op.concat: (8x1x300x-1x-1xf32) <- ([1x1x300x-1x-1xf32, 7x1x300x-1x-1xf32], 1xi32)
        concat_2 = paddle._C_ops.concat(combine_8, full_2)
        del combine_8

        # pd_op.cast: (1x-1x-1xf32) <- (1x-1x-1xui8)
