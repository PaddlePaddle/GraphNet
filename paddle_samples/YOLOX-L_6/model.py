...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3):
        ...
        # pd_op.subtract: (8400x4xf32) <- (8400x4xf32, 4xf32)
        ...
        # pd_op.subtract: (8400x4xf32) <- (4xf32, 8400x4xf32)
        ...
        # builtin.combine: ([8400x4xf32, 8400x4xf32, 8400x4xf32, 8400x4xf32]) <- (8400x4xf32, 8400x4xf32, 8400x4xf32, 8400x4xf32)
        combine_0 = [subtract_0, subtract_1, subtract_2, subtract_3]

        # pd_op.stack: (8400x4x4xf32) <- ([8400x4xf32, 8400x4xf32, 8400x4xf32, 8400x4xf32])
        stack_0 = paddle._C_ops.stack(combine_0, 1)

        # pd_op.min: (8400x4xf32) <- (8400x4x4xf32, 1xi64)
        ...
        # pd_op.greater_than: (8400x4xb) <- (8400x4xf32, xf32)
        greater_than_0 = paddle._C_ops.greater_than(min_0, full_0)

        # pd_op.sum: (8400xi64) <- (8400x4xb, 1xi64)
        ...
        # pd_op.greater_than: (8400xb) <- (8400xi64, xi64)
        ...
        # pd_op.scale: (8400x4xf32) <- (8400x4xf32, 1xf32)
        ...
        # pd_op.add: (8400x4xf32) <- (4xf32, 8400x4xf32)
        add_2 = paddle._C_ops.add(scale_0, scale_2)

        # pd_op.add: (8400x4xf32) <- (4xf32, 8400x4xf32)
        add_3 = paddle._C_ops.add(scale_1, scale_3)

        # pd_op.subtract: (8400x4xf32) <- (8400x4xf32, 8400x4xf32)
        ...
        # pd_op.logical_or: (8400xb) <- (8400xb, 8400xb)
        ...
        # pd_op.cast: (8400x4xi64) <- (8400x4xb)
        ...
        # pd_op.gather: (-1x4xi64) <- (8400x4xi64, -1xi64, 1xi32)
