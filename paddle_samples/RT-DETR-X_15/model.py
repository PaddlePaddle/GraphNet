...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.clip: (-1x-1x1xf32) <- (-1x-1x1xf32, 1xf32, 1xf32)
        ...
        # pd_op.multiply: (-1x-1x1xf32) <- (-1x-1x1xf32, -1x-1x1xf32)
        ...
        # pd_op.add: (-1x-1x1xf32) <- (-1x-1x1xf32, -1x-1x1xf32)
        ...
        # pd_op.divide: (-1x-1x1xf32) <- (-1x-1x1xf32, -1x-1x1xf32)
