...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6, data_7):
        ...
        # pd_op.clip: (6x1xf32) <- (6x1xf32, 1xf32, 1xf32)
        ...
        # pd_op.multiply: (6x1xf32) <- (6x1xf32, 6x1xf32)
        ...
        # pd_op.add: (6x1xf32) <- (6x1xf32, 6x1xf32)
        ...
        # pd_op.divide: (6x1xf32) <- (6x1xf32, 6x1xf32)
