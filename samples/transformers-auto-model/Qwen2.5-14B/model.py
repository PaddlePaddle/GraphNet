...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        hidden_states_482 = (
            l_self_modules_model_modules_norm_parameters_weight_ * to_197
        )
        l_self_modules_model_modules_norm_parameters_weight_ = to_197 = None
        getitem_338 = hidden_states_482[
            (slice(None, None, None), slice(0, None, None), slice(None, None, None))
        ]
        hidden_states_482 = None
        logits = torch._C._nn.linear(
            getitem_338, l_self_modules_lm_head_parameters_weight_, None
        )
        getitem_338 = l_self_modules_lm_head_parameters_weight_ = None
        return (logits,)
