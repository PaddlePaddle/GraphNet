...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        slice_2 = paddle._C_ops.slice(
            add_0, [0], full_int_array_8, full_int_array_9, [1], []
        )
        ...
        generate_proposals_0, generate_proposals_2, generate_proposals_3 = (
            lambda x, f: f(x)
        )(
        ...
        flatten_0 = paddle._C_ops.flatten(generate_proposals_2, 0, 1)
        ...
        slice_6 = paddle._C_ops.slice(
            add_0, [0], full_int_array_9, full_int_array_10, [1], []
        )
        ...
        # pd_op.generate_proposals: (-1x4xf32, -1x1xf32, 1xf32) <- (1x15x-1x-1xf32, 1x60x-1x-1xf32, 1x2xf32, -1x4xf32, -1x4xf32)
        generate_proposals_1, generate_proposals_4, generate_proposals_5 = (
            lambda x, f: f(x)
        )(
            paddle._C_ops.generate_proposals(
                slice_6,
        ...
        # pd_op.shape64: (2xi64) <- (-1x4xf32)
        shape64_2 = paddle._C_ops.shape64(generate_proposals_1)
