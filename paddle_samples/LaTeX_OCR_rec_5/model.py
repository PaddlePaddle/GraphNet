...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        expand_0 = paddle._C_ops.expand(data_3, full_int_array_0)
        ...
        # builtin.combine: ([20x1x256xf32, 20x-1x256xf32]) <- (20x1x256xf32, 20x-1x256xf32)
        combine_0 = [expand_0, data_2]

        # pd_op.concat: (20x-1x256xf32) <- ([20x1x256xf32, 20x-1x256xf32], 1xi32)
        ...
        floor_divide_0 = paddle._C_ops.floor_divide(data_0, full_2)

        # pd_op.floor_divide: (xi64) <- (xi64, xi64)
        floor_divide_1 = paddle._C_ops.floor_divide(data_1, full_2)
        ...
        reshape_4 = paddle._C_ops.reshape(multiply_0, full_int_array_1)

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_2 = [1]

        # pd_op.reshape: (1xi64) <- (xi64, 1xi64)
        reshape_5 = paddle._C_ops.reshape(floor_divide_1, full_int_array_2)
        ...
        scale_1 = paddle._C_ops.scale(add_25, full_7, float("1"), True)
        ...
        transpose_0 = paddle._C_ops.transpose(data_4, [1, 0, 2])
        ...
        # pd_op.add: (20x-1x256xf32) <- (20x-1x256xf32, 1x-1x256xf32)
        ...
        shape64_0 = paddle._C_ops.shape64(layer_norm_0)
        ...
        combine_2 = [full_9, slice_0, full_10, full_11, full_12]
        ...
        reshape_7 = paddle._C_ops.reshape(add_1, stack_0)
        ...
        combine_3 = [full_9, slice_0, full_13]
        ...
        matmul_1 = paddle._C_ops.matmul(reshape_0, data_5, False, True)

        # pd_op.add: (20x-1x256xf32) <- (20x-1x256xf32, 256xf32)
        add_2 = paddle._C_ops.add(matmul_1, data_6)
        ...
        # pd_op.shape64: (3xi64) <- (20x-1x256xf32)
        shape64_1 = paddle._C_ops.shape64(layer_norm_6)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64, xi64)
        combine_4 = [full_9, slice_1, full_10, full_11, full_12]

        # pd_op.stack: (5xi64) <- ([xi64, xi64, xi64, xi64, xi64])
        stack_2 = paddle._C_ops.stack(combine_4, 0)

        # pd_op.reshape: (20x-1x3x8x32xf32) <- (20x-1x768xf32, 5xi64)
        reshape_8 = paddle._C_ops.reshape(add_7, stack_2)
        ...
        # builtin.combine: ([xi64, xi64, xi64]) <- (xi64, xi64, xi64)
        combine_5 = [full_9, slice_1, full_13]

        # pd_op.stack: (3xi64) <- ([xi64, xi64, xi64])
        stack_3 = paddle._C_ops.stack(combine_5, 0)

        # pd_op.reshape: (20x-1x256xf32) <- (20x-1x8x32xf32, 3xi64)
        reshape_1 = paddle._C_ops.reshape(transpose_5, stack_3)

        # pd_op.matmul: (20x-1x256xf32) <- (20x-1x256xf32, 256x256xf32)
        matmul_5 = paddle._C_ops.matmul(reshape_1, data_7, False, True)

        # pd_op.add: (20x-1x256xf32) <- (20x-1x256xf32, 256xf32)
        add_8 = paddle._C_ops.add(matmul_5, data_8)
        ...
        # pd_op.shape64: (3xi64) <- (20x-1x256xf32)
        shape64_2 = paddle._C_ops.shape64(layer_norm_12)

        # pd_op.slice: (xi64) <- (3xi64, 1xi64, 1xi64)
        slice_2 = paddle._C_ops.slice(
            shape64_2, [0], full_int_array_2, full_int_array_4, [1], [0]
        )
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64, xi64)
        combine_6 = [full_9, slice_2, full_10, full_11, full_12]

        # pd_op.stack: (5xi64) <- ([xi64, xi64, xi64, xi64, xi64])
        stack_4 = paddle._C_ops.stack(combine_6, 0)

        # pd_op.reshape: (20x-1x3x8x32xf32) <- (20x-1x768xf32, 5xi64)
        reshape_9 = paddle._C_ops.reshape(add_13, stack_4)
        ...
        # builtin.combine: ([xi64, xi64, xi64]) <- (xi64, xi64, xi64)
        combine_7 = [full_9, slice_2, full_13]

        # pd_op.stack: (3xi64) <- ([xi64, xi64, xi64])
        stack_5 = paddle._C_ops.stack(combine_7, 0)

        # pd_op.reshape: (20x-1x256xf32) <- (20x-1x8x32xf32, 3xi64)
        reshape_2 = paddle._C_ops.reshape(transpose_7, stack_5)

        # pd_op.matmul: (20x-1x256xf32) <- (20x-1x256xf32, 256x256xf32)
        matmul_9 = paddle._C_ops.matmul(reshape_2, data_9, False, True)

        # pd_op.add: (20x-1x256xf32) <- (20x-1x256xf32, 256xf32)
        add_14 = paddle._C_ops.add(matmul_9, data_10)
        ...
        # pd_op.shape64: (3xi64) <- (20x-1x256xf32)
        shape64_3 = paddle._C_ops.shape64(layer_norm_18)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64, xi64)
        combine_8 = [full_9, slice_3, full_10, full_11, full_12]

        # pd_op.stack: (5xi64) <- ([xi64, xi64, xi64, xi64, xi64])
        stack_6 = paddle._C_ops.stack(combine_8, 0)

        # pd_op.reshape: (20x-1x3x8x32xf32) <- (20x-1x768xf32, 5xi64)
        reshape_10 = paddle._C_ops.reshape(add_19, stack_6)
        ...
        # builtin.combine: ([xi64, xi64, xi64]) <- (xi64, xi64, xi64)
        combine_9 = [full_9, slice_3, full_13]

        # pd_op.stack: (3xi64) <- ([xi64, xi64, xi64])
        stack_7 = paddle._C_ops.stack(combine_9, 0)

        # pd_op.reshape: (20x-1x256xf32) <- (20x-1x8x32xf32, 3xi64)
        reshape_3 = paddle._C_ops.reshape(transpose_9, stack_7)

        # pd_op.matmul: (20x-1x256xf32) <- (20x-1x256xf32, 256x256xf32)
        matmul_13 = paddle._C_ops.matmul(reshape_3, data_11, False, True)

        # pd_op.add: (20x-1x256xf32) <- (20x-1x256xf32, 256xf32)
        add_20 = paddle._C_ops.add(matmul_13, data_12)
