...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        t160 = paddle._C_ops.gelu(t154, False)
        ...
        t184 = paddle._C_ops.gelu(t178, False)
        ...
        # pd_op.gelu: (-1x256x28x28xf32) <- (-1x256x28x28xf32)
        t215 = paddle._C_ops.gelu(t209, False)
        ...
        t249 = paddle._C_ops.gelu(t243, False)
        ...
        # pd_op.gelu: (-1x512x14x14xf32) <- (-1x512x14x14xf32)
        t275 = paddle._C_ops.gelu(t269, False)
        ...
        # pd_op.gelu: (-1x512x14x14xf32) <- (-1x512x14x14xf32)
        t301 = paddle._C_ops.gelu(t295, False)
        ...
        # pd_op.gelu: (-1x512x14x14xf32) <- (-1x512x14x14xf32)
        t327 = paddle._C_ops.gelu(t321, False)
        ...
        # pd_op.gelu: (-1x512x14x14xf32) <- (-1x512x14x14xf32)
        t353 = paddle._C_ops.gelu(t347, False)
        ...
        # pd_op.gelu: (-1x512x14x14xf32) <- (-1x512x14x14xf32)
        t379 = paddle._C_ops.gelu(t373, False)
        ...
        # pd_op.gelu: (-1x512x14x14xf32) <- (-1x512x14x14xf32)
        t405 = paddle._C_ops.gelu(t399, False)
        ...
        # pd_op.gelu: (-1x512x14x14xf32) <- (-1x512x14x14xf32)
        t431 = paddle._C_ops.gelu(t425, False)
        ...
        t465 = paddle._C_ops.gelu(t459, False)
        ...
        # pd_op.gelu: (-1x1024x7x7xf32) <- (-1x1024x7x7xf32)
        t491 = paddle._C_ops.gelu(t485, False)
        ...
        t507 = paddle._C_ops.gelu(t506, False)
