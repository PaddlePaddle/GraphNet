...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        matmul_1 = paddle._C_ops.matmul(slice_3, transpose_2, False, False)
        ...
        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_7 = paddle._C_ops.matmul(slice_7, transpose_5, False, False)
        ...
        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_8 = paddle._C_ops.matmul(softmax_1, slice_9, False, False)
        ...
        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_13 = paddle._C_ops.matmul(slice_11, transpose_8, False, False)
        ...
        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_14 = paddle._C_ops.matmul(softmax_2, slice_13, False, False)
        ...
        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_19 = paddle._C_ops.matmul(slice_15, transpose_11, False, False)
        ...
        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_25 = paddle._C_ops.matmul(slice_19, transpose_14, False, False)
        ...
        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_31 = paddle._C_ops.matmul(slice_23, transpose_17, False, False)
        ...
        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_32 = paddle._C_ops.matmul(softmax_5, slice_25, False, False)
        ...
        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_37 = paddle._C_ops.matmul(slice_27, transpose_20, False, False)
        ...
        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_38 = paddle._C_ops.matmul(softmax_6, slice_29, False, False)
        ...
        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_43 = paddle._C_ops.matmul(slice_31, transpose_23, False, False)
        ...
        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_44 = paddle._C_ops.matmul(softmax_7, slice_33, False, False)
        ...
        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_49 = paddle._C_ops.matmul(slice_35, transpose_26, False, False)
        ...
        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_50 = paddle._C_ops.matmul(softmax_8, slice_37, False, False)
        ...
        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_55 = paddle._C_ops.matmul(slice_39, transpose_29, False, False)
        ...
        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_56 = paddle._C_ops.matmul(softmax_9, slice_41, False, False)
        ...
        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_61 = paddle._C_ops.matmul(slice_43, transpose_32, False, False)
        ...
        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_62 = paddle._C_ops.matmul(softmax_10, slice_45, False, False)
        ...
        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_67 = paddle._C_ops.matmul(slice_47, transpose_35, False, False)
        ...
        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_68 = paddle._C_ops.matmul(softmax_11, slice_49, False, False)
        ...
        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_73 = paddle._C_ops.matmul(slice_51, transpose_38, False, False)

        # pd_op.scale: (-1x16x257x257xf32) <- (-1x16x257x257xf32, 1xf32)
        scale_12 = paddle._C_ops.scale(matmul_73, full_2, float("0"), True)

        # pd_op.softmax: (-1x16x257x257xf32) <- (-1x16x257x257xf32)
        softmax_12 = paddle._C_ops.softmax(scale_12, -1)

        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_74 = paddle._C_ops.matmul(softmax_12, slice_53, False, False)
        ...
        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_79 = paddle._C_ops.matmul(slice_55, transpose_41, False, False)

        # pd_op.scale: (-1x16x257x257xf32) <- (-1x16x257x257xf32, 1xf32)
        scale_13 = paddle._C_ops.scale(matmul_79, full_2, float("0"), True)

        # pd_op.softmax: (-1x16x257x257xf32) <- (-1x16x257x257xf32)
        softmax_13 = paddle._C_ops.softmax(scale_13, -1)

        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_80 = paddle._C_ops.matmul(softmax_13, slice_57, False, False)
        ...
        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_85 = paddle._C_ops.matmul(slice_59, transpose_44, False, False)

        # pd_op.scale: (-1x16x257x257xf32) <- (-1x16x257x257xf32, 1xf32)
        scale_14 = paddle._C_ops.scale(matmul_85, full_2, float("0"), True)

        # pd_op.softmax: (-1x16x257x257xf32) <- (-1x16x257x257xf32)
        softmax_14 = paddle._C_ops.softmax(scale_14, -1)

        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_86 = paddle._C_ops.matmul(softmax_14, slice_61, False, False)
        ...
        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_91 = paddle._C_ops.matmul(slice_63, transpose_47, False, False)

        # pd_op.scale: (-1x16x257x257xf32) <- (-1x16x257x257xf32, 1xf32)
        scale_15 = paddle._C_ops.scale(matmul_91, full_2, float("0"), True)

        # pd_op.softmax: (-1x16x257x257xf32) <- (-1x16x257x257xf32)
        softmax_15 = paddle._C_ops.softmax(scale_15, -1)

        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_92 = paddle._C_ops.matmul(softmax_15, slice_65, False, False)
        ...
        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_97 = paddle._C_ops.matmul(slice_67, transpose_50, False, False)

        # pd_op.scale: (-1x16x257x257xf32) <- (-1x16x257x257xf32, 1xf32)
        scale_16 = paddle._C_ops.scale(matmul_97, full_2, float("0"), True)

        # pd_op.softmax: (-1x16x257x257xf32) <- (-1x16x257x257xf32)
        softmax_16 = paddle._C_ops.softmax(scale_16, -1)

        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_98 = paddle._C_ops.matmul(softmax_16, slice_69, False, False)
        ...
        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_103 = paddle._C_ops.matmul(slice_71, transpose_53, False, False)

        # pd_op.scale: (-1x16x257x257xf32) <- (-1x16x257x257xf32, 1xf32)
        scale_17 = paddle._C_ops.scale(matmul_103, full_2, float("0"), True)

        # pd_op.softmax: (-1x16x257x257xf32) <- (-1x16x257x257xf32)
        softmax_17 = paddle._C_ops.softmax(scale_17, -1)

        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_104 = paddle._C_ops.matmul(softmax_17, slice_73, False, False)
        ...
        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_109 = paddle._C_ops.matmul(slice_75, transpose_56, False, False)

        # pd_op.scale: (-1x16x257x257xf32) <- (-1x16x257x257xf32, 1xf32)
        scale_18 = paddle._C_ops.scale(matmul_109, full_2, float("0"), True)

        # pd_op.softmax: (-1x16x257x257xf32) <- (-1x16x257x257xf32)
        softmax_18 = paddle._C_ops.softmax(scale_18, -1)

        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_110 = paddle._C_ops.matmul(softmax_18, slice_77, False, False)
        ...
        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_115 = paddle._C_ops.matmul(slice_79, transpose_59, False, False)

        # pd_op.scale: (-1x16x257x257xf32) <- (-1x16x257x257xf32, 1xf32)
        scale_19 = paddle._C_ops.scale(matmul_115, full_2, float("0"), True)

        # pd_op.softmax: (-1x16x257x257xf32) <- (-1x16x257x257xf32)
        softmax_19 = paddle._C_ops.softmax(scale_19, -1)

        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_116 = paddle._C_ops.matmul(softmax_19, slice_81, False, False)
        ...
        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_121 = paddle._C_ops.matmul(slice_83, transpose_62, False, False)

        # pd_op.scale: (-1x16x257x257xf32) <- (-1x16x257x257xf32, 1xf32)
        scale_20 = paddle._C_ops.scale(matmul_121, full_2, float("0"), True)

        # pd_op.softmax: (-1x16x257x257xf32) <- (-1x16x257x257xf32)
        softmax_20 = paddle._C_ops.softmax(scale_20, -1)

        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_122 = paddle._C_ops.matmul(softmax_20, slice_85, False, False)
        ...
        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_127 = paddle._C_ops.matmul(slice_87, transpose_65, False, False)

        # pd_op.scale: (-1x16x257x257xf32) <- (-1x16x257x257xf32, 1xf32)
        scale_21 = paddle._C_ops.scale(matmul_127, full_2, float("0"), True)

        # pd_op.softmax: (-1x16x257x257xf32) <- (-1x16x257x257xf32)
        softmax_21 = paddle._C_ops.softmax(scale_21, -1)

        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_128 = paddle._C_ops.matmul(softmax_21, slice_89, False, False)
        ...
        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_133 = paddle._C_ops.matmul(slice_91, transpose_68, False, False)

        # pd_op.scale: (-1x16x257x257xf32) <- (-1x16x257x257xf32, 1xf32)
        scale_22 = paddle._C_ops.scale(matmul_133, full_2, float("0"), True)

        # pd_op.softmax: (-1x16x257x257xf32) <- (-1x16x257x257xf32)
        softmax_22 = paddle._C_ops.softmax(scale_22, -1)

        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_134 = paddle._C_ops.matmul(softmax_22, slice_93, False, False)
        ...
        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_139 = paddle._C_ops.matmul(slice_95, transpose_71, False, False)

        # pd_op.scale: (-1x16x257x257xf32) <- (-1x16x257x257xf32, 1xf32)
        scale_23 = paddle._C_ops.scale(matmul_139, full_2, float("0"), True)

        # pd_op.softmax: (-1x16x257x257xf32) <- (-1x16x257x257xf32)
        softmax_23 = paddle._C_ops.softmax(scale_23, -1)

        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_140 = paddle._C_ops.matmul(softmax_23, slice_97, False, False)
        ...
        slice_98 = paddle._C_ops.slice(
            add_145, [1], full_int_array_0, full_int_array_1, [1], [1]
        )
        ...
        slice_99 = paddle._C_ops.slice(
            add_145, [1], full_int_array_1, full_int_array_6, [1], []
        )
        ...
        layer_norm_147, layer_norm_148, layer_norm_149 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                slice_98, parameter_3, parameter_2, float("1e-05"), 1
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )
