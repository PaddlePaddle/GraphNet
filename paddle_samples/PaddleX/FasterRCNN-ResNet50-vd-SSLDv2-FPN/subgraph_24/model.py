...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (4x32x496x368xf32) <- (4x3x992x736xf32, 32x3x3x3xf32)
        conv2d_0 = paddle._C_ops.conv2d(
            data_0, parameter_290, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del data_0, parameter_290

        # pd_op.batch_norm_: (4x32x496x368xf32, 32xf32, 32xf32, 32xf32, 32xf32, -1xui8) <- (4x32x496x368xf32, 32xf32, 32xf32, 32xf32, 32xf32)
        (
            batch_norm__0,
            batch_norm__1,
            batch_norm__2,
        ...
        # pd_op.relu: (4x32x496x368xf32) <- (4x32x496x368xf32)
        relu_0 = paddle._C_ops.relu(batch_norm__0)
        del batch_norm__0

        # pd_op.conv2d: (4x32x496x368xf32) <- (4x32x496x368xf32, 32x32x3x3xf32)
        ...
        # pd_op.conv2d: (4x64x496x368xf32) <- (4x32x496x368xf32, 64x32x3x3xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            relu_1, parameter_280, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_280, relu_1

        # pd_op.batch_norm_: (4x64x496x368xf32, 64xf32, 64xf32, 64xf32, 64xf32, -1xui8) <- (4x64x496x368xf32, 64xf32, 64xf32, 64xf32, 64xf32)
        (
            batch_norm__12,
            batch_norm__13,
            batch_norm__14,
        ...
        # pd_op.relu: (4x64x496x368xf32) <- (4x64x496x368xf32)
        ...
        # pd_op.pool2d: (4x64x248x184xf32) <- (4x64x496x368xf32, 2xi64)
        ...
        # pd_op.conv2d: (4x64x248x184xf32) <- (4x64x248x184xf32, 64x64x1x1xf32)
        conv2d_3 = paddle._C_ops.conv2d(
            pool2d_1, parameter_275, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_275

        # pd_op.batch_norm_: (4x64x248x184xf32, 64xf32, 64xf32, 64xf32, 64xf32, -1xui8) <- (4x64x248x184xf32, 64xf32, 64xf32, 64xf32, 64xf32)
        (
            batch_norm__18,
            batch_norm__19,
            batch_norm__20,
        ...
        # pd_op.relu: (4x64x248x184xf32) <- (4x64x248x184xf32)
        relu_3 = paddle._C_ops.relu(batch_norm__18)
        del batch_norm__18

        # pd_op.conv2d: (4x64x248x184xf32) <- (4x64x248x184xf32, 64x64x3x3xf32)
        ...
        # pd_op.conv2d: (4x256x248x184xf32) <- (4x64x248x184xf32, 256x64x1x1xf32)
        conv2d_5 = paddle._C_ops.conv2d(
            relu_4, parameter_265, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_265, relu_4

        # pd_op.batch_norm_: (4x256x248x184xf32, 256xf32, 256xf32, 256xf32, 256xf32, -1xui8) <- (4x256x248x184xf32, 256xf32, 256xf32, 256xf32, 256xf32)
        (
            batch_norm__30,
            batch_norm__31,
            batch_norm__32,
        ...
        # pd_op.add: (4x256x248x184xf32) <- (4x256x248x184xf32, 4x256x248x184xf32)
        add_3 = paddle._C_ops.add(batch_norm__30, batch_norm__36)
        del batch_norm__30, batch_norm__36

        # pd_op.relu: (4x256x248x184xf32) <- (4x256x248x184xf32)
        relu_5 = paddle._C_ops.relu(add_3)
        del add_3

        # pd_op.conv2d: (4x64x248x184xf32) <- (4x256x248x184xf32, 64x256x1x1xf32)
        ...
        # pd_op.conv2d: (4x128x248x184xf32) <- (4x256x248x184xf32, 128x256x1x1xf32)
        conv2d_13 = paddle._C_ops.conv2d(
            relu_11, parameter_225, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_225

        # pd_op.batch_norm_: (4x128x248x184xf32, 128xf32, 128xf32, 128xf32, 128xf32, -1xui8) <- (4x128x248x184xf32, 128xf32, 128xf32, 128xf32, 128xf32)
        (
            batch_norm__78,
            batch_norm__79,
            batch_norm__80,
        ...
        # pd_op.relu: (4x128x248x184xf32) <- (4x128x248x184xf32)
        relu_12 = paddle._C_ops.relu(batch_norm__78)
        del batch_norm__78

        # pd_op.conv2d: (4x128x124x92xf32) <- (4x128x248x184xf32, 128x128x3x3xf32)
        conv2d_14 = paddle._C_ops.conv2d(
            relu_12, parameter_220, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_220

        # pd_op.batch_norm_: (4x128x124x92xf32, 128xf32, 128xf32, 128xf32, 128xf32, -1xui8) <- (4x128x124x92xf32, 128xf32, 128xf32, 128xf32, 128xf32)
        (
            batch_norm__84,
            batch_norm__85,
            batch_norm__86,
        ...
        # pd_op.relu: (4x128x124x92xf32) <- (4x128x124x92xf32)
        relu_13 = paddle._C_ops.relu(batch_norm__84)
        del batch_norm__84

        # pd_op.conv2d: (4x512x124x92xf32) <- (4x128x124x92xf32, 512x128x1x1xf32)
        conv2d_15 = paddle._C_ops.conv2d(
            relu_13, parameter_215, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_215

        # pd_op.batch_norm_: (4x512x124x92xf32, 512xf32, 512xf32, 512xf32, 512xf32, -1xui8) <- (4x512x124x92xf32, 512xf32, 512xf32, 512xf32, 512xf32)
        (
            batch_norm__90,
            batch_norm__91,
            batch_norm__92,
        ...
        # pd_op.pool2d: (4x256x124x92xf32) <- (4x256x248x184xf32, 2xi64)
        ...
        # pd_op.conv2d: (4x512x124x92xf32) <- (4x256x124x92xf32, 512x256x1x1xf32)
        ...
        # pd_op.add: (4x512x124x92xf32) <- (4x512x124x92xf32, 4x512x124x92xf32)
        add_6 = paddle._C_ops.add(batch_norm__90, batch_norm__96)

        # pd_op.relu: (4x512x124x92xf32) <- (4x512x124x92xf32)
        relu_14 = paddle._C_ops.relu(add_6)
        del add_6

        # pd_op.conv2d: (4x128x124x92xf32) <- (4x512x124x92xf32, 128x512x1x1xf32)
        ...
        # pd_op.conv2d: (4x128x124x92xf32) <- (4x128x124x92xf32, 128x128x3x3xf32)
        ...
        # pd_op.conv2d: (4x256x124x92xf32) <- (4x512x124x92xf32, 256x512x1x1xf32)
        conv2d_26 = paddle._C_ops.conv2d(
            relu_23, parameter_160, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_160

        # pd_op.batch_norm_: (4x256x124x92xf32, 256xf32, 256xf32, 256xf32, 256xf32, -1xui8) <- (4x256x124x92xf32, 256xf32, 256xf32, 256xf32, 256xf32)
        (
            batch_norm__156,
            batch_norm__157,
            batch_norm__158,
        ...
        # pd_op.relu: (4x256x124x92xf32) <- (4x256x124x92xf32)
        relu_24 = paddle._C_ops.relu(batch_norm__156)
        del batch_norm__156

        # pd_op.conv2d: (4x256x62x46xf32) <- (4x256x124x92xf32, 256x256x3x3xf32)
        conv2d_27 = paddle._C_ops.conv2d(
            relu_24, parameter_155, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_155

        # pd_op.batch_norm_: (4x256x62x46xf32, 256xf32, 256xf32, 256xf32, 256xf32, -1xui8) <- (4x256x62x46xf32, 256xf32, 256xf32, 256xf32, 256xf32)
        (
            batch_norm__162,
            batch_norm__163,
            batch_norm__164,
        ...
        # pd_op.relu: (4x256x62x46xf32) <- (4x256x62x46xf32)
        relu_25 = paddle._C_ops.relu(batch_norm__162)
        del batch_norm__162

        # pd_op.conv2d: (4x1024x62x46xf32) <- (4x256x62x46xf32, 1024x256x1x1xf32)
        conv2d_28 = paddle._C_ops.conv2d(
            relu_25, parameter_150, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_150

        # pd_op.batch_norm_: (4x1024x62x46xf32, 1024xf32, 1024xf32, 1024xf32, 1024xf32, -1xui8) <- (4x1024x62x46xf32, 1024xf32, 1024xf32, 1024xf32, 1024xf32)
        (
            batch_norm__168,
            batch_norm__169,
            batch_norm__170,
        ...
        # pd_op.pool2d: (4x512x62x46xf32) <- (4x512x124x92xf32, 2xi64)
        ...
        # pd_op.conv2d: (4x1024x62x46xf32) <- (4x512x62x46xf32, 1024x512x1x1xf32)
        ...
        # pd_op.add: (4x1024x62x46xf32) <- (4x1024x62x46xf32, 4x1024x62x46xf32)
        add_10 = paddle._C_ops.add(batch_norm__168, batch_norm__174)

        # pd_op.relu: (4x1024x62x46xf32) <- (4x1024x62x46xf32)
        relu_26 = paddle._C_ops.relu(add_10)
        del add_10

        # pd_op.conv2d: (4x256x62x46xf32) <- (4x1024x62x46xf32, 256x1024x1x1xf32)
        ...
        # pd_op.conv2d: (4x256x62x46xf32) <- (4x256x62x46xf32, 256x256x3x3xf32)
        ...
        # pd_op.conv2d: (4x512x62x46xf32) <- (4x1024x62x46xf32, 512x1024x1x1xf32)
        conv2d_45 = paddle._C_ops.conv2d(
            relu_41, parameter_65, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_65

        # pd_op.batch_norm_: (4x512x62x46xf32, 512xf32, 512xf32, 512xf32, 512xf32, -1xui8) <- (4x512x62x46xf32, 512xf32, 512xf32, 512xf32, 512xf32)
        (
            batch_norm__270,
            batch_norm__271,
            batch_norm__272,
        ...
        # pd_op.relu: (4x512x62x46xf32) <- (4x512x62x46xf32)
        relu_42 = paddle._C_ops.relu(batch_norm__270)
        del batch_norm__270

        # pd_op.conv2d: (4x512x31x23xf32) <- (4x512x62x46xf32, 512x512x3x3xf32)
        conv2d_46 = paddle._C_ops.conv2d(
            relu_42, parameter_60, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_60

        # pd_op.batch_norm_: (4x512x31x23xf32, 512xf32, 512xf32, 512xf32, 512xf32, -1xui8) <- (4x512x31x23xf32, 512xf32, 512xf32, 512xf32, 512xf32)
        (
            batch_norm__276,
            batch_norm__277,
            batch_norm__278,
        ...
        # pd_op.relu: (4x512x31x23xf32) <- (4x512x31x23xf32)
        relu_43 = paddle._C_ops.relu(batch_norm__276)
        del batch_norm__276

        # pd_op.conv2d: (4x2048x31x23xf32) <- (4x512x31x23xf32, 2048x512x1x1xf32)
        conv2d_47 = paddle._C_ops.conv2d(
            relu_43, parameter_55, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_55

        # pd_op.batch_norm_: (4x2048x31x23xf32, 2048xf32, 2048xf32, 2048xf32, 2048xf32, -1xui8) <- (4x2048x31x23xf32, 2048xf32, 2048xf32, 2048xf32, 2048xf32)
        (
            batch_norm__282,
            batch_norm__283,
            batch_norm__284,
        ...
        # pd_op.pool2d: (4x1024x31x23xf32) <- (4x1024x62x46xf32, 2xi64)
        ...
        # pd_op.conv2d: (4x2048x31x23xf32) <- (4x1024x31x23xf32, 2048x1024x1x1xf32)
        ...
        # pd_op.add: (4x2048x31x23xf32) <- (4x2048x31x23xf32, 4x2048x31x23xf32)
        add_16 = paddle._C_ops.add(batch_norm__282, batch_norm__288)

        # pd_op.relu: (4x2048x31x23xf32) <- (4x2048x31x23xf32)
        relu_44 = paddle._C_ops.relu(add_16)
        del add_16

        # pd_op.conv2d: (4x512x31x23xf32) <- (4x2048x31x23xf32, 512x2048x1x1xf32)
        ...
        # pd_op.conv2d: (4x512x31x23xf32) <- (4x512x31x23xf32, 512x512x3x3xf32)
        ...
        # pd_op.conv2d: (4x256x248x184xf32) <- (4x256x248x184xf32, 256x256x1x1xf32)
        ...
        # pd_op.add: (4x256x248x184xf32) <- (4x256x248x184xf32, 1x256x1x1xf32)
        ...
        # pd_op.add: (4x256x124x92xf32) <- (4x256x124x92xf32, 1x256x1x1xf32)
        ...
        # pd_op.add: (4x256x62x46xf32) <- (4x256x62x46xf32, 1x256x1x1xf32)
        add_21 = paddle._C_ops.add(conv2d_57, reshape_2)

        # pd_op.conv2d: (4x256x31x23xf32) <- (4x2048x31x23xf32, 256x2048x1x1xf32)
        ...
        # pd_op.add: (4x256x31x23xf32) <- (4x256x31x23xf32, 1x256x1x1xf32)
        add_22 = paddle._C_ops.add(conv2d_58, reshape_3)

        # pd_op.nearest_interp: (4x256x62x46xf32) <- (4x256x31x23xf32, None, None, None)
        ...
        # pd_op.add: (4x256x62x46xf32) <- (4x256x62x46xf32, 4x256x62x46xf32)
        add_23 = paddle._C_ops.add(add_21, nearest_interp_0)

        # pd_op.nearest_interp: (4x256x124x92xf32) <- (4x256x62x46xf32, None, None, None)
        ...
        # pd_op.add: (4x256x124x92xf32) <- (4x256x124x92xf32, 4x256x124x92xf32)
        add_24 = paddle._C_ops.add(add_20, nearest_interp_1)

        # pd_op.nearest_interp: (4x256x248x184xf32) <- (4x256x124x92xf32, None, None, None)
        ...
        # pd_op.conv2d: (4x256x248x184xf32) <- (4x256x248x184xf32, 256x256x3x3xf32)
        ...
        # pd_op.conv2d: (4x256x124x92xf32) <- (4x256x124x92xf32, 256x256x3x3xf32)
        ...
        # pd_op.conv2d: (4x256x31x23xf32) <- (4x256x31x23xf32, 256x256x3x3xf32)
        ...
        # pd_op.pool2d: (4x256x16x12xf32) <- (4x256x31x23xf32, 2xi64)
