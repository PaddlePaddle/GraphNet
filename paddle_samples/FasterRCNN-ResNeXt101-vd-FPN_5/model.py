...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.slice: (1x3x248x184xf32) <- (2x3x248x184xf32, 1xi64, 1xi64)
        slice_0 = paddle._C_ops.slice(
            data_0, [0], full_int_array_0, full_int_array_1, [1], []
        )

        # pd_op.slice: (1x12x248x184xf32) <- (2x12x248x184xf32, 1xi64, 1xi64)
        ...
        # pd_op.full_like: (136896x4xf32) <- (136896x4xf32, 1xf32)
        full_like_0 = paddle._C_ops.full_like(
            data_10, full_0, paddle.float32, paddle.framework._current_expected_place()
        )

        # pd_op.generate_proposals: (-1x4xf32, -1x1xf32, 1xf32) <- (1x3x248x184xf32, 1x12x248x184xf32, 1x2xf32, 136896x4xf32, 136896x4xf32)
        ...
        # pd_op.slice: (1x3x124x92xf32) <- (2x3x124x92xf32, 1xi64, 1xi64)
        slice_3 = paddle._C_ops.slice(
            data_1, [0], full_int_array_0, full_int_array_1, [1], []
        )

        # pd_op.slice: (1x12x124x92xf32) <- (2x12x124x92xf32, 1xi64, 1xi64)
        slice_4 = paddle._C_ops.slice(
            data_6, [0], full_int_array_0, full_int_array_1, [1], []
        )

        # pd_op.full_like: (34224x4xf32) <- (34224x4xf32, 1xf32)
        full_like_1 = paddle._C_ops.full_like(
            data_11, full_0, paddle.float32, paddle.framework._current_expected_place()
        )

        # pd_op.generate_proposals: (-1x4xf32, -1x1xf32, 1xf32) <- (1x3x124x92xf32, 1x12x124x92xf32, 1x2xf32, 34224x4xf32, 34224x4xf32)
        ...
        # pd_op.slice: (1x3x62x46xf32) <- (2x3x62x46xf32, 1xi64, 1xi64)
        slice_5 = paddle._C_ops.slice(
            data_2, [0], full_int_array_0, full_int_array_1, [1], []
        )

        # pd_op.slice: (1x12x62x46xf32) <- (2x12x62x46xf32, 1xi64, 1xi64)
        slice_6 = paddle._C_ops.slice(
            data_7, [0], full_int_array_0, full_int_array_1, [1], []
        )

        # pd_op.full_like: (8556x4xf32) <- (8556x4xf32, 1xf32)
        full_like_2 = paddle._C_ops.full_like(
            data_12, full_0, paddle.float32, paddle.framework._current_expected_place()
        )

        # pd_op.generate_proposals: (-1x4xf32, -1x1xf32, 1xf32) <- (1x3x62x46xf32, 1x12x62x46xf32, 1x2xf32, 8556x4xf32, 8556x4xf32)
        ...
        # pd_op.slice: (1x3x31x23xf32) <- (2x3x31x23xf32, 1xi64, 1xi64)
        slice_7 = paddle._C_ops.slice(
            data_3, [0], full_int_array_0, full_int_array_1, [1], []
        )

        # pd_op.slice: (1x12x31x23xf32) <- (2x12x31x23xf32, 1xi64, 1xi64)
        slice_8 = paddle._C_ops.slice(
            data_8, [0], full_int_array_0, full_int_array_1, [1], []
        )

        # pd_op.full_like: (2139x4xf32) <- (2139x4xf32, 1xf32)
        full_like_3 = paddle._C_ops.full_like(
            data_13, full_0, paddle.float32, paddle.framework._current_expected_place()
        )

        # pd_op.generate_proposals: (-1x4xf32, -1x1xf32, 1xf32) <- (1x3x31x23xf32, 1x12x31x23xf32, 1x2xf32, 2139x4xf32, 2139x4xf32)
        ...
        # pd_op.slice: (1x3x16x12xf32) <- (2x3x16x12xf32, 1xi64, 1xi64)
        slice_9 = paddle._C_ops.slice(
            data_4, [0], full_int_array_0, full_int_array_1, [1], []
        )

        # pd_op.slice: (1x12x16x12xf32) <- (2x12x16x12xf32, 1xi64, 1xi64)
