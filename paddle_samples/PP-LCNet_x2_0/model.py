...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.hardswish: (-1x64x112x112xf32) <- (-1x64x112x112xf32)
        ...
        # pd_op.hardswish: (-1x128x56x56xf32) <- (-1x128x56x56xf32)
        ...
        # pd_op.hardswish: (-1x256x28x28xf32) <- (-1x256x28x28xf32)
        ...
        # pd_op.hardswish: (-1x512x14x14xf32) <- (-1x512x14x14xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x512x7x7xf32) <- (-1x512x14x14xf32, 512x1x5x5xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x1024x7x7xf32) <- (-1x1024x7x7xf32, 1024x1x5x5xf32)
