...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (-1x8x112x112xf32) <- (-1x3x224x224xf32, 8x3x3x3xf32)
        ...
        # pd_op.hardswish: (-1x8x112x112xf32) <- (-1x8x112x112xf32)
        hardswish_0 = paddle._C_ops.hardswish(batch_norm__0)

        # pd_op.conv2d: (-1x8x112x112xf32) <- (-1x8x112x112xf32, 8x8x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x8x56x56xf32) <- (-1x8x112x112xf32, 8x1x3x3xf32)
        depthwise_conv2d_0 = paddle._C_ops.depthwise_conv2d(
            relu_0, parameter_203, [2, 2], [1, 1], "EXPLICIT", 8, [1, 1], "NCHW"
        )

        # pd_op.batch_norm_: (-1x8x56x56xf32, 8xf32, 8xf32, 8xf32, 8xf32, -1xui8) <- (-1x8x56x56xf32, 8xf32, 8xf32, 8xf32, 8xf32)
        (
            batch_norm__205,
            batch_norm__11,
            batch_norm__12,
        ...
        # pd_op.relu: (-1x8x56x56xf32) <- (-1x8x56x56xf32)
        ...
        # pd_op.conv2d: (-1x2x1x1xf32) <- (-1x8x1x1xf32, 2x8x1x1xf32)
        ...
        # pd_op.add: (-1x2x1x1xf32) <- (-1x2x1x1xf32, 1x2x1x1xf32)
        add_8 = paddle._C_ops.add(conv2d_2, reshape_0)

        # pd_op.relu: (-1x2x1x1xf32) <- (-1x2x1x1xf32)
        relu_2 = paddle._C_ops.relu(add_8)

        # pd_op.conv2d: (-1x8x1x1xf32) <- (-1x2x1x1xf32, 8x2x1x1xf32)
        ...
        # pd_op.hardsigmoid: (-1x8x1x1xf32) <- (-1x8x1x1xf32)
        hardsigmoid_0 = paddle._C_ops.hardsigmoid(add_9, float("0.2"), float("0.5"))

        # pd_op.multiply: (-1x8x56x56xf32) <- (-1x8x56x56xf32, -1x8x1x1xf32)
        multiply_0 = paddle._C_ops.multiply(relu_1, hardsigmoid_0)

        # pd_op.conv2d: (-1x8x56x56xf32) <- (-1x8x56x56xf32, 8x8x1x1xf32)
        ...
        # pd_op.conv2d: (-1x40x56x56xf32) <- (-1x8x56x56xf32, 40x8x1x1xf32)
        conv2d_5 = paddle._C_ops.conv2d(
            batch_norm__16, parameter_189, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (-1x40x56x56xf32, 40xf32, 40xf32, 40xf32, 40xf32, -1xui8) <- (-1x40x56x56xf32, 40xf32, 40xf32, 40xf32, 40xf32)
        (
            batch_norm__206,
            batch_norm__22,
            batch_norm__23,
        ...
        # pd_op.relu: (-1x40x56x56xf32) <- (-1x40x56x56xf32)
        relu_3 = paddle._C_ops.relu(batch_norm__206)

        # pd_op.depthwise_conv2d: (-1x40x28x28xf32) <- (-1x40x56x56xf32, 40x1x3x3xf32)
        depthwise_conv2d_1 = paddle._C_ops.depthwise_conv2d(
            relu_3, parameter_184, [2, 2], [1, 1], "EXPLICIT", 40, [1, 1], "NCHW"
        )

        # pd_op.batch_norm_: (-1x40x28x28xf32, 40xf32, 40xf32, 40xf32, 40xf32, -1xui8) <- (-1x40x28x28xf32, 40xf32, 40xf32, 40xf32, 40xf32)
        (
            batch_norm__207,
            batch_norm__27,
            batch_norm__28,
        ...
        # pd_op.relu: (-1x40x28x28xf32) <- (-1x40x28x28xf32)
        relu_4 = paddle._C_ops.relu(batch_norm__207)

        # pd_op.conv2d: (-1x16x28x28xf32) <- (-1x40x28x28xf32, 16x40x1x1xf32)
        conv2d_6 = paddle._C_ops.conv2d(
            relu_4, parameter_179, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (-1x16x28x28xf32, 16xf32, 16xf32, 16xf32, 16xf32, -1xui8) <- (-1x16x28x28xf32, 16xf32, 16xf32, 16xf32, 16xf32)
        (
            batch_norm__32,
            batch_norm__33,
            batch_norm__34,
        ...
        # pd_op.conv2d: (-1x48x28x28xf32) <- (-1x16x28x28xf32, 48x16x1x1xf32)
        ...
        # pd_op.relu: (-1x48x28x28xf32) <- (-1x48x28x28xf32)
        relu_5 = paddle._C_ops.relu(batch_norm__208)

        # pd_op.depthwise_conv2d: (-1x48x28x28xf32) <- (-1x48x28x28xf32, 48x1x3x3xf32)
        depthwise_conv2d_2 = paddle._C_ops.depthwise_conv2d(
            relu_5, parameter_169, [1, 1], [1, 1], "EXPLICIT", 48, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x16x28x28xf32) <- (-1x48x28x28xf32, 16x48x1x1xf32)
        ...
        # pd_op.add: (-1x16x28x28xf32) <- (-1x16x28x28xf32, -1x16x28x28xf32)
        ...
        # pd_op.hardswish: (-1x48x28x28xf32) <- (-1x48x28x28xf32)
        hardswish_1 = paddle._C_ops.hardswish(batch_norm__54)

        # pd_op.depthwise_conv2d: (-1x48x14x14xf32) <- (-1x48x28x28xf32, 48x1x5x5xf32)
        depthwise_conv2d_3 = paddle._C_ops.depthwise_conv2d(
            hardswish_1, parameter_154, [2, 2], [2, 2], "EXPLICIT", 48, [1, 1], "NCHW"
        )
        ...
        # pd_op.hardswish: (-1x48x14x14xf32) <- (-1x48x14x14xf32)
        ...
        # pd_op.conv2d: (-1x12x1x1xf32) <- (-1x48x1x1xf32, 12x48x1x1xf32)
        ...
        # pd_op.add: (-1x12x1x1xf32) <- (-1x12x1x1xf32, 1x12x1x1xf32)
        add_10 = paddle._C_ops.add(conv2d_10, reshape_2)

        # pd_op.relu: (-1x12x1x1xf32) <- (-1x12x1x1xf32)
        relu_7 = paddle._C_ops.relu(add_10)

        # pd_op.conv2d: (-1x48x1x1xf32) <- (-1x12x1x1xf32, 48x12x1x1xf32)
        ...
        # pd_op.conv2d: (-1x24x14x14xf32) <- (-1x48x14x14xf32, 24x48x1x1xf32)
        conv2d_12 = paddle._C_ops.conv2d(
            multiply_1, parameter_145, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (-1x24x14x14xf32, 24xf32, 24xf32, 24xf32, 24xf32, -1xui8) <- (-1x24x14x14xf32, 24xf32, 24xf32, 24xf32, 24xf32)
        (
            batch_norm__66,
            batch_norm__67,
            batch_norm__68,
        ...
        # pd_op.conv2d: (-1x120x14x14xf32) <- (-1x24x14x14xf32, 120x24x1x1xf32)
        ...
        depthwise_conv2d_4 = paddle._C_ops.depthwise_conv2d(
            hardswish_3, parameter_135, [1, 1], [2, 2], "EXPLICIT", 120, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x24x14x14xf32) <- (-1x120x14x14xf32, 24x120x1x1xf32)
        ...
        # pd_op.add: (-1x24x14x14xf32) <- (-1x24x14x14xf32, -1x24x14x14xf32)
        ...
        depthwise_conv2d_5 = paddle._C_ops.depthwise_conv2d(
            hardswish_5, parameter_116, [1, 1], [2, 2], "EXPLICIT", 120, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x64x14x14xf32) <- (-1x24x14x14xf32, 64x24x1x1xf32)
        ...
        # pd_op.hardswish: (-1x64x14x14xf32) <- (-1x64x14x14xf32)
        ...
        depthwise_conv2d_6 = paddle._C_ops.depthwise_conv2d(
            hardswish_7, parameter_97, [1, 1], [2, 2], "EXPLICIT", 64, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x24x14x14xf32) <- (-1x64x14x14xf32, 24x64x1x1xf32)
        ...
        # pd_op.conv2d: (-1x72x14x14xf32) <- (-1x24x14x14xf32, 72x24x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x72x14x14xf32) <- (-1x72x14x14xf32, 72x1x5x5xf32)
        depthwise_conv2d_7 = paddle._C_ops.depthwise_conv2d(
            hardswish_9, parameter_78, [1, 1], [2, 2], "EXPLICIT", 72, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x24x14x14xf32) <- (-1x72x14x14xf32, 24x72x1x1xf32)
        ...
        # pd_op.conv2d: (-1x144x14x14xf32) <- (-1x24x14x14xf32, 144x24x1x1xf32)
        ...
        # pd_op.hardswish: (-1x144x14x14xf32) <- (-1x144x14x14xf32)
        hardswish_11 = paddle._C_ops.hardswish(batch_norm__144)

        # pd_op.depthwise_conv2d: (-1x144x7x7xf32) <- (-1x144x14x14xf32, 144x1x5x5xf32)
        depthwise_conv2d_8 = paddle._C_ops.depthwise_conv2d(
            hardswish_11, parameter_59, [2, 2], [2, 2], "EXPLICIT", 144, [1, 1], "NCHW"
        )

        # pd_op.batch_norm_: (-1x144x7x7xf32, 144xf32, 144xf32, 144xf32, 144xf32, -1xui8) <- (-1x144x7x7xf32, 144xf32, 144xf32, 144xf32, 144xf32)
        (
            batch_norm__150,
            batch_norm__151,
            batch_norm__152,
        ...
        # pd_op.hardswish: (-1x144x7x7xf32) <- (-1x144x7x7xf32)
        hardswish_12 = paddle._C_ops.hardswish(batch_norm__150)

        # pd_op.pool2d: (-1x144x1x1xf32) <- (-1x144x7x7xf32, 2xi64)
        ...
        # pd_op.conv2d: (-1x36x1x1xf32) <- (-1x144x1x1xf32, 36x144x1x1xf32)
        ...
        # pd_op.add: (-1x36x1x1xf32) <- (-1x36x1x1xf32, 1x36x1x1xf32)
        add_20 = paddle._C_ops.add(conv2d_30, reshape_12)

        # pd_op.relu: (-1x36x1x1xf32) <- (-1x36x1x1xf32)
        relu_12 = paddle._C_ops.relu(add_20)

        # pd_op.conv2d: (-1x144x1x1xf32) <- (-1x36x1x1xf32, 144x36x1x1xf32)
        ...
        # pd_op.add: (-1x144x1x1xf32) <- (-1x144x1x1xf32, 1x144x1x1xf32)
        add_21 = paddle._C_ops.add(conv2d_31, reshape_13)

        # pd_op.hardsigmoid: (-1x144x1x1xf32) <- (-1x144x1x1xf32)
        hardsigmoid_6 = paddle._C_ops.hardsigmoid(add_21, float("0.2"), float("0.5"))

        # pd_op.multiply: (-1x144x7x7xf32) <- (-1x144x7x7xf32, -1x144x1x1xf32)
        multiply_6 = paddle._C_ops.multiply(hardswish_12, hardsigmoid_6)

        # pd_op.conv2d: (-1x48x7x7xf32) <- (-1x144x7x7xf32, 48x144x1x1xf32)
        conv2d_32 = paddle._C_ops.conv2d(
            multiply_6, parameter_50, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (-1x48x7x7xf32, 48xf32, 48xf32, 48xf32, 48xf32, -1xui8) <- (-1x48x7x7xf32, 48xf32, 48xf32, 48xf32, 48xf32)
        (
            batch_norm__156,
            batch_norm__157,
            batch_norm__158,
        ...
        # pd_op.conv2d: (-1x288x7x7xf32) <- (-1x48x7x7xf32, 288x48x1x1xf32)
        ...
        # pd_op.hardswish: (-1x288x7x7xf32) <- (-1x288x7x7xf32)
        hardswish_13 = paddle._C_ops.hardswish(batch_norm__162)

        # pd_op.depthwise_conv2d: (-1x288x7x7xf32) <- (-1x288x7x7xf32, 288x1x5x5xf32)
        depthwise_conv2d_9 = paddle._C_ops.depthwise_conv2d(
            hardswish_13, parameter_40, [1, 1], [2, 2], "EXPLICIT", 288, [1, 1], "NCHW"
        )
        ...
        # pd_op.pool2d: (-1x288x1x1xf32) <- (-1x288x7x7xf32, 2xi64)
        ...
        # pd_op.conv2d: (-1x72x1x1xf32) <- (-1x288x1x1xf32, 72x288x1x1xf32)
        ...
        # pd_op.relu: (-1x72x1x1xf32) <- (-1x72x1x1xf32)
        relu_13 = paddle._C_ops.relu(add_22)

        # pd_op.conv2d: (-1x288x1x1xf32) <- (-1x72x1x1xf32, 288x72x1x1xf32)
        ...
        # pd_op.add: (-1x288x1x1xf32) <- (-1x288x1x1xf32, 1x288x1x1xf32)
        add_23 = paddle._C_ops.add(conv2d_35, reshape_15)

        # pd_op.hardsigmoid: (-1x288x1x1xf32) <- (-1x288x1x1xf32)
        hardsigmoid_7 = paddle._C_ops.hardsigmoid(add_23, float("0.2"), float("0.5"))

        # pd_op.multiply: (-1x288x7x7xf32) <- (-1x288x7x7xf32, -1x288x1x1xf32)
        multiply_7 = paddle._C_ops.multiply(hardswish_14, hardsigmoid_7)

        # pd_op.conv2d: (-1x48x7x7xf32) <- (-1x288x7x7xf32, 48x288x1x1xf32)
        ...
        # pd_op.add: (-1x48x7x7xf32) <- (-1x48x7x7xf32, -1x48x7x7xf32)
        ...
        depthwise_conv2d_10 = paddle._C_ops.depthwise_conv2d(
            hardswish_15, parameter_21, [1, 1], [2, 2], "EXPLICIT", 288, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x1280x1x1xf32) <- (-1x288x1x1xf32, 1280x288x1x1xf32)
