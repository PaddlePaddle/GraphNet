...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.roi_align: (-1x256x14x14xf32) <- (1x256x160x240xf32, -1x4xf32, -1xi32)
        roi_align_0 = paddle._C_ops.roi_align(
            data_5, split_0, split_4, 14, 14, float("0.25"), 0, True
        )

        # pd_op.roi_align: (-1x256x14x14xf32) <- (1x256x80x120xf32, -1x4xf32, -1xi32)
        roi_align_1 = paddle._C_ops.roi_align(
            data_6, split_1, split_5, 14, 14, float("0.125"), 0, True
        )

        # pd_op.roi_align: (-1x256x14x14xf32) <- (1x256x40x60xf32, -1x4xf32, -1xi32)
        roi_align_2 = paddle._C_ops.roi_align(
            data_7, split_2, split_6, 14, 14, float("0.0625"), 0, True
        )

        # pd_op.roi_align: (-1x256x14x14xf32) <- (1x256x20x30xf32, -1x4xf32, -1xi32)
