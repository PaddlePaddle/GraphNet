...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.transpose: (2x1024x324xf32) <- (2x324x1024xf32)
        transpose_0 = paddle._C_ops.transpose(data_0, [0, 2, 1])

        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_3 = [2, 1024, 18, 18]

        # pd_op.reshape: (2x1024x18x18xf32) <- (2x1024x324xf32, 4xi64)
        reshape_0 = paddle._C_ops.reshape(transpose_0, full_int_array_3)

        # pd_op.conv2d: (2x384x18x18xf32) <- (2x1024x18x18xf32, 384x1024x1x1xf32)
        ...
        # pd_op.conv2d: (2x384x18x18xf32) <- (2x384x18x18xf32, 384x384x3x3xf32)
        ...
        # pd_op.add: (2x384x18x18xf32) <- (2x384x18x18xf32, 2x384x18x18xf32)
        ...
        # pd_op.pool2d: (2x384x18x18xf32) <- (2x384x18x18xf32, 2xi64)
        ...
        # builtin.combine: ([2x384x18x18xf32, 2x384x18x18xf32, 2x384x18x18xf32, 2x384x18x18xf32]) <- (2x384x18x18xf32, 2x384x18x18xf32, 2x384x18x18xf32, 2x384x18x18xf32)
        combine_0 = [swish_5, pool2d_0, pool2d_1, pool2d_2]

        # pd_op.concat: (2x1536x18x18xf32) <- ([2x384x18x18xf32, 2x384x18x18xf32, 2x384x18x18xf32, 2x384x18x18xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_0)

        # pd_op.conv2d: (2x384x18x18xf32) <- (2x1536x18x18xf32, 384x1536x1x1xf32)
        ...
        # builtin.combine: ([2x384x18x18xf32, 2x384x18x18xf32]) <- (2x384x18x18xf32, 2x384x18x18xf32)
        combine_1 = [swish_0, swish_8]

        # pd_op.concat: (2x768x18x18xf32) <- ([2x384x18x18xf32, 2x384x18x18xf32], 1xi32)
        concat_1 = paddle._C_ops.concat(combine_1, full_0)

        # pd_op.conv2d: (2x768x18x18xf32) <- (2x768x18x18xf32, 768x768x1x1xf32)
        conv2d_12 = paddle._C_ops.conv2d(
            concat_1, parameter_264, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (2x768x18x18xf32, 768xf32, 768xf32, 768xf32, 768xf32, -1xui8) <- (2x768x18x18xf32, 768xf32, 768xf32, 768xf32, 768xf32)
        (
            batch_norm__72,
            batch_norm__73,
            batch_norm__74,
        ...
        # pd_op.swish: (2x768x18x18xf32) <- (2x768x18x18xf32)
        swish_9 = paddle._C_ops.swish(batch_norm__72)

        # pd_op.conv2d: (2x384x18x18xf32) <- (2x768x18x18xf32, 384x768x1x1xf32)
        ...
        # pd_op.nearest_interp: (2x384x36x36xf32) <- (2x384x18x18xf32, None, None, None)
        ...
        # builtin.combine: ([2x384x36x36xf32, 2x512x36x36xf32]) <- (2x384x36x36xf32, 2x512x36x36xf32)
        combine_2 = [nearest_interp_0, data_2]

        # pd_op.concat: (2x896x36x36xf32) <- ([2x384x36x36xf32, 2x512x36x36xf32], 1xi32)
        concat_2 = paddle._C_ops.concat(combine_2, full_0)

        # pd_op.conv2d: (2x192x36x36xf32) <- (2x896x36x36xf32, 192x896x1x1xf32)
        ...
        # pd_op.conv2d: (2x192x36x36xf32) <- (2x192x36x36xf32, 192x192x3x3xf32)
        ...
        # pd_op.add: (2x192x36x36xf32) <- (2x192x36x36xf32, 2x192x36x36xf32)
        ...
        # builtin.combine: ([2x192x36x36xf32, 2x192x36x36xf32]) <- (2x192x36x36xf32, 2x192x36x36xf32)
        combine_3 = [swish_11, swish_18]

        # pd_op.concat: (2x384x36x36xf32) <- ([2x192x36x36xf32, 2x192x36x36xf32], 1xi32)
        concat_3 = paddle._C_ops.concat(combine_3, full_0)

        # pd_op.conv2d: (2x384x36x36xf32) <- (2x384x36x36xf32, 384x384x1x1xf32)
        conv2d_25 = paddle._C_ops.conv2d(
            concat_3, parameter_199, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (2x384x36x36xf32, 384xf32, 384xf32, 384xf32, 384xf32, -1xui8) <- (2x384x36x36xf32, 384xf32, 384xf32, 384xf32, 384xf32)
        (
            batch_norm__150,
            batch_norm__151,
            batch_norm__152,
        ...
        # pd_op.swish: (2x384x36x36xf32) <- (2x384x36x36xf32)
        swish_19 = paddle._C_ops.swish(batch_norm__150)

        # pd_op.conv2d: (2x192x36x36xf32) <- (2x384x36x36xf32, 192x384x1x1xf32)
        ...
        # pd_op.nearest_interp: (2x192x72x72xf32) <- (2x192x36x36xf32, None, None, None)
        ...
        # builtin.combine: ([2x192x72x72xf32, 2x256x72x72xf32]) <- (2x192x72x72xf32, 2x256x72x72xf32)
        combine_4 = [nearest_interp_1, data_1]

        # pd_op.concat: (2x448x72x72xf32) <- ([2x192x72x72xf32, 2x256x72x72xf32], 1xi32)
        concat_4 = paddle._C_ops.concat(combine_4, full_0)

        # pd_op.conv2d: (2x96x72x72xf32) <- (2x448x72x72xf32, 96x448x1x1xf32)
        ...
        # pd_op.conv2d: (2x96x72x72xf32) <- (2x96x72x72xf32, 96x96x3x3xf32)
        ...
        # pd_op.add: (2x96x72x72xf32) <- (2x96x72x72xf32, 2x96x72x72xf32)
        ...
        # builtin.combine: ([2x96x72x72xf32, 2x96x72x72xf32]) <- (2x96x72x72xf32, 2x96x72x72xf32)
        combine_5 = [swish_21, swish_28]

        # pd_op.concat: (2x192x72x72xf32) <- ([2x96x72x72xf32, 2x96x72x72xf32], 1xi32)
        concat_5 = paddle._C_ops.concat(combine_5, full_0)

        # pd_op.conv2d: (2x192x72x72xf32) <- (2x192x72x72xf32, 192x192x1x1xf32)
        conv2d_38 = paddle._C_ops.conv2d(
            concat_5, parameter_134, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (2x192x72x72xf32, 192xf32, 192xf32, 192xf32, 192xf32, -1xui8) <- (2x192x72x72xf32, 192xf32, 192xf32, 192xf32, 192xf32)
        (
            batch_norm__228,
            batch_norm__229,
            batch_norm__230,
        ...
        # pd_op.swish: (2x192x72x72xf32) <- (2x192x72x72xf32)
        swish_49 = paddle._C_ops.swish(batch_norm__228)

        # pd_op.conv2d: (2x192x36x36xf32) <- (2x192x72x72xf32, 192x192x3x3xf32)
        ...
        # builtin.combine: ([2x192x36x36xf32, 2x384x36x36xf32]) <- (2x192x36x36xf32, 2x384x36x36xf32)
        combine_6 = [swish_29, swish_19]

        # pd_op.concat: (2x576x36x36xf32) <- ([2x192x36x36xf32, 2x384x36x36xf32], 1xi32)
        concat_6 = paddle._C_ops.concat(combine_6, full_0)

        # pd_op.conv2d: (2x192x36x36xf32) <- (2x576x36x36xf32, 192x576x1x1xf32)
        ...
        # pd_op.conv2d: (2x384x18x18xf32) <- (2x384x36x36xf32, 384x384x3x3xf32)
        ...
        # builtin.combine: ([2x384x18x18xf32, 2x768x18x18xf32]) <- (2x384x18x18xf32, 2x768x18x18xf32)
        combine_8 = [swish_38, swish_9]

        # pd_op.concat: (2x1152x18x18xf32) <- ([2x384x18x18xf32, 2x768x18x18xf32], 1xi32)
        concat_8 = paddle._C_ops.concat(combine_8, full_0)

        # pd_op.conv2d: (2x384x18x18xf32) <- (2x1152x18x18xf32, 384x1152x1x1xf32)
