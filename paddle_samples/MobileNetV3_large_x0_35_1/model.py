...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (-1x24x112x112xf32) <- (-1x8x112x112xf32, 24x8x1x1xf32)
        ...
        # pd_op.conv2d: (-1x8x56x56xf32) <- (-1x24x56x56xf32, 8x24x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x24x56x56xf32) <- (-1x24x56x56xf32, 24x1x3x3xf32)
        ...
        # pd_op.add: (-1x8x56x56xf32) <- (-1x8x56x56xf32, -1x8x56x56xf32)
        ...
        # pd_op.pool2d: (-1x24x1x1xf32) <- (-1x24x28x28xf32, 2xi64)
        ...
        # pd_op.multiply: (-1x24x28x28xf32) <- (-1x24x28x28xf32, -1x24x1x1xf32)
        ...
        # pd_op.conv2d: (-1x40x28x28xf32) <- (-1x16x28x28xf32, 40x16x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x40x28x28xf32) <- (-1x40x28x28xf32, 40x1x5x5xf32)
        ...
        # pd_op.conv2d: (-1x88x28x28xf32) <- (-1x16x28x28xf32, 88x16x1x1xf32)
        ...
        # pd_op.hardswish: (-1x88x28x28xf32) <- (-1x88x28x28xf32)
        hardswish_1 = paddle._C_ops.hardswish(batch_norm__114)

        # pd_op.depthwise_conv2d: (-1x88x14x14xf32) <- (-1x88x28x28xf32, 88x1x3x3xf32)
        ...
        # pd_op.conv2d: (-1x32x14x14xf32) <- (-1x88x14x14xf32, 32x88x1x1xf32)
        ...
        # pd_op.conv2d: (-1x72x14x14xf32) <- (-1x32x14x14xf32, 72x32x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x72x14x14xf32) <- (-1x72x14x14xf32, 72x1x3x3xf32)
        ...
        # pd_op.conv2d: (-1x64x14x14xf32) <- (-1x32x14x14xf32, 64x32x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x64x14x14xf32) <- (-1x64x14x14xf32, 64x1x3x3xf32)
        ...
        # pd_op.conv2d: (-1x32x14x14xf32) <- (-1x64x14x14xf32, 32x64x1x1xf32)
        ...
        # pd_op.conv2d: (-1x168x14x14xf32) <- (-1x32x14x14xf32, 168x32x1x1xf32)
        conv2d_27 = paddle._C_ops.conv2d(
            add_13, parameter_102, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (-1x168x14x14xf32, 168xf32, 168xf32, 168xf32, 168xf32, -1xui8) <- (-1x168x14x14xf32, 168xf32, 168xf32, 168xf32, 168xf32)
        (
            batch_norm__186,
            batch_norm__187,
            batch_norm__188,
        ...
        # pd_op.hardswish: (-1x168x14x14xf32) <- (-1x168x14x14xf32)
        hardswish_9 = paddle._C_ops.hardswish(batch_norm__186)

        # pd_op.depthwise_conv2d: (-1x168x14x14xf32) <- (-1x168x14x14xf32, 168x1x3x3xf32)
        ...
        # pd_op.pool2d: (-1x168x1x1xf32) <- (-1x168x14x14xf32, 2xi64)
        ...
        # pd_op.conv2d: (-1x42x1x1xf32) <- (-1x168x1x1xf32, 42x168x1x1xf32)
        ...
        # pd_op.add: (-1x42x1x1xf32) <- (-1x42x1x1xf32, 1x42x1x1xf32)
        add_14 = paddle._C_ops.add(conv2d_28, reshape_6)

        # pd_op.relu: (-1x42x1x1xf32) <- (-1x42x1x1xf32)
        relu_15 = paddle._C_ops.relu(add_14)

        # pd_op.conv2d: (-1x168x1x1xf32) <- (-1x42x1x1xf32, 168x42x1x1xf32)
        ...
        # pd_op.add: (-1x168x1x1xf32) <- (-1x168x1x1xf32, 1x168x1x1xf32)
        add_15 = paddle._C_ops.add(conv2d_29, reshape_7)

        # pd_op.hardsigmoid: (-1x168x1x1xf32) <- (-1x168x1x1xf32)
        hardsigmoid_3 = paddle._C_ops.hardsigmoid(add_15, float("0.2"), float("0.5"))

        # pd_op.multiply: (-1x168x14x14xf32) <- (-1x168x14x14xf32, -1x168x1x1xf32)
        multiply_3 = paddle._C_ops.multiply(hardswish_10, hardsigmoid_3)

        # pd_op.conv2d: (-1x40x14x14xf32) <- (-1x168x14x14xf32, 40x168x1x1xf32)
        ...
        # pd_op.conv2d: (-1x232x14x14xf32) <- (-1x40x14x14xf32, 232x40x1x1xf32)
        ...
        # pd_op.pool2d: (-1x232x1x1xf32) <- (-1x232x14x14xf32, 2xi64)
        ...
        # pd_op.conv2d: (-1x58x1x1xf32) <- (-1x232x1x1xf32, 58x232x1x1xf32)
        ...
        # pd_op.add: (-1x58x1x1xf32) <- (-1x58x1x1xf32, 1x58x1x1xf32)
        add_16 = paddle._C_ops.add(conv2d_32, reshape_8)

        # pd_op.relu: (-1x58x1x1xf32) <- (-1x58x1x1xf32)
        relu_16 = paddle._C_ops.relu(add_16)

        # pd_op.conv2d: (-1x232x1x1xf32) <- (-1x58x1x1xf32, 232x58x1x1xf32)
        ...
        # pd_op.add: (-1x232x1x1xf32) <- (-1x232x1x1xf32, 1x232x1x1xf32)
        add_17 = paddle._C_ops.add(conv2d_33, reshape_9)

        # pd_op.hardsigmoid: (-1x232x1x1xf32) <- (-1x232x1x1xf32)
        hardsigmoid_4 = paddle._C_ops.hardsigmoid(add_17, float("0.2"), float("0.5"))

        # pd_op.multiply: (-1x232x14x14xf32) <- (-1x232x14x14xf32, -1x232x1x1xf32)
        multiply_4 = paddle._C_ops.multiply(hardswish_12, hardsigmoid_4)

        # pd_op.conv2d: (-1x40x14x14xf32) <- (-1x232x14x14xf32, 40x232x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x232x7x7xf32) <- (-1x232x14x14xf32, 232x1x5x5xf32)
        depthwise_conv2d_12 = paddle._C_ops.depthwise_conv2d(
            hardswish_13, parameter_59, [2, 2], [2, 2], "EXPLICIT", 232, [1, 1], "NCHW"
        )

        # pd_op.batch_norm_: (-1x232x7x7xf32, 232xf32, 232xf32, 232xf32, 232xf32, -1xui8) <- (-1x232x7x7xf32, 232xf32, 232xf32, 232xf32, 232xf32)
        (
            batch_norm__228,
            batch_norm__229,
            batch_norm__230,
        ...
        # pd_op.hardswish: (-1x232x7x7xf32) <- (-1x232x7x7xf32)
        hardswish_14 = paddle._C_ops.hardswish(batch_norm__228)

        # pd_op.pool2d: (-1x232x1x1xf32) <- (-1x232x7x7xf32, 2xi64)
        ...
        # pd_op.multiply: (-1x232x7x7xf32) <- (-1x232x7x7xf32, -1x232x1x1xf32)
        multiply_5 = paddle._C_ops.multiply(hardswish_14, hardsigmoid_5)

        # pd_op.conv2d: (-1x56x7x7xf32) <- (-1x232x7x7xf32, 56x232x1x1xf32)
        conv2d_38 = paddle._C_ops.conv2d(
            multiply_5, parameter_50, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (-1x56x7x7xf32, 56xf32, 56xf32, 56xf32, 56xf32, -1xui8) <- (-1x56x7x7xf32, 56xf32, 56xf32, 56xf32, 56xf32)
        (
            batch_norm__234,
            batch_norm__235,
            batch_norm__236,
        ...
        # pd_op.conv2d: (-1x336x7x7xf32) <- (-1x56x7x7xf32, 336x56x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x336x7x7xf32) <- (-1x336x7x7xf32, 336x1x5x5xf32)
        ...
        # pd_op.conv2d: (-1x56x7x7xf32) <- (-1x336x7x7xf32, 56x336x1x1xf32)
        ...
        # pd_op.add: (-1x56x7x7xf32) <- (-1x56x7x7xf32, -1x56x7x7xf32)
        ...
        # pd_op.conv2d: (-1x1280x1x1xf32) <- (-1x336x1x1xf32, 1280x336x1x1xf32)
