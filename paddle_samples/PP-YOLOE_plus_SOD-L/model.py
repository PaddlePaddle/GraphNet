...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.dropout: (2x324x1024xf32, 2x324x1024xui8) <- (2x324x1024xf32, None, 1xf32)
        ...
        # pd_op.add: (2x324x1024xf32) <- (2x324x1024xf32, 2x324x1024xf32)
        add_0 = paddle._C_ops.add(data_1, dropout_0)

        # pd_op.layer_norm: (2x324x1024xf32, 2x324xf32, 2x324xf32) <- (2x324x1024xf32, 1024xf32, 1024xf32)
        ...
        # pd_op.matmul: (2x324x2048xf32) <- (2x324x1024xf32, 1024x2048xf32)
        ...
        # pd_op.matmul: (2x324x1024xf32) <- (2x324x2048xf32, 2048x1024xf32)
        matmul_1 = paddle._C_ops.matmul(dropout_2, parameter_3, False, False)

        # pd_op.add: (2x324x1024xf32) <- (2x324x1024xf32, 1024xf32)
