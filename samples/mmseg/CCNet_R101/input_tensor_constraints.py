...
dynamic_dim_constraint_input_shapes = [
    ...
    ([], "L_self_modules_decode_head_modules_cca_modules_gamma_parameters_scale_"),
    ([64], "L_self_modules_decode_head_modules_cca_modules_key_conv_parameters_bias_"),
    (
        [64, 512, 1, 1],
        "L_self_modules_decode_head_modules_cca_modules_key_conv_parameters_weight_",
    ),
    (
        [64],
        "L_self_modules_decode_head_modules_cca_modules_query_conv_parameters_bias_",
    ),
    (
        [64, 512, 1, 1],
        "L_self_modules_decode_head_modules_cca_modules_query_conv_parameters_weight_",
    ),
    (
        [512],
        "L_self_modules_decode_head_modules_cca_modules_value_conv_parameters_bias_",
    ),
    (
        [512, 512, 1, 1],
        "L_self_modules_decode_head_modules_cca_modules_value_conv_parameters_weight_",
    ),
    (
        [512],
    ...
    ([512], "L_self_modules_decode_head_modules_conv_cat_modules_bn_parameters_bias_"),
    (
        [512],
