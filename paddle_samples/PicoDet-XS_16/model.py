...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.subtract: (4x3x-1x1xf32) <- (1x1x-1x1xf32, 4x3x1x1xf32)
        subtract_0 = paddle._C_ops.subtract(split_0, split_2)

        # pd_op.subtract: (4x3x-1x1xf32) <- (1x1x-1x1xf32, 4x3x1x1xf32)
        subtract_1 = paddle._C_ops.subtract(split_1, split_3)

        # pd_op.subtract: (4x3x-1x1xf32) <- (4x3x1x1xf32, 1x1x-1x1xf32)
        ...
        # builtin.combine: ([4x3x-1x1xf32, 4x3x-1x1xf32, 4x3x-1x1xf32, 4x3x-1x1xf32]) <- (4x3x-1x1xf32, 4x3x-1x1xf32, 4x3x-1x1xf32, 4x3x-1x1xf32)
        combine_0 = [subtract_0, subtract_1, subtract_2, subtract_3]

        # pd_op.concat: (4x3x-1x4xf32) <- ([4x3x-1x1xf32, 4x3x-1x1xf32, 4x3x-1x1xf32, 4x3x-1x1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_1)

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_2 = [-1]

        # pd_op.min: (4x3x-1xf32) <- (4x3x-1x4xf32, 1xi64)
        ...
        # pd_op.greater_than: (4x3x-1xb) <- (4x3x-1xf32, xf32)
        greater_than_0 = paddle._C_ops.greater_than(min_0, full_2)

        # pd_op.cast: (4x3x-1xf32) <- (4x3x-1xb)
