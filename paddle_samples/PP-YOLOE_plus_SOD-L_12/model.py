...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2):
        ...
        # pd_op.subtract: (2x60x2541x1xf32) <- (1x1x2541x1xf32, 2x60x1x1xf32)
        subtract_0 = paddle._C_ops.subtract(split_0, split_2)

        # pd_op.subtract: (2x60x2541x1xf32) <- (1x1x2541x1xf32, 2x60x1x1xf32)
        subtract_1 = paddle._C_ops.subtract(split_1, split_3)

        # pd_op.subtract: (2x60x2541x1xf32) <- (2x60x1x1xf32, 1x1x2541x1xf32)
        ...
        # builtin.combine: ([2x60x2541x1xf32, 2x60x2541x1xf32, 2x60x2541x1xf32, 2x60x2541x1xf32]) <- (2x60x2541x1xf32, 2x60x2541x1xf32, 2x60x2541x1xf32, 2x60x2541x1xf32)
        combine_0 = [subtract_0, subtract_1, subtract_2, subtract_3]

        # pd_op.concat: (2x60x2541x4xf32) <- ([2x60x2541x1xf32, 2x60x2541x1xf32, 2x60x2541x1xf32, 2x60x2541x1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_1)

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_2 = [-1]

        # pd_op.min: (2x60x2541xf32) <- (2x60x2541x4xf32, 1xi64)
        ...
        # pd_op.greater_than: (2x60x2541xb) <- (2x60x2541xf32, xf32)
        greater_than_0 = paddle._C_ops.greater_than(min_0, full_2)

        # pd_op.unsqueeze: (1x1x2541x1xf32) <- (2541x1xf32, 2xi64)
        ...
        # pd_op.subtract: (2x60x2541x1xf32) <- (1x1x2541x1xf32, 2x60x2541x1xf32)
        ...
        # pd_op.add: (2x60x2541x1xf32) <- (2x60x1x1xf32, 1x1x2541x1xf32)
        add_2 = paddle._C_ops.add(scale_0, unsqueeze_2)

        # pd_op.subtract: (2x60x2541x1xf32) <- (2x60x2541x1xf32, 1x1x2541x1xf32)
        ...
        # pd_op.cast: (2x60x2541xf32) <- (2x60x2541xb)
