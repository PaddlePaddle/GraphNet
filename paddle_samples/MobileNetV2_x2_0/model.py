...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        depthwise_conv2d_0 = paddle._C_ops.depthwise_conv2d(
            relu6_1, parameter_256, [1, 1], [1, 1], "EXPLICIT", 64, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_1 = paddle._C_ops.depthwise_conv2d(
            relu6_3, parameter_241, [2, 2], [1, 1], "EXPLICIT", 192, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_2 = paddle._C_ops.depthwise_conv2d(
            relu6_5, parameter_226, [1, 1], [1, 1], "EXPLICIT", 288, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_3 = paddle._C_ops.depthwise_conv2d(
            relu6_7, parameter_211, [2, 2], [1, 1], "EXPLICIT", 288, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_4 = paddle._C_ops.depthwise_conv2d(
            relu6_9, parameter_196, [1, 1], [1, 1], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_5 = paddle._C_ops.depthwise_conv2d(
            relu6_11, parameter_181, [1, 1], [1, 1], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_6 = paddle._C_ops.depthwise_conv2d(
            relu6_13, parameter_166, [2, 2], [1, 1], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_7 = paddle._C_ops.depthwise_conv2d(
            relu6_15, parameter_151, [1, 1], [1, 1], "EXPLICIT", 768, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_8 = paddle._C_ops.depthwise_conv2d(
            relu6_17, parameter_136, [1, 1], [1, 1], "EXPLICIT", 768, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_9 = paddle._C_ops.depthwise_conv2d(
            relu6_19, parameter_121, [1, 1], [1, 1], "EXPLICIT", 768, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_10 = paddle._C_ops.depthwise_conv2d(
            relu6_21, parameter_106, [1, 1], [1, 1], "EXPLICIT", 768, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_11 = paddle._C_ops.depthwise_conv2d(
            relu6_23, parameter_91, [1, 1], [1, 1], "EXPLICIT", 1152, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_12 = paddle._C_ops.depthwise_conv2d(
            relu6_25, parameter_76, [1, 1], [1, 1], "EXPLICIT", 1152, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_13 = paddle._C_ops.depthwise_conv2d(
            relu6_27, parameter_61, [2, 2], [1, 1], "EXPLICIT", 1152, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_14 = paddle._C_ops.depthwise_conv2d(
            relu6_29, parameter_46, [1, 1], [1, 1], "EXPLICIT", 1920, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_15 = paddle._C_ops.depthwise_conv2d(
            relu6_31, parameter_31, [1, 1], [1, 1], "EXPLICIT", 1920, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_16 = paddle._C_ops.depthwise_conv2d(
            relu6_33, parameter_16, [1, 1], [1, 1], "EXPLICIT", 1920, [1, 1], "NCHW"
        )
