...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2):
        ...
        # pd_op.slice: (2x-1x1xf32) <- (2x-1x2xf32, 1xi64, 1xi64)
        slice_0 = paddle._C_ops.slice(
            one_hot_0, [2], full_int_array_1, full_int_array_2, [1], []
        )

        # pd_op.pow: (2x-1x1xf32) <- (2x-1x1xf32)
        ...
        # pd_op.add: (2x-1x1xf32) <- (2x-1x1xf32, 2x-1x1xf32)
        add_0 = paddle._C_ops.add(multiply_0, multiply_1)

        # pd_op.bce_loss: (2x-1x1xf32) <- (2x-1x1xf32, 2x-1x1xf32)
        ...
        # pd_op.sum: (xf32) <- (2x-1x1xf32, 0xi64)
