...
class Program_weight_tensor_data_4:
    ...
    dtype = "float32"
    min_val = float("-976.895")
    max_val = float("22.0479")
    mean = float("-30.7071")
    std = float("41.2895")
    data = None
...
class Program_weight_tensor_data_5:
    ...
    shape = [1, 4]
    dtype = "float32"
    data = [0.29765, 0.744208, 0.329852, 0.494852]
...
class Program_weight_tensor_data_6:
    ...
    shape = [1, 100, 2]
    dtype = "float32"
    min_val = float("-4.39509")
    max_val = float("-2.79119")
    mean = float("-3.62516")
    std = float("0.419116")
    data = None
...
class Program_weight_tensor_data_11:
    ...
    shape = [1, 100, 4]
    dtype = "float32"
    min_val = float("0.0201952")
    max_val = float("0.991728")
    mean = float("0.389869")
    std = float("0.276509")
    data = None
