...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4):
        ...
        # pd_op.topk: (2x7x9xf32, 2x7x9xi64) <- (2x7x3136xf32, 1xi32)
        ...
        # pd_op.scale: (2x7x9xi64) <- (2x7x9xi64, 1xf32)
        ...
        # pd_op.one_hot: (2x7x9x3136xf32) <- (2x7x9xi64, 1xi32)
        ...
        # pd_op.sum: (2x7x3136xf32) <- (2x7x9x3136xf32, 1xi64)
        sum_0 = paddle._C_ops.sum(one_hot_0, full_int_array_0, None, False)

        # pd_op.multiply: (2x7x3136xf32) <- (2x7x3136xf32, 2x7x1xf32)
        multiply_0 = paddle._C_ops.multiply(sum_0, data_4)

        # pd_op.topk: (2x7x9xf32, 2x7x9xi64) <- (2x7x784xf32, 1xi32)
        ...
        # builtin.combine: ([2x7x3136xf32, 2x7x784xf32, 2x7x196xf32, 2x7x49xf32]) <- (2x7x3136xf32, 2x7x784xf32, 2x7x196xf32, 2x7x49xf32)
        combine_0 = [multiply_0, multiply_1, multiply_2, multiply_3]

        # pd_op.concat: (2x7x4165xf32) <- ([2x7x3136xf32, 2x7x784xf32, 2x7x196xf32, 2x7x49xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_6)

        # builtin.combine: ([2x7x9xi64, 2x7x9xi64, 2x7x9xi64, 2x7x9xi64]) <- (2x7x9xi64, 2x7x9xi64, 2x7x9xi64, 2x7x9xi64)
        combine_1 = [scale_0, scale_1, scale_2, scale_3]

        # pd_op.concat: (2x7x36xi64) <- ([2x7x9xi64, 2x7x9xi64, 2x7x9xi64, 2x7x9xi64], 1xi32)
