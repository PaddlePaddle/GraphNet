...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.matmul: (256x128xf32) <- (256x1xf32, 1x128xf32)
        ...
        # pd_op.sin: (256x128xf32) <- (256x128xf32)
        sin_0 = paddle._C_ops.sin(matmul_0)

        # pd_op.cos: (256x128xf32) <- (256x128xf32)
        ...
        # builtin.combine: ([256x128xf32, 256x128xf32, 256x128xf32, 256x128xf32]) <- (256x128xf32, 256x128xf32, 256x128xf32, 256x128xf32)
        combine_1 = [sin_0, cos_0, sin_1, cos_1]

        # pd_op.concat: (256x512xf32) <- ([256x128xf32, 256x128xf32, 256x128xf32, 256x128xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_1, full_7)

        # pd_op.unsqueeze: (1x256x512xf32) <- (256x512xf32, 1xi64)
