...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6, data_7):
        ...
        # pd_op.share_data_: (10308x4xf32) <- (10308x4xf32)
        ...
        # pd_op.max: (10308x1xf32) <- (10308x4xf32, 1xi64)
        ...
        # pd_op.sum: (xf32) <- (10308x4xf32, 0xi64)
