...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.relu6: (-1x64x112x112xf32) <- (-1x64x112x112xf32)
        t273 = paddle._C_ops.relu6(t267)
        del t267

        # pd_op.conv2d: (-1x64x112x112xf32) <- (-1x64x112x112xf32, 64x64x1x1xf32)
        ...
        del t274, t9, t8, t7, t6

        # pd_op.relu6: (-1x64x112x112xf32) <- (-1x64x112x112xf32)
        t281 = paddle._C_ops.relu6(t275)
        del t275

        # pd_op.depthwise_conv2d: (-1x64x112x112xf32) <- (-1x64x112x112xf32, 64x1x3x3xf32)
        t282 = paddle._C_ops.depthwise_conv2d(
            t281, t10, [1, 1], [1, 1], "EXPLICIT", 64, [1, 1], "NCHW"
        )
        del t10, t281
        ...
        del t282, t14, t13, t12, t11

        # pd_op.relu6: (-1x64x112x112xf32) <- (-1x64x112x112xf32)
        t289 = paddle._C_ops.relu6(t283)
        del t283

        # pd_op.conv2d: (-1x32x112x112xf32) <- (-1x64x112x112xf32, 32x64x1x1xf32)
        ...
        del t290, t19, t18, t17, t16

        # pd_op.conv2d: (-1x192x112x112xf32) <- (-1x32x112x112xf32, 192x32x1x1xf32)
        t297 = paddle._C_ops.conv2d(
            t291, t20, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del t291, t20

        # pd_op.batch_norm_: (-1x192x112x112xf32, 192xf32, 192xf32, 192xf32, 192xf32, -1xui8) <- (-1x192x112x112xf32, 192xf32, 192xf32, 192xf32, 192xf32)
        ...
        del t297, t24, t23, t22, t21

        # pd_op.relu6: (-1x192x112x112xf32) <- (-1x192x112x112xf32)
        t304 = paddle._C_ops.relu6(t298)
        del t298

        # pd_op.depthwise_conv2d: (-1x192x56x56xf32) <- (-1x192x112x112xf32, 192x1x3x3xf32)
        t305 = paddle._C_ops.depthwise_conv2d(
            t304, t25, [2, 2], [1, 1], "EXPLICIT", 192, [1, 1], "NCHW"
        )
        del t25, t304
        ...
        del t305, t29, t28, t27, t26

        # pd_op.relu6: (-1x192x56x56xf32) <- (-1x192x56x56xf32)
        t312 = paddle._C_ops.relu6(t306)
        del t306

        # pd_op.conv2d: (-1x48x56x56xf32) <- (-1x192x56x56xf32, 48x192x1x1xf32)
        ...
        del t313, t34, t33, t32, t31

        # pd_op.conv2d: (-1x288x56x56xf32) <- (-1x48x56x56xf32, 288x48x1x1xf32)
        ...
        del t320, t39, t38, t37, t36

        # pd_op.relu6: (-1x288x56x56xf32) <- (-1x288x56x56xf32)
        t327 = paddle._C_ops.relu6(t321)
        del t321

        # pd_op.depthwise_conv2d: (-1x288x56x56xf32) <- (-1x288x56x56xf32, 288x1x3x3xf32)
        t328 = paddle._C_ops.depthwise_conv2d(
            t327, t40, [1, 1], [1, 1], "EXPLICIT", 288, [1, 1], "NCHW"
        )
        del t40, t327
        ...
        del t328, t44, t43, t42, t41

        # pd_op.relu6: (-1x288x56x56xf32) <- (-1x288x56x56xf32)
        t335 = paddle._C_ops.relu6(t329)
        del t329

        # pd_op.conv2d: (-1x48x56x56xf32) <- (-1x288x56x56xf32, 48x288x1x1xf32)
        ...
        del t336, t49, t48, t47, t46

        # pd_op.add: (-1x48x56x56xf32) <- (-1x48x56x56xf32, -1x48x56x56xf32)
        ...
        del t344, t54, t53, t52, t51

        # pd_op.relu6: (-1x288x56x56xf32) <- (-1x288x56x56xf32)
        t351 = paddle._C_ops.relu6(t345)
        del t345

        # pd_op.depthwise_conv2d: (-1x288x28x28xf32) <- (-1x288x56x56xf32, 288x1x3x3xf32)
        t352 = paddle._C_ops.depthwise_conv2d(
            t351, t55, [2, 2], [1, 1], "EXPLICIT", 288, [1, 1], "NCHW"
        )
        del t55, t351
        ...
        del t352, t59, t58, t57, t56

        # pd_op.relu6: (-1x288x28x28xf32) <- (-1x288x28x28xf32)
        t359 = paddle._C_ops.relu6(t353)
        del t353

        # pd_op.conv2d: (-1x64x28x28xf32) <- (-1x288x28x28xf32, 64x288x1x1xf32)
        ...
        del t360, t64, t63, t62, t61

        # pd_op.conv2d: (-1x384x28x28xf32) <- (-1x64x28x28xf32, 384x64x1x1xf32)
        ...
        del t367, t69, t68, t67, t66

        # pd_op.relu6: (-1x384x28x28xf32) <- (-1x384x28x28xf32)
        t374 = paddle._C_ops.relu6(t368)
        del t368

        # pd_op.depthwise_conv2d: (-1x384x28x28xf32) <- (-1x384x28x28xf32, 384x1x3x3xf32)
        t375 = paddle._C_ops.depthwise_conv2d(
            t374, t70, [1, 1], [1, 1], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        del t70, t374
        ...
        del t375, t74, t73, t72, t71

        # pd_op.relu6: (-1x384x28x28xf32) <- (-1x384x28x28xf32)
        t382 = paddle._C_ops.relu6(t376)
        del t376

        # pd_op.conv2d: (-1x64x28x28xf32) <- (-1x384x28x28xf32, 64x384x1x1xf32)
        ...
        t399 = paddle._C_ops.depthwise_conv2d(
            t398, t85, [1, 1], [1, 1], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        del t85, t398
        ...
        t423 = paddle._C_ops.depthwise_conv2d(
            t422, t100, [2, 2], [1, 1], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        del t100, t422
        ...
        del t438, t114, t113, t112, t111

        # pd_op.relu6: (-1x768x14x14xf32) <- (-1x768x14x14xf32)
        t445 = paddle._C_ops.relu6(t439)
        del t439

        # pd_op.depthwise_conv2d: (-1x768x14x14xf32) <- (-1x768x14x14xf32, 768x1x3x3xf32)
        t446 = paddle._C_ops.depthwise_conv2d(
            t445, t115, [1, 1], [1, 1], "EXPLICIT", 768, [1, 1], "NCHW"
        )
        del t115, t445
        ...
        t470 = paddle._C_ops.depthwise_conv2d(
            t469, t130, [1, 1], [1, 1], "EXPLICIT", 768, [1, 1], "NCHW"
        )
        del t130, t469
        ...
        t494 = paddle._C_ops.depthwise_conv2d(
            t493, t145, [1, 1], [1, 1], "EXPLICIT", 768, [1, 1], "NCHW"
        )
        del t145, t493
        ...
        t518 = paddle._C_ops.depthwise_conv2d(
            t517, t160, [1, 1], [1, 1], "EXPLICIT", 768, [1, 1], "NCHW"
        )
        del t160, t517
        ...
        del t526, t166, t169, t168, t167

        # pd_op.conv2d: (-1x1152x14x14xf32) <- (-1x192x14x14xf32, 1152x192x1x1xf32)
        ...
        del t533, t174, t173, t172, t171

        # pd_op.relu6: (-1x1152x14x14xf32) <- (-1x1152x14x14xf32)
        t540 = paddle._C_ops.relu6(t534)
        del t534

        # pd_op.depthwise_conv2d: (-1x1152x14x14xf32) <- (-1x1152x14x14xf32, 1152x1x3x3xf32)
        t541 = paddle._C_ops.depthwise_conv2d(
            t540, t175, [1, 1], [1, 1], "EXPLICIT", 1152, [1, 1], "NCHW"
        )
        del t175, t540
        ...
        del t549, t184, t183, t182, t181

        # pd_op.add: (-1x192x14x14xf32) <- (-1x192x14x14xf32, -1x192x14x14xf32)
        ...
        t565 = paddle._C_ops.depthwise_conv2d(
            t564, t190, [1, 1], [1, 1], "EXPLICIT", 1152, [1, 1], "NCHW"
        )
        del t190, t564
        ...
        del t581, t204, t203, t202, t201

        # pd_op.relu6: (-1x1152x14x14xf32) <- (-1x1152x14x14xf32)
        t588 = paddle._C_ops.relu6(t582)
        del t582

        # pd_op.depthwise_conv2d: (-1x1152x7x7xf32) <- (-1x1152x14x14xf32, 1152x1x3x3xf32)
        t589 = paddle._C_ops.depthwise_conv2d(
            t588, t205, [2, 2], [1, 1], "EXPLICIT", 1152, [1, 1], "NCHW"
        )
        del t205, t588
        ...
        del t589, t209, t208, t207, t206

        # pd_op.relu6: (-1x1152x7x7xf32) <- (-1x1152x7x7xf32)
        ...
        # pd_op.batch_norm_: (-1x320x7x7xf32, 320xf32, 320xf32, 320xf32, 320xf32, -1xui8) <- (-1x320x7x7xf32, 320xf32, 320xf32, 320xf32, 320xf32)
        ...
        del t597, t214, t213, t212, t211

        # pd_op.conv2d: (-1x1920x7x7xf32) <- (-1x320x7x7xf32, 1920x320x1x1xf32)
        ...
        del t604, t219, t218, t217, t216

        # pd_op.relu6: (-1x1920x7x7xf32) <- (-1x1920x7x7xf32)
        t611 = paddle._C_ops.relu6(t605)
        del t605

        # pd_op.depthwise_conv2d: (-1x1920x7x7xf32) <- (-1x1920x7x7xf32, 1920x1x3x3xf32)
        t612 = paddle._C_ops.depthwise_conv2d(
            t611, t220, [1, 1], [1, 1], "EXPLICIT", 1920, [1, 1], "NCHW"
        )
        del t220, t611
        ...
        del t612, t224, t223, t222, t221

        # pd_op.relu6: (-1x1920x7x7xf32) <- (-1x1920x7x7xf32)
        t619 = paddle._C_ops.relu6(t613)
        del t613

        # pd_op.conv2d: (-1x320x7x7xf32) <- (-1x1920x7x7xf32, 320x1920x1x1xf32)
        ...
        del t620, t229, t228, t227, t226

        # pd_op.add: (-1x320x7x7xf32) <- (-1x320x7x7xf32, -1x320x7x7xf32)
        ...
        t636 = paddle._C_ops.depthwise_conv2d(
            t635, t235, [1, 1], [1, 1], "EXPLICIT", 1920, [1, 1], "NCHW"
        )
        del t235, t635
        ...
        t660 = paddle._C_ops.depthwise_conv2d(
            t659, t250, [1, 1], [1, 1], "EXPLICIT", 1920, [1, 1], "NCHW"
        )
        del t250, t659
        ...
        del t660, t254, t253, t252, t251

        # pd_op.relu6: (-1x1920x7x7xf32) <- (-1x1920x7x7xf32)
        t667 = paddle._C_ops.relu6(t661)
        del t661

        # pd_op.conv2d: (-1x640x7x7xf32) <- (-1x1920x7x7xf32, 640x1920x1x1xf32)
        ...
        del t668, t256, t259, t258, t257

        # pd_op.conv2d: (-1x2560x7x7xf32) <- (-1x640x7x7xf32, 2560x640x1x1xf32)
        t675 = paddle._C_ops.conv2d(
            t669, t260, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del t669, t260

        # pd_op.batch_norm_: (-1x2560x7x7xf32, 2560xf32, 2560xf32, 2560xf32, 2560xf32, -1xui8) <- (-1x2560x7x7xf32, 2560xf32, 2560xf32, 2560xf32, 2560xf32)
        ...
        del t675, t264, t263, t262, t261

        # pd_op.relu6: (-1x2560x7x7xf32) <- (-1x2560x7x7xf32)
        ...
        # pd_op.flatten: (-1x2560xf32) <- (-1x2560x1x1xf32)
        t685 = paddle._C_ops.flatten(t684, 1, 3)
        del t684

        # pd_op.matmul: (-1x102xf32) <- (-1x2560xf32, 2560x102xf32)
