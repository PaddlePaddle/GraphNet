...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        combine_0 = [full_0, slice_2, data_0, full_1]

        # pd_op.stack: (4xi64) <- ([xi64, xi64, xi64, xi64])
        stack_0 = paddle._C_ops.stack(combine_0, 0)

        # pd_op.reshape: (4x-1x-1x80xf32) <- (4x-1x-1xf32, 4xi64)
        reshape_0 = paddle._C_ops.reshape(transpose_0, stack_0)

        # pd_op.conv2d: (4x384x-1x80xf32) <- (4x-1x-1x80xf32, 384x256x3x3xf32)
        ...
        reshape_1 = paddle._C_ops.reshape(parameter_2, full_int_array_3)

        # pd_op.add: (4x384x-1x80xf32) <- (4x384x-1x80xf32, 1x384x1x1xf32)
        add_0 = paddle._C_ops.add(conv2d_0, reshape_1)

        # pd_op.shape64: (4xi64) <- (4x384x-1x80xf32)
        ...
        # pd_op.flatten: (4x384x-1xf32) <- (4x384x-1x80xf32)
        flatten_0 = paddle._C_ops.flatten(add_0, 2, 3)

        # pd_op.transpose: (4x-1x384xf32) <- (4x384x-1xf32)
