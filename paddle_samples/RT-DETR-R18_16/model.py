...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.add: (-1x-1xf32) <- (-1x-1xf32, -1x1xf32)
        ...
        # pd_op.scale: (-1x-1xf32) <- (-1x-1xf32, 1xf32)
        scale_2 = paddle._C_ops.scale(scale_3, full_3, float("0"), True)
        return (
            full_0,
            split_0,
            split_1,
