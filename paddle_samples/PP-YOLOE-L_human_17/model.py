...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        ...
        full_int_array_1 = [1, 22, 1]

        # pd_op.tile: (2x22x12096xb) <- (2x1x12096xb, 3xi64)
        ...
        # pd_op.argmax: (2x12096xi64) <- (2x22x12096xf32, 1xi64)
        argmax_0 = paddle._C_ops.argmax(data_1, full_1, False, False, paddle.int64)

        # pd_op.full: (1xi32) <- ()
        full_2 = paddle._C_ops.full(
            [1], float("22"), paddle.int32, paddle.core.CPUPlace()
        )

        # pd_op.one_hot: (2x12096x22xf32) <- (2x12096xi64, 1xi32)
        one_hot_0 = paddle._C_ops.one_hot(
            argmax_0 % paddle.cast(full_2, argmax_0.dtype), full_2
        )

        # pd_op.transpose: (2x22x12096xf32) <- (2x12096x22xf32)
        transpose_0 = paddle._C_ops.transpose(one_hot_0, [0, 2, 1])

        # pd_op.where: (2x22x12096xf32) <- (2x22x12096xb, 2x22x12096xf32, 2x22x12096xf32)
        ...
        # pd_op.gather: (24192xi32) <- (44xi32, 24192xi64, 1xi32)
        ...
        # pd_op.gather: (24192x4xf32) <- (44x4xf32, 24192xi64, 1xi32)
        ...
        # pd_op.one_hot: (2x12096x2xf32) <- (2x12096xi32, 1xi32)
        ...
        # pd_op.index_select: (2x12096x1xf32) <- (2x12096x2xf32, 1xi64)
        ...
        # pd_op.max: (2x22x1xf32) <- (2x22x12096xf32, 1xi64)
        ...
        # pd_op.divide: (2x22x12096xf32) <- (2x22x12096xf32, 2x22x1xf32)
        ...
        # pd_op.max: (2x12096xf32) <- (2x22x12096xf32, 1xi64)
        ...
        # pd_op.multiply: (2x12096x1xf32) <- (2x12096x1xf32, 2x12096x1xf32)
