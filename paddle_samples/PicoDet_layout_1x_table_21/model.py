...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.subtract: (9180x6xf32) <- (9180x6xf32, 6xf32)
        ...
        # pd_op.subtract: (9180x6xf32) <- (6xf32, 9180x6xf32)
        ...
        # builtin.combine: ([9180x6xf32, 9180x6xf32, 9180x6xf32, 9180x6xf32]) <- (9180x6xf32, 9180x6xf32, 9180x6xf32, 9180x6xf32)
        combine_0 = [subtract_0, subtract_1, subtract_2, subtract_3]

        # pd_op.stack: (9180x4x6xf32) <- ([9180x6xf32, 9180x6xf32, 9180x6xf32, 9180x6xf32])
        stack_0 = paddle._C_ops.stack(combine_0, 1)

        # pd_op.min: (9180x6xf32) <- (9180x4x6xf32, 1xi64)
        ...
        # pd_op.greater_than: (9180x6xb) <- (9180x6xf32, xf32)
        greater_than_0 = paddle._C_ops.greater_than(min_0, full_0)

        # pd_op.sum: (9180xi64) <- (9180x6xb, 1xi64)
        ...
        # pd_op.greater_than: (9180xb) <- (9180xi64, xi64)
        ...
        # pd_op.scale: (9180x6xf32) <- (9180x6xf32, 1xf32)
        ...
        # pd_op.add: (9180x6xf32) <- (6xf32, 9180x6xf32)
        add_2 = paddle._C_ops.add(scale_0, scale_2)

        # pd_op.add: (9180x6xf32) <- (6xf32, 9180x6xf32)
        add_3 = paddle._C_ops.add(scale_1, scale_3)

        # pd_op.subtract: (9180x6xf32) <- (9180x6xf32, 9180x6xf32)
        ...
        # pd_op.cast: (9180x6xi64) <- (9180x6xb)
        ...
        # pd_op.gather: (-1x6xi64) <- (9180x6xi64, -1xi64, 1xi32)
