...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.unsqueeze: (12x1x4xf32) <- (12x4xf32, 1xi64)
        ...
        # pd_op.slice: (12x1x2xf32) <- (12x1x4xf32, 1xi64, 1xi64)
        ...
        # pd_op.maximum: (12x4165x2xf32) <- (12x1x2xf32, 1x4165x2xf32)
        maximum_0 = paddle._C_ops.maximum(slice_0, slice_2)

        # pd_op.minimum: (12x4165x2xf32) <- (12x1x2xf32, 1x4165x2xf32)
        minimum_0 = paddle._C_ops.minimum(slice_1, slice_3)

        # pd_op.subtract: (12x4165x2xf32) <- (12x4165x2xf32, 12x4165x2xf32)
        ...
        # pd_op.clip: (12x4165x2xf32) <- (12x4165x2xf32, 1xf32, 1xf32)
        clip_0 = paddle._C_ops.clip(subtract_0, full_0, full_1)

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_4 = [-1]

        # pd_op.prod: (12x4165xf32) <- (12x4165x2xf32, 1xi64)
        prod_0 = paddle._C_ops.prod(clip_0, full_int_array_4, False, False)

        # pd_op.subtract: (12x1x2xf32) <- (12x1x2xf32, 12x1x2xf32)
        subtract_1 = paddle._C_ops.subtract(slice_1, slice_0)

        # pd_op.clip: (12x1x2xf32) <- (12x1x2xf32, 1xf32, 1xf32)
        clip_1 = paddle._C_ops.clip(subtract_1, full_0, full_1)

        # pd_op.prod: (12x1xf32) <- (12x1x2xf32, 1xi64)
        ...
        # pd_op.add: (12x4165xf32) <- (12x1xf32, 1x4165xf32)
        add_0 = paddle._C_ops.add(prod_1, prod_2)

        # pd_op.subtract: (12x4165xf32) <- (12x4165xf32, 12x4165xf32)
        ...
        # pd_op.scale: (12x4165xf32) <- (12x4165xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(subtract_3, full_2, float("1e-10"), True)

        # pd_op.divide: (12x4165xf32) <- (12x4165xf32, 12x4165xf32)
