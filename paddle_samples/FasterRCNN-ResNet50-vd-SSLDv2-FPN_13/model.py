...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.transpose: (4x-1x-1x3xf32) <- (4x3x-1x-1xf32)
        transpose_0 = paddle._C_ops.transpose(data_0, [0, 2, 3, 1])

        # pd_op.shape64: (4xi64) <- (4x3x-1x-1xf32)
        ...
        full_int_array_4 = [4, -1, 1]

        # pd_op.reshape: (4x-1x1xf32) <- (4x-1x-1x3xf32, 3xi64)
        ...
        # pd_op.transpose: (4x-1x-1x12xf32) <- (4x12x-1x-1xf32)
        transpose_5 = paddle._C_ops.transpose(data_5, [0, 2, 3, 1])

        # pd_op.shape64: (4xi64) <- (4x12x-1x-1xf32)
        ...
        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_5 = [4, -1, 4]

        # pd_op.reshape: (4x-1x4xf32) <- (4x-1x-1x12xf32, 3xi64)
