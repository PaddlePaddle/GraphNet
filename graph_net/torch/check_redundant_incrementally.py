...
def main(args):
    ...
    for current_model_graph_hash_path in current_model_graph_hash_pathes:
        ...
        assert graph_hash not in graph_hash2graph_net_model_path, f"Redundant models detected. old-model-path:{current_model_graph_hash_path}, new-model-path:{graph_hash2graph_net_model_path[graph_hash]}."
