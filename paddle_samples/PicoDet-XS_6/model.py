...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (4x96x-1x-1xf32) <- (4x48x-1x-1xf32, 96x48x1x1xf32)
        conv2d_0 = paddle._C_ops.conv2d(
            data_0, parameter_298, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (4x96x-1x-1xf32, 96xf32, 96xf32, 96xf32, 96xf32, -1xui8) <- (4x96x-1x-1xf32, 96xf32, 96xf32, 96xf32, 96xf32)
        (
            batch_norm__0,
            batch_norm__1,
            batch_norm__2,
        ...
        # pd_op.hardswish: (4x96x-1x-1xf32) <- (4x96x-1x-1xf32)
        hardswish_0 = paddle._C_ops.hardswish(batch_norm__0)

        # pd_op.conv2d: (4x96x-1x-1xf32) <- (4x88x-1x-1xf32, 96x88x1x1xf32)
        ...
        # pd_op.conv2d: (4x96x-1x-1xf32) <- (4x176x-1x-1xf32, 96x176x1x1xf32)
        ...
        # pd_op.nearest_interp: (4x96x-1x-1xf32) <- (4x96x-1x-1xf32, None, None, None)
        ...
        # builtin.combine: ([4x96x-1x-1xf32, 4x96x-1x-1xf32]) <- (4x96x-1x-1xf32, 4x96x-1x-1xf32)
        combine_0 = [nearest_interp_0, hardswish_1]

        # pd_op.concat: (4x192x-1x-1xf32) <- ([4x96x-1x-1xf32, 4x96x-1x-1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_0)

        # pd_op.depthwise_conv2d: (4x192x-1x-1xf32) <- (4x192x-1x-1xf32, 192x1x5x5xf32)
        depthwise_conv2d_0 = paddle._C_ops.depthwise_conv2d(
            concat_0, parameter_283, [1, 1], [2, 2], "EXPLICIT", 192, [1, 1], "NCHW"
        )

        # pd_op.batch_norm_: (4x192x-1x-1xf32, 192xf32, 192xf32, 192xf32, 192xf32, -1xui8) <- (4x192x-1x-1xf32, 192xf32, 192xf32, 192xf32, 192xf32)
        (
            batch_norm__18,
            batch_norm__19,
            batch_norm__20,
        ...
        # pd_op.hardswish: (4x192x-1x-1xf32) <- (4x192x-1x-1xf32)
        hardswish_3 = paddle._C_ops.hardswish(batch_norm__18)

        # pd_op.conv2d: (4x192x-1x-1xf32) <- (4x192x-1x-1xf32, 192x192x1x1xf32)
        ...
        # pd_op.conv2d: (4x96x-1x-1xf32) <- (4x192x-1x-1xf32, 96x192x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (4x96x-1x-1xf32) <- (4x96x-1x-1xf32, 96x1x5x5xf32)
        ...
        # pd_op.conv2d: (4x96x-1x-1xf32) <- (4x96x-1x-1xf32, 96x96x1x1xf32)
        ...
        # pd_op.add: (4x96x-1x-1xf32) <- (4x96x-1x-1xf32, 4x96x-1x-1xf32)
        add_12 = paddle._C_ops.add(hardswish_21, hardswish_23)

        # pd_op.shape64: (4xi64) <- (4x96x-1x-1xf32)
        ...
        # pd_op.pool2d: (4x96x1x1xf32) <- (4x96x-1x-1xf32, 2xi64)
        ...
        # pd_op.multiply: (4x96x-1x-1xf32) <- (4x96x-1x-1xf32, 4x96x1x1xf32)
        ...
        # pd_op.conv2d: (4x4x-1x-1xf32) <- (4x96x-1x-1xf32, 4x96x1x1xf32)
        ...
        # pd_op.conv2d: (4x32x-1x-1xf32) <- (4x96x-1x-1xf32, 32x96x1x1xf32)
        ...
        # pd_op.conv2d: (4x1x-1x-1xf32) <- (4x96x-1x-1xf32, 1x96x5x5xf32)
        ...
        # pd_op.shape64: (4xi64) <- (4x96x-1x-1xf32)
        shape64_4 = paddle._C_ops.shape64(hardswish_50)
