...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        ...
        # pd_op.argmax: (2x10285xi64) <- (2x2x10285xf32, 1xi64)
        ...
        # pd_op.gather: (20570xi32) <- (4xi32, 20570xi64, 1xi32)
        gather_0 = paddle._C_ops.gather(flatten_0, flatten_1, full_2)
        del flatten_0

        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_0 = [2, 10285]
        ...
        # pd_op.max: (2x2x1xf32) <- (2x2x10285xf32, 1xi64)
        ...
        # pd_op.divide: (2x2x10285xf32) <- (2x2x10285xf32, 2x2x1xf32)
        ...
        # pd_op.max: (2x10285xf32) <- (2x2x10285xf32, 1xi64)
