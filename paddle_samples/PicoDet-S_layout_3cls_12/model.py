...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.hardswish: (2x96x64x64xf32) <- (2x96x64x64xf32)
        hardswish_0 = paddle._C_ops.hardswish(batch_norm__0)

        # pd_op.conv2d: (2x96x32x32xf32) <- (2x192x32x32xf32, 96x192x1x1xf32)
        conv2d_1 = paddle._C_ops.conv2d(
            data_1, parameter_293, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (2x96x32x32xf32, 96xf32, 96xf32, 96xf32, 96xf32, -1xui8) <- (2x96x32x32xf32, 96xf32, 96xf32, 96xf32, 96xf32)
        (
            batch_norm__6,
            batch_norm__7,
            batch_norm__8,
        ...
        # pd_op.hardswish: (2x96x32x32xf32) <- (2x96x32x32xf32)
        hardswish_1 = paddle._C_ops.hardswish(batch_norm__6)

        # pd_op.conv2d: (2x96x16x16xf32) <- (2x384x16x16xf32, 96x384x1x1xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            data_2, parameter_288, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (2x96x16x16xf32, 96xf32, 96xf32, 96xf32, 96xf32, -1xui8) <- (2x96x16x16xf32, 96xf32, 96xf32, 96xf32, 96xf32)
        (
            batch_norm__12,
            batch_norm__13,
            batch_norm__14,
        ...
        # pd_op.hardswish: (2x96x16x16xf32) <- (2x96x16x16xf32)
        hardswish_2 = paddle._C_ops.hardswish(batch_norm__12)

        # pd_op.nearest_interp: (2x96x32x32xf32) <- (2x96x16x16xf32, None, None, None)
        ...
        # builtin.combine: ([2x96x32x32xf32, 2x96x32x32xf32]) <- (2x96x32x32xf32, 2x96x32x32xf32)
        combine_0 = [nearest_interp_0, hardswish_1]

        # pd_op.concat: (2x192x32x32xf32) <- ([2x96x32x32xf32, 2x96x32x32xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_0)

        # pd_op.depthwise_conv2d: (2x192x32x32xf32) <- (2x192x32x32xf32, 192x1x5x5xf32)
        ...
        # pd_op.hardswish: (2x192x32x32xf32) <- (2x192x32x32xf32)
        ...
        # pd_op.nearest_interp: (2x96x64x64xf32) <- (2x96x32x32xf32, None, None, None)
        ...
        # pd_op.depthwise_conv2d: (2x192x64x64xf32) <- (2x192x64x64xf32, 192x1x5x5xf32)
        ...
        # pd_op.hardswish: (2x192x64x64xf32) <- (2x192x64x64xf32)
        ...
        # pd_op.depthwise_conv2d: (2x96x32x32xf32) <- (2x96x64x64xf32, 96x1x5x5xf32)
        ...
        # pd_op.conv2d: (2x96x32x32xf32) <- (2x96x32x32xf32, 96x96x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (2x96x16x16xf32) <- (2x96x32x32xf32, 96x1x5x5xf32)
        ...
        # pd_op.conv2d: (2x96x16x16xf32) <- (2x96x16x16xf32, 96x96x1x1xf32)
        ...
        # builtin.combine: ([2x96x16x16xf32, 2x96x16x16xf32]) <- (2x96x16x16xf32, 2x96x16x16xf32)
        combine_3 = [hardswish_16, hardswish_2]

        # pd_op.concat: (2x192x16x16xf32) <- ([2x96x16x16xf32, 2x96x16x16xf32], 1xi32)
        concat_3 = paddle._C_ops.concat(combine_3, full_0)

        # pd_op.depthwise_conv2d: (2x192x16x16xf32) <- (2x192x16x16xf32, 192x1x5x5xf32)
        depthwise_conv2d_8 = paddle._C_ops.depthwise_conv2d(
            concat_3, parameter_203, [1, 1], [2, 2], "EXPLICIT", 192, [1, 1], "NCHW"
        )

        # pd_op.batch_norm_: (2x192x16x16xf32, 192xf32, 192xf32, 192xf32, 192xf32, -1xui8) <- (2x192x16x16xf32, 192xf32, 192xf32, 192xf32, 192xf32)
        (
            batch_norm__114,
            batch_norm__115,
            batch_norm__116,
        ...
        # pd_op.hardswish: (2x192x16x16xf32) <- (2x192x16x16xf32)
        hardswish_17 = paddle._C_ops.hardswish(batch_norm__114)

        # pd_op.conv2d: (2x192x16x16xf32) <- (2x192x16x16xf32, 192x192x1x1xf32)
        ...
        # pd_op.conv2d: (2x96x16x16xf32) <- (2x192x16x16xf32, 96x192x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (2x96x8x8xf32) <- (2x96x16x16xf32, 96x1x5x5xf32)
        depthwise_conv2d_10 = paddle._C_ops.depthwise_conv2d(
            hardswish_2, parameter_183, [2, 2], [2, 2], "EXPLICIT", 96, [1, 1], "NCHW"
        )

        # pd_op.batch_norm_: (2x96x8x8xf32, 96xf32, 96xf32, 96xf32, 96xf32, -1xui8) <- (2x96x8x8xf32, 96xf32, 96xf32, 96xf32, 96xf32)
        (
            batch_norm__138,
            batch_norm__139,
            batch_norm__140,
        ...
        # pd_op.hardswish: (2x96x8x8xf32) <- (2x96x8x8xf32)
        hardswish_20 = paddle._C_ops.hardswish(batch_norm__138)

        # pd_op.conv2d: (2x96x8x8xf32) <- (2x96x8x8xf32, 96x96x1x1xf32)
        ...
        # pd_op.add: (2x96x8x8xf32) <- (2x96x8x8xf32, 2x96x8x8xf32)
        add_12 = paddle._C_ops.add(hardswish_21, hardswish_23)

        # pd_op.shape64: (4xi64) <- (2x96x64x64xf32)
        ...
        # pd_op.depthwise_conv2d: (2x96x64x64xf32) <- (2x96x64x64xf32, 96x1x5x5xf32)
        ...
        # pd_op.conv2d: (2x11x64x64xf32) <- (2x96x64x64xf32, 11x96x1x1xf32)
        ...
        # pd_op.add: (2x11x64x64xf32) <- (2x11x64x64xf32, 1x11x1x1xf32)
        add_14 = paddle._C_ops.add(conv2d_19, reshape_1)

        # pd_op.conv2d: (2x32x64x64xf32) <- (2x96x64x64xf32, 32x96x1x1xf32)
        ...
        # pd_op.add: (2x32x64x64xf32) <- (2x32x64x64xf32, 1x32x1x1xf32)
        add_0 = paddle._C_ops.add(conv2d_20, reshape_2)

        # pd_op.conv2d: (2x1x64x64xf32) <- (2x96x64x64xf32, 1x96x5x5xf32)
        conv2d_21 = paddle._C_ops.conv2d(
            hardswish_27, parameter_132, [1, 1], [2, 2], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (2x1x64x64xf32, 1xf32, 1xf32, 1xf32, 1xf32, -1xui8) <- (2x1x64x64xf32, 1xf32, 1xf32, 1xf32, 1xf32)
        (
            batch_norm__192,
            batch_norm__193,
            batch_norm__194,
        ...
        # pd_op.hardswish: (2x1x64x64xf32) <- (2x1x64x64xf32)
        hardswish_29 = paddle._C_ops.hardswish(batch_norm__192)

        # pd_op.conv2d: (2x1x64x64xf32) <- (2x1x64x64xf32, 1x1x1x1xf32)
        ...
        # pd_op.sigmoid: (2x11x64x64xf32) <- (2x11x64x64xf32)
        sigmoid_2 = paddle._C_ops.sigmoid(add_14)

        # pd_op.multiply: (2x11x64x64xf32) <- (2x11x64x64xf32, 2x1x64x64xf32)
        ...
        # pd_op.scale: (2x11x64x64xf32) <- (2x11x64x64xf32, 1xf32)
        scale_12 = paddle._C_ops.scale(multiply_4, full_1, float("1e-09"), True)

        # pd_op.sqrt: (2x11x64x64xf32) <- (2x11x64x64xf32)
        sqrt_0 = paddle._C_ops.sqrt(scale_12)

        # pd_op.transpose: (2x64x64x11xf32) <- (2x11x64x64xf32)
        transpose_12 = paddle._C_ops.transpose(sqrt_0, [0, 2, 3, 1])

        # pd_op.transpose: (2x64x64x32xf32) <- (2x32x64x64xf32)
        ...
        # pd_op.split_with_num: ([2x4096x2xf32, 2x4096x2xf32]) <- (2x4096x4xf32, 1xi32)
        split_with_num_0 = paddle._C_ops.split_with_num(reshape_15, 2, full_2)

        # builtin.split: (2x4096x2xf32, 2x4096x2xf32) <- ([2x4096x2xf32, 2x4096x2xf32])
        (
            split_6,
            split_0,
        ) = split_with_num_0
        ...
        # pd_op.scale: (2x4096x2xf32) <- (2x4096x2xf32, 1xf32)
        scale_1 = paddle._C_ops.scale(split_6, full_3, float("0"), True)

        # pd_op.add: (2x4096x2xf32) <- (2x4096x2xf32, 4096x2xf32)
        ...
        # builtin.combine: ([2x4096x2xf32, 2x4096x2xf32]) <- (2x4096x2xf32, 2x4096x2xf32)
        combine_6 = [add_1, add_2]

        # pd_op.concat: (2x4096x4xf32) <- ([2x4096x2xf32, 2x4096x2xf32], 1xi32)
        concat_7 = paddle._C_ops.concat(combine_6, full_4)

        # pd_op.flatten: (2x11x4096xf32) <- (2x11x64x64xf32)
        flatten_2 = paddle._C_ops.flatten(sqrt_0, 2, 3)

        # pd_op.transpose: (2x4096x11xf32) <- (2x11x4096xf32)
        transpose_1 = paddle._C_ops.transpose(flatten_2, [0, 2, 1])

        # pd_op.flatten: (2x32x4096xf32) <- (2x32x64x64xf32)
        flatten_3 = paddle._C_ops.flatten(add_0, 2, 3)

        # pd_op.transpose: (2x4096x32xf32) <- (2x32x4096xf32)
        ...
        # pd_op.scale: (2x4096x4xf32) <- (2x4096x4xf32, 1xf32)
        scale_2 = paddle._C_ops.scale(concat_7, full_5, float("0"), True)

        # pd_op.shape64: (4xi64) <- (2x96x32x32xf32)
        ...
        # pd_op.depthwise_conv2d: (2x96x32x32xf32) <- (2x96x32x32xf32, 96x1x5x5xf32)
        ...
        # pd_op.pool2d: (2x96x1x1xf32) <- (2x96x32x32xf32, 2xi64)
        ...
        # pd_op.multiply: (2x96x32x32xf32) <- (2x96x32x32xf32, 2x96x1x1xf32)
        ...
        # pd_op.conv2d: (2x11x32x32xf32) <- (2x96x32x32xf32, 11x96x1x1xf32)
        ...
        # pd_op.add: (2x11x32x32xf32) <- (2x11x32x32xf32, 1x11x1x1xf32)
        add_16 = paddle._C_ops.add(conv2d_27, reshape_4)

        # pd_op.conv2d: (2x32x32x32xf32) <- (2x96x32x32xf32, 32x96x1x1xf32)
        ...
        # pd_op.add: (2x32x32x32xf32) <- (2x32x32x32xf32, 1x32x1x1xf32)
        add_3 = paddle._C_ops.add(conv2d_28, reshape_5)

        # pd_op.conv2d: (2x1x32x32xf32) <- (2x96x32x32xf32, 1x96x5x5xf32)
        conv2d_29 = paddle._C_ops.conv2d(
            hardswish_33, parameter_91, [1, 1], [2, 2], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (2x1x32x32xf32, 1xf32, 1xf32, 1xf32, 1xf32, -1xui8) <- (2x1x32x32xf32, 1xf32, 1xf32, 1xf32, 1xf32)
        (
            batch_norm__233,
            batch_norm__234,
            batch_norm__235,
        ...
        # pd_op.hardswish: (2x1x32x32xf32) <- (2x1x32x32xf32)
        hardswish_35 = paddle._C_ops.hardswish(batch_norm__233)

        # pd_op.conv2d: (2x1x32x32xf32) <- (2x1x32x32xf32, 1x1x1x1xf32)
        ...
        # pd_op.sigmoid: (2x11x32x32xf32) <- (2x11x32x32xf32)
        sigmoid_5 = paddle._C_ops.sigmoid(add_16)

        # pd_op.multiply: (2x11x32x32xf32) <- (2x11x32x32xf32, 2x1x32x32xf32)
        multiply_5 = paddle._C_ops.multiply(sigmoid_5, sigmoid_4)

        # pd_op.scale: (2x11x32x32xf32) <- (2x11x32x32xf32, 1xf32)
        scale_15 = paddle._C_ops.scale(multiply_5, full_1, float("1e-09"), True)

        # pd_op.sqrt: (2x11x32x32xf32) <- (2x11x32x32xf32)
        sqrt_1 = paddle._C_ops.sqrt(scale_15)

        # pd_op.transpose: (2x32x32x11xf32) <- (2x11x32x32xf32)
        transpose_13 = paddle._C_ops.transpose(sqrt_1, [0, 2, 3, 1])

        # pd_op.transpose: (2x32x32x32xf32) <- (2x32x32x32xf32)
        ...
        # pd_op.arange: (32xf32) <- (1xf64, 1xf64, 1xf64)
        ...
        # pd_op.scale: (2x1024x4xf32) <- (2x1024x4xf32, 1xf32)
        scale_5 = paddle._C_ops.scale(concat_8, full_6, float("0"), True)

        # pd_op.shape64: (4xi64) <- (2x96x16x16xf32)
        ...
        # pd_op.depthwise_conv2d: (2x96x16x16xf32) <- (2x96x16x16xf32, 96x1x5x5xf32)
        ...
        # pd_op.pool2d: (2x96x1x1xf32) <- (2x96x16x16xf32, 2xi64)
        ...
        # pd_op.multiply: (2x96x16x16xf32) <- (2x96x16x16xf32, 2x96x1x1xf32)
        ...
        # pd_op.conv2d: (2x11x16x16xf32) <- (2x96x16x16xf32, 11x96x1x1xf32)
        ...
        # pd_op.add: (2x11x16x16xf32) <- (2x11x16x16xf32, 1x11x1x1xf32)
        add_18 = paddle._C_ops.add(conv2d_35, reshape_7)

        # pd_op.conv2d: (2x32x16x16xf32) <- (2x96x16x16xf32, 32x96x1x1xf32)
        ...
        # pd_op.add: (2x32x16x16xf32) <- (2x32x16x16xf32, 1x32x1x1xf32)
        add_6 = paddle._C_ops.add(conv2d_36, reshape_8)

        # pd_op.conv2d: (2x1x16x16xf32) <- (2x96x16x16xf32, 1x96x5x5xf32)
        conv2d_37 = paddle._C_ops.conv2d(
            hardswish_39, parameter_50, [1, 1], [2, 2], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (2x1x16x16xf32, 1xf32, 1xf32, 1xf32, 1xf32, -1xui8) <- (2x1x16x16xf32, 1xf32, 1xf32, 1xf32, 1xf32)
        (
            batch_norm__274,
            batch_norm__275,
            batch_norm__276,
        ...
        # pd_op.hardswish: (2x1x16x16xf32) <- (2x1x16x16xf32)
        hardswish_41 = paddle._C_ops.hardswish(batch_norm__274)

        # pd_op.conv2d: (2x1x16x16xf32) <- (2x1x16x16xf32, 1x1x1x1xf32)
        ...
        # pd_op.sigmoid: (2x11x16x16xf32) <- (2x11x16x16xf32)
        sigmoid_8 = paddle._C_ops.sigmoid(add_18)

        # pd_op.multiply: (2x11x16x16xf32) <- (2x11x16x16xf32, 2x1x16x16xf32)
        multiply_6 = paddle._C_ops.multiply(sigmoid_8, sigmoid_7)

        # pd_op.scale: (2x11x16x16xf32) <- (2x11x16x16xf32, 1xf32)
        scale_18 = paddle._C_ops.scale(multiply_6, full_1, float("1e-09"), True)

        # pd_op.sqrt: (2x11x16x16xf32) <- (2x11x16x16xf32)
        sqrt_2 = paddle._C_ops.sqrt(scale_18)

        # pd_op.transpose: (2x16x16x11xf32) <- (2x11x16x16xf32)
        transpose_14 = paddle._C_ops.transpose(sqrt_2, [0, 2, 3, 1])

        # pd_op.transpose: (2x16x16x32xf32) <- (2x32x16x16xf32)
        ...
        # builtin.combine: ([256xf32, 256xf32]) <- (256xf32, 256xf32)
        combine_11 = [flatten_9, flatten_8]

        # pd_op.stack: (256x2xf32) <- ([256xf32, 256xf32])
        stack_2 = paddle._C_ops.stack(combine_11, -1)

        # pd_op.reshape: (2x256x11xf32) <- (2x16x16x11xf32, 3xi64)
        reshape_20 = paddle._C_ops.reshape(transpose_14, full_int_array_7)

        # pd_op.reshape: (2048x8xf32) <- (2x16x16x32xf32, 2xi64)
        reshape_21 = paddle._C_ops.reshape(transpose_6, full_int_array_8)

        # pd_op.softmax: (2048x8xf32) <- (2048x8xf32)
        softmax_2 = paddle._C_ops.softmax(reshape_21, 1)

        # pd_op.matmul: (2048xf32) <- (2048x8xf32, 8xf32)
        matmul_2 = paddle._C_ops.matmul(softmax_2, data_3, False, False)

        # pd_op.reshape: (512x4xf32) <- (2048xf32, 2xi64)
        reshape_22 = paddle._C_ops.reshape(matmul_2, full_int_array_9)

        # pd_op.scale: (512x4xf32) <- (512x4xf32, 1xf32)
        scale_6 = paddle._C_ops.scale(reshape_22, full_16, float("0"), True)

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_12 = [2, 256, 4]

        # pd_op.reshape: (2x256x4xf32) <- (512x4xf32, 3xi64)
        reshape_23 = paddle._C_ops.reshape(scale_6, full_int_array_12)

        # pd_op.split_with_num: ([2x256x2xf32, 2x256x2xf32]) <- (2x256x4xf32, 1xi32)
        split_with_num_2 = paddle._C_ops.split_with_num(reshape_23, 2, full_2)

        # builtin.split: (2x256x2xf32, 2x256x2xf32) <- ([2x256x2xf32, 2x256x2xf32])
        (
            split_12,
            split_2,
        ) = split_with_num_2

        # pd_op.scale: (2x256x2xf32) <- (2x256x2xf32, 1xf32)
        scale_7 = paddle._C_ops.scale(split_12, full_3, float("0"), True)

        # pd_op.add: (2x256x2xf32) <- (2x256x2xf32, 256x2xf32)
        add_7 = paddle._C_ops.add(scale_7, stack_2)

        # pd_op.add: (2x256x2xf32) <- (2x256x2xf32, 256x2xf32)
        add_8 = paddle._C_ops.add(split_2, stack_2)

        # builtin.combine: ([2x256x2xf32, 2x256x2xf32]) <- (2x256x2xf32, 2x256x2xf32)
        combine_12 = [add_7, add_8]

        # pd_op.concat: (2x256x4xf32) <- ([2x256x2xf32, 2x256x2xf32], 1xi32)
        concat_9 = paddle._C_ops.concat(combine_12, full_4)

        # pd_op.flatten: (2x11x256xf32) <- (2x11x16x16xf32)
        flatten_10 = paddle._C_ops.flatten(sqrt_2, 2, 3)

        # pd_op.transpose: (2x256x11xf32) <- (2x11x256xf32)
        transpose_7 = paddle._C_ops.transpose(flatten_10, [0, 2, 1])

        # pd_op.flatten: (2x32x256xf32) <- (2x32x16x16xf32)
        flatten_11 = paddle._C_ops.flatten(add_6, 2, 3)

        # pd_op.transpose: (2x256x32xf32) <- (2x32x256xf32)
        ...
        # pd_op.scale: (2x256x4xf32) <- (2x256x4xf32, 1xf32)
        scale_8 = paddle._C_ops.scale(concat_9, full_7, float("0"), True)

        # pd_op.shape64: (4xi64) <- (2x96x8x8xf32)
        ...
        # pd_op.depthwise_conv2d: (2x96x8x8xf32) <- (2x96x8x8xf32, 96x1x5x5xf32)
        ...
        # pd_op.pool2d: (2x96x1x1xf32) <- (2x96x8x8xf32, 2xi64)
        ...
        # pd_op.multiply: (2x96x8x8xf32) <- (2x96x8x8xf32, 2x96x1x1xf32)
        ...
        # pd_op.conv2d: (2x11x8x8xf32) <- (2x96x8x8xf32, 11x96x1x1xf32)
        ...
        # pd_op.add: (2x11x8x8xf32) <- (2x11x8x8xf32, 1x11x1x1xf32)
        add_20 = paddle._C_ops.add(conv2d_43, reshape_10)

        # pd_op.conv2d: (2x32x8x8xf32) <- (2x96x8x8xf32, 32x96x1x1xf32)
        ...
        # pd_op.add: (2x32x8x8xf32) <- (2x32x8x8xf32, 1x32x1x1xf32)
        add_9 = paddle._C_ops.add(conv2d_44, reshape_11)

        # pd_op.conv2d: (2x1x8x8xf32) <- (2x96x8x8xf32, 1x96x5x5xf32)
        conv2d_45 = paddle._C_ops.conv2d(
            hardswish_45, parameter_9, [1, 1], [2, 2], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (2x1x8x8xf32, 1xf32, 1xf32, 1xf32, 1xf32, -1xui8) <- (2x1x8x8xf32, 1xf32, 1xf32, 1xf32, 1xf32)
        (
            batch_norm__315,
            batch_norm__316,
            batch_norm__317,
        ...
        # pd_op.hardswish: (2x1x8x8xf32) <- (2x1x8x8xf32)
        hardswish_47 = paddle._C_ops.hardswish(batch_norm__315)

        # pd_op.conv2d: (2x1x8x8xf32) <- (2x1x8x8xf32, 1x1x1x1xf32)
        ...
        # pd_op.arange: (8xf32) <- (1xf64, 1xf64, 1xf64)
        ...
        # pd_op.scale: (2x64x4xf32) <- (2x64x4xf32, 1xf32)
        scale_11 = paddle._C_ops.scale(concat_10, full_8, float("0"), True)

        # builtin.combine: ([2x4096x11xf32, 2x1024x11xf32, 2x256x11xf32, 2x64x11xf32]) <- (2x4096x11xf32, 2x1024x11xf32, 2x256x11xf32, 2x64x11xf32)
        combine_16 = [transpose_1, transpose_4, transpose_7, transpose_10]

        # pd_op.concat: (2x5440x11xf32) <- ([2x4096x11xf32, 2x1024x11xf32, 2x256x11xf32, 2x64x11xf32], 1xi32)
        concat_4 = paddle._C_ops.concat(combine_16, full_0)

        # builtin.combine: ([2x4096x4xf32, 2x1024x4xf32, 2x256x4xf32, 2x64x4xf32]) <- (2x4096x4xf32, 2x1024x4xf32, 2x256x4xf32, 2x64x4xf32)
        combine_17 = [scale_2, scale_5, scale_8, scale_11]

        # pd_op.concat: (2x5440x4xf32) <- ([2x4096x4xf32, 2x1024x4xf32, 2x256x4xf32, 2x64x4xf32], 1xi32)
        concat_6 = paddle._C_ops.concat(combine_17, full_0)

        # builtin.combine: ([2x4096x32xf32, 2x1024x32xf32, 2x256x32xf32, 2x64x32xf32]) <- (2x4096x32xf32, 2x1024x32xf32, 2x256x32xf32, 2x64x32xf32)
        combine_18 = [transpose_2, transpose_5, transpose_8, transpose_11]

        # pd_op.concat: (2x5440x32xf32) <- ([2x4096x32xf32, 2x1024x32xf32, 2x256x32xf32, 2x64x32xf32], 1xi32)
