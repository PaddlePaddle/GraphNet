...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6, data_7):
        ...
        # pd_op.tile: (2x11x-1xb) <- (2x1x-1xb, 3xi64)
        ...
        # pd_op.argmax: (2x-1xi64) <- (2x11x-1xf32, 1xi64)
        ...
        # pd_op.one_hot: (2x-1x11xf32) <- (2x-1xi64, 1xi32)
        ...
        # pd_op.where: (2x11x-1xf32) <- (2x11x-1xb, 2x11x-1xf32, 2x11x-1xf32)
        where_0 = paddle._C_ops.where(tile_0, transpose_0, data_3)
        del data_3, tile_0, transpose_0

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_2 = [-2]

        # pd_op.sum: (2x-1xf32) <- (2x11x-1xf32, 1xi64)
        ...
        # pd_op.gather: (-1xi32) <- (22xi32, -1xi64, 1xi32)
        ...
        reshape_2 = paddle._C_ops.reshape(data_6, full_int_array_3)
        del data_6, full_int_array_3

        # pd_op.gather: (-1x4xf32) <- (22x4xf32, -1xi64, 1xi32)
        ...
        one_hot_1 = paddle._C_ops.one_hot(
            where_1 % paddle.cast(full_9, where_1.dtype), full_9
        )
        del full_9
        ...
        # pd_op.multiply: (2x11x-1xf32) <- (2x11x-1xf32, 2x11x-1xf32)
        multiply_1 = paddle._C_ops.multiply(data_7, where_0)
        del data_7

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_4 = [-1]

        # pd_op.max: (2x11x1xf32) <- (2x11x-1xf32, 1xi64)
        max_0 = paddle._C_ops.max(multiply_1, full_int_array_4, True)

        # pd_op.multiply: (2x11x-1xf32) <- (2x11x-1xf32, 2x11x-1xf32)
        multiply_2 = paddle._C_ops.multiply(data_2, where_0)
        del data_2, where_0

        # pd_op.max: (2x11x1xf32) <- (2x11x-1xf32, 1xi64)
        max_1 = paddle._C_ops.max(multiply_2, full_int_array_4, True)
        del multiply_2
        ...
        # pd_op.divide: (2x11x-1xf32) <- (2x11x-1xf32, 2x11x1xf32)
        divide_0 = paddle._C_ops.divide(multiply_1, scale_1)
        del multiply_1, scale_1

        # pd_op.multiply: (2x11x-1xf32) <- (2x11x-1xf32, 2x11x1xf32)
        multiply_3 = paddle._C_ops.multiply(divide_0, max_1)
        del divide_0, max_1

        # pd_op.max: (2x-1xf32) <- (2x11x-1xf32, 1xi64)
        ...
        unsqueeze_1 = paddle._C_ops.unsqueeze(max_2, full_int_array_4)
        del full_int_array_4, max_2
