...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (128x64x56x56xf32) <- (128x3x224x224xf32, 64x3x4x4xf32)
        ...
        # pd_op.split: ([128x16x56x56xf32, 128x48x56x56xf32]) <- (128x64x56x56xf32, 2xi64, 1xi32)
        split_26 = paddle._C_ops.split(batch_norm__0, full_int_array_1, full_0)

        # builtin.split: (128x16x56x56xf32, 128x48x56x56xf32) <- ([128x16x56x56xf32, 128x48x56x56xf32])
        (
            split_0,
            split_1,
        ) = split_26

        # pd_op.conv2d: (128x16x56x56xf32) <- (128x16x56x56xf32, 16x16x3x3xf32)
        conv2d_1 = paddle._C_ops.conv2d(
            split_0, parameter_108, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # builtin.combine: ([128x16x56x56xf32, 128x48x56x56xf32]) <- (128x16x56x56xf32, 128x48x56x56xf32)
        combine_0 = [conv2d_1, split_1]

        # pd_op.concat: (128x64x56x56xf32) <- ([128x16x56x56xf32, 128x48x56x56xf32], 1xi32)
        ...
        # pd_op.gelu: (128x128x56x56xf32) <- (128x128x56x56xf32)
        gelu_0 = paddle._C_ops.gelu(batch_norm__6, False)

        # pd_op.conv2d: (128x64x56x56xf32) <- (128x128x56x56xf32, 64x128x1x1xf32)
        conv2d_3 = paddle._C_ops.conv2d(
            gelu_0, parameter_102, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.add: (128x64x56x56xf32) <- (128x64x56x56xf32, 128x64x56x56xf32)
        add_0 = paddle._C_ops.add(batch_norm__0, conv2d_3)

        # pd_op.conv2d: (128x128x28x28xf32) <- (128x64x56x56xf32, 128x64x2x2xf32)
        ...
        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_2 = [32, 96]

        # pd_op.split: ([128x32x28x28xf32, 128x96x28x28xf32]) <- (128x128x28x28xf32, 2xi64, 1xi32)
        split_27 = paddle._C_ops.split(batch_norm__12, full_int_array_2, full_0)

        # builtin.split: (128x32x28x28xf32, 128x96x28x28xf32) <- ([128x32x28x28xf32, 128x96x28x28xf32])
        (
            split_2,
            split_3,
        ) = split_27

        # pd_op.conv2d: (128x32x28x28xf32) <- (128x32x28x28xf32, 32x32x3x3xf32)
        conv2d_5 = paddle._C_ops.conv2d(
            split_2, parameter_96, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # builtin.combine: ([128x32x28x28xf32, 128x96x28x28xf32]) <- (128x32x28x28xf32, 128x96x28x28xf32)
        combine_1 = [conv2d_5, split_3]

        # pd_op.concat: (128x128x28x28xf32) <- ([128x32x28x28xf32, 128x96x28x28xf32], 1xi32)
        ...
        # pd_op.gelu: (128x256x28x28xf32) <- (128x256x28x28xf32)
        gelu_1 = paddle._C_ops.gelu(batch_norm__18, False)

        # pd_op.conv2d: (128x128x28x28xf32) <- (128x256x28x28xf32, 128x256x1x1xf32)
        ...
        # pd_op.divide: (128x128x28x28xf32) <- (128x128x28x28xf32, xf32)
        divide_0 = paddle._C_ops.divide(conv2d_7, full_1)

        # pd_op.multiply: (128x128x28x28xf32) <- (128x128x28x28xf32, 128x1x1x1xf32)
        multiply_0 = paddle._C_ops.multiply(divide_0, floor_0)

        # pd_op.add: (128x128x28x28xf32) <- (128x128x28x28xf32, 128x128x28x28xf32)
        add_1 = paddle._C_ops.add(batch_norm__12, multiply_0)
        ...
        # pd_op.conv2d: (128x256x14x14xf32) <- (128x128x28x28xf32, 256x128x2x2xf32)
        ...
        # pd_op.split: ([128x64x14x14xf32, 128x192x14x14xf32]) <- (128x256x14x14xf32, 2xi64, 1xi32)
        split_29 = paddle._C_ops.split(batch_norm__30, full_int_array_4, full_0)

        # builtin.split: (128x64x14x14xf32, 128x192x14x14xf32) <- ([128x64x14x14xf32, 128x192x14x14xf32])
        (
            split_6,
            split_7,
        ) = split_29

        # pd_op.conv2d: (128x64x14x14xf32) <- (128x64x14x14xf32, 64x64x3x3xf32)
        conv2d_12 = paddle._C_ops.conv2d(
            split_6, parameter_77, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # builtin.combine: ([128x64x14x14xf32, 128x192x14x14xf32]) <- (128x64x14x14xf32, 128x192x14x14xf32)
        combine_3 = [conv2d_12, split_7]

        # pd_op.concat: (128x256x14x14xf32) <- ([128x64x14x14xf32, 128x192x14x14xf32], 1xi32)
        ...
        # pd_op.gelu: (128x512x14x14xf32) <- (128x512x14x14xf32)
        ...
        # pd_op.divide: (128x256x14x14xf32) <- (128x256x14x14xf32, xf32)
        divide_2 = paddle._C_ops.divide(conv2d_14, full_3)

        # pd_op.multiply: (128x256x14x14xf32) <- (128x256x14x14xf32, 128x1x1x1xf32)
        multiply_2 = paddle._C_ops.multiply(divide_2, floor_2)

        # pd_op.add: (128x256x14x14xf32) <- (128x256x14x14xf32, 128x256x14x14xf32)
        add_3 = paddle._C_ops.add(batch_norm__30, multiply_2)
        ...
        # pd_op.conv2d: (128x512x7x7xf32) <- (128x256x14x14xf32, 512x256x2x2xf32)
        ...
        # pd_op.split: ([128x128x7x7xf32, 128x384x7x7xf32]) <- (128x512x7x7xf32, 2xi64, 1xi32)
        split_37 = paddle._C_ops.split(batch_norm__84, full_int_array_5, full_0)

        # builtin.split: (128x128x7x7xf32, 128x384x7x7xf32) <- ([128x128x7x7xf32, 128x384x7x7xf32])
        (
            split_22,
            split_23,
        ) = split_37

        # pd_op.conv2d: (128x128x7x7xf32) <- (128x128x7x7xf32, 128x128x3x3xf32)
        conv2d_37 = paddle._C_ops.conv2d(
            split_22, parameter_16, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # builtin.combine: ([128x128x7x7xf32, 128x384x7x7xf32]) <- (128x128x7x7xf32, 128x384x7x7xf32)
        combine_11 = [conv2d_37, split_23]

        # pd_op.concat: (128x512x7x7xf32) <- ([128x128x7x7xf32, 128x384x7x7xf32], 1xi32)
        concat_11 = paddle._C_ops.concat(combine_11, full_0)

        # pd_op.conv2d: (128x1024x7x7xf32) <- (128x512x7x7xf32, 1024x512x1x1xf32)
        ...
        # pd_op.gelu: (128x1024x7x7xf32) <- (128x1024x7x7xf32)
        gelu_11 = paddle._C_ops.gelu(batch_norm__90, False)

        # pd_op.conv2d: (128x512x7x7xf32) <- (128x1024x7x7xf32, 512x1024x1x1xf32)
        ...
        add_11 = paddle._C_ops.add(batch_norm__84, multiply_10)
