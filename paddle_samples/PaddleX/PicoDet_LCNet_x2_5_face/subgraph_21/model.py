...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.split_with_num: ([676x1xf32, 676x1xf32, 676x1xf32, 676x1xf32]) <- (676x4xf32, 1xi32)
        split_with_num_0 = paddle._C_ops.split_with_num(data_0, 4, full_0)
        del data_0

        # builtin.split: (676x1xf32, 676x1xf32, 676x1xf32, 676x1xf32) <- ([676x1xf32, 676x1xf32, 676x1xf32, 676x1xf32])
        (
            split_0,
            split_1,
            split_2,
        ...
        # pd_op.clip: (676x1xf32) <- (676x1xf32, 1xf32, 1xf32)
        ...
        # pd_op.multiply: (676x1xf32) <- (676x1xf32, 676x1xf32)
        ...
        # pd_op.add: (676x1xf32) <- (676x1xf32, 676x1xf32)
        ...
        # pd_op.scale: (676x1xf32) <- (676x1xf32, 1xf32)
        scale_1 = paddle._C_ops.scale(subtract_6, full_3, float("1e-10"), True)
        del subtract_6

        # pd_op.divide: (676x1xf32) <- (676x1xf32, 676x1xf32)
