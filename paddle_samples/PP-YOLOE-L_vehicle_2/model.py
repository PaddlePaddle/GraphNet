...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5):
        # pd_op.shape64: (3xi64) <- (2x-1x4xf32)
        ...
        # pd_op.unsqueeze: (2x12x1x4xf32) <- (2x12x4xf32, 1xi64)
        unsqueeze_1 = paddle._C_ops.unsqueeze(data_4, full_int_array_1)
        ...
        # pd_op.slice: (2x12x1x2xf32) <- (2x12x1x4xf32, 1xi64, 1xi64)
        slice_1 = paddle._C_ops.slice(
            unsqueeze_1, [3], full_int_array_2, full_int_array_1, [1], []
        )
        ...
        slice_2 = paddle._C_ops.slice(
            unsqueeze_1, [3], full_int_array_1, full_int_array_3, [1], []
        )

        # pd_op.slice: (2x1x-1x2xf32) <- (2x1x-1x4xf32, 1xi64, 1xi64)
        slice_3 = paddle._C_ops.slice(
            unsqueeze_2, [3], full_int_array_2, full_int_array_1, [1], []
        )

        # pd_op.slice: (2x1x-1x2xf32) <- (2x1x-1x4xf32, 1xi64, 1xi64)
        slice_4 = paddle._C_ops.slice(
            unsqueeze_2, [3], full_int_array_1, full_int_array_3, [1], []
        )

        # pd_op.maximum: (2x12x-1x2xf32) <- (2x12x1x2xf32, 2x1x-1x2xf32)
        maximum_0 = paddle._C_ops.maximum(slice_1, slice_3)

        # pd_op.minimum: (2x12x-1x2xf32) <- (2x12x1x2xf32, 2x1x-1x2xf32)
        minimum_0 = paddle._C_ops.minimum(slice_2, slice_4)

        # pd_op.subtract: (2x12x-1x2xf32) <- (2x12x-1x2xf32, 2x12x-1x2xf32)
        ...
        # pd_op.clip: (2x12x-1x2xf32) <- (2x12x-1x2xf32, 1xf32, 1xf32)
        clip_0 = paddle._C_ops.clip(subtract_0, full_0, full_1)

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_4 = [-1]

        # pd_op.prod: (2x12x-1xf32) <- (2x12x-1x2xf32, 1xi64)
        prod_0 = paddle._C_ops.prod(clip_0, full_int_array_4, False, False)

        # pd_op.subtract: (2x12x1x2xf32) <- (2x12x1x2xf32, 2x12x1x2xf32)
        subtract_1 = paddle._C_ops.subtract(slice_2, slice_1)

        # pd_op.clip: (2x12x1x2xf32) <- (2x12x1x2xf32, 1xf32, 1xf32)
        clip_1 = paddle._C_ops.clip(subtract_1, full_0, full_1)

        # pd_op.prod: (2x12x1xf32) <- (2x12x1x2xf32, 1xi64)
        ...
        # pd_op.add: (2x12x-1xf32) <- (2x12x1xf32, 2x1x-1xf32)
        add_0 = paddle._C_ops.add(prod_1, prod_2)

        # pd_op.subtract: (2x12x-1xf32) <- (2x12x-1xf32, 2x12x-1xf32)
        ...
        # pd_op.scale: (2x12x-1xf32) <- (2x12x-1xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(subtract_3, full_2, float("1e-09"), True)

        # pd_op.divide: (2x12x-1xf32) <- (2x12x-1xf32, 2x12x-1xf32)
        divide_0 = paddle._C_ops.divide(prod_0, scale_0)

        # pd_op.transpose: (2x4x-1xf32) <- (2x-1x4xf32)
        ...
        full_int_array_5 = [1, 12]

        # pd_op.tile: (2x12xi32) <- (2x1xi32, 2xi64)
        tile_0 = paddle._C_ops.tile(unsqueeze_0, full_int_array_5)

        # pd_op.squeeze: (2x12xi32) <- (2x12x1xi32, 1xi64)
        squeeze_0 = paddle._C_ops.squeeze(data_3, full_int_array_4)

        # builtin.combine: ([2x12xi32, 2x12xi32]) <- (2x12xi32, 2x12xi32)
        combine_0 = [tile_0, squeeze_0]

        # pd_op.stack: (2x12x2xi32) <- ([2x12xi32, 2x12xi32])
        stack_0 = paddle._C_ops.stack(combine_0, -1)

        # pd_op.gather_nd: (2x12x-1xf32) <- (2x4x-1xf32, 2x12x2xi32)
        gather_nd_0 = paddle._C_ops.gather_nd(transpose_0, stack_0)

        # pd_op.pow: (2x12x-1xf32) <- (2x12x-1xf32)
        ...
        # pd_op.split_with_num: ([2x12x1x1xf32, 2x12x1x1xf32, 2x12x1x1xf32, 2x12x1x1xf32]) <- (2x12x1x4xf32, 1xi32)
        split_with_num_1 = paddle._C_ops.split_with_num(unsqueeze_1, 4, full_6)

        # builtin.split: (2x12x1x1xf32, 2x12x1x1xf32, 2x12x1x1xf32, 2x12x1x1xf32) <- ([2x12x1x1xf32, 2x12x1x1xf32, 2x12x1x1xf32, 2x12x1x1xf32])
        (
            split_2,
            split_3,
            split_4,
        ...
        # pd_op.subtract: (2x12x-1x1xf32) <- (1x1x-1x1xf32, 2x12x1x1xf32)
        subtract_4 = paddle._C_ops.subtract(split_0, split_2)

        # pd_op.subtract: (2x12x-1x1xf32) <- (1x1x-1x1xf32, 2x12x1x1xf32)
        subtract_5 = paddle._C_ops.subtract(split_1, split_3)

        # pd_op.subtract: (2x12x-1x1xf32) <- (2x12x1x1xf32, 1x1x-1x1xf32)
        ...
        # builtin.combine: ([2x12x-1x1xf32, 2x12x-1x1xf32, 2x12x-1x1xf32, 2x12x-1x1xf32]) <- (2x12x-1x1xf32, 2x12x-1x1xf32, 2x12x-1x1xf32, 2x12x-1x1xf32)
        combine_1 = [subtract_4, subtract_5, subtract_6, subtract_7]

        # pd_op.concat: (2x12x-1x4xf32) <- ([2x12x-1x1xf32, 2x12x-1x1xf32, 2x12x-1x1xf32, 2x12x-1x1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_1, full_7)

        # pd_op.min: (2x12x-1xf32) <- (2x12x-1x4xf32, 1xi64)
        ...
        # pd_op.greater_than: (2x12x-1xb) <- (2x12x-1xf32, xf32)
        greater_than_1 = paddle._C_ops.greater_than(min_0, full_8)

        # pd_op.cast: (2x12x-1xf32) <- (2x12x-1xb)
        ...
        shape64_1 = paddle._C_ops.shape64(multiply_2)
        ...
        slice_5 = paddle._C_ops.slice(
            shape64_1, [0], full_int_array_1, full_int_array_7, [1], [0]
        )
        ...
        # pd_op.topk: (2x12x13xf32, 2x12x13xi64) <- (2x12x-1xf32, 1xi32)
        topk_0, topk_1 = (lambda x, f: f(x))(
            paddle._C_ops.topk(multiply_2, full_9, -1, True, True),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )

        # pd_op.one_hot: (2x12x13x-1xf32) <- (2x12x13xi64, xi64)
        ...
        # pd_op.sum: (2x12x-1xf32) <- (2x12x13x-1xf32, 1xi64)
        sum_1 = paddle._C_ops.sum(one_hot_0, full_int_array_8, None, False)
        ...
        sum_0 = paddle._C_ops.sum(multiply_0, full_int_array_8, None, False)

        # pd_op.full_int_array: (0xi64) <- ()
        full_int_array_9 = []

        # pd_op.max: (xf32) <- (2x-1xf32, 0xi64)
        max_0 = paddle._C_ops.max(sum_0, full_int_array_9, False)
