...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        ...
        # pd_op.argmax: (2x12096xi64) <- (2x6x12096xf32, 1xi64)
        ...
        # pd_op.flatten: (12xi32) <- (2x6x1xi32)
        ...
        # pd_op.gather: (24192xi32) <- (12xi32, 24192xi64, 1xi32)
        gather_0 = paddle._C_ops.gather(flatten_0, flatten_1, full_2)
        del flatten_0

        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_0 = [2, 12096]
        ...
        # pd_op.multiply: (2x6x12096xf32) <- (2x6x12096xf32, 2x6x12096xf32)
        ...
        # pd_op.max: (2x6x1xf32) <- (2x6x12096xf32, 1xi64)
        ...
        # pd_op.scale: (2x6x1xf32) <- (2x6x1xf32, 1xf32)
        scale_1 = paddle._C_ops.scale(max_0, full_4, float("1e-09"), True)
        del full_4, max_0

        # pd_op.divide: (2x6x12096xf32) <- (2x6x12096xf32, 2x6x1xf32)
        divide_0 = paddle._C_ops.divide(multiply_1, scale_1)
        del multiply_1, scale_1

        # pd_op.multiply: (2x6x12096xf32) <- (2x6x12096xf32, 2x6x1xf32)
        ...
        # pd_op.max: (2x12096xf32) <- (2x6x12096xf32, 1xi64)
