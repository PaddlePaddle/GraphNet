...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3):
        ...
        # builtin.combine: ([6x6xf32]) <- (6x6xf32)
        combine_0 = [data_0]
        del data_0

        # pd_op.concat: (6x6xf32) <- ([6x6xf32], 1xi32)
        ...
        # pd_op.slice: (6x1xf32) <- (6x6xf32, 1xi64, 1xi64)
        ...
        # pd_op.slice: (6x4xf32) <- (6x6xf32, 1xi64, 1xi64)
        slice_4 = paddle._C_ops.slice(
            concat_1, [1], full_int_array_7, full_int_array_8, [1], []
        )
        del full_int_array_8

        # pd_op.divide: (6x4xf32) <- (6x4xf32, -1x4xf32)
        ...
        # pd_op.minimum: (6xf32) <- (6xf32, -1xf32)
        minimum_0 = paddle._C_ops.minimum(slice_7, slice_6)
        del slice_7

        # pd_op.maximum: (6xf32) <- (6xf32, -1xf32)
        ...
        # builtin.combine: ([6xf32, 6xf32, 6xf32, 6xf32]) <- (6xf32, 6xf32, 6xf32, 6xf32)
        combine_7 = [maximum_0, maximum_1, maximum_2, maximum_3]
        del maximum_0, maximum_1, maximum_2, maximum_3

        # pd_op.stack: (6x4xf32) <- ([6xf32, 6xf32, 6xf32, 6xf32])
        ...
        # builtin.combine: ([6x1xf32, 6x1xf32, 6x4xf32]) <- (6x1xf32, 6x1xf32, 6x4xf32)
        combine_8 = [where_0, slice_3, stack_2]
        del slice_3, stack_2, where_0

        # pd_op.concat: (6x6xf32) <- ([6x1xf32, 6x1xf32, 6x4xf32], 1xi32)
