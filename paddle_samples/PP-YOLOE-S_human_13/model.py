...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.unsqueeze: (2x23x1x4xf32) <- (2x23x4xf32, 1xi64)
        unsqueeze_1 = paddle._C_ops.unsqueeze(data_1, full_int_array_1)

        # pd_op.split_with_num: ([2x23x1x1xf32, 2x23x1x1xf32, 2x23x1x1xf32, 2x23x1x1xf32]) <- (2x23x1x4xf32, 1xi32)
        split_with_num_1 = paddle._C_ops.split_with_num(unsqueeze_1, 4, full_0)

        # builtin.split: (2x23x1x1xf32, 2x23x1x1xf32, 2x23x1x1xf32, 2x23x1x1xf32) <- ([2x23x1x1xf32, 2x23x1x1xf32, 2x23x1x1xf32, 2x23x1x1xf32])
        (
            split_2,
            split_3,
            split_4,
        ...
        # pd_op.subtract: (2x23x4116x1xf32) <- (1x1x4116x1xf32, 2x23x1x1xf32)
        subtract_0 = paddle._C_ops.subtract(split_0, split_2)

        # pd_op.subtract: (2x23x4116x1xf32) <- (1x1x4116x1xf32, 2x23x1x1xf32)
        subtract_1 = paddle._C_ops.subtract(split_1, split_3)

        # pd_op.subtract: (2x23x4116x1xf32) <- (2x23x1x1xf32, 1x1x4116x1xf32)
        ...
        # builtin.combine: ([2x23x4116x1xf32, 2x23x4116x1xf32, 2x23x4116x1xf32, 2x23x4116x1xf32]) <- (2x23x4116x1xf32, 2x23x4116x1xf32, 2x23x4116x1xf32, 2x23x4116x1xf32)
        combine_0 = [subtract_0, subtract_1, subtract_2, subtract_3]

        # pd_op.concat: (2x23x4116x4xf32) <- ([2x23x4116x1xf32, 2x23x4116x1xf32, 2x23x4116x1xf32, 2x23x4116x1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_1)

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_2 = [-1]

        # pd_op.min: (2x23x4116xf32) <- (2x23x4116x4xf32, 1xi64)
        ...
        # pd_op.greater_than: (2x23x4116xb) <- (2x23x4116xf32, xf32)
        greater_than_0 = paddle._C_ops.greater_than(min_0, full_2)

        # pd_op.cast: (2x23x4116xf32) <- (2x23x4116xb)
