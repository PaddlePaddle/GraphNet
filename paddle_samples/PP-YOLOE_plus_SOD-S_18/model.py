...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0):
        ...
        full_0 = paddle._C_ops.full(
            [], float("10"), paddle.int32, paddle.framework._current_expected_place()
        )

        # pd_op.not_equal: (2x6804xb) <- (2x6804xi32, xi32)
        not_equal_0 = paddle._C_ops.not_equal(data_0, full_0)

        # pd_op.full_int_array: (0xi64) <- ()
        full_int_array_0 = []

        # pd_op.sum: (xi64) <- (2x6804xb, 0xi64)
        ...
        return greater_than_0, not_equal_0
