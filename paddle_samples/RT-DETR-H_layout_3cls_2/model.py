...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.matmul: (1x-1x192xf32) <- (1x-1x256xf32, 256x192xf32)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_2 = [full_5, slice_0, full_6, full_11]

        # pd_op.stack: (4xi64) <- ([xi64, xi64, xi64, xi64])
        stack_3 = paddle._C_ops.stack(combine_2, 0)

        # pd_op.reshape: (1x-1x8x12xf32) <- (1x-1x96xf32, 4xi64)
        reshape_6 = paddle._C_ops.reshape(add_2, stack_3)

        # pd_op.softmax: (1x-1x8x12xf32) <- (1x-1x8x12xf32)
        ...
        # pd_op.reshape: (1x-1x8x3x4xf32) <- (1x-1x8x12xf32, 5xi64)
        reshape_7 = paddle._C_ops.reshape(softmax_0, stack_4)

        # pd_op.shape64: (4xi64) <- (1x-1x1x4xf32)
        ...
        # pd_op.unsqueeze: (1x-1x1x1x1x2xf32) <- (1x-1x1x2xf32, 2xi64)
        ...
        # pd_op.scale: (1x-1x8x3x4x2xf32) <- (1x-1x8x3x4x2xf32, 1xf32)
        ...
        # pd_op.multiply: (1x-1x8x3x4x2xf32) <- (1x-1x8x3x4x2xf32, 1x-1x1x1x1x2xf32)
        ...
        # pd_op.add: (1x-1x8x3x4x2xf32) <- (1x-1x1x1x1x2xf32, 1x-1x8x3x4x2xf32)
        ...
        # pd_op.shape64: (6xi64) <- (1x-1x8x3x4x2xf32)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_10 = [full_6, full_7, slice_8, slice_9]
        ...
        # pd_op.slice: (1x-1x8x4x2xf32) <- (1x-1x8x3x4x2xf32, 1xi64, 1xi64)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_11 = [full_6, full_7, slice_11, slice_12]
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_12 = [full_6, full_7, slice_14, slice_15]
        ...
        # pd_op.transpose: (1x8x-1x3x4xf32) <- (1x-1x8x3x4xf32)
        transpose_6 = paddle._C_ops.transpose(reshape_7, [0, 2, 1, 3, 4])

        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_13 = [full_6, full_5, slice_6, full_11]

        # pd_op.stack: (4xi64) <- ([xi64, xi64, xi64, xi64])
        stack_14 = paddle._C_ops.stack(combine_13, 0)

        # pd_op.reshape: (8x1x-1x12xf32) <- (1x8x-1x3x4xf32, 4xi64)
        reshape_3 = paddle._C_ops.reshape(transpose_6, stack_14)

        # builtin.combine: ([8x32x-1x4xf32, 8x32x-1x4xf32, 8x32x-1x4xf32]) <- (8x32x-1x4xf32, 8x32x-1x4xf32, 8x32x-1x4xf32)
        combine_14 = [grid_sample_0, grid_sample_1, grid_sample_2]

        # pd_op.stack: (8x32x-1x3x4xf32) <- ([8x32x-1x4xf32, 8x32x-1x4xf32, 8x32x-1x4xf32])
        stack_0 = paddle._C_ops.stack(combine_14, -2)

        # pd_op.flatten: (8x32x-1x12xf32) <- (8x32x-1x3x4xf32)
        flatten_3 = paddle._C_ops.flatten(stack_0, 3, 4)

        # pd_op.multiply: (8x32x-1x12xf32) <- (8x32x-1x12xf32, 8x1x-1x12xf32)
        multiply_0 = paddle._C_ops.multiply(flatten_3, reshape_3)

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_0 = [-1]

        # pd_op.sum: (8x32x-1xf32) <- (8x32x-1x12xf32, 1xi64)
