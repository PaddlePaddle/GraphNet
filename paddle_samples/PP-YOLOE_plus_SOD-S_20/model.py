...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.transpose: (2x512x-1xf32) <- (2x-1x512xf32)
        ...
        # pd_op.reshape: (2x512x-1x-1xf32) <- (2x512x-1xf32, 4xi64)
        ...
        combine_1 = [swish_3, pool2d_0, pool2d_1, pool2d_2]
