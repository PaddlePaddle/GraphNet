...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (-1x64x56x56xf32) <- (-1x3x112x112xf32, 64x3x3x3xf32)
        conv2d_0 = paddle._C_ops.conv2d(
            data_0, parameter_282, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.prelu: (-1x64x56x56xf32) <- (-1x64x56x56xf32, 64xf32)
        ...
        # pd_op.prelu: (-1x128x56x56xf32) <- (-1x128x56x56xf32, 128xf32)
        ...
        # pd_op.prelu: (-1x128x28x28xf32) <- (-1x128x28x28xf32, 128xf32)
        prelu_3 = paddle._C_ops.prelu(batch_norm__18, parameter_259, "NCHW", "channel")

        # pd_op.conv2d: (-1x64x28x28xf32) <- (-1x128x28x28xf32, 64x128x1x1xf32)
        ...
        # pd_op.prelu: (-1x256x28x28xf32) <- (-1x256x28x28xf32, 256xf32)
        ...
        # pd_op.prelu: (-1x256x14x14xf32) <- (-1x256x14x14xf32, 256xf32)
        prelu_13 = paddle._C_ops.prelu(
            batch_norm__108, parameter_174, "NCHW", "channel"
        )

        # pd_op.conv2d: (-1x128x14x14xf32) <- (-1x256x14x14xf32, 128x256x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x256x14x14xf32) <- (-1x256x14x14xf32, 256x1x3x3xf32)
        ...
        # pd_op.prelu: (-1x512x14x14xf32) <- (-1x512x14x14xf32, 512xf32)
        ...
        # pd_op.prelu: (-1x512x7x7xf32) <- (-1x512x7x7xf32, 512xf32)
        ...
        # pd_op.prelu: (-1x256x7x7xf32) <- (-1x256x7x7xf32, 256xf32)
        ...
        # pd_op.conv2d: (-1x128x7x7xf32) <- (-1x256x7x7xf32, 128x256x1x1xf32)
        ...
        # pd_op.add: (-1x128x7x7xf32) <- (-1x128x7x7xf32, -1x128x7x7xf32)
        ...
        # pd_op.conv2d: (-1x512x7x7xf32) <- (-1x128x7x7xf32, 512x128x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x512x1x1xf32) <- (-1x512x7x7xf32, 512x1x7x7xf32)
        depthwise_conv2d_16 = paddle._C_ops.depthwise_conv2d(
            prelu_32, parameter_9, [1, 1], [0, 0], "EXPLICIT", 512, [1, 1], "NCHW"
        )

        # pd_op.batch_norm_: (-1x512x1x1xf32, 512xf32, 512xf32, 512xf32, 512xf32, -1xui8) <- (-1x512x1x1xf32, 512xf32, 512xf32, 512xf32, 512xf32)
        (
            batch_norm__288,
            batch_norm__289,
            batch_norm__290,
        ...
        # pd_op.shape64: (4xi64) <- (-1x128x1x1xf32)
        shape64_0 = paddle._C_ops.shape64(batch_norm__294)
        ...
        combine_0 = [slice_0, full_5]

        # pd_op.stack: (2xi64) <- ([xi64, xi64])
        stack_0 = paddle._C_ops.stack(combine_0, 0)

        # pd_op.reshape: (-1x128xf32) <- (-1x128x1x1xf32, 2xi64)
        reshape_0 = paddle._C_ops.reshape(batch_norm__294, stack_0)

        # pd_op.square: (-1x128xf32) <- (-1x128xf32)
        square_0 = paddle._C_ops.square(reshape_0)

        # pd_op.sum: (-1x1xf32) <- (-1x128xf32, 1xi64)
        sum_0 = paddle._C_ops.sum(square_0, full_int_array_1, None, True)

        # pd_op.sqrt: (-1x1xf32) <- (-1x1xf32)
        sqrt_0 = paddle._C_ops.sqrt(sum_0)

        # pd_op.divide: (-1x128xf32) <- (-1x128xf32, -1x1xf32)
        ...
        # pd_op.matmul: (-1x93431xf32) <- (-1x128xf32, 128x93431xf32)
        matmul_0 = paddle._C_ops.matmul(divide_0, divide_1, False, False)

        # pd_op.square: (-1x93431xf32) <- (-1x93431xf32)
        ...
        # pd_op.scale: (-1x93431xf32) <- (-1x93431xf32, 1xf32)
        ...
        # pd_op.subtract: (-1x93431xf32) <- (-1x93431xf32, -1x93431xf32)
        ...
        # pd_op.greater_than: (-1x93431xb) <- (-1x93431xf32, xf32)
        greater_than_0 = paddle._C_ops.greater_than(matmul_0, full_6)

        # pd_op.cast: (-1x93431xf32) <- (-1x93431xb)
        cast_0 = paddle._C_ops.cast(greater_than_0, paddle.float32)

        # pd_op.multiply: (-1x93431xf32) <- (-1x93431xf32, -1x93431xf32)
        ...
        # pd_op.add: (-1x93431xf32) <- (-1x93431xf32, -1x93431xf32)
        ...
        # pd_op.one_hot: (-1x1x93431xf32) <- (-1x1xi64, 1xi32)
        one_hot_0 = paddle._C_ops.one_hot(
            data_1 % paddle.cast(full_7, data_1.dtype), full_7
        )

        # pd_op.squeeze: (-1x93431xf32) <- (-1x1x93431xf32, 1xi64)
        ...
        # pd_op.scale: (-1x93431xf32) <- (-1x93431xf32, 1xf32)
        scale_5 = paddle._C_ops.scale(add_13, full_4, float("0"), True)
        return (
            conv2d_0,
            batch_norm__0,
            batch_norm__1,
