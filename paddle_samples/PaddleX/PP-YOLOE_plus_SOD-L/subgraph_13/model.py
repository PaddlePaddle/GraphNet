...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2):
        ...
        # pd_op.scale: (2x3549x10xf32) <- (2x3549x10xf32, 1xf32)
        ...
        # pd_op.multiply: (2x3549x10xf32) <- (2x3549x10xf32, 2x3549x10xf32)
        ...
        # pd_op.add: (2x3549x10xf32) <- (2x3549x10xf32, 2x3549x10xf32)
        add_0 = paddle._C_ops.add(multiply_0, multiply_1)

        # pd_op.bce_loss: (2x3549x10xf32) <- (2x3549x10xf32, 2x3549x10xf32)
        ...
        # pd_op.sum: (xf32) <- (2x3549x10xf32, 0xi64)
