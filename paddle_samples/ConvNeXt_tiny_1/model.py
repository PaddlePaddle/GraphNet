...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        multiply_1 = paddle._C_ops.multiply(data_3, add_5)
        ...
        # pd_op.multiply: (-1x56x56x96xf32) <- (96xf32, -1x56x56x96xf32)
        multiply_2 = paddle._C_ops.multiply(data_4, add_9)
        ...
        # pd_op.multiply: (-1x56x56x96xf32) <- (96xf32, -1x56x56x96xf32)
        multiply_3 = paddle._C_ops.multiply(data_5, add_13)
        ...
        # pd_op.unsqueeze: (96x1x1xf32) <- (96xf32, 2xi64)
        unsqueeze_2 = paddle._C_ops.unsqueeze(data_6, full_int_array_1)

        # pd_op.multiply: (-1x96x56x56xf32) <- (96x1x1xf32, -1x96x56x56xf32)
        multiply_4 = paddle._C_ops.multiply(unsqueeze_2, divide_1)

        # pd_op.unsqueeze: (96x1x1xf32) <- (96xf32, 2xi64)
        unsqueeze_3 = paddle._C_ops.unsqueeze(data_7, full_int_array_1)
        ...
        multiply_5 = paddle._C_ops.multiply(data_8, add_19)
        ...
        # pd_op.multiply: (-1x28x28x192xf32) <- (192xf32, -1x28x28x192xf32)
        multiply_6 = paddle._C_ops.multiply(data_9, add_23)
        ...
        # pd_op.multiply: (-1x28x28x192xf32) <- (192xf32, -1x28x28x192xf32)
        multiply_7 = paddle._C_ops.multiply(data_10, add_27)
        ...
        unsqueeze_4 = paddle._C_ops.unsqueeze(data_11, full_int_array_1)

        # pd_op.multiply: (-1x192x28x28xf32) <- (192x1x1xf32, -1x192x28x28xf32)
        multiply_8 = paddle._C_ops.multiply(unsqueeze_4, divide_2)

        # pd_op.unsqueeze: (192x1x1xf32) <- (192xf32, 2xi64)
        unsqueeze_5 = paddle._C_ops.unsqueeze(data_12, full_int_array_1)
        ...
        multiply_9 = paddle._C_ops.multiply(data_13, add_33)
        ...
        # pd_op.multiply: (-1x14x14x384xf32) <- (384xf32, -1x14x14x384xf32)
        multiply_10 = paddle._C_ops.multiply(data_14, add_37)
        ...
        # pd_op.multiply: (-1x14x14x384xf32) <- (384xf32, -1x14x14x384xf32)
        multiply_11 = paddle._C_ops.multiply(data_15, add_41)
        ...
        # pd_op.multiply: (-1x14x14x384xf32) <- (384xf32, -1x14x14x384xf32)
        multiply_12 = paddle._C_ops.multiply(data_16, add_45)
        ...
        # pd_op.multiply: (-1x14x14x384xf32) <- (384xf32, -1x14x14x384xf32)
        multiply_13 = paddle._C_ops.multiply(data_17, add_49)
        ...
        # pd_op.multiply: (-1x14x14x384xf32) <- (384xf32, -1x14x14x384xf32)
        multiply_14 = paddle._C_ops.multiply(data_18, add_53)
        ...
        # pd_op.multiply: (-1x14x14x384xf32) <- (384xf32, -1x14x14x384xf32)
        multiply_15 = paddle._C_ops.multiply(data_19, add_57)
        ...
        # pd_op.multiply: (-1x14x14x384xf32) <- (384xf32, -1x14x14x384xf32)
        multiply_16 = paddle._C_ops.multiply(data_20, add_61)
        ...
        # pd_op.multiply: (-1x14x14x384xf32) <- (384xf32, -1x14x14x384xf32)
        multiply_17 = paddle._C_ops.multiply(data_21, add_65)
        ...
        mean_6 = paddle._C_ops.mean(add_66, [1], True)
        ...
        unsqueeze_6 = paddle._C_ops.unsqueeze(data_22, full_int_array_1)

        # pd_op.multiply: (-1x384x14x14xf32) <- (384x1x1xf32, -1x384x14x14xf32)
        multiply_18 = paddle._C_ops.multiply(unsqueeze_6, divide_3)

        # pd_op.unsqueeze: (384x1x1xf32) <- (384xf32, 2xi64)
        unsqueeze_7 = paddle._C_ops.unsqueeze(data_23, full_int_array_1)
        ...
        multiply_19 = paddle._C_ops.multiply(data_24, add_71)
        ...
        # pd_op.multiply: (-1x7x7x768xf32) <- (768xf32, -1x7x7x768xf32)
        multiply_20 = paddle._C_ops.multiply(data_25, add_75)
        ...
        # pd_op.multiply: (-1x7x7x768xf32) <- (768xf32, -1x7x7x768xf32)
        multiply_21 = paddle._C_ops.multiply(data_26, add_79)
        ...
        mean_8 = paddle._C_ops.mean(add_80, [-2, -1], False)
