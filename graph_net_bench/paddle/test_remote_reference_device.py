...
from graph_net_bench.paddle import test_reference_device


def build_remote_rpc_cmd(args) -> str:
    cmd = "python -m graph_net_bench.paddle.test_reference_device"
    ...
    for model_path in path_utils.get_recursively_model_path(args.model_path):
        if test_samples is None or os.path.abspath(model_path) in test_samples:
            ...
            cmd = " ".join(
                [
                    sys.executable,
                    f"-m graph_net_bench.paddle.{module_name}",
