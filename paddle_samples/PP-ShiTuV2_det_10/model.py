...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.depthwise_conv2d: (2x320x-1x-1xf32) <- (2x-1x-1x-1xf32, 320x1x3x3xf32)
        ...
        # pd_op.conv2d: (2x640x-1x-1xf32) <- (2x320x-1x-1xf32, 640x320x1x1xf32)
        conv2d_0 = paddle._C_ops.conv2d(
            hardswish_0, parameter_54, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (2x640x-1x-1xf32, 640xf32, 640xf32, 640xf32, 640xf32, -1xui8) <- (2x640x-1x-1xf32, 640xf32, 640xf32, 640xf32, 640xf32)
        (
            batch_norm__6,
            batch_norm__7,
            batch_norm__8,
        ...
        # pd_op.hardswish: (2x640x-1x-1xf32) <- (2x640x-1x-1xf32)
        hardswish_1 = paddle._C_ops.hardswish(batch_norm__6)

        # pd_op.depthwise_conv2d: (2x640x-1x-1xf32) <- (2x640x-1x-1xf32, 640x1x5x5xf32)
        ...
        # pd_op.conv2d: (2x640x-1x-1xf32) <- (2x640x-1x-1xf32, 640x640x1x1xf32)
