...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4):
        ...
        # pd_op.split: ([-1x-1x-1x-1xf32, -1x-1x-1x-1xf32]) <- (6x8x-1x4xf32, 2xi64, 1xi32)
        ...
        # builtin.combine: ([1x8x300x4xf32, -1x-1x-1x-1xf32]) <- (1x8x300x4xf32, -1x-1x-1x-1xf32)
        combine_1 = [unsqueeze_0, split_0]

        # pd_op.concat: (-1x8x300x4xf32) <- ([1x8x300x4xf32, -1x-1x-1x-1xf32], 1xi32)
