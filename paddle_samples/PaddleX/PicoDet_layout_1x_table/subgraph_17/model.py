...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.clip: (40xf32) <- (40xf32, 1xf32, 1xf32)
        ...
        # builtin.combine: ([40xf32, 40xf32, 40xf32, 40xf32]) <- (40xf32, 40xf32, 40xf32, 40xf32)
        combine_0 = [clip_0, clip_1, clip_2, clip_3]
        del clip_0, clip_1, clip_2, clip_3

        # pd_op.stack: (40x4xf32) <- ([40xf32, 40xf32, 40xf32, 40xf32])
