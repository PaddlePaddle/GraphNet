...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (-1x72x56x56xf32) <- (-1x16x56x56xf32, 72x16x1x1xf32)
        conv2d_5 = paddle._C_ops.conv2d(
            batch_norm__18, parameter_189, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (-1x72x56x56xf32, 72xf32, 72xf32, 72xf32, 72xf32, -1xui8) <- (-1x72x56x56xf32, 72xf32, 72xf32, 72xf32, 72xf32)
        (
            batch_norm__24,
            batch_norm__25,
            batch_norm__26,
        ...
        # pd_op.relu: (-1x72x56x56xf32) <- (-1x72x56x56xf32)
        relu_3 = paddle._C_ops.relu(batch_norm__24)

        # pd_op.depthwise_conv2d: (-1x72x28x28xf32) <- (-1x72x56x56xf32, 72x1x3x3xf32)
        ...
        # pd_op.relu: (-1x72x28x28xf32) <- (-1x72x28x28xf32)
        relu_4 = paddle._C_ops.relu(batch_norm__30)

        # pd_op.conv2d: (-1x24x28x28xf32) <- (-1x72x28x28xf32, 24x72x1x1xf32)
        ...
        # pd_op.conv2d: (-1x88x28x28xf32) <- (-1x24x28x28xf32, 88x24x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x88x28x28xf32) <- (-1x88x28x28xf32, 88x1x3x3xf32)
        ...
        # pd_op.conv2d: (-1x24x28x28xf32) <- (-1x88x28x28xf32, 24x88x1x1xf32)
        ...
        # pd_op.conv2d: (-1x96x28x28xf32) <- (-1x24x28x28xf32, 96x24x1x1xf32)
        ...
        # pd_op.hardswish: (-1x96x28x28xf32) <- (-1x96x28x28xf32)
        hardswish_1 = paddle._C_ops.hardswish(batch_norm__60)

        # pd_op.depthwise_conv2d: (-1x96x14x14xf32) <- (-1x96x28x28xf32, 96x1x5x5xf32)
        ...
        # pd_op.pool2d: (-1x96x1x1xf32) <- (-1x96x14x14xf32, 2xi64)
        ...
        # pd_op.multiply: (-1x96x14x14xf32) <- (-1x96x14x14xf32, -1x96x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x240x14x14xf32) <- (-1x240x14x14xf32, 240x1x5x5xf32)
        ...
        # pd_op.conv2d: (-1x120x14x14xf32) <- (-1x40x14x14xf32, 120x40x1x1xf32)
        ...
        # pd_op.conv2d: (-1x144x14x14xf32) <- (-1x48x14x14xf32, 144x48x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x144x14x14xf32) <- (-1x144x14x14xf32, 144x1x5x5xf32)
        ...
        # pd_op.pool2d: (-1x144x1x1xf32) <- (-1x144x14x14xf32, 2xi64)
        ...
        # pd_op.multiply: (-1x144x14x14xf32) <- (-1x144x14x14xf32, -1x144x1x1xf32)
        multiply_5 = paddle._C_ops.multiply(hardswish_10, hardsigmoid_5)

        # pd_op.conv2d: (-1x48x14x14xf32) <- (-1x144x14x14xf32, 48x144x1x1xf32)
        ...
        # pd_op.conv2d: (-1x288x14x14xf32) <- (-1x48x14x14xf32, 288x48x1x1xf32)
        ...
        # pd_op.hardswish: (-1x288x14x14xf32) <- (-1x288x14x14xf32)
        hardswish_11 = paddle._C_ops.hardswish(batch_norm__150)

        # pd_op.depthwise_conv2d: (-1x288x7x7xf32) <- (-1x288x14x14xf32, 288x1x5x5xf32)
        ...
        # pd_op.conv2d: (-1x96x7x7xf32) <- (-1x288x7x7xf32, 96x288x1x1xf32)
        conv2d_32 = paddle._C_ops.conv2d(
            multiply_6, parameter_50, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (-1x96x7x7xf32, 96xf32, 96xf32, 96xf32, 96xf32, -1xui8) <- (-1x96x7x7xf32, 96xf32, 96xf32, 96xf32, 96xf32)
        (
            batch_norm__162,
            batch_norm__163,
            batch_norm__164,
        ...
        # pd_op.conv2d: (-1x576x7x7xf32) <- (-1x96x7x7xf32, 576x96x1x1xf32)
        conv2d_33 = paddle._C_ops.conv2d(
            batch_norm__162, parameter_45, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (-1x576x7x7xf32, 576xf32, 576xf32, 576xf32, 576xf32, -1xui8) <- (-1x576x7x7xf32, 576xf32, 576xf32, 576xf32, 576xf32)
        (
            batch_norm__168,
            batch_norm__169,
            batch_norm__170,
        ...
        # pd_op.hardswish: (-1x576x7x7xf32) <- (-1x576x7x7xf32)
        hardswish_13 = paddle._C_ops.hardswish(batch_norm__168)

        # pd_op.depthwise_conv2d: (-1x576x7x7xf32) <- (-1x576x7x7xf32, 576x1x5x5xf32)
        ...
        # pd_op.pool2d: (-1x576x1x1xf32) <- (-1x576x7x7xf32, 2xi64)
        ...
        # pd_op.conv2d: (-1x144x1x1xf32) <- (-1x576x1x1xf32, 144x576x1x1xf32)
        ...
        # pd_op.relu: (-1x144x1x1xf32) <- (-1x144x1x1xf32)
        relu_13 = paddle._C_ops.relu(add_19)

        # pd_op.conv2d: (-1x576x1x1xf32) <- (-1x144x1x1xf32, 576x144x1x1xf32)
        ...
        # pd_op.add: (-1x576x1x1xf32) <- (-1x576x1x1xf32, 1x576x1x1xf32)
        add_20 = paddle._C_ops.add(conv2d_35, reshape_15)

        # pd_op.hardsigmoid: (-1x576x1x1xf32) <- (-1x576x1x1xf32)
        hardsigmoid_7 = paddle._C_ops.hardsigmoid(add_20, float("0.2"), float("0.5"))

        # pd_op.multiply: (-1x576x7x7xf32) <- (-1x576x7x7xf32, -1x576x1x1xf32)
        multiply_7 = paddle._C_ops.multiply(hardswish_14, hardsigmoid_7)

        # pd_op.conv2d: (-1x96x7x7xf32) <- (-1x576x7x7xf32, 96x576x1x1xf32)
        ...
        # pd_op.add: (-1x96x7x7xf32) <- (-1x96x7x7xf32, -1x96x7x7xf32)
        ...
        # pd_op.conv2d: (-1x1280x1x1xf32) <- (-1x576x1x1xf32, 1280x576x1x1xf32)
