...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # builtin.combine: ([3600x4xf32, 900x4xf32, 225x4xf32, 64x4xf32]) <- (3600x4xf32, 900x4xf32, 225x4xf32, 64x4xf32)
        combine_12 = [reshape_0, reshape_1, reshape_2, reshape_3]

        # pd_op.concat: (4789x4xf32) <- ([3600x4xf32, 900x4xf32, 225x4xf32, 64x4xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_12, full_15)

        # builtin.combine: ([3600x2xf32, 900x2xf32, 225x2xf32, 64x2xf32]) <- (3600x2xf32, 900x2xf32, 225x2xf32, 64x2xf32)
        combine_13 = [reshape_4, reshape_5, reshape_6, reshape_7]

        # pd_op.concat: (4789x2xf32) <- ([3600x2xf32, 900x2xf32, 225x2xf32, 64x2xf32], 1xi32)
        concat_1 = paddle._C_ops.concat(combine_13, full_15)

        # builtin.combine: ([3600x1xf32, 900x1xf32, 225x1xf32, 64x1xf32]) <- (3600x1xf32, 900x1xf32, 225x1xf32, 64x1xf32)
        combine_14 = [full_5, full_8, full_11, full_14]

        # pd_op.concat: (4789x1xf32) <- ([3600x1xf32, 900x1xf32, 225x1xf32, 64x1xf32], 1xi32)
