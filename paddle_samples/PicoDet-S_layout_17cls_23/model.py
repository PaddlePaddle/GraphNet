...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.slice: (125xf32) <- (125x2xf32, 1xi64, 1xi64)
        slice_0 = paddle._C_ops.slice(
            data_0, [1], full_int_array_0, full_int_array_1, [1], [1]
        )

        # pd_op.slice: (125xf32) <- (125x4xf32, 1xi64, 1xi64)
        slice_1 = paddle._C_ops.slice(
            data_1, [1], full_int_array_0, full_int_array_1, [1], [1]
        )

        # pd_op.subtract: (125xf32) <- (125xf32, 125xf32)
        ...
        # pd_op.clip: (125xf32) <- (125xf32, 1xf32, 1xf32)
        ...
        # builtin.combine: ([125xf32, 125xf32, 125xf32, 125xf32]) <- (125xf32, 125xf32, 125xf32, 125xf32)
        combine_0 = [clip_0, clip_1, clip_2, clip_3]

        # pd_op.stack: (125x4xf32) <- ([125xf32, 125xf32, 125xf32, 125xf32])
