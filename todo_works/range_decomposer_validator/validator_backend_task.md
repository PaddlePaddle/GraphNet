...
5. 该validator应当能够检测【原模型】与【分解后模型】的算子数量，去掉【分解后模型】的placeholder后进行比对，以验证其完整性；
...
由于是单个样本测试，无需考虑性能提升，故预期对于正确拆分样本，使用所需的RangeDecomposerValidatorBackend后，ES图象应当是y=1的【一条直线】。
