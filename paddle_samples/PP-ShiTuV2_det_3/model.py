...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2):
        ...
        # pd_op.scale: (68xi64) <- (68xi64, 1xf32)
        ...
        # pd_op.subtract: (68xf32) <- (68xf32, 68xf32)
        ...
        # pd_op.unsqueeze: (68x1xi64) <- (68xi64, 1xi64)
        unsqueeze_0 = paddle._C_ops.unsqueeze(cast_0, full_int_array_1)

        # pd_op.cross_entropy_with_softmax: (68x8xf32, 68x1xf32) <- (68x8xf32, 68x1xi64)
        ...
        # pd_op.add: (68xf32) <- (68xf32, 68xf32)
