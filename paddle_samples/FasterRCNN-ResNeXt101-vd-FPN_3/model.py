...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.scale: (xi64) <- (xi64, 1xf32)
        scale_8 = paddle._C_ops.scale(slice_9, full_5, float("0"), True)
        ...
        # pd_op.scale: (xi64) <- (xi64, 1xf32)
        scale_9 = paddle._C_ops.scale(slice_8, full_5, float("0"), True)

        # pd_op.cast: (xf32) <- (xi64)
        cast_9 = paddle._C_ops.cast(scale_9, paddle.float32)

        # pd_op.arange: (-1xf32) <- (1xf32, xf32, 1xf32)
        arange_9 = paddle.arange(full_1, cast_9, full_5, dtype="float32")
