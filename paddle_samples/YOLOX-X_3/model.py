...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.shape64: (4xi64) <- (2x320x-1x-1xf32)
        ...
        # pd_op.shape64: (4xi64) <- (2x640x-1x-1xf32)
        ...
        # pd_op.shape64: (4xi64) <- (2x1280x-1x-1xf32)
        ...
        # pd_op.sigmoid: (2x320x-1x-1xf32) <- (2x320x-1x-1xf32)
        sigmoid_0 = paddle._C_ops.sigmoid(batch_norm__0)

        # pd_op.multiply: (2x320x-1x-1xf32) <- (2x320x-1x-1xf32, 2x320x-1x-1xf32)
        multiply_0 = paddle._C_ops.multiply(batch_norm__0, sigmoid_0)

        # pd_op.conv2d: (2x320x-1x-1xf32) <- (2x320x-1x-1xf32, 320x320x3x3xf32)
        ...
        # pd_op.conv2d: (2x4x-1x-1xf32) <- (2x320x-1x-1xf32, 4x320x1x1xf32)
        ...
        # pd_op.add: (2x4x-1x-1xf32) <- (2x4x-1x-1xf32, 1x4x1x1xf32)
        ...
        # pd_op.conv2d: (2x5x-1x-1xf32) <- (2x320x-1x-1xf32, 5x320x1x1xf32)
        ...
        # pd_op.add: (2x5x-1x-1xf32) <- (2x5x-1x-1xf32, 1x5x1x1xf32)
        add_1 = paddle._C_ops.add(conv2d_6, reshape_1)

        # pd_op.sigmoid: (2x4x-1x-1xf32) <- (2x4x-1x-1xf32)
        sigmoid_5 = paddle._C_ops.sigmoid(add_0)

        # pd_op.flatten: (2x4x-1xf32) <- (2x4x-1x-1xf32)
        flatten_0 = paddle._C_ops.flatten(sigmoid_5, 2, 3)

        # pd_op.transpose: (2x-1x4xf32) <- (2x4x-1xf32)
        ...
        # pd_op.split: ([2x4x-1x-1xf32, 2x1x-1x-1xf32]) <- (2x5x-1x-1xf32, 2xi64, 1xi32)
        split_3 = paddle._C_ops.split(add_1, full_int_array_4, full_0)

        # builtin.split: (2x4x-1x-1xf32, 2x1x-1x-1xf32) <- ([2x4x-1x-1xf32, 2x1x-1x-1xf32])
        (
            split_0,
            split_4,
        ) = split_3
        ...
        # pd_op.conv2d: (2x320x-1x-1xf32) <- (2x640x-1x-1xf32, 320x640x1x1xf32)
        ...
        # pd_op.conv2d: (2x320x-1x-1xf32) <- (2x1280x-1x-1xf32, 320x1280x1x1xf32)
        ...
        # builtin.combine: ([2x-1x1xf32, 2x-1x1xf32, 2x-1x1xf32]) <- (2x-1x1xf32, 2x-1x1xf32, 2x-1x1xf32)
        combine_2 = [transpose_2, transpose_5, transpose_8]

        # pd_op.concat: (2x-1x1xf32) <- ([2x-1x1xf32, 2x-1x1xf32, 2x-1x1xf32], 1xi32)
