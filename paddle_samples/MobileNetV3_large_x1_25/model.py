...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (128x24x112x112xf32) <- (128x3x224x224xf32, 24x3x3x3xf32)
        ...
        # pd_op.hardswish: (128x24x112x112xf32) <- (128x24x112x112xf32)
        hardswish_0 = paddle._C_ops.hardswish(batch_norm__0)

        # pd_op.conv2d: (128x24x112x112xf32) <- (128x24x112x112xf32, 24x24x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (128x24x112x112xf32) <- (128x24x112x112xf32, 24x1x3x3xf32)
        depthwise_conv2d_0 = paddle._C_ops.depthwise_conv2d(
            relu_0, parameter_259, [1, 1], [1, 1], "EXPLICIT", 24, [1, 1], "NCHW"
        )
        ...
        # pd_op.add: (128x24x112x112xf32) <- (128x24x112x112xf32, 128x24x112x112xf32)
        add_0 = paddle._C_ops.add(hardswish_0, batch_norm__16)

        # pd_op.conv2d: (128x80x112x112xf32) <- (128x24x112x112xf32, 80x24x1x1xf32)
        conv2d_3 = paddle._C_ops.conv2d(
            add_0, parameter_249, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (128x80x112x112xf32, 80xf32, 80xf32, 80xf32, 80xf32, -1xui8) <- (128x80x112x112xf32, 80xf32, 80xf32, 80xf32, 80xf32)
        (
            batch_norm__272,
            batch_norm__22,
            batch_norm__23,
        ...
        # pd_op.relu: (128x80x112x112xf32) <- (128x80x112x112xf32)
        relu_2 = paddle._C_ops.relu(batch_norm__272)

        # pd_op.depthwise_conv2d: (128x80x56x56xf32) <- (128x80x112x112xf32, 80x1x3x3xf32)
        depthwise_conv2d_1 = paddle._C_ops.depthwise_conv2d(
            relu_2, parameter_244, [2, 2], [1, 1], "EXPLICIT", 80, [1, 1], "NCHW"
        )
        ...
        # pd_op.relu: (128x80x56x56xf32) <- (128x80x56x56xf32)
        relu_3 = paddle._C_ops.relu(batch_norm__273)

        # pd_op.conv2d: (128x32x56x56xf32) <- (128x80x56x56xf32, 32x80x1x1xf32)
        ...
        # pd_op.conv2d: (128x88x56x56xf32) <- (128x32x56x56xf32, 88x32x1x1xf32)
        conv2d_5 = paddle._C_ops.conv2d(
            batch_norm__32, parameter_234, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (128x88x56x56xf32, 88xf32, 88xf32, 88xf32, 88xf32, -1xui8) <- (128x88x56x56xf32, 88xf32, 88xf32, 88xf32, 88xf32)
        (
            batch_norm__274,
            batch_norm__38,
            batch_norm__39,
        ...
        # pd_op.relu: (128x88x56x56xf32) <- (128x88x56x56xf32)
        relu_4 = paddle._C_ops.relu(batch_norm__274)

        # pd_op.depthwise_conv2d: (128x88x56x56xf32) <- (128x88x56x56xf32, 88x1x3x3xf32)
        depthwise_conv2d_2 = paddle._C_ops.depthwise_conv2d(
            relu_4, parameter_229, [1, 1], [1, 1], "EXPLICIT", 88, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (128x32x56x56xf32) <- (128x88x56x56xf32, 32x88x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (128x88x28x28xf32) <- (128x88x56x56xf32, 88x1x5x5xf32)
        depthwise_conv2d_3 = paddle._C_ops.depthwise_conv2d(
            relu_6, parameter_214, [2, 2], [2, 2], "EXPLICIT", 88, [1, 1], "NCHW"
        )
        ...
        # pd_op.relu: (128x88x28x28xf32) <- (128x88x28x28xf32)
        ...
        # pd_op.pool2d: (128x88x1x1xf32) <- (128x88x28x28xf32, 2xi64)
        ...
        # pd_op.conv2d: (128x22x1x1xf32) <- (128x88x1x1xf32, 22x88x1x1xf32)
        ...
        # pd_op.add: (128x22x1x1xf32) <- (128x22x1x1xf32, 1x22x1x1xf32)
        add_11 = paddle._C_ops.add(conv2d_8, reshape_0)

        # pd_op.relu: (128x22x1x1xf32) <- (128x22x1x1xf32)
        relu_8 = paddle._C_ops.relu(add_11)

        # pd_op.conv2d: (128x88x1x1xf32) <- (128x22x1x1xf32, 88x22x1x1xf32)
        ...
        # pd_op.add: (128x88x1x1xf32) <- (128x88x1x1xf32, 1x88x1x1xf32)
        add_12 = paddle._C_ops.add(conv2d_9, reshape_1)

        # pd_op.hardsigmoid: (128x88x1x1xf32) <- (128x88x1x1xf32)
        hardsigmoid_0 = paddle._C_ops.hardsigmoid(add_12, float("0.2"), float("0.5"))

        # pd_op.multiply: (128x88x28x28xf32) <- (128x88x28x28xf32, 128x88x1x1xf32)
        multiply_0 = paddle._C_ops.multiply(relu_7, hardsigmoid_0)

        # pd_op.conv2d: (128x48x28x28xf32) <- (128x88x28x28xf32, 48x88x1x1xf32)
        conv2d_10 = paddle._C_ops.conv2d(
            multiply_0, parameter_205, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (128x48x28x28xf32, 48xf32, 48xf32, 48xf32, 48xf32, -1xui8) <- (128x48x28x28xf32, 48xf32, 48xf32, 48xf32, 48xf32)
        (
            batch_norm__64,
            batch_norm__65,
            batch_norm__66,
        ...
        # pd_op.conv2d: (128x152x28x28xf32) <- (128x48x28x28xf32, 152x48x1x1xf32)
        conv2d_11 = paddle._C_ops.conv2d(
            batch_norm__64, parameter_200, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (128x152x28x28xf32, 152xf32, 152xf32, 152xf32, 152xf32, -1xui8) <- (128x152x28x28xf32, 152xf32, 152xf32, 152xf32, 152xf32)
        (
            batch_norm__278,
            batch_norm__70,
            batch_norm__71,
        ...
        # pd_op.relu: (128x152x28x28xf32) <- (128x152x28x28xf32)
        relu_9 = paddle._C_ops.relu(batch_norm__278)

        # pd_op.depthwise_conv2d: (128x152x28x28xf32) <- (128x152x28x28xf32, 152x1x5x5xf32)
        depthwise_conv2d_4 = paddle._C_ops.depthwise_conv2d(
            relu_9, parameter_195, [1, 1], [2, 2], "EXPLICIT", 152, [1, 1], "NCHW"
        )
        ...
        # pd_op.pool2d: (128x152x1x1xf32) <- (128x152x28x28xf32, 2xi64)
        ...
        # pd_op.conv2d: (128x38x1x1xf32) <- (128x152x1x1xf32, 38x152x1x1xf32)
        ...
        # pd_op.add: (128x38x1x1xf32) <- (128x38x1x1xf32, 1x38x1x1xf32)
        add_13 = paddle._C_ops.add(conv2d_12, reshape_2)

        # pd_op.relu: (128x38x1x1xf32) <- (128x38x1x1xf32)
        relu_11 = paddle._C_ops.relu(add_13)

        # pd_op.conv2d: (128x152x1x1xf32) <- (128x38x1x1xf32, 152x38x1x1xf32)
        ...
        # pd_op.add: (128x152x1x1xf32) <- (128x152x1x1xf32, 1x152x1x1xf32)
        add_14 = paddle._C_ops.add(conv2d_13, reshape_3)

        # pd_op.hardsigmoid: (128x152x1x1xf32) <- (128x152x1x1xf32)
        hardsigmoid_1 = paddle._C_ops.hardsigmoid(add_14, float("0.2"), float("0.5"))

        # pd_op.multiply: (128x152x28x28xf32) <- (128x152x28x28xf32, 128x152x1x1xf32)
        multiply_1 = paddle._C_ops.multiply(relu_10, hardsigmoid_1)

        # pd_op.conv2d: (128x48x28x28xf32) <- (128x152x28x28xf32, 48x152x1x1xf32)
        ...
        # pd_op.add: (128x48x28x28xf32) <- (128x48x28x28xf32, 128x48x28x28xf32)
        ...
        depthwise_conv2d_5 = paddle._C_ops.depthwise_conv2d(
            relu_12, parameter_176, [1, 1], [2, 2], "EXPLICIT", 152, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (128x304x28x28xf32) <- (128x48x28x28xf32, 304x48x1x1xf32)
        conv2d_19 = paddle._C_ops.conv2d(
            add_3, parameter_162, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (128x304x28x28xf32, 304xf32, 304xf32, 304xf32, 304xf32, -1xui8) <- (128x304x28x28xf32, 304xf32, 304xf32, 304xf32, 304xf32)
        (
            batch_norm__102,
            batch_norm__103,
            batch_norm__104,
        ...
        # pd_op.hardswish: (128x304x28x28xf32) <- (128x304x28x28xf32)
        hardswish_1 = paddle._C_ops.hardswish(batch_norm__102)

        # pd_op.depthwise_conv2d: (128x304x14x14xf32) <- (128x304x28x28xf32, 304x1x3x3xf32)
        depthwise_conv2d_6 = paddle._C_ops.depthwise_conv2d(
            hardswish_1, parameter_157, [2, 2], [1, 1], "EXPLICIT", 304, [1, 1], "NCHW"
        )

        # pd_op.batch_norm_: (128x304x14x14xf32, 304xf32, 304xf32, 304xf32, 304xf32, -1xui8) <- (128x304x14x14xf32, 304xf32, 304xf32, 304xf32, 304xf32)
        (
            batch_norm__108,
            batch_norm__109,
            batch_norm__110,
        ...
        # pd_op.hardswish: (128x304x14x14xf32) <- (128x304x14x14xf32)
        hardswish_2 = paddle._C_ops.hardswish(batch_norm__108)

        # pd_op.conv2d: (128x104x14x14xf32) <- (128x304x14x14xf32, 104x304x1x1xf32)
        conv2d_20 = paddle._C_ops.conv2d(
            hardswish_2, parameter_152, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (128x104x14x14xf32, 104xf32, 104xf32, 104xf32, 104xf32, -1xui8) <- (128x104x14x14xf32, 104xf32, 104xf32, 104xf32, 104xf32)
        (
            batch_norm__114,
            batch_norm__115,
            batch_norm__116,
        ...
        # pd_op.conv2d: (128x248x14x14xf32) <- (128x104x14x14xf32, 248x104x1x1xf32)
        ...
        # pd_op.batch_norm_: (128x248x14x14xf32, 248xf32, 248xf32, 248xf32, 248xf32, -1xui8) <- (128x248x14x14xf32, 248xf32, 248xf32, 248xf32, 248xf32)
        (
            batch_norm__120,
            batch_norm__121,
            batch_norm__122,
        ...
        # pd_op.hardswish: (128x248x14x14xf32) <- (128x248x14x14xf32)
        hardswish_3 = paddle._C_ops.hardswish(batch_norm__120)

        # pd_op.depthwise_conv2d: (128x248x14x14xf32) <- (128x248x14x14xf32, 248x1x3x3xf32)
        depthwise_conv2d_7 = paddle._C_ops.depthwise_conv2d(
            hardswish_3, parameter_142, [1, 1], [1, 1], "EXPLICIT", 248, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (128x104x14x14xf32) <- (128x248x14x14xf32, 104x248x1x1xf32)
        ...
        # pd_op.add: (128x104x14x14xf32) <- (128x104x14x14xf32, 128x104x14x14xf32)
        add_4 = paddle._C_ops.add(batch_norm__114, batch_norm__132)

        # pd_op.conv2d: (128x232x14x14xf32) <- (128x104x14x14xf32, 232x104x1x1xf32)
        ...
        depthwise_conv2d_8 = paddle._C_ops.depthwise_conv2d(
            hardswish_5, parameter_127, [1, 1], [1, 1], "EXPLICIT", 232, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (128x104x14x14xf32) <- (128x232x14x14xf32, 104x232x1x1xf32)
        ...
        depthwise_conv2d_9 = paddle._C_ops.depthwise_conv2d(
            hardswish_7, parameter_112, [1, 1], [1, 1], "EXPLICIT", 232, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (128x600x14x14xf32) <- (128x104x14x14xf32, 600x104x1x1xf32)
        conv2d_27 = paddle._C_ops.conv2d(
            add_6, parameter_102, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (128x600x14x14xf32, 600xf32, 600xf32, 600xf32, 600xf32, -1xui8) <- (128x600x14x14xf32, 600xf32, 600xf32, 600xf32, 600xf32)
        (
            batch_norm__174,
            batch_norm__175,
            batch_norm__176,
        ...
        # pd_op.hardswish: (128x600x14x14xf32) <- (128x600x14x14xf32)
        hardswish_9 = paddle._C_ops.hardswish(batch_norm__174)

        # pd_op.depthwise_conv2d: (128x600x14x14xf32) <- (128x600x14x14xf32, 600x1x3x3xf32)
        depthwise_conv2d_10 = paddle._C_ops.depthwise_conv2d(
            hardswish_9, parameter_97, [1, 1], [1, 1], "EXPLICIT", 600, [1, 1], "NCHW"
        )
        ...
        # pd_op.pool2d: (128x600x1x1xf32) <- (128x600x14x14xf32, 2xi64)
        ...
        # pd_op.conv2d: (128x150x1x1xf32) <- (128x600x1x1xf32, 150x600x1x1xf32)
        ...
        # pd_op.add: (128x150x1x1xf32) <- (128x150x1x1xf32, 1x150x1x1xf32)
        add_17 = paddle._C_ops.add(conv2d_28, reshape_6)

        # pd_op.relu: (128x150x1x1xf32) <- (128x150x1x1xf32)
        relu_15 = paddle._C_ops.relu(add_17)

        # pd_op.conv2d: (128x600x1x1xf32) <- (128x150x1x1xf32, 600x150x1x1xf32)
        ...
        # pd_op.add: (128x600x1x1xf32) <- (128x600x1x1xf32, 1x600x1x1xf32)
        add_18 = paddle._C_ops.add(conv2d_29, reshape_7)

        # pd_op.hardsigmoid: (128x600x1x1xf32) <- (128x600x1x1xf32)
        hardsigmoid_3 = paddle._C_ops.hardsigmoid(add_18, float("0.2"), float("0.5"))

        # pd_op.multiply: (128x600x14x14xf32) <- (128x600x14x14xf32, 128x600x1x1xf32)
        multiply_3 = paddle._C_ops.multiply(hardswish_10, hardsigmoid_3)

        # pd_op.conv2d: (128x144x14x14xf32) <- (128x600x14x14xf32, 144x600x1x1xf32)
        conv2d_30 = paddle._C_ops.conv2d(
            multiply_3, parameter_88, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (128x144x14x14xf32, 144xf32, 144xf32, 144xf32, 144xf32, -1xui8) <- (128x144x14x14xf32, 144xf32, 144xf32, 144xf32, 144xf32)
        (
            batch_norm__186,
            batch_norm__187,
            batch_norm__188,
        ...
        # pd_op.conv2d: (128x840x14x14xf32) <- (128x144x14x14xf32, 840x144x1x1xf32)
        conv2d_31 = paddle._C_ops.conv2d(
            batch_norm__186, parameter_83, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (128x840x14x14xf32, 840xf32, 840xf32, 840xf32, 840xf32, -1xui8) <- (128x840x14x14xf32, 840xf32, 840xf32, 840xf32, 840xf32)
        (
            batch_norm__192,
            batch_norm__193,
            batch_norm__194,
        ...
        # pd_op.hardswish: (128x840x14x14xf32) <- (128x840x14x14xf32)
        hardswish_11 = paddle._C_ops.hardswish(batch_norm__192)

        # pd_op.depthwise_conv2d: (128x840x14x14xf32) <- (128x840x14x14xf32, 840x1x3x3xf32)
        depthwise_conv2d_11 = paddle._C_ops.depthwise_conv2d(
            hardswish_11, parameter_78, [1, 1], [1, 1], "EXPLICIT", 840, [1, 1], "NCHW"
        )
        ...
        # pd_op.pool2d: (128x840x1x1xf32) <- (128x840x14x14xf32, 2xi64)
        ...
        # pd_op.conv2d: (128x210x1x1xf32) <- (128x840x1x1xf32, 210x840x1x1xf32)
        ...
        # pd_op.add: (128x210x1x1xf32) <- (128x210x1x1xf32, 1x210x1x1xf32)
        add_19 = paddle._C_ops.add(conv2d_32, reshape_8)

        # pd_op.relu: (128x210x1x1xf32) <- (128x210x1x1xf32)
        relu_16 = paddle._C_ops.relu(add_19)

        # pd_op.conv2d: (128x840x1x1xf32) <- (128x210x1x1xf32, 840x210x1x1xf32)
        ...
        # pd_op.add: (128x840x1x1xf32) <- (128x840x1x1xf32, 1x840x1x1xf32)
        add_20 = paddle._C_ops.add(conv2d_33, reshape_9)

        # pd_op.hardsigmoid: (128x840x1x1xf32) <- (128x840x1x1xf32)
        hardsigmoid_4 = paddle._C_ops.hardsigmoid(add_20, float("0.2"), float("0.5"))

        # pd_op.multiply: (128x840x14x14xf32) <- (128x840x14x14xf32, 128x840x1x1xf32)
        multiply_4 = paddle._C_ops.multiply(hardswish_12, hardsigmoid_4)

        # pd_op.conv2d: (128x144x14x14xf32) <- (128x840x14x14xf32, 144x840x1x1xf32)
        ...
        # pd_op.add: (128x144x14x14xf32) <- (128x144x14x14xf32, 128x144x14x14xf32)
        ...
        # pd_op.depthwise_conv2d: (128x840x7x7xf32) <- (128x840x14x14xf32, 840x1x5x5xf32)
        depthwise_conv2d_12 = paddle._C_ops.depthwise_conv2d(
            hardswish_13, parameter_59, [2, 2], [2, 2], "EXPLICIT", 840, [1, 1], "NCHW"
        )

        # pd_op.batch_norm_: (128x840x7x7xf32, 840xf32, 840xf32, 840xf32, 840xf32, -1xui8) <- (128x840x7x7xf32, 840xf32, 840xf32, 840xf32, 840xf32)
        (
            batch_norm__216,
            batch_norm__217,
            batch_norm__218,
        ...
        # pd_op.hardswish: (128x840x7x7xf32) <- (128x840x7x7xf32)
        hardswish_14 = paddle._C_ops.hardswish(batch_norm__216)

        # pd_op.pool2d: (128x840x1x1xf32) <- (128x840x7x7xf32, 2xi64)
        ...
        # pd_op.multiply: (128x840x7x7xf32) <- (128x840x7x7xf32, 128x840x1x1xf32)
        multiply_5 = paddle._C_ops.multiply(hardswish_14, hardsigmoid_5)

        # pd_op.conv2d: (128x200x7x7xf32) <- (128x840x7x7xf32, 200x840x1x1xf32)
        conv2d_38 = paddle._C_ops.conv2d(
            multiply_5, parameter_50, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (128x200x7x7xf32, 200xf32, 200xf32, 200xf32, 200xf32, -1xui8) <- (128x200x7x7xf32, 200xf32, 200xf32, 200xf32, 200xf32)
        (
            batch_norm__222,
            batch_norm__223,
            batch_norm__224,
        ...
        # pd_op.conv2d: (128x1200x7x7xf32) <- (128x200x7x7xf32, 1200x200x1x1xf32)
        conv2d_39 = paddle._C_ops.conv2d(
            batch_norm__222, parameter_45, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (128x1200x7x7xf32, 1200xf32, 1200xf32, 1200xf32, 1200xf32, -1xui8) <- (128x1200x7x7xf32, 1200xf32, 1200xf32, 1200xf32, 1200xf32)
        (
            batch_norm__228,
            batch_norm__229,
            batch_norm__230,
        ...
        # pd_op.hardswish: (128x1200x7x7xf32) <- (128x1200x7x7xf32)
        hardswish_15 = paddle._C_ops.hardswish(batch_norm__228)

        # pd_op.depthwise_conv2d: (128x1200x7x7xf32) <- (128x1200x7x7xf32, 1200x1x5x5xf32)
        depthwise_conv2d_13 = paddle._C_ops.depthwise_conv2d(
            hardswish_15, parameter_40, [1, 1], [2, 2], "EXPLICIT", 1200, [1, 1], "NCHW"
        )
        ...
        # pd_op.pool2d: (128x1200x1x1xf32) <- (128x1200x7x7xf32, 2xi64)
        ...
        # pd_op.conv2d: (128x300x1x1xf32) <- (128x1200x1x1xf32, 300x1200x1x1xf32)
        ...
        # pd_op.add: (128x300x1x1xf32) <- (128x300x1x1xf32, 1x300x1x1xf32)
        add_23 = paddle._C_ops.add(conv2d_40, reshape_12)

        # pd_op.relu: (128x300x1x1xf32) <- (128x300x1x1xf32)
        relu_18 = paddle._C_ops.relu(add_23)

        # pd_op.conv2d: (128x1200x1x1xf32) <- (128x300x1x1xf32, 1200x300x1x1xf32)
        ...
        # pd_op.add: (128x1200x1x1xf32) <- (128x1200x1x1xf32, 1x1200x1x1xf32)
        add_24 = paddle._C_ops.add(conv2d_41, reshape_13)

        # pd_op.hardsigmoid: (128x1200x1x1xf32) <- (128x1200x1x1xf32)
        hardsigmoid_6 = paddle._C_ops.hardsigmoid(add_24, float("0.2"), float("0.5"))

        # pd_op.multiply: (128x1200x7x7xf32) <- (128x1200x7x7xf32, 128x1200x1x1xf32)
        multiply_6 = paddle._C_ops.multiply(hardswish_16, hardsigmoid_6)

        # pd_op.conv2d: (128x200x7x7xf32) <- (128x1200x7x7xf32, 200x1200x1x1xf32)
        ...
        # pd_op.add: (128x200x7x7xf32) <- (128x200x7x7xf32, 128x200x7x7xf32)
        ...
        depthwise_conv2d_14 = paddle._C_ops.depthwise_conv2d(
            hardswish_17, parameter_21, [1, 1], [2, 2], "EXPLICIT", 1200, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (128x1280x1x1xf32) <- (128x1200x1x1xf32, 1280x1200x1x1xf32)
