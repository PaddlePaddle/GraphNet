...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (128x48x112x112xf32) <- (128x16x112x112xf32, 48x16x1x1xf32)
        conv2d_3 = paddle._C_ops.conv2d(
            add_0, parameter_249, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (128x48x112x112xf32, 48xf32, 48xf32, 48xf32, 48xf32, -1xui8) <- (128x48x112x112xf32, 48xf32, 48xf32, 48xf32, 48xf32)
        (
            batch_norm__272,
            batch_norm__22,
            batch_norm__23,
        ...
        # pd_op.relu: (128x48x112x112xf32) <- (128x48x112x112xf32)
        relu_2 = paddle._C_ops.relu(batch_norm__272)

        # pd_op.depthwise_conv2d: (128x48x56x56xf32) <- (128x48x112x112xf32, 48x1x3x3xf32)
        depthwise_conv2d_1 = paddle._C_ops.depthwise_conv2d(
            relu_2, parameter_244, [2, 2], [1, 1], "EXPLICIT", 48, [1, 1], "NCHW"
        )

        # pd_op.batch_norm_: (128x48x56x56xf32, 48xf32, 48xf32, 48xf32, 48xf32, -1xui8) <- (128x48x56x56xf32, 48xf32, 48xf32, 48xf32, 48xf32)
        (
            batch_norm__273,
            batch_norm__27,
            batch_norm__28,
        ...
        # pd_op.relu: (128x48x56x56xf32) <- (128x48x56x56xf32)
        relu_3 = paddle._C_ops.relu(batch_norm__273)

        # pd_op.conv2d: (128x24x56x56xf32) <- (128x48x56x56xf32, 24x48x1x1xf32)
        ...
        # pd_op.conv2d: (128x56x56x56xf32) <- (128x24x56x56xf32, 56x24x1x1xf32)
        conv2d_5 = paddle._C_ops.conv2d(
            batch_norm__32, parameter_234, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (128x56x56x56xf32, 56xf32, 56xf32, 56xf32, 56xf32, -1xui8) <- (128x56x56x56xf32, 56xf32, 56xf32, 56xf32, 56xf32)
        (
            batch_norm__274,
            batch_norm__38,
            batch_norm__39,
        ...
        # pd_op.relu: (128x56x56x56xf32) <- (128x56x56x56xf32)
        relu_4 = paddle._C_ops.relu(batch_norm__274)

        # pd_op.depthwise_conv2d: (128x56x56x56xf32) <- (128x56x56x56xf32, 56x1x3x3xf32)
        ...
        # pd_op.conv2d: (128x24x56x56xf32) <- (128x56x56x56xf32, 24x56x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (128x56x28x28xf32) <- (128x56x56x56xf32, 56x1x5x5xf32)
        depthwise_conv2d_3 = paddle._C_ops.depthwise_conv2d(
            relu_6, parameter_214, [2, 2], [2, 2], "EXPLICIT", 56, [1, 1], "NCHW"
        )

        # pd_op.batch_norm_: (128x56x28x28xf32, 56xf32, 56xf32, 56xf32, 56xf32, -1xui8) <- (128x56x28x28xf32, 56xf32, 56xf32, 56xf32, 56xf32)
        (
            batch_norm__277,
            batch_norm__59,
            batch_norm__60,
        ...
        # pd_op.relu: (128x56x28x28xf32) <- (128x56x28x28xf32)
        ...
        # pd_op.pool2d: (128x56x1x1xf32) <- (128x56x28x28xf32, 2xi64)
        ...
        # pd_op.conv2d: (128x14x1x1xf32) <- (128x56x1x1xf32, 14x56x1x1xf32)
        ...
        # pd_op.add: (128x14x1x1xf32) <- (128x14x1x1xf32, 1x14x1x1xf32)
        add_11 = paddle._C_ops.add(conv2d_8, reshape_0)

        # pd_op.relu: (128x14x1x1xf32) <- (128x14x1x1xf32)
        relu_8 = paddle._C_ops.relu(add_11)

        # pd_op.conv2d: (128x56x1x1xf32) <- (128x14x1x1xf32, 56x14x1x1xf32)
        ...
        # pd_op.add: (128x56x1x1xf32) <- (128x56x1x1xf32, 1x56x1x1xf32)
        add_12 = paddle._C_ops.add(conv2d_9, reshape_1)

        # pd_op.hardsigmoid: (128x56x1x1xf32) <- (128x56x1x1xf32)
        hardsigmoid_0 = paddle._C_ops.hardsigmoid(add_12, float("0.2"), float("0.5"))

        # pd_op.multiply: (128x56x28x28xf32) <- (128x56x28x28xf32, 128x56x1x1xf32)
        multiply_0 = paddle._C_ops.multiply(relu_7, hardsigmoid_0)

        # pd_op.conv2d: (128x32x28x28xf32) <- (128x56x28x28xf32, 32x56x1x1xf32)
        conv2d_10 = paddle._C_ops.conv2d(
            multiply_0, parameter_205, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (128x32x28x28xf32, 32xf32, 32xf32, 32xf32, 32xf32, -1xui8) <- (128x32x28x28xf32, 32xf32, 32xf32, 32xf32, 32xf32)
        (
            batch_norm__64,
            batch_norm__65,
            batch_norm__66,
        ...
        # pd_op.conv2d: (128x88x28x28xf32) <- (128x32x28x28xf32, 88x32x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (128x88x28x28xf32) <- (128x88x28x28xf32, 88x1x5x5xf32)
        ...
        # pd_op.conv2d: (128x32x28x28xf32) <- (128x88x28x28xf32, 32x88x1x1xf32)
        ...
        # pd_op.add: (128x32x28x28xf32) <- (128x32x28x28xf32, 128x32x28x28xf32)
        ...
        # pd_op.conv2d: (128x184x28x28xf32) <- (128x32x28x28xf32, 184x32x1x1xf32)
        conv2d_19 = paddle._C_ops.conv2d(
            add_3, parameter_162, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (128x184x28x28xf32, 184xf32, 184xf32, 184xf32, 184xf32, -1xui8) <- (128x184x28x28xf32, 184xf32, 184xf32, 184xf32, 184xf32)
        (
            batch_norm__102,
            batch_norm__103,
            batch_norm__104,
        ...
        # pd_op.hardswish: (128x184x28x28xf32) <- (128x184x28x28xf32)
        hardswish_1 = paddle._C_ops.hardswish(batch_norm__102)

        # pd_op.depthwise_conv2d: (128x184x14x14xf32) <- (128x184x28x28xf32, 184x1x3x3xf32)
        ...
        # pd_op.conv2d: (128x64x14x14xf32) <- (128x184x14x14xf32, 64x184x1x1xf32)
        ...
        # pd_op.conv2d: (128x152x14x14xf32) <- (128x64x14x14xf32, 152x64x1x1xf32)
        ...
        # pd_op.batch_norm_: (128x152x14x14xf32, 152xf32, 152xf32, 152xf32, 152xf32, -1xui8) <- (128x152x14x14xf32, 152xf32, 152xf32, 152xf32, 152xf32)
        (
            batch_norm__120,
            batch_norm__121,
            batch_norm__122,
        ...
        # pd_op.hardswish: (128x152x14x14xf32) <- (128x152x14x14xf32)
        hardswish_3 = paddle._C_ops.hardswish(batch_norm__120)

        # pd_op.depthwise_conv2d: (128x152x14x14xf32) <- (128x152x14x14xf32, 152x1x3x3xf32)
        ...
        # pd_op.conv2d: (128x64x14x14xf32) <- (128x152x14x14xf32, 64x152x1x1xf32)
        ...
        # pd_op.add: (128x64x14x14xf32) <- (128x64x14x14xf32, 128x64x14x14xf32)
        add_4 = paddle._C_ops.add(batch_norm__114, batch_norm__132)

        # pd_op.conv2d: (128x136x14x14xf32) <- (128x64x14x14xf32, 136x64x1x1xf32)
        conv2d_23 = paddle._C_ops.conv2d(
            add_4, parameter_132, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (128x136x14x14xf32, 136xf32, 136xf32, 136xf32, 136xf32, -1xui8) <- (128x136x14x14xf32, 136xf32, 136xf32, 136xf32, 136xf32)
        (
            batch_norm__138,
            batch_norm__139,
            batch_norm__140,
        ...
        # pd_op.hardswish: (128x136x14x14xf32) <- (128x136x14x14xf32)
        hardswish_5 = paddle._C_ops.hardswish(batch_norm__138)

        # pd_op.depthwise_conv2d: (128x136x14x14xf32) <- (128x136x14x14xf32, 136x1x3x3xf32)
        ...
        # pd_op.conv2d: (128x64x14x14xf32) <- (128x136x14x14xf32, 64x136x1x1xf32)
        ...
        # pd_op.conv2d: (128x360x14x14xf32) <- (128x64x14x14xf32, 360x64x1x1xf32)
        conv2d_27 = paddle._C_ops.conv2d(
            add_6, parameter_102, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (128x360x14x14xf32, 360xf32, 360xf32, 360xf32, 360xf32, -1xui8) <- (128x360x14x14xf32, 360xf32, 360xf32, 360xf32, 360xf32)
        (
            batch_norm__174,
            batch_norm__175,
            batch_norm__176,
        ...
        # pd_op.hardswish: (128x360x14x14xf32) <- (128x360x14x14xf32)
        hardswish_9 = paddle._C_ops.hardswish(batch_norm__174)

        # pd_op.depthwise_conv2d: (128x360x14x14xf32) <- (128x360x14x14xf32, 360x1x3x3xf32)
        ...
        # pd_op.pool2d: (128x360x1x1xf32) <- (128x360x14x14xf32, 2xi64)
        ...
        # pd_op.conv2d: (128x90x1x1xf32) <- (128x360x1x1xf32, 90x360x1x1xf32)
        ...
        # pd_op.add: (128x90x1x1xf32) <- (128x90x1x1xf32, 1x90x1x1xf32)
        add_17 = paddle._C_ops.add(conv2d_28, reshape_6)

        # pd_op.relu: (128x90x1x1xf32) <- (128x90x1x1xf32)
        relu_15 = paddle._C_ops.relu(add_17)

        # pd_op.conv2d: (128x360x1x1xf32) <- (128x90x1x1xf32, 360x90x1x1xf32)
        ...
        # pd_op.add: (128x360x1x1xf32) <- (128x360x1x1xf32, 1x360x1x1xf32)
        add_18 = paddle._C_ops.add(conv2d_29, reshape_7)

        # pd_op.hardsigmoid: (128x360x1x1xf32) <- (128x360x1x1xf32)
        hardsigmoid_3 = paddle._C_ops.hardsigmoid(add_18, float("0.2"), float("0.5"))

        # pd_op.multiply: (128x360x14x14xf32) <- (128x360x14x14xf32, 128x360x1x1xf32)
        multiply_3 = paddle._C_ops.multiply(hardswish_10, hardsigmoid_3)

        # pd_op.conv2d: (128x88x14x14xf32) <- (128x360x14x14xf32, 88x360x1x1xf32)
        ...
        # pd_op.conv2d: (128x504x14x14xf32) <- (128x88x14x14xf32, 504x88x1x1xf32)
        conv2d_31 = paddle._C_ops.conv2d(
            batch_norm__186, parameter_83, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (128x504x14x14xf32, 504xf32, 504xf32, 504xf32, 504xf32, -1xui8) <- (128x504x14x14xf32, 504xf32, 504xf32, 504xf32, 504xf32)
        (
            batch_norm__192,
            batch_norm__193,
            batch_norm__194,
        ...
        # pd_op.hardswish: (128x504x14x14xf32) <- (128x504x14x14xf32)
        hardswish_11 = paddle._C_ops.hardswish(batch_norm__192)

        # pd_op.depthwise_conv2d: (128x504x14x14xf32) <- (128x504x14x14xf32, 504x1x3x3xf32)
        ...
        # pd_op.pool2d: (128x504x1x1xf32) <- (128x504x14x14xf32, 2xi64)
        ...
        # pd_op.conv2d: (128x126x1x1xf32) <- (128x504x1x1xf32, 126x504x1x1xf32)
        ...
        # pd_op.add: (128x126x1x1xf32) <- (128x126x1x1xf32, 1x126x1x1xf32)
        add_19 = paddle._C_ops.add(conv2d_32, reshape_8)

        # pd_op.relu: (128x126x1x1xf32) <- (128x126x1x1xf32)
        relu_16 = paddle._C_ops.relu(add_19)

        # pd_op.conv2d: (128x504x1x1xf32) <- (128x126x1x1xf32, 504x126x1x1xf32)
        ...
        # pd_op.add: (128x504x1x1xf32) <- (128x504x1x1xf32, 1x504x1x1xf32)
        add_20 = paddle._C_ops.add(conv2d_33, reshape_9)

        # pd_op.hardsigmoid: (128x504x1x1xf32) <- (128x504x1x1xf32)
        hardsigmoid_4 = paddle._C_ops.hardsigmoid(add_20, float("0.2"), float("0.5"))

        # pd_op.multiply: (128x504x14x14xf32) <- (128x504x14x14xf32, 128x504x1x1xf32)
        multiply_4 = paddle._C_ops.multiply(hardswish_12, hardsigmoid_4)

        # pd_op.conv2d: (128x88x14x14xf32) <- (128x504x14x14xf32, 88x504x1x1xf32)
        ...
        # pd_op.add: (128x88x14x14xf32) <- (128x88x14x14xf32, 128x88x14x14xf32)
        ...
        # pd_op.depthwise_conv2d: (128x504x7x7xf32) <- (128x504x14x14xf32, 504x1x5x5xf32)
        depthwise_conv2d_12 = paddle._C_ops.depthwise_conv2d(
            hardswish_13, parameter_59, [2, 2], [2, 2], "EXPLICIT", 504, [1, 1], "NCHW"
        )

        # pd_op.batch_norm_: (128x504x7x7xf32, 504xf32, 504xf32, 504xf32, 504xf32, -1xui8) <- (128x504x7x7xf32, 504xf32, 504xf32, 504xf32, 504xf32)
        (
            batch_norm__216,
            batch_norm__217,
            batch_norm__218,
        ...
        # pd_op.hardswish: (128x504x7x7xf32) <- (128x504x7x7xf32)
        hardswish_14 = paddle._C_ops.hardswish(batch_norm__216)

        # pd_op.pool2d: (128x504x1x1xf32) <- (128x504x7x7xf32, 2xi64)
        ...
        # pd_op.multiply: (128x504x7x7xf32) <- (128x504x7x7xf32, 128x504x1x1xf32)
        multiply_5 = paddle._C_ops.multiply(hardswish_14, hardsigmoid_5)

        # pd_op.conv2d: (128x120x7x7xf32) <- (128x504x7x7xf32, 120x504x1x1xf32)
        conv2d_38 = paddle._C_ops.conv2d(
            multiply_5, parameter_50, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (128x120x7x7xf32, 120xf32, 120xf32, 120xf32, 120xf32, -1xui8) <- (128x120x7x7xf32, 120xf32, 120xf32, 120xf32, 120xf32)
        (
            batch_norm__222,
            batch_norm__223,
            batch_norm__224,
        ...
        # pd_op.conv2d: (128x720x7x7xf32) <- (128x120x7x7xf32, 720x120x1x1xf32)
        conv2d_39 = paddle._C_ops.conv2d(
            batch_norm__222, parameter_45, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (128x720x7x7xf32, 720xf32, 720xf32, 720xf32, 720xf32, -1xui8) <- (128x720x7x7xf32, 720xf32, 720xf32, 720xf32, 720xf32)
        (
            batch_norm__228,
            batch_norm__229,
            batch_norm__230,
        ...
        # pd_op.hardswish: (128x720x7x7xf32) <- (128x720x7x7xf32)
        hardswish_15 = paddle._C_ops.hardswish(batch_norm__228)

        # pd_op.depthwise_conv2d: (128x720x7x7xf32) <- (128x720x7x7xf32, 720x1x5x5xf32)
        ...
        # pd_op.pool2d: (128x720x1x1xf32) <- (128x720x7x7xf32, 2xi64)
        ...
        # pd_op.conv2d: (128x180x1x1xf32) <- (128x720x1x1xf32, 180x720x1x1xf32)
        ...
        # pd_op.add: (128x180x1x1xf32) <- (128x180x1x1xf32, 1x180x1x1xf32)
        add_23 = paddle._C_ops.add(conv2d_40, reshape_12)

        # pd_op.relu: (128x180x1x1xf32) <- (128x180x1x1xf32)
        relu_18 = paddle._C_ops.relu(add_23)

        # pd_op.conv2d: (128x720x1x1xf32) <- (128x180x1x1xf32, 720x180x1x1xf32)
        ...
        # pd_op.add: (128x720x1x1xf32) <- (128x720x1x1xf32, 1x720x1x1xf32)
        add_24 = paddle._C_ops.add(conv2d_41, reshape_13)

        # pd_op.hardsigmoid: (128x720x1x1xf32) <- (128x720x1x1xf32)
        hardsigmoid_6 = paddle._C_ops.hardsigmoid(add_24, float("0.2"), float("0.5"))

        # pd_op.multiply: (128x720x7x7xf32) <- (128x720x7x7xf32, 128x720x1x1xf32)
        multiply_6 = paddle._C_ops.multiply(hardswish_16, hardsigmoid_6)

        # pd_op.conv2d: (128x120x7x7xf32) <- (128x720x7x7xf32, 120x720x1x1xf32)
        ...
        # pd_op.add: (128x120x7x7xf32) <- (128x120x7x7xf32, 128x120x7x7xf32)
        ...
        # pd_op.conv2d: (128x1280x1x1xf32) <- (128x720x1x1xf32, 1280x720x1x1xf32)
