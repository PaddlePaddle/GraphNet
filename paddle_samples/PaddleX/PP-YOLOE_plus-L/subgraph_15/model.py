...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.pool2d: (8x768x1x1xf32) <- (8x768x-1x-1xf32, 2xi64)
        ...
        # pd_op.sigmoid: (8x768x1x1xf32) <- (8x768x1x1xf32)
        sigmoid_0 = paddle._C_ops.sigmoid(add_0)
        del add_0

        # pd_op.multiply: (8x768x-1x-1xf32) <- (8x768x-1x-1xf32, 8x768x1x1xf32)
        multiply_0 = paddle._C_ops.multiply(data_6, sigmoid_0)

        # pd_op.conv2d: (8x768x-1x-1xf32) <- (8x768x-1x-1xf32, 768x768x1x1xf32)
        conv2d_1 = paddle._C_ops.conv2d(
            multiply_0, parameter_51, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_51

        # pd_op.batch_norm_: (8x768x-1x-1xf32, 768xf32, 768xf32, 768xf32, 768xf32, -1xui8) <- (8x768x-1x-1xf32, 768xf32, 768xf32, 768xf32, 768xf32)
        (
            batch_norm__0,
            batch_norm__1,
            batch_norm__2,
        ...
        # pd_op.swish: (8x768x-1x-1xf32) <- (8x768x-1x-1xf32)
        swish_0 = paddle._C_ops.swish(batch_norm__0)

        # pd_op.add: (8x768x-1x-1xf32) <- (8x768x-1x-1xf32, 8x768x-1x-1xf32)
        add_1 = paddle._C_ops.add(swish_0, data_6)

        # pd_op.conv2d: (8x4x-1x-1xf32) <- (8x768x-1x-1xf32, 4x768x3x3xf32)
        ...
        # pd_op.conv2d: (8x68x-1x-1xf32) <- (8x768x-1x-1xf32, 68x768x3x3xf32)
