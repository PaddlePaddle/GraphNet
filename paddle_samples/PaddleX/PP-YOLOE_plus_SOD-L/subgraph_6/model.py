...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        # pd_op.cast: (2x3549xi32) <- (2x3549xb)
        ...
        # pd_op.unsqueeze: (2x3549x1xi32) <- (2x3549xi32, 1xi64)
        ...
        # pd_op.sum: (2x3549xf32) <- (2x3549x10xf32, 1xi64)
        sum_0 = paddle._C_ops.sum(data_3, full_int_array_0, None, False)
        del data_3

        # pd_op.masked_select: (-1xf32) <- (2x3549xf32, 2x3549xb)
        ...
        # pd_op.unsqueeze: (2x3549x1xb) <- (2x3549xb, 1xi64)
        unsqueeze_2 = paddle._C_ops.unsqueeze(data_0, full_int_array_0)
        del data_0

        # pd_op.cast: (2x3549x1xi32) <- (2x3549x1xb)
        ...
        # pd_op.tile: (2x3549x40xi32) <- (2x3549x1xi32, 3xi64)
        tile_1 = paddle._C_ops.tile(cast_2, full_int_array_4)
        del cast_2, full_int_array_4

        # pd_op.cast: (2x3549x40xb) <- (2x3549x40xi32)
        ...
        # pd_op.split_with_num: ([2x3549x2xf32, 2x3549x2xf32]) <- (2x3549x4xf32, 1xi32)
        split_with_num_2 = paddle._C_ops.split_with_num(data_2, 2, full_5)
        del data_2, full_5

        # builtin.split: (2x3549x2xf32, 2x3549x2xf32) <- ([2x3549x2xf32, 2x3549x2xf32])
        (
            split_8,
            split_9,
        ) = split_with_num_2
        ...
        # pd_op.subtract: (2x3549x2xf32) <- (2x3549x2xf32, 3549x2xf32)
        ...
        # builtin.combine: ([2x3549x2xf32, 2x3549x2xf32]) <- (2x3549x2xf32, 2x3549x2xf32)
        combine_0 = [subtract_12, subtract_13]
        del subtract_12, subtract_13

        # pd_op.concat: (2x3549x4xf32) <- ([2x3549x2xf32, 2x3549x2xf32], 1xi32)
        ...
        # pd_op.clip: (2x3549x4xf32) <- (2x3549x4xf32, 1xf32, 1xf32)
        clip_2 = paddle._C_ops.clip(concat_0, full_7, full_8)
        del concat_0, full_7, full_8
        ...
        # pd_op.scale: (-1x4xi64) <- (-1x4xi64, 1xf32)
        scale_7 = paddle._C_ops.scale(scale_4, full_3, float("2"), True)
        del scale_4
