...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3):
        ...
        # pd_op.gather: (512x4xf32) <- (1001x4xf32, 512xi32, 1xi32)
        gather_0 = paddle._C_ops.gather(data_1, data_0, full_0)
        del data_1

        # pd_op.gather: (512xi64) <- (1001xi64, 512xi32, 1xi32)
        gather_2 = paddle._C_ops.gather(data_2, data_0, full_0)
        del data_2

        # pd_op.gather: (512x4xf32) <- (1x4xf32, 512xi64, 1xi32)
        gather_1 = paddle._C_ops.gather(data_3, gather_2, full_0)
        del data_3, full_0
