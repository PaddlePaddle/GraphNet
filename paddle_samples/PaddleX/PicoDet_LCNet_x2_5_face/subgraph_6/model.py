...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4):
        ...
        equal_0 = paddle._C_ops.equal(data_1, data_2)
        del data_1, data_2
        ...
        cast_0 = paddle._C_ops.cast(data_4, paddle.float32)
        del data_4
        ...
        # pd_op.scale: (-1x1xf32) <- (-1x1xf32, 1xf32)
        scale_1 = paddle._C_ops.scale(multiply_2, full_3, float("0"), True)
        del multiply_2
        ...
        cast_3 = paddle._C_ops.cast(data_0, paddle.float32)
        del data_0

        # pd_op.divide: (xf32) <- (xf32, xf32)
        divide_0 = paddle._C_ops.divide(sum_0, cast_3)
        del (
            abs_0,
            add_0,
            cast_0,
