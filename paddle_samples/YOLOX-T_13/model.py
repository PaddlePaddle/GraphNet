...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.strided_slice: (8x3x256x256xf32) <- (8x3x512x512xf32, 2xi64, 2xi64, 2xi64)
        ...
        # builtin.combine: ([8x3x256x256xf32, 8x3x256x256xf32, 8x3x256x256xf32, 8x3x256x256xf32]) <- (8x3x256x256xf32, 8x3x256x256xf32, 8x3x256x256xf32, 8x3x256x256xf32)
        combine_0 = [strided_slice_0, strided_slice_2, strided_slice_1, strided_slice_3]

        # pd_op.concat: (8x12x256x256xf32) <- ([8x3x256x256xf32, 8x3x256x256xf32, 8x3x256x256xf32, 8x3x256x256xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_0)

        # pd_op.conv2d: (8x24x256x256xf32) <- (8x12x256x256xf32, 24x12x3x3xf32)
        conv2d_0 = paddle._C_ops.conv2d(
            concat_0, parameter_294, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (8x24x256x256xf32, 24xf32, 24xf32, 24xf32, 24xf32, -1xui8) <- (8x24x256x256xf32, 24xf32, 24xf32, 24xf32, 24xf32)
        (
            batch_norm__0,
            batch_norm__1,
            batch_norm__2,
        ...
        # pd_op.sigmoid: (8x24x256x256xf32) <- (8x24x256x256xf32)
        sigmoid_0 = paddle._C_ops.sigmoid(batch_norm__0)

        # pd_op.multiply: (8x24x256x256xf32) <- (8x24x256x256xf32, 8x24x256x256xf32)
        multiply_0 = paddle._C_ops.multiply(batch_norm__0, sigmoid_0)

        # pd_op.conv2d: (8x48x128x128xf32) <- (8x24x256x256xf32, 48x24x3x3xf32)
        conv2d_1 = paddle._C_ops.conv2d(
            multiply_0, parameter_289, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (8x48x128x128xf32, 48xf32, 48xf32, 48xf32, 48xf32, -1xui8) <- (8x48x128x128xf32, 48xf32, 48xf32, 48xf32, 48xf32)
        (
            batch_norm__6,
            batch_norm__7,
            batch_norm__8,
        ...
        # pd_op.sigmoid: (8x48x128x128xf32) <- (8x48x128x128xf32)
        sigmoid_1 = paddle._C_ops.sigmoid(batch_norm__6)

        # pd_op.multiply: (8x48x128x128xf32) <- (8x48x128x128xf32, 8x48x128x128xf32)
        multiply_1 = paddle._C_ops.multiply(batch_norm__6, sigmoid_1)

        # pd_op.conv2d: (8x24x128x128xf32) <- (8x48x128x128xf32, 24x48x1x1xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            multiply_1, parameter_284, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (8x24x128x128xf32, 24xf32, 24xf32, 24xf32, 24xf32, -1xui8) <- (8x24x128x128xf32, 24xf32, 24xf32, 24xf32, 24xf32)
        (
            batch_norm__12,
            batch_norm__13,
            batch_norm__14,
        ...
        # pd_op.sigmoid: (8x24x128x128xf32) <- (8x24x128x128xf32)
        sigmoid_2 = paddle._C_ops.sigmoid(batch_norm__12)

        # pd_op.multiply: (8x24x128x128xf32) <- (8x24x128x128xf32, 8x24x128x128xf32)
        multiply_2 = paddle._C_ops.multiply(batch_norm__12, sigmoid_2)

        # pd_op.conv2d: (8x24x128x128xf32) <- (8x24x128x128xf32, 24x24x1x1xf32)
        ...
        # pd_op.conv2d: (8x24x128x128xf32) <- (8x24x128x128xf32, 24x24x3x3xf32)
        ...
        # pd_op.add: (8x24x128x128xf32) <- (8x24x128x128xf32, 8x24x128x128xf32)
        ...
        # builtin.combine: ([8x24x128x128xf32, 8x24x128x128xf32]) <- (8x24x128x128xf32, 8x24x128x128xf32)
        combine_1 = [add_0, multiply_5]

        # pd_op.concat: (8x48x128x128xf32) <- ([8x24x128x128xf32, 8x24x128x128xf32], 1xi32)
        concat_1 = paddle._C_ops.concat(combine_1, full_0)

        # pd_op.conv2d: (8x48x128x128xf32) <- (8x48x128x128xf32, 48x48x1x1xf32)
        ...
        # pd_op.conv2d: (8x96x64x64xf32) <- (8x48x128x128xf32, 96x48x3x3xf32)
        conv2d_7 = paddle._C_ops.conv2d(
            multiply_6, parameter_259, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (8x96x64x64xf32, 96xf32, 96xf32, 96xf32, 96xf32, -1xui8) <- (8x96x64x64xf32, 96xf32, 96xf32, 96xf32, 96xf32)
        (
            batch_norm__42,
            batch_norm__43,
            batch_norm__44,
        ...
        # pd_op.sigmoid: (8x96x64x64xf32) <- (8x96x64x64xf32)
        sigmoid_7 = paddle._C_ops.sigmoid(batch_norm__42)

        # pd_op.multiply: (8x96x64x64xf32) <- (8x96x64x64xf32, 8x96x64x64xf32)
        multiply_7 = paddle._C_ops.multiply(batch_norm__42, sigmoid_7)

        # pd_op.conv2d: (8x48x64x64xf32) <- (8x96x64x64xf32, 48x96x1x1xf32)
        conv2d_8 = paddle._C_ops.conv2d(
            multiply_7, parameter_254, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (8x48x64x64xf32, 48xf32, 48xf32, 48xf32, 48xf32, -1xui8) <- (8x48x64x64xf32, 48xf32, 48xf32, 48xf32, 48xf32)
        (
            batch_norm__48,
            batch_norm__49,
            batch_norm__50,
        ...
        # pd_op.sigmoid: (8x48x64x64xf32) <- (8x48x64x64xf32)
        sigmoid_8 = paddle._C_ops.sigmoid(batch_norm__48)

        # pd_op.multiply: (8x48x64x64xf32) <- (8x48x64x64xf32, 8x48x64x64xf32)
        multiply_8 = paddle._C_ops.multiply(batch_norm__48, sigmoid_8)

        # pd_op.conv2d: (8x48x64x64xf32) <- (8x48x64x64xf32, 48x48x1x1xf32)
        ...
        # pd_op.conv2d: (8x48x64x64xf32) <- (8x48x64x64xf32, 48x48x3x3xf32)
        ...
        # pd_op.add: (8x48x64x64xf32) <- (8x48x64x64xf32, 8x48x64x64xf32)
        ...
        # builtin.combine: ([8x48x64x64xf32, 8x48x64x64xf32]) <- (8x48x64x64xf32, 8x48x64x64xf32)
        combine_2 = [add_3, multiply_15]

        # pd_op.concat: (8x96x64x64xf32) <- ([8x48x64x64xf32, 8x48x64x64xf32], 1xi32)
        concat_2 = paddle._C_ops.concat(combine_2, full_0)

        # pd_op.conv2d: (8x96x64x64xf32) <- (8x96x64x64xf32, 96x96x1x1xf32)
        ...
        # pd_op.conv2d: (8x192x32x32xf32) <- (8x96x64x64xf32, 192x96x3x3xf32)
        conv2d_17 = paddle._C_ops.conv2d(
            multiply_16, parameter_209, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (8x192x32x32xf32, 192xf32, 192xf32, 192xf32, 192xf32, -1xui8) <- (8x192x32x32xf32, 192xf32, 192xf32, 192xf32, 192xf32)
        (
            batch_norm__102,
            batch_norm__103,
            batch_norm__104,
        ...
        # pd_op.sigmoid: (8x192x32x32xf32) <- (8x192x32x32xf32)
        sigmoid_17 = paddle._C_ops.sigmoid(batch_norm__102)

        # pd_op.multiply: (8x192x32x32xf32) <- (8x192x32x32xf32, 8x192x32x32xf32)
        multiply_17 = paddle._C_ops.multiply(batch_norm__102, sigmoid_17)

        # pd_op.conv2d: (8x96x32x32xf32) <- (8x192x32x32xf32, 96x192x1x1xf32)
        conv2d_18 = paddle._C_ops.conv2d(
            multiply_17, parameter_204, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (8x96x32x32xf32, 96xf32, 96xf32, 96xf32, 96xf32, -1xui8) <- (8x96x32x32xf32, 96xf32, 96xf32, 96xf32, 96xf32)
        (
            batch_norm__108,
            batch_norm__109,
            batch_norm__110,
        ...
        # pd_op.sigmoid: (8x96x32x32xf32) <- (8x96x32x32xf32)
        sigmoid_18 = paddle._C_ops.sigmoid(batch_norm__108)

        # pd_op.multiply: (8x96x32x32xf32) <- (8x96x32x32xf32, 8x96x32x32xf32)
        multiply_18 = paddle._C_ops.multiply(batch_norm__108, sigmoid_18)

        # pd_op.conv2d: (8x96x32x32xf32) <- (8x96x32x32xf32, 96x96x1x1xf32)
        ...
        # pd_op.conv2d: (8x96x32x32xf32) <- (8x96x32x32xf32, 96x96x3x3xf32)
        ...
        # pd_op.add: (8x96x32x32xf32) <- (8x96x32x32xf32, 8x96x32x32xf32)
        ...
        # builtin.combine: ([8x96x32x32xf32, 8x96x32x32xf32]) <- (8x96x32x32xf32, 8x96x32x32xf32)
        combine_3 = [add_6, multiply_25]

        # pd_op.concat: (8x192x32x32xf32) <- ([8x96x32x32xf32, 8x96x32x32xf32], 1xi32)
        concat_3 = paddle._C_ops.concat(combine_3, full_0)

        # pd_op.conv2d: (8x192x32x32xf32) <- (8x192x32x32xf32, 192x192x1x1xf32)
        ...
        # pd_op.conv2d: (8x384x16x16xf32) <- (8x192x32x32xf32, 384x192x3x3xf32)
        conv2d_27 = paddle._C_ops.conv2d(
            multiply_26, parameter_159, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (8x384x16x16xf32, 384xf32, 384xf32, 384xf32, 384xf32, -1xui8) <- (8x384x16x16xf32, 384xf32, 384xf32, 384xf32, 384xf32)
        (
            batch_norm__162,
            batch_norm__163,
            batch_norm__164,
        ...
        # pd_op.sigmoid: (8x384x16x16xf32) <- (8x384x16x16xf32)
        sigmoid_27 = paddle._C_ops.sigmoid(batch_norm__162)

        # pd_op.multiply: (8x384x16x16xf32) <- (8x384x16x16xf32, 8x384x16x16xf32)
        multiply_27 = paddle._C_ops.multiply(batch_norm__162, sigmoid_27)

        # pd_op.conv2d: (8x192x16x16xf32) <- (8x384x16x16xf32, 192x384x1x1xf32)
        conv2d_28 = paddle._C_ops.conv2d(
            multiply_27, parameter_154, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (8x192x16x16xf32, 192xf32, 192xf32, 192xf32, 192xf32, -1xui8) <- (8x192x16x16xf32, 192xf32, 192xf32, 192xf32, 192xf32)
        (
            batch_norm__168,
            batch_norm__169,
            batch_norm__170,
        ...
        # pd_op.sigmoid: (8x192x16x16xf32) <- (8x192x16x16xf32)
        sigmoid_28 = paddle._C_ops.sigmoid(batch_norm__168)

        # pd_op.multiply: (8x192x16x16xf32) <- (8x192x16x16xf32, 8x192x16x16xf32)
        multiply_28 = paddle._C_ops.multiply(batch_norm__168, sigmoid_28)

        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_0 = [5, 5]

        # pd_op.pool2d: (8x192x16x16xf32) <- (8x192x16x16xf32, 2xi64)
        ...
        # builtin.combine: ([8x192x16x16xf32, 8x192x16x16xf32, 8x192x16x16xf32, 8x192x16x16xf32]) <- (8x192x16x16xf32, 8x192x16x16xf32, 8x192x16x16xf32, 8x192x16x16xf32)
        combine_4 = [multiply_28, pool2d_0, pool2d_1, pool2d_2]

        # pd_op.concat: (8x768x16x16xf32) <- ([8x192x16x16xf32, 8x192x16x16xf32, 8x192x16x16xf32, 8x192x16x16xf32], 1xi32)
        concat_4 = paddle._C_ops.concat(combine_4, full_0)

        # pd_op.conv2d: (8x384x16x16xf32) <- (8x768x16x16xf32, 384x768x1x1xf32)
        ...
        # pd_op.conv2d: (8x192x16x16xf32) <- (8x192x16x16xf32, 192x192x1x1xf32)
        ...
        # pd_op.conv2d: (8x192x16x16xf32) <- (8x192x16x16xf32, 192x192x3x3xf32)
        ...
        # builtin.combine: ([8x192x16x16xf32, 8x192x16x16xf32]) <- (8x192x16x16xf32, 8x192x16x16xf32)
        combine_5 = [multiply_32, multiply_33]

        # pd_op.concat: (8x384x16x16xf32) <- ([8x192x16x16xf32, 8x192x16x16xf32], 1xi32)
        concat_5 = paddle._C_ops.concat(combine_5, full_0)

        # pd_op.conv2d: (8x384x16x16xf32) <- (8x384x16x16xf32, 384x384x1x1xf32)
        ...
        # pd_op.nearest_interp: (8x192x32x32xf32) <- (8x192x16x16xf32, None, None, None)
        ...
        # builtin.combine: ([8x192x32x32xf32, 8x192x32x32xf32]) <- (8x192x32x32xf32, 8x192x32x32xf32)
        combine_6 = [nearest_interp_0, multiply_26]

        # pd_op.concat: (8x384x32x32xf32) <- ([8x192x32x32xf32, 8x192x32x32xf32], 1xi32)
        concat_6 = paddle._C_ops.concat(combine_6, full_0)

        # pd_op.conv2d: (8x96x32x32xf32) <- (8x384x32x32xf32, 96x384x1x1xf32)
        ...
        # pd_op.nearest_interp: (8x96x64x64xf32) <- (8x96x32x32xf32, None, None, None)
        ...
        # builtin.combine: ([8x96x64x64xf32, 8x96x64x64xf32]) <- (8x96x64x64xf32, 8x96x64x64xf32)
        combine_8 = [nearest_interp_1, multiply_16]

        # pd_op.concat: (8x192x64x64xf32) <- ([8x96x64x64xf32, 8x96x64x64xf32], 1xi32)
        concat_8 = paddle._C_ops.concat(combine_8, full_0)

        # pd_op.conv2d: (8x48x64x64xf32) <- (8x192x64x64xf32, 48x192x1x1xf32)
        ...
        # pd_op.conv2d: (8x96x32x32xf32) <- (8x96x64x64xf32, 96x96x3x3xf32)
        ...
        # pd_op.conv2d: (8x192x16x16xf32) <- (8x192x32x32xf32, 192x192x3x3xf32)
