...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5):
        ...
        # pd_op.equal: (xb) <- (xi64, xi64)
        equal_1 = paddle._C_ops.equal(data_1, full_0)
        del data_1

        # pd_op.cast: (xi64) <- (xb)
        cast_1 = paddle._C_ops.cast(equal_1, paddle.int64)
        del equal_1
        ...
        # pd_op.equal: (xb) <- (xi64, xi64)
        equal_2 = paddle._C_ops.equal(cast_2, full_0)
        del cast_2
        ...
        # pd_op.tile: (-1x-1xf32) <- (-1x1xf32, 2xi64)
        ...
        # pd_op.subtract: (-1x-1xf32) <- (-1x-1xf32, -1xf32)
        subtract_0 = paddle._C_ops.subtract(tile_0, slice_5)

        # pd_op.slice: (-1xf32) <- (-1x4xf32, 1xi64, 1xi64)
        slice_6 = paddle._C_ops.slice(
            data_5, [1], full_int_array_1, full_int_array_2, [1], [1]
        )
        ...
        slice_7 = paddle._C_ops.slice(
            data_5, [1], full_int_array_2, full_int_array_3, [1], [1]
        )
        ...
        slice_8 = paddle._C_ops.slice(
            data_5, [1], full_int_array_3, full_int_array_4, [1], [1]
        )
        del data_5, full_int_array_3, full_int_array_4
        ...
        # pd_op.min: (-1x-1xf32) <- (-1x4x-1xf32, 1xi64)
        ...
        # pd_op.cast: (-1x-1xi64) <- (-1x-1xb)
        cast_3 = paddle._C_ops.cast(greater_than_0, paddle.int64)
        del greater_than_0
        ...
        # pd_op.gather: (-1x-1xi64) <- (-1x-1xi64, -1xi64, 1xi32)
        gather_0 = paddle._C_ops.gather(cast_3, squeeze_0, full_5)
        del cast_3

        # pd_op.cast: (-1x-1xb) <- (-1x-1xi64)
        cast_4 = paddle._C_ops.cast(gather_0, paddle.bool)
        del gather_0
        ...
        # pd_op.gather: (-1x-1xi64) <- (-1x-1xi64, -1xi64, 1xi32)
        gather_1 = paddle._C_ops.gather(cast_5, squeeze_0, full_5)
        del cast_5, full_5

        # pd_op.cast: (-1x-1xb) <- (-1x-1xi64)
        cast_6 = paddle._C_ops.cast(gather_1, paddle.bool)
        del gather_1

        # pd_op.logical_and: (-1x-1xb) <- (-1x-1xb, -1x-1xb)
        logical_and_0 = paddle._C_ops.logical_and(cast_4, cast_6)
        del cast_4, cast_6
        ...
        # pd_op.gather_nd: (-1x4xf32) <- (-1x4xf32, -1x1xi64)
        gather_nd_1 = paddle._C_ops.gather_nd(data_4, unsqueeze_4)
        del data_4

        # pd_op.gather_nd: (-1x1xf32) <- (-1x1xf32, -1x1xi64)
        gather_nd_0 = paddle._C_ops.gather_nd(data_2, unsqueeze_4)
        del data_2, unsqueeze_4
