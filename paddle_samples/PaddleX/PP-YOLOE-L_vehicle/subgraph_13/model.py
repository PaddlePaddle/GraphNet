...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.pool2d: (2x768x1x1xf32) <- (2x768x16x16xf32, 2xi64)
        ...
        # pd_op.sigmoid: (2x768x1x1xf32) <- (2x768x1x1xf32)
        ...
        # pd_op.add: (2x768x16x16xf32) <- (2x768x16x16xf32, 2x768x16x16xf32)
        add_1 = paddle._C_ops.add(swish_0, data_0)

        # pd_op.conv2d: (2x4x16x16xf32) <- (2x768x16x16xf32, 4x768x3x3xf32)
        ...
        # pd_op.add: (2x4x16x16xf32) <- (2x4x16x16xf32, 1x4x1x1xf32)
        ...
        # pd_op.conv2d: (2x68x16x16xf32) <- (2x768x16x16xf32, 68x768x3x3xf32)
        ...
        # pd_op.sigmoid: (2x4x16x16xf32) <- (2x4x16x16xf32)
        sigmoid_2 = paddle._C_ops.sigmoid(add_2)
        del add_2

        # pd_op.flatten: (2x4x256xf32) <- (2x4x16x16xf32)
        flatten_0 = paddle._C_ops.flatten(sigmoid_2, 2, 3)

        # pd_op.transpose: (2x256x4xf32) <- (2x4x256xf32)
        ...
        # pd_op.pool2d: (2x384x1x1xf32) <- (2x384x32x32xf32, 2xi64)
        ...
        # pd_op.add: (2x384x32x32xf32) <- (2x384x32x32xf32, 2x384x32x32xf32)
        add_6 = paddle._C_ops.add(swish_2, data_1)

        # pd_op.conv2d: (2x4x32x32xf32) <- (2x384x32x32xf32, 4x384x3x3xf32)
        ...
        # pd_op.add: (2x4x32x32xf32) <- (2x4x32x32xf32, 1x4x1x1xf32)
        ...
        # pd_op.conv2d: (2x68x32x32xf32) <- (2x384x32x32xf32, 68x384x3x3xf32)
        ...
        # pd_op.sigmoid: (2x4x32x32xf32) <- (2x4x32x32xf32)
        sigmoid_5 = paddle._C_ops.sigmoid(add_7)
        del add_7

        # pd_op.flatten: (2x4x1024xf32) <- (2x4x32x32xf32)
        flatten_2 = paddle._C_ops.flatten(sigmoid_5, 2, 3)

        # pd_op.transpose: (2x1024x4xf32) <- (2x4x1024xf32)
        ...
        # pd_op.pool2d: (2x192x1x1xf32) <- (2x192x64x64xf32, 2xi64)
        ...
        # pd_op.add: (2x192x64x64xf32) <- (2x192x64x64xf32, 2x192x64x64xf32)
        add_11 = paddle._C_ops.add(swish_4, data_2)

        # pd_op.conv2d: (2x4x64x64xf32) <- (2x192x64x64xf32, 4x192x3x3xf32)
        ...
        # pd_op.add: (2x4x64x64xf32) <- (2x4x64x64xf32, 1x4x1x1xf32)
        ...
        # pd_op.conv2d: (2x68x64x64xf32) <- (2x192x64x64xf32, 68x192x3x3xf32)
        ...
        # pd_op.sigmoid: (2x4x64x64xf32) <- (2x4x64x64xf32)
        sigmoid_8 = paddle._C_ops.sigmoid(add_12)
        del add_12

        # pd_op.flatten: (2x4x4096xf32) <- (2x4x64x64xf32)
        flatten_4 = paddle._C_ops.flatten(sigmoid_8, 2, 3)

        # pd_op.transpose: (2x4096x4xf32) <- (2x4x4096xf32)
        ...
        # builtin.combine: ([2x256x4xf32, 2x1024x4xf32, 2x4096x4xf32]) <- (2x256x4xf32, 2x1024x4xf32, 2x4096x4xf32)
        combine_12 = [transpose_0, transpose_2, transpose_4]

        # pd_op.concat: (2x5376x4xf32) <- ([2x256x4xf32, 2x1024x4xf32, 2x4096x4xf32], 1xi32)
