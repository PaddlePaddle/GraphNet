...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        argmax_0 = paddle._C_ops.argmax(data_4, full_2, False, False, paddle.int64)

        # pd_op.one_hot: (2x-1x-1xf32) <- (2x-1xi64, xi64)
        one_hot_0 = paddle._C_ops.one_hot(
            argmax_0 % paddle.cast(data_2, argmax_0.dtype), data_2
        )
        del argmax_0, data_2
        ...
        where_0 = paddle._C_ops.where(tile_0, transpose_0, data_5)
        del data_5, tile_0, transpose_0
        ...
        multiply_1 = paddle._C_ops.multiply(data_6, cast_0)
        del cast_0, data_6
        ...
        flatten_0 = paddle._C_ops.flatten(data_7, 0, 2)
        del data_7
        ...
        reshape_2 = paddle._C_ops.reshape(data_8, full_int_array_2)
        del data_8, full_int_array_2
        ...
        # pd_op.one_hot: (2x-1x2xf32) <- (2x-1xi32, 1xi32)
        ...
        # pd_op.index_select: (2x-1x1xf32) <- (2x-1x2xf32, 1xi64)
        ...
        multiply_2 = paddle._C_ops.multiply(data_9, where_0)
        del data_9
        ...
        # pd_op.multiply: (2x-1x-1xf32) <- (2x-1x-1xf32, 2x-1x-1xf32)
        multiply_3 = paddle._C_ops.multiply(data_4, where_0)
        del data_4, where_0
        ...
        unsqueeze_1 = paddle._C_ops.unsqueeze(max_2, full_int_array_3)
        del full_int_array_3, max_2

        # pd_op.multiply: (2x-1x1xf32) <- (2x-1x1xf32, 2x-1x1xf32)
