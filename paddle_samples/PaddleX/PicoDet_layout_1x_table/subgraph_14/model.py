...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0):
        ...
        # pd_op.slice: (24x7600xf32) <- (24x10105xf32, 1xi64, 1xi64)
        slice_0 = paddle._C_ops.slice(
            data_0, [1], full_int_array_0, full_int_array_1, [1], []
        )

        # pd_op.squeeze: (24x7600xf32) <- (24x7600xf32, 1xi64)
        ...
        # pd_op.slice: (24x1900xf32) <- (24x10105xf32, 1xi64, 1xi64)
        slice_1 = paddle._C_ops.slice(
            data_0, [1], full_int_array_1, full_int_array_2, [1], []
        )
        del full_int_array_1

        # pd_op.squeeze: (24x1900xf32) <- (24x1900xf32, 1xi64)
        ...
        # pd_op.slice: (24x475xf32) <- (24x10105xf32, 1xi64, 1xi64)
        slice_2 = paddle._C_ops.slice(
            data_0, [1], full_int_array_2, full_int_array_3, [1], []
        )
        del full_int_array_2

        # pd_op.squeeze: (24x475xf32) <- (24x475xf32, 1xi64)
