...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        # pd_op.cast: (5648x1xf32) <- (5648x1xf64)
        ...
        # pd_op.scale: (5648x1xf32) <- (5648x1xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(pow_0, full_1, float("0"), True)
        del full_1, pow_0

        # pd_op.less_equal: (5648x1xb) <- (5648x1xf32, xf32)
        ...
        # pd_op.add: (5648x1xf32) <- (5648x1xf32, 5648x1xf32)
        add_0 = paddle._C_ops.add(multiply_0, multiply_1)
        del multiply_0, multiply_1

        # pd_op.bce_loss: (5648x1xf32) <- (5648x1xf32, 5648x1xf32)
        ...
        # pd_op.sum: (5648xf32) <- (5648x1xf32, 1xi64)
