...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3):
        ...
        unsqueeze_0 = paddle._C_ops.unsqueeze(data_0, full_int_array_1)
        ...
        sum_0 = paddle._C_ops.sum(masked_select_0, full_int_array_0, None, False)
        ...
        sum_1 = paddle._C_ops.sum(cast_0, full_int_array_0, None, False)
