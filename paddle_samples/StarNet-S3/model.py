...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        conv2d_8 = paddle._C_ops.conv2d(
            add_14, parameter_275, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_11 = paddle._C_ops.conv2d(
            multiply_2, parameter_259, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        depthwise_conv2d_6 = paddle._C_ops.depthwise_conv2d(
            add_21, parameter_251, [1, 1], [3, 3], "EXPLICIT", 64, [1, 1], "NCHW"
        )
        ...
        conv2d_14 = paddle._C_ops.conv2d(
            multiply_3, parameter_241, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_15 = paddle._C_ops.conv2d(
            add_27, parameter_233, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_18 = paddle._C_ops.conv2d(
            multiply_4, parameter_217, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        depthwise_conv2d_10 = paddle._C_ops.depthwise_conv2d(
            add_34, parameter_209, [1, 1], [3, 3], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        ...
        conv2d_21 = paddle._C_ops.conv2d(
            multiply_5, parameter_199, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        depthwise_conv2d_12 = paddle._C_ops.depthwise_conv2d(
            add_40, parameter_191, [1, 1], [3, 3], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        ...
        conv2d_24 = paddle._C_ops.conv2d(
            multiply_6, parameter_181, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        depthwise_conv2d_14 = paddle._C_ops.depthwise_conv2d(
            add_46, parameter_173, [1, 1], [3, 3], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        ...
        conv2d_27 = paddle._C_ops.conv2d(
            multiply_7, parameter_163, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        depthwise_conv2d_16 = paddle._C_ops.depthwise_conv2d(
            add_52, parameter_155, [1, 1], [3, 3], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        ...
        conv2d_30 = paddle._C_ops.conv2d(
            multiply_8, parameter_145, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        depthwise_conv2d_18 = paddle._C_ops.depthwise_conv2d(
            add_58, parameter_137, [1, 1], [3, 3], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        ...
        conv2d_33 = paddle._C_ops.conv2d(
            multiply_9, parameter_127, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        depthwise_conv2d_20 = paddle._C_ops.depthwise_conv2d(
            add_64, parameter_119, [1, 1], [3, 3], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        ...
        conv2d_36 = paddle._C_ops.conv2d(
            multiply_10, parameter_109, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        depthwise_conv2d_22 = paddle._C_ops.depthwise_conv2d(
            add_70, parameter_101, [1, 1], [3, 3], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        ...
        conv2d_40 = paddle._C_ops.conv2d(
            add_76, parameter_83, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_43 = paddle._C_ops.conv2d(
            multiply_12, parameter_67, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        depthwise_conv2d_26 = paddle._C_ops.depthwise_conv2d(
            add_83, parameter_59, [1, 1], [3, 3], "EXPLICIT", 256, [1, 1], "NCHW"
        )
        ...
        conv2d_46 = paddle._C_ops.conv2d(
            multiply_13, parameter_49, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        depthwise_conv2d_28 = paddle._C_ops.depthwise_conv2d(
            add_89, parameter_41, [1, 1], [3, 3], "EXPLICIT", 256, [1, 1], "NCHW"
        )
        ...
        conv2d_49 = paddle._C_ops.conv2d(
            multiply_14, parameter_31, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        depthwise_conv2d_30 = paddle._C_ops.depthwise_conv2d(
            add_95, parameter_23, [1, 1], [3, 3], "EXPLICIT", 256, [1, 1], "NCHW"
        )
        ...
        # pd_op.add: (-1x256x7x7xf32) <- (-1x256x7x7xf32, 1x256x1x1xf32)
        add_96 = paddle._C_ops.add(depthwise_conv2d_30, reshape_80)
        ...
        # pd_op.relu6: (-1x1024x7x7xf32) <- (-1x1024x7x7xf32)
        relu6_16 = paddle._C_ops.relu6(add_97)

        # pd_op.multiply: (-1x1024x7x7xf32) <- (-1x1024x7x7xf32, -1x1024x7x7xf32)
        multiply_15 = paddle._C_ops.multiply(relu6_16, add_98)

        # pd_op.conv2d: (-1x256x7x7xf32) <- (-1x1024x7x7xf32, 256x1024x1x1xf32)
        conv2d_52 = paddle._C_ops.conv2d(
            multiply_15, parameter_13, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.add: (-1x256x7x7xf32) <- (-1x256x7x7xf32, 1x256x1x1xf32)
        add_99 = paddle._C_ops.add(conv2d_52, reshape_83)
        ...
        # pd_op.add: (-1x256x7x7xf32) <- (-1x256x7x7xf32, 1x256x1x1xf32)
        add_100 = paddle._C_ops.add(depthwise_conv2d_31, reshape_84)

        # pd_op.add: (-1x256x7x7xf32) <- (-1x256x7x7xf32, -1x256x7x7xf32)
        add_101 = paddle._C_ops.add(add_95, add_100)
