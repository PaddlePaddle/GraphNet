    ...
    def forward(
        ...
        (
            ...
            paddle._C_ops.distribute_fpn_proposals(
                concat_1, data_2, 2, 5, 4, 224, False
            ),
        ...
        # pd_op.roi_align: (-1x256x7x7xf32) <- (2x256x248x184xf32, -1x4xf32, -1xi32)
        roi_align_0 = paddle._C_ops.roi_align(
            data_3, split_0, split_4, 7, 7, float("0.25"), 0, True
        )

        # pd_op.roi_align: (-1x256x7x7xf32) <- (2x256x124x92xf32, -1x4xf32, -1xi32)
        roi_align_1 = paddle._C_ops.roi_align(
            data_4, split_1, split_5, 7, 7, float("0.125"), 0, True
        )

        # pd_op.roi_align: (-1x256x7x7xf32) <- (2x256x62x46xf32, -1x4xf32, -1xi32)
        roi_align_2 = paddle._C_ops.roi_align(
            data_5, split_2, split_6, 7, 7, float("0.0625"), 0, True
        )

        # pd_op.roi_align: (-1x256x7x7xf32) <- (2x256x31x23xf32, -1x4xf32, -1xi32)
        roi_align_3 = paddle._C_ops.roi_align(
            data_6, split_3, split_7, 7, 7, float("0.03125"), 0, True
        )
