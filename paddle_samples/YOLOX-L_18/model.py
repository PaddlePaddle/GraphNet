...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2):
        ...
        # pd_op.add: (4x6069x2xf32) <- (4x6069x2xf32, 6069x2xf32)
        add_0 = paddle._C_ops.add(split_0, divide_0)

        # pd_op.exp: (4x6069x2xf32) <- (4x6069x2xf32)
        ...
        # pd_op.scale: (4x6069x2xf32) <- (4x6069x2xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(exp_0, full_1, float("0"), True)

        # pd_op.subtract: (4x6069x2xf32) <- (4x6069x2xf32, 4x6069x2xf32)
        subtract_0 = paddle._C_ops.subtract(add_0, scale_0)

        # pd_op.add: (4x6069x2xf32) <- (4x6069x2xf32, 4x6069x2xf32)
