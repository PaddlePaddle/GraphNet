...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        reshape_0 = paddle._C_ops.reshape(parameter_159, full_int_array_2)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_69 = [slice_74, full_29, full_29, full_17]
        ...
        # builtin.combine: ([xi64, xi64, xi64]) <- (xi64, xi64, xi64)
        combine_71 = [slice_73, full_16, full_39]
        ...
        # pd_op.shape64: (3xi64) <- (-1x-1x768xf32)
        shape64_46 = paddle._C_ops.shape64(matmul_62)

        # pd_op.slice: (xi64) <- (3xi64, 1xi64, 1xi64)
        slice_76 = paddle._C_ops.slice(
            shape64_46, [0], full_int_array_1, full_int_array_5, [1], [0]
        )
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_72 = [slice_75, full_3, full_3, full_28]
        ...
        shape64_47 = paddle._C_ops.shape64(reshape_155)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64, xi64, xi64)
        combine_73 = [slice_77, full_40, full_3, full_40, full_3, full_28]
        ...
        shape64_48 = paddle._C_ops.shape64(reshape_158)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64, xi64)
        combine_74 = [slice_78, full_4, full_5, full_41, full_6]
        ...
        scale_10 = paddle._C_ops.scale(slice_79, full_7, float("0"), True)

        # pd_op.transpose: (-1x24x32x49xf32) <- (-1x24x49x32xf32)
        transpose_68 = paddle._C_ops.transpose(slice_80, [0, 1, 3, 2])
        ...
        # pd_op.reshape: (2401xi64) <- (49x49xi64, 1xi64)
        reshape_160 = paddle._C_ops.reshape(data_21, full_int_array_7)

        # pd_op.index_select: (2401x24xf32) <- (169x24xf32, 2401xi64)
        index_select_10 = paddle._C_ops.index_select(data_22, reshape_160, 0)
        ...
        # builtin.combine: ([xi64, xi64, xi64]) <- (xi64, xi64, xi64)
        combine_76 = [slice_75, full_4, full_28]
        ...
        # pd_op.shape64: (3xi64) <- (-1x49x768xf32)
        shape64_49 = paddle._C_ops.shape64(add_83)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_77 = [slice_82, full_3, full_3, full_28]
        ...
        # pd_op.shape64: (4xi64) <- (-1x7x7x768xf32)
        shape64_50 = paddle._C_ops.shape64(reshape_167)
        ...
        # pd_op.shape64: (4xi64) <- (-1x7x7x768xf32)
        shape64_51 = paddle._C_ops.shape64(roll_10)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64, xi64, xi64)
        combine_78 = [slice_84, full_40, full_3, full_40, full_3, full_28]
        ...
        reshape_171 = paddle._C_ops.reshape(set_value__5, full_int_array_46)
        ...
        unsqueeze_31 = paddle._C_ops.unsqueeze(reshape_173, full_int_array_1)
        ...
        # pd_op.shape64: (3xi64) <- (-1x49x768xf32)
        shape64_52 = paddle._C_ops.shape64(reshape_170)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64, xi64)
        combine_79 = [slice_85, full_4, full_5, full_41, full_6]
        ...
        # pd_op.scale: (-1x24x49x32xf32) <- (-1x24x49x32xf32, 1xf32)
        scale_11 = paddle._C_ops.scale(slice_86, full_7, float("0"), True)

        # pd_op.transpose: (-1x24x32x49xf32) <- (-1x24x49x32xf32)
        transpose_75 = paddle._C_ops.transpose(slice_87, [0, 1, 3, 2])

        # pd_op.matmul: (-1x24x49x49xf32) <- (-1x24x49x32xf32, -1x24x32x49xf32)
        matmul_70 = paddle._C_ops.matmul(scale_11, transpose_75, False, False)

        # pd_op.reshape: (2401xi64) <- (49x49xi64, 1xi64)
        reshape_175 = paddle._C_ops.reshape(data_23, full_int_array_7)

        # pd_op.index_select: (2401x24xf32) <- (169x24xf32, 2401xi64)
        index_select_11 = paddle._C_ops.index_select(data_24, reshape_175, 0)
        ...
        # pd_op.floor_divide: (xi64) <- (xi64, xi64)
        floor_divide_5 = paddle._C_ops.floor_divide(slice_85, full_45)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_81 = [slice_85, full_41, full_4, full_4]
        ...
        # pd_op.matmul: (-1x24x49x32xf32) <- (-1x24x49x49xf32, -1x24x49x32xf32)
        matmul_71 = paddle._C_ops.matmul(softmax_11, slice_88, False, False)

        # pd_op.transpose: (-1x49x24x32xf32) <- (-1x24x49x32xf32)
        transpose_77 = paddle._C_ops.transpose(matmul_71, [0, 2, 1, 3])

        # builtin.combine: ([xi64, xi64, xi64]) <- (xi64, xi64, xi64)
        combine_82 = [slice_85, full_4, full_28]
        ...
        # builtin.combine: ([xi64, xi64, xi64]) <- (xi64, xi64, xi64)
        combine_83 = [slice_82, full_4, full_28]
