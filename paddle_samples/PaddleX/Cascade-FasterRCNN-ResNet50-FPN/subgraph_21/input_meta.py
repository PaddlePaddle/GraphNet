class Program_weight_tensor_data_0:
    ...
    shape = [1, 256, 304, 200]
    dtype = "float32"
    min_val = float("-7.55462")
    max_val = float("7.37716")
    mean = float("0.0400759")
    std = float("1.11023")
    data = None
...
class Program_weight_tensor_data_1:
    ...
    shape = [1, 256, 152, 100]
    dtype = "float32"
    min_val = float("-6.80274")
    max_val = float("6.31504")
    mean = float("0.0489988")
    std = float("0.956432")
    data = None
...
class Program_weight_tensor_data_2:
    ...
    shape = [1, 256, 76, 50]
    dtype = "float32"
    min_val = float("-7.58168")
    max_val = float("5.78745")
    mean = float("0.0514856")
    std = float("0.904097")
    data = None
...
class Program_weight_tensor_data_3:
    ...
    shape = [1, 256, 38, 25]
    dtype = "float32"
    min_val = float("-5.99726")
    max_val = float("5.65376")
    mean = float("0.0319835")
    std = float("0.855679")
    data = None
...
class Program_weight_tensor_data_4:
    ...
    shape = [1, 256, 19, 13]
    dtype = "float32"
    min_val = float("-5.37711")
    max_val = float("5.24342")
    mean = float("0.0336284")
    std = float("0.86011")
    data = None
