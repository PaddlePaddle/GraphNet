...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (1x256x168x256xf32) <- (1x256x168x256xf32, 256x256x3x3xf32)
        ...
        # pd_op.add: (1x256x168x256xf32) <- (1x256x168x256xf32, 1x256x1x1xf32)
        add_10 = paddle._C_ops.add(conv2d_0, reshape_0)

        # pd_op.relu: (1x256x168x256xf32) <- (1x256x168x256xf32)
        relu_0 = paddle._C_ops.relu(add_10)

        # pd_op.conv2d: (1x256x84x128xf32) <- (1x256x84x128xf32, 256x256x3x3xf32)
        conv2d_1 = paddle._C_ops.conv2d(
            data_6, parameter_5, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.add: (1x256x84x128xf32) <- (1x256x84x128xf32, 1x256x1x1xf32)
        add_11 = paddle._C_ops.add(conv2d_1, reshape_0)

        # pd_op.relu: (1x256x84x128xf32) <- (1x256x84x128xf32)
        relu_1 = paddle._C_ops.relu(add_11)

        # pd_op.conv2d: (1x256x42x64xf32) <- (1x256x42x64xf32, 256x256x3x3xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            data_7, parameter_5, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.add: (1x256x42x64xf32) <- (1x256x42x64xf32, 1x256x1x1xf32)
        add_12 = paddle._C_ops.add(conv2d_2, reshape_0)

        # pd_op.relu: (1x256x42x64xf32) <- (1x256x42x64xf32)
        relu_2 = paddle._C_ops.relu(add_12)

        # pd_op.conv2d: (1x256x21x32xf32) <- (1x256x21x32xf32, 256x256x3x3xf32)
        conv2d_3 = paddle._C_ops.conv2d(
            data_8, parameter_5, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.add: (1x256x21x32xf32) <- (1x256x21x32xf32, 1x256x1x1xf32)
        add_13 = paddle._C_ops.add(conv2d_3, reshape_0)

        # pd_op.relu: (1x256x21x32xf32) <- (1x256x21x32xf32)
        relu_3 = paddle._C_ops.relu(add_13)

        # pd_op.conv2d: (1x256x11x16xf32) <- (1x256x11x16xf32, 256x256x3x3xf32)
        conv2d_4 = paddle._C_ops.conv2d(
            data_9, parameter_5, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.add: (1x256x11x16xf32) <- (1x256x11x16xf32, 1x256x1x1xf32)
        add_14 = paddle._C_ops.add(conv2d_4, reshape_0)

        # pd_op.relu: (1x256x11x16xf32) <- (1x256x11x16xf32)
        relu_4 = paddle._C_ops.relu(add_14)

        # pd_op.conv2d: (1x3x168x256xf32) <- (1x256x168x256xf32, 3x256x1x1xf32)
        ...
        # pd_op.add: (1x3x168x256xf32) <- (1x3x168x256xf32, 1x3x1x1xf32)
        add_0 = paddle._C_ops.add(conv2d_5, reshape_1)

        # pd_op.conv2d: (1x12x168x256xf32) <- (1x256x168x256xf32, 12x256x1x1xf32)
        ...
        # pd_op.add: (1x12x168x256xf32) <- (1x12x168x256xf32, 1x12x1x1xf32)
        add_5 = paddle._C_ops.add(conv2d_6, reshape_2)

        # pd_op.conv2d: (1x3x84x128xf32) <- (1x256x84x128xf32, 3x256x1x1xf32)
        conv2d_7 = paddle._C_ops.conv2d(
            relu_1, parameter_3, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.add: (1x3x84x128xf32) <- (1x3x84x128xf32, 1x3x1x1xf32)
        add_1 = paddle._C_ops.add(conv2d_7, reshape_1)

        # pd_op.conv2d: (1x12x84x128xf32) <- (1x256x84x128xf32, 12x256x1x1xf32)
        conv2d_8 = paddle._C_ops.conv2d(
            relu_1, parameter_1, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.add: (1x12x84x128xf32) <- (1x12x84x128xf32, 1x12x1x1xf32)
        add_6 = paddle._C_ops.add(conv2d_8, reshape_2)

        # pd_op.conv2d: (1x3x42x64xf32) <- (1x256x42x64xf32, 3x256x1x1xf32)
        conv2d_9 = paddle._C_ops.conv2d(
            relu_2, parameter_3, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.add: (1x3x42x64xf32) <- (1x3x42x64xf32, 1x3x1x1xf32)
        add_2 = paddle._C_ops.add(conv2d_9, reshape_1)

        # pd_op.conv2d: (1x12x42x64xf32) <- (1x256x42x64xf32, 12x256x1x1xf32)
        conv2d_10 = paddle._C_ops.conv2d(
            relu_2, parameter_1, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.add: (1x12x42x64xf32) <- (1x12x42x64xf32, 1x12x1x1xf32)
        add_7 = paddle._C_ops.add(conv2d_10, reshape_2)

        # pd_op.conv2d: (1x3x21x32xf32) <- (1x256x21x32xf32, 3x256x1x1xf32)
        conv2d_11 = paddle._C_ops.conv2d(
            relu_3, parameter_3, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.add: (1x3x21x32xf32) <- (1x3x21x32xf32, 1x3x1x1xf32)
        add_3 = paddle._C_ops.add(conv2d_11, reshape_1)

        # pd_op.conv2d: (1x12x21x32xf32) <- (1x256x21x32xf32, 12x256x1x1xf32)
        conv2d_12 = paddle._C_ops.conv2d(
            relu_3, parameter_1, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.add: (1x12x21x32xf32) <- (1x12x21x32xf32, 1x12x1x1xf32)
        add_8 = paddle._C_ops.add(conv2d_12, reshape_2)

        # pd_op.conv2d: (1x3x11x16xf32) <- (1x256x11x16xf32, 3x256x1x1xf32)
        conv2d_13 = paddle._C_ops.conv2d(
            relu_4, parameter_3, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.add: (1x3x11x16xf32) <- (1x3x11x16xf32, 1x3x1x1xf32)
        add_4 = paddle._C_ops.add(conv2d_13, reshape_1)

        # pd_op.conv2d: (1x12x11x16xf32) <- (1x256x11x16xf32, 12x256x1x1xf32)
        conv2d_14 = paddle._C_ops.conv2d(
            relu_4, parameter_1, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.add: (1x12x11x16xf32) <- (1x12x11x16xf32, 1x12x1x1xf32)
        ...
        full_3 = paddle._C_ops.full(
            [1], float("672"), paddle.float64, paddle.core.CPUPlace()
        )

        # pd_op.arange: (168xf32) <- (1xf64, 1xf64, 1xf64)
        arange_1 = paddle.arange(full_0, full_3, full_2, dtype="float32")

        # builtin.combine: ([168xf32, 256xf32]) <- (168xf32, 256xf32)
        combine_0 = [arange_1, arange_0]

        # pd_op.meshgrid: ([168x256xf32, 168x256xf32]) <- ([168xf32, 256xf32])
        meshgrid_0 = paddle._C_ops.meshgrid(combine_0)

        # builtin.split: (168x256xf32, 168x256xf32) <- ([168x256xf32, 168x256xf32])
        (
            split_0,
            split_1,
        ) = meshgrid_0
        ...
        # pd_op.reshape: (43008xf32) <- (168x256xf32, 1xi64)
        reshape_8 = paddle._C_ops.reshape(split_1, full_int_array_1)

        # pd_op.reshape: (43008xf32) <- (168x256xf32, 1xi64)
        reshape_9 = paddle._C_ops.reshape(split_0, full_int_array_1)

        # builtin.combine: ([43008xf32, 43008xf32, 43008xf32, 43008xf32]) <- (43008xf32, 43008xf32, 43008xf32, 43008xf32)
        combine_1 = [reshape_8, reshape_9, reshape_8, reshape_9]

        # pd_op.stack: (43008x4xf32) <- ([43008xf32, 43008xf32, 43008xf32, 43008xf32])
        stack_0 = paddle._C_ops.stack(combine_1, 1)

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_2 = [-1, 1, 4]

        # pd_op.reshape: (43008x1x4xf32) <- (43008x4xf32, 3xi64)
        ...
        # pd_op.add: (43008x3x4xf32) <- (43008x1x4xf32, 1x3x4xf32)
        add_15 = paddle._C_ops.add(reshape_10, reshape_11)

        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_4 = [-1, 4]

        # pd_op.reshape: (129024x4xf32) <- (43008x3x4xf32, 2xi64)
        ...
        # builtin.combine: ([84xf32, 128xf32]) <- (84xf32, 128xf32)
        combine_2 = [arange_3, arange_2]

        # pd_op.meshgrid: ([84x128xf32, 84x128xf32]) <- ([84xf32, 128xf32])
        meshgrid_1 = paddle._C_ops.meshgrid(combine_2)

        # builtin.split: (84x128xf32, 84x128xf32) <- ([84x128xf32, 84x128xf32])
        (
            split_2,
            split_3,
        ) = meshgrid_1

        # pd_op.reshape: (10752xf32) <- (84x128xf32, 1xi64)
        reshape_12 = paddle._C_ops.reshape(split_3, full_int_array_1)

        # pd_op.reshape: (10752xf32) <- (84x128xf32, 1xi64)
        reshape_13 = paddle._C_ops.reshape(split_2, full_int_array_1)

        # builtin.combine: ([10752xf32, 10752xf32, 10752xf32, 10752xf32]) <- (10752xf32, 10752xf32, 10752xf32, 10752xf32)
        combine_3 = [reshape_12, reshape_13, reshape_12, reshape_13]

        # pd_op.stack: (10752x4xf32) <- ([10752xf32, 10752xf32, 10752xf32, 10752xf32])
        stack_1 = paddle._C_ops.stack(combine_3, 1)

        # pd_op.reshape: (10752x1x4xf32) <- (10752x4xf32, 3xi64)
        reshape_14 = paddle._C_ops.reshape(stack_1, full_int_array_2)

        # pd_op.reshape: (1x3x4xf32) <- (3x4xf32, 3xi64)
        reshape_15 = paddle._C_ops.reshape(data_1, full_int_array_3)

        # pd_op.add: (10752x3x4xf32) <- (10752x1x4xf32, 1x3x4xf32)
        add_16 = paddle._C_ops.add(reshape_14, reshape_15)

        # pd_op.reshape: (32256x4xf32) <- (10752x3x4xf32, 2xi64)
        ...
        # builtin.combine: ([42xf32, 64xf32]) <- (42xf32, 64xf32)
        combine_4 = [arange_5, arange_4]

        # pd_op.meshgrid: ([42x64xf32, 42x64xf32]) <- ([42xf32, 64xf32])
        meshgrid_2 = paddle._C_ops.meshgrid(combine_4)

        # builtin.split: (42x64xf32, 42x64xf32) <- ([42x64xf32, 42x64xf32])
        (
            split_4,
            split_5,
        ) = meshgrid_2

        # pd_op.reshape: (2688xf32) <- (42x64xf32, 1xi64)
        reshape_16 = paddle._C_ops.reshape(split_5, full_int_array_1)

        # pd_op.reshape: (2688xf32) <- (42x64xf32, 1xi64)
        reshape_17 = paddle._C_ops.reshape(split_4, full_int_array_1)

        # builtin.combine: ([2688xf32, 2688xf32, 2688xf32, 2688xf32]) <- (2688xf32, 2688xf32, 2688xf32, 2688xf32)
        combine_5 = [reshape_16, reshape_17, reshape_16, reshape_17]

        # pd_op.stack: (2688x4xf32) <- ([2688xf32, 2688xf32, 2688xf32, 2688xf32])
        stack_2 = paddle._C_ops.stack(combine_5, 1)

        # pd_op.reshape: (2688x1x4xf32) <- (2688x4xf32, 3xi64)
        reshape_18 = paddle._C_ops.reshape(stack_2, full_int_array_2)

        # pd_op.reshape: (1x3x4xf32) <- (3x4xf32, 3xi64)
        reshape_19 = paddle._C_ops.reshape(data_2, full_int_array_3)

        # pd_op.add: (2688x3x4xf32) <- (2688x1x4xf32, 1x3x4xf32)
        add_17 = paddle._C_ops.add(reshape_18, reshape_19)

        # pd_op.reshape: (8064x4xf32) <- (2688x3x4xf32, 2xi64)
        ...
        # builtin.combine: ([21xf32, 32xf32]) <- (21xf32, 32xf32)
        combine_6 = [arange_7, arange_6]

        # pd_op.meshgrid: ([21x32xf32, 21x32xf32]) <- ([21xf32, 32xf32])
        meshgrid_3 = paddle._C_ops.meshgrid(combine_6)

        # builtin.split: (21x32xf32, 21x32xf32) <- ([21x32xf32, 21x32xf32])
        (
            split_6,
            split_7,
        ) = meshgrid_3

        # pd_op.reshape: (672xf32) <- (21x32xf32, 1xi64)
        reshape_20 = paddle._C_ops.reshape(split_7, full_int_array_1)

        # pd_op.reshape: (672xf32) <- (21x32xf32, 1xi64)
        reshape_21 = paddle._C_ops.reshape(split_6, full_int_array_1)

        # builtin.combine: ([672xf32, 672xf32, 672xf32, 672xf32]) <- (672xf32, 672xf32, 672xf32, 672xf32)
        combine_7 = [reshape_20, reshape_21, reshape_20, reshape_21]

        # pd_op.stack: (672x4xf32) <- ([672xf32, 672xf32, 672xf32, 672xf32])
        stack_3 = paddle._C_ops.stack(combine_7, 1)

        # pd_op.reshape: (672x1x4xf32) <- (672x4xf32, 3xi64)
        reshape_22 = paddle._C_ops.reshape(stack_3, full_int_array_2)

        # pd_op.reshape: (1x3x4xf32) <- (3x4xf32, 3xi64)
        reshape_23 = paddle._C_ops.reshape(data_3, full_int_array_3)

        # pd_op.add: (672x3x4xf32) <- (672x1x4xf32, 1x3x4xf32)
        add_18 = paddle._C_ops.add(reshape_22, reshape_23)

        # pd_op.reshape: (2016x4xf32) <- (672x3x4xf32, 2xi64)
        ...
        arange_9 = paddle.arange(full_0, full_8, full_7, dtype="float32")

        # builtin.combine: ([11xf32, 16xf32]) <- (11xf32, 16xf32)
        combine_8 = [arange_9, arange_8]

        # pd_op.meshgrid: ([11x16xf32, 11x16xf32]) <- ([11xf32, 16xf32])
        meshgrid_4 = paddle._C_ops.meshgrid(combine_8)

        # builtin.split: (11x16xf32, 11x16xf32) <- ([11x16xf32, 11x16xf32])
        (
            split_8,
            split_9,
        ) = meshgrid_4

        # pd_op.reshape: (176xf32) <- (11x16xf32, 1xi64)
        reshape_24 = paddle._C_ops.reshape(split_9, full_int_array_1)

        # pd_op.reshape: (176xf32) <- (11x16xf32, 1xi64)
        reshape_25 = paddle._C_ops.reshape(split_8, full_int_array_1)

        # builtin.combine: ([176xf32, 176xf32, 176xf32, 176xf32]) <- (176xf32, 176xf32, 176xf32, 176xf32)
        combine_9 = [reshape_24, reshape_25, reshape_24, reshape_25]

        # pd_op.stack: (176x4xf32) <- ([176xf32, 176xf32, 176xf32, 176xf32])
        stack_4 = paddle._C_ops.stack(combine_9, 1)

        # pd_op.reshape: (176x1x4xf32) <- (176x4xf32, 3xi64)
        reshape_26 = paddle._C_ops.reshape(stack_4, full_int_array_2)

        # pd_op.reshape: (1x3x4xf32) <- (3x4xf32, 3xi64)
        reshape_27 = paddle._C_ops.reshape(data_4, full_int_array_3)

        # pd_op.add: (176x3x4xf32) <- (176x1x4xf32, 1x3x4xf32)
        add_19 = paddle._C_ops.add(reshape_26, reshape_27)

        # pd_op.reshape: (528x4xf32) <- (176x3x4xf32, 2xi64)
