...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.assign: (4x-1x256xf32) <- (4x-1x256xf32)
        assign_0 = matmul_0
        ...
        # pd_op.assign: (4x-1x4xf32) <- (4x-1x4xf32)
        assign_4 = matmul_2
        ...
        # pd_op.clip: (4x-1x4xf32) <- (4x-1x4xf32, 1xf32, 1xf32)
        ...
        # pd_op.divide: (4x-1x4xf32) <- (4x-1x4xf32, 4x-1x4xf32)
        divide_1 = paddle._C_ops.divide(clip_4, clip_5)

        # pd_op.log: (4x-1x4xf32) <- (4x-1x4xf32)
        log_0 = paddle._C_ops.log(divide_1)

        # pd_op.add: (4x-1x4xf32) <- (4x-1x4xf32, 4x-1x4xf32)
        add_4 = paddle._C_ops.add(add_0, log_0)

        # pd_op.sigmoid: (4x-1x4xf32) <- (4x-1x4xf32)
