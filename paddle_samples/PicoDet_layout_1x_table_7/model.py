...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2):
        ...
        # pd_op.unsqueeze: (224x1xi64) <- (224xi64, 1xi64)
        unsqueeze_0 = paddle._C_ops.unsqueeze(cast_0, full_int_array_1)

        # pd_op.cross_entropy_with_softmax: (224x8xf32, 224x1xf32) <- (224x8xf32, 224x1xi64)
        ...
        # pd_op.add: (224xf32) <- (224xf32, 224xf32)
        ...
        # pd_op.scale: (224xf32) <- (224xf32, 1xf32)
