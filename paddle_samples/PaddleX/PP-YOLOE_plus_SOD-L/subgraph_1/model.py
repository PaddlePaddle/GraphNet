...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        ...
        # pd_op.argmax: (2x5376xi64) <- (2x3x5376xf32, 1xi64)
        ...
        # pd_op.gather: (10752xi32) <- (6xi32, 10752xi64, 1xi32)
        gather_0 = paddle._C_ops.gather(flatten_0, flatten_1, full_2)
        del flatten_0

        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_0 = [2, 5376]
        ...
        # pd_op.one_hot: (2x5376x11xf32) <- (2x5376xi32, 1xi32)
        ...
        # pd_op.index_select: (2x5376x10xf32) <- (2x5376x11xf32, 10xi64)
        index_select_0 = paddle._C_ops.index_select(one_hot_0, assign_value__0, -1)
        del assign_value__0, one_hot_0

        # pd_op.multiply: (2x3x5376xf32) <- (2x3x5376xf32, 2x3x5376xf32)
        ...
        # pd_op.max: (2x3x1xf32) <- (2x3x5376xf32, 1xi64)
        ...
        # pd_op.scale: (2x3x1xf32) <- (2x3x1xf32, 1xf32)
        scale_1 = paddle._C_ops.scale(max_0, full_7, float("1e-09"), True)
        del full_7, max_0

        # pd_op.divide: (2x3x5376xf32) <- (2x3x5376xf32, 2x3x1xf32)
        divide_0 = paddle._C_ops.divide(multiply_1, scale_1)
        del multiply_1, scale_1

        # pd_op.multiply: (2x3x5376xf32) <- (2x3x5376xf32, 2x3x1xf32)
        ...
        # pd_op.max: (2x5376xf32) <- (2x3x5376xf32, 1xi64)
        ...
        # pd_op.multiply: (2x5376x10xf32) <- (2x5376x10xf32, 2x5376x1xf32)
