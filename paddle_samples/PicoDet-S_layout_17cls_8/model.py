...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2):
        # pd_op.cast: (10880x11xf32) <- (10880x11xf32)
        ...
        # pd_op.greater_than: (10880x11xb) <- (10880x11xf32, xf32)
        greater_than_0 = paddle._C_ops.greater_than(cast_0, full_2)

        # pd_op.cast: (10880x11xf32) <- (10880x11xb)
        cast_2 = paddle._C_ops.cast(greater_than_0, paddle.float32)

        # pd_op.multiply: (10880x11xf32) <- (10880x11xf32, 10880x11xf32)
        multiply_0 = paddle._C_ops.multiply(cast_0, cast_2)

        # pd_op.subtract: (10880x11xf32) <- (10880x11xf32, 10880x11xf32)
        subtract_0 = paddle._C_ops.subtract(data_0, cast_0)

        # pd_op.abs: (10880x11xf32) <- (10880x11xf32)
        abs_0 = paddle._C_ops.abs(subtract_0)

        # pd_op.pow: (10880x11xf32) <- (10880x11xf32)
        ...
        # pd_op.scale: (10880x11xf32) <- (10880x11xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(pow_0, full_0, float("0"), True)

        # pd_op.less_equal: (10880x11xb) <- (10880x11xf32, xf32)
        ...
        # pd_op.add: (10880x11xf32) <- (10880x11xf32, 10880x11xf32)
        add_0 = paddle._C_ops.add(multiply_0, multiply_1)

        # pd_op.bce_loss: (10880x11xf32) <- (10880x11xf32, 10880x11xf32)
        ...
        # pd_op.sum: (10880xf32) <- (10880x11xf32, 1xi64)
        ...
        # pd_op.scale: (10880xf32) <- (10880xf32, 1xf32)
        scale_1 = paddle._C_ops.scale(sum_1, full_1, float("0"), True)

        # pd_op.full_int_array: (0xi64) <- ()
        full_int_array_1 = []

        # pd_op.sum: (xf32) <- (10880xf32, 0xi64)
