...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        hidden_states_258 = (
            l_self_modules_model_modules_norm_parameters_weight_ * to_133
        )
        l_self_modules_model_modules_norm_parameters_weight_ = to_133 = None
        getitem_162 = hidden_states_258[
            (slice(None, None, None), slice(0, None, None), slice(None, None, None))
        ]
        hidden_states_258 = None
        logits = torch._C._nn.linear(
            getitem_162, l_self_modules_lm_head_parameters_weight_, None
        )
        getitem_162 = l_self_modules_lm_head_parameters_weight_ = None
        return (logits,)
