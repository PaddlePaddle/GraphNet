...
python3 -m graph_net.apply_sample_pass \
    --model-path-list "$GRAPH_NET_ROOT/graph_net/test/data_group_ranges_from_subgraph_sources/sample_list.txt" \
...
{
    "subgraph_model_path_prefix": "$GRAPH_NET_ROOT/graph_net/test/data_group_ranges_from_subgraph_sources",
