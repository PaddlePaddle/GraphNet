...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.shape64: (4xi64) <- (4x512x-1x-1xf32)
        ...
        # pd_op.shape64: (4xi64) <- (4x1024x-1x-1xf32)
        ...
        # pd_op.sigmoid: (4x256x-1x-1xf32) <- (4x256x-1x-1xf32)
        sigmoid_0 = paddle._C_ops.sigmoid(batch_norm__0)

        # pd_op.multiply: (4x256x-1x-1xf32) <- (4x256x-1x-1xf32, 4x256x-1x-1xf32)
        ...
        # pd_op.conv2d: (4x4x-1x-1xf32) <- (4x256x-1x-1xf32, 4x256x1x1xf32)
        ...
        reshape_0 = paddle._C_ops.reshape(parameter_70, full_int_array_3)

        # pd_op.add: (4x4x-1x-1xf32) <- (4x4x-1x-1xf32, 1x4x1x1xf32)
        add_0 = paddle._C_ops.add(conv2d_3, reshape_0)
        ...
        # pd_op.conv2d: (4x5x-1x-1xf32) <- (4x256x-1x-1xf32, 5x256x1x1xf32)
        conv2d_6 = paddle._C_ops.conv2d(
            multiply_4, parameter_59, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.reshape: (1x5x1x1xf32) <- (5xf32, 4xi64)
        reshape_1 = paddle._C_ops.reshape(parameter_58, full_int_array_3)

        # pd_op.add: (4x5x-1x-1xf32) <- (4x5x-1x-1xf32, 1x5x1x1xf32)
        add_1 = paddle._C_ops.add(conv2d_6, reshape_1)

        # pd_op.sigmoid: (4x4x-1x-1xf32) <- (4x4x-1x-1xf32)
        sigmoid_5 = paddle._C_ops.sigmoid(add_0)
        ...
        # pd_op.split: ([4x4x-1x-1xf32, 4x1x-1x-1xf32]) <- (4x5x-1x-1xf32, 2xi64, 1xi32)
        split_3 = paddle._C_ops.split(add_1, full_int_array_4, full_0)

        # builtin.split: (4x4x-1x-1xf32, 4x1x-1x-1xf32) <- ([4x4x-1x-1xf32, 4x1x-1x-1xf32])
        (
            split_0,
            split_4,
        ) = split_3
        ...
        sigmoid_6 = paddle._C_ops.sigmoid(split_4)

        # pd_op.flatten: (4x1x-1xf32) <- (4x1x-1x-1xf32)
        flatten_2 = paddle._C_ops.flatten(sigmoid_6, 2, 3)

        # pd_op.transpose: (4x-1x1xf32) <- (4x1x-1xf32)
        ...
        # pd_op.reshape: (1x4x1x1xf32) <- (4xf32, 4xi64)
        reshape_2 = paddle._C_ops.reshape(parameter_41, full_int_array_3)

        # pd_op.add: (4x4x-1x-1xf32) <- (4x4x-1x-1xf32, 1x4x1x1xf32)
        add_2 = paddle._C_ops.add(conv2d_10, reshape_2)
        ...
        # pd_op.reshape: (1x5x1x1xf32) <- (5xf32, 4xi64)
        reshape_3 = paddle._C_ops.reshape(parameter_29, full_int_array_3)

        # pd_op.add: (4x5x-1x-1xf32) <- (4x5x-1x-1xf32, 1x5x1x1xf32)
        add_3 = paddle._C_ops.add(conv2d_13, reshape_3)

        # pd_op.sigmoid: (4x4x-1x-1xf32) <- (4x4x-1x-1xf32)
        sigmoid_12 = paddle._C_ops.sigmoid(add_2)
        ...
        # pd_op.split: ([4x4x-1x-1xf32, 4x1x-1x-1xf32]) <- (4x5x-1x-1xf32, 2xi64, 1xi32)
        split_5 = paddle._C_ops.split(add_3, full_int_array_4, full_0)
        ...
        # pd_op.sigmoid: (4x1x-1x-1xf32) <- (4x1x-1x-1xf32)
        sigmoid_13 = paddle._C_ops.sigmoid(split_6)
        ...
        # pd_op.reshape: (1x4x1x1xf32) <- (4xf32, 4xi64)
        reshape_4 = paddle._C_ops.reshape(parameter_12, full_int_array_3)

        # pd_op.add: (4x4x-1x-1xf32) <- (4x4x-1x-1xf32, 1x4x1x1xf32)
        add_4 = paddle._C_ops.add(conv2d_17, reshape_4)
        ...
        # pd_op.reshape: (1x5x1x1xf32) <- (5xf32, 4xi64)
        reshape_5 = paddle._C_ops.reshape(parameter_0, full_int_array_3)

        # pd_op.add: (4x5x-1x-1xf32) <- (4x5x-1x-1xf32, 1x5x1x1xf32)
        add_5 = paddle._C_ops.add(conv2d_20, reshape_5)

        # pd_op.sigmoid: (4x4x-1x-1xf32) <- (4x4x-1x-1xf32)
        sigmoid_19 = paddle._C_ops.sigmoid(add_4)
        ...
        # pd_op.split: ([4x4x-1x-1xf32, 4x1x-1x-1xf32]) <- (4x5x-1x-1xf32, 2xi64, 1xi32)
        split_7 = paddle._C_ops.split(add_5, full_int_array_4, full_0)
        ...
        # pd_op.sigmoid: (4x1x-1x-1xf32) <- (4x1x-1x-1xf32)
        sigmoid_20 = paddle._C_ops.sigmoid(split_8)
        ...
        # builtin.combine: ([4x-1x1xf32, 4x-1x1xf32, 4x-1x1xf32]) <- (4x-1x1xf32, 4x-1x1xf32, 4x-1x1xf32)
        combine_2 = [transpose_2, transpose_5, transpose_8]

        # pd_op.concat: (4x-1x1xf32) <- ([4x-1x1xf32, 4x-1x1xf32, 4x-1x1xf32], 1xi32)
