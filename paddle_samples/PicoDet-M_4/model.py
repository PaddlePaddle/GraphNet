...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4):
        ...
        # pd_op.argmax: (4x2577xi64) <- (4x1x2577xf32, 1xi64)
        ...
        # pd_op.gather: (10308xi32) <- (4xi32, 10308xi64, 1xi32)
        gather_0 = paddle._C_ops.gather(flatten_0, flatten_1, full_5)

        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_1 = [4, 2577]
        ...
        # pd_op.gather: (10308x4xf32) <- (4x4xf32, 10308xi64, 1xi32)
        gather_1 = paddle._C_ops.gather(reshape_2, flatten_1, full_5)

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_3 = [4, 2577, 4]
        ...
        # pd_op.unsqueeze: (4x1x2577x4xf32) <- (4x2577x4xf32, 1xi64)
        ...
        # pd_op.slice: (4x1x2577x2xf32) <- (4x1x2577x4xf32, 1xi64, 1xi64)
        ...
        # pd_op.maximum: (4x1x2577x2xf32) <- (4x1x1x2xf32, 4x1x2577x2xf32)
        maximum_0 = paddle._C_ops.maximum(slice_0, slice_2)

        # pd_op.minimum: (4x1x2577x2xf32) <- (4x1x1x2xf32, 4x1x2577x2xf32)
        minimum_0 = paddle._C_ops.minimum(slice_1, slice_3)

        # pd_op.subtract: (4x1x2577x2xf32) <- (4x1x2577x2xf32, 4x1x2577x2xf32)
        ...
        # pd_op.clip: (4x1x2577x2xf32) <- (4x1x2577x2xf32, 1xf32, 1xf32)
        clip_0 = paddle._C_ops.clip(subtract_0, full_10, full_11)

        # pd_op.prod: (4x1x2577xf32) <- (4x1x2577x2xf32, 1xi64)
        ...
        # pd_op.add: (4x1x2577xf32) <- (4x1x1xf32, 4x1x2577xf32)
        add_1 = paddle._C_ops.add(prod_1, prod_2)

        # pd_op.subtract: (4x1x2577xf32) <- (4x1x2577xf32, 4x1x2577xf32)
        subtract_3 = paddle._C_ops.subtract(add_1, prod_0)

        # pd_op.scale: (4x1x2577xf32) <- (4x1x2577xf32, 1xf32)
        scale_1 = paddle._C_ops.scale(subtract_3, full_4, float("1e-09"), True)

        # pd_op.divide: (4x1x2577xf32) <- (4x1x2577xf32, 4x1x2577xf32)
        divide_0 = paddle._C_ops.divide(prod_0, scale_1)

        # pd_op.multiply: (4x1x2577xf32) <- (4x1x2577xf32, 4x1x2577xf32)
        multiply_1 = paddle._C_ops.multiply(divide_0, data_0)

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_8 = [-2]

        # pd_op.max: (4x2577xf32) <- (4x1x2577xf32, 1xi64)
