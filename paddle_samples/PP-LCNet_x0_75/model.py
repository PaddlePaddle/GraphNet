...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.depthwise_conv2d: (256x16x112x112xf32) <- (256x16x112x112xf32, 16x1x3x3xf32)
        ...
        # pd_op.conv2d: (256x24x112x112xf32) <- (256x16x112x112xf32, 24x16x1x1xf32)
        ...
        depthwise_conv2d_1 = paddle._C_ops.depthwise_conv2d(
            hardswish_2, parameter_130, [2, 2], [1, 1], "EXPLICIT", 24, [1, 1], "NCHW"
        )
        ...
        # pd_op.hardswish: (256x24x56x56xf32) <- (256x24x56x56xf32)
        hardswish_3 = paddle._C_ops.hardswish(batch_norm__18)

        # pd_op.conv2d: (256x48x56x56xf32) <- (256x24x56x56xf32, 48x24x1x1xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            hardswish_3, parameter_125, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (256x48x56x56xf32, 48xf32, 48xf32, 48xf32, 48xf32, -1xui8) <- (256x48x56x56xf32, 48xf32, 48xf32, 48xf32, 48xf32)
        (
            batch_norm__24,
            batch_norm__25,
            batch_norm__26,
        ...
        # pd_op.hardswish: (256x48x56x56xf32) <- (256x48x56x56xf32)
        hardswish_4 = paddle._C_ops.hardswish(batch_norm__24)

        # pd_op.depthwise_conv2d: (256x48x56x56xf32) <- (256x48x56x56xf32, 48x1x3x3xf32)
        depthwise_conv2d_2 = paddle._C_ops.depthwise_conv2d(
            hardswish_4, parameter_120, [1, 1], [1, 1], "EXPLICIT", 48, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (256x48x56x56xf32) <- (256x48x56x56xf32, 48x48x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (256x48x28x28xf32) <- (256x48x56x56xf32, 48x1x3x3xf32)
        depthwise_conv2d_3 = paddle._C_ops.depthwise_conv2d(
            hardswish_6, parameter_110, [2, 2], [1, 1], "EXPLICIT", 48, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (256x96x28x28xf32) <- (256x48x28x28xf32, 96x48x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (256x96x28x28xf32) <- (256x96x28x28xf32, 96x1x3x3xf32)
        depthwise_conv2d_4 = paddle._C_ops.depthwise_conv2d(
            hardswish_8, parameter_100, [1, 1], [1, 1], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (256x96x28x28xf32) <- (256x96x28x28xf32, 96x96x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (256x96x14x14xf32) <- (256x96x28x28xf32, 96x1x3x3xf32)
        depthwise_conv2d_5 = paddle._C_ops.depthwise_conv2d(
            hardswish_10, parameter_90, [2, 2], [1, 1], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (256x192x14x14xf32) <- (256x96x14x14xf32, 192x96x1x1xf32)
        ...
        # pd_op.hardswish: (256x192x14x14xf32) <- (256x192x14x14xf32)
        hardswish_12 = paddle._C_ops.hardswish(batch_norm__72)

        # pd_op.depthwise_conv2d: (256x192x14x14xf32) <- (256x192x14x14xf32, 192x1x5x5xf32)
        depthwise_conv2d_6 = paddle._C_ops.depthwise_conv2d(
            hardswish_12, parameter_80, [1, 1], [2, 2], "EXPLICIT", 192, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (256x192x14x14xf32) <- (256x192x14x14xf32, 192x192x1x1xf32)
        ...
        depthwise_conv2d_7 = paddle._C_ops.depthwise_conv2d(
            hardswish_14, parameter_70, [1, 1], [2, 2], "EXPLICIT", 192, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_8 = paddle._C_ops.depthwise_conv2d(
            hardswish_16, parameter_60, [1, 1], [2, 2], "EXPLICIT", 192, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_9 = paddle._C_ops.depthwise_conv2d(
            hardswish_18, parameter_50, [1, 1], [2, 2], "EXPLICIT", 192, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_10 = paddle._C_ops.depthwise_conv2d(
            hardswish_20, parameter_40, [1, 1], [2, 2], "EXPLICIT", 192, [1, 1], "NCHW"
        )
        ...
        # pd_op.depthwise_conv2d: (256x192x7x7xf32) <- (256x192x14x14xf32, 192x1x5x5xf32)
        depthwise_conv2d_11 = paddle._C_ops.depthwise_conv2d(
            hardswish_22, parameter_30, [2, 2], [2, 2], "EXPLICIT", 192, [1, 1], "NCHW"
        )

        # pd_op.batch_norm_: (256x192x7x7xf32, 192xf32, 192xf32, 192xf32, 192xf32, -1xui8) <- (256x192x7x7xf32, 192xf32, 192xf32, 192xf32, 192xf32)
        (
            batch_norm__138,
            batch_norm__139,
            batch_norm__140,
        ...
        # pd_op.hardswish: (256x192x7x7xf32) <- (256x192x7x7xf32)
        ...
        # pd_op.pool2d: (256x192x1x1xf32) <- (256x192x7x7xf32, 2xi64)
        ...
        # pd_op.conv2d: (256x48x1x1xf32) <- (256x192x1x1xf32, 48x192x1x1xf32)
        ...
        # pd_op.relu: (256x48x1x1xf32) <- (256x48x1x1xf32)
        relu_0 = paddle._C_ops.relu(add_1)

        # pd_op.conv2d: (256x192x1x1xf32) <- (256x48x1x1xf32, 192x48x1x1xf32)
        ...
        # pd_op.add: (256x192x1x1xf32) <- (256x192x1x1xf32, 1x192x1x1xf32)
        add_2 = paddle._C_ops.add(conv2d_13, reshape_1)

        # pd_op.hardsigmoid: (256x192x1x1xf32) <- (256x192x1x1xf32)
        hardsigmoid_0 = paddle._C_ops.hardsigmoid(
            add_2, float("0.166667"), float("0.5")
        )

        # pd_op.multiply: (256x192x7x7xf32) <- (256x192x7x7xf32, 256x192x1x1xf32)
        multiply_0 = paddle._C_ops.multiply(hardswish_23, hardsigmoid_0)

        # pd_op.conv2d: (256x384x7x7xf32) <- (256x192x7x7xf32, 384x192x1x1xf32)
        conv2d_14 = paddle._C_ops.conv2d(
            multiply_0, parameter_21, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (256x384x7x7xf32, 384xf32, 384xf32, 384xf32, 384xf32, -1xui8) <- (256x384x7x7xf32, 384xf32, 384xf32, 384xf32, 384xf32)
        (
            batch_norm__144,
            batch_norm__145,
            batch_norm__146,
        ...
        # pd_op.hardswish: (256x384x7x7xf32) <- (256x384x7x7xf32)
        hardswish_24 = paddle._C_ops.hardswish(batch_norm__144)

        # pd_op.depthwise_conv2d: (256x384x7x7xf32) <- (256x384x7x7xf32, 384x1x5x5xf32)
        depthwise_conv2d_12 = paddle._C_ops.depthwise_conv2d(
            hardswish_24, parameter_16, [1, 1], [2, 2], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        ...
        # pd_op.pool2d: (256x384x1x1xf32) <- (256x384x7x7xf32, 2xi64)
        ...
        # pd_op.conv2d: (256x96x1x1xf32) <- (256x384x1x1xf32, 96x384x1x1xf32)
        ...
        # pd_op.relu: (256x96x1x1xf32) <- (256x96x1x1xf32)
        relu_1 = paddle._C_ops.relu(add_3)

        # pd_op.conv2d: (256x384x1x1xf32) <- (256x96x1x1xf32, 384x96x1x1xf32)
        ...
        # pd_op.add: (256x384x1x1xf32) <- (256x384x1x1xf32, 1x384x1x1xf32)
        add_4 = paddle._C_ops.add(conv2d_16, reshape_3)

        # pd_op.hardsigmoid: (256x384x1x1xf32) <- (256x384x1x1xf32)
        hardsigmoid_1 = paddle._C_ops.hardsigmoid(
            add_4, float("0.166667"), float("0.5")
        )

        # pd_op.multiply: (256x384x7x7xf32) <- (256x384x7x7xf32, 256x384x1x1xf32)
        multiply_1 = paddle._C_ops.multiply(hardswish_25, hardsigmoid_1)

        # pd_op.conv2d: (256x384x7x7xf32) <- (256x384x7x7xf32, 384x384x1x1xf32)
        ...
        # pd_op.conv2d: (256x1280x1x1xf32) <- (256x384x1x1xf32, 1280x384x1x1xf32)
