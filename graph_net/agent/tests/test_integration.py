...
class TestAgentIntegration(unittest.TestCase):
    ...
    def test_full_workflow_mock(self, mock_subprocess, mock_download):
        ...
        (mock_model_dir / "config.json").write_text('{"model_type": "bert", "max_position_embeddings": 512}')
        ...
        self.agent.graph_extractor._find_output_dir_robust = Mock(return_value=mock_output_dir)
