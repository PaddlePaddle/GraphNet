...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        conv2d_0 = paddle._C_ops.conv2d(
            data_43, parameter_352, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        multiply_0 = paddle._C_ops.multiply(data_44, relu_0)

        # pd_op.add: (-1x24x112x112xf32) <- (-1x24x112x112xf32, 1xf32)
        add_1 = paddle._C_ops.add(multiply_0, data_45)

        # pd_op.conv2d: (-1x12x112x112xf32) <- (-1x24x112x112xf32, 12x24x2x2xf32)
        conv2d_1 = paddle._C_ops.conv2d(
            add_1, parameter_347, [1, 1], [0, 0], "SAME", [1, 1], 1, "NCHW"
        )
        ...
        multiply_1 = paddle._C_ops.multiply(data_46, relu_1)

        # pd_op.add: (-1x12x112x112xf32) <- (-1x12x112x112xf32, 1xf32)
        add_2 = paddle._C_ops.add(multiply_1, data_47)

        # pd_op.conv2d: (-1x24x112x112xf32) <- (-1x12x112x112xf32, 24x12x2x2xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            add_2, parameter_342, [1, 1], [0, 0], "SAME", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.multiply: (-1x24x112x112xf32) <- (1xf32, -1x24x112x112xf32)
        multiply_2 = paddle._C_ops.multiply(data_48, relu_2)

        # pd_op.add: (-1x24x112x112xf32) <- (-1x24x112x112xf32, 1xf32)
        add_3 = paddle._C_ops.add(multiply_2, data_49)
        ...
        multiply_3 = paddle._C_ops.multiply(data_50, relu_3)

        # pd_op.add: (-1x24x56x56xf32) <- (-1x24x56x56xf32, 1xf32)
        add_4 = paddle._C_ops.add(multiply_3, data_51)

        # pd_op.conv2d: (-1x32x56x56xf32) <- (-1x24x56x56xf32, 32x24x1x1xf32)
        conv2d_4 = paddle._C_ops.conv2d(
            add_4, parameter_332, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        multiply_4 = paddle._C_ops.multiply(data_52, relu_4)

        # pd_op.add: (-1x32x56x56xf32) <- (-1x32x56x56xf32, 1xf32)
        add_5 = paddle._C_ops.add(multiply_4, data_53)

        # pd_op.conv2d: (-1x32x56x56xf32) <- (-1x32x56x56xf32, 32x32x3x3xf32)
        conv2d_5 = paddle._C_ops.conv2d(
            add_5, parameter_327, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.multiply: (-1x32x56x56xf32) <- (1xf32, -1x32x56x56xf32)
        multiply_5 = paddle._C_ops.multiply(data_54, relu_5)

        # pd_op.add: (-1x32x56x56xf32) <- (-1x32x56x56xf32, 1xf32)
        add_6 = paddle._C_ops.add(multiply_5, data_55)

        # pd_op.conv2d: (-1x32x56x56xf32) <- (-1x32x56x56xf32, 32x32x3x3xf32)
        conv2d_6 = paddle._C_ops.conv2d(
            add_6, parameter_322, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.multiply: (-1x32x56x56xf32) <- (1xf32, -1x32x56x56xf32)
        multiply_6 = paddle._C_ops.multiply(data_56, relu_6)

        # pd_op.add: (-1x32x56x56xf32) <- (-1x32x56x56xf32, 1xf32)
        add_7 = paddle._C_ops.add(multiply_6, data_57)

        # pd_op.conv2d: (-1x32x56x56xf32) <- (-1x32x56x56xf32, 32x32x3x3xf32)
        conv2d_7 = paddle._C_ops.conv2d(
            add_7, parameter_317, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.multiply: (-1x32x56x56xf32) <- (1xf32, -1x32x56x56xf32)
        multiply_7 = paddle._C_ops.multiply(data_58, relu_7)

        # pd_op.add: (-1x32x56x56xf32) <- (-1x32x56x56xf32, 1xf32)
        add_8 = paddle._C_ops.add(multiply_7, data_59)

        # pd_op.conv2d: (-1x32x56x56xf32) <- (-1x32x56x56xf32, 32x32x3x3xf32)
        conv2d_8 = paddle._C_ops.conv2d(
            add_8, parameter_312, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.multiply: (-1x32x56x56xf32) <- (1xf32, -1x32x56x56xf32)
        multiply_8 = paddle._C_ops.multiply(data_60, relu_8)

        # pd_op.add: (-1x32x56x56xf32) <- (-1x32x56x56xf32, 1xf32)
        add_9 = paddle._C_ops.add(multiply_8, data_61)

        # pd_op.conv2d: (-1x32x56x56xf32) <- (-1x32x56x56xf32, 32x32x3x3xf32)
        conv2d_9 = paddle._C_ops.conv2d(
            add_9, parameter_307, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.multiply: (-1x32x56x56xf32) <- (1xf32, -1x32x56x56xf32)
        multiply_9 = paddle._C_ops.multiply(data_62, relu_9)

        # pd_op.add: (-1x32x56x56xf32) <- (-1x32x56x56xf32, 1xf32)
        add_10 = paddle._C_ops.add(multiply_9, data_63)
        ...
        combine_1 = [add_5, add_6, add_7, add_8, add_9, add_10]
        ...
        multiply_10 = paddle._C_ops.multiply(data_64, relu_10)

        # pd_op.add: (-1x64x56x56xf32) <- (-1x64x56x56xf32, 1xf32)
        add_11 = paddle._C_ops.add(multiply_10, data_65)

        # pd_op.conv2d: (-1x128x56x56xf32) <- (-1x64x56x56xf32, 128x64x1x1xf32)
        conv2d_11 = paddle._C_ops.conv2d(
            add_11, parameter_297, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_12 = paddle._C_ops.conv2d(
            batch_norm__72, parameter_287, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        multiply_12 = paddle._C_ops.multiply(data_68, relu_12)

        # pd_op.add: (-1x64x28x28xf32) <- (-1x64x28x28xf32, 1xf32)
        add_13 = paddle._C_ops.add(multiply_12, data_69)

        # pd_op.conv2d: (-1x64x28x28xf32) <- (-1x64x28x28xf32, 64x64x3x3xf32)
        conv2d_13 = paddle._C_ops.conv2d(
            add_13, parameter_282, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.multiply: (-1x64x28x28xf32) <- (1xf32, -1x64x28x28xf32)
        multiply_13 = paddle._C_ops.multiply(data_70, relu_13)

        # pd_op.add: (-1x64x28x28xf32) <- (-1x64x28x28xf32, 1xf32)
        add_14 = paddle._C_ops.add(multiply_13, data_71)

        # pd_op.conv2d: (-1x64x28x28xf32) <- (-1x64x28x28xf32, 64x64x3x3xf32)
        conv2d_14 = paddle._C_ops.conv2d(
            add_14, parameter_277, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.multiply: (-1x64x28x28xf32) <- (1xf32, -1x64x28x28xf32)
        multiply_14 = paddle._C_ops.multiply(data_72, relu_14)

        # pd_op.add: (-1x64x28x28xf32) <- (-1x64x28x28xf32, 1xf32)
        add_15 = paddle._C_ops.add(multiply_14, data_73)

        # pd_op.conv2d: (-1x64x28x28xf32) <- (-1x64x28x28xf32, 64x64x3x3xf32)
        conv2d_15 = paddle._C_ops.conv2d(
            add_15, parameter_272, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.multiply: (-1x64x28x28xf32) <- (1xf32, -1x64x28x28xf32)
        multiply_15 = paddle._C_ops.multiply(data_74, relu_15)

        # pd_op.add: (-1x64x28x28xf32) <- (-1x64x28x28xf32, 1xf32)
        add_16 = paddle._C_ops.add(multiply_15, data_75)

        # pd_op.conv2d: (-1x64x28x28xf32) <- (-1x64x28x28xf32, 64x64x3x3xf32)
        conv2d_16 = paddle._C_ops.conv2d(
            add_16, parameter_267, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.multiply: (-1x64x28x28xf32) <- (1xf32, -1x64x28x28xf32)
        multiply_16 = paddle._C_ops.multiply(data_76, relu_16)

        # pd_op.add: (-1x64x28x28xf32) <- (-1x64x28x28xf32, 1xf32)
        add_17 = paddle._C_ops.add(multiply_16, data_77)
        ...
        combine_2 = [batch_norm__72, add_13, add_14, add_15, add_16, add_17]
        ...
        multiply_17 = paddle._C_ops.multiply(data_78, relu_17)

        # pd_op.add: (-1x256x28x28xf32) <- (-1x256x28x28xf32, 1xf32)
        add_18 = paddle._C_ops.add(multiply_17, data_79)

        # pd_op.conv2d: (-1x512x28x28xf32) <- (-1x256x28x28xf32, 512x256x1x1xf32)
        conv2d_18 = paddle._C_ops.conv2d(
            add_18, parameter_257, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        multiply_19 = paddle._C_ops.multiply(data_82, relu_19)

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 1xf32)
        add_20 = paddle._C_ops.add(multiply_19, data_83)

        # pd_op.conv2d: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 128x128x1x1xf32)
        conv2d_20 = paddle._C_ops.conv2d(
            add_20, parameter_237, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.multiply: (-1x128x14x14xf32) <- (1xf32, -1x128x14x14xf32)
        multiply_20 = paddle._C_ops.multiply(data_84, relu_20)

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 1xf32)
        add_21 = paddle._C_ops.add(multiply_20, data_85)

        # pd_op.conv2d: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 128x128x1x1xf32)
        conv2d_21 = paddle._C_ops.conv2d(
            add_21, parameter_227, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.multiply: (-1x128x14x14xf32) <- (1xf32, -1x128x14x14xf32)
        multiply_21 = paddle._C_ops.multiply(data_86, relu_21)

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 1xf32)
        add_22 = paddle._C_ops.add(multiply_21, data_87)

        # pd_op.conv2d: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 128x128x1x1xf32)
        conv2d_22 = paddle._C_ops.conv2d(
            add_22, parameter_217, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.multiply: (-1x128x14x14xf32) <- (1xf32, -1x128x14x14xf32)
        multiply_22 = paddle._C_ops.multiply(data_88, relu_22)

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 1xf32)
        add_23 = paddle._C_ops.add(multiply_22, data_89)

        # pd_op.conv2d: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 128x128x1x1xf32)
        conv2d_23 = paddle._C_ops.conv2d(
            add_23, parameter_207, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.multiply: (-1x128x14x14xf32) <- (1xf32, -1x128x14x14xf32)
        multiply_23 = paddle._C_ops.multiply(data_90, relu_23)

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 1xf32)
        add_24 = paddle._C_ops.add(multiply_23, data_91)
        ...
        combine_3 = [batch_norm__120, add_20, add_21, add_22, add_23, add_24]
        ...
        multiply_24 = paddle._C_ops.multiply(data_92, relu_24)

        # pd_op.add: (-1x512x14x14xf32) <- (-1x512x14x14xf32, 1xf32)
        add_25 = paddle._C_ops.add(multiply_24, data_93)

        # pd_op.conv2d: (-1x1024x14x14xf32) <- (-1x512x14x14xf32, 1024x512x1x1xf32)
        conv2d_25 = paddle._C_ops.conv2d(
            add_25, parameter_192, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        multiply_25 = paddle._C_ops.multiply(data_94, relu_25)

        # pd_op.add: (-1x1024x14x14xf32) <- (-1x1024x14x14xf32, 1xf32)
        add_26 = paddle._C_ops.add(multiply_25, data_95)

        # pd_op.conv2d: (-1x128x14x14xf32) <- (-1x1024x14x14xf32, 128x1024x1x1xf32)
        conv2d_26 = paddle._C_ops.conv2d(
            add_26, parameter_187, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.multiply: (-1x128x14x14xf32) <- (1xf32, -1x128x14x14xf32)
        multiply_26 = paddle._C_ops.multiply(data_96, relu_26)

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 1xf32)
        add_27 = paddle._C_ops.add(multiply_26, data_0)

        # pd_op.conv2d: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 128x128x1x1xf32)
        conv2d_27 = paddle._C_ops.conv2d(
            add_27, parameter_177, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x128x14x14xf32) <- (-1x128x14x14xf32)
        relu_27 = paddle._C_ops.relu(batch_norm__216)

        # pd_op.multiply: (-1x128x14x14xf32) <- (1xf32, -1x128x14x14xf32)
        multiply_27 = paddle._C_ops.multiply(data_1, relu_27)

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 1xf32)
        add_28 = paddle._C_ops.add(multiply_27, data_2)

        # pd_op.conv2d: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 128x128x1x1xf32)
        conv2d_28 = paddle._C_ops.conv2d(
            add_28, parameter_167, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.multiply: (-1x128x14x14xf32) <- (1xf32, -1x128x14x14xf32)
        multiply_28 = paddle._C_ops.multiply(data_3, relu_28)

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 1xf32)
        add_29 = paddle._C_ops.add(multiply_28, data_4)

        # pd_op.conv2d: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 128x128x1x1xf32)
        conv2d_29 = paddle._C_ops.conv2d(
            add_29, parameter_157, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.multiply: (-1x128x14x14xf32) <- (1xf32, -1x128x14x14xf32)
        multiply_29 = paddle._C_ops.multiply(data_5, relu_29)

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 1xf32)
        add_30 = paddle._C_ops.add(multiply_29, data_6)

        # pd_op.conv2d: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 128x128x1x1xf32)
        conv2d_30 = paddle._C_ops.conv2d(
            add_30, parameter_147, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.multiply: (-1x128x14x14xf32) <- (1xf32, -1x128x14x14xf32)
        multiply_30 = paddle._C_ops.multiply(data_7, relu_30)

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 1xf32)
        add_31 = paddle._C_ops.add(multiply_30, data_8)
        ...
        combine_4 = [add_26, add_27, add_28, add_29, add_30, add_31]
        ...
        # pd_op.relu: (-1x512x14x14xf32) <- (-1x512x14x14xf32)
        relu_31 = paddle._C_ops.relu(batch_norm__258)

        # pd_op.multiply: (-1x512x14x14xf32) <- (1xf32, -1x512x14x14xf32)
        multiply_31 = paddle._C_ops.multiply(data_9, relu_31)

        # pd_op.add: (-1x512x14x14xf32) <- (-1x512x14x14xf32, 1xf32)
        add_32 = paddle._C_ops.add(multiply_31, data_10)

        # pd_op.conv2d: (-1x1024x14x14xf32) <- (-1x512x14x14xf32, 1024x512x1x1xf32)
        conv2d_32 = paddle._C_ops.conv2d(
            add_32, parameter_132, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x1024x14x14xf32) <- (-1x1024x14x14xf32)
        relu_32 = paddle._C_ops.relu(batch_norm__264)

        # pd_op.multiply: (-1x1024x14x14xf32) <- (1xf32, -1x1024x14x14xf32)
        multiply_32 = paddle._C_ops.multiply(data_11, relu_32)

        # pd_op.add: (-1x1024x14x14xf32) <- (-1x1024x14x14xf32, 1xf32)
        add_33 = paddle._C_ops.add(multiply_32, data_12)

        # pd_op.add: (-1x1024x14x14xf32) <- (-1x1024x14x14xf32, -1x1024x14x14xf32)
        add_34 = paddle._C_ops.add(add_33, add_26)

        # pd_op.conv2d: (-1x128x14x14xf32) <- (-1x1024x14x14xf32, 128x1024x1x1xf32)
        conv2d_33 = paddle._C_ops.conv2d(
            add_34, parameter_127, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x128x14x14xf32) <- (-1x128x14x14xf32)
        relu_33 = paddle._C_ops.relu(batch_norm__276)

        # pd_op.multiply: (-1x128x14x14xf32) <- (1xf32, -1x128x14x14xf32)
        multiply_33 = paddle._C_ops.multiply(data_13, relu_33)

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 1xf32)
        add_35 = paddle._C_ops.add(multiply_33, data_14)

        # pd_op.conv2d: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 128x128x1x1xf32)
        conv2d_34 = paddle._C_ops.conv2d(
            add_35, parameter_117, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.multiply: (-1x128x14x14xf32) <- (1xf32, -1x128x14x14xf32)
        multiply_34 = paddle._C_ops.multiply(data_15, relu_34)

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 1xf32)
        add_36 = paddle._C_ops.add(multiply_34, data_16)

        # pd_op.conv2d: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 128x128x1x1xf32)
        conv2d_35 = paddle._C_ops.conv2d(
            add_36, parameter_107, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x128x14x14xf32) <- (-1x128x14x14xf32)
        relu_35 = paddle._C_ops.relu(batch_norm__300)

        # pd_op.multiply: (-1x128x14x14xf32) <- (1xf32, -1x128x14x14xf32)
        multiply_35 = paddle._C_ops.multiply(data_17, relu_35)

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 1xf32)
        add_37 = paddle._C_ops.add(multiply_35, data_18)

        # pd_op.conv2d: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 128x128x1x1xf32)
        conv2d_36 = paddle._C_ops.conv2d(
            add_37, parameter_97, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x128x14x14xf32) <- (-1x128x14x14xf32)
        relu_36 = paddle._C_ops.relu(batch_norm__312)

        # pd_op.multiply: (-1x128x14x14xf32) <- (1xf32, -1x128x14x14xf32)
        multiply_36 = paddle._C_ops.multiply(data_19, relu_36)

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 1xf32)
        add_38 = paddle._C_ops.add(multiply_36, data_20)

        # pd_op.conv2d: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 128x128x1x1xf32)
        conv2d_37 = paddle._C_ops.conv2d(
            add_38, parameter_87, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x128x14x14xf32) <- (-1x128x14x14xf32)
        relu_37 = paddle._C_ops.relu(batch_norm__324)

        # pd_op.multiply: (-1x128x14x14xf32) <- (1xf32, -1x128x14x14xf32)
        multiply_37 = paddle._C_ops.multiply(data_21, relu_37)

        # pd_op.add: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 1xf32)
        add_39 = paddle._C_ops.add(multiply_37, data_22)

        # builtin.combine: ([-1x1024x14x14xf32, -1x128x14x14xf32, -1x128x14x14xf32, -1x128x14x14xf32, -1x128x14x14xf32, -1x128x14x14xf32]) <- (-1x1024x14x14xf32, -1x128x14x14xf32, -1x128x14x14xf32, -1x128x14x14xf32, -1x128x14x14xf32, -1x128x14x14xf32)
        combine_5 = [add_34, add_35, add_36, add_37, add_38, add_39]
        ...
        # pd_op.relu: (-1x512x14x14xf32) <- (-1x512x14x14xf32)
        relu_38 = paddle._C_ops.relu(batch_norm__330)

        # pd_op.multiply: (-1x512x14x14xf32) <- (1xf32, -1x512x14x14xf32)
        multiply_38 = paddle._C_ops.multiply(data_23, relu_38)

        # pd_op.add: (-1x512x14x14xf32) <- (-1x512x14x14xf32, 1xf32)
        add_40 = paddle._C_ops.add(multiply_38, data_24)

        # pd_op.conv2d: (-1x1024x14x14xf32) <- (-1x512x14x14xf32, 1024x512x1x1xf32)
        conv2d_39 = paddle._C_ops.conv2d(
            add_40, parameter_72, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x1024x14x14xf32) <- (-1x1024x14x14xf32)
        relu_39 = paddle._C_ops.relu(batch_norm__336)

        # pd_op.multiply: (-1x1024x14x14xf32) <- (1xf32, -1x1024x14x14xf32)
        multiply_39 = paddle._C_ops.multiply(data_25, relu_39)

        # pd_op.add: (-1x1024x14x14xf32) <- (-1x1024x14x14xf32, 1xf32)
        add_41 = paddle._C_ops.add(multiply_39, data_26)

        # pd_op.add: (-1x1024x14x14xf32) <- (-1x1024x14x14xf32, -1x1024x14x14xf32)
        add_42 = paddle._C_ops.add(add_41, add_34)

        # pd_op.depthwise_conv2d: (-1x1024x7x7xf32) <- (-1x1024x14x14xf32, 1024x1x3x3xf32)
        depthwise_conv2d_17 = paddle._C_ops.depthwise_conv2d(
            add_42, parameter_67, [2, 2], [1, 1], "EXPLICIT", 1024, [1, 1], "NCHW"
        )
        ...
        conv2d_40 = paddle._C_ops.conv2d(
            batch_norm__342, parameter_62, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        multiply_40 = paddle._C_ops.multiply(data_27, relu_40)

        # pd_op.add: (-1x256x7x7xf32) <- (-1x256x7x7xf32, 1xf32)
        add_43 = paddle._C_ops.add(multiply_40, data_28)

        # pd_op.conv2d: (-1x256x7x7xf32) <- (-1x256x7x7xf32, 256x256x1x1xf32)
        conv2d_41 = paddle._C_ops.conv2d(
            add_43, parameter_52, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x256x7x7xf32) <- (-1x256x7x7xf32)
        relu_41 = paddle._C_ops.relu(batch_norm__366)

        # pd_op.multiply: (-1x256x7x7xf32) <- (1xf32, -1x256x7x7xf32)
        multiply_41 = paddle._C_ops.multiply(data_29, relu_41)

        # pd_op.add: (-1x256x7x7xf32) <- (-1x256x7x7xf32, 1xf32)
        add_44 = paddle._C_ops.add(multiply_41, data_30)

        # pd_op.conv2d: (-1x256x7x7xf32) <- (-1x256x7x7xf32, 256x256x1x1xf32)
        conv2d_42 = paddle._C_ops.conv2d(
            add_44, parameter_42, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x256x7x7xf32) <- (-1x256x7x7xf32)
        relu_42 = paddle._C_ops.relu(batch_norm__378)

        # pd_op.multiply: (-1x256x7x7xf32) <- (1xf32, -1x256x7x7xf32)
        multiply_42 = paddle._C_ops.multiply(data_31, relu_42)

        # pd_op.add: (-1x256x7x7xf32) <- (-1x256x7x7xf32, 1xf32)
        add_45 = paddle._C_ops.add(multiply_42, data_32)

        # pd_op.conv2d: (-1x256x7x7xf32) <- (-1x256x7x7xf32, 256x256x1x1xf32)
        conv2d_43 = paddle._C_ops.conv2d(
            add_45, parameter_32, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x256x7x7xf32) <- (-1x256x7x7xf32)
        relu_43 = paddle._C_ops.relu(batch_norm__390)

        # pd_op.multiply: (-1x256x7x7xf32) <- (1xf32, -1x256x7x7xf32)
        multiply_43 = paddle._C_ops.multiply(data_33, relu_43)

        # pd_op.add: (-1x256x7x7xf32) <- (-1x256x7x7xf32, 1xf32)
        add_46 = paddle._C_ops.add(multiply_43, data_34)

        # pd_op.conv2d: (-1x256x7x7xf32) <- (-1x256x7x7xf32, 256x256x1x1xf32)
        conv2d_44 = paddle._C_ops.conv2d(
            add_46, parameter_22, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x256x7x7xf32) <- (-1x256x7x7xf32)
        relu_44 = paddle._C_ops.relu(batch_norm__402)

        # pd_op.multiply: (-1x256x7x7xf32) <- (1xf32, -1x256x7x7xf32)
        multiply_44 = paddle._C_ops.multiply(data_35, relu_44)

        # pd_op.add: (-1x256x7x7xf32) <- (-1x256x7x7xf32, 1xf32)
        add_47 = paddle._C_ops.add(multiply_44, data_36)
        ...
        combine_6 = [batch_norm__342, add_43, add_44, add_45, add_46, add_47]
        ...
        relu_46 = paddle._C_ops.relu(batch_norm__414)

        # pd_op.multiply: (-1x2048x7x7xf32) <- (1xf32, -1x2048x7x7xf32)
        multiply_46 = paddle._C_ops.multiply(data_39, relu_46)

        # pd_op.add: (-1x2048x7x7xf32) <- (-1x2048x7x7xf32, 1xf32)
        add_49 = paddle._C_ops.add(multiply_46, data_40)
        ...
        multiply_47 = paddle._C_ops.multiply(data_41, relu_47)

        # pd_op.add: (-1x2048x1x1xf32) <- (-1x2048x1x1xf32, 1xf32)
        add_50 = paddle._C_ops.add(multiply_47, data_42)

        # pd_op.flatten: (-1x2048xf32) <- (-1x2048x1x1xf32)
        flatten_0 = paddle._C_ops.flatten(add_50, 1, 3)
