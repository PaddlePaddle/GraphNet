...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        ...
        # pd_op.argmax: (8x6885xi64) <- (8x2x6885xf32, 1xi64)
        ...
        # pd_op.flatten: (16xi32) <- (8x2x1xi32)
        ...
        # pd_op.gather: (55080xi32) <- (16xi32, 55080xi64, 1xi32)
        ...
        # pd_op.reshape: (16x4xf32) <- (8x2x4xf32, 2xi64)
        reshape_2 = paddle._C_ops.reshape(data_4, full_int_array_1)
        del data_4, full_int_array_1

        # pd_op.gather: (55080x4xf32) <- (16x4xf32, 55080xi64, 1xi32)
        ...
        # pd_op.max: (8x2x1xf32) <- (8x2x6885xf32, 1xi64)
        ...
        # pd_op.scale: (8x2x1xf32) <- (8x2x1xf32, 1xf32)
        scale_1 = paddle._C_ops.scale(max_0, full_7, float("1e-09"), True)
        del full_7, max_0

        # pd_op.divide: (8x2x6885xf32) <- (8x2x6885xf32, 8x2x1xf32)
        ...
        # pd_op.max: (8x6885xf32) <- (8x2x6885xf32, 1xi64)
