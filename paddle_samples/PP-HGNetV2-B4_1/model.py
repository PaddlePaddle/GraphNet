...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        conv2d_13 = paddle._C_ops.conv2d(
            batch_norm__78, parameter_332, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x192x14x14xf32) <- (-1x192x14x14xf32)
        relu_22 = paddle._C_ops.relu(batch_norm__156)
        ...
        # pd_op.relu: (-1x192x14x14xf32) <- (-1x192x14x14xf32)
        relu_23 = paddle._C_ops.relu(batch_norm__168)
        ...
        # pd_op.relu: (-1x192x14x14xf32) <- (-1x192x14x14xf32)
        relu_24 = paddle._C_ops.relu(batch_norm__180)
        ...
        # pd_op.relu: (-1x192x14x14xf32) <- (-1x192x14x14xf32)
        relu_29 = paddle._C_ops.relu(batch_norm__228)
        ...
        # pd_op.relu: (-1x192x14x14xf32) <- (-1x192x14x14xf32)
        relu_30 = paddle._C_ops.relu(batch_norm__240)
        ...
        # pd_op.relu: (-1x192x14x14xf32) <- (-1x192x14x14xf32)
        relu_31 = paddle._C_ops.relu(batch_norm__252)
        ...
        # pd_op.relu: (-1x512x14x14xf32) <- (-1x512x14x14xf32)
        relu_35 = paddle._C_ops.relu(batch_norm__294)
        ...
        # pd_op.relu: (-1x1024x14x14xf32) <- (-1x1024x14x14xf32)
        relu_36 = paddle._C_ops.relu(batch_norm__300)
        ...
        conv2d_37 = paddle._C_ops.conv2d(
            add_1, parameter_147, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x192x14x14xf32) <- (-1x192x14x14xf32)
        relu_37 = paddle._C_ops.relu(batch_norm__312)
        ...
        # pd_op.relu: (-1x192x14x14xf32) <- (-1x192x14x14xf32)
        relu_38 = paddle._C_ops.relu(batch_norm__324)
        ...
        # pd_op.relu: (-1x192x14x14xf32) <- (-1x192x14x14xf32)
        relu_40 = paddle._C_ops.relu(batch_norm__348)
        ...
        # pd_op.relu: (-1x192x14x14xf32) <- (-1x192x14x14xf32)
        relu_41 = paddle._C_ops.relu(batch_norm__360)
        ...
        # pd_op.relu: (-1x192x14x14xf32) <- (-1x192x14x14xf32)
        relu_42 = paddle._C_ops.relu(batch_norm__372)
        ...
        # pd_op.relu: (-1x512x14x14xf32) <- (-1x512x14x14xf32)
        relu_43 = paddle._C_ops.relu(batch_norm__378)
        ...
        # pd_op.relu: (-1x1024x14x14xf32) <- (-1x1024x14x14xf32)
        relu_44 = paddle._C_ops.relu(batch_norm__384)
        ...
        depthwise_conv2d_20 = paddle._C_ops.depthwise_conv2d(
            add_2, parameter_77, [2, 2], [1, 1], "EXPLICIT", 1024, [1, 1], "NCHW"
        )
        ...
        conv2d_45 = paddle._C_ops.conv2d(
            batch_norm__390, parameter_72, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        relu_45 = paddle._C_ops.relu(batch_norm__402)
        ...
        # pd_op.relu: (-1x384x7x7xf32) <- (-1x384x7x7xf32)
        relu_47 = paddle._C_ops.relu(batch_norm__426)
        ...
        # pd_op.relu: (-1x384x7x7xf32) <- (-1x384x7x7xf32)
        relu_48 = paddle._C_ops.relu(batch_norm__438)
        ...
        # pd_op.relu: (-1x384x7x7xf32) <- (-1x384x7x7xf32)
        relu_49 = paddle._C_ops.relu(batch_norm__450)
        ...
        # pd_op.relu: (-1x384x7x7xf32) <- (-1x384x7x7xf32)
        relu_50 = paddle._C_ops.relu(batch_norm__462)
        ...
        relu_51 = paddle._C_ops.relu(batch_norm__468)
        ...
        relu_52 = paddle._C_ops.relu(batch_norm__474)
