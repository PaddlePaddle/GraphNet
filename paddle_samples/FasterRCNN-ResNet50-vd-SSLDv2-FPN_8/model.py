...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.roi_align: (-1x256x7x7xf32) <- (4x256x272x200xf32, -1x4xf32, -1xi32)
        roi_align_0 = paddle._C_ops.roi_align(
            data_5, split_0, split_4, 7, 7, float("0.25"), 0, True
        )

        # pd_op.roi_align: (-1x256x7x7xf32) <- (4x256x136x100xf32, -1x4xf32, -1xi32)
        roi_align_1 = paddle._C_ops.roi_align(
            data_6, split_1, split_5, 7, 7, float("0.125"), 0, True
        )

        # pd_op.roi_align: (-1x256x7x7xf32) <- (4x256x68x50xf32, -1x4xf32, -1xi32)
        roi_align_2 = paddle._C_ops.roi_align(
            data_7, split_2, split_6, 7, 7, float("0.0625"), 0, True
        )

        # pd_op.roi_align: (-1x256x7x7xf32) <- (4x256x34x25xf32, -1x4xf32, -1xi32)
