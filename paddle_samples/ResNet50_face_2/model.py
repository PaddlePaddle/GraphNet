...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (-1x64x112x112xf32) <- (-1x3x112x112xf32, 64x3x7x7xf32)
        conv2d_0 = paddle._C_ops.conv2d(
            data_0, parameter_266, [1, 1], [3, 3], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_1 = paddle._C_ops.conv2d(
            relu_0, parameter_261, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x64x56x56xf32) <- (-1x64x112x112xf32, 64x64x3x3xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            relu_1, parameter_256, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_3 = paddle._C_ops.conv2d(
            relu_2, parameter_251, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x256x56x56xf32) <- (-1x64x112x112xf32, 256x64x1x1xf32)
        conv2d_4 = paddle._C_ops.conv2d(
            relu_0, parameter_246, [2, 2], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_6 = paddle._C_ops.conv2d(
            relu_4, parameter_236, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_8 = paddle._C_ops.conv2d(
            relu_6, parameter_226, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_9 = paddle._C_ops.conv2d(
            relu_7, parameter_221, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_10 = paddle._C_ops.conv2d(
            relu_8, parameter_216, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_12 = paddle._C_ops.conv2d(
            relu_10, parameter_206, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_13 = paddle._C_ops.conv2d(
            relu_11, parameter_201, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_14 = paddle._C_ops.conv2d(
            relu_9, parameter_196, [2, 2], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_15 = paddle._C_ops.conv2d(
            relu_12, parameter_191, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_16 = paddle._C_ops.conv2d(
            relu_13, parameter_186, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_17 = paddle._C_ops.conv2d(
            relu_14, parameter_181, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_18 = paddle._C_ops.conv2d(
            relu_15, parameter_176, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_19 = paddle._C_ops.conv2d(
            relu_16, parameter_171, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_20 = paddle._C_ops.conv2d(
            relu_17, parameter_166, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_21 = paddle._C_ops.conv2d(
            relu_18, parameter_161, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_22 = paddle._C_ops.conv2d(
            relu_19, parameter_156, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_23 = paddle._C_ops.conv2d(
            relu_20, parameter_151, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_24 = paddle._C_ops.conv2d(
            relu_21, parameter_146, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_25 = paddle._C_ops.conv2d(
            relu_22, parameter_141, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_26 = paddle._C_ops.conv2d(
            relu_23, parameter_136, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_27 = paddle._C_ops.conv2d(
            relu_21, parameter_131, [2, 2], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_28 = paddle._C_ops.conv2d(
            relu_24, parameter_126, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_29 = paddle._C_ops.conv2d(
            relu_25, parameter_121, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_30 = paddle._C_ops.conv2d(
            relu_26, parameter_116, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_31 = paddle._C_ops.conv2d(
            relu_27, parameter_111, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_32 = paddle._C_ops.conv2d(
            relu_28, parameter_106, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_33 = paddle._C_ops.conv2d(
            relu_29, parameter_101, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_34 = paddle._C_ops.conv2d(
            relu_30, parameter_96, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_35 = paddle._C_ops.conv2d(
            relu_31, parameter_91, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_36 = paddle._C_ops.conv2d(
            relu_32, parameter_86, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_37 = paddle._C_ops.conv2d(
            relu_33, parameter_81, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_38 = paddle._C_ops.conv2d(
            relu_34, parameter_76, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_39 = paddle._C_ops.conv2d(
            relu_35, parameter_71, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_40 = paddle._C_ops.conv2d(
            relu_36, parameter_66, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_41 = paddle._C_ops.conv2d(
            relu_37, parameter_61, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_42 = paddle._C_ops.conv2d(
            relu_38, parameter_56, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_44 = paddle._C_ops.conv2d(
            relu_40, parameter_46, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_45 = paddle._C_ops.conv2d(
            relu_41, parameter_41, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_46 = paddle._C_ops.conv2d(
            relu_39, parameter_36, [2, 2], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_47 = paddle._C_ops.conv2d(
            relu_42, parameter_31, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_48 = paddle._C_ops.conv2d(
            relu_43, parameter_26, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_49 = paddle._C_ops.conv2d(
            relu_44, parameter_21, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_50 = paddle._C_ops.conv2d(
            relu_45, parameter_16, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_51 = paddle._C_ops.conv2d(
            relu_46, parameter_11, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_52 = paddle._C_ops.conv2d(
            relu_47, parameter_6, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.matmul: (-1x512xf32) <- (-1x2048xf32, 2048x512xf32)
