...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.pool2d: (2x768x1x1xf32) <- (2x768x-1x-1xf32, 2xi64)
        ...
        # pd_op.add: (2x768x-1x-1xf32) <- (2x768x-1x-1xf32, 2x768x-1x-1xf32)
        add_1 = paddle._C_ops.add(swish_0, data_6)

        # pd_op.conv2d: (2x10x-1x-1xf32) <- (2x768x-1x-1xf32, 10x768x3x3xf32)
        ...
        # pd_op.add: (2x10x-1x-1xf32) <- (2x10x-1x-1xf32, 1x10x1x1xf32)
        ...
        # pd_op.conv2d: (2x40x-1x-1xf32) <- (2x768x-1x-1xf32, 40x768x3x3xf32)
        ...
        # pd_op.add: (2x40x-1x-1xf32) <- (2x40x-1x-1xf32, 1x40x1x1xf32)
        add_4 = paddle._C_ops.add(conv2d_5, reshape_9)

        # pd_op.sigmoid: (2x10x-1x-1xf32) <- (2x10x-1x-1xf32)
        sigmoid_2 = paddle._C_ops.sigmoid(add_2)
        del add_2

        # pd_op.flatten: (2x10x-1xf32) <- (2x10x-1x-1xf32)
        flatten_0 = paddle._C_ops.flatten(sigmoid_2, 2, 3)

        # pd_op.transpose: (2x-1x10xf32) <- (2x10x-1xf32)
        transpose_0 = paddle._C_ops.transpose(flatten_0, [0, 2, 1])
        del flatten_0

        # pd_op.flatten: (2x40x-1xf32) <- (2x40x-1x-1xf32)
        flatten_1 = paddle._C_ops.flatten(add_4, 2, 3)

        # pd_op.transpose: (2x-1x40xf32) <- (2x40x-1xf32)
        transpose_1 = paddle._C_ops.transpose(flatten_1, [0, 2, 1])
        del flatten_1

        # pd_op.pool2d: (2x384x1x1xf32) <- (2x384x-1x-1xf32, 2xi64)
        ...
        # pd_op.conv2d: (2x10x-1x-1xf32) <- (2x384x-1x-1xf32, 10x384x3x3xf32)
        ...
        # pd_op.conv2d: (2x40x-1x-1xf32) <- (2x384x-1x-1xf32, 40x384x3x3xf32)
        ...
        # pd_op.pool2d: (2x192x1x1xf32) <- (2x192x-1x-1xf32, 2xi64)
        ...
        # pd_op.conv2d: (2x40x-1x-1xf32) <- (2x192x-1x-1xf32, 40x192x3x3xf32)
        ...
        # builtin.combine: ([2x-1x10xf32, 2x-1x10xf32, 2x-1x10xf32]) <- (2x-1x10xf32, 2x-1x10xf32, 2x-1x10xf32)
        combine_15 = [transpose_0, transpose_2, transpose_4]

        # pd_op.concat: (2x-1x10xf32) <- ([2x-1x10xf32, 2x-1x10xf32, 2x-1x10xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_15, full_8)
        del combine_15

        # builtin.combine: ([2x-1x40xf32, 2x-1x40xf32, 2x-1x40xf32]) <- (2x-1x40xf32, 2x-1x40xf32, 2x-1x40xf32)
        combine_16 = [transpose_1, transpose_3, transpose_5]

        # pd_op.concat: (2x-1x40xf32) <- ([2x-1x40xf32, 2x-1x40xf32, 2x-1x40xf32], 1xi32)
