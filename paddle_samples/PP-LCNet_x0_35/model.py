...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        depthwise_conv2d_0 = paddle._C_ops.depthwise_conv2d(
            hardswish_0, parameter_140, [1, 1], [1, 1], "EXPLICIT", 8, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x16x112x112xf32) <- (-1x8x112x112xf32, 16x8x1x1xf32)
        ...
        depthwise_conv2d_1 = paddle._C_ops.depthwise_conv2d(
            hardswish_2, parameter_130, [2, 2], [1, 1], "EXPLICIT", 16, [1, 1], "NCHW"
        )
        ...
        # pd_op.hardswish: (-1x24x56x56xf32) <- (-1x24x56x56xf32)
        ...
        depthwise_conv2d_2 = paddle._C_ops.depthwise_conv2d(
            hardswish_4, parameter_120, [1, 1], [1, 1], "EXPLICIT", 24, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_3 = paddle._C_ops.depthwise_conv2d(
            hardswish_6, parameter_110, [2, 2], [1, 1], "EXPLICIT", 24, [1, 1], "NCHW"
        )
        ...
        # pd_op.hardswish: (-1x24x28x28xf32) <- (-1x24x28x28xf32)
        hardswish_7 = paddle._C_ops.hardswish(batch_norm__42)

        # pd_op.conv2d: (-1x48x28x28xf32) <- (-1x24x28x28xf32, 48x24x1x1xf32)
        ...
        depthwise_conv2d_4 = paddle._C_ops.depthwise_conv2d(
            hardswish_8, parameter_100, [1, 1], [1, 1], "EXPLICIT", 48, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x48x28x28xf32) <- (-1x48x28x28xf32, 48x48x1x1xf32)
        ...
        depthwise_conv2d_5 = paddle._C_ops.depthwise_conv2d(
            hardswish_10, parameter_90, [2, 2], [1, 1], "EXPLICIT", 48, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x88x14x14xf32) <- (-1x48x14x14xf32, 88x48x1x1xf32)
        ...
        depthwise_conv2d_6 = paddle._C_ops.depthwise_conv2d(
            hardswish_12, parameter_80, [1, 1], [2, 2], "EXPLICIT", 88, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x88x14x14xf32) <- (-1x88x14x14xf32, 88x88x1x1xf32)
        ...
        depthwise_conv2d_7 = paddle._C_ops.depthwise_conv2d(
            hardswish_14, parameter_70, [1, 1], [2, 2], "EXPLICIT", 88, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_8 = paddle._C_ops.depthwise_conv2d(
            hardswish_16, parameter_60, [1, 1], [2, 2], "EXPLICIT", 88, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_9 = paddle._C_ops.depthwise_conv2d(
            hardswish_18, parameter_50, [1, 1], [2, 2], "EXPLICIT", 88, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_10 = paddle._C_ops.depthwise_conv2d(
            hardswish_20, parameter_40, [1, 1], [2, 2], "EXPLICIT", 88, [1, 1], "NCHW"
        )
        ...
        # pd_op.depthwise_conv2d: (-1x88x7x7xf32) <- (-1x88x14x14xf32, 88x1x5x5xf32)
        depthwise_conv2d_11 = paddle._C_ops.depthwise_conv2d(
            hardswish_22, parameter_30, [2, 2], [2, 2], "EXPLICIT", 88, [1, 1], "NCHW"
        )

        # pd_op.batch_norm_: (-1x88x7x7xf32, 88xf32, 88xf32, 88xf32, 88xf32, -1xui8) <- (-1x88x7x7xf32, 88xf32, 88xf32, 88xf32, 88xf32)
        (
            batch_norm__138,
            batch_norm__139,
            batch_norm__140,
        ...
        # pd_op.hardswish: (-1x88x7x7xf32) <- (-1x88x7x7xf32)
        ...
        # pd_op.pool2d: (-1x88x1x1xf32) <- (-1x88x7x7xf32, 2xi64)
        ...
        # pd_op.multiply: (-1x88x7x7xf32) <- (-1x88x7x7xf32, -1x88x1x1xf32)
        multiply_0 = paddle._C_ops.multiply(hardswish_23, hardsigmoid_0)

        # pd_op.conv2d: (-1x176x7x7xf32) <- (-1x88x7x7xf32, 176x88x1x1xf32)
        conv2d_14 = paddle._C_ops.conv2d(
            multiply_0, parameter_21, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (-1x176x7x7xf32, 176xf32, 176xf32, 176xf32, 176xf32, -1xui8) <- (-1x176x7x7xf32, 176xf32, 176xf32, 176xf32, 176xf32)
        (
            batch_norm__144,
            batch_norm__145,
            batch_norm__146,
        ...
        # pd_op.hardswish: (-1x176x7x7xf32) <- (-1x176x7x7xf32)
        hardswish_24 = paddle._C_ops.hardswish(batch_norm__144)

        # pd_op.depthwise_conv2d: (-1x176x7x7xf32) <- (-1x176x7x7xf32, 176x1x5x5xf32)
        depthwise_conv2d_12 = paddle._C_ops.depthwise_conv2d(
            hardswish_24, parameter_16, [1, 1], [2, 2], "EXPLICIT", 176, [1, 1], "NCHW"
        )
        ...
        # pd_op.pool2d: (-1x176x1x1xf32) <- (-1x176x7x7xf32, 2xi64)
        ...
        # pd_op.conv2d: (-1x44x1x1xf32) <- (-1x176x1x1xf32, 44x176x1x1xf32)
        ...
        # pd_op.add: (-1x44x1x1xf32) <- (-1x44x1x1xf32, 1x44x1x1xf32)
        add_3 = paddle._C_ops.add(conv2d_15, reshape_2)

        # pd_op.relu: (-1x44x1x1xf32) <- (-1x44x1x1xf32)
        relu_1 = paddle._C_ops.relu(add_3)

        # pd_op.conv2d: (-1x176x1x1xf32) <- (-1x44x1x1xf32, 176x44x1x1xf32)
        ...
        # pd_op.add: (-1x176x1x1xf32) <- (-1x176x1x1xf32, 1x176x1x1xf32)
        add_4 = paddle._C_ops.add(conv2d_16, reshape_3)

        # pd_op.hardsigmoid: (-1x176x1x1xf32) <- (-1x176x1x1xf32)
        hardsigmoid_1 = paddle._C_ops.hardsigmoid(
            add_4, float("0.166667"), float("0.5")
        )

        # pd_op.multiply: (-1x176x7x7xf32) <- (-1x176x7x7xf32, -1x176x1x1xf32)
        multiply_1 = paddle._C_ops.multiply(hardswish_25, hardsigmoid_1)

        # pd_op.conv2d: (-1x176x7x7xf32) <- (-1x176x7x7xf32, 176x176x1x1xf32)
        ...
        # pd_op.conv2d: (-1x1280x1x1xf32) <- (-1x176x1x1xf32, 1280x176x1x1xf32)
