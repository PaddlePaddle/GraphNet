...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6, data_7):
        # pd_op.divide: (16x-1x4xf32) <- (16x-1x4xf32, -1x1xf32)
        ...
        # pd_op.expand: (16x-1x2xf32) <- (-1x2xf32, 3xi64)
        expand_0 = paddle._C_ops.expand(data_4, stack_0)

        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_2 = [-1, 2]

        # pd_op.reshape: (-1x2xf32) <- (16x-1x2xf32, 2xi64)
        ...
        # pd_op.expand: (16x-1x1xf32) <- (-1x1xf32, 3xi64)
        expand_1 = paddle._C_ops.expand(data_3, stack_1)

        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_3 = [-1, 1]

        # pd_op.reshape: (-1x1xf32) <- (16x-1x1xf32, 2xi64)
        ...
        # pd_op.reshape: (-1x32xf32) <- (16x-1x32xf32, 2xi64)
        ...
        # pd_op.reshape: (-1xi32) <- (16x-1xi32, 1xi64)
