...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.split_with_num: ([22x1xf32, 22x1xf32, 22x1xf32, 22x1xf32]) <- (22x4xf32, 1xi32)
        split_with_num_0 = paddle._C_ops.split_with_num(data_0, 4, full_0)
        del data_0

        # builtin.split: (22x1xf32, 22x1xf32, 22x1xf32, 22x1xf32) <- ([22x1xf32, 22x1xf32, 22x1xf32, 22x1xf32])
        (
            split_0,
            split_1,
            split_2,
        ...
        # pd_op.clip: (22x1xf32) <- (22x1xf32, 1xf32, 1xf32)
        ...
        # pd_op.multiply: (22x1xf32) <- (22x1xf32, 22x1xf32)
        ...
        # pd_op.add: (22x1xf32) <- (22x1xf32, 22x1xf32)
        ...
        # pd_op.divide: (22x1xf32) <- (22x1xf32, 22x1xf32)
