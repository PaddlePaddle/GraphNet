...
dynamic_dim_constraint_input_shapes = [
    ...
    ([768], "L_self_modules_wavlm_modules_encoder_modules_layer_norm_parameters_bias_"),
    (
        [768],
    ...
    (
        [768, 768],
        "L_self_modules_wavlm_modules_encoder_modules_layers_modules_8_modules_attention_modules_k_proj_parameters_weight_",
    ),
    (
        [768],
    ...
    (
        [768, 768],
        "L_self_modules_wavlm_modules_encoder_modules_layers_modules_9_modules_attention_modules_k_proj_parameters_weight_",
    ),
    (
        [768],
