...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.slice: (146xf32) <- (146x4xf32, 1xi64, 1xi64)
        ...
        # pd_op.subtract: (146xf32) <- (146xf32, 146xf32)
        ...
        # pd_op.multiply: (146xf32) <- (146xf32, 146xf32)
        ...
        # pd_op.unsqueeze: (146x1x4xf32) <- (146x4xf32, 1xi64)
        unsqueeze_0 = paddle._C_ops.unsqueeze(data_0, full_int_array_3)

        # pd_op.assign: (146x1x4xf32) <- (146x1x4xf32)
        assign_6 = unsqueeze_0

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_5 = [2147483647]

        # pd_op.slice: (146x1x2xf32) <- (146x1x4xf32, 1xi64, 1xi64)
        slice_4 = paddle._C_ops.slice(
            unsqueeze_0, [2], full_int_array_0, full_int_array_5, [1], []
        )

        # pd_op.slice: (146x2xf32) <- (146x4xf32, 1xi64, 1xi64)
        slice_5 = paddle._C_ops.slice(
            data_1, [1], full_int_array_0, full_int_array_5, [1], []
        )

        # pd_op.minimum: (146x146x2xf32) <- (146x1x2xf32, 146x2xf32)
        ...
        # pd_op.maximum: (146x146x2xf32) <- (146x1x2xf32, 146x2xf32)
        maximum_0 = paddle._C_ops.maximum(slice_6, slice_7)

        # pd_op.subtract: (146x146x2xf32) <- (146x146x2xf32, 146x146x2xf32)
        ...
        # pd_op.clip: (146x146x2xf32) <- (146x146x2xf32, 1xf32, 1xf32)
        clip_0 = paddle._C_ops.clip(subtract_2, full_0, full_1)

        # pd_op.prod: (146x146xf32) <- (146x146x2xf32, 1xi64)
