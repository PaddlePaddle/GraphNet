...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.topk: (2x3x13xf32, 2x3x13xi64) <- (2x3x12096xf32, 1xi32)
        ...
        # pd_op.one_hot: (2x3x13x12096xf32) <- (2x3x13xi64, 1xi32)
        ...
        # pd_op.sum: (2x3x12096xf32) <- (2x3x13x12096xf32, 1xi64)
        sum_0 = paddle._C_ops.sum(one_hot_0, full_int_array_0, None, False)

        # pd_op.multiply: (2x3x12096xf32) <- (2x3x12096xf32, 2x3x1xf32)
