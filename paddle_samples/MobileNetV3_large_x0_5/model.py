...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.add: (-1x8x112x112xf32) <- (-1x8x112x112xf32, -1x8x112x112xf32)
        add_0 = paddle._C_ops.add(hardswish_0, batch_norm__16)

        # pd_op.conv2d: (-1x32x112x112xf32) <- (-1x8x112x112xf32, 32x8x1x1xf32)
        ...
        depthwise_conv2d_1 = paddle._C_ops.depthwise_conv2d(
            relu_2, parameter_244, [2, 2], [1, 1], "EXPLICIT", 32, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x16x56x56xf32) <- (-1x32x56x56xf32, 16x32x1x1xf32)
        ...
        # pd_op.conv2d: (-1x40x56x56xf32) <- (-1x16x56x56xf32, 40x16x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x40x56x56xf32) <- (-1x40x56x56xf32, 40x1x3x3xf32)
        depthwise_conv2d_2 = paddle._C_ops.depthwise_conv2d(
            relu_4, parameter_229, [1, 1], [1, 1], "EXPLICIT", 40, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x16x56x56xf32) <- (-1x40x56x56xf32, 16x40x1x1xf32)
        ...
        # pd_op.add: (-1x16x56x56xf32) <- (-1x16x56x56xf32, -1x16x56x56xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x40x28x28xf32) <- (-1x40x56x56xf32, 40x1x5x5xf32)
        depthwise_conv2d_3 = paddle._C_ops.depthwise_conv2d(
            relu_6, parameter_214, [2, 2], [2, 2], "EXPLICIT", 40, [1, 1], "NCHW"
        )
        ...
        # pd_op.pool2d: (-1x40x1x1xf32) <- (-1x40x28x28xf32, 2xi64)
        ...
        # pd_op.multiply: (-1x40x28x28xf32) <- (-1x40x28x28xf32, -1x40x1x1xf32)
        multiply_0 = paddle._C_ops.multiply(relu_7, hardsigmoid_0)

        # pd_op.conv2d: (-1x24x28x28xf32) <- (-1x40x28x28xf32, 24x40x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x64x28x28xf32) <- (-1x64x28x28xf32, 64x1x5x5xf32)
        depthwise_conv2d_4 = paddle._C_ops.depthwise_conv2d(
            relu_9, parameter_195, [1, 1], [2, 2], "EXPLICIT", 64, [1, 1], "NCHW"
        )
        ...
        # pd_op.pool2d: (-1x64x1x1xf32) <- (-1x64x28x28xf32, 2xi64)
        ...
        # pd_op.multiply: (-1x64x28x28xf32) <- (-1x64x28x28xf32, -1x64x1x1xf32)
        ...
        depthwise_conv2d_5 = paddle._C_ops.depthwise_conv2d(
            relu_12, parameter_176, [1, 1], [2, 2], "EXPLICIT", 64, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x120x28x28xf32) <- (-1x24x28x28xf32, 120x24x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x120x14x14xf32) <- (-1x120x28x28xf32, 120x1x3x3xf32)
        depthwise_conv2d_6 = paddle._C_ops.depthwise_conv2d(
            hardswish_1, parameter_157, [2, 2], [1, 1], "EXPLICIT", 120, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x40x14x14xf32) <- (-1x120x14x14xf32, 40x120x1x1xf32)
        ...
        # pd_op.conv2d: (-1x104x14x14xf32) <- (-1x40x14x14xf32, 104x40x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x104x14x14xf32) <- (-1x104x14x14xf32, 104x1x3x3xf32)
        depthwise_conv2d_7 = paddle._C_ops.depthwise_conv2d(
            hardswish_3, parameter_142, [1, 1], [1, 1], "EXPLICIT", 104, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x40x14x14xf32) <- (-1x104x14x14xf32, 40x104x1x1xf32)
        ...
        # pd_op.conv2d: (-1x96x14x14xf32) <- (-1x40x14x14xf32, 96x40x1x1xf32)
        ...
        # pd_op.hardswish: (-1x96x14x14xf32) <- (-1x96x14x14xf32)
        hardswish_5 = paddle._C_ops.hardswish(batch_norm__138)

        # pd_op.depthwise_conv2d: (-1x96x14x14xf32) <- (-1x96x14x14xf32, 96x1x3x3xf32)
        depthwise_conv2d_8 = paddle._C_ops.depthwise_conv2d(
            hardswish_5, parameter_127, [1, 1], [1, 1], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x40x14x14xf32) <- (-1x96x14x14xf32, 40x96x1x1xf32)
        ...
        depthwise_conv2d_9 = paddle._C_ops.depthwise_conv2d(
            hardswish_7, parameter_112, [1, 1], [1, 1], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        ...
        # pd_op.batch_norm_: (-1x240x14x14xf32, 240xf32, 240xf32, 240xf32, 240xf32, -1xui8) <- (-1x240x14x14xf32, 240xf32, 240xf32, 240xf32, 240xf32)
        (
            batch_norm__174,
            batch_norm__175,
            batch_norm__176,
        ...
        # pd_op.hardswish: (-1x240x14x14xf32) <- (-1x240x14x14xf32)
        ...
        depthwise_conv2d_10 = paddle._C_ops.depthwise_conv2d(
            hardswish_9, parameter_97, [1, 1], [1, 1], "EXPLICIT", 240, [1, 1], "NCHW"
        )
        ...
        # pd_op.multiply: (-1x240x14x14xf32) <- (-1x240x14x14xf32, -1x240x1x1xf32)
        multiply_3 = paddle._C_ops.multiply(hardswish_10, hardsigmoid_3)

        # pd_op.conv2d: (-1x56x14x14xf32) <- (-1x240x14x14xf32, 56x240x1x1xf32)
        conv2d_30 = paddle._C_ops.conv2d(
            multiply_3, parameter_88, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (-1x56x14x14xf32, 56xf32, 56xf32, 56xf32, 56xf32, -1xui8) <- (-1x56x14x14xf32, 56xf32, 56xf32, 56xf32, 56xf32)
        (
            batch_norm__186,
            batch_norm__187,
            batch_norm__188,
        ...
        # pd_op.conv2d: (-1x336x14x14xf32) <- (-1x56x14x14xf32, 336x56x1x1xf32)
        conv2d_31 = paddle._C_ops.conv2d(
            batch_norm__186, parameter_83, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (-1x336x14x14xf32, 336xf32, 336xf32, 336xf32, 336xf32, -1xui8) <- (-1x336x14x14xf32, 336xf32, 336xf32, 336xf32, 336xf32)
        (
            batch_norm__192,
            batch_norm__193,
            batch_norm__194,
        ...
        # pd_op.hardswish: (-1x336x14x14xf32) <- (-1x336x14x14xf32)
        ...
        depthwise_conv2d_11 = paddle._C_ops.depthwise_conv2d(
            hardswish_11, parameter_78, [1, 1], [1, 1], "EXPLICIT", 336, [1, 1], "NCHW"
        )
        ...
        # pd_op.pool2d: (-1x336x1x1xf32) <- (-1x336x14x14xf32, 2xi64)
        ...
        # pd_op.conv2d: (-1x84x1x1xf32) <- (-1x336x1x1xf32, 84x336x1x1xf32)
        ...
        # pd_op.add: (-1x84x1x1xf32) <- (-1x84x1x1xf32, 1x84x1x1xf32)
        add_19 = paddle._C_ops.add(conv2d_32, reshape_8)

        # pd_op.relu: (-1x84x1x1xf32) <- (-1x84x1x1xf32)
        relu_16 = paddle._C_ops.relu(add_19)

        # pd_op.conv2d: (-1x336x1x1xf32) <- (-1x84x1x1xf32, 336x84x1x1xf32)
        ...
        # pd_op.add: (-1x336x1x1xf32) <- (-1x336x1x1xf32, 1x336x1x1xf32)
        add_20 = paddle._C_ops.add(conv2d_33, reshape_9)

        # pd_op.hardsigmoid: (-1x336x1x1xf32) <- (-1x336x1x1xf32)
        hardsigmoid_4 = paddle._C_ops.hardsigmoid(add_20, float("0.2"), float("0.5"))

        # pd_op.multiply: (-1x336x14x14xf32) <- (-1x336x14x14xf32, -1x336x1x1xf32)
        multiply_4 = paddle._C_ops.multiply(hardswish_12, hardsigmoid_4)

        # pd_op.conv2d: (-1x56x14x14xf32) <- (-1x336x14x14xf32, 56x336x1x1xf32)
        ...
        # pd_op.add: (-1x56x14x14xf32) <- (-1x56x14x14xf32, -1x56x14x14xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x336x7x7xf32) <- (-1x336x14x14xf32, 336x1x5x5xf32)
        depthwise_conv2d_12 = paddle._C_ops.depthwise_conv2d(
            hardswish_13, parameter_59, [2, 2], [2, 2], "EXPLICIT", 336, [1, 1], "NCHW"
        )

        # pd_op.batch_norm_: (-1x336x7x7xf32, 336xf32, 336xf32, 336xf32, 336xf32, -1xui8) <- (-1x336x7x7xf32, 336xf32, 336xf32, 336xf32, 336xf32)
        (
            batch_norm__216,
            batch_norm__217,
            batch_norm__218,
        ...
        # pd_op.hardswish: (-1x336x7x7xf32) <- (-1x336x7x7xf32)
        hardswish_14 = paddle._C_ops.hardswish(batch_norm__216)

        # pd_op.pool2d: (-1x336x1x1xf32) <- (-1x336x7x7xf32, 2xi64)
        ...
        # pd_op.multiply: (-1x336x7x7xf32) <- (-1x336x7x7xf32, -1x336x1x1xf32)
        multiply_5 = paddle._C_ops.multiply(hardswish_14, hardsigmoid_5)

        # pd_op.conv2d: (-1x80x7x7xf32) <- (-1x336x7x7xf32, 80x336x1x1xf32)
        conv2d_38 = paddle._C_ops.conv2d(
            multiply_5, parameter_50, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (-1x80x7x7xf32, 80xf32, 80xf32, 80xf32, 80xf32, -1xui8) <- (-1x80x7x7xf32, 80xf32, 80xf32, 80xf32, 80xf32)
        (
            batch_norm__222,
            batch_norm__223,
            batch_norm__224,
        ...
        # pd_op.conv2d: (-1x480x7x7xf32) <- (-1x80x7x7xf32, 480x80x1x1xf32)
        ...
        # pd_op.hardswish: (-1x480x7x7xf32) <- (-1x480x7x7xf32)
        hardswish_15 = paddle._C_ops.hardswish(batch_norm__228)

        # pd_op.depthwise_conv2d: (-1x480x7x7xf32) <- (-1x480x7x7xf32, 480x1x5x5xf32)
        depthwise_conv2d_13 = paddle._C_ops.depthwise_conv2d(
            hardswish_15, parameter_40, [1, 1], [2, 2], "EXPLICIT", 480, [1, 1], "NCHW"
        )
        ...
        # pd_op.pool2d: (-1x480x1x1xf32) <- (-1x480x7x7xf32, 2xi64)
        ...
        # pd_op.multiply: (-1x480x7x7xf32) <- (-1x480x7x7xf32, -1x480x1x1xf32)
        multiply_6 = paddle._C_ops.multiply(hardswish_16, hardsigmoid_6)

        # pd_op.conv2d: (-1x80x7x7xf32) <- (-1x480x7x7xf32, 80x480x1x1xf32)
        ...
        # pd_op.add: (-1x80x7x7xf32) <- (-1x80x7x7xf32, -1x80x7x7xf32)
        ...
        depthwise_conv2d_14 = paddle._C_ops.depthwise_conv2d(
            hardswish_17, parameter_21, [1, 1], [2, 2], "EXPLICIT", 480, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x1280x1x1xf32) <- (-1x480x1x1xf32, 1280x480x1x1xf32)
