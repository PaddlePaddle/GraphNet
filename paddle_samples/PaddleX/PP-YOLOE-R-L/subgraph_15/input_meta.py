...
class Program_weight_tensor_data_6:
    ...
    shape = [1, 3, 21504]
    dtype = "float32"
    max_val = float("4.25288e-07")
    mean = float("7.54294e-12")
    std = float("1.67909e-09")
    data = None
...
class Program_weight_tensor_data_7:
    ...
    shape = [1, 3, 21504]
    dtype = "float32"
    max_val = float("0.207679")
    mean = float("0.00012728")
    std = float("0.00194434")
    data = None
