...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2):
        ...
        # pd_op.reshape: (32400x4xf32) <- (32400x4xf32, 2xi64)
        ...
        # builtin.combine: ([32400x4xf32]) <- (32400x4xf32)
        combine_0 = [reshape_0]
        del reshape_0

        # pd_op.concat: (32400x4xf32) <- ([32400x4xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_0)
        del combine_0, full_0

        # pd_op.transpose: (2x54x40x15xf32) <- (2x15x54x40xf32)
        ...
        # pd_op.reshape: (2x32400x1xf32) <- (2x54x40x15xf32, 3xi64)
        ...
        # builtin.combine: ([2x32400x1xf32]) <- (2x32400x1xf32)
        combine_1 = [reshape_1]

        # pd_op.concat: (2x32400x1xf32) <- ([2x32400x1xf32], 1xi32)
        concat_1 = paddle._C_ops.concat(combine_1, full_1)
        del combine_1

        # pd_op.transpose: (2x54x40x60xf32) <- (2x60x54x40xf32)
        ...
        # pd_op.reshape: (2x32400x4xf32) <- (2x54x40x60xf32, 3xi64)
        reshape_2 = paddle._C_ops.reshape(transpose_1, full_int_array_2)
        del full_int_array_2

        # builtin.combine: ([2x32400x4xf32]) <- (2x32400x4xf32)
        combine_2 = [reshape_2]

        # pd_op.concat: (2x32400x4xf32) <- ([2x32400x4xf32], 1xi32)
