...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.assign: (-1x480x1x40xf32) <- (-1x480x1x40xf32)
        assign_0 = data_0

        # pd_op.conv2d: (-1x60x1x40xf32) <- (-1x480x1x40xf32, 60x480x1x3xf32)
        conv2d_0 = paddle._C_ops.conv2d(
            assign_0, parameter_52, [1, 1], [0, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (-1x60x1x40xf32, 60xf32, 60xf32, 60xf32, 60xf32, -1xui8) <- (-1x60x1x40xf32, 60xf32, 60xf32, 60xf32, 60xf32)
        (
            batch_norm__0,
            batch_norm__1,
            batch_norm__2,
        ...
        # pd_op.swish: (-1x60x1x40xf32) <- (-1x60x1x40xf32)
        swish_0 = paddle._C_ops.swish(batch_norm__0)

        # pd_op.conv2d: (-1x120x1x40xf32) <- (-1x60x1x40xf32, 120x60x1x1xf32)
        ...
        # pd_op.conv2d: (-1x480x1x40xf32) <- (-1x120x1x40xf32, 480x120x1x1xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            transpose_7, parameter_16, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (-1x480x1x40xf32, 480xf32, 480xf32, 480xf32, 480xf32, -1xui8) <- (-1x480x1x40xf32, 480xf32, 480xf32, 480xf32, 480xf32)
        (
            batch_norm__12,
            batch_norm__13,
            batch_norm__14,
        ...
        # pd_op.swish: (-1x480x1x40xf32) <- (-1x480x1x40xf32)
        ...
        # builtin.combine: ([-1x480x1x40xf32, -1x480x1x40xf32]) <- (-1x480x1x40xf32, -1x480x1x40xf32)
        combine_0 = [assign_0, swish_2]

        # pd_op.concat: (-1x960x1x40xf32) <- ([-1x480x1x40xf32, -1x480x1x40xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_2)

        # pd_op.conv2d: (-1x60x1x40xf32) <- (-1x960x1x40xf32, 60x960x1x3xf32)
