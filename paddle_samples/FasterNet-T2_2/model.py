...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_5 = [96, 288]

        # pd_op.split: ([-1x96x14x14xf32, -1x288x14x14xf32]) <- (-1x384x14x14xf32, 2xi64, 1xi32)
        split_29 = paddle._C_ops.split(batch_norm__27, full_int_array_5, full_0)
        ...
        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_6 = [192, 576]

        # pd_op.split: ([-1x192x7x7xf32, -1x576x7x7xf32]) <- (-1x768x7x7xf32, 2xi64, 1xi32)
        split_37 = paddle._C_ops.split(batch_norm__73, full_int_array_6, full_0)
