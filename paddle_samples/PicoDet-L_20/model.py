...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6, data_7):
        ...
        # builtin.combine: ([8x-1x-1xf32, 8x-1x-1xf32, 8x-1x-1xf32, 8x-1x-1xf32]) <- (8x-1x-1xf32, 8x-1x-1xf32, 8x-1x-1xf32, 8x-1x-1xf32)
        combine_0 = [multiply_0, multiply_1, multiply_2, multiply_3]

        # pd_op.concat: (8x-1x-1xf32) <- ([8x-1x-1xf32, 8x-1x-1xf32, 8x-1x-1xf32, 8x-1x-1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_2)

        # builtin.combine: ([8x-1x9xi64, 8x-1x9xi64, 8x-1x9xi64, 8x-1x9xi64]) <- (8x-1x9xi64, 8x-1x9xi64, 8x-1x9xi64, 8x-1x9xi64)
        combine_1 = [scale_0, add_0, add_1, add_2]

        # pd_op.concat: (8x-1x36xi64) <- ([8x-1x9xi64, 8x-1x9xi64, 8x-1x9xi64, 8x-1x9xi64], 1xi32)
