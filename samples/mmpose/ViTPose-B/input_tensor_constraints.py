...
dynamic_dim_constraint_input_shapes = [
    ...
    ([768], "L_self_modules_backbone_modules_ln1_parameters_bias_"),
    ([768], "L_self_modules_backbone_modules_ln1_parameters_weight_"),
    (
        [768],
    ...
    ([1, 192, 768], "L_self_modules_backbone_parameters_pos_embed_"),
    (
        [768, 256, 4, 4],
