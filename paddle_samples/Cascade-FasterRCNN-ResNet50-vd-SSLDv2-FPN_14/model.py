...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        concat_1 = paddle._C_ops.concat(combine_0, full_5)
        ...
        gather_0 = paddle._C_ops.gather(concat_0, distribute_fpn_proposals_0, full_5)
        ...
        split_12 = paddle._C_ops.split(reshape_0, full_int_array_7, full_5)
