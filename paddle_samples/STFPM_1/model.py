...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (1x64x-1x-1xf32) <- (1x-1x-1x-1xf32, 64x64x3x3xf32)
        conv2d_0 = paddle._C_ops.conv2d(
            data_0, parameter_19, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.add: (1x64x-1x-1xf32) <- (1x64x-1x-1xf32, 1x-1x-1x-1xf32)
        add_0 = paddle._C_ops.add(batch_norm__6, data_0)
        ...
        add_1 = paddle._C_ops.add(batch_norm__18, relu_2)
