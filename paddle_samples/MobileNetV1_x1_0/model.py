...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        depthwise_conv2d_0 = paddle._C_ops.depthwise_conv2d(
            relu_0, parameter_131, [1, 1], [1, 1], "EXPLICIT", 32, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_1 = paddle._C_ops.depthwise_conv2d(
            relu_2, parameter_121, [2, 2], [1, 1], "EXPLICIT", 64, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_2 = paddle._C_ops.depthwise_conv2d(
            relu_4, parameter_111, [1, 1], [1, 1], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_3 = paddle._C_ops.depthwise_conv2d(
            relu_6, parameter_101, [2, 2], [1, 1], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_4 = paddle._C_ops.depthwise_conv2d(
            relu_8, parameter_91, [1, 1], [1, 1], "EXPLICIT", 256, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_5 = paddle._C_ops.depthwise_conv2d(
            relu_10, parameter_81, [2, 2], [1, 1], "EXPLICIT", 256, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_6 = paddle._C_ops.depthwise_conv2d(
            relu_12, parameter_71, [1, 1], [1, 1], "EXPLICIT", 512, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x512x14x14xf32) <- (-1x512x14x14xf32, 512x512x1x1xf32)
        ...
        depthwise_conv2d_7 = paddle._C_ops.depthwise_conv2d(
            relu_14, parameter_61, [1, 1], [1, 1], "EXPLICIT", 512, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_8 = paddle._C_ops.depthwise_conv2d(
            relu_16, parameter_51, [1, 1], [1, 1], "EXPLICIT", 512, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_9 = paddle._C_ops.depthwise_conv2d(
            relu_18, parameter_41, [1, 1], [1, 1], "EXPLICIT", 512, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_10 = paddle._C_ops.depthwise_conv2d(
            relu_20, parameter_31, [1, 1], [1, 1], "EXPLICIT", 512, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_11 = paddle._C_ops.depthwise_conv2d(
            relu_22, parameter_21, [2, 2], [1, 1], "EXPLICIT", 512, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_12 = paddle._C_ops.depthwise_conv2d(
            relu_24, parameter_11, [1, 1], [1, 1], "EXPLICIT", 1024, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x1024x7x7xf32) <- (-1x1024x7x7xf32, 1024x1024x1x1xf32)
        ...
        # pd_op.flatten: (-1x1024xf32) <- (-1x1024x1x1xf32)
