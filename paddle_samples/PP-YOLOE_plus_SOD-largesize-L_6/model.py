...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.dropout: (1x-1x1024xf32, 1x-1x1024xui8) <- (1x-1x1024xf32, None, 1xf32)
        ...
        # pd_op.add: (1x-1x1024xf32) <- (1x-1x1024xf32, 1x-1x1024xf32)
        ...
        # pd_op.matmul: (1x-1x2048xf32) <- (1x-1x1024xf32, 1024x2048xf32)
        ...
        # pd_op.dropout: (1x-1x2048xf32, 1x-1x2048xui8) <- (1x-1x2048xf32, None, 1xf32)
