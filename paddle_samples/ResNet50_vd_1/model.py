...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        add_14 = paddle._C_ops.add(batch_norm__282, batch_norm__288)
        ...
        # pd_op.add: (-1x2048x7x7xf32) <- (-1x2048x7x7xf32, -1x2048x7x7xf32)
        add_15 = paddle._C_ops.add(batch_norm__306, relu_44)
        ...
        # pd_op.add: (-1x2048x7x7xf32) <- (-1x2048x7x7xf32, -1x2048x7x7xf32)
        add_16 = paddle._C_ops.add(batch_norm__324, relu_47)
