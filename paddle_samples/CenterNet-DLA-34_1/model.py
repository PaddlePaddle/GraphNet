...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.pool2d: (4x-1x-1x-1xf32) <- (4x-1x-1x-1xf32, 2xi64)
        ...
        # pd_op.conv2d: (4x512x-1x-1xf32) <- (4x-1x-1x-1xf32, 512x256x1x1xf32)
        ...
        # pd_op.conv2d: (4x512x-1x-1xf32) <- (4x-1x-1x-1xf32, 512x256x3x3xf32)
        ...
        relu_0 = paddle._C_ops.relu(batch_norm__33)
        ...
        # pd_op.relu: (4x512x-1x-1xf32) <- (4x512x-1x-1xf32)
        relu_2 = paddle._C_ops.relu(batch_norm__34)
        ...
        # builtin.combine: ([4x512x-1x-1xf32, 4x512x-1x-1xf32, 4x-1x-1x-1xf32]) <- (4x512x-1x-1xf32, 4x512x-1x-1xf32, 4x-1x-1x-1xf32)
        combine_0 = [relu_3, relu_1, pool2d_0]

        # pd_op.concat: (4x-1x-1x-1xf32) <- ([4x512x-1x-1xf32, 4x512x-1x-1xf32, 4x-1x-1x-1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_0)

        # pd_op.conv2d: (4x512x-1x-1xf32) <- (4x-1x-1x-1xf32, 512x1280x1x1xf32)
        ...
        # pd_op.relu: (4x512x-1x-1xf32) <- (4x512x-1x-1xf32)
        relu_4 = paddle._C_ops.relu(batch_norm__35)
        return (
            full_int_array_0,
            pool2d_0,
            conv2d_0,
