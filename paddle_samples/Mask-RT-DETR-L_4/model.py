...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.full_like: (2x-1x256xf32) <- (2x-1x256xf32, 1xf32)
        ...
        # pd_op.add: (2x-1x256xf32) <- (2x-1x256xf32, xf32)
        add_15 = paddle._C_ops.add(full_like_6, full_like_7)

        # pd_op.add: (2x-1x256xf32) <- (2x-1x256xf32, -1x-1x1xf32)
        ...
        # pd_op.add: (2x-1x256xf32) <- (xf32, 2x-1x256xf32)
        add_2 = paddle._C_ops.add(assign_value__0, add_0)

        # pd_op.add: (2x-1x256xf32) <- (-1x-1x1xf32, 2x-1x256xf32)
        add_16 = paddle._C_ops.add(cast_11, add_0)

        # pd_op.cast: (2x-1x256xb) <- (2x-1x256xf32)
        cast_0 = paddle._C_ops.cast(add_16, paddle.bool)

        # pd_op.where: (2x-1x256xf32) <- (2x-1x256xb, 2x-1x256xf32, 2x-1x256xf32)
        ...
        # pd_op.matmul: (2x-1x2xf32) <- (2x-1x256xf32, 256x2xf32)
        matmul_12 = paddle._C_ops.matmul(layer_norm_0, parameter_15, False, False)

        # pd_op.add: (2x-1x2xf32) <- (2x-1x2xf32, 2xf32)
        ...
        # pd_op.add: (2x-1x4xf32) <- (2x-1x4xf32, -1x-1x4xf32)
        add_5 = paddle._C_ops.add(add_4, where_0)

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_3 = [-1]

        # pd_op.max: (2x-1xf32) <- (2x-1x2xf32, 1xi64)
        ...
        # pd_op.topk: (2x300xf32, 2x300xi64) <- (2x-1xf32, 1xi32)
        ...
        arange_6 = paddle.arange(full_15, full_16, full_17, dtype="int64")
        ...
        # pd_op.gather_nd: (2x300x256xf32) <- (2x-1x256xf32, 2x300x2xi64)
        gather_nd_0 = paddle._C_ops.gather_nd(layer_norm_0, stack_0)

        # pd_op.gather_nd: (2x300x4xf32) <- (2x-1x4xf32, 2x300x2xi64)
        ...
        # pd_op.shape64: (4xi64) <- (2x32x-1x-1xf32)
        ...
        # pd_op.assign: (2x32x-1xf32) <- (2x32x-1xf32)
        assign_1 = flatten_0

        # pd_op.bmm: (2x300x-1xf32) <- (2x300x32xf32, 2x32x-1xf32)
        ...
        combine_17 = [full_18, full_19, slice_1, slice_2]

        # pd_op.stack: (4xi64) <- ([xi64, xi64, xi64, xi64])
        stack_10 = paddle._C_ops.stack(combine_17, 0)

        # pd_op.reshape: (2x300x-1x-1xf32) <- (2x300x-1xf32, 4xi64)
        ...
        # pd_op.greater_than: (2x300x-1x-1xb) <- (2x300x-1x-1xf32, xf32)
        greater_than_1 = paddle._C_ops.greater_than(reshape_0, full_20)

        # pd_op.shape64: (4xi64) <- (2x300x-1x-1xb)
        ...
        # pd_op.cast: (2x300x-1x-1xf32) <- (2x300x-1x-1xb)
        cast_15 = paddle._C_ops.cast(greater_than_1, paddle.float32)

        # pd_op.multiply: (2x300x-1x-1xf32) <- (-1x-1xf32, 2x300x-1x-1xf32)
        multiply_4 = paddle._C_ops.multiply(split_7, cast_15)

        # pd_op.flatten: (2x300x-1xf32) <- (2x300x-1x-1xf32)
        flatten_1 = paddle._C_ops.flatten(multiply_4, 2, 3)

        # pd_op.max: (2x300xf32) <- (2x300x-1xf32, 1xi64)
        ...
        # pd_op.full_like: (2x300x-1x-1xf32) <- (2x300x-1x-1xf32, 1xf32)
        ...
        # pd_op.full_like: (2x300x-1x-1xb) <- (2x300x-1x-1xb, 1xf32)
        ...
        # pd_op.any: (2x300xb) <- (2x300x-1x-1xb)
        ...
        split_with_num_0 = paddle._C_ops.split_with_num(divide_4, 4, full_23)
        ...
        scale_12 = paddle._C_ops.scale(add_32, full_24, float("0"), True)

        # pd_op.add: (2x300x1xf32) <- (2x300x1xf32, 2x300x1xf32)
        add_33 = paddle._C_ops.add(split_9, split_11)

        # pd_op.scale: (2x300x1xf32) <- (2x300x1xf32, 1xf32)
        scale_13 = paddle._C_ops.scale(add_33, full_24, float("0"), True)
        ...
        # pd_op.clip: (2x300x4xf32) <- (2x300x4xf32, 1xf32, 1xf32)
        clip_1 = paddle._C_ops.clip(clip_0, full_25, full_26)

        # pd_op.scale: (2x300x4xf32) <- (2x300x4xf32, 1xf32)
        scale_14 = paddle._C_ops.scale(clip_0, full_11, float("1"), True)

        # pd_op.clip: (2x300x4xf32) <- (2x300x4xf32, 1xf32, 1xf32)
        clip_2 = paddle._C_ops.clip(scale_14, full_25, full_26)
        ...
        # pd_op.bmm: (2x400x-1xf32) <- (2x400x32xf32, 2x32x-1xf32)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_24 = [full_18, full_27, slice_1, slice_2]

        # pd_op.stack: (4xi64) <- ([xi64, xi64, xi64, xi64])
        stack_13 = paddle._C_ops.stack(combine_24, 0)

        # pd_op.reshape: (2x400x-1x-1xf32) <- (2x400x-1xf32, 4xi64)
