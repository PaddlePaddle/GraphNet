...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.depthwise_conv2d: (4x320x-1x-1xf32) <- (4x-1x-1x-1xf32, 320x1x3x3xf32)
        depthwise_conv2d_0 = paddle._C_ops.depthwise_conv2d(
            data_0, parameter_59, [2, 2], [1, 1], "EXPLICIT", 320, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_1 = paddle._C_ops.depthwise_conv2d(
            hardswish_1, parameter_49, [1, 1], [2, 2], "EXPLICIT", 640, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_2 = paddle._C_ops.depthwise_conv2d(
            hardswish_3, parameter_39, [1, 1], [2, 2], "EXPLICIT", 640, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_3 = paddle._C_ops.depthwise_conv2d(
            hardswish_5, parameter_29, [1, 1], [2, 2], "EXPLICIT", 640, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_4 = paddle._C_ops.depthwise_conv2d(
            hardswish_7, parameter_19, [1, 1], [2, 2], "EXPLICIT", 640, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_5 = paddle._C_ops.depthwise_conv2d(
            hardswish_9, parameter_9, [1, 1], [2, 2], "EXPLICIT", 640, [1, 1], "NCHW"
        )
