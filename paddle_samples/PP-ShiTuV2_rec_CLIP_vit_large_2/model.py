...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        add_1 = paddle._C_ops.add(concat_0, data_2)
        ...
        add_2 = paddle._C_ops.add(matmul_1, parameter_288)
        ...
        add_3 = paddle._C_ops.add(matmul_4, parameter_286)
        ...
        add_5 = paddle._C_ops.add(matmul_5, parameter_282)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_6 = paddle._C_ops.add(matmul_6, parameter_280)
        ...
        # pd_op.add: (-1x257x3072xf32) <- (-1x257x3072xf32, 3072xf32)
        add_8 = paddle._C_ops.add(matmul_7, parameter_276)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_9 = paddle._C_ops.add(matmul_10, parameter_274)
        ...
        # pd_op.add: (-1x257x4096xf32) <- (-1x257x4096xf32, 4096xf32)
        add_11 = paddle._C_ops.add(matmul_11, parameter_270)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_12 = paddle._C_ops.add(matmul_12, parameter_268)
        ...
        # pd_op.add: (-1x257x3072xf32) <- (-1x257x3072xf32, 3072xf32)
        add_14 = paddle._C_ops.add(matmul_13, parameter_264)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_15 = paddle._C_ops.add(matmul_16, parameter_262)
        ...
        # pd_op.add: (-1x257x4096xf32) <- (-1x257x4096xf32, 4096xf32)
        add_17 = paddle._C_ops.add(matmul_17, parameter_258)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_18 = paddle._C_ops.add(matmul_18, parameter_256)
        ...
        # pd_op.add: (-1x257x3072xf32) <- (-1x257x3072xf32, 3072xf32)
        add_20 = paddle._C_ops.add(matmul_19, parameter_252)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_21 = paddle._C_ops.add(matmul_22, parameter_250)
        ...
        # pd_op.add: (-1x257x4096xf32) <- (-1x257x4096xf32, 4096xf32)
        add_23 = paddle._C_ops.add(matmul_23, parameter_246)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_24 = paddle._C_ops.add(matmul_24, parameter_244)
        ...
        # pd_op.add: (-1x257x3072xf32) <- (-1x257x3072xf32, 3072xf32)
        add_26 = paddle._C_ops.add(matmul_25, parameter_240)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_27 = paddle._C_ops.add(matmul_28, parameter_238)
        ...
        # pd_op.add: (-1x257x4096xf32) <- (-1x257x4096xf32, 4096xf32)
        add_29 = paddle._C_ops.add(matmul_29, parameter_234)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_30 = paddle._C_ops.add(matmul_30, parameter_232)
        ...
        # pd_op.add: (-1x257x3072xf32) <- (-1x257x3072xf32, 3072xf32)
        add_32 = paddle._C_ops.add(matmul_31, parameter_228)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_33 = paddle._C_ops.add(matmul_34, parameter_226)
        ...
        # pd_op.add: (-1x257x4096xf32) <- (-1x257x4096xf32, 4096xf32)
        add_35 = paddle._C_ops.add(matmul_35, parameter_222)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_36 = paddle._C_ops.add(matmul_36, parameter_220)
        ...
        # pd_op.add: (-1x257x3072xf32) <- (-1x257x3072xf32, 3072xf32)
        add_38 = paddle._C_ops.add(matmul_37, parameter_216)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_39 = paddle._C_ops.add(matmul_40, parameter_214)
        ...
        # pd_op.add: (-1x257x4096xf32) <- (-1x257x4096xf32, 4096xf32)
        add_41 = paddle._C_ops.add(matmul_41, parameter_210)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_42 = paddle._C_ops.add(matmul_42, parameter_208)
        ...
        # pd_op.add: (-1x257x3072xf32) <- (-1x257x3072xf32, 3072xf32)
        add_44 = paddle._C_ops.add(matmul_43, parameter_204)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_45 = paddle._C_ops.add(matmul_46, parameter_202)
        ...
        # pd_op.add: (-1x257x4096xf32) <- (-1x257x4096xf32, 4096xf32)
        add_47 = paddle._C_ops.add(matmul_47, parameter_198)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_48 = paddle._C_ops.add(matmul_48, parameter_196)
        ...
        # pd_op.add: (-1x257x3072xf32) <- (-1x257x3072xf32, 3072xf32)
        add_50 = paddle._C_ops.add(matmul_49, parameter_192)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_51 = paddle._C_ops.add(matmul_52, parameter_190)
        ...
        # pd_op.add: (-1x257x4096xf32) <- (-1x257x4096xf32, 4096xf32)
        add_53 = paddle._C_ops.add(matmul_53, parameter_186)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_54 = paddle._C_ops.add(matmul_54, parameter_184)
        ...
        # pd_op.add: (-1x257x3072xf32) <- (-1x257x3072xf32, 3072xf32)
        add_56 = paddle._C_ops.add(matmul_55, parameter_180)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_57 = paddle._C_ops.add(matmul_58, parameter_178)
        ...
        # pd_op.add: (-1x257x4096xf32) <- (-1x257x4096xf32, 4096xf32)
        add_59 = paddle._C_ops.add(matmul_59, parameter_174)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_60 = paddle._C_ops.add(matmul_60, parameter_172)
        ...
        # pd_op.add: (-1x257x3072xf32) <- (-1x257x3072xf32, 3072xf32)
        add_62 = paddle._C_ops.add(matmul_61, parameter_168)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_63 = paddle._C_ops.add(matmul_64, parameter_166)
        ...
        # pd_op.add: (-1x257x4096xf32) <- (-1x257x4096xf32, 4096xf32)
        add_65 = paddle._C_ops.add(matmul_65, parameter_162)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_66 = paddle._C_ops.add(matmul_66, parameter_160)
        ...
        # pd_op.add: (-1x257x3072xf32) <- (-1x257x3072xf32, 3072xf32)
        add_68 = paddle._C_ops.add(matmul_67, parameter_156)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_69 = paddle._C_ops.add(matmul_70, parameter_154)
        ...
        # pd_op.add: (-1x257x4096xf32) <- (-1x257x4096xf32, 4096xf32)
        add_71 = paddle._C_ops.add(matmul_71, parameter_150)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_72 = paddle._C_ops.add(matmul_72, parameter_148)
        ...
        # pd_op.shape64: (3xi64) <- (-1x257x1024xf32)
        shape64_14 = paddle._C_ops.shape64(layer_norm_75)
        ...
        # pd_op.add: (-1x257x3072xf32) <- (-1x257x3072xf32, 3072xf32)
        add_74 = paddle._C_ops.add(matmul_73, parameter_144)

        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_24 = paddle._C_ops.reshape(add_74, full_int_array_2)
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_38 = paddle._C_ops.transpose(slice_52, [0, 1, 3, 2])

        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_74 = paddle._C_ops.matmul(slice_51, transpose_38, False, False)
        ...
        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_75 = paddle._C_ops.matmul(softmax_12, slice_53, False, False)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_75 = paddle._C_ops.add(matmul_76, parameter_142)
        ...
        # pd_op.add: (-1x257x4096xf32) <- (-1x257x4096xf32, 4096xf32)
        add_77 = paddle._C_ops.add(matmul_77, parameter_138)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_78 = paddle._C_ops.add(matmul_78, parameter_136)
        ...
        # pd_op.shape64: (3xi64) <- (-1x257x1024xf32)
        shape64_15 = paddle._C_ops.shape64(layer_norm_81)
        ...
        # pd_op.add: (-1x257x3072xf32) <- (-1x257x3072xf32, 3072xf32)
        add_80 = paddle._C_ops.add(matmul_79, parameter_132)

        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_26 = paddle._C_ops.reshape(add_80, full_int_array_2)
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_41 = paddle._C_ops.transpose(slice_56, [0, 1, 3, 2])

        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_80 = paddle._C_ops.matmul(slice_55, transpose_41, False, False)
        ...
        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_81 = paddle._C_ops.matmul(softmax_13, slice_57, False, False)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_81 = paddle._C_ops.add(matmul_82, parameter_130)
        ...
        # pd_op.add: (-1x257x4096xf32) <- (-1x257x4096xf32, 4096xf32)
        add_83 = paddle._C_ops.add(matmul_83, parameter_126)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_84 = paddle._C_ops.add(matmul_84, parameter_124)
        ...
        # pd_op.shape64: (3xi64) <- (-1x257x1024xf32)
        shape64_16 = paddle._C_ops.shape64(layer_norm_87)
        ...
        # pd_op.add: (-1x257x3072xf32) <- (-1x257x3072xf32, 3072xf32)
        add_86 = paddle._C_ops.add(matmul_85, parameter_120)

        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_28 = paddle._C_ops.reshape(add_86, full_int_array_2)
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_44 = paddle._C_ops.transpose(slice_60, [0, 1, 3, 2])

        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_86 = paddle._C_ops.matmul(slice_59, transpose_44, False, False)
        ...
        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_87 = paddle._C_ops.matmul(softmax_14, slice_61, False, False)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_87 = paddle._C_ops.add(matmul_88, parameter_118)
        ...
        # pd_op.add: (-1x257x4096xf32) <- (-1x257x4096xf32, 4096xf32)
        add_89 = paddle._C_ops.add(matmul_89, parameter_114)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_90 = paddle._C_ops.add(matmul_90, parameter_112)
        ...
        # pd_op.shape64: (3xi64) <- (-1x257x1024xf32)
        shape64_17 = paddle._C_ops.shape64(layer_norm_93)
        ...
        # pd_op.add: (-1x257x3072xf32) <- (-1x257x3072xf32, 3072xf32)
        add_92 = paddle._C_ops.add(matmul_91, parameter_108)

        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_30 = paddle._C_ops.reshape(add_92, full_int_array_2)
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_47 = paddle._C_ops.transpose(slice_64, [0, 1, 3, 2])

        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_92 = paddle._C_ops.matmul(slice_63, transpose_47, False, False)
        ...
        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_93 = paddle._C_ops.matmul(softmax_15, slice_65, False, False)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_93 = paddle._C_ops.add(matmul_94, parameter_106)
        ...
        # pd_op.add: (-1x257x4096xf32) <- (-1x257x4096xf32, 4096xf32)
        add_95 = paddle._C_ops.add(matmul_95, parameter_102)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_96 = paddle._C_ops.add(matmul_96, parameter_100)
        ...
        # pd_op.shape64: (3xi64) <- (-1x257x1024xf32)
        shape64_18 = paddle._C_ops.shape64(layer_norm_99)
        ...
        # pd_op.add: (-1x257x3072xf32) <- (-1x257x3072xf32, 3072xf32)
        add_98 = paddle._C_ops.add(matmul_97, parameter_96)

        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_32 = paddle._C_ops.reshape(add_98, full_int_array_2)
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_50 = paddle._C_ops.transpose(slice_68, [0, 1, 3, 2])

        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_98 = paddle._C_ops.matmul(slice_67, transpose_50, False, False)
        ...
        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_99 = paddle._C_ops.matmul(softmax_16, slice_69, False, False)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_99 = paddle._C_ops.add(matmul_100, parameter_94)
        ...
        # pd_op.add: (-1x257x4096xf32) <- (-1x257x4096xf32, 4096xf32)
        add_101 = paddle._C_ops.add(matmul_101, parameter_90)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_102 = paddle._C_ops.add(matmul_102, parameter_88)
        ...
        # pd_op.shape64: (3xi64) <- (-1x257x1024xf32)
        shape64_19 = paddle._C_ops.shape64(layer_norm_105)
        ...
        # pd_op.add: (-1x257x3072xf32) <- (-1x257x3072xf32, 3072xf32)
        add_104 = paddle._C_ops.add(matmul_103, parameter_84)

        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_34 = paddle._C_ops.reshape(add_104, full_int_array_2)
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_53 = paddle._C_ops.transpose(slice_72, [0, 1, 3, 2])

        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_104 = paddle._C_ops.matmul(slice_71, transpose_53, False, False)
        ...
        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_105 = paddle._C_ops.matmul(softmax_17, slice_73, False, False)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_105 = paddle._C_ops.add(matmul_106, parameter_82)
        ...
        # pd_op.add: (-1x257x4096xf32) <- (-1x257x4096xf32, 4096xf32)
        add_107 = paddle._C_ops.add(matmul_107, parameter_78)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_108 = paddle._C_ops.add(matmul_108, parameter_76)
        ...
        # pd_op.shape64: (3xi64) <- (-1x257x1024xf32)
        shape64_20 = paddle._C_ops.shape64(layer_norm_111)
        ...
        # pd_op.add: (-1x257x3072xf32) <- (-1x257x3072xf32, 3072xf32)
        add_110 = paddle._C_ops.add(matmul_109, parameter_72)

        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_36 = paddle._C_ops.reshape(add_110, full_int_array_2)
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_56 = paddle._C_ops.transpose(slice_76, [0, 1, 3, 2])

        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_110 = paddle._C_ops.matmul(slice_75, transpose_56, False, False)
        ...
        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_111 = paddle._C_ops.matmul(softmax_18, slice_77, False, False)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_111 = paddle._C_ops.add(matmul_112, parameter_70)
        ...
        # pd_op.add: (-1x257x4096xf32) <- (-1x257x4096xf32, 4096xf32)
        add_113 = paddle._C_ops.add(matmul_113, parameter_66)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_114 = paddle._C_ops.add(matmul_114, parameter_64)
        ...
        # pd_op.shape64: (3xi64) <- (-1x257x1024xf32)
        shape64_21 = paddle._C_ops.shape64(layer_norm_117)
        ...
        # pd_op.add: (-1x257x3072xf32) <- (-1x257x3072xf32, 3072xf32)
        add_116 = paddle._C_ops.add(matmul_115, parameter_60)

        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_38 = paddle._C_ops.reshape(add_116, full_int_array_2)
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_59 = paddle._C_ops.transpose(slice_80, [0, 1, 3, 2])

        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_116 = paddle._C_ops.matmul(slice_79, transpose_59, False, False)
        ...
        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_117 = paddle._C_ops.matmul(softmax_19, slice_81, False, False)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_117 = paddle._C_ops.add(matmul_118, parameter_58)
        ...
        # pd_op.add: (-1x257x4096xf32) <- (-1x257x4096xf32, 4096xf32)
        add_119 = paddle._C_ops.add(matmul_119, parameter_54)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_120 = paddle._C_ops.add(matmul_120, parameter_52)
        ...
        # pd_op.shape64: (3xi64) <- (-1x257x1024xf32)
        shape64_22 = paddle._C_ops.shape64(layer_norm_123)
        ...
        # pd_op.add: (-1x257x3072xf32) <- (-1x257x3072xf32, 3072xf32)
        add_122 = paddle._C_ops.add(matmul_121, parameter_48)

        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_40 = paddle._C_ops.reshape(add_122, full_int_array_2)
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_62 = paddle._C_ops.transpose(slice_84, [0, 1, 3, 2])

        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_122 = paddle._C_ops.matmul(slice_83, transpose_62, False, False)
        ...
        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_123 = paddle._C_ops.matmul(softmax_20, slice_85, False, False)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_123 = paddle._C_ops.add(matmul_124, parameter_46)
        ...
        # pd_op.add: (-1x257x4096xf32) <- (-1x257x4096xf32, 4096xf32)
        add_125 = paddle._C_ops.add(matmul_125, parameter_42)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_126 = paddle._C_ops.add(matmul_126, parameter_40)
        ...
        # pd_op.shape64: (3xi64) <- (-1x257x1024xf32)
        shape64_23 = paddle._C_ops.shape64(layer_norm_129)
        ...
        # pd_op.add: (-1x257x3072xf32) <- (-1x257x3072xf32, 3072xf32)
        add_128 = paddle._C_ops.add(matmul_127, parameter_36)

        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_42 = paddle._C_ops.reshape(add_128, full_int_array_2)
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_65 = paddle._C_ops.transpose(slice_88, [0, 1, 3, 2])

        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_128 = paddle._C_ops.matmul(slice_87, transpose_65, False, False)
        ...
        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_129 = paddle._C_ops.matmul(softmax_21, slice_89, False, False)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_129 = paddle._C_ops.add(matmul_130, parameter_34)
        ...
        # pd_op.add: (-1x257x4096xf32) <- (-1x257x4096xf32, 4096xf32)
        add_131 = paddle._C_ops.add(matmul_131, parameter_30)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_132 = paddle._C_ops.add(matmul_132, parameter_28)
        ...
        # pd_op.shape64: (3xi64) <- (-1x257x1024xf32)
        shape64_24 = paddle._C_ops.shape64(layer_norm_135)
        ...
        # pd_op.add: (-1x257x3072xf32) <- (-1x257x3072xf32, 3072xf32)
        add_134 = paddle._C_ops.add(matmul_133, parameter_24)

        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_44 = paddle._C_ops.reshape(add_134, full_int_array_2)
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_68 = paddle._C_ops.transpose(slice_92, [0, 1, 3, 2])

        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_134 = paddle._C_ops.matmul(slice_91, transpose_68, False, False)
        ...
        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_135 = paddle._C_ops.matmul(softmax_22, slice_93, False, False)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_135 = paddle._C_ops.add(matmul_136, parameter_22)
        ...
        # pd_op.add: (-1x257x4096xf32) <- (-1x257x4096xf32, 4096xf32)
        add_137 = paddle._C_ops.add(matmul_137, parameter_18)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_138 = paddle._C_ops.add(matmul_138, parameter_16)
        ...
        # pd_op.shape64: (3xi64) <- (-1x257x1024xf32)
        shape64_25 = paddle._C_ops.shape64(layer_norm_141)
        ...
        # pd_op.add: (-1x257x3072xf32) <- (-1x257x3072xf32, 3072xf32)
        add_140 = paddle._C_ops.add(matmul_139, parameter_12)

        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_46 = paddle._C_ops.reshape(add_140, full_int_array_2)
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_71 = paddle._C_ops.transpose(slice_96, [0, 1, 3, 2])

        # pd_op.matmul: (-1x16x257x257xf32) <- (-1x16x257x64xf32, -1x16x64x257xf32)
        matmul_140 = paddle._C_ops.matmul(slice_95, transpose_71, False, False)
        ...
        # pd_op.matmul: (-1x16x257x64xf32) <- (-1x16x257x257xf32, -1x16x257x64xf32)
        matmul_141 = paddle._C_ops.matmul(softmax_23, slice_97, False, False)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_141 = paddle._C_ops.add(matmul_142, parameter_10)
        ...
        # pd_op.add: (-1x257x4096xf32) <- (-1x257x4096xf32, 4096xf32)
        add_143 = paddle._C_ops.add(matmul_143, parameter_6)
        ...
        # pd_op.add: (-1x257x1024xf32) <- (-1x257x1024xf32, 1024xf32)
        add_144 = paddle._C_ops.add(matmul_144, parameter_4)
        ...
        layer_norm_147, layer_norm_148, layer_norm_149 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                add_145, parameter_3, parameter_2, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )

        # pd_op.matmul: (-1x257x512xf32) <- (-1x257x1024xf32, 1024x512xf32)
        matmul_145 = paddle._C_ops.matmul(layer_norm_147, data_3, False, False)

        # pd_op.mean: (-1x512xf32) <- (-1x257x512xf32)
        mean_0 = paddle._C_ops.mean(matmul_145, [1], False)
        ...
        add_0 = paddle._C_ops.add(matmul_146, parameter_0)
