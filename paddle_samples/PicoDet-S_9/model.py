...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0):
        ...
        # builtin.combine: ([1296x4xf32, 324x4xf32, 81x4xf32, 25x4xf32]) <- (1296x4xf32, 324x4xf32, 81x4xf32, 25x4xf32)
        combine_12 = [reshape_0, reshape_1, reshape_2, reshape_3]

        # pd_op.concat: (1726x4xf32) <- ([1296x4xf32, 324x4xf32, 81x4xf32, 25x4xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_12, full_15)

        # builtin.combine: ([1296x2xf32, 324x2xf32, 81x2xf32, 25x2xf32]) <- (1296x2xf32, 324x2xf32, 81x2xf32, 25x2xf32)
        combine_13 = [reshape_4, reshape_5, reshape_6, reshape_7]

        # pd_op.concat: (1726x2xf32) <- ([1296x2xf32, 324x2xf32, 81x2xf32, 25x2xf32], 1xi32)
        concat_2 = paddle._C_ops.concat(combine_13, full_15)

        # builtin.combine: ([1296x1xf32, 324x1xf32, 81x1xf32, 25x1xf32]) <- (1296x1xf32, 324x1xf32, 81x1xf32, 25x1xf32)
        combine_14 = [full_5, full_8, full_11, full_14]

        # pd_op.concat: (1726x1xf32) <- ([1296x1xf32, 324x1xf32, 81x1xf32, 25x1xf32], 1xi32)
        ...
        # pd_op.share_data_: (16x1726x4xf32) <- (16x1726x4xf32)
        share_data__0 = data_0.detach()

        # pd_op.multiply: (16x1726x4xf32) <- (16x1726x4xf32, 1726x1xf32)
