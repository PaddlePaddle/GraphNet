...
dynamic_dim_constraint_input_shapes = [
    ...
    ([2, 64], "L_self_modules_classifier_parameters_weight_"),
    ([16], "L_self_modules_swinv2_modules_embeddings_modules_norm_parameters_bias_"),
    ([16], "L_self_modules_swinv2_modules_embeddings_modules_norm_parameters_weight_"),
    (
        [16],
    ...
    ([64], "L_self_modules_swinv2_modules_layernorm_parameters_bias_"),
    ([64], "L_self_modules_swinv2_modules_layernorm_parameters_weight_"),
]
