...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.assign: (1xi64) <- (1xi64)
        assign_62 = full_int_array_4

        # pd_op.assign: (1xi64) <- (1xi64)
        assign_61 = full_int_array_4
        ...
        combine_0 = [slice_25, full_7, full_7]
        ...
        full_int_array_5 = [-1, 197, 3, 12, 64]

        # pd_op.reshape: (-1x197x3x12x64xf32) <- (-1x197x2304xf32, 5xi64)
        reshape_12 = paddle._C_ops.reshape(add_1, full_int_array_5)
        ...
        slice_28 = paddle._C_ops.slice(
            transpose_1, [0], full_int_array_4, full_int_array_0, [1], [0]
        )
        ...
        transpose_2 = paddle._C_ops.transpose(slice_28, [0, 1, 3, 2])

        # pd_op.matmul: (-1x12x197x197xf32) <- (-1x12x197x64xf32, -1x12x64x197xf32)
        matmul_51 = paddle._C_ops.matmul(slice_0, transpose_2, False, False)
        ...
        scale_6 = paddle._C_ops.scale(matmul_51, full_1, float("0"), True)
        ...
        matmul_52 = paddle._C_ops.matmul(softmax_0, slice_1, False, False)

        # pd_op.transpose: (-1x197x12x64xf32) <- (-1x12x197x64xf32)
        transpose_3 = paddle._C_ops.transpose(matmul_52, [0, 2, 1, 3])

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_6 = [-1, 197, 768]
        ...
        # pd_op.reshape: (-1x197x3x12x64xf32) <- (-1x197x2304xf32, 5xi64)
        reshape_13 = paddle._C_ops.reshape(add_7, full_int_array_5)
        ...
        slice_30 = paddle._C_ops.slice(
            transpose_4, [0], full_int_array_4, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x12x64x197xf32) <- (-1x12x197x64xf32)
        transpose_5 = paddle._C_ops.transpose(slice_30, [0, 1, 3, 2])

        # pd_op.matmul: (-1x12x197x197xf32) <- (-1x12x197x64xf32, -1x12x64x197xf32)
        matmul_53 = paddle._C_ops.matmul(slice_2, transpose_5, False, False)

        # pd_op.scale: (-1x12x197x197xf32) <- (-1x12x197x197xf32, 1xf32)
        scale_7 = paddle._C_ops.scale(matmul_53, full_1, float("0"), True)

        # pd_op.softmax: (-1x12x197x197xf32) <- (-1x12x197x197xf32)
        softmax_1 = paddle._C_ops.softmax(scale_7, -1)

        # pd_op.matmul: (-1x12x197x64xf32) <- (-1x12x197x197xf32, -1x12x197x64xf32)
        matmul_54 = paddle._C_ops.matmul(softmax_1, slice_3, False, False)

        # pd_op.transpose: (-1x197x12x64xf32) <- (-1x12x197x64xf32)
        transpose_6 = paddle._C_ops.transpose(matmul_54, [0, 2, 1, 3])
        ...
        # pd_op.reshape: (-1x197x3x12x64xf32) <- (-1x197x2304xf32, 5xi64)
        reshape_14 = paddle._C_ops.reshape(add_13, full_int_array_5)
        ...
        slice_32 = paddle._C_ops.slice(
            transpose_7, [0], full_int_array_4, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x12x64x197xf32) <- (-1x12x197x64xf32)
        transpose_8 = paddle._C_ops.transpose(slice_32, [0, 1, 3, 2])

        # pd_op.matmul: (-1x12x197x197xf32) <- (-1x12x197x64xf32, -1x12x64x197xf32)
        matmul_55 = paddle._C_ops.matmul(slice_4, transpose_8, False, False)

        # pd_op.scale: (-1x12x197x197xf32) <- (-1x12x197x197xf32, 1xf32)
        scale_8 = paddle._C_ops.scale(matmul_55, full_1, float("0"), True)

        # pd_op.softmax: (-1x12x197x197xf32) <- (-1x12x197x197xf32)
        softmax_2 = paddle._C_ops.softmax(scale_8, -1)

        # pd_op.matmul: (-1x12x197x64xf32) <- (-1x12x197x197xf32, -1x12x197x64xf32)
        matmul_56 = paddle._C_ops.matmul(softmax_2, slice_5, False, False)

        # pd_op.transpose: (-1x197x12x64xf32) <- (-1x12x197x64xf32)
        transpose_9 = paddle._C_ops.transpose(matmul_56, [0, 2, 1, 3])
        ...
        # pd_op.reshape: (-1x197x3x12x64xf32) <- (-1x197x2304xf32, 5xi64)
        reshape_15 = paddle._C_ops.reshape(add_19, full_int_array_5)
        ...
        slice_34 = paddle._C_ops.slice(
            transpose_10, [0], full_int_array_4, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x12x64x197xf32) <- (-1x12x197x64xf32)
        transpose_11 = paddle._C_ops.transpose(slice_34, [0, 1, 3, 2])

        # pd_op.matmul: (-1x12x197x197xf32) <- (-1x12x197x64xf32, -1x12x64x197xf32)
        matmul_57 = paddle._C_ops.matmul(slice_6, transpose_11, False, False)

        # pd_op.scale: (-1x12x197x197xf32) <- (-1x12x197x197xf32, 1xf32)
        scale_9 = paddle._C_ops.scale(matmul_57, full_1, float("0"), True)

        # pd_op.softmax: (-1x12x197x197xf32) <- (-1x12x197x197xf32)
        softmax_3 = paddle._C_ops.softmax(scale_9, -1)

        # pd_op.matmul: (-1x12x197x64xf32) <- (-1x12x197x197xf32, -1x12x197x64xf32)
        matmul_58 = paddle._C_ops.matmul(softmax_3, slice_7, False, False)

        # pd_op.transpose: (-1x197x12x64xf32) <- (-1x12x197x64xf32)
        transpose_12 = paddle._C_ops.transpose(matmul_58, [0, 2, 1, 3])
        ...
        # pd_op.reshape: (-1x197x3x12x64xf32) <- (-1x197x2304xf32, 5xi64)
        reshape_16 = paddle._C_ops.reshape(add_25, full_int_array_5)
        ...
        slice_36 = paddle._C_ops.slice(
            transpose_13, [0], full_int_array_4, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x12x64x197xf32) <- (-1x12x197x64xf32)
        transpose_14 = paddle._C_ops.transpose(slice_36, [0, 1, 3, 2])

        # pd_op.matmul: (-1x12x197x197xf32) <- (-1x12x197x64xf32, -1x12x64x197xf32)
        matmul_59 = paddle._C_ops.matmul(slice_8, transpose_14, False, False)

        # pd_op.scale: (-1x12x197x197xf32) <- (-1x12x197x197xf32, 1xf32)
        scale_10 = paddle._C_ops.scale(matmul_59, full_1, float("0"), True)

        # pd_op.softmax: (-1x12x197x197xf32) <- (-1x12x197x197xf32)
        softmax_4 = paddle._C_ops.softmax(scale_10, -1)

        # pd_op.matmul: (-1x12x197x64xf32) <- (-1x12x197x197xf32, -1x12x197x64xf32)
        matmul_60 = paddle._C_ops.matmul(softmax_4, slice_9, False, False)

        # pd_op.transpose: (-1x197x12x64xf32) <- (-1x12x197x64xf32)
        transpose_15 = paddle._C_ops.transpose(matmul_60, [0, 2, 1, 3])
        ...
        # pd_op.reshape: (-1x197x3x12x64xf32) <- (-1x197x2304xf32, 5xi64)
        reshape_17 = paddle._C_ops.reshape(add_31, full_int_array_5)
        ...
        slice_38 = paddle._C_ops.slice(
            transpose_16, [0], full_int_array_4, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x12x64x197xf32) <- (-1x12x197x64xf32)
        transpose_17 = paddle._C_ops.transpose(slice_38, [0, 1, 3, 2])

        # pd_op.matmul: (-1x12x197x197xf32) <- (-1x12x197x64xf32, -1x12x64x197xf32)
        matmul_61 = paddle._C_ops.matmul(slice_10, transpose_17, False, False)
        ...
        # pd_op.matmul: (-1x12x197x64xf32) <- (-1x12x197x197xf32, -1x12x197x64xf32)
        matmul_62 = paddle._C_ops.matmul(softmax_5, slice_11, False, False)

        # pd_op.transpose: (-1x197x12x64xf32) <- (-1x12x197x64xf32)
        transpose_18 = paddle._C_ops.transpose(matmul_62, [0, 2, 1, 3])
        ...
        # pd_op.reshape: (-1x197x3x12x64xf32) <- (-1x197x2304xf32, 5xi64)
        reshape_18 = paddle._C_ops.reshape(add_37, full_int_array_5)
        ...
        slice_40 = paddle._C_ops.slice(
            transpose_19, [0], full_int_array_4, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x12x64x197xf32) <- (-1x12x197x64xf32)
        transpose_20 = paddle._C_ops.transpose(slice_40, [0, 1, 3, 2])

        # pd_op.matmul: (-1x12x197x197xf32) <- (-1x12x197x64xf32, -1x12x64x197xf32)
        matmul_63 = paddle._C_ops.matmul(slice_12, transpose_20, False, False)

        # pd_op.scale: (-1x12x197x197xf32) <- (-1x12x197x197xf32, 1xf32)
        scale_12 = paddle._C_ops.scale(matmul_63, full_1, float("0"), True)

        # pd_op.softmax: (-1x12x197x197xf32) <- (-1x12x197x197xf32)
        softmax_6 = paddle._C_ops.softmax(scale_12, -1)

        # pd_op.matmul: (-1x12x197x64xf32) <- (-1x12x197x197xf32, -1x12x197x64xf32)
        matmul_64 = paddle._C_ops.matmul(softmax_6, slice_13, False, False)

        # pd_op.transpose: (-1x197x12x64xf32) <- (-1x12x197x64xf32)
        transpose_21 = paddle._C_ops.transpose(matmul_64, [0, 2, 1, 3])
        ...
        slice_41 = paddle._C_ops.slice(
            shape64_9, [0], full_int_array_3, full_int_array_4, [1], [0]
        )
        ...
        # pd_op.reshape: (-1x197x3x12x64xf32) <- (-1x197x2304xf32, 5xi64)
        reshape_19 = paddle._C_ops.reshape(add_43, full_int_array_5)
        ...
        slice_42 = paddle._C_ops.slice(
            transpose_22, [0], full_int_array_4, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x12x64x197xf32) <- (-1x12x197x64xf32)
        transpose_23 = paddle._C_ops.transpose(slice_42, [0, 1, 3, 2])

        # pd_op.matmul: (-1x12x197x197xf32) <- (-1x12x197x64xf32, -1x12x64x197xf32)
        matmul_65 = paddle._C_ops.matmul(slice_14, transpose_23, False, False)

        # pd_op.scale: (-1x12x197x197xf32) <- (-1x12x197x197xf32, 1xf32)
        scale_13 = paddle._C_ops.scale(matmul_65, full_1, float("0"), True)

        # pd_op.softmax: (-1x12x197x197xf32) <- (-1x12x197x197xf32)
        softmax_7 = paddle._C_ops.softmax(scale_13, -1)

        # pd_op.matmul: (-1x12x197x64xf32) <- (-1x12x197x197xf32, -1x12x197x64xf32)
        matmul_66 = paddle._C_ops.matmul(softmax_7, slice_15, False, False)

        # pd_op.transpose: (-1x197x12x64xf32) <- (-1x12x197x64xf32)
        transpose_24 = paddle._C_ops.transpose(matmul_66, [0, 2, 1, 3])
        ...
        # pd_op.reshape: (-1x197x3x12x64xf32) <- (-1x197x2304xf32, 5xi64)
        reshape_20 = paddle._C_ops.reshape(add_49, full_int_array_5)
        ...
        slice_44 = paddle._C_ops.slice(
            transpose_25, [0], full_int_array_4, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x12x64x197xf32) <- (-1x12x197x64xf32)
        transpose_26 = paddle._C_ops.transpose(slice_44, [0, 1, 3, 2])

        # pd_op.matmul: (-1x12x197x197xf32) <- (-1x12x197x64xf32, -1x12x64x197xf32)
        matmul_67 = paddle._C_ops.matmul(slice_16, transpose_26, False, False)

        # pd_op.scale: (-1x12x197x197xf32) <- (-1x12x197x197xf32, 1xf32)
        scale_14 = paddle._C_ops.scale(matmul_67, full_1, float("0"), True)

        # pd_op.softmax: (-1x12x197x197xf32) <- (-1x12x197x197xf32)
        softmax_8 = paddle._C_ops.softmax(scale_14, -1)

        # pd_op.matmul: (-1x12x197x64xf32) <- (-1x12x197x197xf32, -1x12x197x64xf32)
        matmul_68 = paddle._C_ops.matmul(softmax_8, slice_17, False, False)

        # pd_op.transpose: (-1x197x12x64xf32) <- (-1x12x197x64xf32)
        transpose_27 = paddle._C_ops.transpose(matmul_68, [0, 2, 1, 3])
        ...
        slice_45 = paddle._C_ops.slice(
            shape64_11, [0], full_int_array_3, full_int_array_4, [1], [0]
        )
        ...
        # pd_op.reshape: (-1x197x3x12x64xf32) <- (-1x197x2304xf32, 5xi64)
        reshape_21 = paddle._C_ops.reshape(add_55, full_int_array_5)
        ...
        slice_46 = paddle._C_ops.slice(
            transpose_28, [0], full_int_array_4, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x12x64x197xf32) <- (-1x12x197x64xf32)
        transpose_29 = paddle._C_ops.transpose(slice_46, [0, 1, 3, 2])

        # pd_op.matmul: (-1x12x197x197xf32) <- (-1x12x197x64xf32, -1x12x64x197xf32)
        matmul_69 = paddle._C_ops.matmul(slice_18, transpose_29, False, False)

        # pd_op.scale: (-1x12x197x197xf32) <- (-1x12x197x197xf32, 1xf32)
        scale_15 = paddle._C_ops.scale(matmul_69, full_1, float("0"), True)

        # pd_op.softmax: (-1x12x197x197xf32) <- (-1x12x197x197xf32)
        softmax_9 = paddle._C_ops.softmax(scale_15, -1)

        # pd_op.matmul: (-1x12x197x64xf32) <- (-1x12x197x197xf32, -1x12x197x64xf32)
        matmul_70 = paddle._C_ops.matmul(softmax_9, slice_19, False, False)

        # pd_op.transpose: (-1x197x12x64xf32) <- (-1x12x197x64xf32)
        transpose_30 = paddle._C_ops.transpose(matmul_70, [0, 2, 1, 3])
        ...
        slice_47 = paddle._C_ops.slice(
            shape64_12, [0], full_int_array_3, full_int_array_4, [1], [0]
        )
        ...
        # pd_op.reshape: (-1x197x3x12x64xf32) <- (-1x197x2304xf32, 5xi64)
        reshape_22 = paddle._C_ops.reshape(add_61, full_int_array_5)
        ...
        slice_48 = paddle._C_ops.slice(
            transpose_31, [0], full_int_array_4, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x12x64x197xf32) <- (-1x12x197x64xf32)
        transpose_32 = paddle._C_ops.transpose(slice_48, [0, 1, 3, 2])

        # pd_op.matmul: (-1x12x197x197xf32) <- (-1x12x197x64xf32, -1x12x64x197xf32)
        matmul_71 = paddle._C_ops.matmul(slice_20, transpose_32, False, False)

        # pd_op.scale: (-1x12x197x197xf32) <- (-1x12x197x197xf32, 1xf32)
        scale_16 = paddle._C_ops.scale(matmul_71, full_1, float("0"), True)

        # pd_op.softmax: (-1x12x197x197xf32) <- (-1x12x197x197xf32)
        softmax_10 = paddle._C_ops.softmax(scale_16, -1)

        # pd_op.matmul: (-1x12x197x64xf32) <- (-1x12x197x197xf32, -1x12x197x64xf32)
        matmul_72 = paddle._C_ops.matmul(softmax_10, slice_21, False, False)

        # pd_op.transpose: (-1x197x12x64xf32) <- (-1x12x197x64xf32)
        transpose_33 = paddle._C_ops.transpose(matmul_72, [0, 2, 1, 3])
        ...
        slice_49 = paddle._C_ops.slice(
            shape64_13, [0], full_int_array_3, full_int_array_4, [1], [0]
        )
        ...
        # pd_op.reshape: (-1x197x3x12x64xf32) <- (-1x197x2304xf32, 5xi64)
        reshape_23 = paddle._C_ops.reshape(add_67, full_int_array_5)
        ...
        slice_50 = paddle._C_ops.slice(
            transpose_34, [0], full_int_array_4, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x12x64x197xf32) <- (-1x12x197x64xf32)
        transpose_35 = paddle._C_ops.transpose(slice_50, [0, 1, 3, 2])

        # pd_op.matmul: (-1x12x197x197xf32) <- (-1x12x197x64xf32, -1x12x64x197xf32)
        matmul_73 = paddle._C_ops.matmul(slice_22, transpose_35, False, False)

        # pd_op.scale: (-1x12x197x197xf32) <- (-1x12x197x197xf32, 1xf32)
        scale_17 = paddle._C_ops.scale(matmul_73, full_1, float("0"), True)

        # pd_op.softmax: (-1x12x197x197xf32) <- (-1x12x197x197xf32)
        softmax_11 = paddle._C_ops.softmax(scale_17, -1)

        # pd_op.matmul: (-1x12x197x64xf32) <- (-1x12x197x197xf32, -1x12x197x64xf32)
        matmul_74 = paddle._C_ops.matmul(softmax_11, slice_23, False, False)

        # pd_op.transpose: (-1x197x12x64xf32) <- (-1x12x197x64xf32)
        transpose_36 = paddle._C_ops.transpose(matmul_74, [0, 2, 1, 3])
        ...
        slice_24 = paddle._C_ops.slice(
            add_72, [1], full_int_array_4, full_int_array_2, [1], []
        )
        ...
        layer_norm_75, layer_norm_76, layer_norm_77 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                slice_24, parameter_3, parameter_2, float("1e-05"), 2
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )

        # pd_op.matmul: (-1x196x512xf32) <- (-1x196x768xf32, 768x512xf32)
        matmul_48 = paddle._C_ops.matmul(layer_norm_75, data_4, False, False)

        # pd_op.mean: (-1x512xf32) <- (-1x196x512xf32)
        mean_0 = paddle._C_ops.mean(matmul_48, [1], False)

        # pd_op.matmul: (-1x512xf32) <- (-1x512xf32, 512x512xf32)
        matmul_49 = paddle._C_ops.matmul(mean_0, parameter_1, False, False)

        # pd_op.add: (-1x512xf32) <- (-1x512xf32, 512xf32)
        add_74 = paddle._C_ops.add(matmul_49, parameter_0)

        # pd_op.square: (-1x512xf32) <- (-1x512xf32)
        square_0 = paddle._C_ops.square(add_74)

        # pd_op.sum: (-1x1xf32) <- (-1x512xf32, 1xi64)
        sum_0 = paddle._C_ops.sum(square_0, full_int_array_4, None, True)

        # pd_op.sqrt: (-1x1xf32) <- (-1x1xf32)
        sqrt_0 = paddle._C_ops.sqrt(sum_0)

        # pd_op.divide: (-1x512xf32) <- (-1x512xf32, -1x1xf32)
        divide_0 = paddle._C_ops.divide(add_74, sqrt_0)

        # pd_op.square: (512x159xf32) <- (512x159xf32)
        square_1 = paddle._C_ops.square(data_5)

        # pd_op.sum: (1x159xf32) <- (512x159xf32, 1xi64)
        sum_1 = paddle._C_ops.sum(square_1, full_int_array_3, None, True)

        # pd_op.sqrt: (1x159xf32) <- (1x159xf32)
        sqrt_1 = paddle._C_ops.sqrt(sum_1)

        # pd_op.divide: (512x159xf32) <- (512x159xf32, 1x159xf32)
        divide_1 = paddle._C_ops.divide(data_5, sqrt_1)

        # pd_op.matmul: (-1x159xf32) <- (-1x512xf32, 512x159xf32)
        matmul_50 = paddle._C_ops.matmul(divide_0, divide_1, False, False)

        # pd_op.square: (-1x159xf32) <- (-1x159xf32)
        square_2 = paddle._C_ops.square(matmul_50)
        ...
        scale_18 = paddle._C_ops.scale(square_2, full_2, float("1"), True)
        ...
        # pd_op.scale: (-1x159xf32) <- (-1x159xf32, 1xf32)
        scale_19 = paddle._C_ops.scale(scale_18, full_3, float("1e-06"), True)

        # pd_op.sqrt: (-1x159xf32) <- (-1x159xf32)
        sqrt_2 = paddle._C_ops.sqrt(scale_19)
        ...
        # pd_op.scale: (-1x159xf32) <- (-1x159xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(matmul_50, full_4, float("0"), True)
        ...
        # pd_op.scale: (-1x159xf32) <- (-1x159xf32, 1xf32)
        scale_2 = paddle._C_ops.scale(matmul_50, full_3, float("-0.0397339"), True)
        ...
        greater_than_0 = paddle._C_ops.greater_than(matmul_50, full_8)
        ...
        add_73 = paddle._C_ops.add(multiply_0, multiply_1)
        ...
        one_hot_0 = paddle._C_ops.one_hot(
            data_1 % paddle.cast(full_9, data_1.dtype), full_9
        )

        # pd_op.squeeze: (-1x159xf32) <- (-1x1x159xf32, 1xi64)
        squeeze_0 = paddle._C_ops.squeeze(one_hot_0, full_int_array_4)

        # pd_op.multiply: (-1x159xf32) <- (-1x159xf32, -1x159xf32)
        multiply_2 = paddle._C_ops.multiply(squeeze_0, add_73)

        # pd_op.scale: (-1x159xf32) <- (-1x159xf32, 1xf32)
        scale_4 = paddle._C_ops.scale(squeeze_0, full_2, float("1"), True)

        # pd_op.multiply: (-1x159xf32) <- (-1x159xf32, -1x159xf32)
        multiply_3 = paddle._C_ops.multiply(scale_4, matmul_50)
        ...
        # pd_op.scale: (-1x159xf32) <- (-1x159xf32, 1xf32)
        scale_5 = paddle._C_ops.scale(add_75, full_6, float("0"), True)
        return (
            conv2d_0,
            transpose_0,
            stack_0,
