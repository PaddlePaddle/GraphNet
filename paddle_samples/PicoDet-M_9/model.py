...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0):
        ...
        # builtin.combine: ([1936x4xf32, 484x4xf32, 121x4xf32, 36x4xf32]) <- (1936x4xf32, 484x4xf32, 121x4xf32, 36x4xf32)
        combine_12 = [reshape_0, reshape_1, reshape_2, reshape_3]

        # pd_op.concat: (2577x4xf32) <- ([1936x4xf32, 484x4xf32, 121x4xf32, 36x4xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_12, full_15)

        # builtin.combine: ([1936x2xf32, 484x2xf32, 121x2xf32, 36x2xf32]) <- (1936x2xf32, 484x2xf32, 121x2xf32, 36x2xf32)
        combine_13 = [reshape_4, reshape_5, reshape_6, reshape_7]

        # pd_op.concat: (2577x2xf32) <- ([1936x2xf32, 484x2xf32, 121x2xf32, 36x2xf32], 1xi32)
        concat_2 = paddle._C_ops.concat(combine_13, full_15)

        # builtin.combine: ([1936x1xf32, 484x1xf32, 121x1xf32, 36x1xf32]) <- (1936x1xf32, 484x1xf32, 121x1xf32, 36x1xf32)
        combine_14 = [full_5, full_8, full_11, full_14]

        # pd_op.concat: (2577x1xf32) <- ([1936x1xf32, 484x1xf32, 121x1xf32, 36x1xf32], 1xi32)
        ...
        # pd_op.share_data_: (4x2577x4xf32) <- (4x2577x4xf32)
        share_data__0 = data_0.detach()

        # pd_op.multiply: (4x2577x4xf32) <- (4x2577x4xf32, 2577x1xf32)
