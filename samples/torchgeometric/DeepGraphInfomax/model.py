...
class GraphModule(torch.nn.Module):
    def forward(
        self,
        L_args_0_store_mapping_edge_index_: torch.Tensor,
        L_args_0_store_mapping_x_: torch.Tensor,
        L_self_modules_encoder_modules_conv_modules_lin_parameters_weight_: torch.nn.parameter.Parameter,
        L_self_modules_encoder_modules_conv_parameters_bias_: torch.nn.parameter.Parameter,
        L_self_modules_encoder_modules_prelu_parameters_weight_: torch.nn.parameter.Parameter,
    ):
        l_args_0_store_mapping_edge_index_ = L_args_0_store_mapping_edge_index_
        l_args_0_store_mapping_x_ = L_args_0_store_mapping_x_
        l_self_modules_encoder_modules_conv_modules_lin_parameters_weight_ = (
            L_self_modules_encoder_modules_conv_modules_lin_parameters_weight_
        )
        l_self_modules_encoder_modules_conv_parameters_bias_ = (
            L_self_modules_encoder_modules_conv_parameters_bias_
        )
        l_self_modules_encoder_modules_prelu_parameters_weight_ = (
            L_self_modules_encoder_modules_prelu_parameters_weight_
        )
        getitem = l_args_0_store_mapping_edge_index_[0]
        getitem_1 = l_args_0_store_mapping_edge_index_[1]
        ...
        view = None
        edge_index = l_args_0_store_mapping_edge_index_[(slice(None, None, None), mask)]
        l_args_0_store_mapping_edge_index_ = mask = None
        ...
        out_2 = out_1 + l_self_modules_encoder_modules_conv_parameters_bias_
        out_1 = l_self_modules_encoder_modules_conv_parameters_bias_ = None
        pos_z = torch.prelu(
            out_2, l_self_modules_encoder_modules_prelu_parameters_weight_
        )
        out_2 = l_self_modules_encoder_modules_prelu_parameters_weight_ = None
        return (pos_z,)
