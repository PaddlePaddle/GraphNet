...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6, data_7):
        ...
        # pd_op.share_data_: (13770x11xf32) <- (13770x11xf32)
        ...
        # pd_op.max: (13770x1xf32) <- (13770x11xf32, 1xi64)
        ...
        # pd_op.sum: (xf32) <- (13770x11xf32, 0xi64)
        sum_1 = paddle._C_ops.sum(data_0, full_int_array_0, None, False)

        # pd_op.cast: (13770x11xf32) <- (13770x11xf32)
        ...
        # pd_op.greater_than: (13770x11xb) <- (13770x11xf32, xf32)
        greater_than_0 = paddle._C_ops.greater_than(cast_0, full_11)

        # pd_op.cast: (13770x11xf32) <- (13770x11xb)
        cast_5 = paddle._C_ops.cast(greater_than_0, paddle.float32)

        # pd_op.multiply: (13770x11xf32) <- (13770x11xf32, 13770x11xf32)
        multiply_7 = paddle._C_ops.multiply(cast_0, cast_5)

        # pd_op.subtract: (13770x11xf32) <- (13770x11xf32, 13770x11xf32)
        subtract_9 = paddle._C_ops.subtract(data_1, cast_0)

        # pd_op.abs: (13770x11xf32) <- (13770x11xf32)
        abs_0 = paddle._C_ops.abs(subtract_9)

        # pd_op.pow: (13770x11xf32) <- (13770x11xf32)
        ...
        # pd_op.scale: (13770x11xf32) <- (13770x11xf32, 1xf32)
        scale_5 = paddle._C_ops.scale(pow_0, full_7, float("0"), True)

        # pd_op.less_equal: (13770x11xb) <- (13770x11xf32, xf32)
