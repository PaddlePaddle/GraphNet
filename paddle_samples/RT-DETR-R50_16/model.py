...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # builtin.combine: ([4x-1x4xf32, 4x300x4xf32]) <- (4x-1x4xf32, 4x300x4xf32)
        combine_17 = [data_8, gather_nd_1]

        # pd_op.concat: (4x-1x4xf32) <- ([4x-1x4xf32, 4x300x4xf32], 1xi32)
        concat_5 = paddle._C_ops.concat(combine_17, full_8)

        # pd_op.share_data_: (4x-1x4xf32) <- (4x-1x4xf32)
        ...
        # builtin.combine: ([4x-1x256xf32, 4x300x256xf32]) <- (4x-1x256xf32, 4x300x256xf32)
        combine_18 = [data_7, share_data__0]

        # pd_op.concat: (4x-1x256xf32) <- ([4x-1x256xf32, 4x300x256xf32], 1xi32)
