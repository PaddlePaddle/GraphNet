...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.pool2d: (8x576x1x1xf32) <- (8x576x-1x-1xf32, 2xi64)
        ...
        # pd_op.conv2d: (8x576x1x1xf32) <- (8x576x1x1xf32, 576x576x1x1xf32)
        ...
        # pd_op.add: (8x576x1x1xf32) <- (8x576x1x1xf32, 1x576x1x1xf32)
        add_0 = paddle._C_ops.add(conv2d_0, reshape_6)

        # pd_op.sigmoid: (8x576x1x1xf32) <- (8x576x1x1xf32)
        sigmoid_0 = paddle._C_ops.sigmoid(add_0)
        del add_0

        # pd_op.multiply: (8x576x-1x-1xf32) <- (8x576x-1x-1xf32, 8x576x1x1xf32)
        multiply_0 = paddle._C_ops.multiply(data_6, sigmoid_0)

        # pd_op.conv2d: (8x576x-1x-1xf32) <- (8x576x-1x-1xf32, 576x576x1x1xf32)
        conv2d_1 = paddle._C_ops.conv2d(
            multiply_0, parameter_51, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_51

        # pd_op.batch_norm_: (8x576x-1x-1xf32, 576xf32, 576xf32, 576xf32, 576xf32, -1xui8) <- (8x576x-1x-1xf32, 576xf32, 576xf32, 576xf32, 576xf32)
        (
            batch_norm__0,
            batch_norm__1,
            batch_norm__2,
        ...
        # pd_op.swish: (8x576x-1x-1xf32) <- (8x576x-1x-1xf32)
        swish_0 = paddle._C_ops.swish(batch_norm__0)

        # pd_op.add: (8x576x-1x-1xf32) <- (8x576x-1x-1xf32, 8x576x-1x-1xf32)
        add_1 = paddle._C_ops.add(swish_0, data_6)

        # pd_op.conv2d: (8x4x-1x-1xf32) <- (8x576x-1x-1xf32, 4x576x3x3xf32)
        ...
        # pd_op.conv2d: (8x68x-1x-1xf32) <- (8x576x-1x-1xf32, 68x576x3x3xf32)
        ...
        # pd_op.pool2d: (8x288x1x1xf32) <- (8x288x-1x-1xf32, 2xi64)
        ...
        # pd_op.conv2d: (8x288x1x1xf32) <- (8x288x1x1xf32, 288x288x1x1xf32)
        ...
        # pd_op.add: (8x288x1x1xf32) <- (8x288x1x1xf32, 1x288x1x1xf32)
        ...
        # pd_op.multiply: (8x288x-1x-1xf32) <- (8x288x-1x-1xf32, 8x288x1x1xf32)
        multiply_2 = paddle._C_ops.multiply(data_7, sigmoid_3)

        # pd_op.conv2d: (8x288x-1x-1xf32) <- (8x288x-1x-1xf32, 288x288x1x1xf32)
        conv2d_7 = paddle._C_ops.conv2d(
            multiply_2, parameter_33, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_33

        # pd_op.batch_norm_: (8x288x-1x-1xf32, 288xf32, 288xf32, 288xf32, 288xf32, -1xui8) <- (8x288x-1x-1xf32, 288xf32, 288xf32, 288xf32, 288xf32)
        (
            batch_norm__12,
            batch_norm__13,
            batch_norm__14,
        ...
        # pd_op.swish: (8x288x-1x-1xf32) <- (8x288x-1x-1xf32)
        swish_2 = paddle._C_ops.swish(batch_norm__12)

        # pd_op.add: (8x288x-1x-1xf32) <- (8x288x-1x-1xf32, 8x288x-1x-1xf32)
        add_6 = paddle._C_ops.add(swish_2, data_7)

        # pd_op.conv2d: (8x4x-1x-1xf32) <- (8x288x-1x-1xf32, 4x288x3x3xf32)
        ...
        # pd_op.conv2d: (8x68x-1x-1xf32) <- (8x288x-1x-1xf32, 68x288x3x3xf32)
        ...
        # pd_op.pool2d: (8x144x1x1xf32) <- (8x144x-1x-1xf32, 2xi64)
        ...
        # pd_op.conv2d: (8x144x1x1xf32) <- (8x144x1x1xf32, 144x144x1x1xf32)
        ...
        # pd_op.add: (8x144x1x1xf32) <- (8x144x1x1xf32, 1x144x1x1xf32)
        add_10 = paddle._C_ops.add(conv2d_12, reshape_14)

        # pd_op.sigmoid: (8x144x1x1xf32) <- (8x144x1x1xf32)
        sigmoid_6 = paddle._C_ops.sigmoid(add_10)
        del add_10

        # pd_op.multiply: (8x144x-1x-1xf32) <- (8x144x-1x-1xf32, 8x144x1x1xf32)
        multiply_4 = paddle._C_ops.multiply(data_8, sigmoid_6)

        # pd_op.conv2d: (8x144x-1x-1xf32) <- (8x144x-1x-1xf32, 144x144x1x1xf32)
        conv2d_13 = paddle._C_ops.conv2d(
            multiply_4, parameter_15, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del parameter_15

        # pd_op.batch_norm_: (8x144x-1x-1xf32, 144xf32, 144xf32, 144xf32, 144xf32, -1xui8) <- (8x144x-1x-1xf32, 144xf32, 144xf32, 144xf32, 144xf32)
        (
            batch_norm__24,
            batch_norm__25,
            batch_norm__26,
        ...
        # pd_op.swish: (8x144x-1x-1xf32) <- (8x144x-1x-1xf32)
        swish_4 = paddle._C_ops.swish(batch_norm__24)

        # pd_op.add: (8x144x-1x-1xf32) <- (8x144x-1x-1xf32, 8x144x-1x-1xf32)
        add_11 = paddle._C_ops.add(swish_4, data_8)

        # pd_op.conv2d: (8x4x-1x-1xf32) <- (8x144x-1x-1xf32, 4x144x3x3xf32)
        ...
        # pd_op.conv2d: (8x68x-1x-1xf32) <- (8x144x-1x-1xf32, 68x144x3x3xf32)
