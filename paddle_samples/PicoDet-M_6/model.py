...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5):
        ...
        # pd_op.flatten: (4x-1xf32) <- (4x1x-1xf32)
        ...
        # pd_op.index_sample: (4x36xf32) <- (4x-1xf32, 4x36xi64)
        ...
        # pd_op.mean: (4x1x1xf32) <- (4x1x36xf32)
        ...
        # pd_op.greater_than: (4x1x-1xb) <- (4x1x-1xf32, 4x1x1xf32)
        ...
        # pd_op.full_like: (4x1x-1xf32) <- (4x1x-1xf32, 1xf32)
        full_like_0 = paddle._C_ops.full_like(
            data_0, full_2, paddle.float32, paddle.framework._current_expected_place()
        )

        # pd_op.where: (4x1x-1xf32) <- (4x1x-1xb, 4x1x-1xf32, 4x1x-1xf32)
        ...
        # pd_op.subtract: (4x1x-1x1xf32) <- (1x1x-1x1xf32, 4x1x1x1xf32)
        subtract_1 = paddle._C_ops.subtract(split_0, split_2)

        # pd_op.subtract: (4x1x-1x1xf32) <- (1x1x-1x1xf32, 4x1x1x1xf32)
        subtract_2 = paddle._C_ops.subtract(split_1, split_3)

        # pd_op.subtract: (4x1x-1x1xf32) <- (4x1x1x1xf32, 1x1x-1x1xf32)
        ...
        # builtin.combine: ([4x1x-1x1xf32, 4x1x-1x1xf32, 4x1x-1x1xf32, 4x1x-1x1xf32]) <- (4x1x-1x1xf32, 4x1x-1x1xf32, 4x1x-1x1xf32, 4x1x-1x1xf32)
        combine_0 = [subtract_1, subtract_2, subtract_3, subtract_4]

        # pd_op.concat: (4x1x-1x4xf32) <- ([4x1x-1x1xf32, 4x1x-1x1xf32, 4x1x-1x1xf32, 4x1x-1x1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_4)

        # pd_op.min: (4x1x-1xf32) <- (4x1x-1x4xf32, 1xi64)
        ...
        # pd_op.greater_than: (4x1x-1xb) <- (4x1x-1xf32, xf32)
        greater_than_3 = paddle._C_ops.greater_than(min_0, full_5)

        # pd_op.cast: (4x1x-1xf32) <- (4x1x-1xb)
        ...
        # pd_op.sum: (4x-1xf32) <- (4x1x-1xf32, 1xi64)
