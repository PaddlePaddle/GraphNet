...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6, data_7):
        ...
        add_0 = paddle._C_ops.add(topk_3, data_1)
        ...
        # pd_op.add: (2x-1x9xi64) <- (2x-1x9xi64, xi64)
        add_1 = paddle._C_ops.add(topk_5, data_2)
        ...
        # pd_op.shape64: (3xi64) <- (2x-1x-1xf32)
        shape64_3 = paddle._C_ops.shape64(data_6)
        ...
        # pd_op.add: (2x-1x9xi64) <- (2x-1x9xi64, xi64)
        add_2 = paddle._C_ops.add(topk_7, data_0)

        # pd_op.one_hot: (2x-1x9x-1xf32) <- (2x-1x9xi64, xi64)
        one_hot_3 = paddle._C_ops.one_hot(
            topk_7 % paddle.cast(slice_7, topk_7.dtype), slice_7
        )

        # pd_op.sum: (2x-1x-1xf32) <- (2x-1x9x-1xf32, 1xi64)
        sum_3 = paddle._C_ops.sum(one_hot_3, full_int_array_3, None, False)
