...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        ...
        # pd_op.argmax: (1x21504xi64) <- (1x25x21504xf32, 1xi64)
        argmax_0 = paddle._C_ops.argmax(data_0, full_0, False, False, paddle.int64)
        del full_0

        # pd_op.full: (1xf32) <- ()
        full_1 = paddle._C_ops.full(
            [1], float("25"), paddle.float32, paddle.core.CPUPlace()
        )
        ...
        # pd_op.flatten: (25xi32) <- (1x25x1xi32)
        ...
        # pd_op.gather: (21504xi32) <- (25xi32, 21504xi64, 1xi32)
        ...
        # pd_op.reshape: (25x5xf32) <- (1x25x5xf32, 2xi64)
        reshape_2 = paddle._C_ops.reshape(data_4, full_int_array_1)
        del data_4, full_int_array_1

        # pd_op.gather: (21504x5xf32) <- (25x5xf32, 21504xi64, 1xi32)
        ...
        # pd_op.max: (1x25x1xf32) <- (1x25x21504xf32, 1xi64)
        ...
        # pd_op.divide: (1x25x21504xf32) <- (1x25x21504xf32, 1x25x1xf32)
        ...
        # pd_op.max: (1x21504xf32) <- (1x25x21504xf32, 1xi64)
