...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.topk: (2x60x13xf32, 2x60x13xi64) <- (2x60x2541xf32, 1xi32)
        ...
        # pd_op.one_hot: (2x60x13x2541xf32) <- (2x60x13xi64, 1xi32)
        ...
        # pd_op.sum: (2x60x2541xf32) <- (2x60x13x2541xf32, 1xi64)
        sum_0 = paddle._C_ops.sum(one_hot_0, full_int_array_0, None, False)

        # pd_op.multiply: (2x60x2541xf32) <- (2x60x2541xf32, 2x60x1xf32)
