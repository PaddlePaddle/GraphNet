...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.slice: (1x3x272x200xf32) <- (4x3x272x200xf32, 1xi64, 1xi64)
        slice_0 = paddle._C_ops.slice(
            data_0, [0], full_int_array_0, full_int_array_1, [1], []
        )

        # pd_op.slice: (1x12x272x200xf32) <- (4x12x272x200xf32, 1xi64, 1xi64)
        ...
        # pd_op.full_like: (163200x4xf32) <- (163200x4xf32, 1xf32)
        full_like_0 = paddle._C_ops.full_like(
            data_10, full_0, paddle.float32, paddle.framework._current_expected_place()
        )

        # pd_op.generate_proposals: (-1x4xf32, -1x1xf32, 1xf32) <- (1x3x272x200xf32, 1x12x272x200xf32, 1x2xf32, 163200x4xf32, 163200x4xf32)
        ...
        # pd_op.slice: (1x3x136x100xf32) <- (4x3x136x100xf32, 1xi64, 1xi64)
        slice_3 = paddle._C_ops.slice(
            data_1, [0], full_int_array_0, full_int_array_1, [1], []
        )

        # pd_op.slice: (1x12x136x100xf32) <- (4x12x136x100xf32, 1xi64, 1xi64)
        slice_4 = paddle._C_ops.slice(
            data_6, [0], full_int_array_0, full_int_array_1, [1], []
        )

        # pd_op.full_like: (40800x4xf32) <- (40800x4xf32, 1xf32)
        full_like_1 = paddle._C_ops.full_like(
            data_11, full_0, paddle.float32, paddle.framework._current_expected_place()
        )

        # pd_op.generate_proposals: (-1x4xf32, -1x1xf32, 1xf32) <- (1x3x136x100xf32, 1x12x136x100xf32, 1x2xf32, 40800x4xf32, 40800x4xf32)
        ...
        # pd_op.slice: (1x3x68x50xf32) <- (4x3x68x50xf32, 1xi64, 1xi64)
        slice_5 = paddle._C_ops.slice(
            data_2, [0], full_int_array_0, full_int_array_1, [1], []
        )

        # pd_op.slice: (1x12x68x50xf32) <- (4x12x68x50xf32, 1xi64, 1xi64)
        slice_6 = paddle._C_ops.slice(
            data_7, [0], full_int_array_0, full_int_array_1, [1], []
        )

        # pd_op.full_like: (10200x4xf32) <- (10200x4xf32, 1xf32)
        full_like_2 = paddle._C_ops.full_like(
            data_12, full_0, paddle.float32, paddle.framework._current_expected_place()
        )

        # pd_op.generate_proposals: (-1x4xf32, -1x1xf32, 1xf32) <- (1x3x68x50xf32, 1x12x68x50xf32, 1x2xf32, 10200x4xf32, 10200x4xf32)
        ...
        # pd_op.slice: (1x3x34x25xf32) <- (4x3x34x25xf32, 1xi64, 1xi64)
        slice_7 = paddle._C_ops.slice(
            data_3, [0], full_int_array_0, full_int_array_1, [1], []
        )

        # pd_op.slice: (1x12x34x25xf32) <- (4x12x34x25xf32, 1xi64, 1xi64)
        slice_8 = paddle._C_ops.slice(
            data_8, [0], full_int_array_0, full_int_array_1, [1], []
        )

        # pd_op.full_like: (2550x4xf32) <- (2550x4xf32, 1xf32)
        full_like_3 = paddle._C_ops.full_like(
            data_13, full_0, paddle.float32, paddle.framework._current_expected_place()
        )

        # pd_op.generate_proposals: (-1x4xf32, -1x1xf32, 1xf32) <- (1x3x34x25xf32, 1x12x34x25xf32, 1x2xf32, 2550x4xf32, 2550x4xf32)
        ...
        # pd_op.slice: (1x3x17x13xf32) <- (4x3x17x13xf32, 1xi64, 1xi64)
        slice_9 = paddle._C_ops.slice(
            data_4, [0], full_int_array_0, full_int_array_1, [1], []
        )

        # pd_op.slice: (1x12x17x13xf32) <- (4x12x17x13xf32, 1xi64, 1xi64)
        slice_10 = paddle._C_ops.slice(
            data_9, [0], full_int_array_0, full_int_array_1, [1], []
        )

        # pd_op.full_like: (663x4xf32) <- (663x4xf32, 1xf32)
        full_like_4 = paddle._C_ops.full_like(
            data_14, full_0, paddle.float32, paddle.framework._current_expected_place()
        )

        # pd_op.generate_proposals: (-1x4xf32, -1x1xf32, 1xf32) <- (1x3x17x13xf32, 1x12x17x13xf32, 1x2xf32, 663x4xf32, 663x4xf32)
        ...
        full_2 = paddle._C_ops.full(
            [], float("1000"), paddle.int32, paddle.framework._current_expected_place()
        )
