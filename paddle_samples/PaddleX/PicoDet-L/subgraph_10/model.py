...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        ...
        # pd_op.flatten: (-1x-1xf32) <- (8x-1x-1xf32)
        flatten_0 = paddle._C_ops.flatten(multiply_0, 0, 1)

        # pd_op.flatten: (-1x36xi64) <- (8x-1x36xi64)
        flatten_1 = paddle._C_ops.flatten(data_2, 0, 1)
        del data_2

        # pd_op.index_sample: (-1x36xf32) <- (-1x-1xf32, -1x36xi64)
        ...
        # pd_op.reshape: (8x-1x-1xf32) <- (-1x36xf32, 3xi64)
        ...
        # pd_op.split_with_num: ([8x-1x1x1xf32, 8x-1x1x1xf32, 8x-1x1x1xf32, 8x-1x1x1xf32]) <- (8x-1x1x4xf32, 1xi32)
        split_with_num_1 = paddle._C_ops.split_with_num(unsqueeze_1, 4, full_4)
        del full_4, unsqueeze_1

        # builtin.split: (8x-1x1x1xf32, 8x-1x1x1xf32, 8x-1x1x1xf32, 8x-1x1x1xf32) <- ([8x-1x1x1xf32, 8x-1x1x1xf32, 8x-1x1x1xf32, 8x-1x1x1xf32])
        (
            split_2,
            split_3,
            split_4,
        ...
        # pd_op.subtract: (8x-1x-1x1xf32) <- (1x1x-1x1xf32, 8x-1x1x1xf32)
        ...
        # pd_op.subtract: (8x-1x-1x1xf32) <- (8x-1x1x1xf32, 1x1x-1x1xf32)
        ...
        # builtin.combine: ([8x-1x-1x1xf32, 8x-1x-1x1xf32, 8x-1x-1x1xf32, 8x-1x-1x1xf32]) <- (8x-1x-1x1xf32, 8x-1x-1x1xf32, 8x-1x-1x1xf32, 8x-1x-1x1xf32)
        combine_1 = [subtract_1, subtract_2, subtract_3, subtract_4]
        del subtract_1, subtract_2, subtract_3, subtract_4

        # pd_op.concat: (8x-1x-1x4xf32) <- ([8x-1x-1x1xf32, 8x-1x-1x1xf32, 8x-1x-1x1xf32, 8x-1x-1x1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_1, full_5)
        del combine_1, full_5

        # pd_op.min: (8x-1x-1xf32) <- (8x-1x-1x4xf32, 1xi64)
        ...
        # pd_op.greater_than: (8x-1x-1xb) <- (8x-1x-1xf32, xf32)
        greater_than_2 = paddle._C_ops.greater_than(min_0, full_6)
        del full_6, min_0

        # pd_op.cast: (8x-1x-1xf32) <- (8x-1x-1xb)
        ...
        # pd_op.sum: (8x-1xf32) <- (8x-1x-1xf32, 1xi64)
