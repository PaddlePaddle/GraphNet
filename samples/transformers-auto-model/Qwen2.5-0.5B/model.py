...
class GraphModule(torch.nn.Module):
    ...
    def forward(self, s0 : torch.SymInt, L_stack0_last_hidden_state : torch.Tensor, L_logits_to_keep_ : torch.SymInt, L_self_modules_lm_head_parameters_weight_ : torch.nn.parameter.Parameter):
        ...
        logits = torch._C._nn.linear(getitem, l_self_modules_lm_head_parameters_weight_, None);  getitem = l_self_modules_lm_head_parameters_weight_ = None
        return (logits,)
