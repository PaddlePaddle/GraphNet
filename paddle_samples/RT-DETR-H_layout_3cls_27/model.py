...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.matmul: (1x8400x11xf32) <- (1x8400x256xf32, 256x11xf32)
        matmul_1 = paddle._C_ops.matmul(layer_norm_0, parameter_7, False, False)

        # pd_op.add: (1x8400x11xf32) <- (1x8400x11xf32, 11xf32)
        ...
        # pd_op.max: (1x8400xf32) <- (1x8400x11xf32, 1xi64)
        ...
        # builtin.combine: ([1x198x4xf32, 1x300x4xf32]) <- (1x198x4xf32, 1x300x4xf32)
        combine_11 = [data_2, gather_nd_1]

        # pd_op.concat: (1x498x4xf32) <- ([1x198x4xf32, 1x300x4xf32], 1xi32)
        concat_5 = paddle._C_ops.concat(combine_11, full_13)

        # pd_op.share_data_: (1x498x4xf32) <- (1x498x4xf32)
        share_data__1 = concat_5.detach()

        # pd_op.gather_nd: (1x300x11xf32) <- (1x8400x11xf32, 1x300x2xi64)
        ...
        # builtin.combine: ([1x198x256xf32, 1x300x256xf32]) <- (1x198x256xf32, 1x300x256xf32)
        combine_12 = [data_1, share_data__0]

        # pd_op.concat: (1x498x256xf32) <- ([1x198x256xf32, 1x300x256xf32], 1xi32)
