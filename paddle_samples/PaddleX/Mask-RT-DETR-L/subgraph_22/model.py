...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.add: (2x-1x256xf32) <- (2x-1x256xf32, 1x-1x256xf32)
        ...
        # pd_op.transpose: (2x8x-1x32xf32) <- (2x-1x8x32xf32)
        ...
        # pd_op.matmul: (2x8x-1x-1xf32) <- (2x8x-1x32xf32, 2x8x-1x32xf32)
        ...
        # pd_op.scale: (2x8x-1x-1xf32) <- (2x8x-1x-1xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(matmul_3, full_0, float("0"), True)
        del matmul_3

        # pd_op.softmax: (2x8x-1x-1xf32) <- (2x8x-1x-1xf32)
        softmax_0 = paddle._C_ops.softmax(scale_0, -1)
        del scale_0

        # pd_op.matmul: (2x8x-1x32xf32) <- (2x8x-1x-1xf32, 2x8x-1x32xf32)
        matmul_4 = paddle._C_ops.matmul(softmax_0, transpose_2, False, False)

        # pd_op.transpose: (2x-1x8x32xf32) <- (2x8x-1x32xf32)
        ...
        # pd_op.reshape: (2x-1x256xf32) <- (2x-1x8x32xf32, 3xi64)
        ...
        # pd_op.gelu: (2x-1x1024xf32) <- (2x-1x1024xf32)
