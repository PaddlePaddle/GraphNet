...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.split_with_num: ([125x1xf32, 125x1xf32, 125x1xf32, 125x1xf32]) <- (125x4xf32, 1xi32)
        split_with_num_0 = paddle._C_ops.split_with_num(data_0, 4, full_0)

        # builtin.split: (125x1xf32, 125x1xf32, 125x1xf32, 125x1xf32) <- ([125x1xf32, 125x1xf32, 125x1xf32, 125x1xf32])
        (
            split_0,
            split_1,
            split_2,
        ...
        # pd_op.clip: (125x1xf32) <- (125x1xf32, 1xf32, 1xf32)
        ...
        # pd_op.multiply: (125x1xf32) <- (125x1xf32, 125x1xf32)
        ...
        # pd_op.subtract: (125x1xf32) <- (125x1xf32, 125x1xf32)
        subtract_7 = paddle._C_ops.subtract(split_6, split_4)

        # pd_op.subtract: (125x1xf32) <- (125x1xf32, 125x1xf32)
        subtract_8 = paddle._C_ops.subtract(split_7, split_5)

        # pd_op.multiply: (125x1xf32) <- (125x1xf32, 125x1xf32)
        multiply_2 = paddle._C_ops.multiply(subtract_7, subtract_8)

        # pd_op.add: (125x1xf32) <- (125x1xf32, 125x1xf32)
        add_0 = paddle._C_ops.add(multiply_1, multiply_2)

        # pd_op.subtract: (125x1xf32) <- (125x1xf32, 125x1xf32)
        subtract_9 = paddle._C_ops.subtract(add_0, multiply_0)
        ...
        # pd_op.scale: (125x1xf32) <- (125x1xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(subtract_9, full_3, float("1e-10"), True)

        # pd_op.divide: (125x1xf32) <- (125x1xf32, 125x1xf32)
        ...
        # pd_op.multiply: (125x1xf32) <- (125x1xf32, 125x1xf32)
        multiply_3 = paddle._C_ops.multiply(subtract_4, subtract_5)
        ...
        # pd_op.scale: (125x1xf32) <- (125x1xf32, 1xf32)
        scale_2 = paddle._C_ops.scale(scale_3, full_5, float("0"), True)
        return (
            full_0,
            split_0,
            split_1,
