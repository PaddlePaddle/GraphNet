...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        combine_1 = [full_2, data_1, full_2]
        del data_1, full_2
        ...
        # pd_op.max: (4x-1x1xf32) <- (4x-1x-1xf32, 1xi64)
        ...
        # pd_op.scale: (4x-1x1xf32) <- (4x-1x1xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(max_0, full_7, float("1e-09"), True)
        del full_7, max_0

        # pd_op.divide: (4x-1x-1xf32) <- (4x-1x-1xf32, 4x-1x1xf32)
