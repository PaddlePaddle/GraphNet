...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.add: (64x64x56x56xf32) <- (64x64x56x56xf32, 64x64x56x56xf32)
        ...
        # pd_op.conv2d: (64x128x28x28xf32) <- (64x64x56x56xf32, 128x64x3x3xf32)
        ...
        # pd_op.pool2d: (64x64x28x28xf32) <- (64x64x56x56xf32, 2xi64)
        ...
        # pd_op.conv2d: (64x128x28x28xf32) <- (64x64x28x28xf32, 128x64x1x1xf32)
        ...
        # pd_op.add: (64x128x28x28xf32) <- (64x128x28x28xf32, 64x128x28x28xf32)
        add_3 = paddle._C_ops.add(batch_norm__48, batch_norm__54)
        ...
        # pd_op.add: (64x128x28x28xf32) <- (64x128x28x28xf32, 64x128x28x28xf32)
        add_4 = paddle._C_ops.add(batch_norm__65, relu_8)

        # pd_op.relu: (64x128x28x28xf32) <- (64x128x28x28xf32)
        relu_10 = paddle._C_ops.relu(add_4)

        # pd_op.conv2d: (64x256x14x14xf32) <- (64x128x28x28xf32, 256x128x3x3xf32)
        ...
        relu_11 = paddle._C_ops.relu(batch_norm__134)
        ...
        # pd_op.pool2d: (64x128x14x14xf32) <- (64x128x28x28xf32, 2xi64)
        ...
        # pd_op.conv2d: (64x256x14x14xf32) <- (64x128x14x14xf32, 256x128x1x1xf32)
        ...
        # pd_op.add: (64x256x14x14xf32) <- (64x256x14x14xf32, 64x256x14x14xf32)
        add_5 = paddle._C_ops.add(batch_norm__76, batch_norm__82)
        ...
        # pd_op.relu: (64x256x14x14xf32) <- (64x256x14x14xf32)
        relu_13 = paddle._C_ops.relu(batch_norm__135)
        ...
        # pd_op.add: (64x256x14x14xf32) <- (64x256x14x14xf32, 64x256x14x14xf32)
        add_6 = paddle._C_ops.add(batch_norm__93, relu_12)

        # pd_op.relu: (64x256x14x14xf32) <- (64x256x14x14xf32)
        relu_14 = paddle._C_ops.relu(add_6)

        # pd_op.conv2d: (64x512x7x7xf32) <- (64x256x14x14xf32, 512x256x3x3xf32)
        ...
        relu_15 = paddle._C_ops.relu(batch_norm__136)
        ...
        # pd_op.pool2d: (64x256x7x7xf32) <- (64x256x14x14xf32, 2xi64)
        ...
        # pd_op.conv2d: (64x512x7x7xf32) <- (64x256x7x7xf32, 512x256x1x1xf32)
        ...
        # pd_op.add: (64x512x7x7xf32) <- (64x512x7x7xf32, 64x512x7x7xf32)
        add_7 = paddle._C_ops.add(batch_norm__104, batch_norm__110)
        ...
        # pd_op.relu: (64x512x7x7xf32) <- (64x512x7x7xf32)
        relu_17 = paddle._C_ops.relu(batch_norm__137)
        ...
        # pd_op.add: (64x512x7x7xf32) <- (64x512x7x7xf32, 64x512x7x7xf32)
        add_8 = paddle._C_ops.add(batch_norm__121, relu_16)
        ...
        # pd_op.pool2d: (64x512x1x1xf32) <- (64x512x7x7xf32, 2xi64)
        ...
        # pd_op.flatten: (64x512xf32) <- (64x512x1x1xf32)
        flatten_0 = paddle._C_ops.flatten(pool2d_4, 1, 3)

        # pd_op.matmul: (64x102xf32) <- (64x512xf32, 512x102xf32)
