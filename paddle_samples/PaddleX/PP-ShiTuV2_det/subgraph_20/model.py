...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.slice: (4xf32) <- (4x2xf32, 1xi64, 1xi64)
        ...
        # pd_op.clip: (4xf32) <- (4xf32, 1xf32, 1xf32)
        ...
        # builtin.combine: ([4xf32, 4xf32, 4xf32, 4xf32]) <- (4xf32, 4xf32, 4xf32, 4xf32)
        combine_0 = [clip_0, clip_1, clip_2, clip_3]
        del clip_0, clip_1, clip_2, clip_3

        # pd_op.stack: (4x4xf32) <- ([4xf32, 4xf32, 4xf32, 4xf32])
