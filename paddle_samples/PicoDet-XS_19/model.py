...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.depthwise_conv2d: (4x48x-1x-1xf32) <- (4x-1x-1x-1xf32, 48x1x3x3xf32)
        depthwise_conv2d_0 = paddle._C_ops.depthwise_conv2d(
            data_0, parameter_59, [2, 2], [1, 1], "EXPLICIT", 48, [1, 1], "NCHW"
        )

        # pd_op.batch_norm_: (4x48x-1x-1xf32, 48xf32, 48xf32, 48xf32, 48xf32, -1xui8) <- (4x48x-1x-1xf32, 48xf32, 48xf32, 48xf32, 48xf32)
        (
            batch_norm__0,
            batch_norm__1,
            batch_norm__2,
        ...
        # pd_op.hardswish: (4x48x-1x-1xf32) <- (4x48x-1x-1xf32)
        hardswish_0 = paddle._C_ops.hardswish(batch_norm__0)

        # pd_op.conv2d: (4x88x-1x-1xf32) <- (4x48x-1x-1xf32, 88x48x1x1xf32)
        conv2d_0 = paddle._C_ops.conv2d(
            hardswish_0, parameter_54, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (4x88x-1x-1xf32, 88xf32, 88xf32, 88xf32, 88xf32, -1xui8) <- (4x88x-1x-1xf32, 88xf32, 88xf32, 88xf32, 88xf32)
        (
            batch_norm__6,
            batch_norm__7,
            batch_norm__8,
        ...
        # pd_op.hardswish: (4x88x-1x-1xf32) <- (4x88x-1x-1xf32)
        hardswish_1 = paddle._C_ops.hardswish(batch_norm__6)

        # pd_op.depthwise_conv2d: (4x88x-1x-1xf32) <- (4x88x-1x-1xf32, 88x1x5x5xf32)
        depthwise_conv2d_1 = paddle._C_ops.depthwise_conv2d(
            hardswish_1, parameter_49, [1, 1], [2, 2], "EXPLICIT", 88, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (4x88x-1x-1xf32) <- (4x88x-1x-1xf32, 88x88x1x1xf32)
        ...
        depthwise_conv2d_2 = paddle._C_ops.depthwise_conv2d(
            hardswish_3, parameter_39, [1, 1], [2, 2], "EXPLICIT", 88, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_3 = paddle._C_ops.depthwise_conv2d(
            hardswish_5, parameter_29, [1, 1], [2, 2], "EXPLICIT", 88, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_4 = paddle._C_ops.depthwise_conv2d(
            hardswish_7, parameter_19, [1, 1], [2, 2], "EXPLICIT", 88, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_5 = paddle._C_ops.depthwise_conv2d(
            hardswish_9, parameter_9, [1, 1], [2, 2], "EXPLICIT", 88, [1, 1], "NCHW"
        )
