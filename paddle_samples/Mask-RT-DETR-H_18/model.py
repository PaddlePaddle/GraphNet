...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0):
        # pd_op.share_data_: (-1x128x128xf32) <- (-1x128x128xf32)
        share_data__0 = data_0.detach()

        # pd_op.shape64: (3xi64) <- (-1x128x128xf32)
        ...
        # pd_op.unsqueeze: (-1x1x128x128xf32) <- (-1x128x128xf32, 1xi64)
        ...
        # pd_op.grid_sample: (-1x1x1x37632xf32) <- (-1x1x128x128xf32, -1x1x37632x2xf32)
