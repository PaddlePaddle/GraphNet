...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3):
        ...
        # pd_op.pow: (1x300x4xf32) <- (1x300x4xf32)
        ...
        # pd_op.multiply: (1x300x4xf32) <- (1x300x4xf32, 1x300x4xf32)
        ...
        # pd_op.sigmoid_cross_entropy_with_logits: (1x300x4xf32) <- (1x300x4xf32, 1x300x4xf32, None)
        ...
        # pd_op.mean: (1x4xf32) <- (1x300x4xf32)
