...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        full_0 = paddle._C_ops.full(
            [1], float("1000"), paddle.int32, paddle.core.CPUPlace()
        )

        # pd_op.topk: (1000xf32, 1000xi64) <- (2848xf32, 1xi32)
        ...
        # pd_op.gather: (1000x4xf32) <- (2848x4xf32, 1000xi64, 1xi32)
        ...
        return gather_0, topk_0, topk_1, slice_0
