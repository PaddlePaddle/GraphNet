...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        transpose_2 = paddle._C_ops.transpose(slice_49, [0, 1, 3, 2])

        # pd_op.matmul: (16x16x257x257xf32) <- (16x16x257x64xf32, 16x16x64x257xf32)
        matmul_97 = paddle._C_ops.matmul(slice_0, transpose_2, False, False)
        ...
        scale_0 = paddle._C_ops.scale(matmul_97, full_1, float("0"), True)
        ...
        matmul_98 = paddle._C_ops.matmul(softmax_0, slice_1, False, False)

        # pd_op.transpose: (16x257x16x64xf32) <- (16x16x257x64xf32)
        transpose_3 = paddle._C_ops.transpose(matmul_98, [0, 2, 1, 3])
        ...
        # pd_op.transpose: (16x16x64x257xf32) <- (16x16x257x64xf32)
        transpose_5 = paddle._C_ops.transpose(slice_50, [0, 1, 3, 2])

        # pd_op.matmul: (16x16x257x257xf32) <- (16x16x257x64xf32, 16x16x64x257xf32)
        matmul_99 = paddle._C_ops.matmul(slice_2, transpose_5, False, False)

        # pd_op.scale: (16x16x257x257xf32) <- (16x16x257x257xf32, 1xf32)
        scale_1 = paddle._C_ops.scale(matmul_99, full_1, float("0"), True)

        # pd_op.softmax: (16x16x257x257xf32) <- (16x16x257x257xf32)
        softmax_1 = paddle._C_ops.softmax(scale_1, -1)

        # pd_op.matmul: (16x16x257x64xf32) <- (16x16x257x257xf32, 16x16x257x64xf32)
        matmul_100 = paddle._C_ops.matmul(softmax_1, slice_3, False, False)

        # pd_op.transpose: (16x257x16x64xf32) <- (16x16x257x64xf32)
        transpose_6 = paddle._C_ops.transpose(matmul_100, [0, 2, 1, 3])
        ...
        # pd_op.transpose: (16x16x64x257xf32) <- (16x16x257x64xf32)
        transpose_8 = paddle._C_ops.transpose(slice_51, [0, 1, 3, 2])

        # pd_op.matmul: (16x16x257x257xf32) <- (16x16x257x64xf32, 16x16x64x257xf32)
        matmul_101 = paddle._C_ops.matmul(slice_4, transpose_8, False, False)

        # pd_op.scale: (16x16x257x257xf32) <- (16x16x257x257xf32, 1xf32)
        scale_2 = paddle._C_ops.scale(matmul_101, full_1, float("0"), True)

        # pd_op.softmax: (16x16x257x257xf32) <- (16x16x257x257xf32)
        softmax_2 = paddle._C_ops.softmax(scale_2, -1)

        # pd_op.matmul: (16x16x257x64xf32) <- (16x16x257x257xf32, 16x16x257x64xf32)
        matmul_102 = paddle._C_ops.matmul(softmax_2, slice_5, False, False)

        # pd_op.transpose: (16x257x16x64xf32) <- (16x16x257x64xf32)
        transpose_9 = paddle._C_ops.transpose(matmul_102, [0, 2, 1, 3])
        ...
        # pd_op.transpose: (16x16x64x257xf32) <- (16x16x257x64xf32)
        transpose_11 = paddle._C_ops.transpose(slice_52, [0, 1, 3, 2])

        # pd_op.matmul: (16x16x257x257xf32) <- (16x16x257x64xf32, 16x16x64x257xf32)
        matmul_103 = paddle._C_ops.matmul(slice_6, transpose_11, False, False)

        # pd_op.scale: (16x16x257x257xf32) <- (16x16x257x257xf32, 1xf32)
        scale_3 = paddle._C_ops.scale(matmul_103, full_1, float("0"), True)

        # pd_op.softmax: (16x16x257x257xf32) <- (16x16x257x257xf32)
        softmax_3 = paddle._C_ops.softmax(scale_3, -1)

        # pd_op.matmul: (16x16x257x64xf32) <- (16x16x257x257xf32, 16x16x257x64xf32)
        matmul_104 = paddle._C_ops.matmul(softmax_3, slice_7, False, False)

        # pd_op.transpose: (16x257x16x64xf32) <- (16x16x257x64xf32)
        transpose_12 = paddle._C_ops.transpose(matmul_104, [0, 2, 1, 3])
        ...
        # pd_op.transpose: (16x16x64x257xf32) <- (16x16x257x64xf32)
        transpose_14 = paddle._C_ops.transpose(slice_53, [0, 1, 3, 2])

        # pd_op.matmul: (16x16x257x257xf32) <- (16x16x257x64xf32, 16x16x64x257xf32)
        matmul_105 = paddle._C_ops.matmul(slice_8, transpose_14, False, False)

        # pd_op.scale: (16x16x257x257xf32) <- (16x16x257x257xf32, 1xf32)
        scale_4 = paddle._C_ops.scale(matmul_105, full_1, float("0"), True)

        # pd_op.softmax: (16x16x257x257xf32) <- (16x16x257x257xf32)
        softmax_4 = paddle._C_ops.softmax(scale_4, -1)

        # pd_op.matmul: (16x16x257x64xf32) <- (16x16x257x257xf32, 16x16x257x64xf32)
        matmul_106 = paddle._C_ops.matmul(softmax_4, slice_9, False, False)

        # pd_op.transpose: (16x257x16x64xf32) <- (16x16x257x64xf32)
        transpose_15 = paddle._C_ops.transpose(matmul_106, [0, 2, 1, 3])
        ...
        # pd_op.transpose: (16x16x64x257xf32) <- (16x16x257x64xf32)
        transpose_17 = paddle._C_ops.transpose(slice_54, [0, 1, 3, 2])

        # pd_op.matmul: (16x16x257x257xf32) <- (16x16x257x64xf32, 16x16x64x257xf32)
        matmul_107 = paddle._C_ops.matmul(slice_10, transpose_17, False, False)

        # pd_op.scale: (16x16x257x257xf32) <- (16x16x257x257xf32, 1xf32)
        scale_5 = paddle._C_ops.scale(matmul_107, full_1, float("0"), True)

        # pd_op.softmax: (16x16x257x257xf32) <- (16x16x257x257xf32)
        softmax_5 = paddle._C_ops.softmax(scale_5, -1)

        # pd_op.matmul: (16x16x257x64xf32) <- (16x16x257x257xf32, 16x16x257x64xf32)
        matmul_108 = paddle._C_ops.matmul(softmax_5, slice_11, False, False)

        # pd_op.transpose: (16x257x16x64xf32) <- (16x16x257x64xf32)
        transpose_18 = paddle._C_ops.transpose(matmul_108, [0, 2, 1, 3])
        ...
        # pd_op.transpose: (16x16x64x257xf32) <- (16x16x257x64xf32)
        transpose_20 = paddle._C_ops.transpose(slice_55, [0, 1, 3, 2])

        # pd_op.matmul: (16x16x257x257xf32) <- (16x16x257x64xf32, 16x16x64x257xf32)
        matmul_109 = paddle._C_ops.matmul(slice_12, transpose_20, False, False)

        # pd_op.scale: (16x16x257x257xf32) <- (16x16x257x257xf32, 1xf32)
        scale_6 = paddle._C_ops.scale(matmul_109, full_1, float("0"), True)

        # pd_op.softmax: (16x16x257x257xf32) <- (16x16x257x257xf32)
        softmax_6 = paddle._C_ops.softmax(scale_6, -1)

        # pd_op.matmul: (16x16x257x64xf32) <- (16x16x257x257xf32, 16x16x257x64xf32)
        matmul_110 = paddle._C_ops.matmul(softmax_6, slice_13, False, False)

        # pd_op.transpose: (16x257x16x64xf32) <- (16x16x257x64xf32)
        transpose_21 = paddle._C_ops.transpose(matmul_110, [0, 2, 1, 3])
        ...
        # pd_op.transpose: (16x16x64x257xf32) <- (16x16x257x64xf32)
        transpose_23 = paddle._C_ops.transpose(slice_56, [0, 1, 3, 2])

        # pd_op.matmul: (16x16x257x257xf32) <- (16x16x257x64xf32, 16x16x64x257xf32)
        matmul_111 = paddle._C_ops.matmul(slice_14, transpose_23, False, False)

        # pd_op.scale: (16x16x257x257xf32) <- (16x16x257x257xf32, 1xf32)
        scale_7 = paddle._C_ops.scale(matmul_111, full_1, float("0"), True)

        # pd_op.softmax: (16x16x257x257xf32) <- (16x16x257x257xf32)
        softmax_7 = paddle._C_ops.softmax(scale_7, -1)

        # pd_op.matmul: (16x16x257x64xf32) <- (16x16x257x257xf32, 16x16x257x64xf32)
        matmul_112 = paddle._C_ops.matmul(softmax_7, slice_15, False, False)

        # pd_op.transpose: (16x257x16x64xf32) <- (16x16x257x64xf32)
        transpose_24 = paddle._C_ops.transpose(matmul_112, [0, 2, 1, 3])
        ...
        # pd_op.transpose: (16x16x64x257xf32) <- (16x16x257x64xf32)
        transpose_26 = paddle._C_ops.transpose(slice_57, [0, 1, 3, 2])

        # pd_op.matmul: (16x16x257x257xf32) <- (16x16x257x64xf32, 16x16x64x257xf32)
        matmul_113 = paddle._C_ops.matmul(slice_16, transpose_26, False, False)

        # pd_op.scale: (16x16x257x257xf32) <- (16x16x257x257xf32, 1xf32)
        scale_8 = paddle._C_ops.scale(matmul_113, full_1, float("0"), True)

        # pd_op.softmax: (16x16x257x257xf32) <- (16x16x257x257xf32)
        softmax_8 = paddle._C_ops.softmax(scale_8, -1)

        # pd_op.matmul: (16x16x257x64xf32) <- (16x16x257x257xf32, 16x16x257x64xf32)
        matmul_114 = paddle._C_ops.matmul(softmax_8, slice_17, False, False)

        # pd_op.transpose: (16x257x16x64xf32) <- (16x16x257x64xf32)
        transpose_27 = paddle._C_ops.transpose(matmul_114, [0, 2, 1, 3])
        ...
        # pd_op.transpose: (16x16x64x257xf32) <- (16x16x257x64xf32)
        transpose_29 = paddle._C_ops.transpose(slice_58, [0, 1, 3, 2])

        # pd_op.matmul: (16x16x257x257xf32) <- (16x16x257x64xf32, 16x16x64x257xf32)
        matmul_115 = paddle._C_ops.matmul(slice_18, transpose_29, False, False)

        # pd_op.scale: (16x16x257x257xf32) <- (16x16x257x257xf32, 1xf32)
        scale_9 = paddle._C_ops.scale(matmul_115, full_1, float("0"), True)

        # pd_op.softmax: (16x16x257x257xf32) <- (16x16x257x257xf32)
        softmax_9 = paddle._C_ops.softmax(scale_9, -1)

        # pd_op.matmul: (16x16x257x64xf32) <- (16x16x257x257xf32, 16x16x257x64xf32)
        matmul_116 = paddle._C_ops.matmul(softmax_9, slice_19, False, False)

        # pd_op.transpose: (16x257x16x64xf32) <- (16x16x257x64xf32)
        transpose_30 = paddle._C_ops.transpose(matmul_116, [0, 2, 1, 3])
        ...
        # pd_op.transpose: (16x16x64x257xf32) <- (16x16x257x64xf32)
        transpose_32 = paddle._C_ops.transpose(slice_59, [0, 1, 3, 2])

        # pd_op.matmul: (16x16x257x257xf32) <- (16x16x257x64xf32, 16x16x64x257xf32)
        matmul_117 = paddle._C_ops.matmul(slice_20, transpose_32, False, False)

        # pd_op.scale: (16x16x257x257xf32) <- (16x16x257x257xf32, 1xf32)
        scale_10 = paddle._C_ops.scale(matmul_117, full_1, float("0"), True)

        # pd_op.softmax: (16x16x257x257xf32) <- (16x16x257x257xf32)
        softmax_10 = paddle._C_ops.softmax(scale_10, -1)

        # pd_op.matmul: (16x16x257x64xf32) <- (16x16x257x257xf32, 16x16x257x64xf32)
        matmul_118 = paddle._C_ops.matmul(softmax_10, slice_21, False, False)

        # pd_op.transpose: (16x257x16x64xf32) <- (16x16x257x64xf32)
        transpose_33 = paddle._C_ops.transpose(matmul_118, [0, 2, 1, 3])
        ...
        # pd_op.transpose: (16x16x64x257xf32) <- (16x16x257x64xf32)
        transpose_35 = paddle._C_ops.transpose(slice_60, [0, 1, 3, 2])

        # pd_op.matmul: (16x16x257x257xf32) <- (16x16x257x64xf32, 16x16x64x257xf32)
        matmul_119 = paddle._C_ops.matmul(slice_22, transpose_35, False, False)

        # pd_op.scale: (16x16x257x257xf32) <- (16x16x257x257xf32, 1xf32)
        scale_11 = paddle._C_ops.scale(matmul_119, full_1, float("0"), True)

        # pd_op.softmax: (16x16x257x257xf32) <- (16x16x257x257xf32)
        softmax_11 = paddle._C_ops.softmax(scale_11, -1)

        # pd_op.matmul: (16x16x257x64xf32) <- (16x16x257x257xf32, 16x16x257x64xf32)
        matmul_120 = paddle._C_ops.matmul(softmax_11, slice_23, False, False)

        # pd_op.transpose: (16x257x16x64xf32) <- (16x16x257x64xf32)
        transpose_36 = paddle._C_ops.transpose(matmul_120, [0, 2, 1, 3])
        ...
        # pd_op.transpose: (16x16x64x257xf32) <- (16x16x257x64xf32)
        transpose_38 = paddle._C_ops.transpose(slice_61, [0, 1, 3, 2])

        # pd_op.matmul: (16x16x257x257xf32) <- (16x16x257x64xf32, 16x16x64x257xf32)
        matmul_121 = paddle._C_ops.matmul(slice_24, transpose_38, False, False)

        # pd_op.scale: (16x16x257x257xf32) <- (16x16x257x257xf32, 1xf32)
        scale_12 = paddle._C_ops.scale(matmul_121, full_1, float("0"), True)

        # pd_op.softmax: (16x16x257x257xf32) <- (16x16x257x257xf32)
        softmax_12 = paddle._C_ops.softmax(scale_12, -1)

        # pd_op.matmul: (16x16x257x64xf32) <- (16x16x257x257xf32, 16x16x257x64xf32)
        matmul_122 = paddle._C_ops.matmul(softmax_12, slice_25, False, False)

        # pd_op.transpose: (16x257x16x64xf32) <- (16x16x257x64xf32)
        transpose_39 = paddle._C_ops.transpose(matmul_122, [0, 2, 1, 3])
        ...
        # pd_op.transpose: (16x16x64x257xf32) <- (16x16x257x64xf32)
        transpose_41 = paddle._C_ops.transpose(slice_62, [0, 1, 3, 2])

        # pd_op.matmul: (16x16x257x257xf32) <- (16x16x257x64xf32, 16x16x64x257xf32)
        matmul_123 = paddle._C_ops.matmul(slice_26, transpose_41, False, False)

        # pd_op.scale: (16x16x257x257xf32) <- (16x16x257x257xf32, 1xf32)
        scale_13 = paddle._C_ops.scale(matmul_123, full_1, float("0"), True)

        # pd_op.softmax: (16x16x257x257xf32) <- (16x16x257x257xf32)
        softmax_13 = paddle._C_ops.softmax(scale_13, -1)

        # pd_op.matmul: (16x16x257x64xf32) <- (16x16x257x257xf32, 16x16x257x64xf32)
        matmul_124 = paddle._C_ops.matmul(softmax_13, slice_27, False, False)

        # pd_op.transpose: (16x257x16x64xf32) <- (16x16x257x64xf32)
        transpose_42 = paddle._C_ops.transpose(matmul_124, [0, 2, 1, 3])
        ...
        # pd_op.transpose: (16x16x64x257xf32) <- (16x16x257x64xf32)
        transpose_44 = paddle._C_ops.transpose(slice_63, [0, 1, 3, 2])

        # pd_op.matmul: (16x16x257x257xf32) <- (16x16x257x64xf32, 16x16x64x257xf32)
        matmul_125 = paddle._C_ops.matmul(slice_28, transpose_44, False, False)

        # pd_op.scale: (16x16x257x257xf32) <- (16x16x257x257xf32, 1xf32)
        scale_14 = paddle._C_ops.scale(matmul_125, full_1, float("0"), True)

        # pd_op.softmax: (16x16x257x257xf32) <- (16x16x257x257xf32)
        softmax_14 = paddle._C_ops.softmax(scale_14, -1)

        # pd_op.matmul: (16x16x257x64xf32) <- (16x16x257x257xf32, 16x16x257x64xf32)
        matmul_126 = paddle._C_ops.matmul(softmax_14, slice_29, False, False)

        # pd_op.transpose: (16x257x16x64xf32) <- (16x16x257x64xf32)
        transpose_45 = paddle._C_ops.transpose(matmul_126, [0, 2, 1, 3])
        ...
        # pd_op.matmul: (16x16x257x257xf32) <- (16x16x257x64xf32, 16x16x64x257xf32)
        matmul_127 = paddle._C_ops.matmul(slice_30, transpose_47, False, False)

        # pd_op.scale: (16x16x257x257xf32) <- (16x16x257x257xf32, 1xf32)
        scale_15 = paddle._C_ops.scale(matmul_127, full_1, float("0"), True)

        # pd_op.softmax: (16x16x257x257xf32) <- (16x16x257x257xf32)
        softmax_15 = paddle._C_ops.softmax(scale_15, -1)

        # pd_op.matmul: (16x16x257x64xf32) <- (16x16x257x257xf32, 16x16x257x64xf32)
        matmul_128 = paddle._C_ops.matmul(softmax_15, slice_31, False, False)

        # pd_op.transpose: (16x257x16x64xf32) <- (16x16x257x64xf32)
        transpose_48 = paddle._C_ops.transpose(matmul_128, [0, 2, 1, 3])
        ...
        # pd_op.transpose: (16x16x64x257xf32) <- (16x16x257x64xf32)
        transpose_50 = paddle._C_ops.transpose(slice_65, [0, 1, 3, 2])

        # pd_op.matmul: (16x16x257x257xf32) <- (16x16x257x64xf32, 16x16x64x257xf32)
        matmul_129 = paddle._C_ops.matmul(slice_32, transpose_50, False, False)

        # pd_op.scale: (16x16x257x257xf32) <- (16x16x257x257xf32, 1xf32)
        scale_16 = paddle._C_ops.scale(matmul_129, full_1, float("0"), True)

        # pd_op.softmax: (16x16x257x257xf32) <- (16x16x257x257xf32)
        softmax_16 = paddle._C_ops.softmax(scale_16, -1)

        # pd_op.matmul: (16x16x257x64xf32) <- (16x16x257x257xf32, 16x16x257x64xf32)
        matmul_130 = paddle._C_ops.matmul(softmax_16, slice_33, False, False)

        # pd_op.transpose: (16x257x16x64xf32) <- (16x16x257x64xf32)
        transpose_51 = paddle._C_ops.transpose(matmul_130, [0, 2, 1, 3])
        ...
        # pd_op.transpose: (16x16x64x257xf32) <- (16x16x257x64xf32)
        transpose_53 = paddle._C_ops.transpose(slice_66, [0, 1, 3, 2])

        # pd_op.matmul: (16x16x257x257xf32) <- (16x16x257x64xf32, 16x16x64x257xf32)
        matmul_131 = paddle._C_ops.matmul(slice_34, transpose_53, False, False)

        # pd_op.scale: (16x16x257x257xf32) <- (16x16x257x257xf32, 1xf32)
        scale_17 = paddle._C_ops.scale(matmul_131, full_1, float("0"), True)

        # pd_op.softmax: (16x16x257x257xf32) <- (16x16x257x257xf32)
        softmax_17 = paddle._C_ops.softmax(scale_17, -1)

        # pd_op.matmul: (16x16x257x64xf32) <- (16x16x257x257xf32, 16x16x257x64xf32)
        matmul_132 = paddle._C_ops.matmul(softmax_17, slice_35, False, False)

        # pd_op.transpose: (16x257x16x64xf32) <- (16x16x257x64xf32)
        transpose_54 = paddle._C_ops.transpose(matmul_132, [0, 2, 1, 3])
        ...
        # pd_op.transpose: (16x16x64x257xf32) <- (16x16x257x64xf32)
        transpose_56 = paddle._C_ops.transpose(slice_67, [0, 1, 3, 2])

        # pd_op.matmul: (16x16x257x257xf32) <- (16x16x257x64xf32, 16x16x64x257xf32)
        matmul_133 = paddle._C_ops.matmul(slice_36, transpose_56, False, False)

        # pd_op.scale: (16x16x257x257xf32) <- (16x16x257x257xf32, 1xf32)
        scale_18 = paddle._C_ops.scale(matmul_133, full_1, float("0"), True)

        # pd_op.softmax: (16x16x257x257xf32) <- (16x16x257x257xf32)
        softmax_18 = paddle._C_ops.softmax(scale_18, -1)

        # pd_op.matmul: (16x16x257x64xf32) <- (16x16x257x257xf32, 16x16x257x64xf32)
        matmul_134 = paddle._C_ops.matmul(softmax_18, slice_37, False, False)

        # pd_op.transpose: (16x257x16x64xf32) <- (16x16x257x64xf32)
        transpose_57 = paddle._C_ops.transpose(matmul_134, [0, 2, 1, 3])
        ...
        # pd_op.transpose: (16x16x64x257xf32) <- (16x16x257x64xf32)
        transpose_59 = paddle._C_ops.transpose(slice_68, [0, 1, 3, 2])

        # pd_op.matmul: (16x16x257x257xf32) <- (16x16x257x64xf32, 16x16x64x257xf32)
        matmul_135 = paddle._C_ops.matmul(slice_38, transpose_59, False, False)

        # pd_op.scale: (16x16x257x257xf32) <- (16x16x257x257xf32, 1xf32)
        scale_19 = paddle._C_ops.scale(matmul_135, full_1, float("0"), True)

        # pd_op.softmax: (16x16x257x257xf32) <- (16x16x257x257xf32)
        softmax_19 = paddle._C_ops.softmax(scale_19, -1)

        # pd_op.matmul: (16x16x257x64xf32) <- (16x16x257x257xf32, 16x16x257x64xf32)
        matmul_136 = paddle._C_ops.matmul(softmax_19, slice_39, False, False)

        # pd_op.transpose: (16x257x16x64xf32) <- (16x16x257x64xf32)
        transpose_60 = paddle._C_ops.transpose(matmul_136, [0, 2, 1, 3])
        ...
        # pd_op.transpose: (16x16x64x257xf32) <- (16x16x257x64xf32)
        transpose_62 = paddle._C_ops.transpose(slice_69, [0, 1, 3, 2])

        # pd_op.matmul: (16x16x257x257xf32) <- (16x16x257x64xf32, 16x16x64x257xf32)
        matmul_137 = paddle._C_ops.matmul(slice_40, transpose_62, False, False)

        # pd_op.scale: (16x16x257x257xf32) <- (16x16x257x257xf32, 1xf32)
        scale_20 = paddle._C_ops.scale(matmul_137, full_1, float("0"), True)

        # pd_op.softmax: (16x16x257x257xf32) <- (16x16x257x257xf32)
        softmax_20 = paddle._C_ops.softmax(scale_20, -1)

        # pd_op.matmul: (16x16x257x64xf32) <- (16x16x257x257xf32, 16x16x257x64xf32)
        matmul_138 = paddle._C_ops.matmul(softmax_20, slice_41, False, False)

        # pd_op.transpose: (16x257x16x64xf32) <- (16x16x257x64xf32)
        transpose_63 = paddle._C_ops.transpose(matmul_138, [0, 2, 1, 3])
        ...
        # pd_op.transpose: (16x16x64x257xf32) <- (16x16x257x64xf32)
        transpose_65 = paddle._C_ops.transpose(slice_70, [0, 1, 3, 2])

        # pd_op.matmul: (16x16x257x257xf32) <- (16x16x257x64xf32, 16x16x64x257xf32)
        matmul_139 = paddle._C_ops.matmul(slice_42, transpose_65, False, False)

        # pd_op.scale: (16x16x257x257xf32) <- (16x16x257x257xf32, 1xf32)
        scale_21 = paddle._C_ops.scale(matmul_139, full_1, float("0"), True)

        # pd_op.softmax: (16x16x257x257xf32) <- (16x16x257x257xf32)
        softmax_21 = paddle._C_ops.softmax(scale_21, -1)

        # pd_op.matmul: (16x16x257x64xf32) <- (16x16x257x257xf32, 16x16x257x64xf32)
        matmul_140 = paddle._C_ops.matmul(softmax_21, slice_43, False, False)

        # pd_op.transpose: (16x257x16x64xf32) <- (16x16x257x64xf32)
        transpose_66 = paddle._C_ops.transpose(matmul_140, [0, 2, 1, 3])
        ...
        # pd_op.transpose: (16x16x64x257xf32) <- (16x16x257x64xf32)
        transpose_68 = paddle._C_ops.transpose(slice_71, [0, 1, 3, 2])

        # pd_op.matmul: (16x16x257x257xf32) <- (16x16x257x64xf32, 16x16x64x257xf32)
        matmul_141 = paddle._C_ops.matmul(slice_44, transpose_68, False, False)

        # pd_op.scale: (16x16x257x257xf32) <- (16x16x257x257xf32, 1xf32)
        scale_22 = paddle._C_ops.scale(matmul_141, full_1, float("0"), True)

        # pd_op.softmax: (16x16x257x257xf32) <- (16x16x257x257xf32)
        softmax_22 = paddle._C_ops.softmax(scale_22, -1)

        # pd_op.matmul: (16x16x257x64xf32) <- (16x16x257x257xf32, 16x16x257x64xf32)
        matmul_142 = paddle._C_ops.matmul(softmax_22, slice_45, False, False)

        # pd_op.transpose: (16x257x16x64xf32) <- (16x16x257x64xf32)
        transpose_69 = paddle._C_ops.transpose(matmul_142, [0, 2, 1, 3])
        ...
        # pd_op.transpose: (16x16x64x257xf32) <- (16x16x257x64xf32)
        transpose_71 = paddle._C_ops.transpose(slice_72, [0, 1, 3, 2])

        # pd_op.matmul: (16x16x257x257xf32) <- (16x16x257x64xf32, 16x16x64x257xf32)
        matmul_143 = paddle._C_ops.matmul(slice_46, transpose_71, False, False)

        # pd_op.scale: (16x16x257x257xf32) <- (16x16x257x257xf32, 1xf32)
        scale_23 = paddle._C_ops.scale(matmul_143, full_1, float("0"), True)

        # pd_op.softmax: (16x16x257x257xf32) <- (16x16x257x257xf32)
        softmax_23 = paddle._C_ops.softmax(scale_23, -1)

        # pd_op.matmul: (16x16x257x64xf32) <- (16x16x257x257xf32, 16x16x257x64xf32)
        matmul_144 = paddle._C_ops.matmul(softmax_23, slice_47, False, False)

        # pd_op.transpose: (16x257x16x64xf32) <- (16x16x257x64xf32)
        transpose_72 = paddle._C_ops.transpose(matmul_144, [0, 2, 1, 3])
        ...
        slice_48 = paddle._C_ops.slice(
            add_144, [1], full_int_array_1, full_int_array_2, [1], [1]
        )
        ...
        slice_73 = paddle._C_ops.slice(
            add_144, [1], full_int_array_2, full_int_array_7, [1], []
        )
        ...
        layer_norm_147, layer_norm_148, layer_norm_149 = (lambda x, f: f(x))(
            paddle._C_ops.layer_norm(
                slice_48, parameter_3, parameter_2, float("1e-05"), 1
            ),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None, None),
        )

        # pd_op.matmul: (16x102xf32) <- (16x1024xf32, 1024x102xf32)
        matmul_96 = paddle._C_ops.matmul(layer_norm_147, parameter_1, False, False)

        # pd_op.add: (16x102xf32) <- (16x102xf32, 102xf32)
        add_145 = paddle._C_ops.add(matmul_96, parameter_0)
        return (
            conv2d_0,
            transpose_0,
            full_int_array_0,
