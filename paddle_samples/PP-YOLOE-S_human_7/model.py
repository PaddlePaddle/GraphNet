...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.pool2d: (2x192x-1x-1xf32) <- (2x192x-1x-1xf32, 2xi64)
        ...
        # builtin.combine: ([2x192x-1x-1xf32, 2x192x-1x-1xf32, 2x192x-1x-1xf32, 2x192x-1x-1xf32]) <- (2x192x-1x-1xf32, 2x192x-1x-1xf32, 2x192x-1x-1xf32, 2x192x-1x-1xf32)
        combine_4 = [swish_34, pool2d_0, pool2d_1, pool2d_2]

        # pd_op.concat: (2x768x-1x-1xf32) <- ([2x192x-1x-1xf32, 2x192x-1x-1xf32, 2x192x-1x-1xf32, 2x192x-1x-1xf32], 1xi32)
        concat_4 = paddle._C_ops.concat(combine_4, full_0)

        # pd_op.conv2d: (2x192x-1x-1xf32) <- (2x768x-1x-1xf32, 192x768x1x1xf32)
        ...
        # pd_op.nearest_interp: (2x96x-1x-1xf32) <- (2x96x-1x-1xf32, None, None, None)
        ...
        # builtin.combine: ([2x96x-1x-1xf32, 2x128x-1x-1xf32]) <- (2x96x-1x-1xf32, 2x128x-1x-1xf32)
        combine_8 = [nearest_interp_1, swish_16]

        # pd_op.concat: (2x224x-1x-1xf32) <- ([2x96x-1x-1xf32, 2x128x-1x-1xf32], 1xi32)
        concat_8 = paddle._C_ops.concat(combine_8, full_0)

        # pd_op.conv2d: (2x48x-1x-1xf32) <- (2x224x-1x-1xf32, 48x224x1x1xf32)
        ...
        # builtin.combine: ([2x96x-1x-1xf32, 2x192x-1x-1xf32]) <- (2x96x-1x-1xf32, 2x192x-1x-1xf32)
        combine_10 = [swish_48, swish_42]

        # pd_op.concat: (2x288x-1x-1xf32) <- ([2x96x-1x-1xf32, 2x192x-1x-1xf32], 1xi32)
        concat_10 = paddle._C_ops.concat(combine_10, full_0)

        # pd_op.conv2d: (2x96x-1x-1xf32) <- (2x288x-1x-1xf32, 96x288x1x1xf32)
