...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        object_getattribute_L_self_config_mask_ratio_: torch.Tensor,
        ...
        object_getattribute_l_self_config_mask_ratio_ = (
            object_getattribute_L_self_config_mask_ratio_
        )
        ...
        flatten = None
        getitem_8 = l_self_modules_embeddings_parameters_position_embeddings_[
            (slice(None, None, None), slice(1, None, None), slice(None, None, None))
        ]
        embeddings = x + getitem_8
        x = getitem_8 = None
        item = object_getattribute_l_self_config_mask_ratio_.item()
        object_getattribute_l_self_config_mask_ratio_ = None
        sub = 1 - item
        item = None
        mul = 225 * sub
        sub = None
        sym_int = torch.sym_int(mul)
        mul = None
        noise = torch.rand(1, 225, device=device(type="cuda", index=0))
        argsort = torch.argsort(noise, dim=1)
        noise = None
        ids_shuffle = argsort.to(device(type="cuda", index=0))
        argsort = None
        argsort_1 = torch.argsort(ids_shuffle, dim=1)
        ids_restore = argsort_1.to(device(type="cuda", index=0))
        argsort_1 = None
        ids_keep = ids_shuffle[(slice(None, None, None), slice(None, sym_int, None))]
        ids_shuffle = None
        unsqueeze = ids_keep.unsqueeze(-1)
        ids_keep = None
        repeat = unsqueeze.repeat(1, 1, 32)
        unsqueeze = None
        sequence_unmasked = torch.gather(embeddings, dim=1, index=repeat)
        embeddings = repeat = None
        mask = torch.ones([1, 225], device=device(type="cuda", index=0))
        mask[(slice(None, None, None), slice(None, sym_int, None))] = 0
        setitem = mask
        sym_int = setitem = None
        mask_1 = torch.gather(mask, dim=1, index=ids_restore)
        mask = None
        getitem_10 = l_self_modules_embeddings_parameters_position_embeddings_[
        ...
        cls_token = l_self_modules_embeddings_parameters_cls_token_ + getitem_10
        l_self_modules_embeddings_parameters_cls_token_ = getitem_10 = None
        cls_tokens = cls_token.expand(1, -1, -1)
        cls_token = None
        embeddings_1 = torch.cat((cls_tokens, sequence_unmasked), dim=1)
        cls_tokens = sequence_unmasked = None
        item_1 = (
        ...
        transpose_4 = None
        size_5 = torch.Size([1, getitem_15, 32])
        context_layer = attn_output_1.reshape(size_5)
        attn_output_1 = size_5 = None
        ...
        transpose_8 = None
        size_8 = torch.Size([1, getitem_15, 32])
        context_layer_1 = attn_output_3.reshape(size_8)
        attn_output_3 = size_8 = None
        ...
        transpose_12 = None
        size_11 = torch.Size([1, getitem_15, 32])
        context_layer_2 = attn_output_5.reshape(size_11)
        attn_output_5 = size_11 = None
        ...
        transpose_16 = None
        size_14 = torch.Size([1, getitem_15, 32])
        context_layer_3 = attn_output_7.reshape(size_14)
        attn_output_7 = size_14 = None
        ...
        transpose_20 = None
        size_17 = torch.Size([1, getitem_15, 32])
        getitem_15 = None
        context_layer_4 = attn_output_9.reshape(size_17)
        attn_output_9 = size_17 = None
        ...
        return (sequence_output, mask_1, ids_restore)
