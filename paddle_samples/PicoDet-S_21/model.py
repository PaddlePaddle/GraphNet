...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5):
        ...
        # pd_op.divide: (16x3x1xf32) <- (16x3x1xf32, xf32)
        divide_1 = paddle._C_ops.divide(sum_1, where_0)

        # pd_op.sqrt: (16x3x1xf32) <- (16x3x1xf32)
        sqrt_0 = paddle._C_ops.sqrt(divide_1)

        # pd_op.add: (16x3x1xf32) <- (16x3x1xf32, 16x3x1xf32)
        add_0 = paddle._C_ops.add(mean_0, sqrt_0)

        # pd_op.greater_than: (16x3x1726xb) <- (16x3x1726xf32, 16x3x1xf32)
        ...
        # pd_op.split_with_num: ([1x1x1726x1xf32, 1x1x1726x1xf32]) <- (1x1x1726x2xf32, 1xi32)
        split_with_num_0 = paddle._C_ops.split_with_num(unsqueeze_0, 2, full_3)

        # builtin.split: (1x1x1726x1xf32, 1x1x1726x1xf32) <- ([1x1x1726x1xf32, 1x1x1726x1xf32])
        (
            split_0,
            split_1,
        ) = split_with_num_0
        ...
        # pd_op.split_with_num: ([16x3x1x1xf32, 16x3x1x1xf32, 16x3x1x1xf32, 16x3x1x1xf32]) <- (16x3x1x4xf32, 1xi32)
        split_with_num_1 = paddle._C_ops.split_with_num(unsqueeze_1, 4, full_3)

        # builtin.split: (16x3x1x1xf32, 16x3x1x1xf32, 16x3x1x1xf32, 16x3x1x1xf32) <- ([16x3x1x1xf32, 16x3x1x1xf32, 16x3x1x1xf32, 16x3x1x1xf32])
        (
            split_2,
            split_3,
            split_4,
        ...
        # pd_op.subtract: (16x3x1726x1xf32) <- (1x1x1726x1xf32, 16x3x1x1xf32)
        subtract_1 = paddle._C_ops.subtract(split_0, split_2)

        # pd_op.subtract: (16x3x1726x1xf32) <- (1x1x1726x1xf32, 16x3x1x1xf32)
        subtract_2 = paddle._C_ops.subtract(split_1, split_3)

        # pd_op.subtract: (16x3x1726x1xf32) <- (16x3x1x1xf32, 1x1x1726x1xf32)
        ...
        # builtin.combine: ([16x3x1726x1xf32, 16x3x1726x1xf32, 16x3x1726x1xf32, 16x3x1726x1xf32]) <- (16x3x1726x1xf32, 16x3x1726x1xf32, 16x3x1726x1xf32, 16x3x1726x1xf32)
        combine_0 = [subtract_1, subtract_2, subtract_3, subtract_4]

        # pd_op.concat: (16x3x1726x4xf32) <- ([16x3x1726x1xf32, 16x3x1726x1xf32, 16x3x1726x1xf32, 16x3x1726x1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_4)

        # pd_op.min: (16x3x1726xf32) <- (16x3x1726x4xf32, 1xi64)
