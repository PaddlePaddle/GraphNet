...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2):
        # pd_op.cast: (15362x11xf32) <- (15362x11xf32)
        ...
        # pd_op.greater_than: (15362x11xb) <- (15362x11xf32, xf32)
        greater_than_0 = paddle._C_ops.greater_than(cast_0, full_2)

        # pd_op.cast: (15362x11xf32) <- (15362x11xb)
        cast_2 = paddle._C_ops.cast(greater_than_0, paddle.float32)

        # pd_op.multiply: (15362x11xf32) <- (15362x11xf32, 15362x11xf32)
        multiply_0 = paddle._C_ops.multiply(cast_0, cast_2)

        # pd_op.subtract: (15362x11xf32) <- (15362x11xf32, 15362x11xf32)
        subtract_0 = paddle._C_ops.subtract(data_0, cast_0)

        # pd_op.abs: (15362x11xf32) <- (15362x11xf32)
        abs_0 = paddle._C_ops.abs(subtract_0)

        # pd_op.pow: (15362x11xf32) <- (15362x11xf32)
        ...
        # pd_op.scale: (15362x11xf32) <- (15362x11xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(pow_0, full_0, float("0"), True)

        # pd_op.less_equal: (15362x11xb) <- (15362x11xf32, xf32)
        ...
        # pd_op.add: (15362x11xf32) <- (15362x11xf32, 15362x11xf32)
        add_0 = paddle._C_ops.add(multiply_0, multiply_1)

        # pd_op.bce_loss: (15362x11xf32) <- (15362x11xf32, 15362x11xf32)
        ...
        # pd_op.sum: (15362xf32) <- (15362x11xf32, 1xi64)
