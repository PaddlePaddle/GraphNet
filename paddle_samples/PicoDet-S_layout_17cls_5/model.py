...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (2x48x1x1xf32) <- (2x192x1x1xf32, 48x192x1x1xf32)
        ...
        # pd_op.relu: (2x48x1x1xf32) <- (2x48x1x1xf32)
        relu_0 = paddle._C_ops.relu(add_0)

        # pd_op.conv2d: (2x192x1x1xf32) <- (2x48x1x1xf32, 192x48x1x1xf32)
        ...
        # pd_op.multiply: (2x192x14x14xf32) <- (2x192x14x14xf32, 2x192x1x1xf32)
