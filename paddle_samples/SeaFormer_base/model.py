...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (2x192x-1x-1xf32) <- (2x-1x-1x-1xf32, 192x64x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (2x192x-1x-1xf32) <- (2x192x-1x-1xf32, 192x1x3x3xf32)
        depthwise_conv2d_0 = paddle._C_ops.depthwise_conv2d(
            relu_0, parameter_9, [2, 2], [1, 1], "EXPLICIT", 192, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (2x128x-1x-1xf32) <- (2x192x-1x-1xf32, 128x192x1x1xf32)
