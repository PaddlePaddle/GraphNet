...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        depthwise_conv2d_1 = paddle._C_ops.depthwise_conv2d(
            hardswish_2, parameter_130, [2, 2], [1, 1], "EXPLICIT", 8, [1, 1], "NCHW"
        )
        ...
        # pd_op.hardswish: (-1x8x56x56xf32) <- (-1x8x56x56xf32)
        hardswish_3 = paddle._C_ops.hardswish(batch_norm__18)

        # pd_op.conv2d: (-1x16x56x56xf32) <- (-1x8x56x56xf32, 16x8x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x16x56x56xf32) <- (-1x16x56x56xf32, 16x1x3x3xf32)
        depthwise_conv2d_2 = paddle._C_ops.depthwise_conv2d(
            hardswish_4, parameter_120, [1, 1], [1, 1], "EXPLICIT", 16, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_3 = paddle._C_ops.depthwise_conv2d(
            hardswish_6, parameter_110, [2, 2], [1, 1], "EXPLICIT", 16, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x32x28x28xf32) <- (-1x16x28x28xf32, 32x16x1x1xf32)
        ...
        depthwise_conv2d_4 = paddle._C_ops.depthwise_conv2d(
            hardswish_8, parameter_100, [1, 1], [1, 1], "EXPLICIT", 32, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_5 = paddle._C_ops.depthwise_conv2d(
            hardswish_10, parameter_90, [2, 2], [1, 1], "EXPLICIT", 32, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_6 = paddle._C_ops.depthwise_conv2d(
            hardswish_12, parameter_80, [1, 1], [2, 2], "EXPLICIT", 64, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_7 = paddle._C_ops.depthwise_conv2d(
            hardswish_14, parameter_70, [1, 1], [2, 2], "EXPLICIT", 64, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_8 = paddle._C_ops.depthwise_conv2d(
            hardswish_16, parameter_60, [1, 1], [2, 2], "EXPLICIT", 64, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_9 = paddle._C_ops.depthwise_conv2d(
            hardswish_18, parameter_50, [1, 1], [2, 2], "EXPLICIT", 64, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_10 = paddle._C_ops.depthwise_conv2d(
            hardswish_20, parameter_40, [1, 1], [2, 2], "EXPLICIT", 64, [1, 1], "NCHW"
        )
        ...
        # pd_op.depthwise_conv2d: (-1x64x7x7xf32) <- (-1x64x14x14xf32, 64x1x5x5xf32)
        depthwise_conv2d_11 = paddle._C_ops.depthwise_conv2d(
            hardswish_22, parameter_30, [2, 2], [2, 2], "EXPLICIT", 64, [1, 1], "NCHW"
        )

        # pd_op.batch_norm_: (-1x64x7x7xf32, 64xf32, 64xf32, 64xf32, 64xf32, -1xui8) <- (-1x64x7x7xf32, 64xf32, 64xf32, 64xf32, 64xf32)
        (
            batch_norm__138,
            batch_norm__139,
            batch_norm__140,
        ...
        # pd_op.hardswish: (-1x64x7x7xf32) <- (-1x64x7x7xf32)
        ...
        # pd_op.multiply: (-1x64x7x7xf32) <- (-1x64x7x7xf32, -1x64x1x1xf32)
        multiply_0 = paddle._C_ops.multiply(hardswish_23, hardsigmoid_0)

        # pd_op.conv2d: (-1x128x7x7xf32) <- (-1x64x7x7xf32, 128x64x1x1xf32)
        ...
        # pd_op.hardswish: (-1x128x7x7xf32) <- (-1x128x7x7xf32)
        ...
        depthwise_conv2d_12 = paddle._C_ops.depthwise_conv2d(
            hardswish_24, parameter_16, [1, 1], [2, 2], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x1280x1x1xf32) <- (-1x128x1x1xf32, 1280x128x1x1xf32)
