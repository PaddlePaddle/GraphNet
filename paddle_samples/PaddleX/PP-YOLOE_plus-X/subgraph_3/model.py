...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        one_hot_0 = paddle._C_ops.one_hot(
            topk_1 % paddle.cast(data_2, topk_1.dtype), data_2
        )
        del data_2, topk_1
        ...
        multiply_0 = paddle._C_ops.multiply(sum_0, data_8)
        del sum_0
        ...
        one_hot_1 = paddle._C_ops.one_hot(
            topk_3 % paddle.cast(data_3, topk_3.dtype), data_3
        )
        del data_3, topk_3
        ...
        # pd_op.multiply: (4x1x-1xf32) <- (4x1x-1xf32, 4x1x1xf32)
        multiply_1 = paddle._C_ops.multiply(sum_1, data_8)
        del sum_1
        ...
        one_hot_2 = paddle._C_ops.one_hot(
            topk_5 % paddle.cast(data_4, topk_5.dtype), data_4
        )
        del data_4, topk_5
        ...
        # pd_op.multiply: (4x1x-1xf32) <- (4x1x-1xf32, 4x1x1xf32)
        multiply_2 = paddle._C_ops.multiply(sum_2, data_8)
        del data_8, sum_2
        ...
        # builtin.combine: ([4x1x-1xf32, 4x1x-1xf32, 4x1x-1xf32]) <- (4x1x-1xf32, 4x1x-1xf32, 4x1x-1xf32)
        combine_0 = [multiply_0, multiply_1, multiply_2]
        del multiply_0, multiply_1, multiply_2

        # pd_op.concat: (4x1x-1xf32) <- ([4x1x-1xf32, 4x1x-1xf32, 4x1x-1xf32], 1xi32)
