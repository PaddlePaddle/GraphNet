...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3):
        # pd_op.sigmoid: (1x-1x11xf32) <- (1x-1x11xf32)
        sigmoid_0 = paddle._C_ops.sigmoid(data_0)

        # pd_op.pow: (1x-1x11xf32) <- (1x-1x11xf32)
        ...
        # pd_op.scale: (1x-1x11xf32) <- (1x-1x11xf32, 1xf32)
        ...
        # pd_op.sigmoid_cross_entropy_with_logits: (1x-1x11xf32) <- (1x-1x11xf32, 1x-1x11xf32, None)
        ...
        # pd_op.mean: (1x11xf32) <- (1x-1x11xf32)
