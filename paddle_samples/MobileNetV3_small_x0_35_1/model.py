...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (-1x24x56x56xf32) <- (-1x8x56x56xf32, 24x8x1x1xf32)
        ...
        # pd_op.relu: (-1x24x28x28xf32) <- (-1x24x28x28xf32)
        relu_4 = paddle._C_ops.relu(batch_norm__30)

        # pd_op.conv2d: (-1x8x28x28xf32) <- (-1x24x28x28xf32, 8x24x1x1xf32)
        conv2d_6 = paddle._C_ops.conv2d(
            relu_4, parameter_179, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (-1x8x28x28xf32, 8xf32, 8xf32, 8xf32, 8xf32, -1xui8) <- (-1x8x28x28xf32, 8xf32, 8xf32, 8xf32, 8xf32)
        (
            batch_norm__36,
            batch_norm__37,
            batch_norm__38,
        ...
        # pd_op.conv2d: (-1x32x28x28xf32) <- (-1x8x28x28xf32, 32x8x1x1xf32)
        ...
        # pd_op.conv2d: (-1x8x28x28xf32) <- (-1x32x28x28xf32, 8x32x1x1xf32)
        ...
        # pd_op.add: (-1x8x28x28xf32) <- (-1x8x28x28xf32, -1x8x28x28xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x32x14x14xf32) <- (-1x32x28x28xf32, 32x1x5x5xf32)
        ...
        # pd_op.hardswish: (-1x32x14x14xf32) <- (-1x32x14x14xf32)
        ...
        # pd_op.relu: (-1x8x1x1xf32) <- (-1x8x1x1xf32)
        ...
        # pd_op.multiply: (-1x32x14x14xf32) <- (-1x32x14x14xf32, -1x32x1x1xf32)
        multiply_1 = paddle._C_ops.multiply(hardswish_2, hardsigmoid_1)

        # pd_op.conv2d: (-1x16x14x14xf32) <- (-1x32x14x14xf32, 16x32x1x1xf32)
        conv2d_12 = paddle._C_ops.conv2d(
            multiply_1, parameter_145, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (-1x16x14x14xf32, 16xf32, 16xf32, 16xf32, 16xf32, -1xui8) <- (-1x16x14x14xf32, 16xf32, 16xf32, 16xf32, 16xf32)
        (
            batch_norm__72,
            batch_norm__73,
            batch_norm__74,
        ...
        # pd_op.conv2d: (-1x88x14x14xf32) <- (-1x16x14x14xf32, 88x16x1x1xf32)
        ...
        # pd_op.conv2d: (-1x16x14x14xf32) <- (-1x88x14x14xf32, 16x88x1x1xf32)
        ...
        # pd_op.add: (-1x16x14x14xf32) <- (-1x16x14x14xf32, -1x16x14x14xf32)
        ...
        # pd_op.conv2d: (-1x40x14x14xf32) <- (-1x16x14x14xf32, 40x16x1x1xf32)
        ...
        # pd_op.hardswish: (-1x40x14x14xf32) <- (-1x40x14x14xf32)
        hardswish_7 = paddle._C_ops.hardswish(batch_norm__114)

        # pd_op.depthwise_conv2d: (-1x40x14x14xf32) <- (-1x40x14x14xf32, 40x1x5x5xf32)
        ...
        # pd_op.pool2d: (-1x40x1x1xf32) <- (-1x40x14x14xf32, 2xi64)
        ...
        # pd_op.hardsigmoid: (-1x40x1x1xf32) <- (-1x40x1x1xf32)
        hardsigmoid_4 = paddle._C_ops.hardsigmoid(add_13, float("0.2"), float("0.5"))

        # pd_op.multiply: (-1x40x14x14xf32) <- (-1x40x14x14xf32, -1x40x1x1xf32)
        multiply_4 = paddle._C_ops.multiply(hardswish_8, hardsigmoid_4)

        # pd_op.conv2d: (-1x16x14x14xf32) <- (-1x40x14x14xf32, 16x40x1x1xf32)
        ...
        # pd_op.add: (-1x16x14x14xf32) <- (-1x16x14x14xf32, -1x16x14x14xf32)
        add_14 = paddle._C_ops.add(add_11, batch_norm__126)

        # pd_op.conv2d: (-1x48x14x14xf32) <- (-1x16x14x14xf32, 48x16x1x1xf32)
        conv2d_25 = paddle._C_ops.conv2d(
            add_14, parameter_83, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.depthwise_conv2d: (-1x48x14x14xf32) <- (-1x48x14x14xf32, 48x1x5x5xf32)
        ...
        add_15 = paddle._C_ops.add(conv2d_26, reshape_10)

        # pd_op.relu: (-1x12x1x1xf32) <- (-1x12x1x1xf32)
        relu_11 = paddle._C_ops.relu(add_15)
        ...
        add_16 = paddle._C_ops.add(conv2d_27, reshape_11)

        # pd_op.hardsigmoid: (-1x48x1x1xf32) <- (-1x48x1x1xf32)
        hardsigmoid_5 = paddle._C_ops.hardsigmoid(add_16, float("0.2"), float("0.5"))

        # pd_op.multiply: (-1x48x14x14xf32) <- (-1x48x14x14xf32, -1x48x1x1xf32)
        multiply_5 = paddle._C_ops.multiply(hardswish_10, hardsigmoid_5)

        # pd_op.conv2d: (-1x16x14x14xf32) <- (-1x48x14x14xf32, 16x48x1x1xf32)
        ...
        # pd_op.add: (-1x16x14x14xf32) <- (-1x16x14x14xf32, -1x16x14x14xf32)
        add_17 = paddle._C_ops.add(add_14, batch_norm__144)

        # pd_op.conv2d: (-1x104x14x14xf32) <- (-1x16x14x14xf32, 104x16x1x1xf32)
        conv2d_29 = paddle._C_ops.conv2d(
            add_17, parameter_64, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.hardswish: (-1x104x14x14xf32) <- (-1x104x14x14xf32)
        hardswish_11 = paddle._C_ops.hardswish(batch_norm__150)

        # pd_op.depthwise_conv2d: (-1x104x7x7xf32) <- (-1x104x14x14xf32, 104x1x5x5xf32)
        depthwise_conv2d_8 = paddle._C_ops.depthwise_conv2d(
            hardswish_11, parameter_59, [2, 2], [2, 2], "EXPLICIT", 104, [1, 1], "NCHW"
        )

        # pd_op.batch_norm_: (-1x104x7x7xf32, 104xf32, 104xf32, 104xf32, 104xf32, -1xui8) <- (-1x104x7x7xf32, 104xf32, 104xf32, 104xf32, 104xf32)
        (
            batch_norm__156,
            batch_norm__157,
            batch_norm__158,
        ...
        # pd_op.hardswish: (-1x104x7x7xf32) <- (-1x104x7x7xf32)
        hardswish_12 = paddle._C_ops.hardswish(batch_norm__156)

        # pd_op.pool2d: (-1x104x1x1xf32) <- (-1x104x7x7xf32, 2xi64)
        ...
        # pd_op.conv2d: (-1x26x1x1xf32) <- (-1x104x1x1xf32, 26x104x1x1xf32)
        ...
        # pd_op.add: (-1x26x1x1xf32) <- (-1x26x1x1xf32, 1x26x1x1xf32)
        add_18 = paddle._C_ops.add(conv2d_30, reshape_12)

        # pd_op.relu: (-1x26x1x1xf32) <- (-1x26x1x1xf32)
        relu_12 = paddle._C_ops.relu(add_18)

        # pd_op.conv2d: (-1x104x1x1xf32) <- (-1x26x1x1xf32, 104x26x1x1xf32)
        ...
        # pd_op.add: (-1x104x1x1xf32) <- (-1x104x1x1xf32, 1x104x1x1xf32)
        add_19 = paddle._C_ops.add(conv2d_31, reshape_13)

        # pd_op.hardsigmoid: (-1x104x1x1xf32) <- (-1x104x1x1xf32)
        hardsigmoid_6 = paddle._C_ops.hardsigmoid(add_19, float("0.2"), float("0.5"))

        # pd_op.multiply: (-1x104x7x7xf32) <- (-1x104x7x7xf32, -1x104x1x1xf32)
        multiply_6 = paddle._C_ops.multiply(hardswish_12, hardsigmoid_6)

        # pd_op.conv2d: (-1x32x7x7xf32) <- (-1x104x7x7xf32, 32x104x1x1xf32)
        conv2d_32 = paddle._C_ops.conv2d(
            multiply_6, parameter_50, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (-1x32x7x7xf32, 32xf32, 32xf32, 32xf32, 32xf32, -1xui8) <- (-1x32x7x7xf32, 32xf32, 32xf32, 32xf32, 32xf32)
        (
            batch_norm__162,
            batch_norm__163,
            batch_norm__164,
        ...
        # pd_op.conv2d: (-1x200x7x7xf32) <- (-1x32x7x7xf32, 200x32x1x1xf32)
        ...
        # pd_op.hardswish: (-1x200x7x7xf32) <- (-1x200x7x7xf32)
        hardswish_13 = paddle._C_ops.hardswish(batch_norm__168)

        # pd_op.depthwise_conv2d: (-1x200x7x7xf32) <- (-1x200x7x7xf32, 200x1x5x5xf32)
        ...
        # pd_op.pool2d: (-1x200x1x1xf32) <- (-1x200x7x7xf32, 2xi64)
        ...
        # pd_op.conv2d: (-1x50x1x1xf32) <- (-1x200x1x1xf32, 50x200x1x1xf32)
        ...
        # pd_op.add: (-1x50x1x1xf32) <- (-1x50x1x1xf32, 1x50x1x1xf32)
        add_20 = paddle._C_ops.add(conv2d_34, reshape_14)

        # pd_op.relu: (-1x50x1x1xf32) <- (-1x50x1x1xf32)
        relu_13 = paddle._C_ops.relu(add_20)

        # pd_op.conv2d: (-1x200x1x1xf32) <- (-1x50x1x1xf32, 200x50x1x1xf32)
        ...
        # pd_op.add: (-1x200x1x1xf32) <- (-1x200x1x1xf32, 1x200x1x1xf32)
        add_21 = paddle._C_ops.add(conv2d_35, reshape_15)

        # pd_op.hardsigmoid: (-1x200x1x1xf32) <- (-1x200x1x1xf32)
        hardsigmoid_7 = paddle._C_ops.hardsigmoid(add_21, float("0.2"), float("0.5"))

        # pd_op.multiply: (-1x200x7x7xf32) <- (-1x200x7x7xf32, -1x200x1x1xf32)
        multiply_7 = paddle._C_ops.multiply(hardswish_14, hardsigmoid_7)

        # pd_op.conv2d: (-1x32x7x7xf32) <- (-1x200x7x7xf32, 32x200x1x1xf32)
        ...
        # pd_op.add: (-1x32x7x7xf32) <- (-1x32x7x7xf32, -1x32x7x7xf32)
        add_22 = paddle._C_ops.add(batch_norm__162, batch_norm__180)

        # pd_op.conv2d: (-1x200x7x7xf32) <- (-1x32x7x7xf32, 200x32x1x1xf32)
        conv2d_37 = paddle._C_ops.conv2d(
            add_22, parameter_26, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.add: (-1x32x7x7xf32) <- (-1x32x7x7xf32, -1x32x7x7xf32)
        add_25 = paddle._C_ops.add(add_22, batch_norm__198)

        # pd_op.conv2d: (-1x200x7x7xf32) <- (-1x32x7x7xf32, 200x32x1x1xf32)
        conv2d_41 = paddle._C_ops.conv2d(
            add_25, parameter_7, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x1280x1x1xf32) <- (-1x200x1x1xf32, 1280x200x1x1xf32)
