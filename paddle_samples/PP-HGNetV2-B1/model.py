...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        t392 = paddle._C_ops.depthwise_conv2d(
            t386, t90, [1, 1], [2, 2], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        del t386, t90
        ...
        t409 = paddle._C_ops.depthwise_conv2d(
            t403, t100, [1, 1], [2, 2], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        del t403, t100
        ...
        t426 = paddle._C_ops.depthwise_conv2d(
            t420, t110, [1, 1], [2, 2], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        del t420, t110
        ...
        t465 = paddle._C_ops.depthwise_conv2d(
            t459, t130, [1, 1], [2, 2], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        del t459, t130
        ...
        t482 = paddle._C_ops.depthwise_conv2d(
            t476, t140, [1, 1], [2, 2], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        del t476, t140
        ...
        t499 = paddle._C_ops.depthwise_conv2d(
            t493, t150, [1, 1], [2, 2], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        del t493, t150
        ...
        t546 = paddle._C_ops.depthwise_conv2d(
            t540, t175, [1, 1], [2, 2], "EXPLICIT", 192, [1, 1], "NCHW"
        )
        del t540, t175
        ...
        t563 = paddle._C_ops.depthwise_conv2d(
            t557, t185, [1, 1], [2, 2], "EXPLICIT", 192, [1, 1], "NCHW"
        )
        del t557, t185
        ...
        t580 = paddle._C_ops.depthwise_conv2d(
            t574, t195, [1, 1], [2, 2], "EXPLICIT", 192, [1, 1], "NCHW"
        )
        del t574, t195
