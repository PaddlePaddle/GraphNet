...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4):
        ...
        # pd_op.argmax: (4x9261xi64) <- (4x1x9261xf32, 1xi64)
        ...
        # pd_op.gather: (37044xi32) <- (4xi32, 37044xi64, 1xi32)
        gather_0 = paddle._C_ops.gather(flatten_0, flatten_1, full_5)

        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_1 = [4, 9261]

        # pd_op.reshape: (4x9261xi32) <- (37044xi32, 2xi64)
        ...
        # pd_op.greater_than: (4x9261xb) <- (4x9261xf32, xf32)
        ...
        # pd_op.full_like: (4x9261xi32) <- (4x9261xi32, 1xf32)
        full_like_0 = paddle._C_ops.full_like(
            reshape_1, full_7, paddle.int32, paddle.framework._current_expected_place()
        )

        # pd_op.where: (4x9261xi32) <- (4x9261xb, 4x9261xi32, 4x9261xi32)
        ...
        # pd_op.gather: (37044x4xf32) <- (4x4xf32, 37044xi64, 1xi32)
        gather_1 = paddle._C_ops.gather(reshape_2, flatten_1, full_5)

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_3 = [4, 9261, 4]

        # pd_op.reshape: (4x9261x4xf32) <- (37044x4xf32, 3xi64)
        ...
        # pd_op.one_hot: (4x9261x5xf32) <- (4x9261xi32, 1xi32)
        ...
        # pd_op.index_select: (4x9261x4xf32) <- (4x9261x5xf32, 4xi64)
        ...
        # pd_op.unsqueeze: (4x1x9261x4xf32) <- (4x9261x4xf32, 1xi64)
        ...
        # pd_op.slice: (4x1x9261x2xf32) <- (4x1x9261x4xf32, 1xi64, 1xi64)
        ...
        # pd_op.maximum: (4x1x9261x2xf32) <- (4x1x1x2xf32, 4x1x9261x2xf32)
        maximum_0 = paddle._C_ops.maximum(slice_0, slice_2)

        # pd_op.minimum: (4x1x9261x2xf32) <- (4x1x1x2xf32, 4x1x9261x2xf32)
        minimum_0 = paddle._C_ops.minimum(slice_1, slice_3)

        # pd_op.subtract: (4x1x9261x2xf32) <- (4x1x9261x2xf32, 4x1x9261x2xf32)
        ...
        # pd_op.clip: (4x1x9261x2xf32) <- (4x1x9261x2xf32, 1xf32, 1xf32)
        clip_0 = paddle._C_ops.clip(subtract_0, full_10, full_11)

        # pd_op.prod: (4x1x9261xf32) <- (4x1x9261x2xf32, 1xi64)
        ...
        # pd_op.add: (4x1x9261xf32) <- (4x1x1xf32, 4x1x9261xf32)
        add_1 = paddle._C_ops.add(prod_1, prod_2)

        # pd_op.subtract: (4x1x9261xf32) <- (4x1x9261xf32, 4x1x9261xf32)
        subtract_3 = paddle._C_ops.subtract(add_1, prod_0)

        # pd_op.scale: (4x1x9261xf32) <- (4x1x9261xf32, 1xf32)
        scale_1 = paddle._C_ops.scale(subtract_3, full_4, float("1e-09"), True)

        # pd_op.divide: (4x1x9261xf32) <- (4x1x9261xf32, 4x1x9261xf32)
        ...
        # pd_op.max: (4x9261xf32) <- (4x1x9261xf32, 1xi64)
        max_0 = paddle._C_ops.max(multiply_1, full_int_array_8, False)

        # pd_op.unsqueeze: (4x9261x1xf32) <- (4x9261xf32, 1xi64)
        unsqueeze_3 = paddle._C_ops.unsqueeze(max_0, full_int_array_0)

        # pd_op.multiply: (4x9261x4xf32) <- (4x9261x4xf32, 4x9261x1xf32)
