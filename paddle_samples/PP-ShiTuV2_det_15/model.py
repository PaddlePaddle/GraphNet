...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (2x320x1x1xf32) <- (2x-1x1x1xf32, 320x1280x1x1xf32)
        ...
        # pd_op.add: (2x320x1x1xf32) <- (2x320x1x1xf32, 1x320x1x1xf32)
        add_0 = paddle._C_ops.add(conv2d_0, reshape_0)

        # pd_op.relu: (2x320x1x1xf32) <- (2x320x1x1xf32)
        relu_0 = paddle._C_ops.relu(add_0)

        # pd_op.conv2d: (2x1280x1x1xf32) <- (2x320x1x1xf32, 1280x320x1x1xf32)
        ...
        # pd_op.add: (2x1280x1x1xf32) <- (2x1280x1x1xf32, 1x1280x1x1xf32)
        add_1 = paddle._C_ops.add(conv2d_1, reshape_1)

        # pd_op.hardsigmoid: (2x1280x1x1xf32) <- (2x1280x1x1xf32)
        hardsigmoid_0 = paddle._C_ops.hardsigmoid(
            add_1, float("0.166667"), float("0.5")
        )

        # pd_op.multiply: (2x1280x-1x-1xf32) <- (2x-1x-1x-1xf32, 2x1280x1x1xf32)
