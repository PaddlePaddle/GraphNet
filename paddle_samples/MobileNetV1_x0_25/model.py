...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        conv2d_0 = paddle._C_ops.conv2d(
            data_0, parameter_136, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        depthwise_conv2d_0 = paddle._C_ops.depthwise_conv2d(
            relu_0, parameter_131, [1, 1], [1, 1], "EXPLICIT", 8, [1, 1], "NCHW"
        )
        ...
        conv2d_1 = paddle._C_ops.conv2d(
            relu_1, parameter_126, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        depthwise_conv2d_1 = paddle._C_ops.depthwise_conv2d(
            relu_2, parameter_121, [2, 2], [1, 1], "EXPLICIT", 16, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x32x56x56xf32) <- (-1x16x56x56xf32, 32x16x1x1xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            relu_3, parameter_116, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.depthwise_conv2d: (-1x32x56x56xf32) <- (-1x32x56x56xf32, 32x1x3x3xf32)
        depthwise_conv2d_2 = paddle._C_ops.depthwise_conv2d(
            relu_4, parameter_111, [1, 1], [1, 1], "EXPLICIT", 32, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x32x56x56xf32) <- (-1x32x56x56xf32, 32x32x1x1xf32)
        conv2d_3 = paddle._C_ops.conv2d(
            relu_5, parameter_106, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.depthwise_conv2d: (-1x32x28x28xf32) <- (-1x32x56x56xf32, 32x1x3x3xf32)
        depthwise_conv2d_3 = paddle._C_ops.depthwise_conv2d(
            relu_6, parameter_101, [2, 2], [1, 1], "EXPLICIT", 32, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x64x28x28xf32) <- (-1x32x28x28xf32, 64x32x1x1xf32)
        conv2d_4 = paddle._C_ops.conv2d(
            relu_7, parameter_96, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        depthwise_conv2d_4 = paddle._C_ops.depthwise_conv2d(
            relu_8, parameter_91, [1, 1], [1, 1], "EXPLICIT", 64, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x64x28x28xf32) <- (-1x64x28x28xf32, 64x64x1x1xf32)
        conv2d_5 = paddle._C_ops.conv2d(
            relu_9, parameter_86, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.depthwise_conv2d: (-1x64x14x14xf32) <- (-1x64x28x28xf32, 64x1x3x3xf32)
        depthwise_conv2d_5 = paddle._C_ops.depthwise_conv2d(
            relu_10, parameter_81, [2, 2], [1, 1], "EXPLICIT", 64, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x128x14x14xf32) <- (-1x64x14x14xf32, 128x64x1x1xf32)
        conv2d_6 = paddle._C_ops.conv2d(
            relu_11, parameter_76, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.depthwise_conv2d: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 128x1x3x3xf32)
        depthwise_conv2d_6 = paddle._C_ops.depthwise_conv2d(
            relu_12, parameter_71, [1, 1], [1, 1], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        ...
        conv2d_7 = paddle._C_ops.conv2d(
            relu_13, parameter_66, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        depthwise_conv2d_7 = paddle._C_ops.depthwise_conv2d(
            relu_14, parameter_61, [1, 1], [1, 1], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        ...
        conv2d_8 = paddle._C_ops.conv2d(
            relu_15, parameter_56, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        depthwise_conv2d_8 = paddle._C_ops.depthwise_conv2d(
            relu_16, parameter_51, [1, 1], [1, 1], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        ...
        conv2d_9 = paddle._C_ops.conv2d(
            relu_17, parameter_46, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        depthwise_conv2d_9 = paddle._C_ops.depthwise_conv2d(
            relu_18, parameter_41, [1, 1], [1, 1], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        ...
        conv2d_10 = paddle._C_ops.conv2d(
            relu_19, parameter_36, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        depthwise_conv2d_10 = paddle._C_ops.depthwise_conv2d(
            relu_20, parameter_31, [1, 1], [1, 1], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        ...
        # pd_op.relu: (-1x128x14x14xf32) <- (-1x128x14x14xf32)
        relu_21 = paddle._C_ops.relu(batch_norm__126)

        # pd_op.conv2d: (-1x128x14x14xf32) <- (-1x128x14x14xf32, 128x128x1x1xf32)
        conv2d_11 = paddle._C_ops.conv2d(
            relu_21, parameter_26, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x128x14x14xf32) <- (-1x128x14x14xf32)
        relu_22 = paddle._C_ops.relu(batch_norm__132)

        # pd_op.depthwise_conv2d: (-1x128x7x7xf32) <- (-1x128x14x14xf32, 128x1x3x3xf32)
        depthwise_conv2d_11 = paddle._C_ops.depthwise_conv2d(
            relu_22, parameter_21, [2, 2], [1, 1], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        ...
        relu_23 = paddle._C_ops.relu(batch_norm__138)

        # pd_op.conv2d: (-1x256x7x7xf32) <- (-1x128x7x7xf32, 256x128x1x1xf32)
        conv2d_12 = paddle._C_ops.conv2d(
            relu_23, parameter_16, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        relu_24 = paddle._C_ops.relu(batch_norm__144)

        # pd_op.depthwise_conv2d: (-1x256x7x7xf32) <- (-1x256x7x7xf32, 256x1x3x3xf32)
        depthwise_conv2d_12 = paddle._C_ops.depthwise_conv2d(
            relu_24, parameter_11, [1, 1], [1, 1], "EXPLICIT", 256, [1, 1], "NCHW"
        )
        ...
        # pd_op.relu: (-1x256x7x7xf32) <- (-1x256x7x7xf32)
        relu_25 = paddle._C_ops.relu(batch_norm__150)

        # pd_op.conv2d: (-1x256x7x7xf32) <- (-1x256x7x7xf32, 256x256x1x1xf32)
        conv2d_13 = paddle._C_ops.conv2d(
            relu_25, parameter_6, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x256x7x7xf32) <- (-1x256x7x7xf32)
        relu_26 = paddle._C_ops.relu(batch_norm__156)
