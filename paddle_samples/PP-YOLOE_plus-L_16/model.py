...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.maximum: (8x6069x2xf32) <- (8x1x2xf32, 1x6069x2xf32)
        maximum_0 = paddle._C_ops.maximum(slice_0, slice_2)

        # pd_op.minimum: (8x6069x2xf32) <- (8x1x2xf32, 1x6069x2xf32)
        minimum_0 = paddle._C_ops.minimum(slice_1, slice_3)

        # pd_op.subtract: (8x6069x2xf32) <- (8x6069x2xf32, 8x6069x2xf32)
        ...
        # pd_op.clip: (8x6069x2xf32) <- (8x6069x2xf32, 1xf32, 1xf32)
        clip_0 = paddle._C_ops.clip(subtract_0, full_0, full_1)

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_5 = [-1]

        # pd_op.prod: (8x6069xf32) <- (8x6069x2xf32, 1xi64)
        ...
        # pd_op.add: (8x6069xf32) <- (8x1xf32, 1x6069xf32)
        add_0 = paddle._C_ops.add(prod_1, prod_2)

        # pd_op.subtract: (8x6069xf32) <- (8x6069xf32, 8x6069xf32)
        ...
        # pd_op.scale: (8x6069xf32) <- (8x6069xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(subtract_3, full_2, float("1e-10"), True)

        # pd_op.divide: (8x6069xf32) <- (8x6069xf32, 8x6069xf32)
        divide_0 = paddle._C_ops.divide(prod_0, scale_0)

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_6 = [8, -1, 6069]

        # pd_op.reshape: (8x1x6069xf32) <- (8x6069xf32, 3xi64)
        ...
        # pd_op.subtract: (8x6069x2xf32) <- (8x1x2xf32, 1x6069x2xf32)
        subtract_4 = paddle._C_ops.subtract(unsqueeze_2, unsqueeze_3)

        # pd_op.p_norm: (8x6069xf32) <- (8x6069x2xf32)
