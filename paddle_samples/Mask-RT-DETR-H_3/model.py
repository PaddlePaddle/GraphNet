...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        full_int_array_1 = [1, 5376, 8, 32]

        # pd_op.reshape: (1x5376x8x32xf32) <- (1x5376x256xf32, 4xi64)
        ...
        # pd_op.split: ([-1x-1x-1x-1xf32, -1x-1x-1x-1xf32, -1x-1x-1x-1xf32]) <- (1x5376x8x32xf32, 3xi64, 1xi32)
