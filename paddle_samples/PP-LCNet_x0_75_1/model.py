...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (-1x48x56x56xf32) <- (-1x24x56x56xf32, 48x24x1x1xf32)
        ...
        # pd_op.hardswish: (-1x48x56x56xf32) <- (-1x48x56x56xf32)
        hardswish_4 = paddle._C_ops.hardswish(batch_norm__24)

        # pd_op.depthwise_conv2d: (-1x48x56x56xf32) <- (-1x48x56x56xf32, 48x1x3x3xf32)
        ...
        # pd_op.conv2d: (-1x48x56x56xf32) <- (-1x48x56x56xf32, 48x48x1x1xf32)
        ...
        # pd_op.conv2d: (-1x96x28x28xf32) <- (-1x48x28x28xf32, 96x48x1x1xf32)
        ...
        # pd_op.conv2d: (-1x96x28x28xf32) <- (-1x96x28x28xf32, 96x96x1x1xf32)
        ...
        # pd_op.conv2d: (-1x192x14x14xf32) <- (-1x96x14x14xf32, 192x96x1x1xf32)
        ...
        # pd_op.hardswish: (-1x192x14x14xf32) <- (-1x192x14x14xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x192x7x7xf32) <- (-1x192x14x14xf32, 192x1x5x5xf32)
        ...
        # pd_op.hardswish: (-1x192x7x7xf32) <- (-1x192x7x7xf32)
        ...
        # pd_op.multiply: (-1x192x7x7xf32) <- (-1x192x7x7xf32, -1x192x1x1xf32)
        multiply_0 = paddle._C_ops.multiply(hardswish_23, hardsigmoid_0)

        # pd_op.conv2d: (-1x384x7x7xf32) <- (-1x192x7x7xf32, 384x192x1x1xf32)
        ...
        # pd_op.hardswish: (-1x384x7x7xf32) <- (-1x384x7x7xf32)
        ...
        # pd_op.multiply: (-1x384x7x7xf32) <- (-1x384x7x7xf32, -1x384x1x1xf32)
        ...
        # pd_op.conv2d: (-1x1280x1x1xf32) <- (-1x384x1x1xf32, 1280x384x1x1xf32)
