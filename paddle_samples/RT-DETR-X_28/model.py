...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3):
        ...
        slice_2 = paddle._C_ops.slice(
            slice_0, [0], full_int_array_2, full_int_array_3, [1], [0]
        )
        ...
        slice_3 = paddle._C_ops.slice(
            data_1, [0], full_int_array_2, full_int_array_3, [1], [0]
        )

        # pd_op.slice: (xi64) <- (2xi64, 1xi64, 1xi64)
        slice_4 = paddle._C_ops.slice(
            slice_3, [0], full_int_array_1, full_int_array_2, [1], [0]
        )

        # pd_op.slice: (xi64) <- (2xi64, 1xi64, 1xi64)
        slice_5 = paddle._C_ops.slice(
            slice_3, [0], full_int_array_2, full_int_array_3, [1], [0]
        )
        ...
        slice_6 = paddle._C_ops.slice(
            data_1, [0], full_int_array_3, full_int_array_4, [1], [0]
        )
        ...
        slice_8 = paddle._C_ops.slice(
            slice_6, [0], full_int_array_2, full_int_array_3, [1], [0]
        )
        ...
        # pd_op.split: ([-1x-1x-1x-1xf32, -1x-1x-1x-1xf32, -1x-1x-1x-1xf32]) <- (2x8400x8x32xf32, 3xi64, 1xi32)
        ...
        transpose_1 = paddle._C_ops.transpose(slice_9, [0, 2, 1, 3, 4])
        ...
        slice_10 = paddle._C_ops.slice(
            scale_0, [3], full_int_array_2, full_int_array_3, [1], [3]
        )

        # pd_op.transpose: (2x8x500x4x2xf32) <- (2x500x8x4x2xf32)
        transpose_3 = paddle._C_ops.transpose(slice_10, [0, 2, 1, 3, 4])
        ...
        slice_11 = paddle._C_ops.slice(
            scale_0, [3], full_int_array_3, full_int_array_4, [1], [3]
        )

        # pd_op.transpose: (2x8x500x4x2xf32) <- (2x500x8x4x2xf32)
        transpose_5 = paddle._C_ops.transpose(slice_11, [0, 2, 1, 3, 4])
