...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        conv2d_0 = paddle._C_ops.conv2d(
            data_2, parameter_294, [14, 14], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        combine_0 = [slice_48, full_7, full_7]
        ...
        reshape_24 = paddle._C_ops.reshape(add_1, full_int_array_4)
        ...
        # pd_op.assign: (1xi64) <- (1xi64)
        assign_162 = full_int_array_0

        # pd_op.assign: (1xi64) <- (1xi64)
        assign_161 = full_int_array_0

        # pd_op.assign: (1xi64) <- (1xi64)
        assign_155 = full_int_array_0

        # pd_op.assign: (1xi64) <- (1xi64)
        assign_154 = full_int_array_0

        # pd_op.assign: (1xi64) <- (1xi64)
        assign_148 = full_int_array_0

        # pd_op.assign: (1xi64) <- (1xi64)
        assign_147 = full_int_array_0
        ...
        # pd_op.assign: (1xi64) <- (1xi64)
        assign_113 = full_int_array_0

        # pd_op.assign: (1xi64) <- (1xi64)
        assign_112 = full_int_array_0

        # pd_op.assign: (1xi64) <- (1xi64)
        assign_106 = full_int_array_0

        # pd_op.assign: (1xi64) <- (1xi64)
        assign_105 = full_int_array_0

        # pd_op.assign: (1xi64) <- (1xi64)
        assign_99 = full_int_array_0

        # pd_op.assign: (1xi64) <- (1xi64)
        assign_98 = full_int_array_0

        # pd_op.assign: (1xi64) <- (1xi64)
        assign_92 = full_int_array_0

        # pd_op.assign: (1xi64) <- (1xi64)
        assign_91 = full_int_array_0

        # pd_op.assign: (1xi64) <- (1xi64)
        assign_85 = full_int_array_0

        # pd_op.assign: (1xi64) <- (1xi64)
        assign_84 = full_int_array_0

        # pd_op.assign: (1xi64) <- (1xi64)
        assign_78 = full_int_array_0

        # pd_op.assign: (1xi64) <- (1xi64)
        assign_77 = full_int_array_0
        ...
        # pd_op.assign: (1xi64) <- (1xi64)
        assign_63 = full_int_array_0

        # pd_op.assign: (1xi64) <- (1xi64)
        assign_57 = full_int_array_0

        # pd_op.assign: (1xi64) <- (1xi64)
        assign_56 = full_int_array_0

        # pd_op.assign: (1xi64) <- (1xi64)
        assign_50 = full_int_array_0

        # pd_op.assign: (1xi64) <- (1xi64)
        assign_49 = full_int_array_0

        # pd_op.assign: (1xi64) <- (1xi64)
        assign_43 = full_int_array_0

        # pd_op.assign: (1xi64) <- (1xi64)
        assign_42 = full_int_array_0
        ...
        slice_51 = paddle._C_ops.slice(
            transpose_1, [0], full_int_array_3, full_int_array_0, [1], [0]
        )
        ...
        transpose_2 = paddle._C_ops.transpose(slice_51, [0, 1, 3, 2])
        ...
        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_25 = paddle._C_ops.reshape(add_7, full_int_array_4)
        ...
        slice_53 = paddle._C_ops.slice(
            transpose_4, [0], full_int_array_3, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_5 = paddle._C_ops.transpose(slice_53, [0, 1, 3, 2])
        ...
        # pd_op.reshape: (-1x257x1024xf32) <- (-1x257x16x64xf32, 3xi64)
        reshape_1 = paddle._C_ops.reshape(transpose_6, full_int_array_5)
        ...
        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_26 = paddle._C_ops.reshape(add_13, full_int_array_4)
        ...
        slice_55 = paddle._C_ops.slice(
            transpose_7, [0], full_int_array_3, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_8 = paddle._C_ops.transpose(slice_55, [0, 1, 3, 2])
        ...
        # pd_op.reshape: (-1x257x1024xf32) <- (-1x257x16x64xf32, 3xi64)
        reshape_2 = paddle._C_ops.reshape(transpose_9, full_int_array_5)
        ...
        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_27 = paddle._C_ops.reshape(add_19, full_int_array_4)
        ...
        slice_57 = paddle._C_ops.slice(
            transpose_10, [0], full_int_array_3, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_11 = paddle._C_ops.transpose(slice_57, [0, 1, 3, 2])
        ...
        # pd_op.reshape: (-1x257x1024xf32) <- (-1x257x16x64xf32, 3xi64)
        reshape_3 = paddle._C_ops.reshape(transpose_12, full_int_array_5)
        ...
        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_28 = paddle._C_ops.reshape(add_25, full_int_array_4)
        ...
        slice_59 = paddle._C_ops.slice(
            transpose_13, [0], full_int_array_3, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_14 = paddle._C_ops.transpose(slice_59, [0, 1, 3, 2])
        ...
        # pd_op.reshape: (-1x257x1024xf32) <- (-1x257x16x64xf32, 3xi64)
        reshape_4 = paddle._C_ops.reshape(transpose_15, full_int_array_5)
        ...
        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_29 = paddle._C_ops.reshape(add_31, full_int_array_4)
        ...
        slice_61 = paddle._C_ops.slice(
            transpose_16, [0], full_int_array_3, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_17 = paddle._C_ops.transpose(slice_61, [0, 1, 3, 2])
        ...
        # pd_op.reshape: (-1x257x1024xf32) <- (-1x257x16x64xf32, 3xi64)
        reshape_5 = paddle._C_ops.reshape(transpose_18, full_int_array_5)
        ...
        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_30 = paddle._C_ops.reshape(add_37, full_int_array_4)
        ...
        slice_63 = paddle._C_ops.slice(
            transpose_19, [0], full_int_array_3, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_20 = paddle._C_ops.transpose(slice_63, [0, 1, 3, 2])
        ...
        # pd_op.reshape: (-1x257x1024xf32) <- (-1x257x16x64xf32, 3xi64)
        reshape_6 = paddle._C_ops.reshape(transpose_21, full_int_array_5)
        ...
        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_31 = paddle._C_ops.reshape(add_43, full_int_array_4)
        ...
        slice_65 = paddle._C_ops.slice(
            transpose_22, [0], full_int_array_3, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_23 = paddle._C_ops.transpose(slice_65, [0, 1, 3, 2])
        ...
        # pd_op.reshape: (-1x257x1024xf32) <- (-1x257x16x64xf32, 3xi64)
        reshape_7 = paddle._C_ops.reshape(transpose_24, full_int_array_5)
        ...
        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_32 = paddle._C_ops.reshape(add_49, full_int_array_4)
        ...
        slice_67 = paddle._C_ops.slice(
            transpose_25, [0], full_int_array_3, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_26 = paddle._C_ops.transpose(slice_67, [0, 1, 3, 2])
        ...
        # pd_op.reshape: (-1x257x1024xf32) <- (-1x257x16x64xf32, 3xi64)
        reshape_8 = paddle._C_ops.reshape(transpose_27, full_int_array_5)
        ...
        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_33 = paddle._C_ops.reshape(add_55, full_int_array_4)
        ...
        slice_69 = paddle._C_ops.slice(
            transpose_28, [0], full_int_array_3, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_29 = paddle._C_ops.transpose(slice_69, [0, 1, 3, 2])
        ...
        # pd_op.reshape: (-1x257x1024xf32) <- (-1x257x16x64xf32, 3xi64)
        reshape_9 = paddle._C_ops.reshape(transpose_30, full_int_array_5)
        ...
        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_34 = paddle._C_ops.reshape(add_61, full_int_array_4)
        ...
        slice_71 = paddle._C_ops.slice(
            transpose_31, [0], full_int_array_3, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_32 = paddle._C_ops.transpose(slice_71, [0, 1, 3, 2])
        ...
        # pd_op.reshape: (-1x257x1024xf32) <- (-1x257x16x64xf32, 3xi64)
        reshape_10 = paddle._C_ops.reshape(transpose_33, full_int_array_5)
        ...
        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_35 = paddle._C_ops.reshape(add_67, full_int_array_4)
        ...
        slice_73 = paddle._C_ops.slice(
            transpose_34, [0], full_int_array_3, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_35 = paddle._C_ops.transpose(slice_73, [0, 1, 3, 2])
        ...
        # pd_op.reshape: (-1x257x1024xf32) <- (-1x257x16x64xf32, 3xi64)
        reshape_11 = paddle._C_ops.reshape(transpose_36, full_int_array_5)
        ...
        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_36 = paddle._C_ops.reshape(add_73, full_int_array_4)
        ...
        slice_75 = paddle._C_ops.slice(
            transpose_37, [0], full_int_array_3, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_38 = paddle._C_ops.transpose(slice_75, [0, 1, 3, 2])
        ...
        # pd_op.reshape: (-1x257x1024xf32) <- (-1x257x16x64xf32, 3xi64)
        reshape_12 = paddle._C_ops.reshape(transpose_39, full_int_array_5)
        ...
        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_37 = paddle._C_ops.reshape(add_79, full_int_array_4)
        ...
        slice_77 = paddle._C_ops.slice(
            transpose_40, [0], full_int_array_3, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_41 = paddle._C_ops.transpose(slice_77, [0, 1, 3, 2])
        ...
        # pd_op.reshape: (-1x257x1024xf32) <- (-1x257x16x64xf32, 3xi64)
        reshape_13 = paddle._C_ops.reshape(transpose_42, full_int_array_5)
        ...
        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_38 = paddle._C_ops.reshape(add_85, full_int_array_4)
        ...
        slice_79 = paddle._C_ops.slice(
            transpose_43, [0], full_int_array_3, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_44 = paddle._C_ops.transpose(slice_79, [0, 1, 3, 2])
        ...
        # pd_op.reshape: (-1x257x1024xf32) <- (-1x257x16x64xf32, 3xi64)
        reshape_14 = paddle._C_ops.reshape(transpose_45, full_int_array_5)
        ...
        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_39 = paddle._C_ops.reshape(add_91, full_int_array_4)
        ...
        slice_81 = paddle._C_ops.slice(
            transpose_46, [0], full_int_array_3, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_47 = paddle._C_ops.transpose(slice_81, [0, 1, 3, 2])
        ...
        # pd_op.reshape: (-1x257x1024xf32) <- (-1x257x16x64xf32, 3xi64)
        reshape_15 = paddle._C_ops.reshape(transpose_48, full_int_array_5)
        ...
        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_40 = paddle._C_ops.reshape(add_97, full_int_array_4)
        ...
        slice_83 = paddle._C_ops.slice(
            transpose_49, [0], full_int_array_3, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_50 = paddle._C_ops.transpose(slice_83, [0, 1, 3, 2])
        ...
        # pd_op.reshape: (-1x257x1024xf32) <- (-1x257x16x64xf32, 3xi64)
        reshape_16 = paddle._C_ops.reshape(transpose_51, full_int_array_5)
        ...
        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_41 = paddle._C_ops.reshape(add_103, full_int_array_4)
        ...
        slice_85 = paddle._C_ops.slice(
            transpose_52, [0], full_int_array_3, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_53 = paddle._C_ops.transpose(slice_85, [0, 1, 3, 2])
        ...
        # pd_op.reshape: (-1x257x1024xf32) <- (-1x257x16x64xf32, 3xi64)
        reshape_17 = paddle._C_ops.reshape(transpose_54, full_int_array_5)
        ...
        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_42 = paddle._C_ops.reshape(add_109, full_int_array_4)
        ...
        slice_87 = paddle._C_ops.slice(
            transpose_55, [0], full_int_array_3, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_56 = paddle._C_ops.transpose(slice_87, [0, 1, 3, 2])
        ...
        # pd_op.reshape: (-1x257x1024xf32) <- (-1x257x16x64xf32, 3xi64)
        reshape_18 = paddle._C_ops.reshape(transpose_57, full_int_array_5)
        ...
        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_43 = paddle._C_ops.reshape(add_115, full_int_array_4)
        ...
        slice_89 = paddle._C_ops.slice(
            transpose_58, [0], full_int_array_3, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_59 = paddle._C_ops.transpose(slice_89, [0, 1, 3, 2])
        ...
        # pd_op.reshape: (-1x257x1024xf32) <- (-1x257x16x64xf32, 3xi64)
        reshape_19 = paddle._C_ops.reshape(transpose_60, full_int_array_5)
        ...
        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_44 = paddle._C_ops.reshape(add_121, full_int_array_4)
        ...
        slice_91 = paddle._C_ops.slice(
            transpose_61, [0], full_int_array_3, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_62 = paddle._C_ops.transpose(slice_91, [0, 1, 3, 2])
        ...
        # pd_op.reshape: (-1x257x1024xf32) <- (-1x257x16x64xf32, 3xi64)
        reshape_20 = paddle._C_ops.reshape(transpose_63, full_int_array_5)
        ...
        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_45 = paddle._C_ops.reshape(add_127, full_int_array_4)
        ...
        slice_93 = paddle._C_ops.slice(
            transpose_64, [0], full_int_array_3, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_65 = paddle._C_ops.transpose(slice_93, [0, 1, 3, 2])
        ...
        # pd_op.reshape: (-1x257x1024xf32) <- (-1x257x16x64xf32, 3xi64)
        reshape_21 = paddle._C_ops.reshape(transpose_66, full_int_array_5)
        ...
        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_46 = paddle._C_ops.reshape(add_133, full_int_array_4)
        ...
        slice_95 = paddle._C_ops.slice(
            transpose_67, [0], full_int_array_3, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_68 = paddle._C_ops.transpose(slice_95, [0, 1, 3, 2])
        ...
        # pd_op.reshape: (-1x257x1024xf32) <- (-1x257x16x64xf32, 3xi64)
        reshape_22 = paddle._C_ops.reshape(transpose_69, full_int_array_5)
        ...
        # pd_op.reshape: (-1x257x3x16x64xf32) <- (-1x257x3072xf32, 5xi64)
        reshape_47 = paddle._C_ops.reshape(add_139, full_int_array_4)
        ...
        slice_97 = paddle._C_ops.slice(
            transpose_70, [0], full_int_array_3, full_int_array_0, [1], [0]
        )
        ...
        # pd_op.transpose: (-1x16x64x257xf32) <- (-1x16x257x64xf32)
        transpose_71 = paddle._C_ops.transpose(slice_97, [0, 1, 3, 2])
        ...
        # pd_op.reshape: (-1x257x1024xf32) <- (-1x257x16x64xf32, 3xi64)
        reshape_23 = paddle._C_ops.reshape(transpose_72, full_int_array_5)
        ...
        matmul_96 = paddle._C_ops.matmul(layer_norm_147, data_0, False, False)
        ...
        greater_than_0 = paddle._C_ops.greater_than(matmul_98, full_8)
        ...
        one_hot_0 = paddle._C_ops.one_hot(
            data_3 % paddle.cast(full_9, data_3.dtype), full_9
        )
