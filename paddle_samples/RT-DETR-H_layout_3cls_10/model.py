...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6, data_7):
        ...
        # pd_op.clip: (3x1xf32) <- (3x1xf32, 1xf32, 1xf32)
        ...
        # pd_op.multiply: (3x1xf32) <- (3x1xf32, 3x1xf32)
        ...
        # pd_op.add: (3x1xf32) <- (3x1xf32, 3x1xf32)
        ...
        # pd_op.scale: (3x1xf32) <- (3x1xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(subtract_6, full_2, float("1e-09"), True)

        # pd_op.divide: (3x1xf32) <- (3x1xf32, 3x1xf32)
