...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (4x96x1x1xf32) <- (4x-1x1x1xf32, 96x384x1x1xf32)
        ...
        # pd_op.relu: (4x96x1x1xf32) <- (4x96x1x1xf32)
        relu_0 = paddle._C_ops.relu(add_0)

        # pd_op.conv2d: (4x384x1x1xf32) <- (4x96x1x1xf32, 384x96x1x1xf32)
        ...
        # pd_op.multiply: (4x384x-1x-1xf32) <- (4x-1x-1x-1xf32, 4x384x1x1xf32)
