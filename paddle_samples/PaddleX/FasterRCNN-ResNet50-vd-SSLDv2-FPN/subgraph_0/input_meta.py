class Program_weight_tensor_data_0:
    ...
    shape = [4, 256, 272, 200]
    dtype = "float32"
    min_val = float("-5.1768")
    max_val = float("5.37823")
    mean = float("-0.0718855")
    std = float("0.821262")
    data = None
...
class Program_weight_tensor_data_1:
    ...
    shape = [4, 256, 136, 100]
    dtype = "float32"
    min_val = float("-4.83513")
    max_val = float("5.00562")
    mean = float("-0.0382957")
    std = float("0.684757")
    data = None
...
class Program_weight_tensor_data_2:
    ...
    shape = [4, 256, 68, 50]
    dtype = "float32"
    min_val = float("-4.40332")
    max_val = float("3.82266")
    mean = float("-0.0244932")
    std = float("0.624231")
    data = None
...
class Program_weight_tensor_data_3:
    ...
    shape = [4, 256, 34, 25]
    dtype = "float32"
    min_val = float("-3.63749")
    max_val = float("3.49697")
    mean = float("-0.0204063")
    std = float("0.589087")
    data = None
...
class Program_weight_tensor_data_4:
    ...
    shape = [4, 256, 17, 13]
    dtype = "float32"
    min_val = float("-3.51989")
    max_val = float("3.16711")
    mean = float("-0.0216373")
    std = float("0.590614")
    data = None
