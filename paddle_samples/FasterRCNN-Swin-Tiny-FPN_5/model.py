...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        slice_3 = paddle._C_ops.slice(
            transpose_0, [0], full_int_array_3, full_int_array_0, [1], [0]
        )
        ...
        transpose_1 = paddle._C_ops.transpose(slice_3, [0, 1, 3, 2])
        ...
        flatten_0 = paddle._C_ops.flatten(data_1, 0, 1)

        # pd_op.index_select: (2401x12xf32) <- (169x12xf32, 2401xi64)
        index_select_0 = paddle._C_ops.index_select(data_2, flatten_0, 0)

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_5 = [49, 49, -1]

        # pd_op.reshape: (49x49x12xf32) <- (2401x12xf32, 3xi64)
        reshape_2 = paddle._C_ops.reshape(index_select_0, full_int_array_5)
        ...
        unsqueeze_0 = paddle._C_ops.unsqueeze(transpose_2, full_int_array_2)
