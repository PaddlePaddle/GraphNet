...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (-1x720x-1x-1xf32) <- (-1x-1x-1x-1xf32, 720x720x1x1xf32)
        ...
        # pd_op.batch_norm_: (-1x720x-1x-1xf32, 720xf32, 720xf32, 720xf32, 720xf32, -1xui8) <- (-1x720x-1x-1xf32, 720xf32, 720xf32, 720xf32, 720xf32)
        (
            batch_norm__0,
            batch_norm__1,
            batch_norm__2,
        ...
        # pd_op.relu: (-1x720x-1x-1xf32) <- (-1x720x-1x-1xf32)
        relu_0 = paddle._C_ops.relu(batch_norm__0)

        # pd_op.conv2d: (-1x2x-1x-1xf32) <- (-1x720x-1x-1xf32, 2x720x1x1xf32)
