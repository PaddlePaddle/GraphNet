...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.depthwise_conv2d: (2x256x-1x-1xf32) <- (2x-1x-1x-1xf32, 256x1x3x3xf32)
        ...
        # pd_op.hardswish: (2x256x-1x-1xf32) <- (2x256x-1x-1xf32)
        ...
        # pd_op.hardswish: (2x512x-1x-1xf32) <- (2x512x-1x-1xf32)
        hardswish_1 = paddle._C_ops.hardswish(batch_norm__6)

        # pd_op.depthwise_conv2d: (2x512x-1x-1xf32) <- (2x512x-1x-1xf32, 512x1x5x5xf32)
