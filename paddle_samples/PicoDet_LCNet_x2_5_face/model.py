...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        # pd_op.cast: (12903x1xf32) <- (12903x1xf64)
        ...
        # pd_op.greater_than: (12903x1xb) <- (12903x1xf32, xf32)
        greater_than_0 = paddle._C_ops.greater_than(cast_0, full_0)

        # pd_op.cast: (12903x1xf32) <- (12903x1xb)
        cast_1 = paddle._C_ops.cast(greater_than_0, paddle.float32)

        # pd_op.multiply: (12903x1xf32) <- (12903x1xf32, 12903x1xf32)
        multiply_0 = paddle._C_ops.multiply(cast_0, cast_1)

        # pd_op.subtract: (12903x1xf32) <- (12903x1xf32, 12903x1xf32)
        subtract_0 = paddle._C_ops.subtract(data_0, cast_0)

        # pd_op.abs: (12903x1xf32) <- (12903x1xf32)
        abs_0 = paddle._C_ops.abs(subtract_0)

        # pd_op.pow: (12903x1xf32) <- (12903x1xf32)
        ...
        # pd_op.scale: (12903x1xf32) <- (12903x1xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(pow_0, full_1, float("0"), True)

        # pd_op.less_equal: (12903x1xb) <- (12903x1xf32, xf32)
        ...
        # pd_op.add: (12903x1xf32) <- (12903x1xf32, 12903x1xf32)
        add_0 = paddle._C_ops.add(multiply_0, multiply_1)

        # pd_op.bce_loss: (12903x1xf32) <- (12903x1xf32, 12903x1xf32)
        ...
        # pd_op.sum: (12903xf32) <- (12903x1xf32, 1xi64)
