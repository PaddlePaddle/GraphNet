...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.unsqueeze: (1024x1xf32) <- (1024xf32, 1xi64)
        ...
        # pd_op.matmul: (1024x256xf32) <- (1024x1xf32, 1x256xf32)
        ...
        # pd_op.sin: (1024x256xf32) <- (1024x256xf32)
        t25 = paddle._C_ops.sin(t21)

        # pd_op.cos: (1024x256xf32) <- (1024x256xf32)
        ...
        # builtin.combine: ([1024x256xf32, 1024x256xf32, 1024x256xf32, 1024x256xf32]) <- (1024x256xf32, 1024x256xf32, 1024x256xf32, 1024x256xf32)
        t30 = [t25, t26, t27, t28]
        del t26, t28, t25, t27

        # pd_op.concat: (1024x1024xf32) <- ([1024x256xf32, 1024x256xf32, 1024x256xf32, 1024x256xf32], 1xi32)
