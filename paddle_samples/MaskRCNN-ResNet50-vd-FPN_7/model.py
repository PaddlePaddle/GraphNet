...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.full_like: (129024x4xf32) <- (129024x4xf32, 1xf32)
        full_like_0 = paddle._C_ops.full_like(
            data_10, full_0, paddle.float32, paddle.framework._current_expected_place()
        )

        # pd_op.generate_proposals: (-1x4xf32, -1x1xf32, 1xf32) <- (1x3x168x256xf32, 1x12x168x256xf32, 1x2xf32, 129024x4xf32, 129024x4xf32)
        ...
        # pd_op.full_like: (32256x4xf32) <- (32256x4xf32, 1xf32)
        full_like_1 = paddle._C_ops.full_like(
            data_11, full_0, paddle.float32, paddle.framework._current_expected_place()
        )

        # pd_op.generate_proposals: (-1x4xf32, -1x1xf32, 1xf32) <- (1x3x84x128xf32, 1x12x84x128xf32, 1x2xf32, 32256x4xf32, 32256x4xf32)
        ...
        # pd_op.full_like: (8064x4xf32) <- (8064x4xf32, 1xf32)
        full_like_2 = paddle._C_ops.full_like(
            data_12, full_0, paddle.float32, paddle.framework._current_expected_place()
        )

        # pd_op.generate_proposals: (-1x4xf32, -1x1xf32, 1xf32) <- (1x3x42x64xf32, 1x12x42x64xf32, 1x2xf32, 8064x4xf32, 8064x4xf32)
        ...
        # pd_op.full_like: (2016x4xf32) <- (2016x4xf32, 1xf32)
        full_like_3 = paddle._C_ops.full_like(
            data_13, full_0, paddle.float32, paddle.framework._current_expected_place()
        )

        # pd_op.generate_proposals: (-1x4xf32, -1x1xf32, 1xf32) <- (1x3x21x32xf32, 1x12x21x32xf32, 1x2xf32, 2016x4xf32, 2016x4xf32)
        ...
        # pd_op.full_like: (528x4xf32) <- (528x4xf32, 1xf32)
        full_like_4 = paddle._C_ops.full_like(
            data_14, full_0, paddle.float32, paddle.framework._current_expected_place()
        )

        # pd_op.generate_proposals: (-1x4xf32, -1x1xf32, 1xf32) <- (1x3x11x16xf32, 1x12x11x16xf32, 1x2xf32, 528x4xf32, 528x4xf32)
