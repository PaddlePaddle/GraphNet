...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6, data_7):
        # pd_op.divide: (2x-1x4xf32) <- (2x-1x4xf32, -1x1xf32)
        ...
        combine_0 = [full_0, slice_0, full_0]

        # pd_op.stack: (3xi64) <- ([xi64, xi64, xi64])
        stack_0 = paddle._C_ops.stack(combine_0, 0)

        # pd_op.expand: (2x-1x2xf32) <- (-1x2xf32, 3xi64)
        expand_0 = paddle._C_ops.expand(data_4, stack_0)

        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_2 = [-1, 2]

        # pd_op.reshape: (-1x2xf32) <- (2x-1x2xf32, 2xi64)
        ...
        reshape_3 = paddle._C_ops.reshape(data_7, full_int_array_6)
        ...
        # pd_op.reshape: (-1xi32) <- (2x-1xi32, 1xi64)
        reshape_7 = paddle._C_ops.reshape(data_0, full_int_array_7)
        ...
        greater_equal_0 = paddle._C_ops.greater_equal(reshape_7, full_2)

        # pd_op.full: (xi32) <- ()
        full_3 = paddle._C_ops.full(
            [], float("11"), paddle.int32, paddle.framework._current_expected_place()
        )

        # pd_op.less_than: (-1xb) <- (-1xi32, xi32)
        less_than_0 = paddle._C_ops.less_than(reshape_7, full_3)
