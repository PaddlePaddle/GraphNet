...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (-1x64x112x112xf32) <- (-1x16x112x112xf32, 64x16x1x1xf32)
        ...
        t310 = paddle._C_ops.depthwise_conv2d(
            t309, t25, [2, 2], [1, 1], "EXPLICIT", 64, [1, 1], "NCHW"
        )
        del t25, t309
        ...
        # pd_op.conv2d: (-1x24x56x56xf32) <- (-1x64x56x56xf32, 24x64x1x1xf32)
        ...
        # pd_op.conv2d: (-1x72x56x56xf32) <- (-1x24x56x56xf32, 72x24x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x72x56x56xf32) <- (-1x72x56x56xf32, 72x1x3x3xf32)
        t333 = paddle._C_ops.depthwise_conv2d(
            t332, t40, [1, 1], [1, 1], "EXPLICIT", 72, [1, 1], "NCHW"
        )
        del t40, t332
        ...
        # pd_op.conv2d: (-1x24x56x56xf32) <- (-1x72x56x56xf32, 24x72x1x1xf32)
        ...
        t357 = paddle._C_ops.depthwise_conv2d(
            t356, t55, [2, 2], [2, 2], "EXPLICIT", 72, [1, 1], "NCHW"
        )
        del t55, t356
        ...
        # pd_op.multiply: (-1x72x28x28xf32) <- (-1x72x28x28xf32, -1x72x1x1xf32)
        t376 = paddle._C_ops.multiply(t364, t375)
        del t375, t364

        # pd_op.conv2d: (-1x40x28x28xf32) <- (-1x72x28x28xf32, 40x72x1x1xf32)
        ...
        # pd_op.relu: (-1x120x28x28xf32) <- (-1x120x28x28xf32)
        ...
        t392 = paddle._C_ops.depthwise_conv2d(
            t391, t74, [1, 1], [2, 2], "EXPLICIT", 120, [1, 1], "NCHW"
        )
        del t74, t391
        ...
        # pd_op.multiply: (-1x120x28x28xf32) <- (-1x120x28x28xf32, -1x120x1x1xf32)
        t409 = paddle._C_ops.multiply(t399, t408)
        del t408, t399

        # pd_op.conv2d: (-1x40x28x28xf32) <- (-1x120x28x28xf32, 40x120x1x1xf32)
        ...
        # pd_op.add: (-1x40x28x28xf32) <- (-1x40x28x28xf32, -1x40x28x28xf32)
        ...
        t426 = paddle._C_ops.depthwise_conv2d(
            t425, t93, [1, 1], [2, 2], "EXPLICIT", 120, [1, 1], "NCHW"
        )
        del t93, t425
        ...
        # pd_op.batch_norm_: (-1x240x28x28xf32, 240xf32, 240xf32, 240xf32, 240xf32, -1xui8) <- (-1x240x28x28xf32, 240xf32, 240xf32, 240xf32, 240xf32)
        ...
        # pd_op.hardswish: (-1x240x28x28xf32) <- (-1x240x28x28xf32)
        ...
        t460 = paddle._C_ops.depthwise_conv2d(
            t459, t112, [2, 2], [1, 1], "EXPLICIT", 240, [1, 1], "NCHW"
        )
        del t459, t112
        ...
        # pd_op.batch_norm_: (-1x80x14x14xf32, 80xf32, 80xf32, 80xf32, 80xf32, -1xui8) <- (-1x80x14x14xf32, 80xf32, 80xf32, 80xf32, 80xf32)
        ...
        # pd_op.conv2d: (-1x200x14x14xf32) <- (-1x80x14x14xf32, 200x80x1x1xf32)
        t475 = paddle._C_ops.conv2d(
            t469, t122, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del t122

        # pd_op.batch_norm_: (-1x200x14x14xf32, 200xf32, 200xf32, 200xf32, 200xf32, -1xui8) <- (-1x200x14x14xf32, 200xf32, 200xf32, 200xf32, 200xf32)
        ...
        # pd_op.hardswish: (-1x200x14x14xf32) <- (-1x200x14x14xf32)
        t482 = paddle._C_ops.hardswish(t476)
        del t476

        # pd_op.depthwise_conv2d: (-1x200x14x14xf32) <- (-1x200x14x14xf32, 200x1x3x3xf32)
        t483 = paddle._C_ops.depthwise_conv2d(
            t482, t127, [1, 1], [1, 1], "EXPLICIT", 200, [1, 1], "NCHW"
        )
        del t482, t127
        ...
        # pd_op.conv2d: (-1x80x14x14xf32) <- (-1x200x14x14xf32, 80x200x1x1xf32)
        ...
        # pd_op.add: (-1x80x14x14xf32) <- (-1x80x14x14xf32, -1x80x14x14xf32)
        t498 = paddle._C_ops.add(t469, t492)
        del t469, t492

        # pd_op.conv2d: (-1x184x14x14xf32) <- (-1x80x14x14xf32, 184x80x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x184x14x14xf32) <- (-1x184x14x14xf32, 184x1x3x3xf32)
        t507 = paddle._C_ops.depthwise_conv2d(
            t506, t142, [1, 1], [1, 1], "EXPLICIT", 184, [1, 1], "NCHW"
        )
        del t506, t142
        ...
        # pd_op.conv2d: (-1x80x14x14xf32) <- (-1x184x14x14xf32, 80x184x1x1xf32)
        ...
        t531 = paddle._C_ops.depthwise_conv2d(
            t530, t157, [1, 1], [1, 1], "EXPLICIT", 184, [1, 1], "NCHW"
        )
        del t530, t157
        ...
        # pd_op.batch_norm_: (-1x480x14x14xf32, 480xf32, 480xf32, 480xf32, 480xf32, -1xui8) <- (-1x480x14x14xf32, 480xf32, 480xf32, 480xf32, 480xf32)
        ...
        # pd_op.hardswish: (-1x480x14x14xf32) <- (-1x480x14x14xf32)
        ...
        t555 = paddle._C_ops.depthwise_conv2d(
            t554, t172, [1, 1], [1, 1], "EXPLICIT", 480, [1, 1], "NCHW"
        )
        del t554, t172
        ...
        # pd_op.multiply: (-1x480x14x14xf32) <- (-1x480x14x14xf32, -1x480x1x1xf32)
        ...
        # pd_op.batch_norm_: (-1x672x14x14xf32, 672xf32, 672xf32, 672xf32, 672xf32, -1xui8) <- (-1x672x14x14xf32, 672xf32, 672xf32, 672xf32, 672xf32)
        ...
        # pd_op.hardswish: (-1x672x14x14xf32) <- (-1x672x14x14xf32)
        t587 = paddle._C_ops.hardswish(t581)
        del t581

        # pd_op.depthwise_conv2d: (-1x672x14x14xf32) <- (-1x672x14x14xf32, 672x1x3x3xf32)
        t588 = paddle._C_ops.depthwise_conv2d(
            t587, t191, [1, 1], [1, 1], "EXPLICIT", 672, [1, 1], "NCHW"
        )
        del t587, t191
        ...
        # pd_op.relu: (-1x168x1x1xf32) <- (-1x168x1x1xf32)
        ...
        # pd_op.add: (-1x672x1x1xf32) <- (-1x672x1x1xf32, 1x672x1x1xf32)
        ...
        # pd_op.multiply: (-1x672x14x14xf32) <- (-1x672x14x14xf32, -1x672x1x1xf32)
        ...
        # pd_op.add: (-1x112x14x14xf32) <- (-1x112x14x14xf32, -1x112x14x14xf32)
        ...
        t622 = paddle._C_ops.depthwise_conv2d(
            t621, t210, [2, 2], [2, 2], "EXPLICIT", 672, [1, 1], "NCHW"
        )
        del t621, t210

        # pd_op.batch_norm_: (-1x672x7x7xf32, 672xf32, 672xf32, 672xf32, 672xf32, -1xui8) <- (-1x672x7x7xf32, 672xf32, 672xf32, 672xf32, 672xf32)
        ...
        # pd_op.hardswish: (-1x672x7x7xf32) <- (-1x672x7x7xf32)
        ...
        # pd_op.multiply: (-1x672x7x7xf32) <- (-1x672x7x7xf32, -1x672x1x1xf32)
        t639 = paddle._C_ops.multiply(t629, t638)
        del t638, t629

        # pd_op.conv2d: (-1x160x7x7xf32) <- (-1x672x7x7xf32, 160x672x1x1xf32)
        t640 = paddle._C_ops.conv2d(
            t639, t219, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        del t639, t219

        # pd_op.batch_norm_: (-1x160x7x7xf32, 160xf32, 160xf32, 160xf32, 160xf32, -1xui8) <- (-1x160x7x7xf32, 160xf32, 160xf32, 160xf32, 160xf32)
        ...
        # pd_op.hardswish: (-1x960x7x7xf32) <- (-1x960x7x7xf32)
        t654 = paddle._C_ops.hardswish(t648)
        del t648

        # pd_op.depthwise_conv2d: (-1x960x7x7xf32) <- (-1x960x7x7xf32, 960x1x5x5xf32)
        t655 = paddle._C_ops.depthwise_conv2d(
            t654, t229, [1, 1], [2, 2], "EXPLICIT", 960, [1, 1], "NCHW"
        )
        del t654, t229
        ...
        # pd_op.relu: (-1x240x1x1xf32) <- (-1x240x1x1xf32)
        ...
        # pd_op.multiply: (-1x960x7x7xf32) <- (-1x960x7x7xf32, -1x960x1x1xf32)
        t672 = paddle._C_ops.multiply(t662, t671)
        del t671, t662

        # pd_op.conv2d: (-1x160x7x7xf32) <- (-1x960x7x7xf32, 160x960x1x1xf32)
        ...
        # pd_op.add: (-1x160x7x7xf32) <- (-1x160x7x7xf32, -1x160x7x7xf32)
        ...
        t689 = paddle._C_ops.depthwise_conv2d(
            t688, t248, [1, 1], [2, 2], "EXPLICIT", 960, [1, 1], "NCHW"
        )
        del t688, t248
