...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3):
        # pd_op.sigmoid: (2x300x2xf32) <- (2x300x2xf32)
        sigmoid_0 = paddle._C_ops.sigmoid(data_0)

        # pd_op.pow: (2x300x2xf32) <- (2x300x2xf32)
        ...
        # pd_op.scale: (2x300x2xf32) <- (2x300x2xf32, 1xf32)
        ...
        # pd_op.sigmoid_cross_entropy_with_logits: (2x300x2xf32) <- (2x300x2xf32, 2x300x2xf32, None)
        ...
        # pd_op.mean: (2x2xf32) <- (2x300x2xf32)
        mean_0 = paddle._C_ops.mean(multiply_2, [1], False)

        # pd_op.full_int_array: (0xi64) <- ()
        full_int_array_0 = []

        # pd_op.sum: (xf32) <- (2x2xf32, 0xi64)
