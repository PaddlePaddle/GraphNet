...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4):
        ...
        # pd_op.full_like: (253xi32) <- (253xi32, 1xf32)
        full_like_0 = paddle._C_ops.full_like(
            data_1, full_1, paddle.int32, paddle.framework._current_expected_place()
        )
        del full_1

        # pd_op.scatter: (196416xi32) <- (196416xi32, 253xi32, 253xi32)
        ...
        # pd_op.gather: (196416x4xf32) <- (1x4xf32, 196416xi64, 1xi32)
        ...
        # pd_op.scale: (196416xf32) <- (196416xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(subtract_0, full_4, float("0"), True)

        # pd_op.add: (196416xf32) <- (196416xf32, 196416xf32)
        ...
        # pd_op.divide: (196416xf32) <- (196416xf32, 196416xf32)
        ...
        # pd_op.log: (196416xf32) <- (196416xf32)
        ...
        # builtin.combine: ([196416xf32, 196416xf32, 196416xf32, 196416xf32]) <- (196416xf32, 196416xf32, 196416xf32, 196416xf32)
        combine_0 = [divide_0, divide_1, scale_6, scale_7]
        del divide_0, divide_1, scale_6, scale_7

        # pd_op.stack: (196416x4xf32) <- ([196416xf32, 196416xf32, 196416xf32, 196416xf32])
