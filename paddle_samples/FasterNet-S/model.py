...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        combine_2 = [slice_0, full_18, full_18, full_18]
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_4 = [slice_1, full_18, full_18, full_18]
        ...
        split_39 = paddle._C_ops.split(batch_norm__27, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_6 = [slice_2, full_18, full_18, full_18]
        ...
        # pd_op.split: ([-1x128x14x14xf32, -1x384x14x14xf32]) <- (-1x512x14x14xf32, 2xi64, 1xi32)
        split_40 = paddle._C_ops.split(add_3, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_8 = [slice_3, full_18, full_18, full_18]
        ...
        # pd_op.split: ([-1x128x14x14xf32, -1x384x14x14xf32]) <- (-1x512x14x14xf32, 2xi64, 1xi32)
        split_41 = paddle._C_ops.split(add_4, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_10 = [slice_4, full_18, full_18, full_18]
        ...
        # pd_op.split: ([-1x128x14x14xf32, -1x384x14x14xf32]) <- (-1x512x14x14xf32, 2xi64, 1xi32)
        split_42 = paddle._C_ops.split(add_5, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_12 = [slice_5, full_18, full_18, full_18]
        ...
        # pd_op.split: ([-1x128x14x14xf32, -1x384x14x14xf32]) <- (-1x512x14x14xf32, 2xi64, 1xi32)
        split_43 = paddle._C_ops.split(add_6, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_14 = [slice_6, full_18, full_18, full_18]
        ...
        # pd_op.split: ([-1x128x14x14xf32, -1x384x14x14xf32]) <- (-1x512x14x14xf32, 2xi64, 1xi32)
        split_44 = paddle._C_ops.split(add_7, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_16 = [slice_7, full_18, full_18, full_18]
        ...
        # pd_op.split: ([-1x128x14x14xf32, -1x384x14x14xf32]) <- (-1x512x14x14xf32, 2xi64, 1xi32)
        split_45 = paddle._C_ops.split(add_8, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_18 = [slice_8, full_18, full_18, full_18]
        ...
        # pd_op.split: ([-1x128x14x14xf32, -1x384x14x14xf32]) <- (-1x512x14x14xf32, 2xi64, 1xi32)
        split_46 = paddle._C_ops.split(add_9, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_20 = [slice_9, full_18, full_18, full_18]
        ...
        # pd_op.split: ([-1x128x14x14xf32, -1x384x14x14xf32]) <- (-1x512x14x14xf32, 2xi64, 1xi32)
        split_47 = paddle._C_ops.split(add_10, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_22 = [slice_10, full_18, full_18, full_18]
        ...
        # pd_op.split: ([-1x128x14x14xf32, -1x384x14x14xf32]) <- (-1x512x14x14xf32, 2xi64, 1xi32)
        split_48 = paddle._C_ops.split(add_11, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_24 = [slice_11, full_18, full_18, full_18]
        ...
        # pd_op.split: ([-1x128x14x14xf32, -1x384x14x14xf32]) <- (-1x512x14x14xf32, 2xi64, 1xi32)
        split_49 = paddle._C_ops.split(add_12, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_26 = [slice_12, full_18, full_18, full_18]
        ...
        # pd_op.split: ([-1x128x14x14xf32, -1x384x14x14xf32]) <- (-1x512x14x14xf32, 2xi64, 1xi32)
        split_50 = paddle._C_ops.split(add_13, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_28 = [slice_13, full_18, full_18, full_18]
        ...
        # pd_op.split: ([-1x128x14x14xf32, -1x384x14x14xf32]) <- (-1x512x14x14xf32, 2xi64, 1xi32)
        split_51 = paddle._C_ops.split(add_14, full_int_array_5, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_30 = [slice_14, full_18, full_18, full_18]
        ...
        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_6 = [256, 768]

        # pd_op.split: ([-1x256x7x7xf32, -1x768x7x7xf32]) <- (-1x1024x7x7xf32, 2xi64, 1xi32)
        split_52 = paddle._C_ops.split(batch_norm__98, full_int_array_6, full_0)
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_32 = [slice_15, full_18, full_18, full_18]
        ...
        # pd_op.split: ([-1x256x7x7xf32, -1x768x7x7xf32]) <- (-1x1024x7x7xf32, 2xi64, 1xi32)
        split_53 = paddle._C_ops.split(add_16, full_int_array_6, full_0)
        ...
        slice_16 = paddle._C_ops.slice(
            shape64_16, [0], full_int_array_3, full_int_array_4, [1], [0]
        )

        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_34 = [slice_16, full_18, full_18, full_18]
