...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        depthwise_conv2d_0 = paddle._C_ops.depthwise_conv2d(
            hardswish_0, parameter_140, [1, 1], [1, 1], "EXPLICIT", 24, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (128x48x112x112xf32) <- (128x24x112x112xf32, 48x24x1x1xf32)
        ...
        # pd_op.hardswish: (128x48x112x112xf32) <- (128x48x112x112xf32)
        ...
        depthwise_conv2d_1 = paddle._C_ops.depthwise_conv2d(
            hardswish_2, parameter_130, [2, 2], [1, 1], "EXPLICIT", 48, [1, 1], "NCHW"
        )
        ...
        # pd_op.hardswish: (128x48x56x56xf32) <- (128x48x56x56xf32)
        hardswish_3 = paddle._C_ops.hardswish(batch_norm__18)

        # pd_op.conv2d: (128x96x56x56xf32) <- (128x48x56x56xf32, 96x48x1x1xf32)
        ...
        # pd_op.hardswish: (128x96x56x56xf32) <- (128x96x56x56xf32)
        hardswish_4 = paddle._C_ops.hardswish(batch_norm__24)

        # pd_op.depthwise_conv2d: (128x96x56x56xf32) <- (128x96x56x56xf32, 96x1x3x3xf32)
        depthwise_conv2d_2 = paddle._C_ops.depthwise_conv2d(
            hardswish_4, parameter_120, [1, 1], [1, 1], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (128x96x56x56xf32) <- (128x96x56x56xf32, 96x96x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (128x96x28x28xf32) <- (128x96x56x56xf32, 96x1x3x3xf32)
        depthwise_conv2d_3 = paddle._C_ops.depthwise_conv2d(
            hardswish_6, parameter_110, [2, 2], [1, 1], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        ...
        # pd_op.hardswish: (128x96x28x28xf32) <- (128x96x28x28xf32)
        hardswish_7 = paddle._C_ops.hardswish(batch_norm__42)

        # pd_op.conv2d: (128x192x28x28xf32) <- (128x96x28x28xf32, 192x96x1x1xf32)
        ...
        # pd_op.hardswish: (128x192x28x28xf32) <- (128x192x28x28xf32)
        hardswish_8 = paddle._C_ops.hardswish(batch_norm__48)

        # pd_op.depthwise_conv2d: (128x192x28x28xf32) <- (128x192x28x28xf32, 192x1x3x3xf32)
        depthwise_conv2d_4 = paddle._C_ops.depthwise_conv2d(
            hardswish_8, parameter_100, [1, 1], [1, 1], "EXPLICIT", 192, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (128x192x28x28xf32) <- (128x192x28x28xf32, 192x192x1x1xf32)
        ...
        # pd_op.depthwise_conv2d: (128x192x14x14xf32) <- (128x192x28x28xf32, 192x1x3x3xf32)
        depthwise_conv2d_5 = paddle._C_ops.depthwise_conv2d(
            hardswish_10, parameter_90, [2, 2], [1, 1], "EXPLICIT", 192, [1, 1], "NCHW"
        )
        ...
        # pd_op.hardswish: (128x192x14x14xf32) <- (128x192x14x14xf32)
        hardswish_11 = paddle._C_ops.hardswish(batch_norm__66)

        # pd_op.conv2d: (128x384x14x14xf32) <- (128x192x14x14xf32, 384x192x1x1xf32)
        ...
        # pd_op.hardswish: (128x384x14x14xf32) <- (128x384x14x14xf32)
        hardswish_12 = paddle._C_ops.hardswish(batch_norm__72)

        # pd_op.depthwise_conv2d: (128x384x14x14xf32) <- (128x384x14x14xf32, 384x1x5x5xf32)
        depthwise_conv2d_6 = paddle._C_ops.depthwise_conv2d(
            hardswish_12, parameter_80, [1, 1], [2, 2], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (128x384x14x14xf32) <- (128x384x14x14xf32, 384x384x1x1xf32)
        ...
        depthwise_conv2d_7 = paddle._C_ops.depthwise_conv2d(
            hardswish_14, parameter_70, [1, 1], [2, 2], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_8 = paddle._C_ops.depthwise_conv2d(
            hardswish_16, parameter_60, [1, 1], [2, 2], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_9 = paddle._C_ops.depthwise_conv2d(
            hardswish_18, parameter_50, [1, 1], [2, 2], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_10 = paddle._C_ops.depthwise_conv2d(
            hardswish_20, parameter_40, [1, 1], [2, 2], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        ...
        # pd_op.depthwise_conv2d: (128x384x7x7xf32) <- (128x384x14x14xf32, 384x1x5x5xf32)
        depthwise_conv2d_11 = paddle._C_ops.depthwise_conv2d(
            hardswish_22, parameter_30, [2, 2], [2, 2], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        ...
        # pd_op.hardswish: (128x384x7x7xf32) <- (128x384x7x7xf32)
        ...
        # pd_op.pool2d: (128x384x1x1xf32) <- (128x384x7x7xf32, 2xi64)
        ...
        # pd_op.conv2d: (128x96x1x1xf32) <- (128x384x1x1xf32, 96x384x1x1xf32)
        ...
        # pd_op.add: (128x96x1x1xf32) <- (128x96x1x1xf32, 1x96x1x1xf32)
        add_1 = paddle._C_ops.add(conv2d_12, reshape_0)

        # pd_op.relu: (128x96x1x1xf32) <- (128x96x1x1xf32)
        relu_0 = paddle._C_ops.relu(add_1)

        # pd_op.conv2d: (128x384x1x1xf32) <- (128x96x1x1xf32, 384x96x1x1xf32)
        ...
        # pd_op.add: (128x384x1x1xf32) <- (128x384x1x1xf32, 1x384x1x1xf32)
        add_2 = paddle._C_ops.add(conv2d_13, reshape_1)

        # pd_op.hardsigmoid: (128x384x1x1xf32) <- (128x384x1x1xf32)
        hardsigmoid_0 = paddle._C_ops.hardsigmoid(
            add_2, float("0.166667"), float("0.5")
        )

        # pd_op.multiply: (128x384x7x7xf32) <- (128x384x7x7xf32, 128x384x1x1xf32)
        multiply_0 = paddle._C_ops.multiply(hardswish_23, hardsigmoid_0)

        # pd_op.conv2d: (128x768x7x7xf32) <- (128x384x7x7xf32, 768x384x1x1xf32)
        ...
        # pd_op.hardswish: (128x768x7x7xf32) <- (128x768x7x7xf32)
        hardswish_24 = paddle._C_ops.hardswish(batch_norm__144)

        # pd_op.depthwise_conv2d: (128x768x7x7xf32) <- (128x768x7x7xf32, 768x1x5x5xf32)
        depthwise_conv2d_12 = paddle._C_ops.depthwise_conv2d(
            hardswish_24, parameter_16, [1, 1], [2, 2], "EXPLICIT", 768, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (128x192x1x1xf32) <- (128x768x1x1xf32, 192x768x1x1xf32)
        ...
        # pd_op.add: (128x192x1x1xf32) <- (128x192x1x1xf32, 1x192x1x1xf32)
        add_3 = paddle._C_ops.add(conv2d_15, reshape_2)

        # pd_op.relu: (128x192x1x1xf32) <- (128x192x1x1xf32)
        relu_1 = paddle._C_ops.relu(add_3)

        # pd_op.conv2d: (128x768x1x1xf32) <- (128x192x1x1xf32, 768x192x1x1xf32)
        ...
        # pd_op.add: (128x768x1x1xf32) <- (128x768x1x1xf32, 1x768x1x1xf32)
        add_4 = paddle._C_ops.add(conv2d_16, reshape_3)

        # pd_op.hardsigmoid: (128x768x1x1xf32) <- (128x768x1x1xf32)
        hardsigmoid_1 = paddle._C_ops.hardsigmoid(
            add_4, float("0.166667"), float("0.5")
        )

        # pd_op.multiply: (128x768x7x7xf32) <- (128x768x7x7xf32, 128x768x1x1xf32)
        multiply_1 = paddle._C_ops.multiply(hardswish_25, hardsigmoid_1)

        # pd_op.conv2d: (128x768x7x7xf32) <- (128x768x7x7xf32, 768x768x1x1xf32)
