...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        conv2d_0 = paddle._C_ops.conv2d(
            data_0, parameter_186, [2, 2], [3, 3], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_2 = paddle._C_ops.conv2d(
            relu_1, parameter_176, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        add_1 = paddle._C_ops.add(batch_norm__12, batch_norm__18)
        ...
        conv2d_4 = paddle._C_ops.conv2d(
            relu_2, parameter_166, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_5 = paddle._C_ops.conv2d(
            relu_3, parameter_161, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.add: (-1x64x56x56xf32) <- (-1x64x56x56xf32, -1x64x56x56xf32)
        add_2 = paddle._C_ops.add(batch_norm__30, relu_2)
        ...
        conv2d_6 = paddle._C_ops.conv2d(
            relu_4, parameter_156, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_7 = paddle._C_ops.conv2d(
            relu_5, parameter_151, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.add: (-1x64x56x56xf32) <- (-1x64x56x56xf32, -1x64x56x56xf32)
        add_3 = paddle._C_ops.add(batch_norm__42, relu_4)

        # pd_op.relu: (-1x64x56x56xf32) <- (-1x64x56x56xf32)
        relu_6 = paddle._C_ops.relu(add_3)

        # pd_op.conv2d: (-1x128x28x28xf32) <- (-1x64x56x56xf32, 128x64x3x3xf32)
        conv2d_8 = paddle._C_ops.conv2d(
            relu_6, parameter_146, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_9 = paddle._C_ops.conv2d(
            relu_7, parameter_141, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_10 = paddle._C_ops.conv2d(
            relu_6, parameter_136, [2, 2], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        add_4 = paddle._C_ops.add(batch_norm__54, batch_norm__60)
        ...
        conv2d_11 = paddle._C_ops.conv2d(
            relu_8, parameter_131, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_12 = paddle._C_ops.conv2d(
            relu_9, parameter_126, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.relu: (-1x128x28x28xf32) <- (-1x128x28x28xf32)
        relu_10 = paddle._C_ops.relu(add_5)

        # pd_op.conv2d: (-1x128x28x28xf32) <- (-1x128x28x28xf32, 128x128x3x3xf32)
        conv2d_13 = paddle._C_ops.conv2d(
            relu_10, parameter_121, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_14 = paddle._C_ops.conv2d(
            relu_11, parameter_116, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.add: (-1x128x28x28xf32) <- (-1x128x28x28xf32, -1x128x28x28xf32)
        add_6 = paddle._C_ops.add(batch_norm__84, relu_10)
        ...
        conv2d_15 = paddle._C_ops.conv2d(
            relu_12, parameter_111, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_16 = paddle._C_ops.conv2d(
            relu_13, parameter_106, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.add: (-1x128x28x28xf32) <- (-1x128x28x28xf32, -1x128x28x28xf32)
        add_7 = paddle._C_ops.add(batch_norm__96, relu_12)

        # pd_op.relu: (-1x128x28x28xf32) <- (-1x128x28x28xf32)
        relu_14 = paddle._C_ops.relu(add_7)

        # pd_op.conv2d: (-1x256x14x14xf32) <- (-1x128x28x28xf32, 256x128x3x3xf32)
        conv2d_17 = paddle._C_ops.conv2d(
            relu_14, parameter_101, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_18 = paddle._C_ops.conv2d(
            relu_15, parameter_96, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_19 = paddle._C_ops.conv2d(
            relu_14, parameter_91, [2, 2], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        add_8 = paddle._C_ops.add(batch_norm__108, batch_norm__114)

        # pd_op.relu: (-1x256x14x14xf32) <- (-1x256x14x14xf32)
        relu_16 = paddle._C_ops.relu(add_8)

        # pd_op.conv2d: (-1x256x14x14xf32) <- (-1x256x14x14xf32, 256x256x3x3xf32)
        conv2d_20 = paddle._C_ops.conv2d(
            relu_16, parameter_86, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_21 = paddle._C_ops.conv2d(
            relu_17, parameter_81, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.add: (-1x256x14x14xf32) <- (-1x256x14x14xf32, -1x256x14x14xf32)
        add_9 = paddle._C_ops.add(batch_norm__126, relu_16)

        # pd_op.relu: (-1x256x14x14xf32) <- (-1x256x14x14xf32)
        relu_18 = paddle._C_ops.relu(add_9)

        # pd_op.conv2d: (-1x256x14x14xf32) <- (-1x256x14x14xf32, 256x256x3x3xf32)
        conv2d_22 = paddle._C_ops.conv2d(
            relu_18, parameter_76, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_23 = paddle._C_ops.conv2d(
            relu_19, parameter_71, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.add: (-1x256x14x14xf32) <- (-1x256x14x14xf32, -1x256x14x14xf32)
        add_10 = paddle._C_ops.add(batch_norm__138, relu_18)
        ...
        conv2d_24 = paddle._C_ops.conv2d(
            relu_20, parameter_66, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_25 = paddle._C_ops.conv2d(
            relu_21, parameter_61, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.add: (-1x256x14x14xf32) <- (-1x256x14x14xf32, -1x256x14x14xf32)
        add_11 = paddle._C_ops.add(batch_norm__150, relu_20)

        # pd_op.relu: (-1x256x14x14xf32) <- (-1x256x14x14xf32)
        relu_22 = paddle._C_ops.relu(add_11)

        # pd_op.conv2d: (-1x256x14x14xf32) <- (-1x256x14x14xf32, 256x256x3x3xf32)
        conv2d_26 = paddle._C_ops.conv2d(
            relu_22, parameter_56, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_27 = paddle._C_ops.conv2d(
            relu_23, parameter_51, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.add: (-1x256x14x14xf32) <- (-1x256x14x14xf32, -1x256x14x14xf32)
        add_12 = paddle._C_ops.add(batch_norm__162, relu_22)

        # pd_op.relu: (-1x256x14x14xf32) <- (-1x256x14x14xf32)
        relu_24 = paddle._C_ops.relu(add_12)

        # pd_op.conv2d: (-1x256x14x14xf32) <- (-1x256x14x14xf32, 256x256x3x3xf32)
        conv2d_28 = paddle._C_ops.conv2d(
            relu_24, parameter_46, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_29 = paddle._C_ops.conv2d(
            relu_25, parameter_41, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.add: (-1x256x14x14xf32) <- (-1x256x14x14xf32, -1x256x14x14xf32)
        add_13 = paddle._C_ops.add(batch_norm__174, relu_24)

        # pd_op.relu: (-1x256x14x14xf32) <- (-1x256x14x14xf32)
        relu_26 = paddle._C_ops.relu(add_13)

        # pd_op.conv2d: (-1x512x7x7xf32) <- (-1x256x14x14xf32, 512x256x3x3xf32)
        conv2d_30 = paddle._C_ops.conv2d(
            relu_26, parameter_36, [2, 2], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_31 = paddle._C_ops.conv2d(
            relu_27, parameter_31, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_32 = paddle._C_ops.conv2d(
            relu_26, parameter_26, [2, 2], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        add_14 = paddle._C_ops.add(batch_norm__186, batch_norm__192)

        # pd_op.relu: (-1x512x7x7xf32) <- (-1x512x7x7xf32)
        relu_28 = paddle._C_ops.relu(add_14)

        # pd_op.conv2d: (-1x512x7x7xf32) <- (-1x512x7x7xf32, 512x512x3x3xf32)
        conv2d_33 = paddle._C_ops.conv2d(
            relu_28, parameter_21, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_34 = paddle._C_ops.conv2d(
            relu_29, parameter_16, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.add: (-1x512x7x7xf32) <- (-1x512x7x7xf32, -1x512x7x7xf32)
        add_15 = paddle._C_ops.add(batch_norm__204, relu_28)

        # pd_op.relu: (-1x512x7x7xf32) <- (-1x512x7x7xf32)
        relu_30 = paddle._C_ops.relu(add_15)

        # pd_op.conv2d: (-1x512x7x7xf32) <- (-1x512x7x7xf32, 512x512x3x3xf32)
        conv2d_35 = paddle._C_ops.conv2d(
            relu_30, parameter_11, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        conv2d_36 = paddle._C_ops.conv2d(
            relu_31, parameter_6, [1, 1], [1, 1], "EXPLICIT", [1, 1], 1, "NCHW"
        )
        ...
        # pd_op.add: (-1x512x7x7xf32) <- (-1x512x7x7xf32, -1x512x7x7xf32)
        add_16 = paddle._C_ops.add(batch_norm__216, relu_30)

        # pd_op.relu: (-1x512x7x7xf32) <- (-1x512x7x7xf32)
        relu_32 = paddle._C_ops.relu(add_16)
