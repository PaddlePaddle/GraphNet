...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        # pd_op.shape64: (3xi64) <- (2x-1x8400xf32)
        ...
        # pd_op.topk: (2x-1x13xf32, 2x-1x13xi64) <- (2x-1x8400xf32, 1xi32)
        ...
        # pd_op.one_hot: (2x-1x13x8400xf32) <- (2x-1x13xi64, 1xi32)
        ...
        # pd_op.sum: (2x-1x8400xf32) <- (2x-1x13x8400xf32, 1xi64)
        sum_0 = paddle._C_ops.sum(one_hot_0, full_int_array_2, None, False)

        # pd_op.multiply: (2x-1x8400xf32) <- (2x-1x8400xf32, 2x-1x1xf32)
