...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        full_1 = paddle._C_ops.full(
            [1], float("25"), paddle.float64, paddle.core.CPUPlace()
        )
        ...
        # pd_op.matmul: (625x128xf32) <- (625x1xf32, 1x128xf32)
        ...
        # pd_op.sin: (625x128xf32) <- (625x128xf32)
        sin_0 = paddle._C_ops.sin(matmul_0)

        # pd_op.cos: (625x128xf32) <- (625x128xf32)
        ...
        # builtin.combine: ([625x128xf32, 625x128xf32, 625x128xf32, 625x128xf32]) <- (625x128xf32, 625x128xf32, 625x128xf32, 625x128xf32)
        combine_1 = [sin_0, cos_0, sin_1, cos_1]

        # pd_op.concat: (625x512xf32) <- ([625x128xf32, 625x128xf32, 625x128xf32, 625x128xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_1, full_7)

        # pd_op.unsqueeze: (1x625x512xf32) <- (625x512xf32, 1xi64)
