...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        ...
        # pd_op.argmax: (2x5376xi64) <- (2x11x5376xf32, 1xi64)
        ...
        # pd_op.gather: (10752xi32) <- (22xi32, 10752xi64, 1xi32)
        ...
        # pd_op.gather: (10752x4xf32) <- (22x4xf32, 10752xi64, 1xi32)
        ...
        # pd_op.one_hot: (2x5376x5xf32) <- (2x5376xi32, 1xi32)
        ...
        # pd_op.index_select: (2x5376x4xf32) <- (2x5376x5xf32, 4xi64)
        index_select_0 = paddle._C_ops.index_select(one_hot_0, assign_value__0, -1)
        del assign_value__0, one_hot_0

        # pd_op.multiply: (2x11x5376xf32) <- (2x11x5376xf32, 2x11x5376xf32)
        ...
        # pd_op.max: (2x11x1xf32) <- (2x11x5376xf32, 1xi64)
        ...
        # pd_op.divide: (2x11x5376xf32) <- (2x11x5376xf32, 2x11x1xf32)
        divide_0 = paddle._C_ops.divide(multiply_1, scale_1)
        del multiply_1, scale_1

        # pd_op.multiply: (2x11x5376xf32) <- (2x11x5376xf32, 2x11x1xf32)
        ...
        # pd_op.max: (2x5376xf32) <- (2x11x5376xf32, 1xi64)
        ...
        # pd_op.multiply: (2x5376x4xf32) <- (2x5376x4xf32, 2x5376x1xf32)
