...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4):
        ...
        # pd_op.argmax: (4x4789xi64) <- (4x1x4789xf32, 1xi64)
        ...
        # pd_op.gather: (19156xi32) <- (4xi32, 19156xi64, 1xi32)
        gather_0 = paddle._C_ops.gather(flatten_0, flatten_1, full_5)
        del flatten_0

        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_1 = [4, 4789]
        ...
        # pd_op.maximum: (4x1x4789x2xf32) <- (4x1x1x2xf32, 4x1x4789x2xf32)
        maximum_0 = paddle._C_ops.maximum(slice_0, slice_2)

        # pd_op.minimum: (4x1x4789x2xf32) <- (4x1x1x2xf32, 4x1x4789x2xf32)
        ...
        # pd_op.add: (4x1x4789xf32) <- (4x1x1xf32, 4x1x4789xf32)
        add_1 = paddle._C_ops.add(prod_1, prod_2)
        del prod_1, prod_2

        # pd_op.subtract: (4x1x4789xf32) <- (4x1x4789xf32, 4x1x4789xf32)
        subtract_3 = paddle._C_ops.subtract(add_1, prod_0)
        del add_1

        # pd_op.scale: (4x1x4789xf32) <- (4x1x4789xf32, 1xf32)
        scale_1 = paddle._C_ops.scale(subtract_3, full_4, float("1e-09"), True)
        del full_4, subtract_3

        # pd_op.divide: (4x1x4789xf32) <- (4x1x4789xf32, 4x1x4789xf32)
        ...
        # pd_op.max: (4x4789xf32) <- (4x1x4789xf32, 1xi64)
