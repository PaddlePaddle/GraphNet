...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.hardswish: (128x32x112x112xf32) <- (128x32x112x112xf32)
        ...
        depthwise_conv2d_0 = paddle._C_ops.depthwise_conv2d(
            hardswish_0, parameter_140, [1, 1], [1, 1], "EXPLICIT", 32, [1, 1], "NCHW"
        )
        ...
        # pd_op.hardswish: (128x64x112x112xf32) <- (128x64x112x112xf32)
        ...
        depthwise_conv2d_1 = paddle._C_ops.depthwise_conv2d(
            hardswish_2, parameter_130, [2, 2], [1, 1], "EXPLICIT", 64, [1, 1], "NCHW"
        )
        ...
        # pd_op.hardswish: (128x64x56x56xf32) <- (128x64x56x56xf32)
        ...
        # pd_op.hardswish: (128x128x56x56xf32) <- (128x128x56x56xf32)
        ...
        depthwise_conv2d_2 = paddle._C_ops.depthwise_conv2d(
            hardswish_4, parameter_120, [1, 1], [1, 1], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_3 = paddle._C_ops.depthwise_conv2d(
            hardswish_6, parameter_110, [2, 2], [1, 1], "EXPLICIT", 128, [1, 1], "NCHW"
        )
        ...
        # pd_op.hardswish: (128x128x28x28xf32) <- (128x128x28x28xf32)
        ...
        # pd_op.hardswish: (128x256x28x28xf32) <- (128x256x28x28xf32)
        ...
        depthwise_conv2d_4 = paddle._C_ops.depthwise_conv2d(
            hardswish_8, parameter_100, [1, 1], [1, 1], "EXPLICIT", 256, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_5 = paddle._C_ops.depthwise_conv2d(
            hardswish_10, parameter_90, [2, 2], [1, 1], "EXPLICIT", 256, [1, 1], "NCHW"
        )
        ...
        # pd_op.hardswish: (128x256x14x14xf32) <- (128x256x14x14xf32)
        ...
        # pd_op.hardswish: (128x512x14x14xf32) <- (128x512x14x14xf32)
        ...
        depthwise_conv2d_6 = paddle._C_ops.depthwise_conv2d(
            hardswish_12, parameter_80, [1, 1], [2, 2], "EXPLICIT", 512, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (128x512x14x14xf32) <- (128x512x14x14xf32, 512x512x1x1xf32)
        ...
        depthwise_conv2d_7 = paddle._C_ops.depthwise_conv2d(
            hardswish_14, parameter_70, [1, 1], [2, 2], "EXPLICIT", 512, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_8 = paddle._C_ops.depthwise_conv2d(
            hardswish_16, parameter_60, [1, 1], [2, 2], "EXPLICIT", 512, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_9 = paddle._C_ops.depthwise_conv2d(
            hardswish_18, parameter_50, [1, 1], [2, 2], "EXPLICIT", 512, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_10 = paddle._C_ops.depthwise_conv2d(
            hardswish_20, parameter_40, [1, 1], [2, 2], "EXPLICIT", 512, [1, 1], "NCHW"
        )
        ...
        # pd_op.depthwise_conv2d: (128x512x7x7xf32) <- (128x512x14x14xf32, 512x1x5x5xf32)
        depthwise_conv2d_11 = paddle._C_ops.depthwise_conv2d(
            hardswish_22, parameter_30, [2, 2], [2, 2], "EXPLICIT", 512, [1, 1], "NCHW"
        )
        ...
        # pd_op.hardswish: (128x512x7x7xf32) <- (128x512x7x7xf32)
        ...
        # pd_op.hardsigmoid: (128x512x1x1xf32) <- (128x512x1x1xf32)
        hardsigmoid_0 = paddle._C_ops.hardsigmoid(
            add_2, float("0.166667"), float("0.5")
        )

        # pd_op.multiply: (128x512x7x7xf32) <- (128x512x7x7xf32, 128x512x1x1xf32)
        ...
        # pd_op.hardswish: (128x1024x7x7xf32) <- (128x1024x7x7xf32)
        hardswish_24 = paddle._C_ops.hardswish(batch_norm__144)

        # pd_op.depthwise_conv2d: (128x1024x7x7xf32) <- (128x1024x7x7xf32, 1024x1x5x5xf32)
        depthwise_conv2d_12 = paddle._C_ops.depthwise_conv2d(
            hardswish_24, parameter_16, [1, 1], [2, 2], "EXPLICIT", 1024, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (128x256x1x1xf32) <- (128x1024x1x1xf32, 256x1024x1x1xf32)
        ...
        # pd_op.relu: (128x256x1x1xf32) <- (128x256x1x1xf32)
        relu_1 = paddle._C_ops.relu(add_3)

        # pd_op.conv2d: (128x1024x1x1xf32) <- (128x256x1x1xf32, 1024x256x1x1xf32)
        ...
        # pd_op.add: (128x1024x1x1xf32) <- (128x1024x1x1xf32, 1x1024x1x1xf32)
        add_4 = paddle._C_ops.add(conv2d_16, reshape_3)

        # pd_op.hardsigmoid: (128x1024x1x1xf32) <- (128x1024x1x1xf32)
        hardsigmoid_1 = paddle._C_ops.hardsigmoid(
            add_4, float("0.166667"), float("0.5")
        )

        # pd_op.multiply: (128x1024x7x7xf32) <- (128x1024x7x7xf32, 128x1024x1x1xf32)
        multiply_1 = paddle._C_ops.multiply(hardswish_25, hardsigmoid_1)

        # pd_op.conv2d: (128x1024x7x7xf32) <- (128x1024x7x7xf32, 1024x1024x1x1xf32)
