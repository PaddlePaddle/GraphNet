...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.full_like: (1x12096x256xf32) <- (1x12096x256xf32, 1xf32)
        ...
        # pd_op.add: (1x12096x256xf32) <- (1x12096x256xf32, xf32)
        add_12 = paddle._C_ops.add(full_like_6, full_like_7)

        # pd_op.add: (1x12096x256xf32) <- (1x12096x256xf32, 1x12096x1xf32)
        add_0 = paddle._C_ops.add(add_12, cast_7)

        # pd_op.add: (1x12096x256xf32) <- (1x12096x256xf32, 1x12096x256xf32)
        add_1 = paddle._C_ops.add(data_0, add_0)

        # pd_op.add: (1x12096x256xf32) <- (xf32, 1x12096x256xf32)
        add_2 = paddle._C_ops.add(assign_value__0, add_0)

        # pd_op.add: (1x12096x256xf32) <- (1x12096x1xf32, 1x12096x256xf32)
        add_13 = paddle._C_ops.add(cast_8, add_0)

        # pd_op.cast: (1x12096x256xb) <- (1x12096x256xf32)
        cast_0 = paddle._C_ops.cast(add_13, paddle.bool)

        # pd_op.where: (1x12096x256xf32) <- (1x12096x256xb, 1x12096x256xf32, 1x12096x256xf32)
        where_1 = paddle._C_ops.where(cast_0, add_1, add_2)

        # pd_op.matmul: (1x12096x256xf32) <- (1x12096x256xf32, 256x256xf32)
        matmul_0 = paddle._C_ops.matmul(where_1, parameter_11, False, False)

        # pd_op.add: (1x12096x256xf32) <- (1x12096x256xf32, 256xf32)
        add_3 = paddle._C_ops.add(matmul_0, parameter_10)

        # pd_op.layer_norm: (1x12096x256xf32, 1x12096xf32, 1x12096xf32) <- (1x12096x256xf32, 256xf32, 256xf32)
        ...
        # pd_op.matmul: (1x12096x4xf32) <- (1x12096x256xf32, 256x4xf32)
        matmul_1 = paddle._C_ops.matmul(layer_norm_0, parameter_7, False, False)

        # pd_op.add: (1x12096x4xf32) <- (1x12096x4xf32, 4xf32)
        ...
        # pd_op.relu: (1x12096x256xf32) <- (1x12096x256xf32)
        ...
        # pd_op.max: (1x12096xf32) <- (1x12096x4xf32, 1xi64)
        ...
        # pd_op.topk: (1x300xf32, 1x300xi64) <- (1x12096xf32, 1xi32)
        ...
        # pd_op.gather_nd: (1x300x4xf32) <- (1x12096x4xf32, 1x300x2xi64)
        ...
        # builtin.combine: ([1x200x4xf32, 1x300x4xf32]) <- (1x200x4xf32, 1x300x4xf32)
        combine_11 = [data_2, gather_nd_1]

        # pd_op.concat: (1x500x4xf32) <- ([1x200x4xf32, 1x300x4xf32], 1xi32)
        ...
        # pd_op.gather_nd: (1x300x256xf32) <- (1x12096x256xf32, 1x300x2xi64)
        ...
        # builtin.combine: ([1x200x256xf32, 1x300x256xf32]) <- (1x200x256xf32, 1x300x256xf32)
        combine_12 = [data_1, share_data__0]

        # pd_op.concat: (1x500x256xf32) <- ([1x200x256xf32, 1x300x256xf32], 1xi32)
