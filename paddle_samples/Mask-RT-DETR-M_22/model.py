...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0):
        ...
        squeeze_0 = paddle._C_ops.squeeze(grid_sample_0, full_int_array_4)
        ...
        unsqueeze_1 = paddle._C_ops.unsqueeze(arange_0, full_int_array_5)

        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_6 = [1, 9408]

        # pd_op.tile: (-1x9408xi64) <- (-1x1xi64, 2xi64)
        tile_0 = paddle._C_ops.tile(unsqueeze_1, full_int_array_6)
