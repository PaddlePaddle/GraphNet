...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        t274 = paddle._C_ops.depthwise_conv2d(
            t273, t29, [2, 2], [1, 1], "EXPLICIT", 24, [1, 1], "NCHW"
        )
        del t29
        ...
        t297 = paddle._C_ops.depthwise_conv2d(
            t296, t44, [1, 1], [1, 1], "EXPLICIT", 32, [1, 1], "NCHW"
        )
        del t44
        ...
        t321 = paddle._C_ops.depthwise_conv2d(
            t320, t59, [2, 2], [2, 2], "EXPLICIT", 32, [1, 1], "NCHW"
        )
        del t59
        ...
        t354 = paddle._C_ops.depthwise_conv2d(
            t353, t78, [1, 1], [2, 2], "EXPLICIT", 88, [1, 1], "NCHW"
        )
        del t78
        ...
        t388 = paddle._C_ops.depthwise_conv2d(
            t387, t97, [1, 1], [2, 2], "EXPLICIT", 88, [1, 1], "NCHW"
        )
        del t97
        ...
        t422 = paddle._C_ops.depthwise_conv2d(
            t421, t116, [1, 1], [2, 2], "EXPLICIT", 40, [1, 1], "NCHW"
        )
        del t116
        ...
        t456 = paddle._C_ops.depthwise_conv2d(
            t455, t135, [1, 1], [2, 2], "EXPLICIT", 48, [1, 1], "NCHW"
        )
        del t135
        ...
        t490 = paddle._C_ops.depthwise_conv2d(
            t489, t154, [2, 2], [2, 2], "EXPLICIT", 104, [1, 1], "NCHW"
        )
        del t154
        ...
        t523 = paddle._C_ops.depthwise_conv2d(
            t522, t173, [1, 1], [2, 2], "EXPLICIT", 200, [1, 1], "NCHW"
        )
        del t173
        ...
        t557 = paddle._C_ops.depthwise_conv2d(
            t556, t192, [1, 1], [2, 2], "EXPLICIT", 200, [1, 1], "NCHW"
        )
        del t192
