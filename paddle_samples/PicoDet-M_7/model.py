...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6, data_7):
        ...
        # pd_op.topk: (4x-1x9xf32, 4x-1x9xi64) <- (4x-1x-1xf32, 1xi32)
        ...
        # pd_op.scale: (4x-1x9xi64) <- (4x-1x9xi64, 1xf32)
        scale_0 = paddle._C_ops.scale(topk_1, full_1, float("0"), True)

        # pd_op.one_hot: (4x-1x9x-1xf32) <- (4x-1x9xi64, xi64)
        ...
        # pd_op.sum: (4x-1x-1xf32) <- (4x-1x9x-1xf32, 1xi64)
        ...
        # pd_op.add: (4x-1x9xi64) <- (4x-1x9xi64, xi64)
        ...
        # builtin.combine: ([4x-1x-1xf32, 4x-1x-1xf32, 4x-1x-1xf32, 4x-1x-1xf32]) <- (4x-1x-1xf32, 4x-1x-1xf32, 4x-1x-1xf32, 4x-1x-1xf32)
        combine_0 = [multiply_0, multiply_1, multiply_2, multiply_3]

        # pd_op.concat: (4x-1x-1xf32) <- ([4x-1x-1xf32, 4x-1x-1xf32, 4x-1x-1xf32, 4x-1x-1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_2)

        # builtin.combine: ([4x-1x9xi64, 4x-1x9xi64, 4x-1x9xi64, 4x-1x9xi64]) <- (4x-1x9xi64, 4x-1x9xi64, 4x-1x9xi64, 4x-1x9xi64)
        combine_1 = [scale_0, add_0, add_1, add_2]

        # pd_op.concat: (4x-1x36xi64) <- ([4x-1x9xi64, 4x-1x9xi64, 4x-1x9xi64, 4x-1x9xi64], 1xi32)
