...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.slice: (1x3x16x-1xf32) <- (4x3x16x-1xf32, 1xi64, 1xi64)
        slice_9 = paddle._C_ops.slice(
            data_4, [0], full_int_array_0, full_int_array_1, [1], []
        )
        del data_4

        # pd_op.slice: (1x12x16x-1xf32) <- (4x12x16x-1xf32, 1xi64, 1xi64)
        ...
        # pd_op.generate_proposals: (-1x4xf32, -1x1xf32, 1xf32) <- (1x3x16x-1xf32, 1x12x16x-1xf32, 1x2xf32, -1x4xf32, -1x4xf32)
