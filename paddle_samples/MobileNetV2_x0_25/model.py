...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.relu6: (-1x8x112x112xf32) <- (-1x8x112x112xf32)
        ...
        depthwise_conv2d_0 = paddle._C_ops.depthwise_conv2d(
            relu6_1, parameter_256, [1, 1], [1, 1], "EXPLICIT", 8, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x4x112x112xf32) <- (-1x8x112x112xf32, 4x8x1x1xf32)
        conv2d_2 = paddle._C_ops.conv2d(
            relu6_2, parameter_251, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (-1x4x112x112xf32, 4xf32, 4xf32, 4xf32, 4xf32, -1xui8) <- (-1x4x112x112xf32, 4xf32, 4xf32, 4xf32, 4xf32)
        (
            batch_norm__18,
            batch_norm__19,
            batch_norm__20,
        ...
        # pd_op.conv2d: (-1x24x112x112xf32) <- (-1x4x112x112xf32, 24x4x1x1xf32)
        ...
        # pd_op.relu6: (-1x24x112x112xf32) <- (-1x24x112x112xf32)
        ...
        depthwise_conv2d_1 = paddle._C_ops.depthwise_conv2d(
            relu6_3, parameter_241, [2, 2], [1, 1], "EXPLICIT", 24, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x6x56x56xf32) <- (-1x24x56x56xf32, 6x24x1x1xf32)
        conv2d_4 = paddle._C_ops.conv2d(
            relu6_4, parameter_236, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (-1x6x56x56xf32, 6xf32, 6xf32, 6xf32, 6xf32, -1xui8) <- (-1x6x56x56xf32, 6xf32, 6xf32, 6xf32, 6xf32)
        (
            batch_norm__36,
            batch_norm__37,
            batch_norm__38,
        ...
        # pd_op.conv2d: (-1x36x56x56xf32) <- (-1x6x56x56xf32, 36x6x1x1xf32)
        ...
        # pd_op.relu6: (-1x36x56x56xf32) <- (-1x36x56x56xf32)
        ...
        depthwise_conv2d_2 = paddle._C_ops.depthwise_conv2d(
            relu6_5, parameter_226, [1, 1], [1, 1], "EXPLICIT", 36, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x6x56x56xf32) <- (-1x36x56x56xf32, 6x36x1x1xf32)
        ...
        # pd_op.add: (-1x6x56x56xf32) <- (-1x6x56x56xf32, -1x6x56x56xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x36x28x28xf32) <- (-1x36x56x56xf32, 36x1x3x3xf32)
        depthwise_conv2d_3 = paddle._C_ops.depthwise_conv2d(
            relu6_7, parameter_211, [2, 2], [1, 1], "EXPLICIT", 36, [1, 1], "NCHW"
        )

        # pd_op.batch_norm_: (-1x36x28x28xf32, 36xf32, 36xf32, 36xf32, 36xf32, -1xui8) <- (-1x36x28x28xf32, 36xf32, 36xf32, 36xf32, 36xf32)
        (
            batch_norm__66,
            batch_norm__67,
            batch_norm__68,
        ...
        # pd_op.relu6: (-1x36x28x28xf32) <- (-1x36x28x28xf32)
        relu6_8 = paddle._C_ops.relu6(batch_norm__66)

        # pd_op.conv2d: (-1x8x28x28xf32) <- (-1x36x28x28xf32, 8x36x1x1xf32)
        ...
        # pd_op.conv2d: (-1x48x28x28xf32) <- (-1x8x28x28xf32, 48x8x1x1xf32)
        ...
        depthwise_conv2d_4 = paddle._C_ops.depthwise_conv2d(
            relu6_9, parameter_196, [1, 1], [1, 1], "EXPLICIT", 48, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x8x28x28xf32) <- (-1x48x28x28xf32, 8x48x1x1xf32)
        ...
        depthwise_conv2d_5 = paddle._C_ops.depthwise_conv2d(
            relu6_11, parameter_181, [1, 1], [1, 1], "EXPLICIT", 48, [1, 1], "NCHW"
        )
        ...
        # pd_op.depthwise_conv2d: (-1x48x14x14xf32) <- (-1x48x28x28xf32, 48x1x3x3xf32)
        depthwise_conv2d_6 = paddle._C_ops.depthwise_conv2d(
            relu6_13, parameter_166, [2, 2], [1, 1], "EXPLICIT", 48, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x96x14x14xf32) <- (-1x16x14x14xf32, 96x16x1x1xf32)
        ...
        # pd_op.relu6: (-1x96x14x14xf32) <- (-1x96x14x14xf32)
        ...
        depthwise_conv2d_7 = paddle._C_ops.depthwise_conv2d(
            relu6_15, parameter_151, [1, 1], [1, 1], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x16x14x14xf32) <- (-1x96x14x14xf32, 16x96x1x1xf32)
        ...
        depthwise_conv2d_8 = paddle._C_ops.depthwise_conv2d(
            relu6_17, parameter_136, [1, 1], [1, 1], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_9 = paddle._C_ops.depthwise_conv2d(
            relu6_19, parameter_121, [1, 1], [1, 1], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_10 = paddle._C_ops.depthwise_conv2d(
            relu6_21, parameter_106, [1, 1], [1, 1], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x24x14x14xf32) <- (-1x96x14x14xf32, 24x96x1x1xf32)
        ...
        # pd_op.relu6: (-1x144x14x14xf32) <- (-1x144x14x14xf32)
        relu6_23 = paddle._C_ops.relu6(batch_norm__204)

        # pd_op.depthwise_conv2d: (-1x144x14x14xf32) <- (-1x144x14x14xf32, 144x1x3x3xf32)
        depthwise_conv2d_11 = paddle._C_ops.depthwise_conv2d(
            relu6_23, parameter_91, [1, 1], [1, 1], "EXPLICIT", 144, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x24x14x14xf32) <- (-1x144x14x14xf32, 24x144x1x1xf32)
        ...
        depthwise_conv2d_12 = paddle._C_ops.depthwise_conv2d(
            relu6_25, parameter_76, [1, 1], [1, 1], "EXPLICIT", 144, [1, 1], "NCHW"
        )
        ...
        # pd_op.depthwise_conv2d: (-1x144x7x7xf32) <- (-1x144x14x14xf32, 144x1x3x3xf32)
        depthwise_conv2d_13 = paddle._C_ops.depthwise_conv2d(
            relu6_27, parameter_61, [2, 2], [1, 1], "EXPLICIT", 144, [1, 1], "NCHW"
        )
        ...
        # pd_op.relu6: (-1x144x7x7xf32) <- (-1x144x7x7xf32)
        relu6_28 = paddle._C_ops.relu6(batch_norm__246)

        # pd_op.conv2d: (-1x40x7x7xf32) <- (-1x144x7x7xf32, 40x144x1x1xf32)
        conv2d_28 = paddle._C_ops.conv2d(
            relu6_28, parameter_56, [1, 1], [0, 0], "EXPLICIT", [1, 1], 1, "NCHW"
        )

        # pd_op.batch_norm_: (-1x40x7x7xf32, 40xf32, 40xf32, 40xf32, 40xf32, -1xui8) <- (-1x40x7x7xf32, 40xf32, 40xf32, 40xf32, 40xf32)
        (
            batch_norm__252,
            batch_norm__253,
            batch_norm__254,
        ...
        # pd_op.conv2d: (-1x240x7x7xf32) <- (-1x40x7x7xf32, 240x40x1x1xf32)
        ...
        # pd_op.relu6: (-1x240x7x7xf32) <- (-1x240x7x7xf32)
        relu6_29 = paddle._C_ops.relu6(batch_norm__258)

        # pd_op.depthwise_conv2d: (-1x240x7x7xf32) <- (-1x240x7x7xf32, 240x1x3x3xf32)
        depthwise_conv2d_14 = paddle._C_ops.depthwise_conv2d(
            relu6_29, parameter_46, [1, 1], [1, 1], "EXPLICIT", 240, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x40x7x7xf32) <- (-1x240x7x7xf32, 40x240x1x1xf32)
        ...
        # pd_op.add: (-1x40x7x7xf32) <- (-1x40x7x7xf32, -1x40x7x7xf32)
        ...
        depthwise_conv2d_15 = paddle._C_ops.depthwise_conv2d(
            relu6_31, parameter_31, [1, 1], [1, 1], "EXPLICIT", 240, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_16 = paddle._C_ops.depthwise_conv2d(
            relu6_33, parameter_16, [1, 1], [1, 1], "EXPLICIT", 240, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x80x7x7xf32) <- (-1x240x7x7xf32, 80x240x1x1xf32)
        ...
        # pd_op.conv2d: (-1x1280x7x7xf32) <- (-1x80x7x7xf32, 1280x80x1x1xf32)
