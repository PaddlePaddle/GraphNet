...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        # pd_op.cast: (20553x11xf32) <- (20553x11xf64)
        ...
        # pd_op.greater_than: (20553x11xb) <- (20553x11xf32, xf32)
        greater_than_0 = paddle._C_ops.greater_than(cast_0, full_0)

        # pd_op.cast: (20553x11xf32) <- (20553x11xb)
        cast_1 = paddle._C_ops.cast(greater_than_0, paddle.float32)
        del greater_than_0

        # pd_op.multiply: (20553x11xf32) <- (20553x11xf32, 20553x11xf32)
        multiply_0 = paddle._C_ops.multiply(cast_0, cast_1)
        del cast_1

        # pd_op.subtract: (20553x11xf32) <- (20553x11xf32, 20553x11xf32)
        subtract_0 = paddle._C_ops.subtract(data_0, cast_0)

        # pd_op.abs: (20553x11xf32) <- (20553x11xf32)
        abs_0 = paddle._C_ops.abs(subtract_0)
        del subtract_0

        # pd_op.pow: (20553x11xf32) <- (20553x11xf32)
        ...
        # pd_op.scale: (20553x11xf32) <- (20553x11xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(pow_0, full_1, float("0"), True)
        del full_1, pow_0

        # pd_op.less_equal: (20553x11xb) <- (20553x11xf32, xf32)
        ...
        # pd_op.add: (20553x11xf32) <- (20553x11xf32, 20553x11xf32)
        add_0 = paddle._C_ops.add(multiply_0, multiply_1)
        del multiply_0, multiply_1

        # pd_op.bce_loss: (20553x11xf32) <- (20553x11xf32, 20553x11xf32)
        ...
        # pd_op.sum: (20553xf32) <- (20553x11xf32, 1xi64)
