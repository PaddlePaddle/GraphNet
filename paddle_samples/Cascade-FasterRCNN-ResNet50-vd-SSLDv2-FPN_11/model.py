...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.scale: (217413xf32) <- (217413xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(subtract_0, full_0, float("0"), True)

        # pd_op.add: (217413xf32) <- (217413xf32, 217413xf32)
        ...
        # pd_op.divide: (217413xf32) <- (217413xf32, 217413xf32)
        ...
        # pd_op.log: (217413xf32) <- (217413xf32)
        log_0 = paddle._C_ops.log(divide_2)

        # pd_op.scale: (217413xf32) <- (217413xf32, 1xf32)
        scale_6 = paddle._C_ops.scale(log_0, full_1, float("0"), True)
        ...
        # pd_op.scale: (217413xf32) <- (217413xf32, 1xf32)
        scale_7 = paddle._C_ops.scale(log_1, full_1, float("0"), True)

        # builtin.combine: ([217413xf32, 217413xf32, 217413xf32, 217413xf32]) <- (217413xf32, 217413xf32, 217413xf32, 217413xf32)
        combine_0 = [divide_0, divide_1, scale_6, scale_7]

        # pd_op.stack: (217413x4xf32) <- ([217413xf32, 217413xf32, 217413xf32, 217413xf32])
