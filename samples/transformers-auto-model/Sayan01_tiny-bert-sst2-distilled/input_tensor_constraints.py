...
dynamic_dim_constraint_input_shapes = [
    ...
    ([312], "L_self_modules_embeddings_modules_LayerNorm_parameters_bias_"),
    ([312], "L_self_modules_embeddings_modules_LayerNorm_parameters_weight_"),
    (
        [512, 312],
    ...
    ([312], "L_self_modules_pooler_modules_dense_parameters_bias_"),
    ([312, 312], "L_self_modules_pooler_modules_dense_parameters_weight_"),
