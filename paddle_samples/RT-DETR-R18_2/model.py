...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.matmul: (441x64xf32) <- (441x1xf32, 1x64xf32)
        ...
        # pd_op.sin: (441x64xf32) <- (441x64xf32)
        sin_0 = paddle._C_ops.sin(matmul_0)

        # pd_op.cos: (441x64xf32) <- (441x64xf32)
        ...
        # builtin.combine: ([441x64xf32, 441x64xf32, 441x64xf32, 441x64xf32]) <- (441x64xf32, 441x64xf32, 441x64xf32, 441x64xf32)
        combine_1 = [sin_0, cos_0, sin_1, cos_1]

        # pd_op.concat: (441x256xf32) <- ([441x64xf32, 441x64xf32, 441x64xf32, 441x64xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_1, full_7)

        # pd_op.unsqueeze: (1x441x256xf32) <- (441x256xf32, 1xi64)
