...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (-1x32x112x112xf32) <- (-1x32x112x112xf32, 32x32x1x1xf32)
        ...
        depthwise_conv2d_0 = paddle._C_ops.depthwise_conv2d(
            relu6_1, parameter_256, [1, 1], [1, 1], "EXPLICIT", 32, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_1 = paddle._C_ops.depthwise_conv2d(
            relu6_3, parameter_241, [2, 2], [1, 1], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_2 = paddle._C_ops.depthwise_conv2d(
            relu6_5, parameter_226, [1, 1], [1, 1], "EXPLICIT", 144, [1, 1], "NCHW"
        )
        ...
        # pd_op.depthwise_conv2d: (-1x144x28x28xf32) <- (-1x144x56x56xf32, 144x1x3x3xf32)
        depthwise_conv2d_3 = paddle._C_ops.depthwise_conv2d(
            relu6_7, parameter_211, [2, 2], [1, 1], "EXPLICIT", 144, [1, 1], "NCHW"
        )

        # pd_op.batch_norm_: (-1x144x28x28xf32, 144xf32, 144xf32, 144xf32, 144xf32, -1xui8) <- (-1x144x28x28xf32, 144xf32, 144xf32, 144xf32, 144xf32)
        (
            batch_norm__66,
            batch_norm__67,
            batch_norm__68,
        ...
        # pd_op.relu6: (-1x144x28x28xf32) <- (-1x144x28x28xf32)
        relu6_8 = paddle._C_ops.relu6(batch_norm__66)

        # pd_op.conv2d: (-1x32x28x28xf32) <- (-1x144x28x28xf32, 32x144x1x1xf32)
        ...
        # pd_op.conv2d: (-1x192x28x28xf32) <- (-1x32x28x28xf32, 192x32x1x1xf32)
        ...
        depthwise_conv2d_4 = paddle._C_ops.depthwise_conv2d(
            relu6_9, parameter_196, [1, 1], [1, 1], "EXPLICIT", 192, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x32x28x28xf32) <- (-1x192x28x28xf32, 32x192x1x1xf32)
        ...
        depthwise_conv2d_5 = paddle._C_ops.depthwise_conv2d(
            relu6_11, parameter_181, [1, 1], [1, 1], "EXPLICIT", 192, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_6 = paddle._C_ops.depthwise_conv2d(
            relu6_13, parameter_166, [2, 2], [1, 1], "EXPLICIT", 192, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x64x14x14xf32) <- (-1x192x14x14xf32, 64x192x1x1xf32)
        ...
        # pd_op.conv2d: (-1x384x14x14xf32) <- (-1x64x14x14xf32, 384x64x1x1xf32)
        ...
        depthwise_conv2d_7 = paddle._C_ops.depthwise_conv2d(
            relu6_15, parameter_151, [1, 1], [1, 1], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x64x14x14xf32) <- (-1x384x14x14xf32, 64x384x1x1xf32)
        ...
        depthwise_conv2d_8 = paddle._C_ops.depthwise_conv2d(
            relu6_17, parameter_136, [1, 1], [1, 1], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_9 = paddle._C_ops.depthwise_conv2d(
            relu6_19, parameter_121, [1, 1], [1, 1], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_10 = paddle._C_ops.depthwise_conv2d(
            relu6_21, parameter_106, [1, 1], [1, 1], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_11 = paddle._C_ops.depthwise_conv2d(
            relu6_23, parameter_91, [1, 1], [1, 1], "EXPLICIT", 576, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_12 = paddle._C_ops.depthwise_conv2d(
            relu6_25, parameter_76, [1, 1], [1, 1], "EXPLICIT", 576, [1, 1], "NCHW"
        )
        ...
        # pd_op.depthwise_conv2d: (-1x576x7x7xf32) <- (-1x576x14x14xf32, 576x1x3x3xf32)
        depthwise_conv2d_13 = paddle._C_ops.depthwise_conv2d(
            relu6_27, parameter_61, [2, 2], [1, 1], "EXPLICIT", 576, [1, 1], "NCHW"
        )
        ...
        # pd_op.relu6: (-1x576x7x7xf32) <- (-1x576x7x7xf32)
        relu6_28 = paddle._C_ops.relu6(batch_norm__246)

        # pd_op.conv2d: (-1x160x7x7xf32) <- (-1x576x7x7xf32, 160x576x1x1xf32)
        ...
        # pd_op.relu6: (-1x960x7x7xf32) <- (-1x960x7x7xf32)
        relu6_29 = paddle._C_ops.relu6(batch_norm__258)

        # pd_op.depthwise_conv2d: (-1x960x7x7xf32) <- (-1x960x7x7xf32, 960x1x3x3xf32)
        depthwise_conv2d_14 = paddle._C_ops.depthwise_conv2d(
            relu6_29, parameter_46, [1, 1], [1, 1], "EXPLICIT", 960, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_15 = paddle._C_ops.depthwise_conv2d(
            relu6_31, parameter_31, [1, 1], [1, 1], "EXPLICIT", 960, [1, 1], "NCHW"
        )
        ...
        depthwise_conv2d_16 = paddle._C_ops.depthwise_conv2d(
            relu6_33, parameter_16, [1, 1], [1, 1], "EXPLICIT", 960, [1, 1], "NCHW"
        )
        ...
        # pd_op.conv2d: (-1x320x7x7xf32) <- (-1x960x7x7xf32, 320x960x1x1xf32)
