...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5):
        ...
        # pd_op.flatten: (8x4116xf32) <- (8x1x4116xf32)
        ...
        # pd_op.index_sample: (8x27xf32) <- (8x4116xf32, 8x27xi64)
        ...
        # pd_op.subtract: (8x1x4116x1xf32) <- (1x1x4116x1xf32, 8x1x1x1xf32)
        ...
        # pd_op.subtract: (8x1x4116x1xf32) <- (8x1x1x1xf32, 1x1x4116x1xf32)
        ...
        # builtin.combine: ([8x1x4116x1xf32, 8x1x4116x1xf32, 8x1x4116x1xf32, 8x1x4116x1xf32]) <- (8x1x4116x1xf32, 8x1x4116x1xf32, 8x1x4116x1xf32, 8x1x4116x1xf32)
        combine_0 = [subtract_1, subtract_2, subtract_3, subtract_4]
        del subtract_1, subtract_2, subtract_3, subtract_4

        # pd_op.concat: (8x1x4116x4xf32) <- ([8x1x4116x1xf32, 8x1x4116x1xf32, 8x1x4116x1xf32, 8x1x4116x1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_3)
        del combine_0, full_3

        # pd_op.min: (8x1x4116xf32) <- (8x1x4116x4xf32, 1xi64)
        ...
        # pd_op.greater_than: (8x1x4116xb) <- (8x1x4116xf32, xf32)
        greater_than_2 = paddle._C_ops.greater_than(min_0, full_4)
        del full_4, min_0

        # pd_op.cast: (8x1x4116xf32) <- (8x1x4116xb)
        ...
        # pd_op.multiply: (8x1x4116xf32) <- (8x1x4116xf32, 8x1x1xf32)
        ...
        # pd_op.sum: (8x4116xf32) <- (8x1x4116xf32, 1xi64)
        ...
        # pd_op.max: (xf32) <- (8x4116xf32, 0xi64)
