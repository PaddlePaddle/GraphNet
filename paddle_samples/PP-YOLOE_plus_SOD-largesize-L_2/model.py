...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0):
        # pd_op.flatten: (1x1024x2116xf32) <- (1x1024x46x46xf32)
        flatten_0 = paddle._C_ops.flatten(data_0, 2, 3)

        # pd_op.transpose: (1x2116x1024xf32) <- (1x1024x2116xf32)
        ...
        # pd_op.flatten: (2116xf32) <- (46x46xf32)
        flatten_1 = paddle._C_ops.flatten(split_0, 0, 1)

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_0 = [1]

        # pd_op.unsqueeze: (2116x1xf32) <- (2116xf32, 1xi64)
        ...
        # pd_op.matmul: (2116x256xf32) <- (2116x1xf32, 1x256xf32)
        ...
        # pd_op.sin: (2116x256xf32) <- (2116x256xf32)
        sin_0 = paddle._C_ops.sin(matmul_0)

        # pd_op.cos: (2116x256xf32) <- (2116x256xf32)
        ...
        # builtin.combine: ([2116x256xf32, 2116x256xf32, 2116x256xf32, 2116x256xf32]) <- (2116x256xf32, 2116x256xf32, 2116x256xf32, 2116x256xf32)
        combine_1 = [sin_0, cos_0, sin_1, cos_1]

        # pd_op.concat: (2116x1024xf32) <- ([2116x256xf32, 2116x256xf32, 2116x256xf32, 2116x256xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_1, full_7)

        # pd_op.unsqueeze: (1x2116x1024xf32) <- (2116x1024xf32, 1xi64)
