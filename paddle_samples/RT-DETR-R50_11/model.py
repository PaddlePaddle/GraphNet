...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.matmul: (4x6804x256xf32) <- (4x6804x256xf32, 256x256xf32)
        matmul_0 = paddle._C_ops.matmul(data_2, parameter_7, False, False)

        # pd_op.add: (4x6804x256xf32) <- (4x6804x256xf32, 256xf32)
        add_0 = paddle._C_ops.add(matmul_0, parameter_6)

        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_1 = [4, 6804, 8, 32]

        # pd_op.reshape: (4x6804x8x32xf32) <- (4x6804x256xf32, 4xi64)
        reshape_4 = paddle._C_ops.reshape(add_0, full_int_array_1)
        ...
        slice_0 = paddle._C_ops.slice(
            data_1, [3], full_int_array_5, full_int_array_6, [1], []
        )
        ...
        slice_1 = paddle._C_ops.slice(
            data_1, [3], full_int_array_6, full_int_array_8, [1], []
        )
        ...
        # pd_op.split: ([-1x-1x-1x-1xf32, -1x-1x-1x-1xf32, -1x-1x-1x-1xf32]) <- (4x6804x8x32xf32, 3xi64, 1xi32)
        ...
        combine_1 = [full_7, full_7, slice_12, slice_13]
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_2 = [full_7, full_7, slice_16, slice_17]
        ...
        # builtin.combine: ([xi64, xi64, xi64, xi64]) <- (xi64, xi64, xi64, xi64)
        combine_3 = [full_7, full_7, slice_20, slice_21]
