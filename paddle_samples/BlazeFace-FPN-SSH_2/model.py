...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (4x8x80x80xf32) <- (4x48x80x80xf32, 8x48x3x3xf32)
        ...
        reshape_4 = paddle._C_ops.reshape(transpose_0, full_int_array_1)

        # pd_op.conv2d: (4x4x80x80xf32) <- (4x48x80x80xf32, 4x48x3x3xf32)
        ...
        reshape_6 = paddle._C_ops.reshape(transpose_1, full_int_array_2)
        ...
        reshape_2 = paddle._C_ops.reshape(parameter_2, full_int_array_0)
        ...
        reshape_5 = paddle._C_ops.reshape(transpose_2, full_int_array_1)

        # pd_op.conv2d: (4x12x40x40xf32) <- (4x48x40x40xf32, 12x48x3x3xf32)
        ...
        reshape_7 = paddle._C_ops.reshape(transpose_3, full_int_array_2)

        # pd_op.prior_box: (80x80x2x4xf32, 80x80x2x4xf32) <- (4x48x80x80xf32, 4x3x640x640xf32)
        ...
        reshape_8 = paddle._C_ops.reshape(prior_box_0, full_int_array_3)

        # pd_op.prior_box: (40x40x6x4xf32, 40x40x6x4xf32) <- (4x48x40x40xf32, 4x3x640x640xf32)
        ...
        reshape_9 = paddle._C_ops.reshape(prior_box_2, full_int_array_3)
        return (
            conv2d_0,
            reshape_0,
            transpose_0,
