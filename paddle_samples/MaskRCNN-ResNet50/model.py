...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (1x1024x-1x-1xf32) <- (1x1024x-1x-1xf32, 1024x1024x3x3xf32)
        ...
        # pd_op.conv2d: (1x15x-1x-1xf32) <- (1x1024x-1x-1xf32, 15x1024x1x1xf32)
        ...
        # pd_op.add: (1x15x-1x-1xf32) <- (1x15x-1x-1xf32, 1x15x1x1xf32)
        add_0 = paddle._C_ops.add(conv2d_1, reshape_1)

        # pd_op.conv2d: (1x60x-1x-1xf32) <- (1x1024x-1x-1xf32, 60x1024x1x1xf32)
        ...
        # pd_op.add: (1x60x-1x-1xf32) <- (1x60x-1x-1xf32, 1x60x1x1xf32)
        add_1 = paddle._C_ops.add(conv2d_2, reshape_2)

        # pd_op.shape64: (4xi64) <- (1x1024x-1x-1xf32)
        ...
        reshape_4 = paddle._C_ops.reshape(split_1, full_int_array_4)

        # pd_op.reshape: (-1xf32) <- (-1x-1xf32, 1xi64)
        reshape_5 = paddle._C_ops.reshape(split_0, full_int_array_4)

        # builtin.combine: ([-1xf32, -1xf32, -1xf32, -1xf32]) <- (-1xf32, -1xf32, -1xf32, -1xf32)
        combine_1 = [reshape_4, reshape_5, reshape_4, reshape_5]
        ...
        reshape_6 = paddle._C_ops.reshape(stack_0, full_int_array_5)

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_6 = [1, -1, 4]

        # pd_op.reshape: (1x15x4xf32) <- (15x4xf32, 3xi64)
        reshape_7 = paddle._C_ops.reshape(data_1, full_int_array_6)

        # pd_op.add: (-1x15x4xf32) <- (-1x1x4xf32, 1x15x4xf32)
        add_3 = paddle._C_ops.add(reshape_6, reshape_7)
