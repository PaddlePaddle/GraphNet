...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.topk: (2x-1x9xf32, 2x-1x9xi64) <- (2x-1x-1xf32, 1xi32)
        ...
        # pd_op.scale: (2x-1x9xi64) <- (2x-1x9xi64, 1xf32)
        scale_0 = paddle._C_ops.scale(topk_1, full_1, float("0"), True)
        del full_1

        # pd_op.one_hot: (2x-1x9x-1xf32) <- (2x-1x9xi64, xi64)
        one_hot_0 = paddle._C_ops.one_hot(
            topk_1 % paddle.cast(data_0, topk_1.dtype), data_0
        )
        del data_0, topk_1
        ...
        # pd_op.sum: (2x-1x-1xf32) <- (2x-1x9x-1xf32, 1xi64)
        ...
        # pd_op.add: (2x-1x9xi64) <- (2x-1x9xi64, xi64)
        add_0 = paddle._C_ops.add(topk_3, data_4)
        del data_4

        # pd_op.one_hot: (2x-1x9x-1xf32) <- (2x-1x9xi64, xi64)
        one_hot_1 = paddle._C_ops.one_hot(
            topk_3 % paddle.cast(data_1, topk_3.dtype), data_1
        )
        del data_1, topk_3
        ...
        # pd_op.add: (2x-1x9xi64) <- (2x-1x9xi64, xi64)
        add_1 = paddle._C_ops.add(topk_5, data_5)
        del data_5

        # pd_op.one_hot: (2x-1x9x-1xf32) <- (2x-1x9xi64, xi64)
        one_hot_2 = paddle._C_ops.one_hot(
            topk_5 % paddle.cast(data_2, topk_5.dtype), data_2
        )
        del data_2, topk_5
        ...
        # pd_op.add: (2x-1x9xi64) <- (2x-1x9xi64, xi64)
        add_2 = paddle._C_ops.add(topk_7, data_6)
        del data_6

        # pd_op.one_hot: (2x-1x9x-1xf32) <- (2x-1x9xi64, xi64)
        one_hot_3 = paddle._C_ops.one_hot(
            topk_7 % paddle.cast(data_3, topk_7.dtype), data_3
        )
        del data_3, topk_7
        ...
        # builtin.combine: ([2x-1x-1xf32, 2x-1x-1xf32, 2x-1x-1xf32, 2x-1x-1xf32]) <- (2x-1x-1xf32, 2x-1x-1xf32, 2x-1x-1xf32, 2x-1x-1xf32)
        combine_0 = [multiply_0, multiply_1, multiply_2, multiply_3]
        del multiply_0, multiply_1, multiply_2, multiply_3

        # pd_op.concat: (2x-1x-1xf32) <- ([2x-1x-1xf32, 2x-1x-1xf32, 2x-1x-1xf32, 2x-1x-1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_2)
        del combine_0

        # builtin.combine: ([2x-1x9xi64, 2x-1x9xi64, 2x-1x9xi64, 2x-1x9xi64]) <- (2x-1x9xi64, 2x-1x9xi64, 2x-1x9xi64, 2x-1x9xi64)
        combine_1 = [scale_0, add_0, add_1, add_2]
        del add_0, add_1, add_2, scale_0

        # pd_op.concat: (2x-1x36xi64) <- ([2x-1x9xi64, 2x-1x9xi64, 2x-1x9xi64, 2x-1x9xi64], 1xi32)
