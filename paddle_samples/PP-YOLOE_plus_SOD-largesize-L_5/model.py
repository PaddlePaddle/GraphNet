...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        ...
        # pd_op.unsqueeze: (1x-1x1xi32) <- (1x-1xi32, 1xi64)
        ...
        # pd_op.masked_select: (-1xf32) <- (1x-1x4xf32, 1x-1x4xb)
        ...
        # pd_op.sum: (1x-1xf32) <- (1x-1x10xf32, 1xi64)
        ...
        # pd_op.unsqueeze: (1x-1x1xb) <- (1x-1xb, 1xi64)
        ...
        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_4 = [1, 1, 88]

        # pd_op.tile: (1x-1x88xi32) <- (1x-1x1xi32, 3xi64)
        tile_1 = paddle._C_ops.tile(cast_3, full_int_array_4)

        # pd_op.cast: (1x-1x88xb) <- (1x-1x88xi32)
        cast_1 = paddle._C_ops.cast(tile_1, paddle.bool)

        # pd_op.masked_select: (-1xf32) <- (1x-1x88xf32, 1x-1x88xb)
        masked_select_1 = paddle._C_ops.masked_select(data_5, cast_1)

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_5 = [-1, 4, 22]

        # pd_op.reshape: (-1x4x22xf32) <- (-1xf32, 3xi64)
        ...
        # pd_op.subtract: (1x-1x2xf32) <- (-1x2xf32, 1x-1x2xf32)
        subtract_13 = paddle._C_ops.subtract(data_6, split_8)

        # pd_op.subtract: (1x-1x2xf32) <- (1x-1x2xf32, -1x2xf32)
        ...
        full_8 = paddle._C_ops.full(
            [1], float("18.99"), paddle.float32, paddle.core.CPUPlace()
        )
        ...
        # pd_op.cross_entropy_with_softmax: (-1x4x22xf32, -1x4x1xf32) <- (-1x4x22xf32, -1x4x1xi64)
