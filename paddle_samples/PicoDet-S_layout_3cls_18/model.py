...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # builtin.combine: ([4624x4xf32, 1156x4xf32, 289x4xf32, 81x4xf32]) <- (4624x4xf32, 1156x4xf32, 289x4xf32, 81x4xf32)
        combine_12 = [reshape_0, reshape_1, reshape_2, reshape_3]

        # pd_op.concat: (6150x4xf32) <- ([4624x4xf32, 1156x4xf32, 289x4xf32, 81x4xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_12, full_15)

        # builtin.combine: ([4624x2xf32, 1156x2xf32, 289x2xf32, 81x2xf32]) <- (4624x2xf32, 1156x2xf32, 289x2xf32, 81x2xf32)
        combine_13 = [reshape_4, reshape_5, reshape_6, reshape_7]

        # pd_op.concat: (6150x2xf32) <- ([4624x2xf32, 1156x2xf32, 289x2xf32, 81x2xf32], 1xi32)
        concat_1 = paddle._C_ops.concat(combine_13, full_15)

        # builtin.combine: ([4624x1xf32, 1156x1xf32, 289x1xf32, 81x1xf32]) <- (4624x1xf32, 1156x1xf32, 289x1xf32, 81x1xf32)
        combine_14 = [full_5, full_8, full_11, full_14]

        # pd_op.concat: (6150x1xf32) <- ([4624x1xf32, 1156x1xf32, 289x1xf32, 81x1xf32], 1xi32)
