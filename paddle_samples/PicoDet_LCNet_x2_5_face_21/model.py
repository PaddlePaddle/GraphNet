...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.slice: (718xf32) <- (718x2xf32, 1xi64, 1xi64)
        slice_0 = paddle._C_ops.slice(
            data_0, [1], full_int_array_0, full_int_array_1, [1], [1]
        )

        # pd_op.slice: (718xf32) <- (718x4xf32, 1xi64, 1xi64)
        slice_1 = paddle._C_ops.slice(
            data_1, [1], full_int_array_0, full_int_array_1, [1], [1]
        )

        # pd_op.subtract: (718xf32) <- (718xf32, 718xf32)
        ...
        # pd_op.clip: (718xf32) <- (718xf32, 1xf32, 1xf32)
        ...
        # builtin.combine: ([718xf32, 718xf32, 718xf32, 718xf32]) <- (718xf32, 718xf32, 718xf32, 718xf32)
        combine_0 = [clip_0, clip_1, clip_2, clip_3]

        # pd_op.stack: (718x4xf32) <- ([718xf32, 718xf32, 718xf32, 718xf32])
