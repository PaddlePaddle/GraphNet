...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.topk: (1x46x13xf32, 1x46x13xi64) <- (1x46x56784xf32, 1xi32)
        ...
        full_1 = paddle._C_ops.full(
            [1], float("56784"), paddle.int32, paddle.core.CPUPlace()
        )

        # pd_op.one_hot: (1x46x13x56784xf32) <- (1x46x13xi64, 1xi32)
        ...
        # pd_op.sum: (1x46x56784xf32) <- (1x46x13x56784xf32, 1xi64)
        sum_0 = paddle._C_ops.sum(one_hot_0, full_int_array_0, None, False)

        # pd_op.multiply: (1x46x56784xf32) <- (1x46x56784xf32, 1x46x1xf32)
