...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0):
        ...
        # builtin.combine: ([6400x4xf32, 1600x4xf32, 400x4xf32, 100x4xf32]) <- (6400x4xf32, 1600x4xf32, 400x4xf32, 100x4xf32)
        combine_12 = [reshape_0, reshape_1, reshape_2, reshape_3]

        # pd_op.concat: (8500x4xf32) <- ([6400x4xf32, 1600x4xf32, 400x4xf32, 100x4xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_12, full_15)

        # builtin.combine: ([6400x2xf32, 1600x2xf32, 400x2xf32, 100x2xf32]) <- (6400x2xf32, 1600x2xf32, 400x2xf32, 100x2xf32)
        combine_13 = [reshape_4, reshape_5, reshape_6, reshape_7]

        # pd_op.concat: (8500x2xf32) <- ([6400x2xf32, 1600x2xf32, 400x2xf32, 100x2xf32], 1xi32)
        concat_2 = paddle._C_ops.concat(combine_13, full_15)

        # builtin.combine: ([6400x1xf32, 1600x1xf32, 400x1xf32, 100x1xf32]) <- (6400x1xf32, 1600x1xf32, 400x1xf32, 100x1xf32)
        combine_14 = [full_5, full_8, full_11, full_14]

        # pd_op.concat: (8500x1xf32) <- ([6400x1xf32, 1600x1xf32, 400x1xf32, 100x1xf32], 1xi32)
        ...
        # pd_op.share_data_: (8x8500x4xf32) <- (8x8500x4xf32)
        share_data__0 = data_0.detach()

        # pd_op.multiply: (8x8500x4xf32) <- (8x8500x4xf32, 8500x1xf32)
