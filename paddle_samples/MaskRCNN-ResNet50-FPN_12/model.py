...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.full_like: (115200x4xf32) <- (115200x4xf32, 1xf32)
        full_like_0 = paddle._C_ops.full_like(
            data_10, full_0, paddle.float32, paddle.framework._current_expected_place()
        )

        # pd_op.generate_proposals: (-1x4xf32, -1x1xf32, 1xf32) <- (1x3x160x240xf32, 1x12x160x240xf32, 1x2xf32, 115200x4xf32, 115200x4xf32)
        ...
        # pd_op.full_like: (28800x4xf32) <- (28800x4xf32, 1xf32)
        full_like_1 = paddle._C_ops.full_like(
            data_11, full_0, paddle.float32, paddle.framework._current_expected_place()
        )

        # pd_op.generate_proposals: (-1x4xf32, -1x1xf32, 1xf32) <- (1x3x80x120xf32, 1x12x80x120xf32, 1x2xf32, 28800x4xf32, 28800x4xf32)
        ...
        # pd_op.full_like: (7200x4xf32) <- (7200x4xf32, 1xf32)
        full_like_2 = paddle._C_ops.full_like(
            data_12, full_0, paddle.float32, paddle.framework._current_expected_place()
        )

        # pd_op.generate_proposals: (-1x4xf32, -1x1xf32, 1xf32) <- (1x3x40x60xf32, 1x12x40x60xf32, 1x2xf32, 7200x4xf32, 7200x4xf32)
        ...
        # pd_op.full_like: (1800x4xf32) <- (1800x4xf32, 1xf32)
        full_like_3 = paddle._C_ops.full_like(
            data_13, full_0, paddle.float32, paddle.framework._current_expected_place()
        )

        # pd_op.generate_proposals: (-1x4xf32, -1x1xf32, 1xf32) <- (1x3x20x30xf32, 1x12x20x30xf32, 1x2xf32, 1800x4xf32, 1800x4xf32)
        ...
        # pd_op.full_like: (450x4xf32) <- (450x4xf32, 1xf32)
        full_like_4 = paddle._C_ops.full_like(
            data_14, full_0, paddle.float32, paddle.framework._current_expected_place()
        )

        # pd_op.generate_proposals: (-1x4xf32, -1x1xf32, 1xf32) <- (1x3x10x15xf32, 1x12x10x15xf32, 1x2xf32, 450x4xf32, 450x4xf32)
