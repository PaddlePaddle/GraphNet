...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        ...
        # pd_op.slice: (300x-1x168xf32) <- (2x300x-1x168xf32, 1xi64, 1xi64)
        ...
        # pd_op.gather: (1x-1x168xf32) <- (300x-1x168xf32, 1xi64, 1xi32)
        ...
        # builtin.combine: ([1x-1x168xf32, 1x-1x168xf32]) <- (1x-1x168xf32, 1x-1x168xf32)
        combine_0 = [gather_0, gather_1]

        # pd_op.concat: (2x-1x168xf32) <- ([1x-1x168xf32, 1x-1x168xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_0)

        # pd_op.gather: (1x-1x672xf32) <- (1x-1x672xf32, 1xi64, 1xi32)
        gather_2 = paddle._C_ops.gather(data_1, data_4, full_0)

        # pd_op.gather: (1x-1x672xf32) <- (1x-1x672xf32, 1xi64, 1xi32)
        gather_3 = paddle._C_ops.gather(data_2, data_6, full_0)

        # builtin.combine: ([1x-1x672xf32, 1x-1x672xf32]) <- (1x-1x672xf32, 1x-1x672xf32)
        combine_1 = [gather_2, gather_3]

        # pd_op.concat: (2x-1x672xf32) <- ([1x-1x672xf32, 1x-1x672xf32], 1xi32)
