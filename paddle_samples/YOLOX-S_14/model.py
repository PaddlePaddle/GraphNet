...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.slice: (140xf32) <- (140x4xf32, 1xi64, 1xi64)
        ...
        # pd_op.subtract: (140xf32) <- (140xf32, 140xf32)
        ...
        # pd_op.multiply: (140xf32) <- (140xf32, 140xf32)
        ...
        # pd_op.unsqueeze: (140x1x4xf32) <- (140x4xf32, 1xi64)
        unsqueeze_0 = paddle._C_ops.unsqueeze(data_0, full_int_array_3)

        # pd_op.assign: (140x1x4xf32) <- (140x1x4xf32)
        assign_6 = unsqueeze_0

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_5 = [2147483647]

        # pd_op.slice: (140x1x2xf32) <- (140x1x4xf32, 1xi64, 1xi64)
        slice_4 = paddle._C_ops.slice(
            unsqueeze_0, [2], full_int_array_0, full_int_array_5, [1], []
        )

        # pd_op.slice: (140x2xf32) <- (140x4xf32, 1xi64, 1xi64)
        slice_5 = paddle._C_ops.slice(
            data_1, [1], full_int_array_0, full_int_array_5, [1], []
        )

        # pd_op.minimum: (140x140x2xf32) <- (140x1x2xf32, 140x2xf32)
        ...
        # pd_op.maximum: (140x140x2xf32) <- (140x1x2xf32, 140x2xf32)
        maximum_0 = paddle._C_ops.maximum(slice_6, slice_7)

        # pd_op.subtract: (140x140x2xf32) <- (140x140x2xf32, 140x140x2xf32)
        ...
        # pd_op.clip: (140x140x2xf32) <- (140x140x2xf32, 1xf32, 1xf32)
        clip_0 = paddle._C_ops.clip(subtract_2, full_0, full_1)

        # pd_op.prod: (140x140xf32) <- (140x140x2xf32, 1xi64)
