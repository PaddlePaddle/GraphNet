...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        add_1 = paddle._C_ops.add(batch_norm__12, conv2d_7)
        ...
        # pd_op.add: (128x80x28x28xf32) <- (128x80x28x28xf32, 128x80x28x28xf32)
        add_2 = paddle._C_ops.add(add_1, conv2d_10)
        ...
        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_3 = [40, 120]

        # pd_op.split: ([128x40x14x14xf32, 128x120x14x14xf32]) <- (128x160x14x14xf32, 2xi64, 1xi32)
        split_29 = paddle._C_ops.split(batch_norm__30, full_int_array_3, full_0)
        ...
        add_3 = paddle._C_ops.add(batch_norm__30, conv2d_14)

        # pd_op.split: ([128x40x14x14xf32, 128x120x14x14xf32]) <- (128x160x14x14xf32, 2xi64, 1xi32)
        split_30 = paddle._C_ops.split(add_3, full_int_array_3, full_0)
        ...
        # pd_op.add: (128x160x14x14xf32) <- (128x160x14x14xf32, 128x160x14x14xf32)
        add_4 = paddle._C_ops.add(add_3, conv2d_17)

        # pd_op.split: ([128x40x14x14xf32, 128x120x14x14xf32]) <- (128x160x14x14xf32, 2xi64, 1xi32)
        split_31 = paddle._C_ops.split(add_4, full_int_array_3, full_0)
        ...
        # pd_op.add: (128x160x14x14xf32) <- (128x160x14x14xf32, 128x160x14x14xf32)
        add_5 = paddle._C_ops.add(add_4, conv2d_20)

        # pd_op.split: ([128x40x14x14xf32, 128x120x14x14xf32]) <- (128x160x14x14xf32, 2xi64, 1xi32)
        split_32 = paddle._C_ops.split(add_5, full_int_array_3, full_0)
        ...
        # pd_op.add: (128x160x14x14xf32) <- (128x160x14x14xf32, 128x160x14x14xf32)
        add_6 = paddle._C_ops.add(add_5, conv2d_23)

        # pd_op.split: ([128x40x14x14xf32, 128x120x14x14xf32]) <- (128x160x14x14xf32, 2xi64, 1xi32)
        split_33 = paddle._C_ops.split(add_6, full_int_array_3, full_0)
        ...
        # pd_op.add: (128x160x14x14xf32) <- (128x160x14x14xf32, 128x160x14x14xf32)
        add_7 = paddle._C_ops.add(add_6, conv2d_26)

        # pd_op.split: ([128x40x14x14xf32, 128x120x14x14xf32]) <- (128x160x14x14xf32, 2xi64, 1xi32)
        split_34 = paddle._C_ops.split(add_7, full_int_array_3, full_0)
        ...
        # pd_op.add: (128x160x14x14xf32) <- (128x160x14x14xf32, 128x160x14x14xf32)
        add_8 = paddle._C_ops.add(add_7, conv2d_29)

        # pd_op.split: ([128x40x14x14xf32, 128x120x14x14xf32]) <- (128x160x14x14xf32, 2xi64, 1xi32)
        split_35 = paddle._C_ops.split(add_8, full_int_array_3, full_0)
        ...
        # pd_op.add: (128x160x14x14xf32) <- (128x160x14x14xf32, 128x160x14x14xf32)
        add_9 = paddle._C_ops.add(add_8, conv2d_32)

        # pd_op.split: ([128x40x14x14xf32, 128x120x14x14xf32]) <- (128x160x14x14xf32, 2xi64, 1xi32)
        split_36 = paddle._C_ops.split(add_9, full_int_array_3, full_0)
        ...
        # pd_op.add: (128x160x14x14xf32) <- (128x160x14x14xf32, 128x160x14x14xf32)
        add_10 = paddle._C_ops.add(add_9, conv2d_35)
        ...
        # pd_op.full_int_array: (2xi64) <- ()
        full_int_array_4 = [80, 240]

        # pd_op.split: ([128x80x7x7xf32, 128x240x7x7xf32]) <- (128x320x7x7xf32, 2xi64, 1xi32)
        split_37 = paddle._C_ops.split(batch_norm__84, full_int_array_4, full_0)
        ...
        add_11 = paddle._C_ops.add(batch_norm__84, conv2d_39)

        # pd_op.split: ([128x80x7x7xf32, 128x240x7x7xf32]) <- (128x320x7x7xf32, 2xi64, 1xi32)
        split_38 = paddle._C_ops.split(add_11, full_int_array_4, full_0)
        ...
        # pd_op.add: (128x320x7x7xf32) <- (128x320x7x7xf32, 128x320x7x7xf32)
        add_12 = paddle._C_ops.add(add_11, conv2d_42)
