...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.conv2d: (1x10x-1x-1xf32) <- (1x768x-1x-1xf32, 10x768x3x3xf32)
        ...
        # pd_op.add: (1x10x-1x-1xf32) <- (1x10x-1x-1xf32, 1x10x1x1xf32)
        ...
        # pd_op.conv2d: (1x88x-1x-1xf32) <- (1x768x-1x-1xf32, 88x768x3x3xf32)
        ...
        # pd_op.add: (1x88x-1x-1xf32) <- (1x88x-1x-1xf32, 1x88x1x1xf32)
        add_4 = paddle._C_ops.add(conv2d_5, reshape_9)

        # pd_op.sigmoid: (1x10x-1x-1xf32) <- (1x10x-1x-1xf32)
        sigmoid_2 = paddle._C_ops.sigmoid(add_2)
        del add_2

        # pd_op.flatten: (1x10x-1xf32) <- (1x10x-1x-1xf32)
        flatten_0 = paddle._C_ops.flatten(sigmoid_2, 2, 3)

        # pd_op.transpose: (1x-1x10xf32) <- (1x10x-1xf32)
        transpose_0 = paddle._C_ops.transpose(flatten_0, [0, 2, 1])
        del flatten_0

        # pd_op.flatten: (1x88x-1xf32) <- (1x88x-1x-1xf32)
        flatten_1 = paddle._C_ops.flatten(add_4, 2, 3)

        # pd_op.transpose: (1x-1x88xf32) <- (1x88x-1xf32)
        ...
        # pd_op.conv2d: (1x10x-1x-1xf32) <- (1x384x-1x-1xf32, 10x384x3x3xf32)
        ...
        # pd_op.conv2d: (1x88x-1x-1xf32) <- (1x384x-1x-1xf32, 88x384x3x3xf32)
        ...
        # pd_op.conv2d: (1x10x-1x-1xf32) <- (1x192x-1x-1xf32, 10x192x3x3xf32)
        ...
        # pd_op.conv2d: (1x88x-1x-1xf32) <- (1x192x-1x-1xf32, 88x192x3x3xf32)
        ...
        # builtin.combine: ([1x-1x10xf32, 1x-1x10xf32, 1x-1x10xf32]) <- (1x-1x10xf32, 1x-1x10xf32, 1x-1x10xf32)
        combine_15 = [transpose_0, transpose_2, transpose_4]

        # pd_op.concat: (1x-1x10xf32) <- ([1x-1x10xf32, 1x-1x10xf32, 1x-1x10xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_15, full_8)
        del combine_15

        # builtin.combine: ([1x-1x88xf32, 1x-1x88xf32, 1x-1x88xf32]) <- (1x-1x88xf32, 1x-1x88xf32, 1x-1x88xf32)
        combine_16 = [transpose_1, transpose_3, transpose_5]

        # pd_op.concat: (1x-1x88xf32) <- ([1x-1x88xf32, 1x-1x88xf32, 1x-1x88xf32], 1xi32)
