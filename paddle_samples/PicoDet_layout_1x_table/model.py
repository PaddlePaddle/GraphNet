...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3):
        ...
        # pd_op.tile: (10105x4xf32) <- (10105x1xf32, 2xi64)
        ...
        # pd_op.subtract: (10105x4xf32) <- (10105x4xf32, 4xf32)
        ...
        # pd_op.subtract: (10105x4xf32) <- (4xf32, 10105x4xf32)
        ...
        # builtin.combine: ([10105x4xf32, 10105x4xf32, 10105x4xf32, 10105x4xf32]) <- (10105x4xf32, 10105x4xf32, 10105x4xf32, 10105x4xf32)
        combine_0 = [subtract_0, subtract_1, subtract_2, subtract_3]

        # pd_op.stack: (10105x4x4xf32) <- ([10105x4xf32, 10105x4xf32, 10105x4xf32, 10105x4xf32])
        stack_0 = paddle._C_ops.stack(combine_0, 1)

        # pd_op.min: (10105x4xf32) <- (10105x4x4xf32, 1xi64)
        ...
        # pd_op.greater_than: (10105x4xb) <- (10105x4xf32, xf32)
        greater_than_0 = paddle._C_ops.greater_than(min_0, full_0)

        # pd_op.sum: (10105xi64) <- (10105x4xb, 1xi64)
        ...
        # pd_op.scale: (10105x4xf32) <- (10105x4xf32, 1xf32)
        ...
        # pd_op.add: (10105x4xf32) <- (4xf32, 10105x4xf32)
        add_2 = paddle._C_ops.add(scale_0, scale_2)

        # pd_op.add: (10105x4xf32) <- (4xf32, 10105x4xf32)
        add_3 = paddle._C_ops.add(scale_1, scale_3)

        # pd_op.subtract: (10105x4xf32) <- (10105x4xf32, 10105x4xf32)
        ...
        # pd_op.cast: (10105x4xi64) <- (10105x4xb)
        ...
        # pd_op.gather: (-1x4xi64) <- (10105x4xi64, -1xi64, 1xi32)
        gather_0 = paddle._C_ops.gather(cast_0, squeeze_0, full_4)

        # pd_op.cast: (-1x4xb) <- (-1x4xi64)
        ...
        # pd_op.logical_and: (-1x4xb) <- (-1x4xb, -1x4xb)
