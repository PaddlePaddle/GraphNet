...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5):
        ...
        # pd_op.flatten: (4x6885xf32) <- (2x2x6885xf32)
        flatten_0 = paddle._C_ops.flatten(multiply_0, 0, 1)

        # pd_op.flatten: (4x36xi64) <- (2x2x36xi64)
        flatten_1 = paddle._C_ops.flatten(data_1, 0, 1)
        del data_1

        # pd_op.index_sample: (4x36xf32) <- (4x6885xf32, 4x36xi64)
        index_sample_0 = paddle._C_ops.index_sample(flatten_0, flatten_1)
        del flatten_0, flatten_1

        # pd_op.full_int_array: (3xi64) <- ()
        full_int_array_0 = [2, 2, -1]

        # pd_op.reshape: (2x2x36xf32) <- (4x36xf32, 3xi64)
        ...
        # pd_op.subtract: (2x2x6885x1xf32) <- (1x1x6885x1xf32, 2x2x1x1xf32)
        ...
        # pd_op.subtract: (2x2x6885x1xf32) <- (2x2x1x1xf32, 1x1x6885x1xf32)
        ...
        # builtin.combine: ([2x2x6885x1xf32, 2x2x6885x1xf32, 2x2x6885x1xf32, 2x2x6885x1xf32]) <- (2x2x6885x1xf32, 2x2x6885x1xf32, 2x2x6885x1xf32, 2x2x6885x1xf32)
        combine_0 = [subtract_1, subtract_2, subtract_3, subtract_4]
        del subtract_1, subtract_2, subtract_3, subtract_4

        # pd_op.concat: (2x2x6885x4xf32) <- ([2x2x6885x1xf32, 2x2x6885x1xf32, 2x2x6885x1xf32, 2x2x6885x1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_3)
        del combine_0, full_3

        # pd_op.min: (2x2x6885xf32) <- (2x2x6885x4xf32, 1xi64)
        ...
        # pd_op.greater_than: (2x2x6885xb) <- (2x2x6885xf32, xf32)
        greater_than_2 = paddle._C_ops.greater_than(min_0, full_4)
        del full_4, min_0

        # pd_op.cast: (2x2x6885xf32) <- (2x2x6885xb)
        ...
        # pd_op.multiply: (2x2x6885xf32) <- (2x2x6885xf32, 2x2x1xf32)
        ...
        # pd_op.sum: (2x6885xf32) <- (2x2x6885xf32, 1xi64)
        ...
        # pd_op.max: (xf32) <- (2x6885xf32, 0xi64)
