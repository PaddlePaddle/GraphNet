...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0):
        # pd_op.flatten: (2x1024x324xf32) <- (2x1024x18x18xf32)
        flatten_0 = paddle._C_ops.flatten(data_0, 2, 3)

        # pd_op.transpose: (2x324x1024xf32) <- (2x1024x324xf32)
        ...
        # pd_op.matmul: (324x256xf32) <- (324x1xf32, 1x256xf32)
        ...
        # pd_op.sin: (324x256xf32) <- (324x256xf32)
        sin_0 = paddle._C_ops.sin(matmul_0)

        # pd_op.cos: (324x256xf32) <- (324x256xf32)
        ...
        # builtin.combine: ([324x256xf32, 324x256xf32, 324x256xf32, 324x256xf32]) <- (324x256xf32, 324x256xf32, 324x256xf32, 324x256xf32)
        combine_1 = [sin_0, cos_0, sin_1, cos_1]

        # pd_op.concat: (324x1024xf32) <- ([324x256xf32, 324x256xf32, 324x256xf32, 324x256xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_1, full_7)

        # pd_op.unsqueeze: (1x324x1024xf32) <- (324x1024xf32, 1xi64)
