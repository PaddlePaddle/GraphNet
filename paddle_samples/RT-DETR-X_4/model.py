...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.matmul: (2x6069x256xf32) <- (2x6069x256xf32, 256x256xf32)
        matmul_0 = paddle._C_ops.matmul(data_2, parameter_7, False, False)

        # pd_op.add: (2x6069x256xf32) <- (2x6069x256xf32, 256xf32)
        add_0 = paddle._C_ops.add(matmul_0, parameter_6)

        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_1 = [2, 6069, 8, 32]
        ...
        full_int_array_2 = [2, 500, 8, 3, 4, 2]
        ...
        # pd_op.split: ([-1x-1x-1x-1xf32, -1x-1x-1x-1xf32, -1x-1x-1x-1xf32]) <- (2x6069x8x32xf32, 3xi64, 1xi32)
