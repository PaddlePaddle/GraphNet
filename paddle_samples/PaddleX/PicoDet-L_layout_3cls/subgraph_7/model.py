...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5, data_6):
        ...
        # pd_op.transpose: (2x11x-1xf32) <- (2x-1x11xf32)
        ...
        arange_0 = paddle.arange(full_4, full_5, full_6, dtype="int32")
        ...
        split_with_num_0 = paddle._C_ops.split_with_num(unsqueeze_3, 2, full_8)
        del unsqueeze_3
        ...
        split_with_num_1 = paddle._C_ops.split_with_num(unsqueeze_0, 4, full_8)
        del full_8, unsqueeze_0
        ...
        # pd_op.subtract: (2x-1x-1x1xf32) <- (1x1x-1x1xf32, 2x-1x1x1xf32)
        ...
        # pd_op.subtract: (2x-1x-1x1xf32) <- (2x-1x1x1xf32, 1x1x-1x1xf32)
        ...
        # builtin.combine: ([2x-1x-1x1xf32, 2x-1x-1x1xf32, 2x-1x-1x1xf32, 2x-1x-1x1xf32]) <- (2x-1x-1x1xf32, 2x-1x-1x1xf32, 2x-1x-1x1xf32, 2x-1x-1x1xf32)
        combine_2 = [subtract_4, subtract_5, subtract_6, subtract_7]
        del subtract_4, subtract_5, subtract_6, subtract_7

        # pd_op.concat: (2x-1x-1x4xf32) <- ([2x-1x-1x1xf32, 2x-1x-1x1xf32, 2x-1x-1x1xf32, 2x-1x-1x1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_2, full_9)
        del combine_2, full_9

        # pd_op.min: (2x-1x-1xf32) <- (2x-1x-1x4xf32, 1xi64)
        ...
        # pd_op.greater_than: (2x-1x-1xb) <- (2x-1x-1xf32, xf32)
        greater_than_1 = paddle._C_ops.greater_than(min_0, full_10)
        del full_10, min_0

        # pd_op.cast: (2x-1x-1xf32) <- (2x-1x-1xb)
        cast_2 = paddle._C_ops.cast(greater_than_1, paddle.float32)
        del greater_than_1

        # pd_op.multiply: (2x-1x-1xf32) <- (2x-1x-1xf32, 2x-1x-1xf32)
        multiply_1 = paddle._C_ops.multiply(multiply_0, cast_2)
        ...
        topk_0, topk_1 = (lambda x, f: f(x))(
            paddle._C_ops.topk(multiply_1, full_11, -1, True, True),
            lambda out: out if isinstance(out, (list, tuple)) else (out, None),
        )
        del full_11, multiply_1
        ...
        multiply_2 = paddle._C_ops.multiply(sum_0, data_6)
        del sum_0

        # pd_op.multiply: (2x-1x-1xf32) <- (2x-1x-1xf32, 2x-1x-1xf32)
        multiply_3 = paddle._C_ops.multiply(multiply_2, cast_2)
        del cast_2, multiply_2

        # pd_op.multiply: (2x-1x-1xf32) <- (2x-1x-1xf32, 2x-1x1xf32)
        multiply_4 = paddle._C_ops.multiply(multiply_3, data_6)
        del data_6, multiply_3
        ...
        del divide_0, full_12, max_0, multiply_0, multiply_4, sum_1, unsqueeze_2
