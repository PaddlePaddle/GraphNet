...
class GraphModule(torch.nn.Module):
    def forward(
        ...
        L_self_modules_classifier_modules_cbr_modules_0_parameters_weight_: torch.nn.parameter.Parameter,
        L_self_modules_classifier_modules_cbr_modules_1_buffers_running_mean_: torch.Tensor,
        L_self_modules_classifier_modules_cbr_modules_1_buffers_running_var_: torch.Tensor,
        L_self_modules_classifier_modules_cbr_modules_1_parameters_weight_: torch.nn.parameter.Parameter,
        L_self_modules_classifier_modules_cbr_modules_1_parameters_bias_: torch.nn.parameter.Parameter,
        L_self_modules_classifier_modules_scale_modules_1_parameters_weight_: torch.nn.parameter.Parameter,
        L_self_modules_classifier_modules_low_classifier_parameters_weight_: torch.nn.parameter.Parameter,
        L_self_modules_classifier_modules_low_classifier_parameters_bias_: torch.nn.parameter.Parameter,
        L_self_modules_classifier_modules_high_classifier_parameters_weight_: torch.nn.parameter.Parameter,
        L_self_modules_classifier_modules_high_classifier_parameters_bias_: torch.nn.parameter.Parameter,
    ):
        ...
        l_self_modules_classifier_modules_cbr_modules_0_parameters_weight_ = (
            L_self_modules_classifier_modules_cbr_modules_0_parameters_weight_
        )
        l_self_modules_classifier_modules_cbr_modules_1_buffers_running_mean_ = (
            L_self_modules_classifier_modules_cbr_modules_1_buffers_running_mean_
        )
        l_self_modules_classifier_modules_cbr_modules_1_buffers_running_var_ = (
            L_self_modules_classifier_modules_cbr_modules_1_buffers_running_var_
        )
        l_self_modules_classifier_modules_cbr_modules_1_parameters_weight_ = (
            L_self_modules_classifier_modules_cbr_modules_1_parameters_weight_
        )
        l_self_modules_classifier_modules_cbr_modules_1_parameters_bias_ = (
            L_self_modules_classifier_modules_cbr_modules_1_parameters_bias_
        )
        l_self_modules_classifier_modules_scale_modules_1_parameters_weight_ = (
            L_self_modules_classifier_modules_scale_modules_1_parameters_weight_
        )
        l_self_modules_classifier_modules_low_classifier_parameters_weight_ = (
            L_self_modules_classifier_modules_low_classifier_parameters_weight_
        )
        l_self_modules_classifier_modules_low_classifier_parameters_bias_ = (
            L_self_modules_classifier_modules_low_classifier_parameters_bias_
        )
        l_self_modules_classifier_modules_high_classifier_parameters_weight_ = (
            L_self_modules_classifier_modules_high_classifier_parameters_weight_
        )
        l_self_modules_classifier_modules_high_classifier_parameters_bias_ = (
            L_self_modules_classifier_modules_high_classifier_parameters_bias_
        )
        ...
        l_input_ = l_self_modules_backbone_modules_0_modules_0_parameters_weight_ = None
        ...
        l_self_modules_classifier_modules_cbr_modules_0_parameters_weight_ = None
        ...
        input_132 = (
            ...
            l_self_modules_classifier_modules_cbr_modules_1_parameters_weight_
        ) = l_self_modules_classifier_modules_cbr_modules_1_parameters_bias_ = None
        input_134 = torch.nn.functional.relu(input_133, inplace=True)
        input_133 = None
        input_135 = torch.nn.functional.adaptive_avg_pool2d(input_131, 1)
        input_131 = None
        ...
        input_137 = torch.sigmoid(input_136)
        input_136 = None
        x = input_134 * input_137
        input_134 = input_137 = None
        x_1 = torch.nn.functional.interpolate(
            x, size=(65, 65), mode="bilinear", align_corners=False
        )
        x = None
        ...
        input_33 = (
            l_self_modules_classifier_modules_low_classifier_parameters_weight_
        ) = l_self_modules_classifier_modules_low_classifier_parameters_bias_ = None
        ...
        x_1 = (
            l_self_modules_classifier_modules_high_classifier_parameters_weight_
        ) = l_self_modules_classifier_modules_high_classifier_parameters_bias_ = None
        out = conv2d_64 + conv2d_65
        conv2d_64 = conv2d_65 = None
        out_1 = torch.nn.functional.interpolate(
            out, size=(520, 520), mode="bilinear", align_corners=False
        )
        out = None
        return (out_1,)
