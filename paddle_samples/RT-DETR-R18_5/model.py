...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.relu: (4x500x256xf32) <- (4x500x256xf32)
        ...
        # pd_op.matmul: (4x500x4xf32) <- (4x500x256xf32, 256x4xf32)
        matmul_2 = paddle._C_ops.matmul(relu_1, parameter_3, False, False)

        # pd_op.add: (4x500x4xf32) <- (4x500x4xf32, 4xf32)
        ...
        # pd_op.clip: (4x500x4xf32) <- (4x500x4xf32, 1xf32, 1xf32)
