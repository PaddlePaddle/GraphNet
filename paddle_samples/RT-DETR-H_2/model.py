...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.matmul: (1x4725x256xf32) <- (1x4725x256xf32, 256x256xf32)
        matmul_0 = paddle._C_ops.matmul(data_2, parameter_7, False, False)

        # pd_op.add: (1x4725x256xf32) <- (1x4725x256xf32, 256xf32)
        add_0 = paddle._C_ops.add(matmul_0, parameter_6)

        # pd_op.full_int_array: (4xi64) <- ()
        full_int_array_1 = [1, 4725, 8, 32]

        # pd_op.reshape: (1x4725x8x32xf32) <- (1x4725x256xf32, 4xi64)
        ...
        full_int_array_2 = [1, 500, 8, 3, 4, 2]
        ...
        # pd_op.split: ([-1x-1x-1x-1xf32, -1x-1x-1x-1xf32, -1x-1x-1x-1xf32]) <- (1x4725x8x32xf32, 3xi64, 1xi32)
