class Program_weight_tensor_data_0:
    ...
    shape = [1, 256, 304, 200]
    dtype = "float32"
    min_val = float("-5.1243")
    max_val = float("6.7769")
    mean = float("-0.0765288")
    std = float("0.854665")
    data = None
...
class Program_weight_tensor_data_1:
    ...
    shape = [1, 256, 152, 100]
    dtype = "float32"
    min_val = float("-4.34093")
    max_val = float("4.74524")
    mean = float("-0.0404039")
    std = float("0.681765")
    data = None
...
class Program_weight_tensor_data_2:
    ...
    shape = [1, 256, 76, 50]
    dtype = "float32"
    min_val = float("-3.90352")
    max_val = float("3.97142")
    mean = float("-0.0279239")
    std = float("0.623874")
    data = None
...
class Program_weight_tensor_data_3:
    ...
    shape = [1, 256, 38, 25]
    dtype = "float32"
    min_val = float("-3.32368")
    max_val = float("4.00038")
    mean = float("-0.0227527")
    std = float("0.578569")
    data = None
...
class Program_weight_tensor_data_4:
    ...
    shape = [1, 256, 19, 13]
    dtype = "float32"
    min_val = float("-3.1299")
    max_val = float("3.41386")
    mean = float("-0.023596")
    std = float("0.578067")
    data = None
