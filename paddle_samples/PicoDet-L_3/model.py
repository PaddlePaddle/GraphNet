...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        ...
        # pd_op.subtract: (8x3x10285x1xf32) <- (1x1x10285x1xf32, 8x3x1x1xf32)
        subtract_0 = paddle._C_ops.subtract(split_0, split_2)

        # pd_op.subtract: (8x3x10285x1xf32) <- (1x1x10285x1xf32, 8x3x1x1xf32)
        subtract_1 = paddle._C_ops.subtract(split_1, split_3)

        # pd_op.subtract: (8x3x10285x1xf32) <- (8x3x1x1xf32, 1x1x10285x1xf32)
        ...
        # builtin.combine: ([8x3x10285x1xf32, 8x3x10285x1xf32, 8x3x10285x1xf32, 8x3x10285x1xf32]) <- (8x3x10285x1xf32, 8x3x10285x1xf32, 8x3x10285x1xf32, 8x3x10285x1xf32)
        combine_0 = [subtract_0, subtract_1, subtract_2, subtract_3]

        # pd_op.concat: (8x3x10285x4xf32) <- ([8x3x10285x1xf32, 8x3x10285x1xf32, 8x3x10285x1xf32, 8x3x10285x1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_1)

        # pd_op.full_int_array: (1xi64) <- ()
        full_int_array_2 = [-1]

        # pd_op.min: (8x3x10285xf32) <- (8x3x10285x4xf32, 1xi64)
        ...
        # pd_op.greater_than: (8x3x10285xb) <- (8x3x10285xf32, xf32)
        greater_than_0 = paddle._C_ops.greater_than(min_0, full_2)

        # pd_op.cast: (8x3x10285xf32) <- (8x3x10285xb)
