...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.hardswish: (-1x48x112x112xf32) <- (-1x48x112x112xf32)
        ...
        # pd_op.hardswish: (-1x96x56x56xf32) <- (-1x96x56x56xf32)
        ...
        # pd_op.hardswish: (-1x192x28x28xf32) <- (-1x192x28x28xf32)
        ...
        # pd_op.hardswish: (-1x384x14x14xf32) <- (-1x384x14x14xf32)
        ...
        # pd_op.depthwise_conv2d: (-1x384x7x7xf32) <- (-1x384x14x14xf32, 384x1x5x5xf32)
        ...
        # pd_op.hardswish: (-1x768x7x7xf32) <- (-1x768x7x7xf32)
        ...
        # pd_op.conv2d: (-1x192x1x1xf32) <- (-1x768x1x1xf32, 192x768x1x1xf32)
        ...
        # pd_op.relu: (-1x192x1x1xf32) <- (-1x192x1x1xf32)
        relu_1 = paddle._C_ops.relu(add_3)

        # pd_op.conv2d: (-1x768x1x1xf32) <- (-1x192x1x1xf32, 768x192x1x1xf32)
