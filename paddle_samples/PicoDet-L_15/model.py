...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1, data_2, data_3, data_4, data_5):
        # pd_op.multiply: (8x1x8500xf32) <- (8x1x8500xf32, 8x1x8500xf32)
        multiply_1 = paddle._C_ops.multiply(data_2, data_0)

        # pd_op.flatten: (8x8500xf32) <- (8x1x8500xf32)
        ...
        # pd_op.index_sample: (8x36xf32) <- (8x8500xf32, 8x36xi64)
        ...
        # pd_op.mean: (8x1x1xf32) <- (8x1x36xf32)
        ...
        # pd_op.greater_than: (8x1x8500xb) <- (8x1x8500xf32, 8x1x1xf32)
        ...
        # pd_op.split_with_num: ([1x1x8500x1xf32, 1x1x8500x1xf32]) <- (1x1x8500x2xf32, 1xi32)
        split_with_num_0 = paddle._C_ops.split_with_num(unsqueeze_0, 2, full_3)

        # builtin.split: (1x1x8500x1xf32, 1x1x8500x1xf32) <- ([1x1x8500x1xf32, 1x1x8500x1xf32])
        (
            split_0,
            split_1,
        ) = split_with_num_0
        ...
        # pd_op.subtract: (8x1x8500x1xf32) <- (1x1x8500x1xf32, 8x1x1x1xf32)
        subtract_1 = paddle._C_ops.subtract(split_0, split_2)

        # pd_op.subtract: (8x1x8500x1xf32) <- (1x1x8500x1xf32, 8x1x1x1xf32)
        subtract_2 = paddle._C_ops.subtract(split_1, split_3)

        # pd_op.subtract: (8x1x8500x1xf32) <- (8x1x1x1xf32, 1x1x8500x1xf32)
        ...
        # builtin.combine: ([8x1x8500x1xf32, 8x1x8500x1xf32, 8x1x8500x1xf32, 8x1x8500x1xf32]) <- (8x1x8500x1xf32, 8x1x8500x1xf32, 8x1x8500x1xf32, 8x1x8500x1xf32)
        combine_0 = [subtract_1, subtract_2, subtract_3, subtract_4]

        # pd_op.concat: (8x1x8500x4xf32) <- ([8x1x8500x1xf32, 8x1x8500x1xf32, 8x1x8500x1xf32, 8x1x8500x1xf32], 1xi32)
        concat_0 = paddle._C_ops.concat(combine_0, full_4)

        # pd_op.min: (8x1x8500xf32) <- (8x1x8500x4xf32, 1xi64)
