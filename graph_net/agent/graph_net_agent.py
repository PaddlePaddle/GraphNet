...
class GraphNetAgent:
    ...
    def __init__(
        ...
        self.graph_extractor = SubprocessGraphExtractor(workspace=str(self.workspace.workspace_root))
    ...
    def _analyze_model(self, model_dir: Path):
        ...
        self.logger.info(f"Metadata: model_type={model_metadata.model_type}, vocab_size={model_metadata.vocab_size}")
    ...
    def _generate_script(self, model_dir: Path, model_metadata, model_id: str) -> Path:
        ...
        script_path = self.code_generator.generate(model_dir, model_metadata, generated_dir)
