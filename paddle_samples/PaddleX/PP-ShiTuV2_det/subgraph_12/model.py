...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(self, data_0, data_1):
        # pd_op.cast: (309x1xf32) <- (309x1xf64)
        ...
        # pd_op.scale: (309x1xf32) <- (309x1xf32, 1xf32)
        scale_0 = paddle._C_ops.scale(pow_0, full_1, float("0"), True)
        del full_1, pow_0

        # pd_op.less_equal: (309x1xb) <- (309x1xf32, xf32)
        ...
        # pd_op.add: (309x1xf32) <- (309x1xf32, 309x1xf32)
        add_0 = paddle._C_ops.add(multiply_0, multiply_1)
        del multiply_0, multiply_1

        # pd_op.bce_loss: (309x1xf32) <- (309x1xf32, 309x1xf32)
        ...
        # pd_op.sum: (309xf32) <- (309x1xf32, 1xi64)
