...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        # pd_op.depthwise_conv2d: (2x24x-1x-1xf32) <- (2x-1x-1x-1xf32, 24x1x3x3xf32)
        ...
        # pd_op.hardswish: (2x24x-1x-1xf32) <- (2x24x-1x-1xf32)
        hardswish_0 = paddle._C_ops.hardswish(batch_norm__0)

        # pd_op.conv2d: (2x48x-1x-1xf32) <- (2x24x-1x-1xf32, 48x24x1x1xf32)
        ...
        # pd_op.hardswish: (2x48x-1x-1xf32) <- (2x48x-1x-1xf32)
        hardswish_1 = paddle._C_ops.hardswish(batch_norm__6)

        # pd_op.depthwise_conv2d: (2x48x-1x-1xf32) <- (2x48x-1x-1xf32, 48x1x3x3xf32)
