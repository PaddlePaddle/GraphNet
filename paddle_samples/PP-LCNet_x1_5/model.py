...
class GraphModule(paddle.nn.Layer):
    ...
    def forward(
        ...
        t154 = paddle._C_ops.depthwise_conv2d(
            t153, t5, [1, 1], [1, 1], "EXPLICIT", 24, [1, 1], "NCHW"
        )
        del t5
        ...
        t170 = paddle._C_ops.depthwise_conv2d(
            t169, t15, [2, 2], [1, 1], "EXPLICIT", 48, [1, 1], "NCHW"
        )
        del t15
        ...
        t186 = paddle._C_ops.depthwise_conv2d(
            t185, t25, [1, 1], [1, 1], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        del t25
        ...
        t202 = paddle._C_ops.depthwise_conv2d(
            t201, t35, [2, 2], [1, 1], "EXPLICIT", 96, [1, 1], "NCHW"
        )
        del t35
        ...
        t218 = paddle._C_ops.depthwise_conv2d(
            t217, t45, [1, 1], [1, 1], "EXPLICIT", 192, [1, 1], "NCHW"
        )
        del t45
        ...
        t234 = paddle._C_ops.depthwise_conv2d(
            t233, t55, [2, 2], [1, 1], "EXPLICIT", 192, [1, 1], "NCHW"
        )
        del t55
        ...
        t250 = paddle._C_ops.depthwise_conv2d(
            t249, t65, [1, 1], [2, 2], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        del t65
        ...
        t266 = paddle._C_ops.depthwise_conv2d(
            t265, t75, [1, 1], [2, 2], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        del t75
        ...
        t282 = paddle._C_ops.depthwise_conv2d(
            t281, t85, [1, 1], [2, 2], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        del t85
        ...
        t298 = paddle._C_ops.depthwise_conv2d(
            t297, t95, [1, 1], [2, 2], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        del t95
        ...
        t314 = paddle._C_ops.depthwise_conv2d(
            t313, t105, [1, 1], [2, 2], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        del t105
        ...
        t330 = paddle._C_ops.depthwise_conv2d(
            t329, t115, [2, 2], [2, 2], "EXPLICIT", 384, [1, 1], "NCHW"
        )
        del t115
        ...
        t360 = paddle._C_ops.depthwise_conv2d(
            t359, t129, [1, 1], [2, 2], "EXPLICIT", 768, [1, 1], "NCHW"
        )
        del t129
